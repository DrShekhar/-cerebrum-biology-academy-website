...
describe('Personalized Sequencing System', () => {
  let mockContext: SequencingContext
  ...
  describe('Learning Path Generation', () => {
    test('should generate personalized learning path', () => {
      const availableItems = [
        {
          id: 'item1', conceptId: 'cell_basics', topic: 'Cell Biology',
          difficulty: -0.5, estimatedTime: 90, bloomsLevel: 'remember'
        },
        {
          id: 'item2', conceptId: 'cell_organelles', topic: 'Cell Biology',
          difficulty: 0.0, estimatedTime: 120, bloomsLevel: 'understand'
        },
        {
          id: 'item3', conceptId: 'DNA_structure', topic: 'Genetics',
          difficulty: 0.3, estimatedTime: 110, bloomsLevel: 'understand'
        },
        {
          id: 'item4', conceptId: 'DNA_replication', topic: 'Genetics',
          difficulty: 0.7, estimatedTime: 150, bloomsLevel: 'apply'
        },
        {
          id: 'item5', conceptId: 'natural_selection', topic: 'Evolution',
          difficulty: 0.2, estimatedTime: 100, bloomsLevel: 'understand'
        }
      ]
      ...
      const cellBasicsIndex = learningPath.sequence.findIndex(item => item.conceptId === 'cell_basics')
      const cellOrganellesIndex = learningPath.sequence.findIndex(item => item.conceptId === 'cell_organelles')
      expect(cellBasicsIndex).toBeLessThan(cellOrganellesIndex)

      const dnaStructureIndex = learningPath.sequence.findIndex(item => item.conceptId === 'DNA_structure')
      const dnaReplicationIndex = learningPath.sequence.findIndex(item => item.conceptId === 'DNA_replication')
    ...
    test('should optimize for different learning goals', () => {
      ...
      const availableItems = [
        { id: 'easy', conceptId: 'cell_basics', topic: 'Cell Biology', difficulty: -0.5, estimatedTime: 60, bloomsLevel: 'remember' },
        { id: 'medium', conceptId: 'DNA_structure', topic: 'Genetics', difficulty: 0.0, estimatedTime: 90, bloomsLevel: 'understand' },
        { id: 'hard', conceptId: 'DNA_replication', topic: 'Genetics', difficulty: 0.8, estimatedTime: 120, bloomsLevel: 'apply' }
      ]

      const masteryPath = personalizedSequencing.generateLearningPath(masteryContext, availableItems, mockKnowledgeGraph)
      const reviewPath = personalizedSequencing.generateLearningPath(reviewContext, availableItems, mockKnowledgeGraph)
      const explorationPath = personalizedSequencing.generateLearningPath(explorationContext, availableItems, mockKnowledgeGraph)
    ...
    test('should handle time constraints appropriately', () => {
      ...
      const availableItems = Array(10).fill(null).map((_, i) => ({
        id: `item${i}`,
        conceptId: `concept${i}`,
        topic: 'Biology',
        difficulty: i * 0.2 - 1,
      ...
      expect(path.totalEstimatedTime).toBeLessThanOrEqual(tightTimeContext.timeConstraints.timeRemaining)
  ...
  describe('Adaptive Sequencing Strategies', () => {
    test('should implement zone of proximal development strategy', () => {
      const strategy: SequencingStrategy = 'zone_of_proximal_development'

      const availableItems = [
        { id: 'too_easy', conceptId: 'concept1', topic: 'Biology', difficulty: -1.5, estimatedTime: 60, bloomsLevel: 'remember' },
        { id: 'just_right', conceptId: 'concept2', topic: 'Biology', difficulty: 0.3, estimatedTime: 90, bloomsLevel: 'understand' },
        { id: 'optimal', conceptId: 'concept3', topic: 'Biology', difficulty: 0.7, estimatedTime: 100, bloomsLevel: 'apply' },
        { id: 'too_hard', conceptId: 'concept4', topic: 'Biology', difficulty: 1.8, estimatedTime: 150, bloomsLevel: 'analyze' }
      ]
      ...
      const optimalItems = sequence.filter(item =>
        Math.abs(item.difficulty - mockContext.currentAbility) <= 0.5
      )
    ...
    test('should implement spaced repetition strategy', () => {
      const strategy: SequencingStrategy = 'spaced_repetition'
      ...
      const availableItems = [
        { id: 'cell1', conceptId: 'cell_basics', topic: 'Cell Biology', difficulty: 0.0, estimatedTime: 90, bloomsLevel: 'remember' },
        { id: 'gene1', conceptId: 'DNA_structure', topic: 'Genetics', difficulty: 0.2, estimatedTime: 100, bloomsLevel: 'understand' },
        { id: 'new1', conceptId: 'evolution1', topic: 'Evolution', difficulty: 0.3, estimatedTime: 110, bloomsLevel: 'understand' }
      ]
    ...
    test('should implement scaffolded learning strategy', () => {
      const strategy: SequencingStrategy = 'scaffolded_learning'

      const availableItems = [
        { id: 'foundation', conceptId: 'cell_basics', topic: 'Cell Biology', difficulty: -0.5, estimatedTime: 60, bloomsLevel: 'remember' },
        { id: 'building', conceptId: 'cell_organelles', topic: 'Cell Biology', difficulty: 0.0, estimatedTime: 90, bloomsLevel: 'understand' },
        { id: 'advanced', conceptId: 'cellular_processes', topic: 'Cell Biology', difficulty: 0.5, estimatedTime: 120, bloomsLevel: 'apply' },
        { id: 'complex', conceptId: 'cell_division', topic: 'Cell Biology', difficulty: 1.0, estimatedTime: 150, bloomsLevel: 'analyze' }
      ]
  ...
  describe('Knowledge Graph Navigation', () => {
    ...
    test('should detect knowledge gaps', () => {
      ...
      const gaps = personalizedSequencing.detectKnowledgeGaps(
        mockKnowledgeGraph,
        contextWithGaps
      )
  ...
  describe('Multi-objective Optimization', () => {
    test('should balance multiple optimization objectives', () => {
      ...
      const availableItems = [
        { id: 'efficient', conceptId: 'concept1', topic: 'Biology', difficulty: 0.2, estimatedTime: 60, bloomsLevel: 'understand', engagement: 0.7 },
        { id: 'engaging', conceptId: 'concept2', topic: 'Biology', difficulty: 0.5, estimatedTime: 120, bloomsLevel: 'apply', engagement: 0.9 },
        { id: 'quick', conceptId: 'concept3', topic: 'Biology', difficulty: 0.1, estimatedTime: 45, bloomsLevel: 'remember', engagement: 0.5 },
        { id: 'challenging', conceptId: 'concept4', topic: 'Biology', difficulty: 0.8, estimatedTime: 150, bloomsLevel: 'analyze', engagement: 0.6 }
      ]
    ...
    test('should adapt optimization based on student preferences', () => {
      ...
      const availableItems = [
        { id: 'item1', conceptId: 'concept1', topic: 'Biology', difficulty: 0.3, estimatedTime: 90, bloomsLevel: 'understand' },
        { id: 'item2', conceptId: 'concept2', topic: 'Biology', difficulty: 0.7, estimatedTime: 120, bloomsLevel: 'apply' },
        { id: 'item3', conceptId: 'concept3', topic: 'Biology', difficulty: 0.1, estimatedTime: 60, bloomsLevel: 'remember' }
      ]

      const speedPath = personalizedSequencing.generateLearningPath(speedFocusedContext, availableItems, mockKnowledgeGraph)
      const engagementPath = personalizedSequencing.generateLearningPath(engagementFocusedContext, availableItems, mockKnowledgeGraph)

      expect(speedPath.difficultyProgression.trend).toBe('ascending')
      expect(engagementPath.difficultyProgression.variability).toBeGreaterThan(speedPath.difficultyProgression.variability)
    })
  })
  ...
  describe('Real-time Adaptation', () => {
    test('should adapt sequence based on performance feedback', () => {
      ...
      const currentSequence = [
        { id: 'item1', conceptId: 'DNA_structure', topic: 'Genetics', difficulty: 0.5, estimatedTime: 120, bloomsLevel: 'understand' },
        { id: 'item2', conceptId: 'DNA_replication', topic: 'Genetics', difficulty: 0.8, estimatedTime: 150, bloomsLevel: 'apply' },
        { id: 'item3', conceptId: 'transcription', topic: 'Genetics', difficulty: 0.6, estimatedTime: 140, bloomsLevel: 'apply' }
      ]
      ...
      expect(adaptedSequence.modifications.some(mod => mod.type === 'insert_remediation')).toBe(true)

      // Should adjust difficulty for next items
      expect(adaptedSequence.modifications.some(mod => mod.type === 'difficulty_adjustment')).toBe(true)
    })
    ...
    test('should handle consecutive incorrect responses', () => {
      ...
      const currentSequence = [
        { id: 'item1', conceptId: 'concept1', topic: 'Biology', difficulty: 0.6, estimatedTime: 120, bloomsLevel: 'apply' },
        { id: 'item2', conceptId: 'concept2', topic: 'Biology', difficulty: 0.8, estimatedTime: 150, bloomsLevel: 'analyze' }
      ]
      ...
      expect(adaptations.interventions.some(int => int.type === 'difficulty_reduction')).toBe(true)
  ...
  describe('Content Variety and Balancing', () => {
    test('should maintain content variety across topics', () => {
      const availableItems = [
        { id: 'cell1', conceptId: 'concept1', topic: 'Cell Biology', difficulty: 0.2, estimatedTime: 90, bloomsLevel: 'understand' },
        { id: 'cell2', conceptId: 'concept2', topic: 'Cell Biology', difficulty: 0.3, estimatedTime: 100, bloomsLevel: 'apply' },
        { id: 'gene1', conceptId: 'concept3', topic: 'Genetics', difficulty: 0.1, estimatedTime: 80, bloomsLevel: 'remember' },
        { id: 'gene2', conceptId: 'concept4', topic: 'Genetics', difficulty: 0.4, estimatedTime: 110, bloomsLevel: 'analyze' },
        { id: 'evo1', conceptId: 'concept5', topic: 'Evolution', difficulty: 0.2, estimatedTime: 95, bloomsLevel: 'understand' },
        { id: 'eco1', conceptId: 'concept6', topic: 'Ecology', difficulty: 0.3, estimatedTime: 105, bloomsLevel: 'apply' }
      ]
    ...
    test('should balance Bloom\'s taxonomy levels', () => {
      const availableItems = Array(12).fill(null).map((_, i) => ({
        id: `item${i}`,
        conceptId: `concept${i}`,
        topic: 'Biology',
        difficulty: i * 0.1,
      ...
      const bloomsDistribution = sequence.sequence.reduce((acc, item) => {
  ...
  describe('Performance and Efficiency', () => {
    test('should handle large item banks efficiently', () => {
      const largeItemBank = Array(500).fill(null).map((_, i) => ({
        id: `item_${i}`,
    ...
    test('should cache and reuse optimization results', () => {
      const availableItems = [
        { id: 'item1', conceptId: 'concept1', topic: 'Biology', difficulty: 0.2, estimatedTime: 90, bloomsLevel: 'understand' },
        { id: 'item2', conceptId: 'concept2', topic: 'Biology', difficulty: 0.4, estimatedTime: 110, bloomsLevel: 'apply' }
      ]

      // First call
      const startTime1 = Date.now()
      const path1 = personalizedSequencing.generateLearningPath(mockContext, availableItems, mockKnowledgeGraph)
      const time1 = Date.now() - startTime1

      // Second call with same parameters (should use cache)
      const startTime2 = Date.now()
      const path2 = personalizedSequencing.generateLearningPath(mockContext, availableItems, mockKnowledgeGraph)
...
describe('Personalized Sequencing Integration Tests', () => {
  test('should work end-to-end with realistic data', () => {
    const realisticContext: SequencingContext = {
      ...
      performanceHistory: [
        { topic: 'Cell Biology', accuracy: 0.75, averageTime: 95, masteryLevel: 0.8, lastAttempt: new Date(Date.now() - 86400000) },
        { topic: 'Genetics', accuracy: 0.55, averageTime: 140, masteryLevel: 0.4, lastAttempt: new Date(Date.now() - 172800000) },
        { topic: 'Evolution', accuracy: 0.85, averageTime: 80, masteryLevel: 0.9, lastAttempt: new Date(Date.now() - 259200000) },
        { topic: 'Ecology', accuracy: 0.35, averageTime: 160, masteryLevel: 0.2, lastAttempt: new Date(Date.now() - 345600000) }
      ],
      preferences: {
        difficultyProgression: 'gradual',
        contentMixing: 'balanced',
    ...
    const realisticItems = [
      ...
      { id: 'cell_01', conceptId: 'cell_membrane', topic: 'Cell Biology', difficulty: 0.1, estimatedTime: 90, bloomsLevel: 'understand' },
      { id: 'cell_02', conceptId: 'organelles', topic: 'Cell Biology', difficulty: 0.3, estimatedTime: 110, bloomsLevel: 'apply' },

      // Genetics items (student weakness)
      { id: 'gene_01', conceptId: 'dna_structure', topic: 'Genetics', difficulty: 0.0, estimatedTime: 100, bloomsLevel: 'remember' },
      { id: 'gene_02', conceptId: 'genetic_crosses', topic: 'Genetics', difficulty: 0.4, estimatedTime: 130, bloomsLevel: 'apply' },
      { id: 'gene_03', conceptId: 'inheritance', topic: 'Genetics', difficulty: 0.2, estimatedTime: 120, bloomsLevel: 'understand' },

      // Evolution items (student mastery)
      { id: 'evo_01', conceptId: 'natural_selection', topic: 'Evolution', difficulty: 0.5, estimatedTime: 100, bloomsLevel: 'analyze' },

      // Ecology items (major weakness)
      { id: 'eco_01', conceptId: 'ecosystem_basics', topic: 'Ecology', difficulty: -0.2, estimatedTime: 90, bloomsLevel: 'remember' },
      { id: 'eco_02', conceptId: 'food_webs', topic: 'Ecology', difficulty: 0.1, estimatedTime: 110, bloomsLevel: 'understand' },
      { id: 'eco_03', conceptId: 'ecosystem_dynamics', topic: 'Ecology', difficulty: 0.3, estimatedTime: 140, bloomsLevel: 'apply' }
    ]
    ...
    expect(learningPath.totalEstimatedTime).toBeLessThanOrEqual(realisticContext.timeConstraints.timeRemaining)

    // Should prioritize weaknesses (Genetics and Ecology)
    const weaknessItems = learningPath.sequence.filter(item =>
      item.topic === 'Genetics' || item.topic === 'Ecology'
    )
    expect(weaknessItems.length).toBeGreaterThan(learningPath.sequence.length * 0.4)

    // Should include some strength reinforcement
    const strengthItems = learningPath.sequence.filter(item =>
      item.topic === 'Cell Biology' || item.topic === 'Evolution'
    )
