...
export const testimonialVideos: VideoData[] = [
  {
    ...
    description:
      "Sadhna Sirin shares her journey to scoring 695/720 in NEET 2023 with 100 percentile in Biology. Learn how Cerebrum Biology Academy's teaching methodology helped her achieve this remarkable score.",
  ...
  },
  {
    ...
    description:
      'Rahul Sharma talks about his NEET preparation journey at Cerebrum Biology Academy and how he secured admission to Maulana Azad Medical College, Delhi.',
  ...
  },
  {
    ...
    description:
      "Priya Gupta shares how she improved her NEET score from 450 to 665 in just one year with Cerebrum's dropper batch and secured JIPMER Puducherry.",
  ...
  },
  {
    ...
    description:
      'Parents share their experience with Cerebrum Biology Academy - from small batch sizes to personalized attention and consistent communication about student progress.',
