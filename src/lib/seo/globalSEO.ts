...
export class GlobalSEOService {
  ...
  generateCoursePageSEO(courseData: CoursePageSEO): SEOData {
    ...
    const description = `🏆 #1 ${className} ${subject} online coaching for ${targetExam}. Expert AIIMS faculty, 98% success rate, live classes. Join 15,000+ students. Free demo available!`
