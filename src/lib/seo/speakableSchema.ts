...
export const speakablePages = {
  home: {
    ...
    description: "Cerebrum Biology Academy offers top NEET Biology coaching with 98% success rate. AIIMS faculty, small batches, 5 centers in Delhi NCR.",
  ...
  courses: {
    ...
    description: "Comprehensive NEET Biology courses for Class 9, 10, 11, 12 and droppers. Foundation to advanced programs with expert faculty.",
  ...
  faculty: {
    ...
    description: "Learn from Dr. Shekhar C Singh, AIIMS alumnus with 14+ years experience and our team of expert Biology teachers.",
    url: "https://cerebrumbiologyacademy.com/faculty",
    speakableSections: [
      ".faculty-intro",
      ".faculty-credentials"
  ...
  results: {
    ...
    description: "Our students scored up to 695/720 in NEET 2023. 500+ medical college selections including AIIMS, JIPMER, and state medical colleges.",
...
export const voiceOptimizedFAQs = [
  {
    ...
    answer: "Cerebrum Biology Academy has a 98% NEET qualification rate. In NEET 2023, our top student Sadhna Sirin scored 695 out of 720, achieving 100 percentile in Biology."
  },
  {
    question: "Who teaches at Cerebrum Biology Academy?",
    answer: "The academy is led by Dr. Shekhar C Singh, an AIIMS New Delhi alumnus with 14 years of teaching experience. Our faculty includes PhD holders and medical doctors."
  },
  {
    question: "What is the fee for NEET Biology coaching?",
    answer: "Course fees range from 58,000 rupees for foundation courses to 78,000 rupees for NEET crash courses. We offer installment options and scholarships for deserving students."
  },
  {
    question: "Where is Cerebrum Biology Academy located?",
    answer: "We have 5 centers in Delhi NCR: South Extension, Rohini, Gurugram, Green Park, and Faridabad. We also offer online classes for students outside Delhi."
  },
  {
    question: "Is there a free demo class available?",
    answer: "Yes, we offer free demo classes every week. You can book a slot through our website or WhatsApp to experience our teaching methodology before enrolling."
  },
  {
    question: "What is the batch size at Cerebrum Biology Academy?",
    answer: "We maintain a maximum batch size of 25 students to ensure personal attention and effective doubt resolution for every student."
  },
  {
    question: "Does Cerebrum Biology Academy offer online classes?",
    answer: "Yes, we offer live online classes with weekend batches for students outside Delhi NCR. Online courses include recorded lectures, live doubt sessions, and online tests."
  },
  {
    question: "What is the best time to start NEET preparation?",
    answer: "We recommend starting in Class 11 for comprehensive 2-year preparation. However, our foundation courses for Class 9-10 help build strong fundamentals early."
  }
];
