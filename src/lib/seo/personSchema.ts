...
export const facultyMembers: FacultyData[] = [
  {
    ...
    description: "Dr. Shekhar C Singh is the founder of Cerebrum Biology Academy and has 14+ years of experience in NEET Biology coaching. An AIIMS New Delhi alumnus, he has helped over 500 students secure admissions to top medical colleges including AIIMS, JIPMER, and state medical colleges. His 'Concept-First Approach' has revolutionized Biology teaching for NEET preparation.",
  ...
  },
  {
    ...
    description: "Dr. Priya Sharma is a Botany specialist with a PhD from Jawaharlal Nehru University. With 8 years of teaching experience, she specializes in Plant Physiology, Ecology, and Plant Diversity. Her research background brings depth to NEET Biology preparation.",
  ...
  },
  {
    ...
    description: "Dr. Amit Kumar brings a unique medical perspective to NEET Biology teaching. With an MBBS from Maulana Azad Medical College and MD in Physiology from Lady Hardinge Medical College, he makes complex Human Physiology topics easy to understand.",
