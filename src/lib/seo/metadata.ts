...
export const pageMetadata: Record<string, PageMetadata> = {
  ...
  bookDemo: {
    title: 'Book Free Biology Demo Class | WhatsApp Booking | Cerebrum Academy',
    description:
      'Book a free Biology demo class — Class 9–12, NEET droppers, Boards, Olympiad. Online + offline (South Delhi · Gurugram · Faridabad). AIIMS-trained faculty. WhatsApp confirmation in 15 minutes.',
    keywords: [
      'book free biology demo class',
      'free demo class NEET biology',
      'free biology class class 11',
      'free biology class class 12',
      'free NEET dropper demo class',
      'free olympiad biology demo class',
      'biology demo class online',
      'biology demo class Delhi NCR',
      'biology demo class near me',
