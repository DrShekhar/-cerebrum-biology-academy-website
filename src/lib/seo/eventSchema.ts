...
export const upcomingEvents: EventData[] = [
  {
    ...
    description: "Experience Dr. Shekhar Singh's teaching methodology in this free demo class. Topic: Human Physiology - Cardiovascular System. Limited seats available.",
  ...
  },
  {
    ...
    description: "Intensive 4-month NEET Biology preparation with 200+ hours of live classes. Join our proven crash course that has produced 100 percentile scorers.",
  ...
  },
  {
    ...
    description: "Perfect for students outside Delhi NCR. Live interactive online classes every Saturday and Sunday with recorded backup.",
  ...
  },
  {
    ...
    description: "Start your 2-year NEET journey early. Integrated program covering Class 11 boards and NEET Biology simultaneously.",
  ...
  },
  {
    ...
    description: "One-on-one counseling with our academic team. Discuss course options, study plans, and get your queries answered. No obligation to enroll.",
 ...
 */
export function generateCustomEventSchema(eventData: Partial<EventData> & { name: string; startDate: string; url: string }) {
  const defaultEvent: EventData = {
    name: eventData.name,
    description: eventData.description || `Join us for ${eventData.name} at Cerebrum Biology Academy`,
