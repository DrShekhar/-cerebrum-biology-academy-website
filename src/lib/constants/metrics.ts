...
export const NOIDA_AREA_COORDINATES: Record<string, { lat: number; lng: number }> = {
  'sector-18': { lat: 28.5685, lng: 77.321 },
  'sector-62': { lat: 28.628, lng: 77.3649 },
  'sector-15': { lat: 28.58, lng: 77.31 },
  'sector-16': { lat: 28.572, lng: 77.315 },
  'sector-44': { lat: 28.575, lng: 77.35 },
  'sector-50': { lat: 28.59, lng: 77.34 },
  'sector-76': { lat: 28.62, lng: 77.38 },
  'sector-77': { lat: 28.625, lng: 77.385 },
  'sector-78': { lat: 28.63, lng: 77.39 },
  'sector-137': { lat: 28.51, lng: 77.36 },
  'sector-135': { lat: 28.52, lng: 77.355 },
  'sector-128': { lat: 28.535, lng: 77.365 },
  'sector-126': { lat: 28.54, lng: 77.36 },
  'sector-120': { lat: 28.55, lng: 77.37 },
  'sector-100': { lat: 28.56, lng: 77.375 },
  'sector-104': { lat: 28.545, lng: 77.368 },
  'sector-37': { lat: 28.565, lng: 77.335 },
  'sector-41': { lat: 28.57, lng: 77.345 },
  'sector-39': { lat: 28.568, lng: 77.34 },
  'sector-63': { lat: 28.63, lng: 77.37 },
  'sector-71': { lat: 28.615, lng: 77.375 },
  'sector-72': { lat: 28.61, lng: 77.378 },
  'sector-73': { lat: 28.608, lng: 77.38 },
  'noida-extension': { lat: 28.5, lng: 77.39 },
  'greater-noida-west': { lat: 28.47, lng: 77.42 },
  'knowledge-park': { lat: 28.455, lng: 77.51 },
  'pari-chowk': { lat: 28.46, lng: 77.5 },
  alpha: { lat: 28.47, lng: 77.49 },
  beta: { lat: 28.465, lng: 77.485 },
  gamma: { lat: 28.46, lng: 77.48 },
  'gaur-city': { lat: 28.48, lng: 77.41 },
  'jaypee-greens': { lat: 28.45, lng: 77.52 },
  'techzone-4': { lat: 28.49, lng: 77.4 },
  surajpur: { lat: 28.44, lng: 77.495 },
  kasna: { lat: 28.435, lng: 77.505 },
  omicron: { lat: 28.47, lng: 77.475 },
  'sector-12': { lat: 28.585, lng: 77.305 },
  'sector-25': { lat: 28.578, lng: 77.328 },
  'film-city': { lat: 28.576, lng: 77.318 },
  'atta-market': { lat: 28.569, lng: 77.322 },
}
...
export const GHAZIABAD_AREA_COORDINATES: Record<string, { lat: number; lng: number }> = {
  indirapuram: { lat: 28.641, lng: 77.358 },
  vaishali: { lat: 28.642, lng: 77.338 },
  kaushambi: { lat: 28.645, lng: 77.325 },
  'raj-nagar-extension': { lat: 28.72, lng: 77.45 },
  'crossings-republik': { lat: 28.66, lng: 77.43 },
  vasundhara: { lat: 28.66, lng: 77.365 },
  'lal-kuan': { lat: 28.68, lng: 77.41 },
  'mohan-nagar': { lat: 28.665, lng: 77.42 },
  sahibabad: { lat: 28.675, lng: 77.38 },
  'raj-nagar': { lat: 28.67, lng: 77.435 },
  'wave-city': { lat: 28.71, lng: 77.46 },
  arthala: { lat: 28.67, lng: 77.4 },
  govindpuram: { lat: 28.69, lng: 77.44 },
  'siddharth-vihar': { lat: 28.655, lng: 77.415 },
  'pratap-vihar': { lat: 28.65, lng: 77.405 },
  'nehru-nagar': { lat: 28.668, lng: 77.41 },
  'vijay-nagar': { lat: 28.663, lng: 77.415 },
  nandgram: { lat: 28.685, lng: 77.425 },
}
...
export const GURUGRAM_CENTER_METRICS = {
  ...
  coverageRadiusKm: 20,
  nearbyLandmark: 'Mayfield Garden, near Sector 55-56 Rapid Metro',
