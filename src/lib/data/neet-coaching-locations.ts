...
const delhiNCRLocations: NEETCoachingLocation[] = [
  // Dwarka areas
  {
    ...
    description:
      'Top NEET biology coaching for Dwarka students. AIIMS trained faculty, 98% success rate. Online + Offline classes. Book free demo!',
    heroColor: 'blue',
    studentCount: '500+',
    successRate: '98%',
    topScore: '672',
    localities: [
      {
        ...
        students: '50+',
        highlight: 'Near Dwarka Mor Metro',
        priority: 'high',
      },
      {
        ...
        students: '45+',
        highlight: 'Near Dwarka Sector 9 Metro',
        priority: 'high',
      },
      {
        ...
        students: '60+',
        highlight: 'Direct Blue Line Access',
        priority: 'high',
      },
      {
        ...
        students: '40+',
        highlight: 'Near Dwarka Sector 14 Metro',
        priority: 'medium',
      },
      {
      ...
      },
      {
        ...
        students: '35+',
        highlight: 'Near Dwarka Sector 21 Metro',
        priority: 'medium',
      },
    ],
    schools: [
  ...
  },
  {
    ...
    localities: [
      ...
      },
      {
        ...
        students: '150+',
        highlight: 'Near Rohini West Metro',
        priority: 'high',
      },
      {
        name: 'Sector 9',
  ...
  // More Delhi areas...
  {
    ...
    description:
      'Top NEET biology coaching for Greater Kailash students. AIIMS trained faculty, 98% success rate. Online + Offline.',
    heroColor: 'purple',
    studentCount: '200+',
    successRate: '98%',
    topScore: '668',
...
const gurgaonLocations: NEETCoachingLocation[] = [
  {
    ...
    description:
      'Top NEET biology coaching in Gurgaon. AIIMS trained faculty, proven 98% success rate. Online classes available.',
    heroColor: 'teal',
    studentCount: '800+',
    successRate: '98%',
    topScore: '685',
    localities: [
      ...
      },
      {
        ...
        students: '75+',
        highlight: 'Leisure Valley',
        priority: 'high',
      },
      {
        name: 'DLF Phase 1',
        slug: 'dlf-phase-1-gurugram',
        students: '90+',
  ...
  // Gurgaon sector pages REMOVED (2026-04-23).
  // 30 thin-template sector pages were in the GSC "Crawled — not indexed"
  // bucket. Google correctly rejected them as near-duplicate doorways.
  // Replaced by 301 redirects `/neet-coaching/gurgaon-sector-N` →
  // `/neet-coaching-gurugram` in src/config/seo-redirects.mjs.
]
...
const noidaLocations: NEETCoachingLocation[] = [
  {
    ...
    description:
      'Top NEET biology coaching in Noida. AIIMS trained faculty, 98% success rate. Online + Offline classes.',
    heroColor: 'indigo',
    studentCount: '600+',
    successRate: '98%',
    topScore: '678',
...
const majorCityLocations: NEETCoachingLocation[] = [
  {
    ...
    description:
      'Top NEET biology coaching for Bangalore students. AIIMS trained faculty, 98% success rate. Join online!',
    heroColor: 'purple',
    studentCount: '400+',
    successRate: '98%',
    topScore: '665',
  ...
  },
  {
    ...
    description:
      'Top NEET biology coaching for Chennai students. AIIMS trained faculty, 98% success rate.',
    heroColor: 'teal',
    studentCount: '350+',
    successRate: '98%',
    topScore: '660',
  ...
  },
  {
    ...
    description:
      'Top NEET biology coaching for Hyderabad students. AIIMS trained faculty, 98% success rate.',
    heroColor: 'blue',
    studentCount: '450+',
    successRate: '98%',
    topScore: '668',
  ...
  },
  {
    ...
    description:
      'Top NEET biology coaching for Mumbai students. AIIMS trained faculty, 98% success rate.',
    heroColor: 'indigo',
    studentCount: '500+',
    successRate: '98%',
    topScore: '675',
  ...
  },
  {
    ...
    description:
      'Top NEET biology coaching for Pune students. AIIMS trained faculty, 98% success rate.',
    heroColor: 'green',
    studentCount: '300+',
    successRate: '98%',
    topScore: '662',
  ...
  },
  {
    ...
    description:
      'Top NEET biology coaching for Kolkata students. AIIMS trained faculty, 98% success rate.',
    heroColor: 'purple',
    studentCount: '280+',
    successRate: '98%',
    topScore: '658',
  ...
  },
  {
    ...
    description:
      'Top NEET biology coaching for Ahmedabad students. AIIMS trained faculty, 98% success rate.',
    heroColor: 'teal',
    studentCount: '250+',
    successRate: '98%',
    topScore: '655',
  ...
  },
  {
    ...
    description:
      'Top NEET biology coaching for Jaipur students. AIIMS trained faculty, 98% success rate.',
    heroColor: 'blue',
    studentCount: '350+',
    successRate: '98%',
    topScore: '670',
  ...
  },
  {
    ...
    description:
      'Top NEET biology coaching for Lucknow students. AIIMS trained faculty, 98% success rate.',
    heroColor: 'indigo',
    studentCount: '400+',
    successRate: '98%',
    topScore: '672',
  ...
  },
  {
    ...
    description:
      'Top NEET biology coaching for Agra students. AIIMS trained faculty, 98% success rate. City of Taj!',
    heroColor: 'teal',
    studentCount: '200+',
    successRate: '98%',
    topScore: '665',
  ...
  },
  {
    ...
    description:
      'Top NEET biology coaching for Chandigarh students. AIIMS trained faculty, 98% success rate.',
    heroColor: 'green',
    studentCount: '300+',
    successRate: '98%',
    topScore: '675',
    localities: [
      ...
      {
        name: 'Sector 34',
        slug: 'chandigarh-sector-34',
        students: '50+',
        highlight: 'Educational Area',
        priority: 'high',
      },
    ],
