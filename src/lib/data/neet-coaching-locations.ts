...
const delhiNCRLocations: NEETCoachingLocation[] = [
  // Dwarka areas
  {
    ...
    description: 'Top NEET biology coaching for Dwarka students. AIIMS trained faculty, 94% success rate. Online + Offline classes. Book free demo!',
    heroColor: 'blue',
    studentCount: '500+',
    successRate: '94%',
    topScore: '672',
  ...
  },
  {
    ...
    description: 'Premier NEET biology coaching in Rohini DC Chauk. AIIMS trained faculty, small batches, 94% success rate. Join now!',
    heroColor: 'green',
    studentCount: '1500+',
    successRate: '94%',
    topScore: '695',
  ...
  // More Delhi areas...
  {
    ...
    description: 'Top NEET biology coaching for Greater Kailash students. AIIMS trained faculty, 94% success rate. Online + Offline.',
    heroColor: 'purple',
    studentCount: '200+',
    successRate: '94%',
    topScore: '668',
...
const gurgaonLocations: NEETCoachingLocation[] = [
  {
    ...
    description: 'Top NEET biology coaching in Gurgaon. AIIMS trained faculty, proven 94% success rate. Online classes available.',
    heroColor: 'teal',
    studentCount: '800+',
    successRate: '94%',
    topScore: '685',
...
const noidaLocations: NEETCoachingLocation[] = [
  {
    ...
    description: 'Top NEET biology coaching in Noida. AIIMS trained faculty, 94% success rate. Online + Offline classes.',
    heroColor: 'indigo',
    studentCount: '600+',
    successRate: '94%',
    topScore: '678',
...
const majorCityLocations: NEETCoachingLocation[] = [
  {
    ...
    description: 'Top NEET biology coaching for Bangalore students. AIIMS trained faculty, 94% success rate. Join online!',
    heroColor: 'purple',
    studentCount: '400+',
    successRate: '94%',
    topScore: '665',
  ...
  },
  {
    ...
    description: 'Top NEET biology coaching for Chennai students. AIIMS trained faculty, 94% success rate.',
    heroColor: 'teal',
    studentCount: '350+',
    successRate: '94%',
    topScore: '660',
  ...
  },
  {
    ...
    description: 'Top NEET biology coaching for Hyderabad students. AIIMS trained faculty, 94% success rate.',
    heroColor: 'blue',
    studentCount: '450+',
    successRate: '94%',
    topScore: '668',
  ...
  },
  {
    ...
    description: 'Top NEET biology coaching for Mumbai students. AIIMS trained faculty, 94% success rate.',
    heroColor: 'indigo',
    studentCount: '500+',
    successRate: '94%',
    topScore: '675',
  ...
  },
  {
    ...
    description: 'Top NEET biology coaching for Pune students. AIIMS trained faculty, 94% success rate.',
    heroColor: 'green',
    studentCount: '300+',
    successRate: '94%',
    topScore: '662',
  ...
  },
  {
    ...
    description: 'Top NEET biology coaching for Kolkata students. AIIMS trained faculty, 94% success rate.',
    heroColor: 'purple',
    studentCount: '280+',
    successRate: '94%',
    topScore: '658',
  ...
  },
  {
    ...
    description: 'Top NEET biology coaching for Ahmedabad students. AIIMS trained faculty, 94% success rate.',
    heroColor: 'teal',
    studentCount: '250+',
    successRate: '94%',
    topScore: '655',
  ...
  },
  {
    ...
    description: 'Top NEET biology coaching for Jaipur students. AIIMS trained faculty, 94% success rate.',
    heroColor: 'blue',
    studentCount: '350+',
    successRate: '94%',
    topScore: '670',
  ...
  },
  {
    ...
    description: 'Top NEET biology coaching for Lucknow students. AIIMS trained faculty, 94% success rate.',
    heroColor: 'indigo',
    studentCount: '400+',
    successRate: '94%',
    topScore: '672',
  ...
  },
  {
    ...
    description: 'Top NEET biology coaching for Agra students. AIIMS trained faculty, 94% success rate. City of Taj!',
    heroColor: 'teal',
    studentCount: '200+',
    successRate: '94%',
    topScore: '665',
  ...
  },
  {
    ...
    description: 'Top NEET biology coaching for Chandigarh students. AIIMS trained faculty, 94% success rate.',
    heroColor: 'green',
    studentCount: '300+',
    successRate: '94%',
    topScore: '675',
