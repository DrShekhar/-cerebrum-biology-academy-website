...
// TODO: Install pdf.js-extract package to enable PDF processing
// npm install pdf.js-extract
// import { PDFExtract } from 'pdf.js-extract'

// Placeholder type until pdf.js-extract is installed
class PDFExtract {
  extract(path: string): Promise<any> {
    throw new Error('pdf.js-extract is not installed. Please run: npm install pdf.js-extract')
  }
}
