  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <div className="bg-slate-900 rounded-2xl shadow-2xl max-w-full sm:max-w-2xl lg:max-w-4xl xl:max-w-5xl w-full max-h-[90vh] overflow-hidden border border-slate-700 animate-fadeInUp">
          {/* Header */}
          ...
          <div className="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
            ...
            {currentStep === 0 && (
              <div key="safety-stats" className="space-y-6 animate-fadeInUp">
            ...
            {currentStep === 1 && (
              <div key="faculty-credentials" className="space-y-6 animate-fadeInUp">
                <div className="text-center mb-8">
            ...
            {currentStep === 2 && (
              <div key="fee-transparency" className="space-y-6 animate-fadeInUp">
                <div className="text-center mb-8">
            ...
            {/* Step 3: EMI Options */}
            {currentStep === 3 && (
              <div key="emi-options" className="space-y-6 animate-fadeInUp">
                <div className="text-center mb-8">
            ...
            {currentStep === 4 && (
              <div key="direct-contact" className="space-y-6 animate-fadeInUp">
                <div className="text-center mb-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-slate-800 rounded-xl p-6 border border-slate-700">
                    ...
                    <p className="text-gray-300 mb-4">
                      Speak with our parent counselors who understand your concerns and can provide
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="text-center text-sm text-gray-400">Available: 24/7</div>
                    </div>
                  </div>
            ...
            {currentStep === 5 && (
              <div key="visit-center" className="space-y-6 animate-fadeInUp">
                <div className="text-center mb-8">
