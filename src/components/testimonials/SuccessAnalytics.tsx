...
export function SuccessAnalytics({ data }: SuccessAnalyticsProps) {
  ...
  const tabs = [
    ...
    { id: 'subjects' as const, label: 'Subject Analysis', icon: BookOpen },
    { id: 'batches' as const, label: 'Batch Performance', icon: Users },
    { id: 'colleges' as const, label: 'College Admissions', icon: Award },
  ]
