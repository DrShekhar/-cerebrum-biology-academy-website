...
const AdaptiveTestResults: React.FC<AdaptiveTestResultsProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      {/* Score Overview */}
      <div className="bg-white rounded-xl border-2 border-gray-200 p-8 animate-fadeInUp">
      ...
      <div className="bg-white rounded-xl border">
        ...
        <div className="p-6">
          {activeTab === 'overview' && (
            <div key="overview" className="space-y-6 animate-fadeInUp">
              {/* Topic Scores */}
                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    <div className="text-sm text-gray-600">
                      ...
                      {results.diagnostics.algorithmPerformance.convergence
                        ? 'converged'
                        : 'processed'}{' '}
                      your ability estimate in {results.diagnostics.algorithmPerformance.iterations}{' '}
                      iterations with a final standard error of{' '}
                      {results.diagnostics.algorithmPerformance.finalSE}.
                    </div>
                  </div>
                )}
          ...
          {activeTab === 'adaptations' && (
            <div key="adaptations" className="space-y-6 animate-fadeInUp">
              {/* Adaptation Summary */}
          ...
          {activeTab === 'gaps' && (
            <div key="gaps" className="space-y-6 animate-fadeInUp">
              {/* Gap Summary */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
