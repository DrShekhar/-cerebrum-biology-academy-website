...
export function ViewAnalytics({ isOpen, onClose }: ViewAnalyticsProps) {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'performance' | 'trends' | 'realtime'>('overview')
  ...
  const mockAnalyticsData: AnalyticsData = {
    ...
    performance: {
      subjectWise: [
        { subject: 'Cell Biology', averageScore: 82.1, completionRate: 91.5, studentsCount: 1245, difficulty: 'Medium' },
        { subject: 'Genetics', averageScore: 75.8, completionRate: 87.3, studentsCount: 1156, difficulty: 'Hard' },
        { subject: 'Ecology', averageScore: 84.2, completionRate: 93.1, studentsCount: 987, difficulty: 'Easy' },
        { subject: 'Human Physiology', averageScore: 79.4, completionRate: 88.7, studentsCount: 1398, difficulty: 'Medium' },
        { subject: 'Plant Biology', averageScore: 81.6, completionRate: 90.2, studentsCount: 876, difficulty: 'Medium' }
      ],
      difficultyWise: [
    ...
    trends: {
      ...
      topPerformers: [
        { studentName: 'Arjun Sharma', averageScore: 94.5, testsCompleted: 23, rank: 1, improvement: 12.3 },
        { studentName: 'Priya Patel', averageScore: 92.8, testsCompleted: 21, rank: 2, improvement: 8.7 },
        { studentName: 'Rahul Kumar', averageScore: 91.2, testsCompleted: 25, rank: 3, improvement: 15.2 },
        { studentName: 'Sneha Reddy', averageScore: 89.6, testsCompleted: 19, rank: 4, improvement: 9.8 },
        { studentName: 'Amit Singh', averageScore: 88.9, testsCompleted: 22, rank: 5, improvement: 6.4 }
      ],
      strugglingAreas: [
        { topic: 'Photosynthesis Reactions', averageScore: 64.2, attemptCount: 1245, difficultyLevel: 85 },
        ...
        { topic: 'Respiration Pathways', averageScore: 71.3, attemptCount: 1123, difficultyLevel: 75 }
      ]
    },
    realTime: {
      activeNow: 142,
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-3xl font-bold text-blue-600">{analyticsData.overview.totalTests}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-xl p-6 border border-green-200">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-3xl font-bold text-green-600">{analyticsData.overview.totalStudents}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl p-6 border border-purple-200">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-3xl font-bold text-purple-600">{analyticsData.overview.averageScore}%</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl p-6 border border-orange-200">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-3xl font-bold text-orange-600">{analyticsData.overview.completionRate}%</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-teal-50 to-teal-100 rounded-xl p-6 border border-teal-200">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-3xl font-bold text-teal-600">{analyticsData.overview.totalAttempts}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-indigo-50 to-indigo-100 rounded-xl p-6 border border-indigo-200">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-3xl font-bold text-indigo-600">{analyticsData.overview.activeStudents}</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {activeTab === 'performance' && (
                <div className="space-y-6">
                      ...
                      <table className="w-full">
                        <thead>
                          <tr className="border-b border-gray-200">
                            <th className="text-left py-2 px-4 font-medium text-gray-600">Subject</th>
                            <th className="text-left py-2 px-4 font-medium text-gray-600">Avg Score</th>
                            <th className="text-left py-2 px-4 font-medium text-gray-600">Completion</th>
                            <th className="text-left py-2 px-4 font-medium text-gray-600">Students</th>
                            <th className="text-left py-2 px-4 font-medium text-gray-600">Difficulty</th>
                          </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr key={index} className="border-b border-gray-100">
                              ...
                              <td className="py-3 px-4">
                                <span className={`px-2 py-1 rounded text-sm font-medium ${
                                  ...
                                  subject.averageScore >= 70 ? 'bg-yellow-100 text-yellow-700' :
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                      <h3 className="text-lg font-semibold text-gray-800 mb-4">Difficulty-wise Analysis</h3>
                        ...
                        {analyticsData.performance.difficultyWise.map((item, index) => (
                          <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            ...
                            <div className="text-right">
                              ...
                              <p className="text-sm text-gray-600">{item.completionRate}% completion</p>
                            </div>
                          </div>
                        ))}
                      </div>
                        ...
                        <div key={index} className="flex items-center justify-between p-4 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg border border-yellow-200">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">{student.testsCompleted} tests completed</p>
                            </div>
                          </div>
                          <div className="text-right">
                            <p className="font-bold text-yellow-600">{student.averageScore}%</p>
                            <p className="text-sm text-green-600">+{student.improvement}% improvement</p>
                          </div>
                        </div>
                      ))}
                    </div>
                      ...
                      {analyticsData.trends.strugglingAreas.map((area, index) => (
                        <div key={index} className="flex items-center justify-between p-4 bg-red-50 rounded-lg border border-red-200">
                          ...
                          <div className="text-right">
                            ...
                            <p className="text-sm text-gray-600">Difficulty: {area.difficultyLevel}%</p>
                          </div>
                        </div>
                      ))}
                    </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-xl p-4 border border-green-200">
                      ...
                      <p className="text-2xl font-bold text-green-600 mt-1">{analyticsData.realTime.todaysStats.testsCompleted}</p>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-4 border border-blue-200">
                      ...
                      <p className="text-2xl font-bold text-blue-600 mt-1">{analyticsData.realTime.todaysStats.newSignups}</p>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl p-4 border border-purple-200">
                      ...
                      <p className="text-2xl font-bold text-purple-600 mt-1">{analyticsData.realTime.todaysStats.averageScore}%</p>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl p-4 border border-orange-200">
                      ...
                      <p className="text-2xl font-bold text-orange-600 mt-1">{analyticsData.realTime.todaysStats.totalTimeSpent}h</p>
                    </div>
                  </div>
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                          ...
                          <span className="font-bold text-green-600">{analyticsData.realTime.activeNow}</span>
                        </div>
                        <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                          <span className="text-gray-700">Tests in Progress</span>
                          <span className="font-bold text-blue-600">{analyticsData.realTime.testsInProgress}</span>
                        </div>
                      </div>
                    </div>
