...
export function QuestionProperties({
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-lg">
      ...
      <div className="p-6">
        {activeTab === 'basic' && (
          <div key="basic" className="space-y-6 animate-fadeInUp">
            {/* Difficulty Level */}
            <div>
        ...
        {activeTab === 'taxonomy' && (
          <div key="taxonomy" className="space-y-6 animate-fadeInUp">
        ...
        {activeTab === 'content' && (
          <div key="content" className="space-y-6 animate-fadeInUp">
            {/* Solution */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
        ...
        {activeTab === 'metadata' && (
          <div key="metadata" className="space-y-6 animate-fadeInUp">
            {/* Quality Metrics */}
              ...
              <div className="space-y-2 text-sm text-gray-600">
                ...
                {properties.reliability_coefficient < 0.8 && (
                  <div className="flex items-start space-x-2">
                    <div className="w-1.5 h-1.5 bg-yellow-500 rounded-full mt-2 flex-shrink-0"></div>
                    <span>
                      Add more specific details or clarify the question stem to improve consistency.
                    </span>
                  </div>
                )}
                ...
                {properties.discrimination_index >= 0.3 &&
                  properties.reliability_coefficient >= 0.8 && (
                    <div className="flex items-start space-x-2">
                      ...
                      <span>
                        Excellent question quality! This question effectively distinguishes student
                        ability levels.
                      </span>
                    </div>
                  )}
