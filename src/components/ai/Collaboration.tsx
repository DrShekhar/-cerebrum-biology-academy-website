              ...
              >
                <div className="flex items-start gap-3">
                  <div className="relative">
                    ...
                    <div
                      className={`absolute -bottom-1 -right-1 w-4 h-4 bg-${getStatusColor(user.status)}-500 border-2 border-white rounded-full`}
                    />
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      <span
                        className={`px-2 py-1 rounded text-xs font-medium capitalize bg-${getStatusColor(user.role)}-100 text-${getStatusColor(user.role)}-700`}
                      >
                        {user.role}
                      </span>
                      <span
                        className={`px-2 py-1 rounded text-xs font-medium capitalize bg-${getStatusColor(user.status)}-100 text-${getStatusColor(user.status)}-700`}
                      >
                        {user.status}
                      </span>
                    </div>
                    ...
                    >
                      <div className="flex justify-between items-start mb-3">
                        ...
                        <div className="flex items-center gap-2">
                          <span
                            className={`px-2 py-1 rounded text-xs font-medium bg-${getStatusColor(invitation.status)}-100 text-${getStatusColor(invitation.status)}-700`}
                          >
                            {invitation.status}
                          </span>
                          <span
                            className={`px-2 py-1 rounded text-xs font-medium bg-${getStatusColor(invitation.role)}-100 text-${getStatusColor(invitation.role)}-700`}
                          >
                            {invitation.role}
                          </span>
                        </div>
                ...
                {reviews.map((review) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        <span
                          className={`px-2 py-1 rounded text-xs font-medium bg-${getStatusColor(review.status)}-100 text-${getStatusColor(review.status)}-700`}
                        >
                ...
                {comments.map((comment) => (
                  <div key={comment.id} className="border-l-4 border-blue-200 pl-4">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <div className="flex items-center gap-2">
                        <span
                          className={`px-2 py-1 rounded text-xs font-medium bg-${getStatusColor(comment.type)}-100 text-${getStatusColor(comment.type)}-700`}
                        >
                          {comment.type}
                        </span>
                        <span
                          className={`px-2 py-1 rounded text-xs font-medium bg-${getStatusColor(comment.priority)}-100 text-${getStatusColor(comment.priority)}-700`}
                        >
                          {comment.priority}
                        </span>
                      </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 bg-gray-50 rounded-lg p-4">
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <div className="flex items-center gap-2">
                            <span
                              className={`px-2 py-1 rounded text-xs font-medium bg-${getStatusColor(version.status)}-100 text-${getStatusColor(version.status)}-700`}
                            >
                              {version.status}
                            </span>
                            <button className="text-blue-600 hover:text-blue-800 text-sm">
                ...
                {shares.map((share) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        <span
                          className={`px-2 py-1 rounded text-xs font-medium bg-${getStatusColor(share.shareType)}-100 text-${getStatusColor(share.shareType)}-700`}
                        >
                          {share.shareType}
                        </span>
