...
const Lifecycle: React.FC = () => {
  const [activeTab, setActiveTab] = useState<
    'draft' | 'publish' | 'schedule' | 'clone' | 'practice' | 'answers' | 'solutions' | 'regrade'
  >('draft')
  ...
  const convertToPractice = () => {
    ...
    setTimeout(() => {
      setTests((prev) =>
        prev.map((test) => (test.id === selectedTest ? { ...test, status: 'practice' } : test))
      )
      setLoading(false)
    }, 2000)
  }
    ...
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Complete test lifecycle management from draft to publication, with scheduling, cloning,
          practice modes, and comprehensive grading options
        </p>
      </div>
            ...
            {selectedTest && (
              <div className="text-sm">
                ...
                <div className="text-gray-500">
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(getSelectedTestData()?.status || '')}`}
                  >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-cyan-600">
                {getSelectedTestData()?.totalQuestions}
              </div>
              <div className="text-sm text-gray-600">Questions</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600">
                {getSelectedTestData()?.totalMarks}
              </div>
              <div className="text-sm text-gray-600">Total Marks</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-600">
                {getSelectedTestData()?.duration}m
              </div>
              <div className="text-sm text-gray-600">Duration</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-orange-600">
                {getSelectedTestData()?.participants}
              </div>
              <div className="text-sm text-gray-600">Participants</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-600">
                {getSelectedTestData()?.completionRate.toFixed(1)}%
              </div>
              <div className="text-sm text-gray-600">Completion</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-indigo-600">
                {getSelectedTestData()?.averageScore.toFixed(1)}%
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-yellow-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-yellow-700">
                    High security settings may affect user experience. Test thoroughly before
                    deployment.
                  </p>
                </div>
              </div>
                  ...
                  scheduleSettings.availabilityWindows.map((window) => (
                    <div key={window.id} className="p-4 border rounded-lg">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex items-center gap-2">
                          <span
                            className={`w-3 h-3 rounded-full ${window.isActive ? 'bg-green-500' : 'bg-gray-300'}`}
                          />
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setCloneSettings((prev) => ({ ...prev, newTitle: e.target.value }))
                    }
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setCloneSettings((prev) => ({ ...prev, cloneType: e.target.value as any }))
                    }
                    className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                  >
                ...
                <div className="space-y-3">
                  ...
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={(e) =>
                        setCloneSettings((prev) => ({ ...prev, updateQuestions: e.target.checked }))
                      }
                      className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                    />
                  ...
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={(e) =>
                        setCloneSettings((prev) => ({ ...prev, resetAnalytics: e.target.checked }))
                      }
                      className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                    />
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setPracticeModeSettings((prev) => ({
                        ...prev,
                        feedbackLevel: e.target.value as any,
                      }))
                    }
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setAnswerKeySettings((prev) => ({ ...prev, format: e.target.value as any }))
                    }
                ...
                <div className="bg-gray-50 p-4 rounded-lg min-h-64">
                  ...
                  <div className="space-y-3">
                    <div className="border-b pb-2">
                      ...
                      {answerKeySettings.includeExplanations && (
                        <div className="text-sm text-gray-600 mt-1">
                          Explanation: Mitochondria are called the powerhouse because they produce
                          ATP...
                        </div>
                      )}
                    </div>
                    ...
                    <div className="border-b pb-2">
                      <div className="flex justify-between items-center">
                        <span className="font-medium">
                          2. The process of photosynthesis occurs in:
                        </span>
                        <span className="text-sm text-gray-500">2 marks</span>
                      </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setSolutionReleaseSettings((prev) => ({
                        ...prev,
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setSolutionReleaseSettings((prev) => ({
                        ...prev,
                        contentLevel: e.target.value as any,
                      }))
                    }
                    className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
                ...
                <div className="space-y-4">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setRegradeOptions((prev) => ({
                          ...prev,
                          regradeType: e.target.value as any,
                        }))
                      }
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setRegradeOptions((prev) => ({ ...prev, reason: e.target.value }))
                      }
                      rows={3}
