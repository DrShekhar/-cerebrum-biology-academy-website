...
const TestReview: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      {/* Student Preview */}
      {activeTab === 'student' && (
        <div key="student" className="space-y-6 animate-fadeInUp">
          {/* Preview Controls */}
      ...
      {/* Teacher Preview */}
      {activeTab === 'teacher' && (
        <div key="teacher" className="space-y-6 animate-fadeInUp">
          {/* Teacher Controls */}
          <div className="bg-white rounded-xl p-4 border">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-semibold flex items-center gap-2">
      ...
      {activeTab === 'answers' && (
        <div key="answers" className="space-y-6 animate-fadeInUp">
          <div className="bg-white rounded-xl p-6 border">
      ...
      {activeTab === 'calculation' && (
        <div key="calculation" className="space-y-6 animate-fadeInUp">
          <div className="bg-white rounded-xl p-6 border">
            <h3 className="text-lg font-semibold mb-6 flex items-center gap-2">
      ...
      {activeTab === 'timing' && (
        <div key="timing" className="space-y-6 animate-fadeInUp">
          <div className="bg-white rounded-xl p-6 border">
            <h3 className="text-lg font-semibold mb-6 flex items-center gap-2">
      ...
      {activeTab === 'difficulty' && (
        <div key="difficulty" className="space-y-6 animate-fadeInUp">
          <div className="bg-white rounded-xl p-6 border">
            <h3 className="text-lg font-semibold mb-6 flex items-center gap-2">
              ...
              <div className="space-y-2 text-sm">
                {(() => {
                  const easyPercentage =
                    (reviewMetrics.difficultyDistribution.easy / reviewMetrics.totalQuestions) * 100
                  const mediumPercentage =
                    (reviewMetrics.difficultyDistribution.medium / reviewMetrics.totalQuestions) *
                    100
                  const hardPercentage =
                    (reviewMetrics.difficultyDistribution.hard / reviewMetrics.totalQuestions) * 100
                  ...
                  if (mediumPercentage > 60)
                    recommendations.push('⚠️ Consider balancing with more easy and hard questions')
      ...
      {activeTab === 'coverage' && (
        <div key="coverage" className="space-y-6 animate-fadeInUp">
          <div className="bg-white rounded-xl p-6 border">
            <h3 className="text-lg font-semibold mb-6 flex items-center gap-2">
      ...
      {/* Grammar/Spell Check */}
      {activeTab === 'quality' && (
        <div key="quality" className="space-y-6 animate-fadeInUp">
          <div className="bg-white rounded-xl p-6 border">
