                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div
                        key={grade.grade}
                        className={`flex justify-between items-center p-3 bg-${grade.color}-50 border border-${grade.color}-200 rounded-lg`}
                      >
                        <div className="flex items-center gap-3">
                          <span className={`font-bold text-${grade.color}-800 w-8`}>
                            {grade.grade}
                          </span>
                          <span className={`text-${grade.color}-700`}>{grade.range}</span>
                        </div>
                        <span className={`font-medium text-${grade.color}-800`}>
                          {grade.marks} marks
                        </span>
                      </div>
                    ))}
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                  {Object.entries(reviewMetrics.bloomsDistribution).map(([level, count]) => {
                    ...
                    return (
                      <div
                        key={level}
                        className={`p-3 bg-${color}-50 border border-${color}-200 rounded-lg text-center`}
                      >
