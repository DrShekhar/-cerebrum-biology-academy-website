...
const TestTemplates: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      {/* Content */}
      {activeView === 'browse' && (
        <div key="browse" className="space-y-6 animate-fadeInUp">
          ...
          <div className="space-y-6">
            {filteredCategories.map((category) => (
              <div key={category.id} className="bg-white rounded-xl border animate-fadeInUp">
                {/* Category Header */}
                <div
      ...
      {activeView === 'create' && (
        <div key="create" className="bg-white rounded-xl p-6 border animate-fadeInUp">
      ...
      {activeView === 'customize' && selectedTemplate && (
        <div key="customize" className="bg-white rounded-xl p-6 border animate-fadeInUp">
          <div className="flex justify-between items-center mb-6">
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{selectedTemplate.isPopular ? 'Yes' : 'No'}</span>
                  </div>
                </div>
              </div>
