...
const questionCreationMethods: QuestionCreationMethodInfo[] = [
  {
    ...
    description:
      'Let AI create high-quality NEET Biology questions automatically based on your selected topics',
    icon: Brain,
    difficulty: 'Easy',
  ...
  },
  {
    ...
    description:
      'Extract questions from textbook images or PDF files using advanced OCR technology',
    icon: Camera,
    difficulty: 'Advanced',
...
export function TestCreationInterface({
  isOpen,
  onClose,
  onCreateTest,
}: TestCreationInterfaceProps) {
  ...
  const totalDifficultyPercentage =
    testConfig.difficultyDistribution.easy +
    testConfig.difficultyDistribution.moderate +
    testConfig.difficultyDistribution.difficult

  const totalQuestionTypePercentage = Object.values(testConfig.questionTypeDistribution).reduce(
    (sum, value) => sum + value,
    0
  )
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden animate-fadeInUp">
        {/* Header */}
          ...
          <div className="flex items-center space-x-4 mt-6">
            {[
              ...
              <div key={step} className="flex items-center">
                ...
                {step < 4 && <ChevronRight className="w-4 h-4 mx-4 text-white/60" />}
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
          ...
          {currentStep === 1 && (
            <div key="step1" className="space-y-6 animate-fadeInUp">
              <div>
                          ...
                          <div className="border-t border-gray-200 bg-gray-50 p-3 space-y-2">
                            {chapter.topics.map((topic) => (
                              <label key={topic.id} className="flex items-center cursor-pointer">
                                ...
                                />
                                <span className="ml-2 text-xs text-gray-600">{topic.name}</span>
                              </label>
                            ))}
                          </div>
                        )}
          ...
          {currentStep === 2 && (
            <div key="step2" className="space-y-8 animate-fadeInUp">
              <div className="text-center">
                <h3 className="text-2xl font-bold text-gray-800 mb-2">Configure Test Settings</h3>
                <p className="text-gray-600">
                  Set up comprehensive test parameters and requirements
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setTestConfig((prev) => ({ ...prev, testName: e.target.value }))
                      }
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setTestConfig((prev) => ({ ...prev, gradeLevel: e.target.value }))
                      }
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setTestConfig((prev) => ({ ...prev, language: e.target.value }))
                      }
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    >
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setTestConfig((prev) => ({ ...prev, testDescription: e.target.value }))
                      }
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex space-x-2 mt-2">
                          {[25, 50, 100, 150].map((count) => (
                            <button
                              key={count}
                              onClick={() =>
                                setTestConfig((prev) => ({ ...prev, totalQuestions: count }))
                              }
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          Average: {(testConfig.totalMarks / testConfig.totalQuestions).toFixed(1)}{' '}
                          marks per question
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          Pass marks:{' '}
                          {Math.round((testConfig.totalMarks * testConfig.passingPercentage) / 100)}
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setTestConfig((prev) => ({
                              ...prev,
                              testCategory: e.target.value as any,
                            }))
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        >
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        {testConfig.timeLimit > 0 && (
                          <p className="text-xs text-gray-500 mt-1">
                            ~{Math.round(testConfig.timeLimit / testConfig.totalQuestions)} minutes
                            per question
                          </p>
                        )}
                      </div>
                        ...
                        <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                          ...
                          {testConfig.partialMarkingScheme.enabled && (
                            <div className="ml-7 text-sm text-gray-600">
                              <p>
                                Enabled for: Short Answer (50%), Long Answer (60%), Case Study (40%)
                              </p>
                            </div>
                          )}
                        </div>
                  ...
                  {[
                    ...
                    <div key={key} className={`p-4 rounded-lg ${bgColor}`}>
                      ...
                      <div className="text-xs text-gray-600 mt-2">
                        {Math.round(
                          (testConfig.totalQuestions * testConfig.difficultyDistribution[key]) / 100
                        )}{' '}
                        questions
                      </div>
                    </div>
          ...
          {currentStep === 3 && (
            <div key="step3" className="space-y-6 animate-fadeInUp">
              <div className="text-center">
                <h3 className="text-2xl font-bold text-gray-800 mb-2">
                  Choose Question Creation Method
                </h3>
                <p className="text-gray-600">
                  Select how you want to create questions for your test
                </p>
              </div>
                ...
                {questionCreationMethods.map((method) => {
                  ...
                  return (
                    <div
                      ...
                      onClick={() =>
                        setTestConfig((prev) => ({ ...prev, questionCreationMethod: method.id }))
                      }
                    >
              ...
              {testConfig.questionCreationMethod && (
                <div className="p-6 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl border border-purple-200 animate-fadeInUp">
                  <div className="flex items-center space-x-3 mb-4">
                    <div className="p-2 bg-purple-500 text-white rounded-lg">
                      {React.createElement(
                        questionCreationMethods.find(
                          (m) => m.id === testConfig.questionCreationMethod
                        )?.icon || Brain,
                        { className: 'w-5 h-5' }
                      )}
                    </div>
                  ...
                  <div className="mt-8 p-6 bg-gray-50 rounded-xl border border-purple-200">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="text-sm text-gray-500">
                        ...
                        {createdQuestions.length !== 1 ? 's' : ''} created
                      </div>
                    </div>
          ...
          {currentStep === 4 && (
            <div key="step3" className="space-y-6 animate-fadeInUp">
              <div>
                ...
                <p className="text-gray-600">Choose the mix of question formats for your test</p>
              </div>
                      ...
                      {[
                        {
                          ...
                          icon: '🔘',
                          description: 'Classic 4-option multiple choice',
                        },
                        {
                        ...
                        },
                        {
                          ...
                          icon: '📝',
                          description: 'Complete the sentence/formula',
                        },
                        {
                          key: 'matchFollowing' as const,
                          label: 'Match the Following',
                          icon: '🔗',
                          description: 'Connect related items',
                        },
                        {
                          key: 'diagramLabeling' as const,
                          label: 'Diagram Labeling',
                          icon: '🏷️',
                          description: 'Label parts of biological diagrams',
                        },
                        {
                          key: 'shortAnswer' as const,
                          label: 'Short Answer',
                          icon: '📋',
                          description: '1-2 sentence responses',
                        },
                        {
                        ...
                        {
                          key: 'assertionReasoning' as const,
                          label: 'Assertion-Reasoning',
                          icon: '💭',
                          description: 'NEET-style assertion-reason format',
                        },
                        {
                        ...
                        {
                          key: 'imageBased' as const,
                          label: 'Image-Based Questions',
                          icon: '🖼️',
                          description: 'Questions with biological images',
                        },
                        {
                          key: 'sequenceOrdering' as const,
                          label: 'Sequence Ordering',
                          icon: '🔢',
                          description: 'Arrange in correct order',
                        },
                        {
                          key: 'multipleSelect' as const,
                        ...
                        <div key={key} className="space-y-2">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              handleQuestionTypeChange(key, parseInt(e.target.value))
                            }
                  ...
                  <div className="space-y-3">
                    ...
                    <label className="flex items-center">
                      <input
                        ...
                        className="w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
                      />
                      <span className="ml-3 text-sm text-gray-700">Include microscopy images</span>
                    </label>
                  </div>
          ...
          {currentStep === 5 && (
            <div key="step3" className="space-y-6 animate-fadeInUp">
              <div>
                ...
                <p className="text-gray-600">Review your settings before creating the test</p>
              </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold">
                      {Math.round(
                        (testConfig.totalQuestions * testConfig.difficultyDistribution.easy) / 100
                      )}
                    </div>
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold">
                      {Math.round(
                        (testConfig.totalQuestions * testConfig.difficultyDistribution.moderate) /
                          100
                      )}
                    </div>
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold">
                      {Math.round(
                        (testConfig.totalQuestions * testConfig.difficultyDistribution.difficult) /
                          100
                      )}
                    </div>
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold">
                      {testConfig.timeLimit === 0
                        ? '∞'
                        : `${(testConfig.timeLimit / testConfig.totalQuestions).toFixed(1)}m`}
                    </div>
            ...
            <div className="flex space-x-3">
              {currentStep < 5 ? (
                ...
                <button
                  ...
                  disabled={!canProceedToNextStep()}
                  className="px-6 py-2 bg-[#4a5d4a] hover:bg-[#3d4f3d] text-white rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center"
                >
