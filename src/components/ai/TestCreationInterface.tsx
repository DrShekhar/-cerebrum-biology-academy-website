                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500 mt-1">
                            Average:{' '}
                            {(testConfig.totalMarks / testConfig.totalQuestions).toFixed(1)} marks
                            per question
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500 mt-1">
                            Pass marks:{' '}
                            {Math.round(
                              (testConfig.totalMarks * testConfig.passingPercentage) / 100
                            )}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          {testConfig.timeLimit > 0 && (
                            <p className="text-xs text-gray-500 mt-1">
                              ~{Math.round(testConfig.timeLimit / testConfig.totalQuestions)}{' '}
                          ...
                          <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                            ...
                            {testConfig.partialMarkingScheme.enabled && (
                              <div className="ml-7 text-sm text-gray-600">
                                <p>
                                  Enabled for: Short Answer (50%), Long Answer (60%), Case Study
                                  (40%)
                                </p>
                              </div>
                            )}
                    ...
                    {[
                      ...
                      <div key={key} className={`p-4 rounded-lg ${bgColor}`}>
                        ...
                        <div className="text-xs text-gray-600 mt-2">
                          {Math.round(
                            (testConfig.totalQuestions * testConfig.difficultyDistribution[key]) /
                              100
                          )}{' '}
                          questions
                        </div>
                          ...
                          {Object.entries(testConfig.questionTypeDistribution)
                            ...
                            .map(([type, percentage]) => {
                              const count = Math.round(
                                (testConfig.totalQuestions * percentage) / 100
                              )
