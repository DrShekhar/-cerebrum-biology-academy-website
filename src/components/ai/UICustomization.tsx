          ...
          <div className="xl:col-span-1">
            <div className="bg-white rounded-xl p-6 border sticky top-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-2">
                  <Monitor
                    className={`w-4 h-4 ${previewMode === 'desktop' ? 'text-pink-600' : 'text-gray-400'}`}
                  />
                  <Tablet
                    className={`w-4 h-4 ${previewMode === 'tablet' ? 'text-pink-600' : 'text-gray-400'}`}
                  />
                  <Smartphone
                    className={`w-4 h-4 ${previewMode === 'mobile' ? 'text-pink-600' : 'text-gray-400'}`}
                  />
                </div>
              </div>
