      ...
      {configuration.isAdaptiveEnabled && (
        <>
          ...
          {activeTab === 'prerequisites' && (
            <div key="prerequisites" className="space-y-6 animate-fadeInUp">
              <div className="bg-white rounded-xl p-6 border">
          ...
          {activeTab === 'branching' && (
            <div key="branching" className="space-y-6 animate-fadeInUp">
              <div className="bg-white rounded-xl p-6 border">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-semibold flex items-center gap-2">
          ...
          {activeTab === 'skip' && (
            <div key="skip" className="space-y-6 animate-fadeInUp">
              <div className="bg-white rounded-xl p-6 border">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-semibold flex items-center gap-2">
          ...
          {activeTab === 'time' && (
            <div key="time" className="space-y-6 animate-fadeInUp">
              <div className="bg-white rounded-xl p-6 border">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-semibold flex items-center gap-2">
