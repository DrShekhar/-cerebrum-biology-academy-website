...
const SectionConfiguration: React.FC<SectionConfigurationProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              updateSection(section.id, {
                                ...
                                totalMarks:
                                  (parseInt(e.target.value) || 0) * section.markingScheme.correct,
                              })
                            }
                            min="1"
                            className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent"
      ...
      {/* Preview Mode */}
      {previewMode && (
        <div className="bg-gray-50 rounded-xl p-6 border-2 border-dashed border-gray-300 animate-fadeInUp">
