...
const QuestionBank: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      {/* Search Tab */}
      {activeTab === 'search' && (
        <div key="search" className="space-y-6 animate-fadeInUp">
          {/* Search Bar */}
          ...
          <div className="space-y-4">
            {filteredQuestions.map((question) => (
              ...
              >
                ...
                {/* Expanded Content */}
                {expandedQuestion === question.id && (
                  <div className="mt-4 pt-4 border-t animate-fadeInUp">
                    {question.options && (
      ...
      {/* Filter Tab */}
      {activeTab === 'filter' && (
        <div key="filter" className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-fadeInUp">
          {/* Basic Filters */}
          <div className="bg-white rounded-xl p-6 border">
      ...
      {/* Favorites Tab */}
      {activeTab === 'favorites' && (
        <div key="favorites" className="space-y-6 animate-fadeInUp">
          <div className="bg-white rounded-xl p-6 border">
            <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
      ...
      {/* Statistics Tab */}
      {activeTab === 'stats' && (
        <div key="stats" className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-fadeInUp">
      ...
      {/* Community Tab */}
      {activeTab === 'community' && (
        <div key="community" className="space-y-6 animate-fadeInUp">
          <div className="bg-white rounded-xl p-6 border">
            <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
      ...
      {/* Rating Tab */}
      {activeTab === 'rating' && (
        <div key="rating" className="space-y-6 animate-fadeInUp">
          <div className="bg-white rounded-xl p-6 border">
            <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
