                  ...
                  >
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        <span
                          className={`px-2 py-1 rounded text-xs font-medium bg-${getStatusColor(job.status)}-100 text-${getStatusColor(job.status)}-700`}
                        >
                          {job.status}
                        </span>
                ...
                {backups.map((backup) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        <span
                          className={`px-2 py-1 rounded text-xs font-medium bg-${getStatusColor(backup.status)}-100 text-${getStatusColor(backup.status)}-700`}
                        >
                          {backup.status}
                        </span>
                        <span
                    ...
                    >
                      <div className={viewMode === 'list' ? 'flex-1' : ''}>
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <span
                            className={`px-2 py-1 rounded text-xs font-medium bg-${getStatusColor(test.status)}-100 text-${getStatusColor(test.status)}-700`}
                          >
                            {test.status}
                          </span>
                        </div>
