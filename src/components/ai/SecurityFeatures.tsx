...
const SecurityFeatures: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      {/* Browser Lockdown */}
      {activeTab === 'browser' && (
        <div key="browser" className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-fadeInUp">
      ...
      {activeTab === 'copy' && (
        <div key="copy" className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-fadeInUp">
          {/* Copy/Paste Settings */}
          <div className="bg-white rounded-xl p-6 border">
            <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
      ...
      {activeTab === 'rightclick' && (
        <div key="rightclick" className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-fadeInUp">
      ...
      {activeTab === 'tabswitch' && (
        <div key="tabswitch" className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-fadeInUp">
          {/* Tab Switch Settings */}
          <div className="bg-white rounded-xl p-6 border">
            <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
      ...
      {/* Webcam Proctoring */}
      {activeTab === 'webcam' && (
        <div key="webcam" className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-fadeInUp">
          {/* Webcam Settings */}
          <div className="bg-white rounded-xl p-6 border">
            <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
      ...
      {/* Screen Recording */}
      {activeTab === 'screen' && (
        <div key="screen" className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-fadeInUp">
                        ...
                        <button
                          onClick={() =>
                            setConfiguration((prev) => ({
                              ...
                              screenRecording: {
                                ...prev.screenRecording,
                                [key]: !prev.screenRecording[key as keyof ScreenRecordingSettings],
                              },
                            }))
                          }
                          className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors ${
      ...
      {activeTab === 'plagiarism' && (
        <div key="plagiarism" className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-fadeInUp">
          {/* Plagiarism Settings */}
          <div className="bg-white rounded-xl p-6 border">
            <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
      ...
      {/* Time Tracking */}
      {activeTab === 'tracking' && (
        <div key="tracking" className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-fadeInUp">
