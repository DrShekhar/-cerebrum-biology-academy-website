...
const MultiModalQuestionGenerator: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      {/* Generate Tab */}
      {activeTab === 'generate' && (
        <div key="generate" className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-fadeInUp">
          {/* Generation Controls */}
                ...
                {isGenerating && (
                  <div className="mt-4">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 h-2 rounded-full animate-fadeInUp" />
                    </div>
                  </div>
                )}
              </div>
      ...
      {/* Library Tab */}
      {activeTab === 'library' && (
        <div key="library" className="space-y-6 animate-fadeInUp">
          <div className="bg-white rounded-xl p-6 border">
            <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
