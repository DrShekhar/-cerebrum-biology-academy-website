...
export const BrandIdentityGenerator: React.FC<BrandIdentityGeneratorProps> = ({ className }) => {
  ...
  return (
    <div className={cn('w-full max-w-7xl mx-auto p-6', className)}>
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      downloadAsset(currentLogo.svgCode, `cerebrum-logo-${selectedLogoVariant}.svg`)
                    }
                  >
      ...
      {/* Icon Library Tab */}
      {activeTab === 'icons' && (
        <div className="grid lg:grid-cols-4 gap-8 animate-fadeInUp">
          {/* Icon Categories */}
          <div className="bg-white rounded-3xl shadow-xl p-6">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 animate-fadeInUp">
          ...
          <div className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div className="p-6 bg-gray-50 rounded-2xl">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Heading 2 - Section Title</h2>
                <p className="text-gray-600">
