  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 pt-3 border-t border-gray-100">
        <button className="flex-1 flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#20BA5A] text-white px-3 py-2 rounded-lg text-xs font-medium transition-colors">
