    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Detailed Curriculum</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-8">
            Comprehensive module-wise breakdown designed to build strong fundamentals and ensure
            NEET success
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm">
              ...
              <div className="text-2xl font-bold text-gray-900">
                {course.curriculum.practicalHours}
              </div>
        ...
        {course.curriculum.modules.length > 6 && (
          <div className="text-center mt-8">
            <Button onClick={() => setShowAllModules(!showAllModules)} variant="outline" size="lg">
              {showAllModules
