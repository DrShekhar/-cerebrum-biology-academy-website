          ...
          <Button
            ...
            onClick={() =>
              trackAndOpenWhatsApp({
                source: 'course-schedule-reserve-' + batch.id,
                message:
                  'Hi! I want to reserve a seat in ' +
                  batch.name +
                  ' for ' +
                  course.name +
                  '. Timing: ' +
        ...
        <div className="text-center space-y-4">
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              onClick={() =>
                trackAndOpenWhatsApp({
                  source: 'course-schedule-counseling',
                  message:
                    'Hi! I need counseling for ' +
                    course.name +
                    '. Please help me choose the right batch and plan.',
                  campaign: 'course-counseling',
                })
              }
            >
            ...
            <Button
              ...
              onClick={() =>
                trackAndOpenWhatsApp({
                  source: 'course-schedule-pdf',
                  message: 'Hi! Please share the schedule PDF for ' + course.name + '.',
                  campaign: 'course-schedule',
                })
              }
            >
            ...
            <Button
              ...
              onClick={() =>
                trackAndOpenWhatsApp({
                  source: 'course-custom-schedule',
                  message:
                    'Hi! I need a custom schedule for ' +
                    course.name +
                    '. My school timings are [please fill]. Can you suggest a suitable batch?',
                  campaign: 'course-custom',
                })
              }
            >
