...
const mockSuccessStories = [
  ...
  },
  {
    ...
    rank: 'NSEB Qualifier',
    year: '2024',
    college: 'Selected for INBiO Camp',
    course: 'Class 9th Foundation Biology',
    tier: 'Ascent Series',
    beforeScore: 45,
    afterScore: 92,
    improvement: 47,
    quote:
      'I joined Cerebrum in Class 9 just to improve my school marks. The Olympiad prep module opened a whole new world. I qualified NSEB in my first attempt and represented my state at the national level.',
    story:
      'Started with 45% in Class 8 biology. The systematic NCERT foundation plus olympiad problem-solving transformed my approach to science. By Class 10, I was solving IBO-level questions.',
    achievements: ['NSEB Stage 1 Qualifier', 'School Biology Topper', '92% in Board Exams'],
    videoTestimonial: null,
  },
  {
    id: '5b',
    ...
    improvement: 348,
    quote:
      'Starting in Class 9 gave me 4 years to prepare. While my Class 11 friends were struggling with basics, I was already doing advanced problems. The head start was everything.',
    story:
      'Joined Class 9 Foundation → Class 10 Advanced → Class 11 NEET → Class 12 Intensive. The 4-year journey with Cerebrum meant NEET felt like revision, not a new exam. Scored 658/720 in first attempt.',
    achievements: ['AIIMS Rishikesh', 'NEET AIR 289', '4-Year Cerebrum Journey'],
    videoTestimonial: 'https://youtube.com/watch?v=sample5b',
  },
  {
    id: '5',
    name: 'Vikash Singh',
