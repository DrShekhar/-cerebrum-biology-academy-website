...
export function ClassFilterNav({ selectedClass, onClassSelect, courseCounts }: ClassFilterNavProps) {
    ...
    <div className="bg-white rounded-2xl shadow-lg p-2 mb-8 overflow-x-auto">
      <div className="flex space-x-2 min-w-max">
        {classOptions.map((option) => {
          const courseCount = option.value === 'all' ? getTotalCourses() : courseCounts[option.value as ClassLevel] || 0
