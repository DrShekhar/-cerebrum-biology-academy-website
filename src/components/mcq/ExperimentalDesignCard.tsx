...
interface ExperimentalDesignCardProps {
...
export function ExperimentalDesignCard({
  question,
  questionNumber,
  onAnswer,
  ...
  return (
    <div
      ...
      role="article"
      aria-label={`Experimental Design Question ${questionNumber}`}
    >
