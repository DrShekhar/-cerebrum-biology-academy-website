  ...
  return (
    ...
    >
      ...
      <div className="mb-3 flex flex-wrap items-center gap-2">
        ...
        {question.campbellChapter && (
          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-stone-100 text-stone-600 text-xs">
            Ch.{question.campbellChapter}
          </span>
        )}
      </div>
