...
const INTERNAL_LINKS = {
  location: [
    ...
    { title: 'NEET Coaching Dubai UAE', slug: '/neet-coaching-dubai-uae' },
    { title: 'NEET Coaching Singapore', slug: '/neet-coaching-singapore-city' },
    { title: 'NEET Coaching Riyadh', slug: '/neet-coaching-riyadh-saudi-arabia' },
    { title: 'NEET Coaching London UK', slug: '/neet-coaching-london-uk' },
    { title: 'NEET Coaching Doha Qatar', slug: '/neet-coaching-doha-qatar' },
    { title: 'NEET Coaching New York USA', slug: '/neet-coaching-new-york-usa' },
    { title: 'NEET Coaching Toronto Canada', slug: '/neet-coaching-toronto-canada' },
    { title: 'NEET Coaching Sydney Australia', slug: '/neet-coaching-sydney-australia' },
    { title: 'NEET Coaching Kathmandu Nepal', slug: '/neet-coaching-kathmandu-nepal' },
    { title: 'NEET Coaching Kuala Lumpur', slug: '/neet-coaching-kuala-lumpur-malaysia' },
    { title: 'NRI NEET Saudi Arabia', slug: '/neet-coaching-nri-saudi-arabia' },
    { title: 'NRI NEET USA', slug: '/neet-coaching-nri-usa' },
    { title: 'NRI NEET UK', slug: '/neet-coaching-nri-uk' },
    { title: 'NRI NEET Nepal', slug: '/neet-coaching-nri-nepal' },
    { title: 'NEET Coaching Houston USA', slug: '/neet-coaching-houston-usa' },
    { title: 'NEET Coaching Muscat Oman', slug: '/neet-coaching-muscat-oman' },
    { title: 'NEET Coaching Lagos Nigeria', slug: '/neet-coaching-lagos-nigeria' },
    { title: 'NEET Coaching Nairobi Kenya', slug: '/neet-coaching-nairobi-kenya' },
  ],
  course: [
    ...
    // NRI Programs
    { title: 'NRI NEET Dropper Program', slug: '/nri-neet-dropper-program' },
    { title: 'NRI NEET Crash Course', slug: '/nri-neet-crash-course' },
    { title: 'NRI NEET Foundation Program', slug: '/nri-neet-foundation-program' },
    { title: 'NRI Medical Admission Counseling', slug: '/nri-medical-admission-counseling' },
    // Board Bridge
    { title: 'IB to NEET Preparation', slug: '/ib-to-neet-biology-preparation' },
    { title: 'IGCSE to NEET Preparation', slug: '/igcse-to-neet-biology-preparation' },
    { title: 'A-Level to NEET Preparation', slug: '/a-level-to-neet-biology-preparation' },
    { title: 'AP Biology to NEET', slug: '/ap-biology-to-neet-preparation' },
    { title: 'Edexcel to NEET', slug: '/edexcel-to-neet-biology-preparation' },
  ],
  blog: [
