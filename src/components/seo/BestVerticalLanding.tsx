...
import { Award, Star, CheckCircle, ArrowRight, Phone, GraduationCap } from 'lucide-react'
      ...
      <section className="py-16 bg-slate-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
            Book a free demo class with Dr. Shekhar Singh and senior faculty. No obligation, no
            commitment — just an honest look at the teaching.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="tel:+918826444334"
