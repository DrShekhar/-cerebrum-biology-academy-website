  ...
  const schema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Cerebrum Biology Academy has a 98% success rate with 67+ AIIMS selections. Over 1,50,000+ students have been mentored successfully for NEET examinations since 2009.',
        },
      },
      {
        '@type': 'Question',
