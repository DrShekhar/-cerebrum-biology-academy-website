...
export function OrganizationSchema() {
  const organizationData = {
    ...
    description:
      'Premier NEET Biology coaching institute with AIIMS Trained faculty, offering comprehensive preparation for medical entrance exams with 98% success rate. 5 centers across Delhi NCR — South Extension, Green Park, Rohini, Gurugram, and Faridabad.',
...
export function DrShekharSinghSchema() {
  return (
    <PersonSchema
      ...
      description="AIIMS New Delhi alumnus with 14+ years of experience in NEET Biology coaching. Former Academic Head at PhysicsWallah (PW). Has mentored 500+ students into AIIMS, JIPMER, and other top medical colleges."
