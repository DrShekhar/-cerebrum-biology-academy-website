...
/**
 * Pre-built Top 10 NEET Coaching data for Faridabad
 */
export const TOP_10_NEET_COACHING_FARIDABAD: RankedItem[] = [
  {
    rank: 1,
    name: 'Cerebrum Biology Academy',
    description: 'Specialized Biology-only coaching with AIIMS faculty and highest success rate',
  ...
  },
  {
    ...
    cons: [
      ...
      'Average study material',
    ],
    keyFeatures: [
      { label: 'Success Rate', value: '68%' },
      { label: 'Batch Size', value: '40-60' },
      { label: 'Fee Range', value: '₹80K-1.2L' },
      { label: 'Focus', value: 'NEET + JEE' },
    ],
    feeRange: '₹80,000 - ₹1,20,000/year',
  ...
  },
  {
    ...
    keyFeatures: [
      ...
      { label: 'Fee Range', value: '₹60K-1L' },
      { label: 'Area', value: 'NIT Faridabad' },
    ],
    feeRange: '₹60,000 - ₹1,00,000/year',
  ...
  },
  {
    ...
    keyFeatures: [
      ...
      { label: 'Fee Range', value: '₹50K-90K' },
      { label: 'Type', value: 'Local' },
    ],
    feeRange: '₹50,000 - ₹90,000/year',
    location: 'Faridabad',
  },
  {
    rank: 9,
