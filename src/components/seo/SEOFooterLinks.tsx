...
const FOOTER_CATEGORIES: FooterLinkCategory[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'South Delhi', href: '/ib-biology/south-delhi' },
      { label: 'Gurugram', href: '/ib-biology/gurugram' },
      { label: 'Noida', href: '/ib-biology/noida' },
      { label: 'Faridabad', href: '/ib-biology/faridabad' },
      { label: 'Rohini', href: '/ib-biology/rohini' },
      ...
      { label: 'Kolkata', href: '/ib-biology/kolkata' },
    ],
  },
  {
