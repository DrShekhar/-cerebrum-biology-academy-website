  ...
  faculty: [
    {
      ...
      answer:
        'Lead faculty Dr. Shekhar C Singh - AIIMS New Delhi alumnus, 15+ years experience, former Narayana Academic Head. Has mentored 15,000+ students with 67+ AIIMS/JIPMER selections. All faculty from AIIMS/premier medical colleges.',
    },
  ],
  comparison: [
    {
...
export function NoidaFAQSchema({
  ...
  const defaultFAQs = [
    ...
    // Faculty FAQ
    {
      ...
      answer: `Lead faculty Dr. Shekhar C Singh - AIIMS New Delhi alumnus, 15+ years experience, former Narayana Academic Head. Has mentored 15,000+ students with 67+ AIIMS/JIPMER selections. All faculty from AIIMS/premier medical colleges.`,
    },
    // Demo FAQ
    {
