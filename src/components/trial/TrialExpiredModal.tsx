                  ...
                  <>
                    ...
                    <div className="mt-6 text-center space-y-3">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 bg-[#25D366] hover:bg-[#20BD5A] text-white font-medium rounded-lg transition-colors text-sm cursor-pointer"
                      >
