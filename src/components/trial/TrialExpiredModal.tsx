          ...
          <div className="relative overflow-y-auto max-h-[90vh] custom-scrollbar">
            ...
            <div className="p-6 sm:p-8 lg:p-12">
              <div className="text-center mb-8">
                ...
                <h2 id="modal-title" className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">
                  Your 15-Day Trial Has Ended
                </h2>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  You took {trialStatus.testsTaken} tests during your trial. Upgrade now to continue
                  your NEET preparation journey with unlimited access!
                </p>
              </div>
              ...
              {!showContactForm ? (
                <>
                  ...
                  <div className="mt-6 text-center space-y-3">
                    ...
                    <a
                      href="https://wa.me/918826444334?text=Hi!%20My%20trial%20has%20expired.%20I%20need%20help%20with%20upgrading%20or%20extending%20my%20trial."
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-4 py-2 bg-[#25D366] hover:bg-[#20BD5A] text-white font-medium rounded-lg transition-colors text-sm"
                    >
