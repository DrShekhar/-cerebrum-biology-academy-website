...
function buildSchemas(metro: DATMetroConfig) {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Home', item: SITE_URL },
      {
        ...
        item: `${SITE_URL}/dat-biology-preparation`,
      },
  ...
  const personSchema = {
    ...
    description: `AIIMS-trained biology educator specialising in DAT Biology preparation for ${metro.city} pre-dental students. Campbell Biology curriculum mapped to ADA survey content.`,
...
export default function DATBiologyCityTemplate({ metro }: { metro: DATMetroConfig }) {
  ...
  const wa =
    ...
    encodeURIComponent(
      `Hi — I'm a ${metro.city} pre-dental student (or parent) preparing for the DAT. I'd like Biology section programme details, ${metro.timezoneShort} slot availability, and pricing. Please share.`
    )
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-teal-900 to-teal-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-xl text-teal-200 mb-6 max-w-3xl" data-speakable="summary">
            {metro.heroSubtitle}
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 prose prose-slate max-w-none">
          ...
          <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">
            Dental schools we coach toward in the {metro.city} metro
          </h2>
          <ul>
          ...
          <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">
            How Cerebrum coaches DAT Biology from {metro.city}
          </h2>
          <p>
            <strong>100% online live.</strong> Zoom-based sessions, screen-shared Campbell Biology
            excerpts (cell biology, genetics, anatomy/physiology, evolution, ecology — the five DAT
            Biology pillars), DAT Bootcamp-style passage walkthroughs, and a WhatsApp channel for
            between-session doubts.
          </p>
          <p>
            <strong>Weekly small-batch sessions</strong> (4–6 students max, grouped by target band),
            90 minutes each, plus monthly DAT Biology section mocks.{' '}
            <strong>Ad-hoc 1:1 sessions</strong> at $109/hour for gap-fill.
          </p>
          ...
          <ul>
            <li>
              <strong>DAT Biology — Pursuit: $399</strong> for the full 3–5 month programme.
              Campbell Biology coverage aligned to ADA DAT content outline, 200+ practice questions,
              recorded library, WhatsApp doubt support.
            </li>
            <li>
              <strong>DAT Biology — Ascent: $799</strong> for the full programme. Adds weekly
              90-minute live sessions, monthly section mocks, peer Slack channel, senior faculty
              office hours.
            </li>
            <li>
              <strong>DAT Biology — Pinnacle: $1,249</strong> for the full programme. Adds weekly
              60-minute 1:1 video sessions with AIIMS-trained senior faculty, personalised study
              plan, custom question drills.
            </li>
            <li>
              <strong>Ad-hoc 1:1 tutoring — $109/hour</strong> outside the packaged programme.
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-slate-900 mb-8">
            FAQs from {metro.city} pre-dental families
          </h2>
      ...
      <section className="py-12 bg-white border-t border-slate-200">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <Link
              href="/dat-biology-preparation"
              className="block p-4 rounded-xl border border-slate-200 hover:border-teal-400 hover:shadow transition"
            >
      ...
      <section className="py-16 bg-gradient-to-br from-teal-600 to-emerald-600">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Start DAT Biology prep from {metro.city}
          </h2>
          ...
          <a
            href={wa}
            className="inline-flex items-center gap-2 bg-white text-teal-700 px-8 py-4 rounded-xl font-semibold text-lg"
            target="_blank"
            rel="noopener noreferrer"
          >
            WhatsApp +91 88264-44334
