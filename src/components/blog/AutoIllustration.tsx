...
function getMotif(neetChapter: string, slug: string): string {
  ...
  if (
    chapter.includes('genetics') ||
    chapter.includes('inheritance') ||
    chapter.includes('variation')
  )
    return 'dna'
  ...
  if (
    chapter.includes('breathing') ||
    chapter.includes('respiration') ||
    chapter.includes('exchange')
  )
    return 'lungs'
    ...
    case 'dna':
      return (
        <g transform="translate(350, 260)">
          {/* Double helix */}
          <path
            d="M-60,-160 C-60,-120 60,-100 60,-60 C60,-20 -60,0 -60,40 C-60,80 60,100 60,140"
            stroke={primary}
            strokeWidth="4"
            fill="none"
            opacity="0.9"
          />
          <path
            d="M60,-160 C60,-120 -60,-100 -60,-60 C-60,-20 60,0 60,40 C60,80 -60,100 -60,140"
            stroke={secondary}
            strokeWidth="4"
            fill="none"
            opacity="0.9"
    ...
    case 'heart':
      return (
        <g transform="translate(350, 250)">
          {/* Heart shape */}
          <path
            d="M0,-70 C-25,-110 -90,-100 -90,-55 C-90,10 0,80 0,80 C0,80 90,10 90,-55 C90,-100 25,-110 0,-70Z"
            fill={`url(#${uid}-hg)`}
            stroke={primary}
            strokeWidth="2"
          />
          ...
          {/* Pulse line */}
          <path
            d="M-200,40 L-120,40 L-100,10 L-80,70 L-60,-10 L-40,50 L-20,40 L200,40"
            fill="none"
            stroke={primary}
            strokeWidth="2.5"
            opacity="0.6"
    ...
    case 'cell':
      return (
        <g transform="translate(350, 260)">
          ...
          {/* Organelles - ER */}
          <path
            d="M-70,-20 Q-80,10 -60,20 Q-40,30 -50,50"
            stroke={secondary}
            strokeWidth="2"
            fill="none"
            opacity="0.5"
          />
          <path
            d="M-60,-25 Q-70,5 -50,15 Q-30,25 -40,45"
            stroke={secondary}
            strokeWidth="2"
            fill="none"
            opacity="0.5"
          ...
          />
          <path
            d="M62,30 Q72,22 82,30 Q92,38 102,30"
            stroke={primary}
            strokeWidth="1"
            fill="none"
            opacity="0.5"
    ...
    case 'leaf':
      return (
        <g transform="translate(350, 260)">
          {/* Main leaf */}
          <path
            d="M0,-130 C80,-100 120,-20 100,60 C80,130 20,160 0,160 C-20,160 -80,130 -100,60 C-120,-20 -80,-100 0,-130Z"
            fill={`url(#${uid}-lg)`}
            stroke={primary}
            strokeWidth="2"
            opacity="0.8"
    ...
    case 'microscope':
      return (
        <g transform="translate(350, 260)">
          ...
          {/* Arm */}
          <path
            d="M10,-20 Q10,10 30,30 Q50,50 50,80"
            stroke={primary}
            strokeWidth="12"
            fill="none"
            strokeLinecap="round"
    ...
    case 'books':
      return (
        <g transform="translate(350, 260)">
          ...
          {/* Open book on top */}
          <path
            d="M-60,-30 L-60,-100 Q0,-90 0,-100 L0,-30"
            fill="white"
            stroke={primary}
            strokeWidth="2"
            opacity="0.9"
          />
          <path
            d="M60,-30 L60,-100 Q0,-90 0,-100 L0,-30"
            fill="white"
            stroke={primary}
            strokeWidth="2"
            opacity="0.85"
    ...
    case 'trophy':
      return (
        <g transform="translate(350, 260)">
          {/* Trophy cup */}
          <path
            d="M-50,-100 L-50,-20 Q-50,40 0,60 Q50,40 50,-20 L50,-100Z"
            fill={`url(#${uid}-tg)`}
            stroke={primary}
            strokeWidth="2"
          />
          ...
          {/* Handles */}
          <path
            d="M-50,-70 Q-90,-70 -90,-30 Q-90,10 -50,10"
            stroke="#D97706"
            strokeWidth="6"
            fill="none"
            strokeLinecap="round"
          />
          <path
            d="M50,-70 Q90,-70 90,-30 Q90,10 50,10"
            stroke="#D97706"
            strokeWidth="6"
            fill="none"
            strokeLinecap="round"
          ...
          {/* Star */}
          <polygon
            points="0,-75 8,-55 30,-55 13,-40 20,-18 0,-32 -20,-18 -13,-40 -30,-55 -8,-55"
            fill="white"
            opacity="0.5"
          />
          {/* Sparkles */}
      ...
      return (
        <g transform="translate(350, 260)">
          ...
          {[
            ...
            <path
              key={i}
              d={`M${x - 8},${y} L${x - 2},${y + 8} L${x + 10},${y - 6}`}
              stroke={primary}
              strokeWidth="2.5"
              fill="none"
              strokeLinecap="round"
    ...
    case 'chart':
      return (
        <g transform="translate(350, 260)">
          ...
          {/* Trend line */}
          <path
            d="M-85,-60 Q-25,-90 35,-50 Q65,-65 95,-90"
            stroke="#EF4444"
            strokeWidth="2"
            fill="none"
            strokeDasharray="4,3"
    ...
    case 'document':
      return (
        <g transform="translate(350, 260)">
          {/* Document */}
          <path
            d="M-65,-130 L45,-130 L75,-100 L75,110 L-65,110Z"
            fill="white"
            stroke={primary}
            strokeWidth="2"
            opacity="0.9"
      ...
      return (
        <g transform="translate(350, 260)">
          ...
          {[-120, -60, 20, 80, 130].map((x, i) => (
            <g key={i}>
              <polygon
                points={`${x},${50 - i * 5} ${x - 15},${70 - i * 3} ${x + 15},${70 - i * 3}`}
                fill="#22C55E"
                opacity={0.3 + i * 0.05}
              />
    ...
    case 'mitosis':
      return (
        <g transform="translate(350, 260)">
          ...
          {/* Dividing cell */}
          <path
            d="M60,-80 Q100,-80 100,-40 Q100,0 60,0 Q80,-20 80,-40 Q80,-60 60,-80Z"
            fill={accent}
            opacity="0.2"
            stroke={primary}
            strokeWidth="2"
          />
          <path
            d="M60,-80 Q20,-80 20,-40 Q20,0 60,0 Q40,-20 40,-40 Q40,-60 60,-80Z"
            fill={accent}
            opacity="0.2"
            stroke={primary}
            strokeWidth="2"
    ...
    case 'neuron':
      return (
        <g transform="translate(350, 260)">
          ...
          {/* Dendrites */}
          <path
            d="M-30,-20 Q-60,-40 -80,-30 Q-100,-25 -120,-35"
            stroke={primary}
            strokeWidth="3"
            fill="none"
            opacity="0.6"
          ...
          />
          <path
            d="M-25,15 Q-50,30 -70,20 Q-85,15 -100,25"
            stroke={primary}
            strokeWidth="2.5"
            fill="none"
            opacity="0.5"
    ...
    case 'biotech':
      return (
        <g transform="translate(350, 260)">
          {/* Flask */}
          <path
            d="M-20,-100 L-20,-30 L-60,60 Q-65,80 -45,80 L45,80 Q65,80 60,60 L20,-30 L20,-100Z"
            fill={accent}
            opacity="0.15"
            stroke={primary}
            strokeWidth="2"
          ...
          {/* Liquid */}
          <path
            d="M-50,30 Q0,20 50,30 L60,60 Q65,80 45,80 L-45,80 Q-65,80 -60,60Z"
            fill={primary}
            opacity="0.2"
          />
          {/* Bubbles */}
          ...
          {/* DNA snippet inside */}
          <path
            d="M-10,30 C-10,15 10,10 10,30 C10,50 -10,45 -10,60"
            stroke={secondary}
            strokeWidth="2"
            fill="none"
            opacity="0.4"
    ...
    case 'tree':
      return (
        <g transform="translate(350, 270)">
          ...
          <text x="-120" y="125" fontSize="10" fill={primary} opacity="0.3" fontFamily="system-ui">
            Simple
          </text>
          <text x="80" y="125" fontSize="10" fill={primary} opacity="0.3" fontFamily="system-ui">
            Complex
          </text>
        </g>
      )
    ...
    case 'beaker':
      return (
        <g transform="translate(350, 260)">
          {/* Beaker */}
          <path
            d="M-55,-100 L-55,60 Q-55,80 -35,80 L35,80 Q55,80 55,60 L55,-100"
            fill="white"
            stroke={primary}
            strokeWidth="2"
            opacity="0.85"
          ...
          {/* Liquid */}
          <path
            d="M-50,-10 Q0,-20 50,-10 L50,60 Q50,75 35,75 L-35,75 Q-50,75 -50,60Z"
            fill={accent}
            opacity="0.2"
          />
          {/* Measurement lines */}
    ...
    case 'steps':
      return (
        <g transform="translate(350, 270)">
          ...
          />
          <polygon
            points={`${-100 + 4 * 45 + 30},${60 - 4 * 35 - 40} ${-100 + 4 * 45 + 50},${60 - 4 * 35 - 32} ${-100 + 4 * 45 + 30},${60 - 4 * 35 - 24}`}
            fill="#EF4444"
            opacity="0.5"
          />
        </g>
    ...
    case 'animal':
      return (
        <g transform="translate(350, 260)">
          ...
          <path
            d="M0,-10 Q-60,-80 -100,-40 Q-120,0 -60,30 Q-30,15 0,-10Z"
            fill={primary}
            opacity="0.3"
          />
          <path d="M0,-10 Q60,-80 100,-40 Q120,0 60,30 Q30,15 0,-10Z" fill={accent} opacity="0.3" />
          <path
            d="M0,-10 Q-40,30 -70,80 Q-50,90 -20,50 Q-10,30 0,-10Z"
            fill={secondary}
            opacity="0.25"
          />
          <path d="M0,-10 Q40,30 70,80 Q50,90 20,50 Q10,30 0,-10Z" fill={primary} opacity="0.25" />
          {/* Body */}
          <ellipse cx="0" cy="10" rx="5" ry="30" fill="#1E293B" opacity="0.5" />
          {/* Antennae */}
          <path
            d="M0,-25 Q-15,-50 -25,-60"
            stroke="#1E293B"
            strokeWidth="1.5"
            fill="none"
            opacity="0.4"
    ...
    case 'digestive':
      return (
        <g transform="translate(350, 260)">
          ...
          />
          <path
            d="M0,-30 Q20,0 -10,30 Q-30,60 10,90 Q30,110 0,130"
            stroke={secondary}
            strokeWidth="5"
            fill="none"
            opacity="0.4"
          ...
          {/* Labels */}
          <text x="50" y="-50" fontSize="10" fill={primary} opacity="0.35" fontFamily="system-ui">
            Stomach
          </text>
          <text x="40" y="50" fontSize="10" fill={secondary} opacity="0.35" fontFamily="system-ui">
            Intestine
          </text>
          {/* Arrow */}
          <line
    ...
    case 'lungs':
      return (
        <g transform="translate(350, 260)">
          ...
          {/* Left lung */}
          <path
            d="M-30,-60 Q-110,-40 -110,30 Q-110,90 -50,90 Q-10,90 -10,-10 Q-10,-50 -30,-60Z"
            fill={accent}
            opacity="0.15"
            stroke={primary}
            strokeWidth="2"
          ...
          {/* Right lung */}
          <path
            d="M30,-60 Q110,-40 110,30 Q110,90 50,90 Q10,90 10,-10 Q10,-50 30,-60Z"
            fill={accent}
            opacity="0.15"
            stroke={primary}
            strokeWidth="2"
    ...
    case 'kidney':
      return (
        <g transform="translate(350, 260)">
          {/* Kidney shape */}
          <path
            d="M-50,-80 Q-90,-40 -70,20 Q-50,80 0,80 Q30,80 30,30 Q30,-10 0,-20 Q-20,-30 -20,-60 Q-20,-80 -50,-80Z"
            fill={primary}
            opacity="0.2"
            stroke={primary}
            strokeWidth="2"
          ...
          {/* Inner structure */}
          <path
            d="M-10,-20 Q-30,0 -20,30 Q-10,50 10,50"
            stroke={secondary}
            strokeWidth="2"
            fill="none"
            opacity="0.4"
          ...
          />
          <path
            d="M-18,-10 Q0,-30 10,-10 Q20,10 10,30 Q0,40 -10,30"
            stroke={accent}
            strokeWidth="1.5"
            fill="none"
            opacity="0.3"
          ...
          {/* Ureter */}
          <path
            d="M10,60 Q20,80 15,100 Q10,120 15,140"
            stroke={secondary}
            strokeWidth="4"
            fill="none"
            opacity="0.4"
          ...
          {[
            ...
            <path
              key={i}
              d={`M${x},${y} Q${x - 2},${y - 6} ${x - 4},${y} Q${x - 2},${y + 3} ${x},${y}Z`}
              fill={primary}
              opacity="0.3"
            />
          ))}
