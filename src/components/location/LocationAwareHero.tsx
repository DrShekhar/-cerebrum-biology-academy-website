...
export function LocationAwareHero({
  ...
  fallbackSubtitle = 'Join 15,000+ students who chose Cerebrum Biology Academy for guaranteed NEET success',
  ...
  const getLocationContent = () => {
    ...
    return {
      ...
      locationBadge: null,
      aspirants: null,
      urgencyMessage: 'Limited seats available for 2027 batch',
