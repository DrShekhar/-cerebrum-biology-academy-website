...
const RefundPolicyDisplay: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      {activeTab === 'policy' && (
        <div key="policy" className="space-y-6 animate-fadeInUp">
        ...
        >
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="lg:pl-8">
              {calculateRefund() && (
                <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-xl p-6 space-y-4 animate-fadeInUp">
                    ...
                    return (
                      <>
                        <div className="flex items-center justify-between py-2">
                          ...
                          <span className="font-medium text-gray-900">{calculation.scenario}</span>
                        </div>
      ...
      {activeTab === 'process' && (
        <div key="process" className="space-y-8 animate-fadeInUp">
          {/* Process Steps */}
            ...
            <div className="space-y-4">
              {faqData.map((faq) => (
                <div key={faq.id} className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedFAQ === faq.id && (
                    <div className="px-6 pb-4 bg-gray-50 animate-fadeInUp">
