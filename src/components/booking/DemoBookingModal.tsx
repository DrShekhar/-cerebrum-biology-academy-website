              ...
              {!isSubmitted ? (
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <a
                      href={`https://wa.me/918826444334?text=${encodeURIComponent(`Hi! I want to book a demo class for ${courseTitle}. Please help me schedule.`)}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-2 w-full px-6 py-3 bg-[#25D366] hover:bg-[#20BD5A] text-white font-semibold rounded-2xl transition-colors min-h-[48px] touch-manipulation"
                    >
