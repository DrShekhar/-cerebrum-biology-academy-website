...
const StarIcon = () => (
  <svg
    className="h-5 xs:h-6 w-5 xs:w-6 group-hover:text-yellow-300 transition-colors flex-shrink-0"
    fill="none"
    viewBox="0 0 24 24"
    stroke="currentColor"
    strokeWidth={2}
...
const ClockIcon = ({ className }: { className?: string }) => (
  <svg
    className={className || 'w-4 xs:w-5 h-4 xs:h-5 mr-2 text-red-300 flex-shrink-0'}
    fill="none"
    viewBox="0 0 24 24"
    stroke="currentColor"
    strokeWidth={2}
...
const SparklesIcon = ({ className }: { className?: string }) => (
  <svg
    className={className || 'w-4 xs:w-5 h-4 xs:h-5'}
    fill="none"
    viewBox="0 0 24 24"
    stroke="currentColor"
    strokeWidth={2}
...
const MessageCircleIcon = ({ className }: { className?: string }) => (
  <svg
    className={
      className ||
      'h-5 xs:h-6 w-5 xs:w-6 text-[#25D366] group-hover:scale-110 transition-transform flex-shrink-0'
    }
    fill="none"
    viewBox="0 0 24 24"
    stroke="currentColor"
