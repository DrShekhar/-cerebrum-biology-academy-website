...
import { InternationalNavItems } from './InternationalNavItems'
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          >
            ...
            {/* By Exam dropdown + Global link: geo-gated client island —
                hidden for visitors browsing from inside India (owner rule),
                shown to international visitors and NRIs abroad. */}
