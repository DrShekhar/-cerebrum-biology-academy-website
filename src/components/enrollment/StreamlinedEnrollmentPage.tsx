...
export function StreamlinedEnrollmentPage({
  ...
  const counselingSlots: CounselingSlot[] = useMemo(() => {
    const counselors = ['Dr. Priya Sharma', 'Dr. Raj Kumar', 'Dr. Anjali Singh', 'Dr. Vikram Patel']
  ...
  const calculateAssessmentResult = (): AssessmentResult => {
    ...
    if (assessmentAnswers.studyHours === 'More than 6 hours') {
      timeToTarget = timeToTarget.replace(
        /(\d+)-(\d+)/,
        (_, min, max) => `${Math.max(3, parseInt(min) - 2)}-${parseInt(max) - 2}`
      )
    } else if (assessmentAnswers.studyHours === 'Less than 2 hours') {
      timeToTarget = timeToTarget.replace(
        /(\d+)-(\d+)/,
        (_, min, max) => `${parseInt(min) + 2}-${parseInt(max) + 2}`
      )
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        {currentStep === 0 && (
          <div key="assessment" className="max-w-3xl mx-auto animate-fadeInUp">
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="space-y-3">
                  ...
                  <div
                    ...
                    role="group"
                    aria-label="Select challenging topics"
                  >
        ...
        {currentStep === 1 && (
          <div key="counseling" className="max-w-4xl mx-auto animate-fadeInUp">
            {/* Assessment Results */}
            {assessmentResult && (
        ...
        {currentStep === 2 && (
          <div key="plan-selection" className="max-w-6xl mx-auto animate-fadeInUp">
            <div className="text-center mb-8">
              ...
              {planOptions.map((plan) => (
                ...
                >
                  ...
                  <div className="text-center mb-6">
                    ...
                    <div className="text-gray-600">or ₹{plan.emiPrice.toLocaleString()}/month</div>
        ...
        {currentStep === 3 && (
          <div key="enrollment" className="max-w-4xl mx-auto animate-fadeInUp">
            <PremiumCard variant="luxury" size="lg">
              <div className="text-center mb-8">
                <Clock className="w-12 h-12 sm:w-16 sm:h-16 text-blue-500 mx-auto mb-4" />
                <h2 className="text-3xl font-bold text-gray-900 mb-4">Complete Your Enrollment</h2>
                <p className="text-gray-600 text-lg">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      aria-describedby={
                        validationStates.fullName?.error ? 'fullName-error' : undefined
                      }
                    />
                    {validationStates.fullName?.error && (
                      ...
                      <p id="email-suggestion" className="mt-1 text-xs text-amber-600">
                        ...
                        <button
                          ...
                          onClick={() => {
                            setFormData({
                              ...formData,
                              email: validationStates.email?.suggestion || '',
                            })
                            validateField(
                              'email',
                              validationStates.email?.suggestion || '',
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      aria-describedby={
                        validationStates.parentName?.error ? 'parentName-error' : undefined
                      }
                    />
                    {validationStates.parentName?.error && (
        ...
        {/* Step 4: Success */}
        {currentStep === 4 && (
          <div key="success" className="max-w-3xl mx-auto text-center animate-fadeInUp">
            <PremiumCard variant="luxury" size="xl">
              ...
              <div className="bg-green-50 border border-green-200 rounded-xl p-6 mb-8">
                ...
                <div className="space-y-3 text-left">
                  <div className="flex items-center space-x-3">
                    <CheckCircle2 className="w-5 h-5 text-green-600" />
                    <span className="text-green-800">Enrollment confirmation SMS & email sent</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle2 className="w-5 h-5 text-green-600" />
