    ...
    return (
      <div className="w-full">
        <input
          type={type}
          className={cn(
            'flex h-12 min-h-[48px] w-full rounded-lg border bg-white px-3 sm:px-4 py-2 sm:py-3 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-200',
            error
