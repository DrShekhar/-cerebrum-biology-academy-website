...
export default function NEETFoundationClass9NoidaContent({ faqs }: { faqs: FAQ[] }) {
  const [openFaq, setOpenFaq] = useState<number | null>(null)

  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'foundation-class9-noida',
      message:
        'Hi! I am a Class 9 student from Noida interested in NEET Foundation course. Please share details.',
      campaign: 'foundation-class9-noida',
    })
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              NEET Foundation Class 9<span className="block text-green-400 mt-2">in Noida</span>
            </h1>
      ...
      <section className="py-16 bg-gradient-to-br from-green-600 to-teal-600 text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-8 animate-fadeInUp">
            <h2 className="text-3xl font-bold mb-4">Students from Premium Noida Schools</h2>
            <p className="text-green-100">We have students from all major schools in Noida</p>
          </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            <Link href="/courses" className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md">
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-green-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join Cerebrum Biology Academy Noida and get a 4-year head start
          </p>
