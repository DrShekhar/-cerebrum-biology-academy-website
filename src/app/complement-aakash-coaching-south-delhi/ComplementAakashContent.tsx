...
const benefits = [
  {
    ...
    description:
      'Aakash South Extension Part 1 is literally across the road from our D-35 South Extension Part 2 flagship. Zero extra commute.',
    icon: MapPin,
  },
  {
...
const successStats = [
  { stat: '360/720', label: 'NEET marks come from Biology' },
  { stat: '15-20', label: 'Students per Cerebrum batch' },
  { stat: '98%', label: 'NEET qualification success rate' },
  { stat: '0 min', label: 'Extra commute (across the road)' },
]
...
export default function ComplementAakashContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'complement-aakash-coaching-south-delhi',
      message:
        'Hi! I am an Aakash student in South Delhi and want to join Cerebrum for extra Biology coaching. Please share the schedule and fees.',
      campaign: 'complement-aakash-south-delhi',
    })
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              Don't leave Aakash. Keep Physics and Chemistry there, and add focused Biology coaching
              from AIIMS-trained faculty — literally across the road from Aakash South Extension.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4 mb-8">
              ...
              <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-lg text-white">
                ...
                <span>Classroom or Live Online</span>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeInUp">
              ...
              <p className="text-xl text-indigo-100 mb-6">
                Aakash's South Extension Part 1 centre is literally across the road from our
                flagship at <strong>D-35, South Extension Part 2</strong>. The Aakash Kalu Sarai hub
                is only about 10 minutes away. Finish your Aakash class and walk over for Biology.
              </p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  Keep Aakash for Physics & Chemistry, add Cerebrum for Biology
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  Attend right after your Aakash class — same neighbourhood
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  Easy metro access for PG students from Ber Sarai, Katwaria Sarai & Lajpat Nagar
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  Every batch also available live online
                </li>
              </ul>
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Biology%20coaching%20in%20South%20Delhi.%20Please%20share%20available%20timings."
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-slate-600 mb-6">
                  ...
                  AIIMS and steps from South Extension Metro. We also have a second South Delhi
                  centre at <strong>B-113 Gulmohar Park</strong> (Green Park).
                </p>
                <div className="space-y-3 mb-6">
                  ...
                  <p className="flex items-center gap-2">
                    ...
                    Across the road from Aakash South Extension Part 1
                  </p>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <Link
              ...
              className="bg-gray-50 p-4 rounded-xl hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">NEET Coaching Kalu Sarai</h3>
              <p className="text-sm text-gray-600">Near the Kalu Sarai coaching hub</p>
            </Link>
            <Link
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Keep Aakash for Physics & Chemistry — add Cerebrum as your Biology specialist
          </p>
