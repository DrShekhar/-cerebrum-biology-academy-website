                        ...
                        >
                          <td className="py-4 px-4">
                            <div className="flex items-center gap-2">
                              ...
                              <span
                                className={
                                  college.highlight ? 'text-amber-300 font-semibold' : 'text-white'
                                }
                              >
                                {college.name}
                              </span>
              ...
              <div className="max-w-4xl mx-auto animate-fadeInUp">
                ...
                <div className="text-center mt-8">
                  <p className="text-2xl font-bold text-white">
                    Save <span className="text-green-400">₹4,35,000+</span> and stay in HP's best
                    study environment!
                  </p>
                </div>
              </div>
            ...
            <div className="container mx-auto px-4">
              <div className="text-center max-w-3xl mx-auto animate-fadeInUp">
                ...
                <p className="text-slate-400 mt-6">
                  Join 280+ students from Hamirpur district who chose expert guidance over local
                  coaching
                </p>
              </div>
            </div>
