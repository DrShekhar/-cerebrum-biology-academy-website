...
const rohiniAreas = [
  ...
  { name: 'Sector 7', highlight: 'School Area' },
  { name: 'Sector 9', highlight: 'Residential' },
  { name: 'DC Chowk (Center)', highlight: 'Visit Us' },
  { name: 'Sector 11-13', highlight: 'Extended' },
  { name: 'Pitampura', highlight: '5 min away' },
  { name: 'Prashant Vihar', highlight: 'Adjacent' },
  { name: 'Shalimar Bagh', highlight: '10 min away' },
]

const faqs = [
  {
    question: 'What are the biology tuition fees in Rohini?',
    answer:
      'Cerebrum Biology Academy charges \u20B948,000/year (\u20B94,000/month) for Class 11-12 biology tuition in Rohini. Private home tutors in Rohini charge \u20B95,000-8,000/month. Our fee includes study materials, weekly tests, recorded lectures, and 24/7 doubt support.',
  },
  {
    question: 'Which is the best biology tutor near Rohini Sector 9?',
    answer:
      'Cerebrum Biology Academy at DC Chowk is the top-rated biology tuition near Rohini Sector 9 with 5.0 Google rating. Our AIIMS-trained faculty offers CBSE Board + NEET dual preparation. Students from Sector 3, 7, 9, Pitampura, and Prashant Vihar attend here.',
  },
  {
    question: 'Is home tuition or coaching better for biology in Rohini?',
    answer:
      'Coaching at Cerebrum is better than home tuition. Home tutors charge \u20B95-8K/month with no test series or study material. Cerebrum offers AIIMS faculty, weekly tests, peer learning in batches of 15, recorded lectures, and complete study materials \u2014 all at \u20B94K/month.',
  },
  {
    question: 'How do I reach Cerebrum biology tuition center in Rohini?',
    answer:
      'Our Rohini center is located at DC Chowk, easily accessible from Rohini West and Rithala metro stations. Students from Sector 3, 7, 9, Pitampura, Prashant Vihar, and Shalimar Bagh can reach within 10-15 minutes. Call 88264-44334 for directions.',
  },
  {
    question: 'Do you offer CBSE Board + NEET combined preparation in Rohini?',
    answer:
      'Yes. Our dual-prep curriculum covers 100% NCERT (required for both CBSE Board and NEET) with additional NEET-level MCQ practice. Most Rohini parents prefer this over hiring separate tutors for board exams and NEET entrance preparation.',
  },
]
    ...
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="text-center max-w-5xl mx-auto">
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              ...
              #1 Biology Tuition in Rohini | CBSE + NEET
            </div>

            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              Best <span className="text-yellow-300">Biology Tuition</span> in Rohini
            </h1>

            <h2 className="text-xl md:text-2xl opacity-90 mb-4">
              Class 11 &bull; Class 12 &bull; CBSE Board &bull; NEET &bull; DC Chowk Center
            </h2>

            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-4xl mx-auto">
              CBSE Board + NEET dual preparation by AIIMS Alumnus at DC Chowk center. Sector 3, 7,
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Rohini Parents Choose Cerebrum Over Private Tutors
            </h2>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Rohini &amp; Nearby Areas We Serve
            </h2>
            <p className="text-lg text-gray-600">
              DC Chowk center accessible from all Rohini sectors and nearby areas
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
          ...
          <div className="mt-12 max-w-2xl mx-auto bg-green-50 border border-green-200 rounded-xl p-6 text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Visit Our Rohini Center</h3>
            <p className="text-gray-700 mb-2">DC Chowk, Rohini, New Delhi 110085</p>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Biology Tuition in Rohini - FAQs
            </h2>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-green-600 via-green-600 to-green-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Start Biology Tuition in Rohini Today
          </h2>
