...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/biology-tutor-indirapuram',
  },
}

export default function BiologyTutorIndirapuramLayout({ children }: { children: React.ReactNode }) {
  return children
}
