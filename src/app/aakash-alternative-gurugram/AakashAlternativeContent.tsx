        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              ...
              Discover why 400+ Gurugram students chose Cerebrum for focused NEET Biology
              preparation.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-4">
                  Conveniently Located in Sector 51
                </h2>
                <p className="text-slate-600 mb-6">
                  Our Gurugram center is at <strong>M2K Corporate Park, Sector 51</strong> - easily
                  accessible from Golf Course Road and Rapid Metro. Perfect location for students
                  from all parts of Gurugram.
                </p>
                <div className="space-y-3 mb-6">
                  ...
                  <p className="flex items-center gap-2">
                    <Clock className="w-5 h-5 text-purple-600" />5 min walk from Sector 55-56 Rapid
                    Metro
                  </p>
                </div>
