...
const reasons = [
  { title: 'Lost in Digital Overload?', description: 'the 2nd-largest national NEET chain\'s heavy app-based approach can overwhelm. At Cerebrum, technology enhances - not replaces - personal teaching.', icon: Zap },
...
const testimonials = [
  { name: 'Kavya T.', score: '648/720', previous: 'Ex-the 2nd-largest national NEET chain Student', quote: 'Left the 2nd-largest national NEET chain after Class 11. The personal mentorship at Cerebrum helped me focus on my weak areas. Biology score improved by 50 marks.' },
  { name: 'Arjun P.', score: '625/720', previous: 'the 2nd-largest national NEET chain + Cerebrum', quote: 'Continued the 2nd-largest national NEET chain for their test series but joined Cerebrum for Biology concepts. The combination worked perfectly for me.' },
  { name: 'Sneha K.', score: '632/720', previous: 'Dropper from the 2nd-largest national NEET chain', quote: 'After a disappointing first attempt, switched to Cerebrum. The small batch and focused approach helped me crack NEET in second attempt.' },
]
...
export default function AakashAlternativeContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      ...
      message: 'Hi! I am currently at the 2nd-largest national NEET chain/considering the 2nd-largest national NEET chain and want to know about Cerebrum as an alternative for NEET Biology. Please share details.',
  ...
  return (
    <main className="min-h-screen bg-white">
      <nav className="bg-gray-100 py-3 px-4">
        <div className="max-w-7xl mx-auto">
          <ol className="flex items-center flex-wrap gap-1 text-sm">
            ...
            <li className="flex items-center"><ChevronRight className="w-4 h-4 text-gray-400 mx-1" /><span className="text-teal-700 font-medium">the 2nd-largest national NEET chain Alternative</span></li>
          </ol>
        </div>
      </nav>
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Looking for an
              <span className="block text-yellow-400 mt-2">the 2nd-largest national NEET chain Alternative in Gurugram?</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button onClick={handleWhatsApp}
                ...
                <Phone className="w-5 h-5" />Compare with the 2nd-largest national NEET chain Expert
              </button>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Why Students Switch from the 2nd-largest national NEET chain</h2>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Cerebrum vs the 2nd-largest national NEET chain: Head-to-Head</h2>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeInUp">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Don't Want to Leave the 2nd-largest national NEET chain?<br />Complement Your Coaching!</h2>
              <p className="text-xl text-indigo-100 mb-6">
                Many students continue at the 2nd-largest national NEET chain for Physics & Chemistry while joining Cerebrum specifically for Biology.
                Get the best of both worlds.
              </p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-green-400" />Weekend batches that don't clash with the 2nd-largest national NEET chain</li>
                ...
                <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-green-400" />Use the 2nd-largest national NEET chain's digital resources + our expert teaching</li>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">From the 2nd-largest national NEET chain Students Who Switched</h2>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <Link href="/allen-alternative-gurugram" className="bg-gray-50 p-4 rounded-xl hover:shadow-md"><h3 className="font-semibold text-teal-600">the largest national NEET chain Alternative</h3><p className="text-sm text-gray-600">Compare with the largest national NEET chain</p></Link>
            <Link href="/complement-aakash-coaching-gurugram" className="bg-gray-50 p-4 rounded-xl hover:shadow-md"><h3 className="font-semibold text-teal-600">Complement the 2nd-largest national NEET chain</h3><p className="text-sm text-gray-600">Add Biology support</p></Link>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">Join 400+ students who switched from the 2nd-largest national NEET chain for better Biology coaching</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Biology%20coaching%20in%20Gurugram.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer"><Button variant="secondary" size="xl" className="bg-white text-purple-600 hover:bg-gray-100 font-bold"><Play className="w-5 h-5 mr-2" />Book Free Demo</Button></Link>
