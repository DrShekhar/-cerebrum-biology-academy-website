...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'NEET 2025 Results Gurugram | 97% Success',
    description: 'Cerebrum Biology Academy NEET 2025 results: 97% qualification rate, 15 students scored 650+, 4 in top 5000 AIR. Our best year yet! Call 88264-44334!',
  },
}
...
const faqs = [
  {
    ...
    answer:
      'Our NEET 2025 success rate was 97% - 151 out of 156 students qualified. 58 students scored above 600, and 15 scored above 650. This was our best performance with 4 students in top 5000 AIR.',
  },
  {
    question: "Who was Cerebrum's NEET 2025 topper?",
    answer:
      'Ishita Malhotra topped our batch with 702/720 marks and AIR 1,892 - our first student to cross 700! She secured admission to AIIMS Delhi. She was a 2-year program student from DPS Sector 45.',
  },
  {
    question: 'How did droppers perform in NEET 2025?',
    answer:
      'Droppers showed remarkable improvement with average gain of 98 marks. Kavya Reddy improved by 112 marks (567 to 679) and secured AIIMS Jodhpur. 85% of our dropper students qualified.',
  },
  {
    question: 'How does 2025 compare to 2024 results?',
    answer:
      'NEET 2025 was our best year: 4 students in top 5000 (vs 3 in 2024), 15 students 650+ (vs 12), average score 635 for 600+ batch (vs 628). Student strength grew 23% to 156.',
  },
]
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex items-center justify-center gap-2 text-yellow-300 mb-8">
              ...
              <span className="text-2xl font-bold">
                97% Success | 15 Students 650+ | First 700+ Scorer!
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 max-w-6xl mx-auto">
            {overallStats.map((stat, index) => (
              <div key={index} className="bg-green-50 rounded-xl p-4 text-center">
                ...
                {stat.subtext && (
                  <p className="text-lg font-semibold text-green-500">{stat.subtext}</p>
                )}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {toppers.map((topper, index) => (
              <div
                key={index}
                className={`bg-white rounded-xl shadow-lg overflow-hidden ${index === 0 ? 'ring-2 ring-green-500' : ''}`}
              >
                {index === 0 && (
