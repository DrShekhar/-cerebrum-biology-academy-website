...
export const metadata: Metadata = {
  ...
  description:
    'RE-NEET 2026 coaching for Hyderabad students (Telangana + AP) after the 12 May NEET cancellation. Online biology-only AIIMS-trained crash — alongside your Sri Chaitanya and Narayana / PhysicsWallah (PW) / Allen Hyderabad main coaching.',
  keywords: [
  ...
  twitter: {
    ...
    title: 'RE-NEET 2026 Coaching in Hyderabad | Online Biology Crash Course',
    description:
      'RE-NEET 2026 coaching for Hyderabad students (Telangana + AP) after the 12 May NEET cancellation. Online biology-only AIIMS-trained crash — alongside your Sri Chaitanya and Narayana / a leading nati...',
  },
}
