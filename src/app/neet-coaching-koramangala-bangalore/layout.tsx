...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Premium NEET biology coaching in Koramangala with 94.2% success rate. AIIMS faculty, startup-era platform. Perfect for Bangalore startup families.',
  ...
  twitter: {
    ...
    description:
      'Premium NEET biology coaching in Koramangala. 94.2% success rate. All blocks, BTM Layout, Madiwala, Ejipura.',
  },
  alternates: {
