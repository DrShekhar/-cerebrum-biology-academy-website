...
export const metadata: Metadata = {
  title: 'Best NEET Coaching in Koramangala Bangalore | BTM Layout',
  description:
  ...
  openGraph: {
    title: 'Best NEET Coaching in Koramangala Bangalore | Startup Hub',
    description:
  ...
  twitter: {
    ...
    title: 'Best NEET Coaching in Koramangala Bangalore',
    description:
