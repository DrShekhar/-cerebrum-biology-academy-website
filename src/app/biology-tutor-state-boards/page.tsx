        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20%E2%80%94%20interested%20in%20tutor%20state%20boards.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer">
                <Button
                  variant="secondary"
                  size="xl"
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {statesSupported.map((state, index) => (
              <div
                key={state.name}
                className="bg-white rounded-xl p-4 shadow-lg text-center animate-fadeInUp"
              >
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {classesOffered.map((item, index) => (
              <div
                key={item.class}
                className="bg-amber-50 rounded-xl p-6 text-center animate-fadeInUp"
              >
          ...
          <div
           className="animate-fadeInUp">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="https://wa.me/918826444334?text=Hi!%20I'm%20interested%20in%20tutor%20state%20boards.%20Please%20share%20fee%20structure%20and%20enrolment%20details." target="_blank" rel="noopener noreferrer">
                <Button
                  variant="outline"
                  size="xl"
