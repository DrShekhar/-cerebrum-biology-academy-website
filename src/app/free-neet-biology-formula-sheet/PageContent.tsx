    ...
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 via-white to-gray-50">
      ...
      <section className="relative py-16 bg-gradient-to-r from-indigo-700 via-indigo-600 to-indigo-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-indigo-100 mb-2">All Important Equations & Ratios on One Page</p>
          <p className="text-lg text-indigo-200 max-w-2xl mx-auto mb-8">
            Every formula, equation, and ratio you need for NEET Biology on a single printable sheet. From Mendelian ratios to Hardy-Weinberg, enzyme kinetics to population ecology.
          </p>
          <Link
          ...
          <p className="text-sm text-indigo-200 mt-3">WhatsApp +91-8826444334 to receive instantly</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-600 to-indigo-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-indigo-100 mb-8 text-lg">Join 10,000+ NEET aspirants who have already downloaded this resource.</p>
          <Link
            href="https://wa.me/918826444334?text=Hi%20I%20want%20the%20free%20formula%20sheet"
            className="inline-flex bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-lg font-bold text-lg items-center gap-2 transition-colors shadow-lg"
          >
          ...
          <p className="text-sm text-indigo-200 mt-4">Instant delivery on WhatsApp | 100% Free | No spam</p>
        </div>
      </section>
      ...
      <section className="py-12 max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-4">
          <Link href="/pricing" className="text-indigo-600 hover:text-indigo-800 font-semibold">View Courses &rarr;</Link>
          <Link href="/nri-students" className="text-indigo-600 hover:text-indigo-800 font-semibold">NRI Students &rarr;</Link>
          <Link href="/free-resources" className="text-indigo-600 hover:text-indigo-800 font-semibold">More Free Resources &rarr;</Link>
        </div>
      </section>
    </div>
  )
