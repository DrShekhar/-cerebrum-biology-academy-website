...
export const metadata: Metadata = {
  title: 'Cerebrum vs Unacademy for NEET Biology | Specialist vs Subscription Platform',
  description:
...
const config: CompetitorComparisonConfig = {
  ...
  table: [
    ...
    },
    {
      ...
      cerebrum: 'Standalone biology + PhysicsWallah / Unacademy for PC',
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        'Yes — this is a popular Cerebrum student pattern. Cerebrum biology-only Ascent ₹58K-90K + Unacademy Plus PC subscription ₹20K-40K = total ₹78K-1.3L with materially better biology than combined Unacademy and comparable PC coverage. The alternative pattern is Cerebrum biology + PhysicsWallah PCB ₹10K-20K for tighter cost (₹68K-1.1L total). Both patterns deliver better biology pedagogy than full-Unacademy NEET while staying within reasonable budget.',
    },
    {
