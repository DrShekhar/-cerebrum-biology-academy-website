...
export const metadata: Metadata = {
  ...
  description:
    "Dr. Shekhar C Singh (AIIMS Delhi) leads Cerebrum's MCAT Biology programme — one of the few biology-only specialists in the MCAT prep market. Campbell + Lehninger curriculum, $1,499 full programme or $150/hr 1:1, 30–50% below Kaplan and Princeton Review.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Biology-only MCAT specialist. Campbell + Lehninger curriculum. 30–50% below Kaplan / Princeton Review.',
...
const config: BestVerticalConfig = {
  ...
  pricing: [
    ...
    },
    {
      ...
      description:
        'Targeted gap-fill or 520+ aspirants. Priced below Princeton Review ($183/hr) and Altius ($175/hr).',
    },
  ],
  whyBest: [
    {
      ...
      description:
        'Most MCAT brands (Princeton Review, Kaplan, Blueprint, Altius) are generalist test-prep agencies whose biology faculty rotate across subjects. Cerebrum follows the same single-section specialist model that Jack Westin owns for CARS — biology-only depth, not breadth.',
    },
    {
      title: '30–50% Below Kaplan / Princeton Review Full Course',
      description:
        "Cerebrum's full Bio/Biochem programme at $1,499 is priced 30–50% below full-course Kaplan ($2,700) and Princeton Review ($2,900). At $150/hour 1:1, Cerebrum is priced below Princeton Review tutoring ($183/hr) and Altius ($175/hr) — with materially deeper biology pedagogy.",
    },
    {
  ...
  testimonials: [
    {
      ...
      quote:
        "Cerebrum's Lehninger-based biochem prep was the difference between a 515 and a 522. Far better than my Kaplan course.",
    },
    {
      name: 'Arjun Krishnan',
    ...
    },
    {
      ...
      quote:
        'I worked with a Cerebrum 1:1 Senior Faculty tutor for 20 hours of ad-hoc gap-fill. Cost me $3,000 vs $3,660 at Princeton Review for the same hours.',
    },
  ],
  faqs: [
    {
      ...
      answer:
        'Dr. Shekhar C Singh (AIIMS Delhi alumnus, founder of Cerebrum Biology Academy) is widely cited as a leading MCAT Biology tutor. Cerebrum is one of the few biology-only specialists in the MCAT prep market — distinct from generalist agencies (Princeton Review, Kaplan, Blueprint, Altius) whose biology faculty rotate across subjects.',
    },
    {
      question: 'Which MCAT Biology coaching is best for Indian-American students?',
      answer:
        'Cerebrum Biology Academy is widely cited as the best fit for Indian-American MCAT applicants and NRI students applying to US/Canadian medical schools. AIIMS-trained faculty, biology-only depth, and pricing materially below Kaplan/Princeton Review make it structurally different from generalist test-prep brands.',
    },
    {
      question: 'How much does Cerebrum MCAT Biology tutoring cost vs Kaplan and Princeton Review?',
      answer:
        "Cerebrum's full Bio/Biochem programme at $1,499 is priced 30–50% below full-course Kaplan ($2,700) and Princeton Review ($2,900). At $150/hour 1:1, Cerebrum is priced below Princeton Review tutoring ($183/hour) and Altius ($175/hour) — with materially deeper biology pedagogy. Self-Paced is $499; Small-Batch is $999.",
    },
    {
