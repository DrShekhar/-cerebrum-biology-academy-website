...
export default function AreaPageContent({ area, areaSlug }: AreaPageContentProps) {
  const handleDemoBooking = () => {
    if (typeof window !== 'undefined' && (window as any).gtag) {
      ;(window as any).gtag('event', `demo_booking_gurugram_${areaSlug}`, {
        event_category: 'conversion',
        event_label: `neet_coaching_gurugram_${areaSlug}`,
        value: 1,
      })
    }
  }

  const nearbyAreas = getNearbyGurugramAreas(areaSlug)
      ...
      <nav className="bg-gray-100 py-3 px-4" aria-label="Breadcrumb">
        <div className="max-w-7xl mx-auto">
          <ol className="flex items-center flex-wrap gap-1 text-sm">
            ...
            <li className="flex items-center">
              <ChevronRight className="w-4 h-4 text-gray-400 mx-1" />
              <span className="text-teal-700 font-medium">{area.name}</span>
            </li>
          </ol>
        </div>
      </nav>
          ...
          <section className="py-10 bg-white border-b border-gray-100">
            <div className="max-w-4xl mx-auto px-4">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
                NEET Biology coaching in {area.name}, Gurugram
              </h2>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="quick-answers">
            <QuickAnswers locality={`${area.name}, Gurugram`} />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {gurugramCourseOptions.map((course, index) => (
              <div
                key={course.name}
          ...
          <div className="bg-gradient-to-br from-teal-50 to-blue-50 rounded-2xl p-8 animate-fadeInUp">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  <strong>Nearest Metro:</strong> Sector 55-56 Rapid Metro (5 min walk)
                </p>
              </div>
              <div className="space-y-3">
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    'Safe & secure campus',
                    'Easy access from all Gurugram sectors',
                  ].map((item) => (
                ...
                return (
                  <div key={slug} className="animate-fadeInUp">
                    ...
                    >
                      ...
                      <h3 className="font-bold text-gray-900 mb-2 group-hover:text-teal-700">
                        {nearbyArea.name}
                      </h3>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="animate-fadeInUp">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              ...
              <Link href="/neet-coaching-gurugram">
                <Button
                  variant="outline"
                  size="xl"
