...
const gurugramLocalities = [
  ...
  // AAKASH COMPETITOR AREAS
  {
    ...
    slug: 'sector-49',
    students: '145+',
    highlight: 'Near Allen - Better Alternative',
    priority: 'high',
  },
  {
    ...
    slug: 'sector-84',
    students: '55+',
    highlight: 'Near Allen - 60% Cheaper',
    priority: 'high',
  },
  {
    name: 'Sector 14',
...
export default function NeetCoachingGurugramPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <StickyMobileCTABar waUrl="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20for%20NEET%20Biology%20coaching%20in%20Gurugram.%20Please%20share%20timings." />
    </div>
  )
}
