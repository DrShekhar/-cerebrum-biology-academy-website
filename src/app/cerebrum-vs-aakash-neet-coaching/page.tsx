...
export const metadata: Metadata = {
  title: 'Cerebrum vs Aakash NEET Coaching | Delhi NCR Comparison',
  description:
...
export default function CerebrumVsAakashPage() {
  const comparisonSchema = {
    ...
    description:
      'Detailed comparison of Cerebrum Biology Academy and Aakash for NEET preparation in Delhi NCR',
    mainEntity: {
      '@type': 'ItemList',
      itemListElement: [
        {
