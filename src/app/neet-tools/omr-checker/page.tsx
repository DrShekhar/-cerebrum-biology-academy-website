  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        {step === 'password' && (
          <div key="password" className="max-w-md mx-auto animate-fadeInUp">
        ...
        {step === 'subject' && (
          <div key="subject" className="max-w-2xl mx-auto animate-fadeInUp">
            <div className="bg-white rounded-2xl shadow-lg p-8">
        ...
        {step === 'paper' && (
          <div key="paper" className="max-w-2xl mx-auto animate-fadeInUp">
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <button
        ...
        {step === 'answers' && selectedPaper && (
          <div key="answers" className="animate-fadeInUp">
        ...
        {step === 'result' && result && selectedPaper && (
          <div key="result" className="animate-fadeInUp">
            <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
              <div className="text-center mb-8">
                <div
                  ...
                  <tbody>
                    {Object.entries(result.sectionResults).map(([section, data]) => (
                      <tr key={section} className="border-b">
                        ...
                        <td className="px-4 py-3 text-center text-gray-400">{data.unattempted}</td>
