...
export default function NEETFoundationClass10Content({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'foundation-class10-faridabad',
      message:
        'Hi! I am a Class 10 student from Faridabad interested in NEET Foundation course. Please share details.',
      campaign: 'foundation-class10-faridabad',
    })
  }
    ...
    <main className="min-h-screen bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              ...
              with your board syllabus. Get a 2-year head start at our Sector 17, Faridabad center.
            </p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              Why Start NEET Prep from Class 10?
            </h2>
            <p className="text-xl text-slate-600">
      ...
      <section className="py-16 bg-gradient-to-br from-blue-600 to-teal-600 text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-8 animate-fadeInUp">
            ...
            <p className="text-blue-100">Trusted by students from top schools in Faridabad</p>
          </div>
