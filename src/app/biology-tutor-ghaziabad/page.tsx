...
const ghaziabadAreas = [
  ...
  { name: 'Vaishali', distance: '10 km', metro: 'Vaishali Metro', landmark: 'Mahagun Mall' },
  { name: 'Kaushambi', distance: '12 km', metro: 'Kaushambi Metro', landmark: 'Anand Vihar ISBT' },
  { name: 'Vasundhara', distance: '7 km', metro: 'Vaishali Metro', landmark: 'Sector 1-16' },
  { name: 'Raj Nagar Extension', distance: '15 km', metro: 'Near Aqua Line', landmark: 'NH-24' },
  { name: 'Crossings Republik', distance: '6 km', metro: 'Aqua Line', landmark: 'Crossing Mall' },
  { name: 'Sahibabad', distance: '14 km', metro: 'Mohan Nagar', landmark: 'Industrial Area' },
  { name: 'Vijay Nagar', distance: '16 km', metro: 'Blue Line', landmark: 'Ghaziabad City' },
]

const whyChooseUs = [
  {
    icon: Building2,
    title: 'Ghaziabad Coverage',
    description: 'Serving all major areas - Indirapuram, Vaishali, Kaushambi, and more.',
  },
  {
    icon: GraduationCap,
    title: 'AIIMS Faculty',
  ...
  },
  {
    ...
    description: 'Proven track record with students from across Ghaziabad.',
  },
  {
    icon: Star,
    title: 'Metro Connected',
    description: 'Easy access via Blue Line and Aqua Line metros.',
  },
]
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Yes! We have many students from Indirapuram, Vaishali, Kaushambi, and other Ghaziabad areas. Parents appreciate that we offer quality teaching with AIIMS faculty, which is rare in local coaching centers.',
  },
  {
    question: 'Is metro connectivity good from Ghaziabad?',
    answer:
      'Yes! Ghaziabad has excellent metro connectivity. From Vaishali or Kaushambi, you can reach Greater Noida via the Aqua Line. The journey takes about 30-40 minutes.',
  },
  {
    question: 'Do you offer online classes for Ghaziabad students?',
    answer:
...
export default function BiologyTutorGhaziabadPage() {
    ...
    <div className="min-h-screen">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              'Best Biology Tutor for Ghaziabad students - NEET & Board exam preparation',
            ...
            areaServed: ['Ghaziabad', 'Indirapuram', 'Vaishali', 'Kaushambi', 'Vasundhara'],
            priceRange: '$$',
          }),
        }}
      />
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              ...
              Serving Indirapuram, Vaishali & All Ghaziabad
            </div>

            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Biology Tutor in <span className="text-yellow-400">Ghaziabad</span>
            </h1>

            <h2 className="text-xl md:text-2xl opacity-90 mb-4">
              NEET & Board Preparation | Indirapuram | Vaishali | Kaushambi
            </h2>

            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              Expert Biology coaching for Ghaziabad students. Learn from{' '}
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Quality NEET coaching accessible from all major Ghaziabad localities
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              Why Ghaziabad Students Choose Us
            </h2>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 via-green-700 to-blue-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-6">Ghaziabad Students, Join Us!</h2>
