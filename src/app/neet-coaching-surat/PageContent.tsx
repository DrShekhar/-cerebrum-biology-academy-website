...
export default function PageContent() {
  ...
  return (
    <div className="w-full">
      <CityBreadcrumb cityName="Surat" stateName="Gujarat" stateSlug="gujarat" />
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8 inline-block">
            <span className="text-sm font-semibold text-blue-600 bg-blue-50 px-4 py-2 rounded-full">Diamond City - Best NEET Coaching in Surat</span>
          </div>
          
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-gray-900 mb-6 leading-tight">
            Best NEET Coaching<br className="hidden sm:block" /> in <span className="text-blue-600">Surat</span>
          </h1>
          
          <p className="text-xl sm:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto font-light">
            Top NEET Biology coaching in growing education hub Surat. AIIMS faculty. 98% success rate. 695/720 top score.
          </p>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl sm:text-5xl font-bold text-center text-gray-900 mb-16">Why Choose Cerebrum for NEET in Surat?</h2>
          ...
          <div ref={features.ref} className={`grid grid-cols-1 md:grid-cols-2 gap-8 transition-opacity duration-1000 ${features.isVisible ? 'opacity-100' : 'opacity-0'}`}>
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Growing Education Hub</h3>
                  <p className="text-gray-600">Surat's booming education culture. AIIMS faculty network strong. Rising NEET preparation demand.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Gujarat Board Specialists</h3>
                  <p className="text-gray-600">Perfect curriculum for Gujarat board students. Board + NEET integrated success strategy.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">Online + offline batches. Live interactive sessions. Recorded classes available 24x7.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">NCERT + advanced materials, chapter tests, 12 full-length mocks, career counseling.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl sm:text-5xl font-bold text-center text-gray-900 mb-4">NEET Coaching in Surat Areas</h2>
          <p className="text-center text-gray-600 mb-16 max-w-2xl mx-auto">Coaching centers across prime localities in Surat, Gujarat</p>
          ...
          <div ref={areas.ref} className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 transition-opacity duration-1000 ${areas.isVisible ? 'opacity-100' : 'opacity-0'}`}>
            {['Athwa', 'Vesu', 'Adajan', 'Urvashi Complex', 'Dumas Road', 'Pal', 'Nana Varachha', 'Chandan Nagar'].map((area) => (
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div ref={faq.ref} className={`space-y-6 transition-opacity duration-1000 ${faq.isVisible ? 'opacity-100' : 'opacity-0'}`}>
            {[
              {
                q: 'Is Surat good for NEET preparation?',
                a: 'Excellent! Growing education hub with peaceful environment, good colleges, and strong NEET culture development.'
              },
              {
                q: 'Do you specialize in Gujarat board curriculum?',
                a: 'Yes! Dedicated Gujarat board integration with NEET. Students excel in both board and competitive exams.'
              },
              {
                q: 'Do you have centers in Athwa/Vesu area?',
                a: 'Yes! Main center in premium location with online + offline batches available across Surat.'
              },
              {
                q: 'What is the batch strength and mentoring?',
                a: 'Small batches (15-20 students) with personalized mentoring, weekly progress meetings, individual study plans.'
              },
              {
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">Crack NEET from Diamond City Surat!</h2>
          <p className="text-xl text-blue-100 mb-8">Join Surat's fastest-growing NEET coaching hub. Excellence with Gujarat board advantage.</p>
      ...
      <RelatedCityLinks currentCity="surat" variant="default" />
    </div>
  )
}
