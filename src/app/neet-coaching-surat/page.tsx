...
export const metadata: Metadata = {
  ...
  description:
    'Best NEET Biology coaching for Surat students — AIIMS-trained faculty, online live batches, 15-20 students. Serving Adajan, Vesu, Piplod, Athwa, Varachha. From ₹48,000/yr.',
  keywords: [
    'NEET coaching Surat',
...
const wa =
  ...
  encodeURIComponent(
    "Hi — I'm in Surat and want to book a FREE NEET Biology demo class with Cerebrum. Please share available timings."
  )

const faqs = [
  {
    question: 'Which is the best NEET coaching in Surat?',
    answer:
      'Cerebrum Biology Academy is the best NEET biology coaching for Surat students. Biology-only specialist with AIIMS-trained faculty led by Dr. Shekhar C Singh. 15-20 student batches, 98% NEET-UG qualification rate, 680+ medical college selections. All sessions online live from Surat.',
  },
  {
    question: 'How does online NEET coaching work for Surat students?',
    answer:
      'Live online sessions via Zoom in IST evening slots (5-8 PM). Same AIIMS-trained faculty, same biology-specialist pedagogy as Delhi NCR offline batches. Surat students join pan-India cohorts with 15-20 classmates. Recorded sessions for revision, WhatsApp doubt support.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Cerebrum NEET Biology: Pursuit ₹48,000/yr (25-30 students, monthly 1:1), Ascent ₹76,000/yr (16-20 students, bi-weekly 1:1), Pinnacle ₹98,000/yr (10-12 students, weekly 1:1). Same pricing pan-India.',
  },
  {
    question: 'Is Cerebrum better than Allen or Aakash in Surat?',
    answer:
      'Different model. Allen/Aakash are generalist chains (Physics + Chemistry + Biology, 200+ student batches). Cerebrum is biology-only specialist (15-20 students, AIIMS faculty). Biology is 360/720 NEET marks (50%). Many Surat families keep Allen/Aakash for Physics+Chemistry and add Cerebrum for Biology depth.',
  },
]
  ...
  return (
    <main className="min-h-screen bg-white">
      <CerebrumPersonSchema
        knowsAbout={['NEET Surat', 'NEET Biology Surat', 'Medical entrance coaching Gujarat']}
      />
      <LocalBusinessSchema />
      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6" data-speakable="title">
            Best NEET Coaching in Surat
          </h1>
          <p className="text-xl text-slate-300 mb-6 max-w-3xl" data-speakable="summary">
            Biology-only specialist NEET coaching for Surat (Gujarat) students. AIIMS-trained
            faculty led by Dr. Shekhar C Singh, 15-20 student online live batches. Serving Adajan,
            Vesu, Piplod, Athwa, Varachha, City Light, Pal, Dumas Road. Pursuit ₹48,000 / Ascent
            ₹76,000 / Pinnacle ₹98,000 per year.
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 prose prose-slate max-w-none">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">
            Why Surat families choose Cerebrum
          </h2>
          <p>
            Surat is Gujarat's second-largest NEET market after Ahmedabad — with a population of 6M+
            and a rapidly growing aspirant base. The diamond and textile industry families in
            Adajan, Vesu, and Piplod drive strong pre-medical demand. Surat has 50+ CBSE/GSEB
            schools producing 3,000+ NEET aspirants annually. However, Surat lacks a local Cerebrum
            centre — all coaching is online live, with the same AIIMS-trained faculty and
            biology-specialist pedagogy as Delhi NCR.
          </p>
          ...
          <p>
            ...
            Bhulka Vihar School, Mount Litera Zee School.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>NEET Biology — Pinnacle: ₹98,000/yr.</strong> 10-12 student batch, weekly 1:1,
          ...
          <ul>
            <li>
              <Link href="/neet-coaching-ahmedabad" className="text-blue-600 hover:underline">
