...
export const metadata: Metadata = {
  title: 'Best NEET Coaching in Jodhpur | Ratanada, Sardarpura | Cerebrum Academy',
  description:
    'Top NEET biology coaching in Jodhpur for Rajasthan students. AIIMS Jodhpur focused! 94.2% success rate. Ratanada, Sardarpura, Paota. 2,200+ students. Book free demo!',
  keywords:
  ...
  openGraph: {
    title: 'Best NEET Coaching in Jodhpur | Rajasthan | Cerebrum Academy',
    description:
      'Top NEET biology coaching in Jodhpur with 94.2% success rate. AIIMS Jodhpur focused! Small batches.',
  ...
  twitter: {
    ...
    title: 'Best NEET Coaching in Jodhpur | Cerebrum Biology Academy',
    description:
      'Top NEET biology coaching in Jodhpur. AIIMS Jodhpur focused! 94.2% success rate. Ratanada, Sardarpura.',
  },
  alternates: {
