...
const reasons = [
  ...
  },
  {
    ...
    description:
      'Get premium coaching at 20-30% lower fees with significantly better student-teacher ratio.',
    icon: Target,
  },
]
...
export default function AllenAlternativeContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'allen-alternative-south-delhi',
      message:
        'Hi! I am currently at Allen/considering Allen in South Delhi and want to know about Cerebrum as an alternative for NEET Biology. Please share details.',
      campaign: 'allen-alternative-south-delhi',
    })
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Looking for an
              <span className="block text-yellow-400 mt-2">Allen Alternative in South Delhi?</span>
            </h1>

            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              Tired of 100+ student batches? Want personal attention from AIIMS-trained faculty?
              Discover why South Delhi students — from Lajpat Nagar to the Kalu Sarai belt — choose
              Cerebrum for focused NEET Biology preparation.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4 mb-8">
              ...
              <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-lg text-white">
                ...
                <span>Near AIIMS & South Extension Metro</span>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              Why Students Compare Allen with Cerebrum
            </h2>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            ...
            <p className="text-xl text-slate-600">
              An honest look at specialist coaching vs mass batches
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeInUp">
              ...
              <p className="text-xl text-blue-100 mb-6">
                ...
                specifically for Biology. Our South Extension flagship is a short ride from both
                Allen Lajpat Nagar and the Kalu Sarai hub — get the best of both worlds.
              </p>
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  Minutes from Allen Lajpat Nagar & Kalu Sarai
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
              ...
              <Link href="/complement-allen-coaching-south-delhi">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-4">
                  Conveniently Located in South Extension
                </h2>
                <p className="text-slate-600 mb-6">
                  Our flagship centre is at <strong>D-35, South Extension Part 2</strong> — near
                  AIIMS and steps from South Extension Metro, minutes from Allen Lajpat Nagar and
                  the Kalu Sarai coaching hub. We also have a second South Delhi centre at{' '}
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <Link
              href="/aakash-alternative-south-delhi"
