...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'Biology Tutor in East Delhi',
    description: 'Expert NEET Biology coaching in East Delhi localities.',
  },
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/biology-tutor-east-delhi',
  },
}

export default function BiologyTutorEastDelhiLayout({ children }: { children: React.ReactNode }) {
  return children
}
