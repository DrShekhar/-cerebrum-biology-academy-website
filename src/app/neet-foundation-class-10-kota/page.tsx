...
export const metadata: Metadata = {
  ...
  keywords: ['neet foundation class 10 kota', 'class 10 biology coaching kota', 'class 10 neet preparation kota'],
...
const faqs = [
  { question: 'Is Class 10 too early for NEET prep in Kota?', answer: 'No — Class 10 is ideal. NCERT Class 10 Biology maps directly to NEET. Starting early gives 2-3 year advantage.' },
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-emerald-900 to-green-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">NEET Foundation Class 10 in Kota</h1>
