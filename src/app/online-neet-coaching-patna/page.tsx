...
const PAGE_URL = 'https://cerebrumbiologyacademy.com/online-neet-coaching-patna'

export const metadata: Metadata = {
  title: 'Online NEET Coaching Patna | Live Biology Classes | Cerebrum',
  description: 'Online NEET Biology coaching for Patna students — live classes with AIIMS-trained faculty. IST evening slots. Same pedagogy as Delhi NCR offline batches. From Rs 48,000/yr.',
  keywords: [
    'online NEET coaching patna',
    'online NEET classes patna',
    'live NEET coaching patna',
    'NEET online biology patna',
  ],
  other: { 'article:modified_time': '2026-05-27' },
  alternates: { canonical: PAGE_URL },
  openGraph: { title: 'Online NEET Coaching Patna | Live Biology Classes', description: 'Online NEET Biology coaching for Patna students — live classes with AIIMS-trained faculty. IST evening slots. Same pedagogy as Delhi NCR offline batches. From Rs 48,000/yr.', url: PAGE_URL, locale: 'en_IN', type: 'website' },
}
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Online NEET Coaching in Patna</h1>
          <p className="text-xl text-slate-300 mb-6 max-w-3xl">100% live online NEET Biology coaching for Patna (Bihar) students. Same AIIMS-trained faculty and biology-specialist pedagogy as Delhi NCR offline batches — delivered via Zoom in IST evening slots (5-8 PM weekdays, 10 AM-12 PM weekends). Patna students join pan-India cohorts of 15-20 classmates. Recorded sessions for revision, WhatsApp doubt support, monthly progress reviews.</p>
