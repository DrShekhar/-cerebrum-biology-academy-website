...
export const metadata: Metadata = {
  title: 'Best NEET Coaching in HSR Layout Bangalore | All Sectors',
  description:
  ...
  openGraph: {
    title: 'Best NEET Coaching in HSR Layout Bangalore | Tech Hub',
    description:
  ...
  twitter: {
    ...
    title: 'Best NEET Coaching in HSR Layout Bangalore',
    description:
