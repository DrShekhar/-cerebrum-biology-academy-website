...
export const metadata: Metadata = {
  title:
    'Best NEET Coaching in HSR Layout Bangalore | All Sectors | Cerebrum Academy',
  description:
  ...
  openGraph: {
    ...
    description:
      'Premium NEET biology coaching in HSR Layout with 94.2% success rate. AIIMS faculty, tech-forward platform. Perfect for South Bangalore IT families.',
  ...
  twitter: {
    ...
    description:
      'Premium NEET biology coaching in HSR Layout. 94.2% success rate. All sectors, Bommanahalli, Agara.',
  },
  alternates: {
...
export default function HSRLayoutBangaloreCoachingLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>
}
