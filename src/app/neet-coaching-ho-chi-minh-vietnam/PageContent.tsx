...
export default function NEETCoachingPageContent() {
  const faqData = [
    {
      question: 'Why choose Cerebrum Biology Academy for NEET coaching in Ho Chi Minh City?',
      answer: 'Cerebrum Academy offers 98% success rate with personalized coaching from Dr. Shekhar C Singh. We understand Ho Chi Minh City student needs and provide curriculum-aligned preparation.'
    },
    {
      question: 'What is the success rate for students in Ho Chi Minh City?',
      answer: 'Our Ho Chi Minh City center maintains a consistent 98% success rate with students regularly scoring in top percentiles.'
    },
    {
      question: 'Do you offer online NEET coaching for Ho Chi Minh City students?',
    ...
    {
      question: 'What are the class timings at Ho Chi Minh City center?',
      answer: 'We offer flexible batches in morning, afternoon, and evening aligned with ICT timezone, accommodating school schedules.'
    },
    {
      question: 'How does Cerebrum Academy help with curriculum transition?',
      answer: 'We provide comprehensive curriculum bridge programs connecting Vietnam school education with NEET requirements.'
    },
    {
  ...
  return (
    <>
      <LocalitySchema
        name="Cerebrum Biology Academy - Ho Chi Minh City Center"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              NEET Coaching in Ho Chi Minh City, Vietnam
            </h1>
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center mb-12 text-gray-900">
            Why Choose Cerebrum Academy in Ho Chi Minh City?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div key="0" className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              <h3 className="font-bold text-lg mb-2 text-gray-900">Emerging Indian community in HCMC</h3>
            ...
            <div key="1" className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              <h3 className="font-bold text-lg mb-2 text-gray-900">International school student focus</h3>
              <p className="text-gray-700">Expert coaching aligned with local education standards.</p>
            </div>
            <div key="2" className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              <h3 className="font-bold text-lg mb-2 text-gray-900">Southeast Asia's growing medical education hub</h3>
              <p className="text-gray-700">Expert coaching aligned with local education standards.</p>
            </div>
            <div key="3" className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              <h3 className="font-bold text-lg mb-2 text-gray-900">Saigon South International partnerships</h3>
              <p className="text-gray-700">Expert coaching aligned with local education standards.</p>
            </div>
            <div key="4" className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              <h3 className="font-bold text-lg mb-2 text-gray-900">Premium coaching for expat families</h3>
              <p className="text-gray-700">Expert coaching aligned with local education standards.</p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div key="0" className="bg-blue-50 p-4 rounded-lg border border-blue-200">Saigon South International School</div>
            <div key="1" className="bg-blue-50 p-4 rounded-lg border border-blue-200">ABC International School</div>
            <div key="2" className="bg-blue-50 p-4 rounded-lg border border-blue-200">United Nations International School</div>
            <div key="3" className="bg-blue-50 p-4 rounded-lg border border-blue-200">International School of Hanoi (Alumni)</div>
            <div key="4" className="bg-blue-50 p-4 rounded-lg border border-blue-200">Ho Chi Minh City International School</div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 bg-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl font-bold mb-8 text-gray-900">
            Class Timings in Ho Chi Minh City
          </h2>
          <p className="text-lg text-gray-700 mb-6">
            Morning and afternoon batches aligned with ICT timezone (UTC+7)
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="font-bold text-lg mb-3">Weekday Classes</h3>
              <p className="text-gray-700">Evening: 6:00 PM - 8:30 PM (ICT)</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="font-bold text-lg mb-3">Weekend Classes</h3>
              <p className="text-gray-700">Saturday & Sunday: 10:00 AM - 1:00 PM (ICT)</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Pricing Section */}
      <PricingSection city="Ho Chi Minh City" />
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-r from-blue-600 to-purple-700 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-blue-100">
            Contact Dr. Shekhar C Singh today for personalized NEET coaching in Ho Chi Minh City
          </p>
      ...
      {/* Related Cities */}
      <RelatedCityLinks currentCity="Ho Chi Minh City" />
    </>
  );
}
