        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8 inline-block">
            <span className="text-sm font-semibold text-blue-600 bg-blue-50 px-4 py-2 rounded-full">
              Ancient Learning Center - Best NEET Coaching in Varanasi
            </span>
          </div>

          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-gray-900 mb-6 leading-tight">
            Best NEET Coaching
            <br className="hidden sm:block" /> in <span className="text-blue-600">Varanasi</span>
          </h1>

          <p className="text-xl sm:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto font-light">
            Top NEET Biology coaching in sacred Varanasi. AIIMS faculty. 98% success rate. BHU
            proximity advantage.
          </p>

          <div className="flex flex-col md:flex-row gap-4 justify-center mb-16">
            <a href="https://wa.me/918826444334?text=Hi!%20I%20am%20on%20your%20NEET%20Coaching%20Varanasi%20page%20and%20want%20to%20know%20more%20about%20batches%2C%20fees%2C%20and%20admission." target="_blank" rel="noopener noreferrer">
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl sm:text-5xl font-bold text-center text-gray-900 mb-16">
            Why Choose Cerebrum for NEET in Varanasi?
          </h2>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">
                    Ancient Learning Tradition
                  </h3>
                  <p className="text-gray-600">
                    Varanasi's 5000-year academic legacy merged with modern NEET preparation
                    excellence.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">
                    Near Banaras Hindu University. Exposure to excellent education environment.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">
                    Online + offline batches. Live interactive classes. Recorded content 24x7.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl sm:text-5xl font-bold text-center text-gray-900 mb-4">
            NEET Coaching in Varanasi Areas
          </h2>
          <p className="text-center text-gray-600 mb-16 max-w-2xl mx-auto">
            Coaching centers across prime localities in Varanasi, Uttar Pradesh
          </p>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">
            Excel in NEET from Sacred Varanasi!
          </h2>
          <p className="text-xl text-blue-100 mb-8">
            Join Varanasi's premier NEET coaching with ancient learning tradition merged with modern
            excellence.
          </p>
