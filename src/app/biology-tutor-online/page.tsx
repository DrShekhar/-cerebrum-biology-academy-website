  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Dr. Shekhar is AIIMS-trained with 15+ years teaching experience and 15,000+ NEET selections. He specializes in CBSE, ICSE, and NEET biology preparation.',
        },
      },
      {
        '@type': 'Question',
              ...
              <div
               className="animate-fadeInUp">
                ...
                <div className="mb-8 grid grid-cols-3 gap-4">
                  ...
                  <div className="rounded-lg bg-white/10 p-4 text-center backdrop-blur-sm">
                    <div className="text-2xl font-bold md:text-3xl">15,000+</div>
