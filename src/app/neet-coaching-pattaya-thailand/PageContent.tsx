      ...
      <section className="relative py-16 bg-gradient-to-r from-blue-700 via-blue-600 to-teal-700 text-white">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-6">
            Growing Indian community in Pattaya/Eastern Seaboard. Online access to premium NEET
            coaching.
          </p>
          <div className="flex flex-wrap justify-center gap-4 mb-6">
            <Link
              href="https://wa.me/918826444334?text=Hi%20I%20am%20from%20Pattaya%20interested%20in%20NEET%20coaching"
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm">
            ...
            <span className="flex items-center gap-1">
              <CheckCircle className="w-4 h-4" /> 2+ CBSE Schools
            </span>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-10">
            Why Pattaya Students Choose Cerebrum
          </h2>
          ...
          {[
            {
              ...
              score: '578/720',
              quote:
                'Living in Pattaya, I thought quality NEET coaching was out of reach. Cerebrum proved me wrong with their online platform.',
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 mb-8 text-lg">
            Join Indian students in Pattaya already preparing with expert AIIMS faculty. Book a free
            demo today.
          </p>
          <Link
            href="https://wa.me/918826444334?text=Hi%20I%20am%20from%20Pattaya%20interested%20in%20NEET%20coaching"
