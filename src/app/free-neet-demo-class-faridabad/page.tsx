...
export const metadata: Metadata = {
  title: 'Free NEET Demo Class Faridabad | Book Now',
  description:
    'Book your FREE NEET Biology demo class in Faridabad. Experience AIIMS faculty teaching, small batches, and our proven methodology. Online & offline options. No obligation. Call 88264-44334!',
  keywords: [
    'free neet demo class faridabad',
    'free neet trial class faridabad',
    'neet biology free demo',
    'free neet coaching demo faridabad',
    'try neet classes free faridabad',
    'neet demo class near me',
    'free biology class neet faridabad',
  ...
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/free-neet-demo-class-faridabad',
  },

  twitter: {
    card: 'summary_large_image' as const,
    title: 'Free NEET Demo Class Faridabad | Book Now',
    description: 'Book your FREE NEET Biology demo class in Faridabad. Experience AIIMS faculty teaching, small batches, and our proven methodology. Online & offline options. No obligation. Call 88264-44334!',
  },
}
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Call us at 88264-44334 or fill the form on this page. We schedule demos instantly — same day slots available 7 days a week. Online demo also available.',
  },
  {
...
export default function FreeNEETDemoClassFaridabad() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Free NEET Demo Class in Faridabad
            </h1>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    <p className="font-semibold">Offline Demo - Faridabad Center</p>
