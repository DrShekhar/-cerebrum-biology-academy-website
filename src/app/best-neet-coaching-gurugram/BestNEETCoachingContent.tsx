        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Best NEET Coaching
              <span className="block text-yellow-400 mt-2">in Gurugram 2026-27</span>
            </h1>
        ...
        <div className="mx-auto grid max-w-5xl items-center gap-8 md:grid-cols-2">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">
              Talk to the best NEET Biology faculty in Gurugram
            </h2>
            <p className="mt-3 text-gray-600">
              Leave your number and our Gurugram counsellor calls you the same day to book a free
              trial class with AIIMS-trained faculty.
            </p>
          </div>
          <CityLeadForm city="Gurugram" citySlug="gurugram" accent="indigo" />
        </div>
      </section>
