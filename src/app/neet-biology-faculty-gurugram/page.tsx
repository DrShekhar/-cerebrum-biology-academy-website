...
const faculty = [
  {
    ...
    teachingStyle:
      'Concept-based learning with clinical correlations. Uses real medical cases to explain physiology concepts.',
    studentRating: 5.0,
    toppersTrained: 12,
  },
  {
    ...
    teachingStyle:
      'Visual learning with diagrams and flowcharts. Makes complex plant processes easy to remember with mnemonics.',
    studentRating: 4.8,
    toppersTrained: 8,
  },
  {
    ...
    achievements: [
      'Former Allen senior faculty',
      'GATE AIR 45',
      'YouTube: 100K+ subscribers',
      'Developed NEET cell biology module',
    ],
    teachingStyle:
      'Animation-based teaching. Creates mental models for understanding cellular processes. Strong focus on diagrams.',
    studentRating: 4.7,
    toppersTrained: 6,
  },
  {
    ...
    teachingStyle:
      'Comparative teaching - links similar concepts across phyla. Excellent at classification tricks and memory techniques.',
    studentRating: 4.8,
    toppersTrained: 5,
  },
]
...
const whyOurFaculty = [
  {
    ...
    description:
      '3 of 4 faculty are MBBS doctors who understand NEET exam mindset and medical career requirements.',
  },
  {
    title: 'Research Experience',
    description:
      "All faculty have research publications. They bring depth that textbooks can't provide.",
  },
  {
    title: 'Small Batch Focus',
    description:
      'Max 20 students per batch. Each faculty knows every student by name and tracks individual progress.',
  },
  {
    title: 'Updated Knowledge',
    description:
      'Faculty attend annual workshops and analyze NEET patterns. Curriculum updated yearly.',
  },
]
...
const faqs = [
  {
    ...
    answer:
      'Yes, 2 of our 4 faculty are AIIMS graduates (Dr. Rajesh Sharma - AIIMS Delhi, and we have visiting faculty from AIIMS). All faculty have medical or top research institute backgrounds.',
  },
  {
    question: 'What is the student-to-faculty ratio?',
    answer:
      'We maintain a 20:1 student-to-faculty ratio per batch. With 4 full-time faculty for biology, each student gets personalized attention across all topics.',
  },
  {
    question: 'How experienced are your teachers?',
    answer:
      'Our faculty has combined 54+ years of NEET teaching experience. Minimum qualification is PhD/MBBS with 15+ years of competitive exam teaching.',
  },
  {
    question: 'Can I meet the faculty before joining?',
    answer:
      'Yes! We encourage demo classes where you can experience our teaching style. Book a free demo to meet Dr. Sharma or any faculty member.',
  },
]
...
export default function NEETBiologyFacultyGurugram() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <GurgaonGurugramAreaSchema spelling="gurugram" pageSlug="neet-biology-faculty-gurugram" />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100 mb-8">
              AIIMS graduates with 15+ years experience | 98% success rate
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-5xl mx-auto space-y-8">
            {faculty.map((member, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div
                  className={`p-6 ${index === 0 ? 'bg-gradient-to-r from-blue-600 to-indigo-600' : 'bg-blue-600'} text-white`}
                >
                  <div className="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-blue-200 text-sm">
                        {member.toppersTrained} toppers trained
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-16 bg-blue-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Book a free demo class with any faculty member. No obligation.
          </p>
