  ...
  const features = [
    {
      ...
      description:
        'Complete coverage of all 56 chapters aligned with JBO syllabus',
    },
    {
      icon: Target,
      title: 'JBO Past Papers',
      description:
        'Extensive practice with previous years Japan Biology Olympiad papers',
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description:
        'Classes scheduled to accommodate Japanese timezone (JST)',
    },
    {
      icon: Trophy,
      title: 'Competition Strategy',
      description:
        'Specialized tips for Japan Biology Olympiad exam patterns',
    },
  ]
        ...
        <section className="relative bg-gradient-to-br from-slate-900 to-slate-800 py-20">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              >
                Expert coaching to help you excel in the Japan Biology Olympiad
                and qualify for the International Biology Olympiad (IBO). Join
                Japan&apos;s top biology students!
              </motion.p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Your journey from Japan Biology Olympiad to representing Japan
                at the International Biology Olympiad
              </p>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                ...
                Japan Biology Olympiad requirements
              </p>
            </div>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Hear from Japanese students who achieved JBO success with our
                coaching
              </p>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Flexible pricing for Japanese students. All prices shown in JPY
                and USD.
              </p>
            </div>
        ...
        <section className="py-16 bg-gradient-to-br from-slate-900 to-slate-800">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Join hundreds of Japanese students who have achieved Biology
              Olympiad success with Cerebrum. Start your journey to IBO today!
            </p>
            <button
