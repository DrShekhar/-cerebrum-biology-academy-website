...
export default function PageContent() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              Premium NEET coaching for Sarjapur Road, Marathahalli, Bellandur & nearby areas. Learn
              from <strong>Dr. Shekhar C Singh, AIIMS Alumnus</strong> - trusted by IT professionals
              and executive families.
            </p>
      ...
      <PricingSection cityName="Sarjapur Road" />
      <CostComparisonSection cityName="Sarjapur Road" />
      ...
      <RelatedCityLinks currentCity="sarjapur-road-bangalore" variant="default" />
    </div>
  )
}
