...
export default function ScholarshipPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white py-12 sm:py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div>
              ...
              <p className="text-base sm:text-lg md:text-xl text-emerald-100 mb-4 sm:mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <Link
                  href="/contact"
                  className="bg-white text-emerald-600 px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-bold hover:bg-emerald-50 transition-all hover:scale-105 inline-flex items-center justify-center text-base sm:text-lg shadow-lg min-h-[44px]"
                >
                ...
                <Link
                  href="#types"
                  className="border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:bg-white hover:text-emerald-600 transition-colors inline-flex items-center justify-center min-h-[44px]"
                >
      ...
      <section className="py-8 sm:py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
              ...
              return (
                <div key={index} className="relative">
                  <div className="bg-white rounded-xl p-4 sm:p-6 shadow-lg text-center h-full">
                    <div className="w-12 h-12 sm:w-14 sm:h-14 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                      <Icon className="w-6 h-6 sm:w-7 sm:h-7 text-emerald-600" />
                    </div>
                    <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-emerald-600 text-white w-6 h-6 rounded-full flex items-center justify-center text-sm font-bold">
                      {step.step}
                    </div>
                    ...
                    <div className="text-xs text-emerald-600 font-medium">{step.duration}</div>
                  </div>
          ...
          <div className="mt-8 sm:mt-10 text-center">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-emerald-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-bold hover:bg-emerald-700 transition-colors min-h-[44px]"
            >
                ...
                <div className="bg-gradient-to-r from-emerald-600 to-teal-600 p-4 sm:p-6 text-white">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-emerald-100 text-xs sm:text-sm">{story.location}</p>
                    </div>
                  </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            {faqs.map((faq, index) => (
              <div key={index} className="bg-white rounded-xl p-4 sm:p-6 shadow-lg">
                <div className="flex items-start gap-3">
                  <HelpCircle className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-600 flex-shrink-0 mt-0.5" />
                  <div>
      ...
      {/* CTA Section */}
      <section className="py-8 sm:py-12 md:py-16 bg-gradient-to-r from-emerald-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6 sm:mb-8">
            <Link
              href="/contact"
              className="bg-white text-emerald-600 px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-bold hover:bg-emerald-50 transition-colors inline-flex items-center justify-center min-h-[44px]"
            >
              Apply Now
