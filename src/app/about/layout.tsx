...
export const metadata: Metadata = {
  ...
  description:
    'About Cerebrum Biology Academy, founded by Dr. Shekhar C Singh (AIIMS Delhi) in 2014. 98% NEET success rate, 680+ medical college selections. Visit us today!',
  keywords:
  ...
  openGraph: {
    ...
    description:
      "Founded by AIIMS alumnus Dr. Shekhar C Singh. 680+ medical college selections, 98% success rate, AIIMS Delhi/JIPMER/AFMC placements. Meet the team behind India's #1 NEET-UG coaching.",
    images: ['/og-image.jpg'],
  ...
  twitter: {
    ...
    description:
      'Founded 2014. AIIMS alumnus-led. 680+ medical college selections. 98% success rate. 6 centers in Delhi NCR.',
    images: ['/og-image.jpg'],
