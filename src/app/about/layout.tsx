...
export const metadata: Metadata = {
  ...
  keywords:
    'Cerebrum Biology Academy, AIIMS faculty NEET coaching, Dr Shekhar C Singh AIIMS, NEET Biology coaching Delhi, medical college entrance coaching, NEET success rate, top NEET coaching institute',
  openGraph: {
