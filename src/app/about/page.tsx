            ...
            <div className="grid lg:grid-cols-5 gap-8 sm:gap-10 lg:gap-16 items-center">
              <div className="lg:col-span-3 space-y-5 sm:space-y-6 md:space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 pt-4">
                  <Link href="https://wa.me/918826444334?text=Hi!%20I'm%20interested%20in%20about.%20Please%20share%20fee%20structure%20and%20enrolment%20details." target="_blank" rel="noopener noreferrer">
                    <Button
                      variant="primary"
                      size="xl"
