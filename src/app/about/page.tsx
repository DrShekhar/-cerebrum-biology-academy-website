          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              <div className="bg-purple-50 rounded-3xl p-8">
                ...
                <p className="text-gray-700 text-lg leading-relaxed">
                  To become India's most trusted and innovative NEET coaching institute, recognized
                  for producing confident, competent medical professionals who contribute
                  meaningfully to healthcare and society.
                </p>
              </div>
            </motion.div>
          </div>
