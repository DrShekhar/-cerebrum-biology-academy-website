...
const aboutFAQs = [
  ...
  },
  {
    ...
    answer:
      'Cerebrum Biology Academy has been operating since 2014, starting with just 23 students in a 400 sq ft room in Rohini. Over the years, we have grown to coach 15,000+ students with a 98% NEET qualification rate.',
  },
  {
...
export default function AboutPage() {
  ...
  return (
    <>
      {/* Dr. Shekhar C Singh — Person schema with the full universal
          authority payload (10 sameAs anchors, 33 universal knowsAbout,
          8 awards, hasOccupation, mainEntityOfPage → master page).
          Same @id as inline schemas elsewhere on the site → Google
          merges into a single canonical entity. */}
      <CerebrumPersonSchema
        ...
        jobTitle="Founder & Lead Biology Faculty — About Cerebrum Biology Academy"
      />
            ...
            <div className="grid lg:grid-cols-5 gap-8 sm:gap-10 lg:gap-16 items-center">
              <div className="lg:col-span-3 space-y-5 sm:space-y-6 md:space-y-8">
                ...
                <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-800 font-light leading-relaxed tracking-wide">
                  How One Doctor's Mission Helped 15,000+ Students Get Into Medical College
                </p>
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-start max-w-7xl mx-auto">
                <div className="space-y-8 animate-fade-in-left">
                  <p className="text-base sm:text-lg md:text-xl text-gray-700 leading-[1.8] font-light">
                    ...
                    <strong className="font-semibold text-[#3d4d3d]">AIIMS Delhi in 2014</strong>,
        ...
        <section className="py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-12 sm:mb-16 md:mb-20 lg:mb-24">
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-700 leading-relaxed max-w-4xl mx-auto font-light">
                From a 400 sq ft room to transforming 15,000+ lives
              </p>
            </div>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center relative z-10">
            <div className="animate-fade-in-up">
              ...
              <div className="mt-8 flex flex-wrap gap-4 justify-center text-sm">
                <Link
                  href="/results"
                  className="text-[#3d4d3d] hover:text-[#4a5d4a] underline underline-offset-4"
                >
