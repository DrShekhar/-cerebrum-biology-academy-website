...
export const metadata: Metadata = {
  ...
  description:
    'NEET Foundation Class 9 in Mysore — AIIMS-trained faculty, online live. Serving Saraswathipuram, VV Mohalla, Kuvempunagar, Gokulam, Vijayanagar. From Rs 35,000/year.',
  keywords: [
    'neet foundation class 9 mysore',
    'class 9 biology coaching mysore',
    'class 9 neet mysore',
  ],
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: 'NEET Foundation Class 9 Mysore',
    url: PAGE_URL,
    locale: 'en_IN',
    type: 'website',
  },
...
const wa =
  ...
  encodeURIComponent('Hi — Class 9 student in Mysore, want NEET Foundation details.')
const faqs = [
  {
    question: 'Is Class 9 too early for NEET in Mysore?',
...
export default function Page() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-emerald-900 to-green-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            NEET Foundation Class 9 in Mysore
          </h1>
      ...
      <FoundationCityEnrichment slug="mysore" classLevel={9} />
