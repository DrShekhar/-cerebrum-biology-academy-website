...
export const metadata: Metadata = {
  ...
  keywords: ['neet dropper batch nashik', 'neet repeater course nashik', 'best dropper batch neet nashik'],
  alternates: { canonical: `https://cerebrumbiologyacademy.com/neet-dropper-batch-nashik` },
  openGraph: { title: `NEET Dropper Batch 2026-27 ${cityName}`, url: `https://cerebrumbiologyacademy.com/neet-dropper-batch-nashik`, locale: 'en_IN', type: 'website' },
