...
export const metadata: Metadata = {
  title: 'Class 11th Biology Course | NEET Foundation | Cerebrum Biology Academy',
  description: 'Build strong NEET foundation with our Class 11th Biology course. Expert AIIMS faculty, comprehensive NCERT coverage, board exam preparation. Enroll now!',
  keywords: 'Class 11 Biology, NEET foundation, NCERT Biology, board exam preparation, Class 11 coaching',
}
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Our Class 11th Biology Course?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Perfect blend of board exam preparation and NEET foundation building with expert faculty guidance
            </p>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Structured learning path covering all NCERT Biology topics</p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 mb-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Class 11th Biology Complete Course</h3>
              ...
              <div>
                ...
                <p className="text-gray-600 mb-6">Complete 1-year program</p>
          ...
          <p className="text-gray-600">
            💡 <strong>Early Bird Offer:</strong> Enroll before 15th of the month and get 10% discount!
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-600">
                Yes, our Class 11th Biology course covers NCERT curriculum which is the foundation for all boards. 
                We provide additional support for board-specific requirements.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-600">
                We build strong conceptual foundation essential for NEET. Topics are taught with NEET perspective 
                while ensuring board exam success. This gives students 2-year advantage for NEET preparation.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-600">
                ...
                Morning (8-10 AM), Evening (5-7 PM), and Weekend batches. Choose as per your convenience.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-600">
                Yes, we provide comprehensive study materials including NCERT solutions, chapter-wise notes, 
                practice questions, and board exam previous papers. All materials are designed by our expert faculty.
              </p>
            </div>
          </div>
        </div>
