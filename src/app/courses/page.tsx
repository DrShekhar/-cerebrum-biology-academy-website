...
export default function CoursesPage() {
  const courseSchema = {
    ...
    description:
      'NEET biology courses 2026 in Delhi NCR — Class 11, Class 12 & Dropper batches. AIIMS faculty, 15-student batches, 98% success rate. Rs 45K–1.56L with EMI. 5 centers across Delhi NCR. Enroll now!',
