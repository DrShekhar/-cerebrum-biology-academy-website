                ...
                <button
                  onClick={() =>
                    trackAndOpenWhatsApp({
                      source: 'neet-complete-enroll',
                      message:
                        'Hi! I want to enroll in Complete NEET Biology. Please share fee structure, batch timings, and enrollment process.',
                      campaign: 'neet-complete',
                    })
                  }
                  className="bg-yellow-500 text-yellow-900 px-8 py-4 rounded-lg font-bold text-lg hover:bg-yellow-400 transition-all shadow-lg"
                >
                  Enroll Now - ₹75,000
                </button>
                <button
                  onClick={() =>
                    trackAndOpenWhatsApp({
                      source: 'neet-complete-demo',
                      message:
                        'Hi! I want to book a FREE demo class for Complete NEET Biology. Please share available timings.',
                      campaign: 'neet-complete',
                    })
                  }
                  ...
                  <div className="border-t pt-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <button
                        onClick={() =>
                          trackAndOpenWhatsApp({
                            source: 'neet-complete-emi',
                            message:
                              'Hi! I want to enroll in Complete NEET Biology with EMI option. Please share EMI details and enrollment process.',
                            campaign: 'neet-complete',
                          })
                        }
                        className="w-full border-2 border-blue-600 text-blue-600 py-3 rounded-lg font-bold hover:bg-blue-50 transition-all"
                      >
