...
import { CheckCircle, Clock, Users, Award, BookOpen, Target, Star, ArrowRight, Trophy } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Class 12th Biology Course | NEET Intensive | Cerebrum Biology Academy',
  description: 'Master Class 12th Biology with intensive NEET preparation. Expert AIIMS faculty, board exam excellence, complete syllabus coverage. Enroll now!',
  keywords: 'Class 12 Biology, NEET intensive, board exam, NCERT Biology, Class 12 coaching, NEET preparation',
}
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-purple-100 mb-8">
                Master Class 12th Biology with intensive NEET preparation. The most crucial year 
                for medical entrance success with expert AIIMS faculty guidance.
              </p>
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Our Class 12th Biology Course?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              The most critical year for NEET aspirants with dual focus on board excellence and entrance exam success
            </p>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Comprehensive NEET-focused approach for maximum Biology score</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {neetPreparation.map((item, index) => {
              ...
              return (
                <div key={index} className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl p-6 text-center hover:shadow-lg transition-shadow">
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Complete Curriculum with NEET Weightage</h2>
            <p className="text-gray-600">Strategic coverage based on NEET exam pattern and board requirements</p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 mb-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Class 12th Biology Intensive Course</h3>
              ...
              <div>
                <div className="text-4xl font-bold text-purple-600 mb-4">₹34,999</div>
                <p className="text-gray-600 mb-6">Complete 1-year intensive program</p>
          ...
          <div className="bg-yellow-100 border border-yellow-300 rounded-xl p-6">
            ...
            <p className="text-yellow-700">
              Enroll before 31st January and get FREE NEET crash course (worth ₹15,000) + Previous 15 years question bank!
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-600">
                Class 12th course is more intensive with direct NEET focus. We cover board syllabus alongside 
                intensive NEET preparation with daily practice, mock tests, and previous year questions analysis.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-600">
                Our students typically achieve 330+ marks in NEET Biology (out of 360). We focus on high-weightage 
                topics and provide extensive practice to ensure maximum scoring.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-600">
                Yes, our unique curriculum covers both. Board exam preparation is integrated with NEET-level 
                depth, ensuring students excel in both without any compromise.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-600">
                We provide daily doubt sessions, one-on-one mentoring, WhatsApp support, and weekend doubt 
                clearing classes. No student question goes unanswered.
              </p>
            </div>
          </div>
        </div>
