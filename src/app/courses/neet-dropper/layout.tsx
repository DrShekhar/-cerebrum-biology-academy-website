...
export const metadata: Metadata = {
  ...
  description:
    "Specialized NEET dropper batch for 2025. Complete Biology syllabus in 10 months, rank improvement strategies, 94.2% success rate. Join India's best NEET repeater program!",
  keywords:
  ...
  openGraph: {
    ...
    description:
      'Intensive 10-month program for NEET droppers. 94.2% qualification rate, personalized mentoring, rank improvement guarantee. Limited seats available!',
  ...
  twitter: {
    ...
    description:
      'One year intensive program, 94.2% success, rank improvement strategies, AIIMS faculty',
    images: ['/og-images/neet-dropper-batch.jpg'],
  },
  alternates: {
