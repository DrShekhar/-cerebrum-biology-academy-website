...
export const metadata: Metadata = {
  ...
  description:
    'Best Karnataka PUC Biology coaching online. 94.2% success rate. AIIMS faculty. Bridge KSEEB syllabus with NCERT for NEET. Bangalore, Mysore, Mangalore. Fee ₹24,000+. Book free demo!',
  keywords:
  ...
  openGraph: {
    title: 'Karnataka PUC Biology Coaching Online | NEET + Board Prep | Cerebrum Academy',
    description:
      'Best Karnataka PUC Biology coaching with 94.2% success rate. AIIMS faculty. Bridge PUC-NCERT gap. Bangalore, Mysore, Mangalore.',
  ...
  twitter: {
    ...
    description:
      'Best Karnataka PUC Biology coaching online. 94.2% success rate. Bangalore, Mysore, Mangalore.',
  },
  alternates: {
