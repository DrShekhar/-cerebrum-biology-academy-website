...
const wa =
  ...
  encodeURIComponent(
    'Hi — I want to enroll my child (Class 10) in NEET Foundation from Dehradun. Please share batch details and demo timings.'
  )

const faqs = [
  {
    question: 'Is Class 10 too early to start NEET preparation in Dehradun?',
    answer:
      'No — Class 10 is the ideal time to build the Biology foundation that NEET demands. NCERT Class 10 Biology (cell biology, tissues, diversity in organisms) directly maps to NEET syllabus. Starting early gives Dehradun students a 2-3 year advantage over those who start in Class 11.',
  },
  {
  ...
  {
    question: 'What does NEET Foundation Class 10 cost in Dehradun?',
    answer:
...
export default function Page() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-emerald-900 to-green-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            NEET Foundation Class 10 in Dehradun
          </h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 prose prose-slate max-w-none">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">
            Why start NEET Foundation in Class 10 from Dehradun?
          </h2>
          <p>
          ...
          <ul>
            ...
            <li>
              <Link
                href="/neet-foundation-class-9-dehradun"
                className="text-blue-600 hover:underline"
              >
                Foundation Class 9 Dehradun
              </Link>
            </li>
            <li>
      ...
      <FoundationCityEnrichment slug="dehradun" classLevel={10} showIntro={false} />
