...
const malviyaNagarAreas = [
  { name: 'Malviya Nagar', distance: '18 km', landmark: 'Near Metro Station' },
  { name: 'Saket', distance: '20 km', landmark: 'Near Select City Walk' },
  { name: 'Sheikh Sarai', distance: '17 km', landmark: 'Near Malviya Nagar' },
  { name: 'Khirki Extension', distance: '19 km', landmark: 'Near Saket' },
  { name: 'Panchsheel Enclave', distance: '16 km', landmark: 'Near Chirag Delhi' },
  { name: 'Chirag Delhi', distance: '15 km', landmark: 'Near Nehru Place' },
  { name: 'Khanpur', distance: '21 km', landmark: 'Near Tughlakabad' },
  { name: 'Hauz Rani', distance: '20 km', landmark: 'Near Malviya Nagar' },
]
...
const faqs = [
  {
    question: 'Do you offer home tutoring in Malviya Nagar?',
    answer:
      'We offer premium live online Biology tutoring for Malviya Nagar students. Our virtual sessions provide the same personalized attention as home tutoring, with added benefits of recorded lectures for revision and flexible scheduling.',
  },
  {
    question: 'How is online tutoring different from classroom coaching?',
    answer:
      'Our online Biology tutoring offers smaller batch sizes (max 15 students), personalized doubt clearing via WhatsApp, recorded lectures for unlimited revision, and flexible timing. Many Malviya Nagar parents prefer this modern approach over traditional classroom coaching.',
  },
  {
    question: 'What boards do you cover for Biology tutoring?',
    answer:
      'We provide Biology tutoring for CBSE Class 11-12, NEET preparation, and board exam preparation. Our comprehensive approach covers NCERT thoroughly while building strong conceptual understanding required for competitive exams.',
  },
  {
    question: 'Do you provide study material for Biology?',
    answer:
      'Yes! Students receive comprehensive study notes, chapter-wise question banks, previous year papers with solutions, and exclusive NEET practice papers. All material is designed by AIIMS faculty for maximum effectiveness.',
  },
]
...
const localBusinessSchema = {
  ...
  areaServed: ['Malviya Nagar', 'Saket', 'Sheikh Sarai', 'Khirki Extension', 'Panchsheel Enclave'],
  priceRange: '$$',
}
...
export default function PageContent() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero */}
      <section className="relative bg-gradient-to-br from-teal-900 via-teal-800 to-green-900 text-white py-12 md:py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              ...
              Personalized Tutoring | AIIMS Faculty
            </div>
            ...
            <h2 className="text-xl md:text-2xl opacity-90 mb-4">
              Expert Biology Tutoring for NEET & Board Exams
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Biology%20coaching%20in%20Malviya%20Nagar.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer">
                <Button
                  variant="secondary"
                  size="xl"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                ...
                <div className="text-sm opacity-80">Attention</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
      ...
      <section className="py-12 md:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {malviyaNagarAreas.map((area, index) => (
              <div
                key={area.name}
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {whyChooseUs.map((item, index) => (
              ...
              >
                <div className="w-16 h-16 bg-gradient-to-br from-teal-600 to-green-600 rounded-2xl flex items-center justify-center mx-auto mb-6">
      ...
      {/* CTA */}
      <section className="py-12 md:py-20 bg-gradient-to-r from-teal-600 via-teal-700 to-green-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              Malviya Nagar Students, Excel in Biology!
            </h2>
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              Personalized Biology tutoring from AIIMS expert
            </p>
