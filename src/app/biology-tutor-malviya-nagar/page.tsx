...
export default function BiologyTutorMalviyaNagarPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero */}
      <section className="relative bg-gradient-to-br from-teal-900 via-teal-800 to-green-900 text-white py-20 overflow-hidden">
      ...
      {/* CTA */}
      <section className="py-20 bg-gradient-to-r from-teal-600 via-teal-700 to-green-700 text-white">
