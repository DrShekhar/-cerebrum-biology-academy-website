...
const cityName = 'Mysore'
const citySlug = 'mysore'
...
export const metadata: Metadata = {
  ...
  keywords: ['neet dropper batch mysore', 'neet repeater course mysore', 'best dropper batch neet mysore'],
  alternates: { canonical: `https://cerebrumbiologyacademy.com/neet-dropper-batch-mysore` },
  openGraph: { title: `NEET Dropper Batch 2026-27 ${cityName}`, url: `https://cerebrumbiologyacademy.com/neet-dropper-batch-mysore`, locale: 'en_IN', type: 'website' },
