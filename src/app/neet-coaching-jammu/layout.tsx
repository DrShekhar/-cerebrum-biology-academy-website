...
export const metadata: Metadata = {
  ...
  description:
    'Top NEET biology coaching in Jammu for J&K students. GMC Jammu focused! 94.2% success rate, AIIMS faculty. Gandhi Nagar, Residency Road, Talab Tillo. 1,500+ students. Book free demo!',
  keywords:
  ...
  openGraph: {
    ...
    description:
      'Top NEET biology coaching in Jammu with 94.2% success rate. GMC Jammu focused! AIIMS faculty, small batches.',
  ...
  twitter: {
    ...
    description:
      'Top NEET biology coaching in Jammu. GMC focused! 94.2% success rate. Gandhi Nagar, Residency Road.',
  },
  alternates: {
