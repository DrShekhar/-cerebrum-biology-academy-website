...
export default function NEETDropperBatchGhaziabadContent({ faqs }: { faqs: FAQ[] }) {
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              ...
              personalized strategy. Easily accessible from Ghaziabad via Blue Line Metro to Sector
              62.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Dropper%20batch%20in%20Ghaziabad.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer">
                <Button
                  variant="secondary"
                  size="xl"
            ...
            {successStories.map((story) => (
              ...
              >
                ...
                <p className="text-green-100 mb-4">
                  <span className="line-through">{story.before}</span> &rarr;{' '}
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-xl animate-fadeInUp">
              ...
              <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Dropper%20batch%20in%20Ghaziabad.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer" className="block mt-6">
            ...
            <div className="bg-gradient-to-br from-slate-800 to-slate-700 rounded-2xl p-8 text-white animate-fadeInUp">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold">Nearest Center (Sector 62, Noida)</h2>
              </div>
              <p className="text-slate-300 mb-4">
                <strong className="text-white">Address:</strong> B-45, Sector 62, Noida, UP 201301
              </p>
              <p className="text-slate-300 mb-4">
                <strong className="text-white">Metro Access:</strong> Sector 62 Metro Station (Blue
                Line) — 15-20 min from Vaishali/Kaushambi
              </p>
              <p className="text-slate-300 mb-6">
                <strong className="text-white">For Ghaziabad students:</strong> Easily accessible
                from Indirapuram, Vasundhara, Raj Nagar Extension, Crossings Republik
              </p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            >
              <h3 className="font-semibold text-teal-600">NEET Coaching Ghaziabad</h3>
            ...
            <Link
              ...
              className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">Crash Course Ghaziabad</h3>
              <p className="text-sm text-gray-600">45-day intensive</p>
            </Link>
            <Link
              href="/neet-scholarship-ghaziabad"
              className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">Scholarship</h3>
              <p className="text-sm text-gray-600">Up to 100% fee waiver</p>
            </Link>
            <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Dropper%20batch%20in%20Ghaziabad.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer" className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md">
