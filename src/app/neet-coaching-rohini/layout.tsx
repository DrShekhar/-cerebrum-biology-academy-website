...
export const metadata: Metadata = {
  ...
  description:
    'Top NEET coaching in Rohini — Physics, Chemistry & Biology at DC Chowk center. AIIMS Alumnus Dr. Shekhar C Singh. 98% success, 67+ AIIMS selections. Call 88264-44334. Free Demo!',
  keywords:
