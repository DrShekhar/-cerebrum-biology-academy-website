...
export const metadata: Metadata = {
  title: 'Best NEET Coaching in Patiala 2026 | Royal City',
  description:
  ...
  keywords:
    'NEET coaching Patiala, best NEET coaching Patiala Punjab, NEET preparation Patiala, NEET classes GMC Patiala, biology coaching Patiala, medical entrance Patiala, NEET 2027 Patiala, online NEET coaching Patiala, biology tuition Patiala, biology classes Patiala, online biology coaching Patiala, NEET biology Patiala, biology teacher Patiala',
  openGraph: {
    title: 'Best NEET Coaching in Patiala 2026',
    description:
