...
export default function NEETCrashCourseNoidaContent({ faqs }: { faqs: FAQ[] }) {
  const [openFaq, setOpenFaq] = useState<number | null>(null)

  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'neet-crash-course-noida',
      message:
        'Hi! I am interested in the NEET Biology crash course in Noida. Please share the next batch dates and fee details.',
      campaign: 'crash-course-noida',
    })
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              45-Day NEET
              <span className="block text-yellow-400 mt-2">Crash Course in Noida</span>
            </h1>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-orange-600 to-red-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join our 45-day crash course in Noida and improve by 75+ marks
          </p>
