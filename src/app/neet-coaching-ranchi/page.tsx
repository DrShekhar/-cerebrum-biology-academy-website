...
export default function NEETCoachingRanchiPage() {
  return (
    <>
      <LocalitySchema locality="Ranchi" slug={slug} pageTitle="Best NEET Coaching in Ranchi" pageDescription="Top NEET Biology coaching in Ranchi, Jharkhand with AIIMS faculty and 98% success rate." pageType="coaching" />
      <PageContent />
    </>
  )
}
