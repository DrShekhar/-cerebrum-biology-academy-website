...
export default function PageContent() {
  ...
  return (
    <div className="w-full">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center mb-16">
            <a href="https://wa.me/918826444334?text=Hi!%20I%20am%20on%20your%20NEET%20Coaching%20Ranchi%20page%20and%20want%20to%20know%20more%20about%20batches%2C%20fees%2C%20and%20admission." target="_blank" rel="noopener noreferrer">
      ...
      <PricingSection cityName="Ranchi" />
      <CostComparisonSection cityName="Ranchi" />
