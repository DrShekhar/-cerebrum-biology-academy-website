...
export const metadata: Metadata = {
  title: 'Best NEET Coaching in Ranchi | Main Road, Lalpur',
  description:
    'Top NEET biology coaching in Ranchi for Jharkhand students. RIMS Ranchi focused! 98% success rate, AIIMS faculty. Main Road, Lalpur, Doranda. 15,000+ students. Book free demo!',
  keywords:
  ...
  openGraph: {
    title: 'Best NEET Coaching in Ranchi | Jharkhand',
    description:
  ...
  twitter: {
    ...
    title: 'Best NEET Coaching in Ranchi',
    description:
