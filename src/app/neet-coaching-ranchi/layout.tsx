...
export const metadata: Metadata = {
  ...
  description:
    'Top NEET biology coaching in Ranchi for Jharkhand students. RIMS Ranchi focused! 94.2% success rate, AIIMS faculty. Main Road, Lalpur, Doranda. 2,000+ students. Book free demo!',
  keywords:
  ...
  openGraph: {
    ...
    description:
      'Top NEET biology coaching in Ranchi with 94.2% success rate. RIMS Ranchi focused! AIIMS faculty.',
  ...
  twitter: {
    ...
    description:
      'Top NEET biology coaching in Ranchi. RIMS focused! 94.2% success rate. Main Road, Lalpur, Doranda.',
  },
  alternates: {
