...
export const metadata: Metadata = {
  title: 'Cerebrum vs Allen NEET Coaching | Biology Delhi NCR',
  description:
  ...
  openGraph: {
    ...
    description:
      'Compare Cerebrum Biology Academy with Allen. See why students switch to smaller batches, AIIMS faculty, and personalized attention.',
  ...
  twitter: {
    ...
    title: 'Cerebrum vs Allen NEET Coaching | Biology Delhi NCR',
    description:
      'Detailed comparison of Cerebrum vs Allen for NEET Biology coaching. Compare batch sizes (15-20 vs 200+), AIIMS-trained faculty, personal attention, fee structure, and succ...',
  },
}
...
export default function CerebrumVsAllenPage() {
  const comparisonSchema = {
    ...
    description:
      'Detailed comparison of Cerebrum Biology Academy vs Allen for NEET Biology preparation in Delhi NCR',
    mainEntity: {
      '@type': 'ItemList',
      itemListElement: [
        {
          ...
          description:
            'Specialized NEET Biology coaching with small batches (15-20 students) and AIIMS faculty',
        },
        {
          '@type': 'EducationalOrganization',
          position: 2,
          name: 'Allen',
          description:
            'Large coaching institute offering preparation for NEET, JEE, and other competitive exams',
        },
      ],
    },
  }
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        '@type': 'ListItem',
        position: 3,
        name: 'Cerebrum vs Allen',
        item: 'https://cerebrumbiologyacademy.com/cerebrum-vs-allen-neet-coaching',
      },
    ],
  }
