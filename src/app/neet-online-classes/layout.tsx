...
export const metadata: Metadata = {
  ...
  description:
    'Attend live NEET online classes from anywhere in India. Expert faculty, interactive sessions, recorded lectures for revision. Join 15,000+ students preparing for NEET 2027 online!',
  keywords: [
    'neet online classes',
    'online neet classes',
    'neet classes online',
