...
export const metadata: Metadata = {
  ...
  description:
    'Expert NEET coaching for Vancouver, Canada students. 98% success rate with Dr. Shekhar C Singh. WhatsApp: 918826444334',
  keywords:
    'NEET coaching vancouver, vancouver NEET classes, medical coaching vancouver, NEET canada',
  openGraph: {
    title: 'NEET Coaching in Vancouver, Canada',
