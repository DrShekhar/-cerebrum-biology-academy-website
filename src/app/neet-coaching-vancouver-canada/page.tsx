...
export const metadata: Metadata = {
  ...
  description:
    "Expert NEET coaching for Vancouver, Canada students. 98% success rate. Dr. Shekhar C Singh's specialized curriculum. Join 50+ top scorers.",
  keywords:
    'NEET coaching vancouver, NEET classes vancouver, medical entrance exam vancouver, biology coaching vancouver, Cerebrum Biology Academy vancouver',
  alternates: {
