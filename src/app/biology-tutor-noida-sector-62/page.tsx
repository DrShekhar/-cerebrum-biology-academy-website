...
const sector62Areas = [
  { name: 'Sector 62', distance: '8 km', landmark: 'NSEZ, HCL, Infosys' },
  { name: 'Sector 63', distance: '9 km', landmark: 'Electronic City' },
  { name: 'Sector 61', distance: '7 km', landmark: 'Ganga Shopping Complex' },
  { name: 'Sector 59', distance: '10 km', landmark: 'Near Botanical Garden' },
  { name: 'Sector 60', distance: '8 km', landmark: 'Residential Area' },
  { name: 'Sector 64', distance: '11 km', landmark: 'Near Golf Course' },
  { name: 'Sector 65', distance: '12 km', landmark: 'Knowledge Park' },
  { name: 'Sector 52', distance: '6 km', landmark: 'Near DND' },
]
...
const whyChooseUs = [
  {
    ...
    description: 'Flexible timings for children of IT professionals working in Sector 62.',
  },
  {
    icon: GraduationCap,
    title: 'AIIMS Faculty',
  ...
  },
  {
    ...
    description: 'Special weekend intensive batches for busy schedules.',
  },
]
...
export default function BiologyTutorNoidaSector62Page() {
    ...
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              ...
              IT Hub - Flexible Timings Available
            </div>
            ...
            <h2 className="text-xl md:text-2xl opacity-90 mb-4">
              NEET & Board Preparation | IT Hub Coverage | Weekend Batches
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              Sector 62 & Nearby Areas
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Serving the IT corridor of Noida
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {sector62Areas.map((area, index) => (
              <div
                key={area.name}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              Why Sector 62 Families Choose Us
            </h2>
          </div>
