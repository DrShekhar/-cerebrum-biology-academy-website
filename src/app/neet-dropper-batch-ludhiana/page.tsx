...
const cityName = 'Ludhiana'
const citySlug = 'ludhiana'
export const metadata: Metadata = {
  ...
  keywords: ['neet dropper batch ludhiana', 'neet repeater ludhiana'],
  alternates: { canonical: `https://cerebrumbiologyacademy.com/neet-dropper-batch-ludhiana` },
  openGraph: { title: `NEET Dropper Batch 2026-27 ${cityName}`, url: `https://cerebrumbiologyacademy.com/neet-dropper-batch-ludhiana`, locale: 'en_IN', type: 'website' },
