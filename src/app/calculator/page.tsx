      ...
      <section className="py-8 sm:py-12 md:py-16 bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            ...
            <Link
              href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20%E2%80%94%20interested%20in%20calculator.%20Please%20share%20available%20timings."
              target="_blank"
