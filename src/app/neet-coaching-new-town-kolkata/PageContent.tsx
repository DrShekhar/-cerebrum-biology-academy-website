...
export default function PageContent() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              ...
              <strong>IT professionals and corporate families</strong>. Premium online classes with
              modern infrastructure and recorded lectures.
            </p>
      ...
      <PricingSection cityName="New Town" />
      <CostComparisonSection cityName="New Town" />
      ...
      <RelatedCityLinks currentCity="new-town-kolkata" variant="default" />
    </div>
  )
}
