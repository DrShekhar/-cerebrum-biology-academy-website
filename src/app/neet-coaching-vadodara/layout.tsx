...
export const metadata: Metadata = {
  ...
  description:
    'Top NEET biology coaching in Vadodara for Gujarat students. Medical College Baroda focused! 98% success rate, AIIMS faculty. Alkapuri, Sayajigunj, Fatehgunj. 15,000+ students. Book free demo!',
  keywords:
