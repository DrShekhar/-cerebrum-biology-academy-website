...
const features = [
  {
    ...
    description: 'Real-time teaching with instant doubt resolution from Vadodara',
  },
  {
    icon: Users,
    title: 'Small Batches (10-15)',
    description: 'Exclusive Gujarat batches with personal attention',
  },
  {
    icon: Award,
    title: 'AIIMS Trained Faculties',
    description: 'Expert doctors trained at premier medical institutions',
  },
  {
    icon: BookOpen,
    title: 'Medical College Baroda Focused',
    description: 'Coaching for Gujarat medical college admissions',
  },
  {
    icon: Clock,
    title: 'Flexible Timings',
    description: 'Morning, afternoon, and evening batches',
  },
  {
    icon: Shield,
    title: 'Stay in Vadodara',
    description: 'No need to migrate - get top coaching from the Cultural Capital',
  },
]
...
const faqs = [
  {
    question: 'Why choose online coaching for NEET preparation in Vadodara?',
    answer:
      'Vadodara students can get quality NEET coaching without migrating to Kota. Our online coaching at Rs 24,000-48,000/year delivers the same results. Stay in the Cultural Capital with family.',
  },
  {
    question: 'Which areas in Vadodara do you serve?',
    answer:
      'We serve Alkapuri, Sayajigunj, Fatehgunj, Manjalpur, Karelibaug, Gotri, and all Vadodara localities. Students from any Gujarat district can join.',
  },
  {
    question: 'What is the fee for NEET coaching in Vadodara?',
    answer:
      'Our NEET Biology course ranges from Rs 24,000 to Rs 48,000 per year with EMI options and scholarships for Gujarat students.',
  },
  {
    question: 'Do you understand Gujarat board patterns?',
    answer:
      'Yes! We have specialized batches for GSEB students with faculty who understand Gujarat exam patterns.',
  },
  {
...
export default function PageContent() {
  const handleDemoBooking = () => {
    if (typeof window !== 'undefined' && (window as any).gtag) {
      ;(window as any).gtag('event', 'demo_booking_vadodara', {
        event_category: 'conversion',
        event_label: 'neet_coaching_vadodara_page',
        value: 1,
      })
    }
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto animate-fadeInUp">
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              ...
              Cultural Capital of Gujarat | Medical College Baroda Focused
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Best <span className="text-yellow-300">NEET Coaching in Vadodara</span>
            </h1>
            ...
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              ...
              Vadodara. Join 15,000+ Gujarat students achieving NEET success.
            </p>
            <div className="flex flex-col md:flex-row gap-4 justify-center mb-12">
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20%E2%80%94%20interested%20in%20coaching%20vadodara.%20Please%20share%20available%20timings."
                target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16 animate-fadeInUp">
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              NEET Coaching Across All Vadodara Localities
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-teal-50 rounded-xl p-8 border border-teal-100 animate-fadeInUp">
              ...
              <p className="text-gray-600">
                Get quality coaching from Vadodara. Save lakhs and stay with family.
              </p>
            </div>
            <div className="bg-teal-50 rounded-xl p-8 border border-teal-100 animate-fadeInUp">
              <TrendingUp className="w-12 h-12 text-teal-600 mb-4" />
              <h3 className="text-xl font-bold text-gray-900 mb-2">Rising Excellence</h3>
              <p className="text-gray-600">Gujarat students are cracking NEET at record numbers.</p>
            </div>
            <div className="bg-teal-50 rounded-xl p-8 border border-teal-100 animate-fadeInUp">
              <GraduationCap className="w-12 h-12 text-teal-600 mb-4" />
              <h3 className="text-xl font-bold text-gray-900 mb-2">GSEB Expert</h3>
              <p className="text-gray-600">We understand Gujarat board patterns and schedules.</p>
            </div>
          </div>
          <div className="bg-gray-50 rounded-2xl p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">
              Students from These Vadodara Schools Trust Us
            </h3>
            <div className="flex flex-wrap justify-center gap-4">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="animate-fadeInUp">
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              Start Your NEET Journey from the Cultural Capital
            </h2>
            <p className="text-xl mb-8 opacity-90">
              98% success rate, AIIMS trained faculties, 15,000+ Gujarat students!
            </p>
            <div className="flex flex-col md:flex-row gap-4 justify-center mb-12">
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20%E2%80%94%20interested%20in%20coaching%20vadodara.%20Please%20share%20available%20timings."
              ...
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I'm%20interested%20in%20coaching%20vadodara.%20Please%20share%20fee%20structure%20and%20enrolment%20details."
                target="_blank"
                rel="noopener noreferrer"
              >
                <Button
