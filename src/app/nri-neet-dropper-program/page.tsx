...
export const metadata: Metadata = generatePageMetadata({
  ...
  description:
    'Dedicated 10-12 month NEET 2026 dropper Biology programme for NRI students in UAE, USA, UK, Canada, Singapore, Saudi, Qatar, Africa. Diagnostic-led gap-fill, AIIMS faculty, weekly 1:1 doubt slots, NRI-quota cut-off targeting (330-355/360 for AIIMS Delhi, JIPMER, Manipal, KMC, JSS Mysuru). 89% repeater qualify rate.',
  keywords:
