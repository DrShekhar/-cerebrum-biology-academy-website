...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'live neet classes ghaziabad',
    'hybrid neet coaching ghaziabad',
    'neet classes from home ghaziabad',
  ...
  openGraph: {
    ...
    url: 'https://cerebrumbiologyacademy.com/online-neet-coaching-ghaziabad',
  },
  alternates: {
...
const travelTimes = [
  { area: 'Indirapuram', time: '0 min', mode: 'Study from home!' },
  { area: 'Vaishali', time: '0 min', mode: 'Study from home!' },
  { area: 'Kaushambi', time: '0 min', mode: 'Study from home!' },
...
const faqs = [
  {
    question: 'How do online NEET classes work for Ghaziabad students?',
    answer:
      'Our online classes are live, interactive sessions conducted via Zoom/Google Meet. You attend from your Ghaziabad home, ask questions in real-time, and get instant feedback. Classes are also recorded for later revision. Most Ghaziabad students prefer this mode as it saves 1-2 hours of daily travel.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'For most Ghaziabad students, online mode works best due to minimal travel time. However, if you need classroom environment motivation or struggle with self-discipline, hybrid mode provides weekly accountability. We recommend starting with online and upgrading to hybrid if needed.',
  },
  {
    question: 'Is online coaching as effective as offline?',
    answer:
      'Yes! Our online students consistently score 650+ in NEET. The key advantages: more study time (no travel), recorded lectures for revision, instant doubt resolution via WhatsApp, and comfortable home environment. 800+ Ghaziabad area students are currently enrolled in our online program.',
  },
  {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Online NEET Coaching for Ghaziabad Students
            </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            <div className="text-center p-4 bg-indigo-50 rounded-xl">
              ...
              <p className="text-sm text-gray-600">Ghaziabad Students Online</p>
            </div>
            <div className="text-center p-4 bg-indigo-50 rounded-xl">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Why Ghaziabad Students Love Online Classes
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <div className="bg-indigo-50 rounded-2xl p-6 border-2 border-indigo-200">
              ...
              <p className="text-gray-600 mb-4">
                Study entirely from your Ghaziabad home. Zero travel.
              </p>
      ...
      <section className="py-16 bg-indigo-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-indigo-200 mb-8">
            Join 800+ Ghaziabad students already learning online
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="tel:+919953643938"
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 3,
                name: 'Online Classes',
                item: 'https://cerebrumbiologyacademy.com/online-neet-coaching-ghaziabad',
              },
            ],
          }),
        }}
