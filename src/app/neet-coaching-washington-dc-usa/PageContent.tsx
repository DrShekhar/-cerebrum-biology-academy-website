    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-blue-50">
      <section className="relative py-16 bg-gradient-to-r from-blue-700 via-blue-600 to-teal-700 text-white">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 bg-white/20 rounded-full px-4 py-1 text-sm mb-4">
            ...
            <span>Online NEET Biology for DC / NoVA / MoCo students</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            NEET Biology Coaching in
            <br />
            <span className="text-blue-200">Washington DC (DMV)</span>
          </h1>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-6">
            Live online NEET Biology classes for Indian-American students across DC, Northern
            Virginia (Fairfax, Loudoun) and Montgomery County Maryland. AP Biology + NEET dual prep.
          </p>
          <div className="flex flex-wrap justify-center gap-4 mb-6">
            <Link
              href="https://wa.me/918826444334?text=Hi%2C%20I%20am%20from%20the%20DC%20area%20and%20want%20a%20free%20NEET%20Biology%20demo"
      ...
      <section className="py-12 max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white p-6 rounded-xl shadow text-center">
            ...
            <p className="text-sm text-gray-500">Indian-American in DMV</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow text-center">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-10">Why DMV students join Cerebrum</h2>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-3">
                  The NTA does not operate a NEET exam centre inside the United States. DC-area
                  students typically fly from <strong>IAD, DCA or BWI to Dubai</strong> (official
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-center">DMV schools we support</h2>
          <p className="text-center text-gray-600 mb-8 max-w-2xl mx-auto">
            Indian-American students from Fairfax, Loudoun, and Montgomery County schools with
            strong Indian-American populations.
          </p>
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold text-gray-900 mb-3">Northern Virginia</h3>
                <ul className="space-y-1 text-gray-700">
                  <li>Thomas Jefferson HSST</li>
                  <li>Langley HS &amp; McLean HS</li>
                  <li>Oakton HS &amp; Chantilly HS</li>
                  <li>Centreville HS &amp; Westfield HS</li>
                  <li>Academies of Loudoun, Stone Bridge, Lightridge HS</li>
                </ul>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-3">Maryland (Montgomery / PG)</h3>
                <ul className="space-y-1 text-gray-700">
                  <li>Richard Montgomery HS (Rockville)</li>
                  <li>Winston Churchill HS (Potomac)</li>
                  <li>Walt Whitman HS (Bethesda)</li>
                  <li>Walter Johnson HS &amp; Wootton HS</li>
                  <li>Poolesville HS</li>
                </ul>
              </div>
            </div>
            <p className="text-sm text-gray-500 mt-6 text-center">
              Any US high school curriculum (AP, IB, Cambridge) is fine — NEET is NCERT-based and we
              bridge the gap.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-12 text-center">Class timings for DMV</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-4 text-blue-600">Weekday Live Classes</h3>
              <p className="text-gray-700 mb-2">
                <span className="font-semibold">DC (EST):</span> 10:30 AM – 1:00 PM
              </p>
              <p className="text-gray-700 mb-2">
                <span className="font-semibold">DC (EDT):</span> 11:30 AM – 2:00 PM
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 mb-2">
                <span className="font-semibold">DC (EST):</span> 9:00 AM – 12:00 PM
              </p>
              <p className="text-gray-700 mb-2">
                <span className="font-semibold">DC (EDT):</span> 10:00 AM – 1:00 PM
              </p>
      ...
      <div id="pricing">
        <PricingSection cityName="Washington DC" />
      </div>
      <CostComparisonSection cityName="Washington DC" />

      <section className="py-16 max-w-4xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-10">
          FAQs — NEET coaching in Washington DC
        </h2>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">
            Book a free Biology demo from DC / NoVA / MoCo
          </h2>
