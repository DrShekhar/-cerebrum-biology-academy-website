...
export const metadata: Metadata = {
  ...
  description:
    'Join 2-year NEET course in Noida from Class 11. Complete foundation + advanced coaching. Sector 62. Best results with 98% success rate. Call 88264-44334!',
  keywords: [
    '2 year neet course noida',
    'two year neet coaching noida',
    'class 11 neet course',
    'class 11 12 integrated neet',
    '2 year neet program noida',
    'foundation neet course class 11',
    'neet from class 11 noida',
  ...
  openGraph: {
    ...
    url: 'https://cerebrumbiologyacademy.com/2-year-neet-course-noida',
  },
  alternates: {
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Our schedule is designed for balance: 3-4 hours coaching daily (evening batch) + 2 hours self-study. Weekends: 4-5 hours. Total: 25-30 hours/week for NEET + full school attendance. Many DPS Noida, Amity, Ryan International students manage both successfully.',
  },
  {
...
export default function TwoYearNEETCourseNoida() {
  return (
      ...
      <section className="bg-gradient-to-r from-teal-800 to-teal-600 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">2 Year NEET Course in Noida</h1>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Course',
            name: '2 Year NEET Course Noida',
            description: 'Comprehensive 2-year NEET biology coaching from Class 11 in Noida',
            provider: {
              '@type': 'Organization',
