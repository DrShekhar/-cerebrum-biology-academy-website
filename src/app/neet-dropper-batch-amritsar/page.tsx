...
export const metadata: Metadata = {
  ...
  keywords: ['neet dropper batch amritsar', 'neet repeater amritsar'],
  alternates: { canonical: `https://cerebrumbiologyacademy.com/neet-dropper-batch-amritsar` },
  openGraph: { title: `NEET Dropper Batch 2026-27 ${cityName}`, url: `https://cerebrumbiologyacademy.com/neet-dropper-batch-amritsar`, locale: 'en_IN', type: 'website' },
