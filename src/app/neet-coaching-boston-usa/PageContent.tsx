    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-blue-50">
      <section className="relative py-16 bg-gradient-to-r from-blue-700 via-blue-600 to-teal-700 text-white">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 bg-white/20 rounded-full px-4 py-1 text-sm mb-4">
            ...
            <span>Online NEET Biology for Greater Boston students</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            NEET Biology Coaching in
            <br />
            <span className="text-blue-200">Boston, USA</span>
          </h1>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-6">
            Live online NEET Biology classes for Indian-American students across Lexington,
            Burlington, Westford, Acton, Andover, Shrewsbury and Greater Boston.
          </p>
          <div className="flex flex-wrap justify-center gap-4 mb-6">
            <Link
              href="https://wa.me/918826444334?text=Hi%2C%20I%20am%20from%20Boston%20and%20want%20a%20free%20NEET%20Biology%20demo"
      ...
      <section className="py-12 max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white p-6 rounded-xl shadow text-center">
            ...
            <p className="text-sm text-gray-500">Indian-American in Greater Boston</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow text-center">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-10">
            Why Boston students join Cerebrum
          </h2>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-3">
                  The NTA does not operate a NEET exam centre inside the United States. Boston
                  students typically fly from <strong>BOS to Dubai</strong> (official NEET centre)
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-4 text-center">Greater Boston schools we support</h2>
          <p className="text-center text-gray-600 mb-8 max-w-2xl mx-auto">
            Indian-American students from Route 128/495-belt schools with the densest
            Indian-American populations.
          </p>
          <div className="bg-white border border-gray-200 rounded-lg p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold text-gray-900 mb-3">Inner Route 128 / West suburbs</h3>
                <ul className="space-y-1 text-gray-700">
                  <li>Lexington High School</li>
                  <li>Burlington High School</li>
                  <li>Acton-Boxborough Regional HS</li>
                  <li>Wayland HS &amp; Weston HS</li>
                  <li>Boston Latin School &amp; Boston Latin Academy</li>
                </ul>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-3">Outer 128 / 495 belt</h3>
                <ul className="space-y-1 text-gray-700">
                  <li>Westford Academy</li>
                  <li>Andover High School</li>
                  <li>Chelmsford High School</li>
                  <li>Shrewsbury High School</li>
                  <li>Hopkinton HS &amp; Ashland HS</li>
                </ul>
              </div>
            </div>
            <p className="text-sm text-gray-500 mt-6 text-center">
              Any Massachusetts high school curriculum (AP, IB, honors) is fine — NEET is
              NCERT-based and we bridge the gap.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-12 text-center">Class timings for Boston</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-4 text-blue-600">Weekday Live Classes</h3>
              <p className="text-gray-700 mb-2">
                <span className="font-semibold">Boston (EST):</span> 10:30 AM – 1:00 PM
              </p>
              <p className="text-gray-700 mb-2">
                <span className="font-semibold">Boston (EDT):</span> 11:30 AM – 2:00 PM
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 mb-2">
                <span className="font-semibold">Boston (EST):</span> 9:00 AM – 12:00 PM
              </p>
              <p className="text-gray-700 mb-2">
                <span className="font-semibold">Boston (EDT):</span> 10:00 AM – 1:00 PM
              </p>
      ...
      <div id="pricing">
        <PricingSection cityName="Boston" />
      </div>
      <CostComparisonSection cityName="Boston" />

      <section className="py-16 max-w-4xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-10">
          FAQs — NEET coaching in Boston, USA
        </h2>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">Book a free Biology demo from Boston</h2>
