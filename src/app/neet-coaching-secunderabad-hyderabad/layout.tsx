...
export const metadata: Metadata = {
  title: 'Best NEET Coaching in Secunderabad Hyderabad | Biology Classes',
  description:
    'Best NEET biology coaching in Secunderabad Hyderabad. 98% success rate. AIIMS faculty. Begumpet, Trimulgherry, Alwal, Malkajgiri. Online live classes. Fee ₹24,000+. Book free demo!',
  keywords:
  ...
  openGraph: {
    title: 'Best NEET Coaching in Secunderabad Hyderabad | Biology Classes',
    description:
      'Best NEET biology coaching in Secunderabad Hyderabad with 98% success rate. AIIMS faculty. Begumpet, Trimulgherry, Alwal.',
  ...
  twitter: {
    ...
    title: 'Best NEET Coaching in Secunderabad Hyderabad | Biology Classes',
    description:
      'Best NEET biology coaching in Secunderabad Hyderabad. 98% success rate. AIIMS faculty.',
  },
  alternates: {
