...
export const metadata: Metadata = {
  title: 'NEET Weekend Batch Ghaziabad 2026 | Saturday-Sunday Classes | Cerebrum',
  description:
    'Join NEET weekend batch for Ghaziabad students - Saturday & Sunday intensive classes. Complete syllabus coverage. Sector 62 Noida center, Blue Line Metro accessible. Call 99536-43938!',
  keywords: [
    'neet weekend batch ghaziabad',
    'neet weekend classes ghaziabad',
    'saturday sunday neet coaching ghaziabad',
    'weekend neet coaching ghaziabad',
    'neet classes for school students ghaziabad',
    'part time neet coaching ghaziabad',
    'weekend biology classes ghaziabad',
    'neet coaching saturday sunday ghaziabad',
    'school students neet coaching ghaziabad',
    'integrated neet coaching weekend ghaziabad',
  ],
  openGraph: {
    title: 'NEET Weekend Batch Ghaziabad 2026 | Cerebrum Biology Academy',
    description:
...
const idealFor = [
  'Class 11-12 students attending regular school in Ghaziabad',
  'Students in integrated schools (DPS Indirapuram, Ryan, GD Goenka)',
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Yes, with proper utilization! Our weekend batch covers: 8 hours class time + 6-8 hours self-study assignments = 14-16 hours/week biology preparation. Many Ghaziabad students score 300+/360 with weekend-only coaching plus dedicated home study.',
  },
  {
    question: 'Who is the weekend batch ideal for in Ghaziabad?',
    answer:
      'Perfect for: 1) Class 11-12 students attending regular school in Ghaziabad, 2) Students in integrated schools (DPS Indirapuram, Ryan, etc.), 3) Working professionals, 4) Students already taking coaching for Physics/Chemistry elsewhere, 5) Those needing biology supplementary coaching.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes, flexible switching allowed: 1) Mid-year switch with syllabus sync, 2) Fee difference adjusted, 3) Catch-up support for additional chapters. Many Class 12 Ghaziabad students switch to regular batch after boards for intensive prep.',
  },
  {
...
export default function NEETWeekendBatchGhaziabad() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link
                href="/neet-evening-batch-ghaziabad"
