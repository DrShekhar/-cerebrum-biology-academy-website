...
export default function NEETDropperBatchNoidaContent({ faqs }: { faqs: FAQ[] }) {
  const [openFaq, setOpenFaq] = useState<number | null>(null)

  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'dropper-batch-2025-noida',
      message:
        'Hi! I am interested in NEET Dropper Batch 2026-27 in Noida. Please share details about the program.',
      campaign: 'dropper-batch-2025-noida',
    })
  }
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-slate-800 to-slate-700 rounded-2xl p-8 text-white animate-fadeInUp">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold">Our Noida Center</h2>
              </div>
              <p className="text-slate-300 mb-4">
                <strong className="text-white">Address:</strong> B-45, Sector 62, Noida, UP 201301
              </p>
              <p className="text-slate-300 mb-4">
                <strong className="text-white">Landmark:</strong> Near Sector 62 Metro Station (5
                min walk)
              </p>
              <p className="text-slate-300 mb-6">
                <strong className="text-white">Metro:</strong> Sector 62 Metro Station (Blue Line)
              </p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <Link
              href="/1-year-neet-course-noida"
              className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">One Year NEET Course</h3>
            ...
            <Link
              ...
              className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">NEET Coaching Noida</h3>
            ...
            <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Dropper%20batch%20in%20Noida.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer" className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md">
