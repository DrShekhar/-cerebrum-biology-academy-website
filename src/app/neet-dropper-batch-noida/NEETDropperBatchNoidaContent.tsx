...
export default function NEETDropperBatchNoidaContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      ...
      message:
        'Hi! I am interested in NEET Dropper Batch 2025-26 in Noida. Please share details about the program.',
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-slate-900 to-slate-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join NEET Dropper Batch 2025-26 in Noida and improve by 100-150 marks
          </p>
