      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 prose prose-slate max-w-none">
          ...
          <ul>
            ...
            <li>
              <strong>Ascent (Pro Batch 12-16) — ₹55,000-75,000/year.</strong> Most popular Chennai
