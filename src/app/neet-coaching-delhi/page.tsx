      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-5xl px-4 prose prose-slate max-w-none">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">
            Delhi NEET coaching — why families choose Cerebrum over Aakash and Allen / FIITJEE /
            PhysicsWallah and Unacademy
          </h2>
          <p>
            Delhi NEET aspirants have several generalist NEET coaching options — the largest
            national NEET chain (Kalu Sarai / Punjabi Bagh), Allen (multiple centres), FIITJEE
            (Punjabi Bagh / South Ex), other online-only platforms (online), and Kota-origin
            coaching chains. These chains run combined Physics + Chemistry + Biology batches of
            200-400 students with rotating subject faculty. Cerebrum is structurally different: the
            only NEET coaching institute in India built exclusively around biology — the
            highest-scoring NEET subject at 360/720 marks (50% of total). 15-20 student batches,
            AIIMS-trained faculty continuity year-over-year, half the cost of Kota relocation. Most
            Cerebrum Delhi students pair Cerebrum biology with PhysicsWallah and Unacademy or other
            multi-subject tutoring platforms for Physics + Chemistry — total stack ₹70K-₹1.1L vs
            Aakash full PCB at ₹1.5L+ and Kota relocation at ₹2L-₹2.5L all-in.
          </p>
