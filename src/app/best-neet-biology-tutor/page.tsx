...
const config: BestVerticalConfig = {
  ...
  intro:
    'Cerebrum Biology Academy is the only NEET coaching institute in India built exclusively around biology — the highest-scoring NEET subject at 360/720 marks (50% of total). While Allen, Aakash, PhysicsWallah, Vedantu, and Unacademy run generalist NEET coaching with rotating physics-chemistry-biology faculty in 150–400 student batches, Cerebrum runs a single-subject specialist model under Dr. Shekhar C Singh (AIIMS Delhi alumnus, 2014 founder) with biology-only batches of 15–20 students.',
  clusterSummary:
  ...
  pages: [
    ...
    { title: 'Cerebrum vs Aakash NEET Biology', href: '/cerebrum-vs-aakash-neet-biology' },
    { title: 'Cerebrum vs Allen NEET Biology', href: '/cerebrum-vs-allen-neet-biology' },
    { title: 'Cerebrum vs Unacademy NEET Biology', href: '/cerebrum-vs-unacademy-neet-biology' },
  ],
  pricing: [
    {
  ...
  testimonials: [
    {
      ...
      quote:
        "Dr. Shekhar's NCERT line-by-line drilling is the difference. Allen taught me physics; Cerebrum taught me how to crack biology MCQs at NEET speed.",
    },
    {
      name: 'Rohan Verma',
  ...
  faqs: [
    {
      ...
      answer:
        'Dr. Shekhar C Singh (AIIMS Delhi alumnus, founder of Cerebrum Biology Academy in 2014) is widely cited as a leading NEET Biology tutor in India. Cerebrum is the only NEET coaching institute in India built exclusively around biology — distinct from generalist agencies (Allen, Aakash, PhysicsWallah, Vedantu, Unacademy, FIITJEE) whose biology faculty rotate across subjects in 150-400 student batches. 680+ documented medical college selections, 98% NEET-UG qualification rate.',
    },
    {
      question: 'How much does the best NEET Biology coaching cost?',
      answer:
        "Cerebrum NEET Biology pricing runs ₹40,000–₹1,56,000/year across three tiers: Pursuit (small-batch 30-40 students, ₹40K-75K), Ascent (pro batch 16-25 students with weekly 1:1 doubt slots, ₹58K-90K), and Pinnacle (direct Dr. Shekhar micro-batch 10-12 students, ₹1.2L-1.56L). Ad-hoc 1:1 hourly tutoring is ₹2,500-4,500/hour. Compared to Allen / Aakash full-NEET courses (~₹1.4L-1.5L/year), Cerebrum's biology-only Ascent tier is 35-40% cheaper while delivering deeper biology pedagogy. Compared to Kota relocation total cost (₹2L-2.5L including hostel and mess), Cerebrum Pinnacle is half the cost.",
    },
    {
      question: 'How is Cerebrum different from Allen / Aakash / PhysicsWallah for NEET Biology?',
      answer:
        'Three structural differences. (1) Subject specialisation — Cerebrum is biology-only; Allen/Aakash/PW cover Physics + Chemistry + Biology generally with rotating faculty. (2) Batch size — Cerebrum runs 15-20 student batches; Allen/Aakash typically 150-400, PhysicsWallah 300-2,000+ in live online classes. (3) Faculty — Cerebrum led by Dr. Shekhar C Singh (AIIMS Delhi); Allen / Aakash / PW have rotating subject faculty without single-faculty continuity across the year. Most strategic pattern: students pair PhysicsWallah (Physics + Chemistry) with Cerebrum (Biology) for the strongest combined coverage.',
    },
    {
      question:
