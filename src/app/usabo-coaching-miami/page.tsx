...
export default function Page() {
  return (
    <USABOCityTemplate
      ...
      faqs={[
        { question: 'Ransom Everglades or Gulliver students — what level should they start at?', answer: 'Both schools have strong AP Biology programmes. Our USABO coaching extends to Alberts/Lehninger depth for Semifinal targeting. Start in October for the February Open.' },
        { question: 'Weston / Coral Springs families — planning conversation?', answer: 'The South Asian community in Weston/Coral Springs drives growing USABO demand. We discuss: target level (Open qualification vs Semifinal), AP Biology bridge, and ET evening scheduling.' },
        { question: 'MAST Academy marine-science students — relevant for USABO?', answer: 'Yes — MAST students have strong ecology and marine-biology foundations that overlap with USABO ecology questions. We build on this foundation and add molecular biology and genetics depth.' },
        { question: 'How does USABO coaching complement AP Biology?', answer: 'USABO Open overlaps ~70% with AP Biology. The Semifinal requires Alberts-level depth beyond AP. We build on the AP foundation.' },
        { question: 'What does USABO coaching cost?', answer: '1:1 Elite Mentoring: $90/hour. Small-Batch Weekend: $50/hour. Complete Olympiad Year: $4,500/year.' },
      ]}
    />
  )
}
