...
const syllabusTopics = [
  { unit: 'Cell - The Unit of Life', chapters: ['Cell structure', 'Cell organelles', 'Cell division basics'], neetRelevance: 'High' },
  { unit: 'Tissues', chapters: ['Plant tissues', 'Animal tissues', 'Tissue functions'], neetRelevance: 'High' },
  { unit: 'Diversity in Living Organisms', chapters: ['Classification', 'Five Kingdom', 'Nomenclature'], neetRelevance: 'Medium' },
  { unit: 'Life Processes - I', chapters: ['Nutrition', 'Respiration basics', 'Transport'], neetRelevance: 'High' },
  { unit: 'Scientific Methodology', chapters: ['Observation', 'Hypothesis', 'Experimentation'], neetRelevance: 'Foundation' },
]

const benefits = [
  { title: '4-Year Head Start', description: 'More time to build concepts, less stress in Class 11-12', icon: Clock },
  { title: 'Strong Foundation', description: 'Deep understanding of basics that NEET builds upon', icon: BookOpen },
  { title: 'Board + NEET Dual Prep', description: 'Excel in school exams while preparing for NEET', icon: Target },
  { title: 'Expert Faculty', description: 'Teachers who understand both board and competitive exams', icon: Users },
  { title: 'Small Batches', description: 'Maximum 15 students for personalized attention', icon: GraduationCap },
  { title: 'Score Improvement', description: 'Students score 50-100 marks higher starting early', icon: TrendingUp },
]
...
export default function NEETFoundationClass9Content({ faqs }: { faqs: FAQ[] }) {
  const [openFaq, setOpenFaq] = useState<number | null>(null)

  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'foundation-class9-gurugram',
      message: 'Hi! I am a Class 9 student from Gurugram interested in NEET Foundation course. Please share details.',
      campaign: 'foundation-class9-gurugram',
    })
  }
    ...
    <main className="min-h-screen bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              Start your medical dream journey from Class 9. Build strong biology foundation while excelling in board exams.
              Join our Sector 51, Gurugram center for expert guidance.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20Foundation%20Biology%20(Class%209%2F10)%20in%20Gurugram.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between py-3 border-b"><span className="text-slate-600">Duration</span><span className="font-semibold">1 Year</span></div>
                <div className="flex justify-between py-3 border-b"><span className="text-slate-600">Fee Range</span><span className="font-semibold text-green-600">₹45,000 - ₹90,000/year</span></div>
              ...
              <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20Foundation%20Biology%20(Class%209%2F10)%20in%20Gurugram.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer" className="block mt-6">
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <Link href="/neet-foundation-class-10-gurugram" className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md"><h3 className="font-semibold text-teal-600">Foundation Class 10</h3><p className="text-sm text-gray-600">Continue your journey</p></Link>
            <Link href="/class-9-biology-tuition-gurugram" className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md"><h3 className="font-semibold text-teal-600">Class 9 Biology Tuition</h3><p className="text-sm text-gray-600">Board exam focus</p></Link>
            <Link href="/neet-coaching-gurugram" className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md"><h3 className="font-semibold text-teal-600">NEET Coaching Gurugram</h3><p className="text-sm text-gray-600">Full NEET program</p></Link>
            <Link href="/biology-olympiad-coaching-gurugram" className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md"><h3 className="font-semibold text-teal-600">Biology Olympiad</h3><p className="text-sm text-gray-600">Competitive exams</p></Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-green-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Start Your NEET Journey from Class 9</h2>
          <p className="text-xl mb-8 opacity-90">Join Cerebrum Biology Academy Gurugram and get a 4-year head start</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20Foundation%20Biology%20(Class%209%2F10)%20in%20Gurugram.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer"><Button variant="secondary" size="xl" className="bg-white text-green-600 hover:bg-gray-100 font-bold"><Play className="w-5 h-5 mr-2" />Book Free Demo</Button></Link>
