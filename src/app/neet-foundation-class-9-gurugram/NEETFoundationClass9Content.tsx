...
export default function NEETFoundationClass9Content({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      ...
      message:
        'Hi! I am a Class 9 student from Gurugram interested in NEET Foundation course. Please share details.',
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              NEET Foundation Class 9<span className="block text-green-400 mt-2">in Gurugram</span>
            </h1>

            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              Start your medical dream journey from Class 9. Build strong biology foundation while
              excelling in board exams. Join our Sector 51, Gurugram center for expert guidance.
            </p>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20Foundation%20Biology%20(Class%209%2F10)%20in%20Gurugram.%20Please%20share%20available%20timings."
                target="_blank"
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-green-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join Cerebrum Biology Academy Gurugram and get a 4-year head start
          </p>
