      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            jobTitle: 'Founder & Lead Faculty — Contact Cerebrum Biology Academy',
            description:
        ...
        <section className="bg-[#3d4d3d] text-white py-12 sm:py-16 md:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              >
                <Link
                  href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20%E2%80%94%20interested%20in%20contact.%20Please%20share%20available%20timings."
                  target="_blank"
