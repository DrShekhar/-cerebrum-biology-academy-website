...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: 'Call Us',
      details: ['+91 98765 43210', '+91 98765 43211 (Admissions)'],
      color: 'bg-green-500',
    },
    {
      icon: Mail,
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center">
            ...
            >
              Ready to start your NEET journey? Contact us for admission guidance, course information, 
              or any queries about our biology coaching programs.
            </motion.p>
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-green-100 mb-8">
            Join thousands of successful students and achieve your medical dreams with expert guidance.
          </p>
