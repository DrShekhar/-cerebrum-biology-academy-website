...
const PAGE_URL = 'https://cerebrumbiologyacademy.com/neet-coaching-near-me-patna'

export const metadata: Metadata = {
  title: 'NEET Coaching Near Me Patna | Best Biology Coaching Nearby | Cerebrum',
  description: 'Best NEET coaching near me in Patna — serving Boring Road, Kankarbagh. AIIMS-trained biology specialists, online live. 15-20 student batches. From Rs 48,000/yr.',
  keywords: [
    'NEET coaching near me patna',
    'best NEET coaching near me patna',
    'NEET biology coaching near patna',
    'NEET coaching nearby patna',
  ],
  other: { 'article:modified_time': '2026-05-27' },
  alternates: { canonical: PAGE_URL },
  openGraph: { title: 'NEET Coaching Near Me Patna | Best Biology Coaching Nearby', description: 'Best NEET coaching near me in Patna — serving Boring Road, Kankarbagh. AIIMS-trained biology specialists, online live. 15-20 student batches. From Rs 48,000/yr.', url: PAGE_URL, locale: 'en_IN', type: 'website' },
}
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">NEET Coaching Near Me in Patna</h1>
          <p className="text-xl text-slate-300 mb-6 max-w-3xl">Looking for NEET coaching near you in Patna? Cerebrum Biology Academy serves students across Boring Road, Kankarbagh and surrounding areas via online live classes. No commute needed — join from home with the same AIIMS-trained faculty and 15-20 student batch structure as our Delhi NCR offline centres. IST evening sessions (5-8 PM) fit around school schedules.</p>
