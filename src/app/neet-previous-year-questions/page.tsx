...
export default function NEETPreviousYearQuestionsPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        '@type': 'ListItem',
        position: 2,
        name: 'NEET Biology PYQ',
        item: 'https://cerebrumbiologyacademy.com/neet-previous-year-questions',
      },
    ],
  }
  ...
  const courseSchema = {
    ...
    description:
      'Practice 500+ NEET Biology PYQs with detailed solutions and chapter-wise analysis.',
    provider: {
      '@type': 'Organization',
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white animate-fadeInUp">
        ...
        <section className="bg-gradient-to-r from-indigo-700 via-purple-700 to-indigo-800 text-white py-16 px-4 sm:px-6 lg:px-8 animate-fadeInUp">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-indigo-100 text-lg md:text-xl max-w-3xl mb-8">
              Chapter-wise and year-wise NEET Biology PYQs from 2019 to 2024. Detailed solutions,
              trend analysis, and high-yield topic identification by AIIMS faculty.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl">
              {[
                ...
                {
                  label: 'High-Yield Chapters',
                  value: String(highYieldChapters.length),
                  icon: Target,
                },
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 animate-fadeInUp">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-4">
            Why NEET PYQs Are Non-Negotiable
          </h2>
          <p className="text-gray-600 text-center mb-10 max-w-2xl mx-auto">
            Solving previous year questions is the single most effective strategy for NEET Biology
            preparation. Here is why.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                icon: Target,
                title: '60-70% Repeated Concepts',
                desc: 'The same high-yield topics are tested every year. PYQs reveal exactly where to focus.',
                color: 'text-red-600 bg-red-50',
              },
              {
                icon: TrendingUp,
                title: 'Understand Exam Trends',
                desc: 'See which chapters are gaining weightage and which are losing relevance year after year.',
                color: 'text-blue-600 bg-blue-50',
              },
              {
                icon: Clock,
                title: 'Time Management',
                desc: 'PYQ practice builds speed. You learn to identify question types and solve them faster.',
                color: 'text-green-600 bg-green-50',
              },
              {
                icon: Brain,
                title: 'NCERT Alignment',
                desc: '85-90% of NEET biology is NCERT-based. PYQs show you exactly which NCERT lines are tested.',
        ...
        <section className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8 animate-fadeInUp">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-gray-600 mb-10 ml-10">
              Practice NEET biology questions from each year. Start with the most recent paper for
              current patterns.
            </p>
                ...
                >
                  <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={`px-3 py-1 rounded-full text-xs font-bold border ${getDifficultyColor(yearData.averageDifficulty)}`}
                      >
                        {yearData.averageDifficulty}
                      </span>
                    </div>
                    <p className="text-indigo-100 text-sm mt-1">
                      {yearData.totalBioQuestions} Biology Questions
                    </p>
                  </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 animate-fadeInUp">
          ...
          <p className="text-gray-600 mb-10 ml-10">
            Based on analysis of NEET 2019-2024 papers. Focus on chapters marked as High Yield for
            maximum marks.
          </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-bold text-amber-900 text-lg">
                  High-Yield Chapters (60%+ of all questions)
                </h3>
                <p className="text-amber-800 text-sm mt-1">
                  These {highYieldChapters.length} chapters contribute over 60% of all NEET biology
                  questions. Master these first for the highest score improvement.
                </p>
                <div className="flex flex-wrap gap-2 mt-3">
                  {highYieldChapters.map((ch) => (
                    <span
                      key={ch.chapter}
                      className="px-3 py-1 bg-amber-100 text-amber-800 rounded-full text-xs font-bold"
                    >
          ...
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            <div className="overflow-x-auto">
              <table className="min-w-full">
                ...
                <tbody>
                  {CHAPTER_DISTRIBUTION.sort(
                    (a, b) => b.avgQuestionsPerYear - a.avgQuestionsPerYear
                  ).map((ch, idx) => (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                {
                  step: '1',
                  title: 'Complete NCERT First',
                  desc: 'Read every line, diagram, and example in NCERT Biology for both Class 11 and 12. This is your foundation — 85-90% of NEET questions come from NCERT.',
                  icon: BookOpen,
                },
                {
                  step: '2',
                  title: 'Solve Chapter-wise, Not Year-wise',
                  desc: 'After finishing a chapter in NCERT, immediately solve all PYQs from that chapter (across all years). This reinforces concepts and reveals which specific topics are tested repeatedly.',
                  icon: Layers,
                },
                {
                  step: '3',
                  title: 'Focus on High-Yield Chapters First',
                  desc: `Start with the ${highYieldChapters.length} high-yield chapters that contribute 60%+ of questions. Genetics, Ecology, Human Physiology, and Reproduction should be your top priorities.`,
                  icon: Target,
                },
                {
                  step: '4',
                  title: 'Analyse Mistakes Deeply',
                  desc: 'For every wrong answer, go back to NCERT and find the exact line where the concept is mentioned. Make a separate error log categorised by chapter. This becomes your revision sheet.',
                  icon: Brain,
                },
                {
                  step: '5',
                  title: 'Simulate Exam Conditions',
                  desc: 'After chapter-wise practice, solve full year papers (90 questions in 90 minutes) under timed conditions. This builds exam temperament and time management skills.',
                  icon: Clock,
                },
              ].map((item) => (
                <div
                  key={item.step}
                  className="flex gap-4 bg-white rounded-xl p-6 border border-indigo-100"
                >
            ...
            {[
              {
                ...
                desc: 'Chapter-wise notes for all 38 NEET biology chapters by AIIMS faculty.',
                href: '/biology-notes-for-neet',
                icon: BookOpen,
              },
              {
                title: 'How to Score 360 in Biology',
                desc: 'Complete strategy guide for scoring full marks in NEET Biology.',
                href: '/blog/how-to-score-360-in-neet-biology',
                icon: Award,
              },
              {
                title: 'NEET Biology MCQ Practice',
                desc: 'Chapter-wise MCQ practice with instant feedback and explanations.',
