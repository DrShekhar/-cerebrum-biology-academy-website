...
import { class10SEOPages } from '@/data/seo-landing'

const content = class10SEOPages.class10BiologyTuitionOnline
...
export default function Class10BiologyTuitionOnlinePage() {
  return (
    <>
      <script
