...
const features = [
  {
    ...
    description:
      'Real-time online sessions from Zirakpur. Same quality as Sector 34 coaching centers.',
  },
  {
    icon: Users,
    title: 'Batch Size: 10-15 Only',
    description:
      'Unlike 100+ batches at Chandigarh centers. Every Zirakpur student gets attention.',
  },
  {
    icon: Award,
    title: 'AIIMS Faculty',
...
const faqs = [
  {
    ...
    answer:
      'Zirakpur lacks quality NEET coaching centers. Cerebrum Biology Academy provides online NEET coaching accessible from Zirakpur with AIIMS faculty, 98% success rate. 90+ Zirakpur students already enrolled. Better than traveling to Chandigarh daily!',
  },
  {
    question: 'How much does NEET coaching cost for Zirakpur students?',
    answer:
      'Cerebrum Academy fees: Foundation (Class 11) - Rs 24,000/year, Comprehensive (Class 12) - Rs 36,000/year, Dropper batch - Rs 68,000/year. Plus you save Rs 45,000+ yearly by not traveling to Chandigarh Sector 34.',
  },
  {
    question: 'Should Zirakpur students travel to Chandigarh for NEET coaching?',
    answer:
      'No! Zirakpur to Sector 34 takes 30-45 min each way, costs Rs 3000-4500/month in transport, and VIP Road traffic is unpredictable. Cerebrum offers same quality online - study from home in Zirakpur.',
  },
  {
    question: 'Which areas in Zirakpur does Cerebrum cover?',
    answer:
      'Cerebrum serves all Zirakpur areas: VIP Road, Baltana, Dhakoli, Maya Garden, Patiala Road, Lohgarh, and nearby localities. Online classes = no travel required.',
  },
  {
    question: 'What are the batch timings for Zirakpur students?',
    answer:
      'Multiple options: Morning batch (6 AM - 8 AM), After-school batch (4 PM - 6 PM), Evening batch (7 PM - 9 PM). Choose based on your school timing. Weekend batches also available.',
  },
  {
    question: 'Is online NEET coaching effective for Zirakpur students?',
    answer:
      'Yes! 98% success rate. Live interactive classes, small batches (10-15 students), instant WhatsApp doubt clearing, recorded sessions for revision. 90+ Zirakpur students achieving great results.',
  },
  {
    question: 'Which medical colleges can Zirakpur students target?',
    answer:
      'Target colleges: PGIMER Chandigarh (15 km), GMCH Sector 32 (12 km), AIIMS Bathinda, GMC Patiala (55 km for Punjab quota), DMC Ludhiana. Cerebrum provides college-specific guidance.',
  },
  {
    question: 'How does Cerebrum compare to Chandigarh coaching?',
    answer:
      'Cerebrum advantages: (1) Batch 10-15 vs 60-120 at the largest national NEET chains, (2) AIIMS faculty, (3) Fees Rs 24-68K vs Rs 1.5-3.5 Lakhs, (4) No Chandigarh commute from Zirakpur, (5) 98% success rate.',
  },
  {
    question: 'Is NEET coaching available on VIP Road Zirakpur?',
    answer:
      "There's no dedicated NEET coaching on VIP Road. Cerebrum's online coaching is accessible from VIP Road area. 25+ students from VIP Road enrolled. Save 30+ min daily commute to Chandigarh.",
  },
  {
    question: 'Does Cerebrum provide study material for Zirakpur students?',
    answer:
      'Complete package included: Digital notes, chapter-wise video lectures, 10,000+ MCQs, previous year papers (2015-2025), mock tests with analysis. All accessible online from Zirakpur.',
  },
  {
    question: 'Is dropper batch available for Zirakpur students?',
    answer:
      'Yes! Dedicated dropper batch at Rs 68,000/year. Intensive 6-8 hours daily, personal mentorship, weekly tests, AIIMS faculty. Many Zirakpur droppers improved 100+ marks with Cerebrum.',
  },
  {
    question: 'How to book free demo from Zirakpur?',
    answer:
      'Simple: (1) Call/WhatsApp: +91-8826444334, (2) Visit cerebrumbiologyacademy.com, (3) Attend live demo from Zirakpur home, (4) Meet AIIMS faculty. Free demo - no commitment required.',
  },
  {
    question: 'Can Baltana students join Cerebrum?',
    answer:
      'Absolutely! 20+ students from Baltana already enrolled. Online classes mean no travel from Baltana to anywhere. Study from home with same quality as Chandigarh coaching.',
  },
  {
    question: 'Are there scholarships for Zirakpur students?',
    answer:
      'Yes! Monthly scholarship test with 25-100% fee waiver. Zirakpur students appear online. Also: sibling discount (10%), early bird discount (15%), need-based scholarships available.',
  },
  {
    question: 'What is the success rate for Zirakpur students?',
    answer:
      '98% overall success rate. From Zirakpur specifically: 12+ students in government medical colleges in 2024, several in PGIMER/GMCH. Highest Biology score 358/360.',
  },
]
...
export default function PageContent() {
  return (
    <div className="min-h-screen">
      <CityBreadcrumb cityName="Zirakpur" stateName="Punjab" stateSlug="punjab" />
      <CitySchema
        cityName="Zirakpur"
        citySlug="zirakpur"
        state="Punjab"
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="animate-fadeInUp">
              ...
              <p className="text-xl lg:text-2xl text-teal-100 mb-8 leading-relaxed">
                Finally! Quality NEET coaching accessible from Zirakpur.{' '}
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {successMetrics.map((metric, index) => (
              <div
                key={metric.label}
                className="text-center p-6 rounded-xl bg-gradient-to-br from-teal-50 to-cyan-50 animate-fadeInUp"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Why Zirakpur students struggle with NEET preparation
            </p>
          </div>
      ...
      <section className="py-16 bg-green-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Premium coaching delivered to your Zirakpur home
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
            {zirakpurAreas.map((area, index) => (
              ...
              >
                ...
                <div
                  className={`text-sm ${area.priority === 'high' ? 'text-teal-100' : 'text-gray-600'}`}
                >
                  {area.students} students
                </div>
                <div
                  className={`text-xs mt-1 ${area.priority === 'high' ? 'text-teal-200' : 'text-gray-500'}`}
                >
                  {area.highlight}
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-red-50 p-8 rounded-2xl border border-red-200">
              <h3 className="text-xl font-bold text-red-700 mb-6">
                Chandigarh Coaching (from Zirakpur)
              </h3>
              <ul className="space-y-3">
                ...
                <li className="flex justify-between">
                  ...
                  <span className="font-bold">₹36,000 - ₹54,000</span>
                </li>
                <li className="flex justify-between">
                  <span>Time Lost (hrs/year)</span>
                  <span className="font-bold">550+ hours</span>
                </li>
                <li className="flex justify-between">
                ...
                <li className="flex justify-between border-t pt-3 text-lg">
                  ...
                  <span className="font-bold text-red-700">₹1,90,000+</span>
                </li>
              </ul>
            </div>
            <div className="bg-green-50 p-8 rounded-2xl border border-green-200">
              <h3 className="text-xl font-bold text-green-700 mb-6">
                Cerebrum Online (From Zirakpur)
              </h3>
              <ul className="space-y-3">
                <li className="flex justify-between">
                  <span>Tuition Fee</span>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-gray-900">
              Free NEET Tools for Zirakpur Students
            </h2>
          </div>
      ...
      <PricingSection cityName="Zirakpur" />
      <CostComparisonSection cityName="Zirakpur" />
      ...
      <nav className="py-4 bg-gray-100">
        <div className="container mx-auto px-4">
          <ol className="flex flex-wrap items-center gap-2 text-sm text-gray-600">
            ...
            <li>/</li>
            <li>
              <Link href="/neet-coaching-punjab" className="hover:text-teal-600">
      ...
      <RelatedCityLinks currentCity="zirakpur" variant="default" />
    </div>
  )
}
