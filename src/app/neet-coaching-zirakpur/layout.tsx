...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Best NEET Coaching in Zirakpur 2026 | VIP Road & Baltana',
    description:
      'Top NEET coaching in Zirakpur Punjab. 98% success rate, AIIMS faculty. 90+ students from Zirakpur. Skip traffic to Chandigarh!',
...
export default function ZirakpurCoachingLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>
}
