...
export const metadata: Metadata = {
  title: 'NEET Scholarship Ghaziabad 2026 | Up to 100% Fee Waiver | Cerebrum Academy',
  description:
  ...
  keywords: [
    ...
    'neet coaching scholarship ghaziabad',
    'free neet coaching scholarship ghaziabad',
    'merit scholarship neet ghaziabad',
    'neet fee concession ghaziabad',
    'scholarship test neet ghaziabad',
    'neet coaching financial aid',
    'biology scholarship ghaziabad',
  ],
  openGraph: {
    title: 'NEET Scholarship Ghaziabad 2026 | Cerebrum Biology Academy',
...
const eligibility = [
  ...
  'Ghaziabad / NCR residents preferred (online available for others)',
]
...
const faqs = [
  {
    question: 'Who is eligible for the NEET scholarship for Ghaziabad students?',
    answer:
      'Students with 75%+ marks in Class 10/11/12 are eligible. Both Ghaziabad residents and online students can apply. Scholarship is based on academic merit or performance in our scholarship test.',
  },
  {
  ...
  {
    question: 'Is scholarship available for Ghaziabad online students?',
    answer:
      ...
      <section className="bg-gradient-to-r from-yellow-600 to-orange-500 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">NEET Scholarship Ghaziabad 2026</h1>
