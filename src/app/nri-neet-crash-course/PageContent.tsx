...
const stats = [
  'Average improvement: 120+ marks',
  'Focus on top 40 high-yield topics',
  'USD-anchored pricing',
  'Daily mock tests included',
]
...
export function PageContent() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl mb-6 opacity-90">
            Last-minute intensive 3-6 month program for NRI students before NEET. Focus on
            high-yield topics, daily mock tests, and NCERT revision.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            <p className="text-lg text-gray-700 mb-4">
              <strong>Target Audience:</strong> Students in final 3-6 months before NEET
            </p>
            <p className="text-lg text-gray-700 mb-4">
              <strong>Program Duration:</strong> 3 or 6 months intensive
            </p>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-700">
                  Topic prioritization - focus on 40 high-yield chapters
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">•</span>
                <span className="text-gray-700">Daily mock tests to build exam confidence</span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">•</span>
                <span className="text-gray-700">NCERT revision videos and notes</span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">•</span>
                <span className="text-gray-700">Quick concept clarification sessions</span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">•</span>
                <span className="text-gray-700">
                  Previous year analysis to predict paper pattern
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">•</span>
                <span className="text-gray-700">Last-minute strategy sessions</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      {/* Geo-aware pricing replaces previous hardcoded INR tiers. */}
      <NEETNRIPricingTiers />
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">
                Is 3-6 months enough time to improve my NEET score significantly?
              </h3>
              <p className="text-gray-700 leading-relaxed">
                Yes! Our crash course focuses on high-yield topics that constitute 70% of the NEET
                paper.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">
                Which 40 topics should I prioritize in my last months?
              </h3>
              <p className="text-gray-700 leading-relaxed">
                We provide detailed topic prioritization based on NEET exam analysis.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">
                How many mock tests are included in the crash course?
              </h3>
              <p className="text-gray-700 leading-relaxed">
                In the 3-month program: ~90 mock tests. In the 6-month program: ~180 mock tests.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">Can NRI students join mid-month?</h3>
              <p className="text-gray-700 leading-relaxed">
                Yes! You can start the program at any point and catch up with recorded sessions.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">
                What makes this different from regular NEET preparation?
              </h3>
              <p className="text-gray-700 leading-relaxed">
                Our crash course is specifically designed for last-minute preparation with focus on
                exam strategy.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">
                Is NCERT revision included or should I study separately?
              </h3>
              <p className="text-gray-700 leading-relaxed">
                Complete NCERT revision notes and videos are provided as part of the crash course.
              </p>
            </div>
          </div>
          <div className="mt-8 text-center">
