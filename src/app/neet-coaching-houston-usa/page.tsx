...
export const metadata: Metadata = {
  ...
  description:
    "Expert NEET coaching for Houston, USA students. 98% success rate. Dr. Shekhar C Singh's specialized curriculum. Join 50+ top scorers.",
  keywords:
    'NEET coaching houston, NEET classes houston, medical entrance exam houston, biology coaching houston, Cerebrum Biology Academy houston',
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/neet-coaching-houston-usa',
  },
