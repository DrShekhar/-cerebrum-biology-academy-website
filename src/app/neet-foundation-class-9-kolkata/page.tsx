...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'NEET Foundation Class 9 in Kolkata | AIIMS-Trained Online Live',
    description:
      'NEET Foundation Class 9 in Kolkata at Cerebrum Biology Academy — pan-India online live with AIIMS-trained faculty. CBSE / ICSE / West Bengal Board (Madhyamik) + NEET parallel. Ballygunge, Park Stre...',
  },
}
...
const faqs = [
  ...
  {
    question:
      'How does Cerebrum compare to Allen Kolkata, Pathfinder, or FIITJEE Kolkata for Class 9?',
    answer:
      'Allen Scholastics Kolkata operates ~4 centres (Park Street, Salt Lake, Howrah, Behala) with 150-300 student Class 9 PCB Foundation batches. Pathfinder (Kolkata-headquartered) runs strong local NEET prep with similar mass-batch model. FIITJEE Kolkata operates 1-2 centres focused on JEE+NEET combined. Cerebrum is biology-only with 15-20 student online live batches and AIIMS-trained biology faculty — structurally different positioning. Kolkata families with strong ICSE academic tradition disproportionately value pedagogy depth; Cerebrum biology + Allen/Pathfinder PC is a common Kolkata pattern.',
  },
  {
    question: 'What does Class 9 NEET Foundation cost in Kolkata?',
    answer:
      "Cerebrum Class 9 Foundation pricing for Kolkata families (pan-India online): Pursuit ₹35K-50K, Ascent ₹55K-70K, Pinnacle ₹75K-90K, ad-hoc 1:1 ₹2,000-3,500/hr. Kolkata Class 9 competitive context: Allen Scholastics Kolkata Class 9 PCB (~₹75K-95K, 4 centres Park Street/Salt Lake/Howrah/Behala, 200-student batches); Pathfinder Kolkata (Kolkata-headquartered, ~₹70K-90K, strong local brand with ICSE-aware pedagogy); FIITJEE Kolkata Class 9 (~₹85K-1L, JEE-leaning); Future Foundation Class 9 prep (~₹65K-85K). Kolkata's ICSE-legacy families pattern: Cerebrum biology Ascent (₹65K) + PhysicsWallah and Unacademy live PC (₹15K) = ₹80K total with materially deeper biology than Allen standalone, suited to families who value academic depth over mass-batch volume.",
  },
]
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 prose prose-slate max-w-none">
          ...
          <ul>
            ...
            <li>
              <strong>Ascent (Pro Batch 12-16) — ₹55,000-70,000/year.</strong> Most popular Kolkata
