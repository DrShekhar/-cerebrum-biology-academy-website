...
const onlineFeatures = [
  {
    ...
    description: 'Real-time sessions with Dr. Shekhar. Ask questions, participate in discussions.',
    icon: Video,
  },
  {
    title: 'HD Recorded Lectures',
    description: '500+ hours of content. Watch anytime, unlimited replays for 1 year.',
    icon: Download,
  },
  {
    title: 'Instant Doubt Support',
    description: 'WhatsApp group with 4-hour response. Weekly live doubt sessions.',
    icon: MessageCircle,
  },
  {
    title: 'Digital Study Material',
    description: 'Complete PDF notes, diagrams, and MCQ banks. Print or study on device.',
    icon: FileText,
  },
  {
    title: 'Online Test Series',
    description: '100+ mock tests with instant results. All India Rank comparison.',
    icon: Monitor,
  },
  {
    title: 'Flexible Schedule',
    description: 'Morning, evening, and weekend batches. Switch between modes anytime.',
    icon: Calendar,
  },
]
...
const pricingPlans = [
  {
    ...
    duration: 'per year',
    features: [
      'Live classes (all sessions)',
      'Recorded lectures access',
      'Digital study material',
      'Online test series (50+)',
  ...
  },
  {
    ...
    features: [
      ...
      'Weekend classes at South Extension / Gulmohar Park centre',
...
export default function OnlineNEETClassesContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'online-neet-classes-south-delhi',
      message:
        'Hi! I am interested in online NEET classes from South Delhi. Please share details about live classes, timings, and fees.',
      campaign: 'online-classes-south-delhi',
    })
  }
  ...
  return (
    <main className="min-h-screen bg-white">
      <nav className="bg-gray-100 py-3 px-4">
        <div className="max-w-7xl mx-auto">
          <ol className="flex items-center flex-wrap gap-1 text-sm">
            ...
            <li className="flex items-center">
              <ChevronRight className="w-4 h-4 text-gray-400 mx-1" />
              <span className="text-blue-700 font-medium">Online Classes</span>
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Online NEET Classes
              <span className="block text-yellow-400 mt-2">for South Delhi Students</span>
            </h1>

            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              The same AIIMS-trained faculty as our South Extension flagship (D-35, South Extension
              Part 2) and Gulmohar Park (B-113) centres — live from your home. No commute, full
              recordings, and unlimited doubt support. Perfect for school-heavy schedules at DPS RK
              Puram, Modern School, Sanskriti, Vasant Valley, and Shri Ram, and for students outside
              the centre catchment.
            </p>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20online%20demo%20class%20for%20NEET%20Biology%20coaching%20in%20South%20Delhi.%20Please%20share%20available%20timings."
                target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              What You Get with Online Classes
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeInUp">
              ...
              <p className="text-xl text-blue-100 mb-6">
                Our online classes deliver the same results as the South Extension and Gulmohar Park
                centres. You save the commute and can go hybrid — online on weekdays, centre classes
                on weekends. Outstation students in Ber Sarai and Katwaria Sarai PGs join the
                evening batch alongside their integrated coaching.
              </p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  Same Dr. Shekhar teaching live
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  Same study material (digital format)
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  Same test series with rank comparison
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  Better doubt clearing (recorded + live)
                </li>
              </ul>
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20online%20demo%20class%20for%20NEET%20Biology%20coaching%20in%20South%20Delhi.%20Please%20share%20available%20timings."
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 animate-fadeInUp">
              ...
              <div className="space-y-4">
                <div className="flex justify-between py-3 border-b border-white/20">
                  ...
                  <span className="font-semibold">315/360</span>
                </div>
                <div className="flex justify-between py-3 border-b border-white/20">
      ...
      <NEETToolsWidget
        ...
        subtitle="Use our AI-powered tools to boost your online preparation"
      />
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              <h3 className="font-semibold text-teal-600">Offline Coaching</h3>
              <p className="text-sm text-gray-600">South Extension & Gulmohar Park centres</p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-gray-600">Personal tutoring in South Delhi</p>
            </Link>
            <Link
              href="/online-biology-classes-in/delhi"
              className="bg-white p-4 rounded-xl hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">Online Biology Delhi</h3>
              <p className="text-sm text-gray-600">Delhi-wide online classes</p>
            </Link>
            <Link
              href="/neet-coaching-south-delhi/ber-sarai"
              className="bg-white p-4 rounded-xl hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">Ber Sarai</h3>
            ...
            <Link
              ...
              className="bg-white p-4 rounded-xl hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">Katwaria Sarai</h3>
              <p className="text-sm text-gray-600">Evening batches near IIT gate</p>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join 300+ students learning online with us from South Delhi and beyond
          </p>
