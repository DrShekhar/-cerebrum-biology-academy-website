...
export const metadata: Metadata = {
  title: 'Best Biology Books for NEET 2027 | NCERT + Reference Guide | Cerebrum Biology Academy',
  description:
    "Best biology books for NEET 2027 — NCERT Class 11 & 12 (mandatory), Trueman's Biology, Pradeep Biology, MTG NCERT Fingertips, Allen Modules, Dinesh Objective Biology. Topic-by-topic recommendations from AIIMS-trained Dr. Shekhar C Singh. Class 11 / 12 / dropper / repeater book strategy.",
  keywords: [
  ...
  openGraph: {
    title: 'Best Biology Books for NEET 2027 | Cerebrum Biology Academy',
    description:
  ...
  twitter: {
    ...
    title: 'Best Biology Books for NEET 2027',
