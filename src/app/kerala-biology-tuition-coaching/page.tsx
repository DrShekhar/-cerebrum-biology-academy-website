...
const features = [
  {
    ...
    description:
      'Real-time online coaching aligned with Kerala Plus Two syllabus. English medium focus.',
  },
  {
    icon: Users,
    title: 'Small Batches (10-15)',
    description: 'Personalized attention for every Kerala student. Doubt clearing until mastery.',
  },
  {
    icon: Award,
    title: 'AIIMS Trained Faculty',
    description: 'Expert teachers who understand both Kerala HSE pattern and NEET requirements.',
  },
  {
    icon: BookOpen,
    title: 'Plus Two + NEET Dual Focus',
    description: 'Comprehensive preparation covering both Kerala board and NEET biology.',
  },
  {
    icon: Clock,
  ...
  },
  {
    icon: Shield,
    title: 'NCERT Aligned',
    description: 'Our curriculum bridges Kerala SCERT with NCERT for complete NEET coverage.',
  },
]
...
const faqs = [
  {
    ...
    answer:
      'Kerala Plus Two (HSE) Biology syllabus under SCERT is approximately 80-85% aligned with NEET - one of the highest among state boards. Kerala follows NCERT-based curriculum, but some topics need deeper coverage for NEET. Our coaching ensures complete alignment.',
  },
  {
    question: 'Which cities in Kerala do you serve?',
    answer:
      'We serve students from all Kerala cities including Kochi, Thiruvananthapuram, Kozhikode, Thrissur, Kollam, Kannur, Malappuram, Palakkad, and more. Our online live classes are accessible from anywhere in Kerala.',
  },
  {
    question: 'What is the fee for Plus Two Biology + NEET coaching?',
    answer:
      'Our comprehensive Plus Two + NEET Biology coaching ranges from Rs 24,000 to Rs 68,000 per year. This includes board exam preparation, NEET coaching, study materials, and unlimited doubt sessions. EMI options available.',
  },
  {
    question: 'Which medical colleges can Kerala students target?',
    answer:
      'With strong NEET scores, Kerala students can target: Government Medical College Thiruvananthapuram, Government Medical College Kozhikode, Amrita Institute of Medical Sciences, Government Medical College Thrissur, plus AIIMS, JIPMER, and other all-India institutes.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Kerala SCERT curriculum is largely based on NCERT, making it one of the best state boards for NEET preparation. The syllabus has high overlap, reducing the gap students need to bridge. We enhance this advantage with focused NEET-specific training.',
  },
]
...
export default function KeralaBiologyTuitionPage() {
  const handleWhatsAppClick = async () => {
    await trackAndOpenWhatsApp({
      source: 'kerala-biology-tuition',
      campaign: 'kerala-biology-tuition',
      message: 'Hi! I am interested in Kerala Biology tuition. Please share details.',
    })
  }
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              'Best online biology tuition for Kerala Plus Two students preparing for NEET',
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              ...
              Kerala State Board | Plus Two + NEET Biology
            </div>
            ...
            <h2 className="text-xl md:text-2xl opacity-90 mb-4">
              Kochi | Trivandrum | Calicut | Thrissur | All Kerala Cities
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20%E2%80%94%20interested%20in%20kerala%20biology%20tuition%20coaching.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer">
                <Button
                  variant="secondary"
                  size="xl"
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16 animate-fadeInUp">
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              Biology Coaching Across Kerala
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-green-50 rounded-2xl p-8 border border-green-200">
              <h3 className="text-2xl font-bold text-green-800 mb-6 flex items-center">
                ...
                Kerala Syllabus Strength (80-85%)
              </h3>
              <ul className="space-y-3">
                {[
                  'NCERT-based SCERT curriculum',
                  'High overlap with NEET syllabus',
                  'Strong conceptual foundation',
                  'Quality state education system',
                  'English medium strength',
            ...
            <div className="bg-blue-50 rounded-2xl p-8 border border-blue-200">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  'Deeper Biotechnology coverage',
                  'Ecology application questions',
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="bg-[#1e3a5f]/5 rounded-2xl p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">
              Students from These Kerala Schools Trust Us
            </h3>
