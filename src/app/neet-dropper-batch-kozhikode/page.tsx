...
const cityName = 'Kozhikode'
const citySlug = 'kozhikode'
...
export const metadata: Metadata = {
  ...
  keywords: ['neet dropper batch kozhikode', 'neet repeater course kozhikode', 'best dropper batch neet kozhikode'],
  alternates: { canonical: `https://cerebrumbiologyacademy.com/neet-dropper-batch-kozhikode` },
  openGraph: { title: `NEET Dropper Batch 2026-27 ${cityName}`, url: `https://cerebrumbiologyacademy.com/neet-dropper-batch-kozhikode`, locale: 'en_IN', type: 'website' },
}
