...
export const metadata: Metadata = {
  ...
  keywords:
    'NEET coaching Shimla, best NEET coaching Shimla Himachal, NEET preparation Shimla, NEET classes IGMC Shimla, biology coaching Shimla, medical entrance Himachal Pradesh, NEET 2027 Shimla, online NEET coaching Himachal, biology tuition Shimla, biology classes Shimla, online biology coaching Shimla, NEET biology Shimla, biology teacher Shimla',
  openGraph: {
