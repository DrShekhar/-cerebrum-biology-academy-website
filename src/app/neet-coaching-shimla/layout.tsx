...
export const metadata: Metadata = {
  ...
  keywords:
    'NEET coaching Shimla, best NEET coaching Shimla Himachal, NEET preparation Shimla, NEET classes IGMC Shimla, biology coaching Shimla, medical entrance Himachal Pradesh, NEET 2026 Shimla, online NEET coaching Himachal',
  openGraph: {
