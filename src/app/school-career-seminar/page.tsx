...
Submitted via School Seminar Booking Form`
  ...
  const seminarGalleryImages = [
    ...
    },
    {
      ...
      alt: 'Dr. Shekhar Sir at PhysicsWallah (PW) E-Techno School South City',
      school: 'PhysicsWallah (PW) E-Techno School, South City',
    },
    {
      src: '/images/gallery/untitled-design-10.png',
      alt: "Dr. Shekhar with Sharani PhysicsWallah (PW) Ma'am - Director PhysicsWallah (PW)",
      school: 'With PhysicsWallah (PW) Director',
    },
    {
      src: '/images/gallery/untitled-design-8.png',
      alt: "Sharani PhysicsWallah (PW) Ma'am addressing students at Pariksha Pe Charcha",
      school: 'Pariksha Pe Charcha - PhysicsWallah (PW)',
    },
    {
      src: '/images/gallery/warm-welcome-by-mgr-staff.png',
      alt: 'Warm welcome at PhysicsWallah (PW) E-Techno School MG Road',
      school: 'PhysicsWallah (PW) E-Techno School, MG Road',
    },
    {
      src: '/images/gallery/untitled-design-11.png',
      alt: 'Expert Seminar Session featuring Sharani PhysicsWallah (PW)',
    ...
    },
    {
      ...
      school: 'PhysicsWallah (PW) JR College, South City 2',
    },
    {
