...
export const metadata: Metadata = {
  title: 'Best NEET Coaching in Dharamshala 2026 | Kangra District',
  description:
  ...
  twitter: {
    ...
    title: 'Best NEET Coaching in Dharamshala 2026 | Kangra District',
    description:
      'Top NEET coaching for Dharamshala & Kangra students. 98% success rate. Online classes from AIIMS faculty.',
  },
  alternates: {
