...
const PAGE_URL = 'https://cerebrumbiologyacademy.com/neet-coaching-fees-kochi'
export const metadata: Metadata = {
  title: 'NEET Coaching Fees Kochi | Cerebrum Biology Academy',
  description: 'NEET Coaching Fees in Kochi — AIIMS-trained faculty, online live. Serving Marine Drive, Edappally, Kakkanad, Vyttila, Aluva, Palarivattom, Infopark. From Rs 48,000/yr.',
  keywords: ['neet coaching fees kochi', 'NEET biology kochi', 'best NEET kochi'],
  alternates: { canonical: PAGE_URL },
  openGraph: { title: 'NEET Coaching Fees Kochi', url: PAGE_URL, locale: 'en_IN', type: 'website' },
}
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          <nav className="text-sm text-slate-400 mb-6" aria-label="Breadcrumb"><Link href="/" className="hover:text-white">Home</Link><span className="mx-2">/</span><Link href="/neet-coaching-kochi" className="hover:text-white">NEET Kochi</Link><span className="mx-2">/</span><span className="text-white">Coaching Fees</span></nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">NEET Coaching Fees in Kochi</h1>
