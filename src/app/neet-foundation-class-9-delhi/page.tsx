/**
 * /neet-foundation-class-9-delhi
 *
 * NEET Foundation Class 9 city page — Delhi proper (covers South Delhi
 * flagship + North/West Delhi via Rohini and Green Park centres).
...
const PAGE_URL = 'https://cerebrumbiologyacademy.com/neet-foundation-class-9-delhi'

export const metadata: Metadata = {
  title: 'NEET Foundation Class 9 in Delhi | South Extension + Rohini + Green Park',
  description:
    'NEET Foundation Class 9 in Delhi at Cerebrum Biology Academy — South Extension flagship, Rohini, Green Park. Board + NEET parallel, AIIMS-trained faculty, batches of 15-20. ₹35K-90K/year. Free demo available.',
  keywords: [
    'neet foundation class 9 delhi',
    'class 9 neet preparation delhi',
    'class 9 biology coaching delhi',
    'class 9 neet foundation south delhi',
    'class 9 neet rohini',
    'class 9 neet south extension',
    'class 9 neet greater kailash',
    'class 9 neet hauz khas',
    'class 9 cbse biology neet delhi',
    'best class 9 foundation delhi',
  ],
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: 'NEET Foundation Class 9 in Delhi | Cerebrum Biology Academy',
    description:
      'Class 9 NEET Foundation in Delhi — South Extension, Rohini, Green Park centres. AIIMS-trained, 15-20 student batches.',
    url: PAGE_URL,
    locale: 'en_IN',
    type: 'website',
  },
...
const faqs = [
  {
    question: 'Where in Delhi can my Class 9 child attend Cerebrum NEET Foundation?',
    answer:
      'Cerebrum has three offline Delhi centres serving Class 9 Foundation — South Extension Part II (flagship centre with full faculty access), Rohini (West/North Delhi catchment serving DPS Rohini, Bal Bharati Rohini, Modern Public School families), and Green Park (South Delhi catchment near Hauz Khas, Vasant Vihar, R.K. Puram families). All three centres run Class 9 Foundation batches with the same AIIMS-trained faculty. Online live Class 9 Foundation is also available for families in East Delhi, Dwarka, or where commute is impractical.',
  },
  {
    question: 'What is the Class 9 NEET Foundation timing in Delhi?',
    answer:
      "Cerebrum Class 9 Foundation in Delhi runs in 2-hour weekend-friendly slots: Saturday morning (10 AM - 12 PM), Sunday morning (10 AM - 12 PM), plus a weekday evening 6 PM - 8 PM IST option for students with weekend extracurriculars. Most students attend twice weekly (4 hours total weekly). Schedule is calibrated specifically so Foundation doesn't crowd out school + activities + family time.",
  },
  {
    question:
      'How does Cerebrum Delhi compare to FIITJEE Foundation or Aakash Scholastics in Delhi?',
    answer:
      'Three structural differences. (1) Subject focus: Cerebrum is biology-only specialist; FIITJEE Foundation and Aakash Scholastics are combined PCB Foundation with generalist faculty. (2) Batch size: Cerebrum 15-20 students per Class 9 batch vs FIITJEE/Aakash 150-300 students. (3) Faculty: Cerebrum Delhi has AIIMS-trained biology specialists from day one; generalist Foundation typically uses school-teacher-level instructors for Class 9-10 batches (senior faculty work Class 11-12). For biology pedagogy specifically, Cerebrum Delhi is structurally different.',
  },
  {
...
const courseSchema = {
  ...
  '@type': 'Course',
  name: 'NEET Foundation Class 9 Biology in Delhi',
  description:
    'Class 9 NEET Foundation biology coaching in Delhi at Cerebrum Biology Academy — three offline centres (South Extension, Rohini, Green Park) plus online live. Board + NEET parallel pedagogy from AIIMS-trained faculty.',
  url: PAGE_URL,
  inLanguage: 'en-IN',
...
const wa =
  ...
  encodeURIComponent(
    'Hi — my child is in Class 9 in Delhi and we want to start NEET Foundation at Cerebrum. Please share details on the South Extension / Rohini / Green Park centres, pricing, and demo class timings.'
  )
      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            NEET Foundation Class 9 in Delhi
          </h1>
          <p className="text-xl text-slate-300 mb-6 max-w-3xl">
            Class 9 NEET Foundation Biology at Cerebrum — three offline Delhi centres (South
            Extension flagship, Rohini, Green Park) plus online live. AIIMS-trained biology
            specialists, batches of 15-20, CBSE / ICSE board + NEET-pattern parallel pedagogy.
            ₹35K-₹90K/year. Weekend-friendly scheduling for Class 9 students balancing school +
            activities.
          </p>
          <a
            href={wa}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 prose prose-slate max-w-none">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">
            Three Delhi centres + online live for Class 9 NEET Foundation
          </h2>
          <ul>
            <li>
            ...
            <li>
              <strong>Rohini</strong> — West and North Delhi catchment. Serves DPS Rohini, Bal
              Bharati Rohini, Modern Public School Sector 17 Rohini, Mt. Abu Public School families.
            </li>
            <li>
          ...
          <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">
            Class 9 Foundation pricing (Delhi)
          </h2>
          <ul>
            <li>
          ...
          <ul>
            ...
            <li>
              <Link
                href="/neet-foundation-class-10-delhi"
                className="text-blue-600 hover:underline"
              >
                Class 10 Foundation in Delhi
              </Link>
            </li>
            <li>
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-slate-900 mb-8">
            FAQs from Delhi Class 9 Foundation families
          </h2>
      ...
      <section className="py-16 bg-gradient-to-br from-blue-600 to-purple-600">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Book a free Class 9 demo at Cerebrum Delhi
          </h2>
