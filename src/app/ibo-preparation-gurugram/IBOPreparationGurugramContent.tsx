...
export default function IBOPreparationGurugramContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsAppEnquiry = () => {
    trackAndOpenWhatsApp({
      ...
      message:
        'Hi! I am from Gurugram and interested in IBO (International Biology Olympiad) preparation. I have qualified INBO. Please share details.',
      ...
      <nav className="bg-gray-100 py-3 px-4">
        <div className="max-w-7xl mx-auto">
          <ol className="flex items-center flex-wrap gap-1 text-sm">
            ...
            <li className="flex items-center">
              <ChevronRight className="w-4 h-4 text-gray-400 mx-1" />
              <span className="text-teal-700 font-medium">IBO Preparation</span>
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20IBO%20in%20Gurugram.%20Please%20share%20available%20timings."
                target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              IBO Syllabus Distribution
            </h2>
            <p className="text-xl text-slate-600">
              Comprehensive coverage based on Campbell Biology
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-2xl p-8 animate-fadeInUp">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Button
                variant="secondary"
                size="xl"
                className="bg-white text-yellow-600 hover:bg-gray-100 font-bold"
              >
                <Play className="w-5 h-5 mr-2" />
                Book Consultation
              </Button>
