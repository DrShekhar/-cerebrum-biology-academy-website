...
export default function OneYearNEETCourseFaridabad() {
  return (
      ...
      <section className="bg-gradient-to-r from-red-700 to-red-600 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">1 Year NEET Course in Faridabad</h1>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link
                href="/2-year-neet-course-faridabad"
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Course',
            name: '1 Year NEET Course Faridabad',
            description:
