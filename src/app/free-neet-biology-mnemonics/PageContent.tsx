...
import { Phone, Star, CheckCircle, Download, Users, Award, Brain } from 'lucide-react'
import Link from 'next/link'

const benefits = [
  '200+ tested mnemonics across all chapters',
  'Visual memory aids and diagrams',
  'Taxonomy shortcuts (Kingdom to Species)',
  'Human body system memory tricks',
  'Genetics and heredity mnemonics',
]
...
export default function PageContent() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 via-white to-gray-50">
      {/* Hero */}
      <section className="relative py-16 bg-gradient-to-r from-purple-700 via-purple-600 to-purple-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">200+ NEET Biology Mnemonics</h1>
          <p className="text-xl text-purple-100 mb-2">
            Memory Tricks for Every Chapter by AIIMS Faculty
          </p>
          <p className="text-lg text-purple-200 max-w-2xl mx-auto mb-8">
            Stop struggling to memorize complex biological terms. Our 200+ mnemonics cover taxonomy,
            human physiology, plant biology, genetics, and ecology in easy-to-remember formats.
          </p>
          <Link
            href="https://wa.me/918826444334?text=Hi%20I%20want%20the%20free%20mnemonics"
          ...
          <p className="text-sm text-purple-200 mt-3">
            WhatsApp +91-8826444334 to receive instantly
          </p>
        </div>
      </section>
      ...
      <section className="py-12 max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-4">
          <Link href="/pricing" className="text-purple-600 hover:text-purple-800 font-semibold">
            View Courses &rarr;
          </Link>
          <Link
            href="/nri-students"
