...
const noidaExtAreas = [
  { name: 'Gaur City 1', distance: '5 km', landmark: 'Near Greater Noida West Metro' },
  { name: 'Gaur City 2', distance: '6 km', landmark: 'Near Gaur Chowk' },
  { name: 'Supertech Eco Village', distance: '7 km', landmark: 'Near Bisrakh' },
  { name: 'Crossing Republik', distance: '10 km', landmark: 'Ghaziabad Border' },
  { name: 'Aster RNE', distance: '4 km', landmark: 'Near YEIDA Office' },
  { name: 'Ajnara Homes', distance: '5 km', landmark: 'Tech Zone IV' },
  { name: 'Prateek Wisteria', distance: '6 km', landmark: 'Sector 77' },
  { name: 'Ace City', distance: '8 km', landmark: 'Near Knowledge Park' },
]
...
const whyChooseUs = [
  {
    icon: Home,
    title: 'Nearby Center',
    description: 'Just 5-10 km from Noida Extension. Shortest travel for students.',
  },
  {
    icon: GraduationCap,
    title: 'AIIMS Faculty',
  ...
  },
  {
    ...
    description: 'Proven track record with many students from new townships.',
  },
  {
    icon: Star,
    title: 'Growing Community',
    description: 'Strong student community from Gaur City and nearby societies.',
  },
]
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Yes! We have students from Gaur City, Supertech Eco Village, Crossing Republik, Aster RNE, Ajnara Homes, and many other societies. Parents often form carpools from the same society.',
  },
  {
    question: 'Is Aqua Line metro extended to Noida Extension?',
    answer:
      'The Aqua Line extension to Greater Noida West is being developed. Currently, students use the expressway which takes just 10-15 minutes. Once metro opens, connectivity will be even better.',
  },
  {
    question: 'Do you offer online classes for Noida Extension students?',
    answer:
      'Yes! While offline is preferred for better interaction, we offer online classes too. Many students attend offline for regular classes and use online for revision or when unable to travel.',
  },
]

export default function BiologyTutorNoidaExtensionPage() {
    ...
    <div className="min-h-screen">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            areaServed: ['Noida Extension', 'Gaur City', 'Greater Noida West', 'Crossing Republik'],
            priceRange: '$$',
          }),
        }}
      />
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              ...
              Closest Coaching for Noida Extension
            </div>
            ...
            <h2 className="text-xl md:text-2xl opacity-90 mb-4">
              NEET & Board Preparation | Gaur City & Nearby | Offline Classes
            </h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                <Home className="w-8 h-8 mx-auto mb-2 text-yellow-400" />
                <div className="text-2xl font-bold">5 km</div>
                <div className="text-sm opacity-80">From Gaur City</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              Noida Extension Societies We Serve
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Closest NEET coaching for all new townships
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {noidaExtAreas.map((area, index) => (
              <div
                key={area.name}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              Why Noida Extension Families Choose Us
            </h2>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              Noida Extension Students, Join Us!
            </h2>
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              Closest NEET coaching for Gaur City and nearby societies
            </p>
