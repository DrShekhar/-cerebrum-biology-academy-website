...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'NEET Coaching for Hillwoods Academy Gurugram',
    description: 'Best NEET coaching for Hillwoods Academy Preet Vihar students. Just 12 min drive. CBSE-NEET aligned preparation. AIIMS faculty, 98% success rate. Call 88264-44334!',
  },
}
...
const faqs = [
  {
    ...
    answer:
      'Our center at M2K Corporate Park, Sector 51 is approximately 6-7 km from Hillwoods Academy Preet Vihar. Takes 10-12 minutes by car.',
  },
  {
    question: 'What batch timings suit Hillwoods students?',
    answer:
      'Our 4-7 PM evening batch works well for Hillwoods students. Weekend batches (Sat-Sun 9 AM - 1 PM) are also available for those preferring fewer weekday commitments.',
  },
  {
    question: 'Do you have students from Hillwoods?',
    answer:
      'Yes, we have several students from Hillwoods Academy. They appreciate our small batch size and personalized teaching approach.',
  },
  {
    question: 'How do you complement school education?',
    answer:
      'We follow NCERT-first approach aligned with CBSE. School concepts are reinforced while adding NEET-specific depth, MCQ practice, and application-based learning.',
  },
]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-white">
      ...
      <GurgaonGurugramAreaSchema
        spelling="gurugram"
        pageSlug="neet-coaching-hillwoods-academy-gurugram"
        subArea="Hillwoods Academy Gurugram"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              NEET Coaching for Hillwoods Academy
            </h1>
            <p className="text-xl text-teal-100 mb-4">
              CBSE-aligned NEET preparation just 12 min away
            </p>
              ...
              <div className="md:w-1/2 p-8">
                ...
                <div className="bg-teal-50 p-4 rounded-lg mb-4">
                  <p className="text-sm text-teal-800">
                    <strong>Route:</strong> Hillwoods → Sector 46 → Golf Course Rd → Sector 51
                  </p>
                </div>
                <a
                  href="tel:+918826444334"
      ...
      <section className="py-16 bg-teal-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-teal-100 mb-8">
            CBSE excellence + NEET expertise = Your medical dream.
          </p>
          <a
            href="tel:+918826444334"
