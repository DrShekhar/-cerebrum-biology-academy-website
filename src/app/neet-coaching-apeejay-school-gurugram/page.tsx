...
const whyApeejayStudents = [
  {
    ...
    description:
      "Apeejay's strong CBSE foundation is perfect for NEET. We build on your school preparation.",
    icon: GraduationCap,
  },
  {
...
const faqs = [
  {
    ...
    answer:
      'Our center at M2K Corporate Park, Sector 51 is approximately 5-6 km from Apeejay School Sector 15. Via Golf Course Road or Sohna Road, it takes 10-12 minutes.',
  },
  {
    question: 'Why should Apeejay students join Cerebrum?',
    answer:
      'Apeejay has excellent CBSE academics. We build on this foundation with NEET-specific training, MCQ practice, and AIIMS faculty guidance. Your strong school base gives you an advantage.',
  },
  {
    question: 'Do you coordinate with school schedules?',
    answer:
      'Yes! We plan our test schedules around major school exams. Our evening batch (4-7 PM) allows students to attend after school without conflicts.',
  },
  {
    question: 'How is Cerebrum different from Sector 14 coaching?',
    answer:
      'Sector 14 has large coaching centers with 100+ batches. We offer 20-student batches, personal attention, and AIIMS faculty. Quality over quantity.',
  },
]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-red-50 to-white">
      <GurgaonGurugramAreaSchema
        spelling="gurugram"
        pageSlug="neet-coaching-apeejay-school-gurugram"
        subArea="Apeejay School Gurugram"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              NEET Coaching for Apeejay School
            </h1>
            <p className="text-xl text-red-100 mb-4">
              Build on your strong CBSE foundation with NEET expertise
            </p>
              ...
              <div className="md:w-1/2 p-8">
                ...
                <div className="bg-red-50 p-4 rounded-lg mb-4">
                  <p className="text-sm text-red-800">
                    <strong>Route:</strong> Apeejay → Sohna Road → Sector 50 → Sector 51
                  </p>
                </div>
                <a
                  href="tel:+918826444334"
      ...
      <section className="py-16 bg-red-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-red-100 mb-8">
            Your CBSE excellence + Our NEET expertise = AIIMS dream.
          </p>
          <a
            href="tel:+918826444334"
            className="inline-flex items-center gap-2 bg-yellow-500 text-red-900 px-8 py-3 rounded-lg font-semibold hover:bg-yellow-400 transition"
          >
            <Phone className="w-5 h-5" />
