...
import { CheckCircle, Trophy, Star, ArrowRight, Medal, Target, Users, TrendingUp, Award, Crown, Zap } from 'lucide-react'
...
export const metadata: Metadata = {
  ...
  keywords: 'NEET results, AIIMS selection, JIPMER admission, NEET Biology scores, medical college admission, student success stories',
}
  ...
  const remarkableStories = [
    {
      ...
      details: 'From a small village with limited resources, Vikash used our online classes to overcome geographical barriers and achieve his medical dream.',
      biologyScore: 342,
    ...
    },
    {
      ...
      details: 'After two unsuccessful attempts, Sneha joined our dropper program and finally secured admission with dedicated coaching and psychological support.',
      biologyScore: 338,
    ...
    },
    {
      ...
      details: 'Balancing part-time work with studies, Ali used our flexible online classes and doubt resolution to achieve his goal despite financial constraints.',
      biologyScore: 335,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center">
            ...
            <p className="text-xl text-orange-100 mb-8 max-w-3xl mx-auto">
              Celebrating the success of our students who achieved their medical dreams. 
              From AIIMS selections to remarkable rank improvements - these are stories of determination and excellence.
            </p>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Our star students who achieved exceptional ranks and secured top medical colleges</p>
          </div>
                  ...
                  <div className="flex items-start mb-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center mt-2">
                        ...
                        <span className="text-yellow-600 font-semibold text-sm">{student.rank}</span>
                      </div>
                    </div>
                  </div>
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Year-wise Performance Analysis</h2>
            <p className="text-gray-600">Consistent excellence in NEET Biology coaching over the years</p>
          </div>
              ...
              <div key={index} className="bg-white rounded-xl shadow-lg p-8">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <div className="text-right">
                    <div className="text-3xl font-bold text-green-600">{year.qualificationRate}</div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Medical College Admissions 2024</h2>
            <p className="text-gray-600">Our students secured admissions in top medical colleges across India</p>
          </div>
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Detailed breakdown of student achievements across different categories</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8">
            {categoryWiseResults.map((category, index) => (
              <div key={index} className={`bg-white rounded-xl p-6 shadow-lg border-l-4 ${getColorClasses(category.color)} hover:shadow-xl transition-shadow`}>
                <div className="flex justify-between items-start mb-4">
                  <h3 className="text-xl font-bold text-gray-900">{category.category}</h3>
                  <div className="text-right">
                    <div className="text-2xl font-bold text-gray-900">{category.count}</div>
                    <div className="text-sm font-semibold text-green-600">{category.percentage}</div>
                  </div>
                </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Inspiring journeys of students who overcame challenges to achieve their dreams</p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            These results speak for themselves. Join thousands of successful students who achieved their medical dreams with us.
          </p>
