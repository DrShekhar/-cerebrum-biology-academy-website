...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes: MetadataRoute.Sitemap = [
    ...
    {
      url: `${baseUrl}/biology-notes-for-neet/morphology-of-flowering-plants`,
      lastModified: lastUpdated,
      changeFrequency: 'monthly' as const,
      priority: 0.85,
    },
    {
      url: `${baseUrl}/biology-notes-for-neet/anatomy-of-flowering-plants`,
      lastModified: lastUpdated,
      changeFrequency: 'monthly' as const,
      priority: 0.85,
    },
    {
      url: `${baseUrl}/biology-notes-for-neet/structural-organisation-in-animals`,
      lastModified: lastUpdated,
      changeFrequency: 'monthly' as const,
      priority: 0.85,
    },
    {
      url: `${baseUrl}/biology-notes-for-neet/plant-physiology`,
      lastModified: lastUpdated,
      changeFrequency: 'monthly' as const,
      priority: 0.85,
    },
    ...
    ...[
      'best-neet-coaching-noida', 'best-neet-coaching-greater-noida',
      'neet-coaching-fee-noida', 'neet-coaching-fees-greater-noida',
      'neet-coaching-near-me-noida', 'neet-coaching-near-me-greater-noida',
      'neet-test-series-noida', 'neet-test-series-greater-noida',
      'neet-crash-course-noida', 'neet-crash-course-greater-noida',
      'neet-dropper-batch-noida', 'neet-dropper-batch-greater-noida',
      'neet-foundation-class-9-noida', 'neet-foundation-class-9-greater-noida',
      'neet-foundation-class-10-noida', 'neet-foundation-class-10-greater-noida',
      'neet-evening-batch-noida', 'neet-weekend-batch-noida',
      'neet-scholarship-noida', 'neet-scholarship-greater-noida',
      '1-year-neet-course-noida', '2-year-neet-course-noida',
      'allen-alternative-noida', 'aakash-alternative-noida',
      'aakash-alternative-greater-noida',
      'complement-allen-coaching-noida', 'complement-aakash-coaching-noida',
      'fiitjee-alternative-noida', 'narayana-alternative-noida',
      ...
      'free-neet-demo-class-noida', 'free-neet-demo-class-greater-noida',
      'online-neet-coaching-greater-noida', 'online-neet-classes-noida',
      'online-biology-tuition-noida',
      'parents-guide-neet-coaching-noida',
      'best-biology-tutor-noida', 'biology-tuition-noida',
      'biology-tutor-noida-sector-18', 'home-biology-tutor-noida',
      'biology-class-11-noida', 'biology-class-12-noida',
      'cbse-biology-coaching-noida', 'ncert-biology-coaching-noida',
      'class-12-board-biology-noida', 'neet-toppers-noida',
      'neet-coaching-ats-pristine-noida', 'neet-coaching-jaypee-greens-noida',
    ].map((slug) => ({
      url: `${baseUrl}/${slug}`,
      lastModified: lastUpdated,
      changeFrequency: 'monthly' as const,
    ...
    {
      url: `${baseUrl}/biology-olympiad/ireland`,
      lastModified: lastUpdated,
      changeFrequency: 'weekly' as const,
      priority: 0.88,
    },
    {
      url: `${baseUrl}/biology-olympiad/south-africa`,
      lastModified: lastUpdated,
      changeFrequency: 'weekly' as const,
      priority: 0.88,
    },
    {
      url: `${baseUrl}/biology-olympiad/nigeria`,
      lastModified: lastUpdated,
      changeFrequency: 'weekly' as const,
      priority: 0.88,
    },
    {
      url: `${baseUrl}/biology-olympiad/philippines`,
      lastModified: lastUpdated,
      changeFrequency: 'weekly' as const,
      priority: 0.88,
    },
    {
      url: `${baseUrl}/biology-olympiad/malaysia`,
      lastModified: lastUpdated,
      changeFrequency: 'weekly' as const,
      priority: 0.88,
    },
    ...
    {
      url: `${baseUrl}/ib-biology-vs/a-level`,
      lastModified: lastUpdated,
      changeFrequency: 'monthly' as const,
      priority: 0.85,
    },
    {
      url: `${baseUrl}/ib-biology-vs/ap-biology`,
      lastModified: lastUpdated,
      changeFrequency: 'monthly' as const,
      priority: 0.85,
    },
    {
      url: `${baseUrl}/ib-biology-vs/igcse`,
      lastModified: lastUpdated,
      changeFrequency: 'monthly' as const,
      priority: 0.8,
    },
    {
      url: `${baseUrl}/ib-biology-vs/cbse`,
      lastModified: lastUpdated,
      changeFrequency: 'monthly' as const,
      priority: 0.85,
    },
    {
      url: `${baseUrl}/ib-biology-vs/neet-biology`,
      lastModified: lastUpdated,
      changeFrequency: 'monthly' as const,
      priority: 0.85,
    },
