...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes: MetadataRoute.Sitemap = [
    ...
    ...[
      ...
      // Wave 1.1 (2026-07): best-neet-coaching-<city> for tier-1 + South hubs
      // (data-driven BestNeetCoachingTemplate — unique per-city content).
      'best-neet-coaching-kota',
      'best-neet-coaching-hyderabad',
      'best-neet-coaching-bangalore',
      'best-neet-coaching-chennai',
      'best-neet-coaching-mumbai',
      'best-neet-coaching-kolkata',
      'best-neet-coaching-pune',
      'best-neet-coaching-jaipur',
      'best-neet-coaching-indore',
      'best-neet-coaching-lucknow',
      'best-neet-coaching-patna',
      'best-neet-coaching-visakhapatnam',
      'best-neet-coaching-vijayawada',
    ...
    // Faridabad satellite pages (56 — audit fix May 2026, expanded Jul 2026)
    ...[
    ...
    {
      url: `${baseUrl}/usabo-coaching-california`,
      lastModified: lastUpdated,
      changeFrequency: 'weekly' as const,
      priority: 0.9,
    },
    {
      url: `${baseUrl}/usabo-coaching-orange-county`,
      lastModified: lastUpdated,
      changeFrequency: 'weekly' as const,
      priority: 0.88,
    },
    {
      url: `${baseUrl}/usabo-coaching-sacramento`,
      lastModified: lastUpdated,
      changeFrequency: 'weekly' as const,
      priority: 0.88,
    },
