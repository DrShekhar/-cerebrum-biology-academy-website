...
export const metadata: Metadata = {
  ...
  description:
    'Top NEET biology coaching in Amritsar for Punjab students. GMC Amritsar focused! 94.2% success rate, AIIMS faculty. Lawrence Road, Ranjit Avenue, Mall Road. 2,400+ students. Book free demo!',
  keywords:
  ...
  openGraph: {
    ...
    description:
      'Top NEET biology coaching in Amritsar with 94.2% success rate. GMC Amritsar focused! AIIMS faculty.',
  ...
  twitter: {
    ...
    description:
      'Top NEET biology coaching in Amritsar. GMC focused! 94.2% success rate. Lawrence Road, Ranjit Avenue.',
  },
  alternates: {
