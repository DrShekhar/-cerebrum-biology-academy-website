      ...
      <section className="relative py-16 bg-gradient-to-r from-blue-700 via-blue-600 to-teal-700 text-white">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-6">
            <Link
              href="https://wa.me/918826444334?text=Hi%20I%20am%20from%20Dubai%20interested%20in%20NEET%20coaching"
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm">
            ...
            <span className="flex items-center gap-1">
              <CheckCircle className="w-4 h-4" /> 50+ CBSE Schools
            </span>
            <span className="flex items-center gap-1">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-10">
            Why Dubai Students Choose Cerebrum
          </h2>
          ...
          {[
            {
              ...
              score: '645/720',
              quote:
                'The timezone-friendly classes made all the difference. I could focus on school during the day and NEET prep in the afternoon.',
              college: 'AIIMS Delhi',
            },
            {
              name: 'Rohan Mehta',
              ...
              score: '632/720',
              quote:
                'Having the NEET exam center right here in Dubai was a huge advantage. Cerebrum prepared me perfectly.',
            ...
            },
            {
              ...
              score: '618/720',
              quote:
                'From GEMS school to NEET success, the NCERT alignment was spot on. WhatsApp doubt support saved me countless times.',
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 mb-8 text-lg">
            Join Indian students in Dubai already preparing with expert AIIMS faculty. Book a free
            demo today.
          </p>
          <Link
            href="https://wa.me/918826444334?text=Hi%20I%20am%20from%20Dubai%20interested%20in%20NEET%20coaching"
