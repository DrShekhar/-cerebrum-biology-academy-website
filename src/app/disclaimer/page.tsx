...
export const metadata: Metadata = {
  ...
  description: 'Legal disclaimer for Cerebrum Biology Academy educational services and website content.',
}
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8 md:p-12">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-6 mb-8">
            ...
            <p className="text-amber-800">
              This disclaimer governs the use of our website and services. By using our website or services, 
              you accept this disclaimer in full. Please read it carefully before proceeding.
            </p>
          </div>
          ...
          <div className="space-y-8">
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  ...
                  permitted by law, Cerebrum Biology Academy excludes all representations, warranties, 
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">2. Educational Results and Performance</h2>
              <div className="space-y-4 text-gray-700">
                ...
                <p>
                  Academic success depends on numerous factors including but not limited to:
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">3. Website Content and Accuracy</h2>
              <div className="space-y-4 text-gray-700">
                ...
                <p>
                  ...
                  content. We do not endorse or take responsibility for the accuracy, quality, 
                  or reliability of such external content.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p>
                  Users are responsible for ensuring their systems meet technical requirements 
                  and maintaining appropriate security measures. We are not liable for issues 
                  arising from incompatible systems or security breaches on the user's end.
                </p>
              </div>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Faculty and Staff Qualifications</h2>
              <div className="space-y-4 text-gray-700">
                <p>
                  While we provide information about our faculty qualifications and experience, 
                ...
                <p>
                  Faculty information is provided for general reference and may be subject to change.
                </p>
              </div>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">6. Medical and Health Advice</h2>
              <div className="space-y-4 text-gray-700">
                <p>
                ...
                <p>
                  Students studying medical topics should always refer to current medical texts 
                  and consult qualified healthcare professionals for any health-related decisions.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  Investment in education involves financial commitment. We make no guarantees about:
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p>
                  All fee information is subject to change. Students should carefully consider 
                  their financial situation before enrolling.
                </p>
              </div>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">8. Testimonials and Success Stories</h2>
              <div className="space-y-4 text-gray-700">
                <p>
                ...
                <p>
                  Individual results may vary significantly based on personal circumstances, 
                  effort, and various external factors.
                </p>
              </div>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">10. Changes to Curriculum and Services</h2>
              <div className="space-y-4 text-gray-700">
                <p>
                ...
                <p>
                  Such changes will be communicated to enrolled students as per our communication policy.
                </p>
              </div>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">11. Jurisdiction and Applicable Law</h2>
              <div className="space-y-4 text-gray-700">
                <p>
                  This disclaimer is governed by the laws of India. Any disputes arising from 
                  the use of our website or services will be subject to the jurisdiction of 
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <p className="text-blue-700">
                ...
                and agree to the terms of this disclaimer. If you do not agree with any part of 
