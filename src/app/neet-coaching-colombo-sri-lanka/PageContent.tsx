    ...
    <main className="bg-white">
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-6 inline-block">
            <span className="bg-amber-200 text-amber-900 px-6 py-2 rounded-full text-sm font-semibold">
              Trusted by 15,000+ Students
            </span>
          </div>
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Best NEET Coaching for Indian Students in Colombo
          </h1>
          <p className="text-xl md:text-2xl mb-12 text-amber-100">
            A/L to NEET Transition • 98% Success Rate • 695/720 Top Score • Sri Lanka-Friendly
            Timing
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            ...
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg border border-white/20">
              ...
              <p className="text-sm text-amber-200">5.0/5 Rating</p>
            </div>
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg border border-white/20">
              <Users className="w-8 h-8 mx-auto mb-2 text-yellow-300" />
              <p className="text-sm text-amber-200">15,000+ Students</p>
            </div>
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg border border-white/20">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/918826444334?text=Hi%20Cerebrum%21%20I%20want%20to%20join%20NEET%20coaching%20in%20Colombo"
              target="_blank"
      ...
      >
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-4">
            Why Choose Cerebrum for NEET in Colombo?
          </h2>
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Specialized A/L to NEET transition coaching for Sri Lankan students
          </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Only 30 minutes behind India timezone. Classes fit perfectly with Colombo
                    schedule. Morning batches ideal for students. Evening options for working
                    professionals.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 p-8 rounded-lg border border-amber-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Specialized curriculum bridge the gap between A/Level and NEET syllabi. Help
                    relearning key concepts with NEET focus. 3-4 month intensive transition program
                    available.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    ...
                    within minutes. Video calls for complex A/L to NEET transition topics.
                  </p>
                </div>
              </div>
            </div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 bg-amber-50 p-8 rounded-lg border-l-4 border-amber-600">
            <p className="text-gray-700">
              <strong>From another school?</strong> We support students from all CBSE, ICSE, and
              local schools in Colombo. Special support for A/L students transitioning to NEET.
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 text-center mb-12">
            Everything you need to know about NEET coaching in Colombo
          </p>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-amber-900 to-orange-900 text-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-amber-100 mb-8">
            Get expert NEET guidance for Colombo students. A/L to NEET transition support. Free demo
            available now.
          </p>
