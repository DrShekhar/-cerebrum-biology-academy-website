...
export const metadata: Metadata = {
  title: 'Affordable NEET Coaching in Faridabad | Budget-Friendly Biology Preparation',
  description:
    'Best affordable NEET coaching in Faridabad starting from ₹45,000/year. Quality Biology coaching with AIIMS faculty at 30-40% lower fees than Allen, Aakash. EMI options available.',
  keywords: [
    'affordable neet coaching faridabad',
    'cheap neet coaching faridabad',
    'budget neet coaching faridabad',
  ...
  openGraph: {
    title: 'Affordable NEET Coaching in Faridabad | Quality at Lower Cost',
    description:
      'Premium NEET Biology coaching at 30-40% lower fees than big institutes. Starting ₹45,000/year.',
    url: 'https://cerebrumbiologyacademy.com/affordable-neet-coaching-faridabad',
  },
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/affordable-neet-coaching-faridabad',
  },
}
...
export default function AffordableNEETCoachingFaridabadPage() {
  const courseSchema = {
    '@context': 'https://schema.org',
    '@type': 'Course',
    name: 'Affordable NEET Biology Coaching - Faridabad',
    description:
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: 'https://cerebrumbiologyacademy.com/affordable-neet-coaching-faridabad',
      },
    ],
  }
