...
const PAGE_URL = 'https://cerebrumbiologyacademy.com/neet-coaching-near-me-rajkot'

export const metadata: Metadata = {
  title: 'NEET Coaching Near Me Rajkot | Cerebrum',
  description: 'NEET Coaching Near Me in Rajkot — AIIMS-trained faculty, online live. Serving Kalawad Road, University Road, Yagnik Road, 150 Feet Ring Road. From Rs 48,000/yr.',
  keywords: ['neet coaching near me rajkot', 'NEET biology rajkot', 'best NEET rajkot'],
  alternates: { canonical: PAGE_URL },
  openGraph: { title: 'NEET Coaching Near Me Rajkot', url: PAGE_URL, locale: 'en_IN', type: 'website' },
}
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">NEET Coaching Near Me in Rajkot</h1>
