...
const benefits = [
  { title: 'Digital + Personal', description: 'Keep the 2nd-largest national NEET chain\'s digital resources while adding personal teaching from AIIMS faculty.', icon: Monitor },
  { title: 'Flexible Scheduling', description: 'Weekend intensives or evening sessions. Choose what fits your the 2nd-largest national NEET chain schedule.', icon: Calendar },
  { title: 'Biology Deep-Dive', description: 'While the 2nd-largest national NEET chain covers breadth, we focus on depth. Master concepts that matter for NEET.', icon: BookOpen },
  { title: 'Personal Attention', description: '10-20 students vs the 2nd-largest national NEET chain\'s 60-80. Your doubts get answered properly.', icon: Users },
]
...
const testimonials = [
  { name: 'Arjun P.', score: '625/720', combo: 'the 2nd-largest national NEET chain + Cerebrum', quote: 'Continued the 2nd-largest national NEET chain for their test series but joined Cerebrum for Biology concepts. The combination worked perfectly for me.' },
  { name: 'Priya M.', score: '638/720', combo: 'the 2nd-largest national NEET chain + Cerebrum Weekend', quote: 'the 2nd-largest national NEET chain\'s digital resources are good, but Biology needs personal teaching. Cerebrum weekend batch gave me exactly that.' },
  { name: 'Ravi S.', score: '608/720', combo: 'the 2nd-largest national NEET chain + Cerebrum Evening', quote: 'My Biology score improved by 60 marks after joining Cerebrum evening sessions. The doubt clearing is so much better than app-based.' },
]
...
export default function ComplementAakashContent({ faqs }: { faqs: FAQ[] }) {
  const [openFaq, setOpenFaq] = useState<number | null>(null)

  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'complement-aakash-coaching-gurugram',
      message: 'Hi! I am an the 2nd-largest national NEET chain student in Gurugram and want to join Cerebrum for extra Biology coaching. Please share the schedule and fees.',
      campaign: 'complement-aakash-gurugram',
    })
  }
  ...
  return (
    <main className="min-h-screen bg-white">
      <nav className="bg-gray-100 py-3 px-4">
        <div className="max-w-7xl mx-auto">
          <ol className="flex items-center flex-wrap gap-1 text-sm">
            ...
            <li className="flex items-center"><ChevronRight className="w-4 h-4 text-gray-400 mx-1" /><span className="text-teal-700 font-medium">Complement the 2nd-largest national NEET chain Coaching</span></li>
          </ol>
        </div>
      </nav>
          ...
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button onClick={handleWhatsApp}
                ...
                <Phone className="w-5 h-5" />Get Schedule for the 2nd-largest national NEET chain Students
              </button>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Why the 2nd-largest national NEET chain Students Add Cerebrum</h2>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Flexible Batches for the 2nd-largest national NEET chain Students</h2>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">the 2nd-largest national NEET chain + Cerebrum Success Stories</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeInUp">
              ...
              <p className="text-xl text-indigo-100 mb-6">
                the 2nd-largest national NEET chain's digital platform is good for practice and tests. But Biology needs personal teaching and doubt clearing that apps cannot provide.
                Cerebrum adds the human element.
              </p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-green-400" />Use the 2nd-largest national NEET chain test series + Cerebrum concepts</li>
                <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-green-400" />Digital resources + Personal doubt clearing</li>
                <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-green-400" />App-based practice + Classroom teaching</li>
                <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-green-400" />Video lectures + AIIMS faculty interaction</li>
              </ul>
              <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Biology%20coaching%20in%20Gurugram.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-slate-600 mb-6">
                  Our center is at <strong>M2K Corporate Park, Sector 51</strong> - easily accessible from Golf Course Road and Rapid Metro.
                </p>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between py-2 border-b"><span>AIIMS Faculty</span><span className="text-green-600 font-semibold">Dr. Shekhar</span></div>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <Link href="/aakash-alternative-gurugram" className="bg-gray-50 p-4 rounded-xl hover:shadow-md"><h3 className="font-semibold text-teal-600">the 2nd-largest national NEET chain Alternative</h3><p className="text-sm text-gray-600">Full switch from the 2nd-largest national NEET chain</p></Link>
            <Link href="/complement-allen-coaching-gurugram" className="bg-gray-50 p-4 rounded-xl hover:shadow-md"><h3 className="font-semibold text-teal-600">Complement the largest national NEET chain</h3><p className="text-sm text-gray-600">For the largest national NEET chain students</p></Link>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">Join 150+ the 2nd-largest national NEET chain students who complement their coaching with Cerebrum</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Biology%20coaching%20in%20Gurugram.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer"><Button variant="secondary" size="xl" className="bg-white text-indigo-600 hover:bg-gray-100 font-bold"><Play className="w-5 h-5 mr-2" />Book Free Trial</Button></Link>
