...
export default function ComplementAakashContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      ...
      message:
        'Hi! I am an Aakash student in Gurugram and want to join Cerebrum for extra Biology coaching. Please share the schedule and fees.',
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-slate-600 mb-6">
                  Our center is at <strong>M2K Corporate Park, Sector 51</strong> - easily
                  accessible from Golf Course Road and Rapid Metro.
                </p>
