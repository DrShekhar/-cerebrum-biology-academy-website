...
const benefits = [
  { title: 'Digital + Personal', description: 'Keep Aakash\'s digital resources while adding personal teaching from AIIMS faculty.', icon: Monitor },
  { title: 'Flexible Scheduling', description: 'Weekend intensives or evening sessions. Choose what fits your Aakash schedule.', icon: Calendar },
  { title: 'Biology Deep-Dive', description: 'While Aakash covers breadth, we focus on depth. Master concepts that matter for NEET.', icon: BookOpen },
  { title: 'Personal Attention', description: '10-20 students vs Aakash\'s 60-80. Your doubts get answered properly.', icon: Users },
]
...
const testimonials = [
  { name: 'Arjun P.', score: '625/720', combo: 'Aakash + Cerebrum', quote: 'Continued Aakash for their test series but joined Cerebrum for Biology concepts. The combination worked perfectly for me.' },
  { name: 'Priya M.', score: '638/720', combo: 'Aakash + Cerebrum Weekend', quote: 'Aakash\'s digital resources are good, but Biology needs personal teaching. Cerebrum weekend batch gave me exactly that.' },
  { name: 'Ravi S.', score: '608/720', combo: 'Aakash + Cerebrum Evening', quote: 'My Biology score improved by 60 marks after joining Cerebrum evening sessions. The doubt clearing is so much better than app-based.' },
]
...
export default function ComplementAakashContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      ...
      message: 'Hi! I am an Aakash student in Gurugram and want to join Cerebrum for extra Biology coaching. Please share the schedule and fees.',
    ...
    <main className="min-h-screen bg-white">
      <nav className="bg-gray-100 py-3 px-4">
        <div className="max-w-7xl mx-auto">
          <ol className="flex items-center flex-wrap gap-1 text-sm">
            ...
            <li className="flex items-center"><ChevronRight className="w-4 h-4 text-gray-400 mx-1" /><span className="text-teal-700 font-medium">Complement Aakash Coaching</span></li>
          </ol>
        </div>
      </nav>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeInUp">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-green-400" />Use Aakash test series + Cerebrum concepts</li>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">Join 150+ Aakash students who complement their coaching with Cerebrum</p>
