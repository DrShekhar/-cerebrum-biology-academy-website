...
export const metadata: Metadata = {
  ...
  description: 'NSEB (National Standard Examination in Biology) coaching for Coimbatore students. NSEB → INBO → OCSC → IBO pathway. AIIMS-trained faculty, online live.',
...
const faqs = [
  ...
  { question: 'How does NSEB coaching work from Coimbatore?', answer: 'Live online sessions via Zoom, IST evenings and weekends. Campbell Biology + Alberts Molecular Biology depth. Weekly past-paper drilling. Coimbatore students join pan-India NSEB cohort.' },
...
export default function Page() {
  return (
    <main className="min-h-screen bg-white">
      <CerebrumPersonSchema knowsAbout={['NSEB Coimbatore', 'Biology Olympiad Tamil Nadu', 'INBO preparation', 'IBO coaching']} />
      ...
      <section className="bg-gradient-to-br from-amber-900 to-yellow-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">NSEB Coaching for Coimbatore Students</h1>
          <p className="text-xl text-amber-200 mb-6 max-w-3xl">Biology Olympiad coaching for Coimbatore (Tamil Nadu). NSEB → INBO → OCSC → IBO pathway. AIIMS-trained faculty, Campbell + Alberts depth. Online live. Pursuit Rs 2,500/yr to Pinnacle Rs 6,000/yr.</p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 prose prose-slate max-w-none">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">NSEB → INBO → IBO pathway from Coimbatore</h2>
      ...
      <section className="py-16 bg-gradient-to-br from-amber-600 to-yellow-600">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Start NSEB Coaching from Coimbatore</h2>
