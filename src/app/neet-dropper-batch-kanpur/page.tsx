...
export const metadata: Metadata = {
  ...
  keywords: ['neet dropper batch kanpur', 'neet repeater course kanpur', 'best dropper batch neet kanpur'],
  alternates: { canonical: `https://cerebrumbiologyacademy.com/neet-dropper-batch-kanpur` },
  openGraph: { title: `NEET Dropper Batch 2026-27 ${cityName}`, url: `https://cerebrumbiologyacademy.com/neet-dropper-batch-kanpur`, locale: 'en_IN', type: 'website' },
