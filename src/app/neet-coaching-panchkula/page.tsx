...
const features = [
  {
    ...
    alternates: { canonical: 'https://cerebrumbiologyacademy.com/neet-coaching-panchkula' },
  ...
  },
  {
    ...
    description:
      'Unlike 100+ batches at Sector 34. Every Panchkula student gets personal attention.',
  },
  {
    icon: Award,
    title: 'AIIMS Faculty',
    description:
      'Teachers trained at AIIMS Delhi. Not available at any Panchkula or nearby coaching.',
  },
  {
    icon: Clock,
  ...
  },
  {
    ...
    description:
      'Special prep for PGIMER Chandigarh and BPS GMC Khanpur - top choices for Haryana students.',
  },
]
...
const neetTools = [
  ...
  { name: 'NEET Syllabus 2026', href: '/neet-syllabus-2026', icon: BookOpen },
  { name: 'Previous Papers', href: '/neet-previous-year-questions', icon: Target },
]
...
const faqs = [
  {
    ...
    answer:
      'Cerebrum Biology Academy is the best NEET coaching for Panchkula students. With AIIMS-trained faculty, 98% success rate, and online classes, Panchkula students get top-quality coaching without crossing the border to Chandigarh. 150+ students from Panchkula already enrolled.',
  },
  {
    question: 'How much does NEET coaching cost for Panchkula students?',
    answer:
      'Cerebrum Academy fees: Foundation (Class 11) - Rs 24,000/year, Comprehensive (Class 12) - Rs 36,000/year, Dropper batch - Rs 68,000/year. This is 60-70% cheaper than Chandigarh coaching centers, plus you save Rs 40,000+ yearly on transport.',
  },
  {
    question: 'Should Panchkula students go to Chandigarh Sector 34 for NEET coaching?',
    answer:
      'Not necessary! Panchkula students waste 2 hours daily commuting to Chandigarh, spend Rs 2500-4000/month on transport, and face border crossing hassles. Cerebrum offers identical quality online - study from your Panchkula home.',
  },
  {
    question: 'Is online NEET coaching effective for Panchkula students?',
    answer:
      "Absolutely! Cerebrum's online coaching has 98% success rate. Live interactive classes, small batches (10-15 students), instant doubt clearing via WhatsApp, and recorded sessions. 150+ Panchkula students achieving excellent results.",
  },
  {
    question: 'Which areas in Panchkula does Cerebrum serve?',
    answer:
      'Cerebrum serves all Panchkula areas: Sector 12A, Sector 20, MDC Sector 5, Sector 11, Sector 4, Sector 14, Kalka, Pinjore, and surrounding areas. Online classes mean no location restrictions.',
  },
  {
    question: 'What are the batch timings for Panchkula students?',
    answer:
      'Multiple options: Morning batch (6 AM - 8 AM), After-school batch (4 PM - 6 PM), Evening batch (7 PM - 9 PM). Panchkula students can choose based on school schedule. Weekend batches also available.',
  },
  {
    question: 'Does Cerebrum support Haryana Board students from Panchkula?',
    answer:
      'Yes! Our content is aligned with both CBSE and Haryana Board. Many Panchkula students follow Haryana Board, and we ensure NEET preparation complements their board studies. Special focus on Biology for Haryana students.',
  },
  {
    question: 'Which medical colleges can Panchkula students target?',
    answer:
      'Panchkula students can target: PGIMER Chandigarh (12 km), GMCH Sector 32 (10 km) for All India quota, and BPS GMC Khanpur, PGIMS Rohtak, Kalpana Chawla GMC for Haryana state quota. We provide college-specific guidance.',
  },
  {
    question: 'Is there NEET coaching in Sector 12A Panchkula?',
    answer:
      "There's limited quality NEET coaching in Sector 12A. Cerebrum provides superior online coaching accessible from Sector 12A. 30+ students from Sector 12A area enrolled. Save 25+ min daily commute to Chandigarh.",
  },
  {
    question: 'How does Cerebrum compare to Chandigarh coaching centers?',
    answer:
      'Cerebrum advantages: (1) Batch size 10-15 vs 60-120 at the largest national NEET chains, (2) AIIMS faculty vs regular teachers, (3) Fees Rs 24-68K vs Rs 1-3.5 Lakhs, (4) Online - no Chandigarh commute, (5) 98% success rate, (6) Haryana board support.',
  },
  {
    question: 'Does Cerebrum provide study material for Panchkula students?',
    answer:
      'Yes! Complete package: Digital notes (NCERT-based), chapter-wise video lectures, 10,000+ MCQs, previous year papers (2015-2025), mock tests with analysis. All accessible online from Panchkula.',
  },
  {
    question: 'Is dropper batch available for Panchkula students?',
    answer:
      'Yes! Dedicated dropper/repeater batch at Rs 68,000/year. Intensive 6-8 hours daily coaching, personal mentorship, weekly tests, AIIMS faculty guidance. Many Panchkula droppers improved 100+ marks.',
  },
  {
    question: 'How to book free demo from Panchkula?',
    answer:
      'Easy process: (1) Call/WhatsApp: +91-8826444334, (2) Visit cerebrumbiologyacademy.com, (3) Attend live demo class from your Panchkula home, (4) Meet AIIMS faculty. Free demo - no commitment.',
  },
  {
    question: 'What is the success rate for Panchkula students?',
    answer:
      '98% of Cerebrum students qualify NEET. From Panchkula: 18+ students in government medical colleges in 2024, 6 in PGIMER/GMCH, 5 in Haryana GMCs. Highest score 358/360 in Biology.',
  },
  {
    question: 'Are there scholarships for Panchkula students?',
    answer:
      'Yes! Monthly scholarship test with 25-100% fee waiver for top performers. Panchkula students can appear online. Also: sibling discount (10%), early bird discount (15%), need-based financial aid.',
  },
  {
    question: 'Can Kalka students join Cerebrum?',
    answer:
      'Absolutely! 15+ students from Kalka area enrolled. Online classes mean excellent connectivity from Kalka. No need to travel to Panchkula city or Chandigarh. Study from the comfort of your home in Kalka.',
  },
  {
    question: 'What makes Cerebrum better than local Panchkula tutors?',
    answer:
      'Key differences: (1) AIIMS-trained faculty vs local graduates, (2) Structured NEET curriculum vs generic teaching, (3) National-level mock tests, (4) 98% proven success rate, (5) Complete study material, (6) Technology-enabled learning.',
  },
  {
    question: 'How do Panchkula students clear doubts online?',
    answer:
      'Multiple channels: (1) Live doubt solving during class, (2) WhatsApp direct to faculty (2-hour response guarantee), (3) Weekly dedicated doubt sessions, (4) One-on-one video calls. No doubt remains unanswered.',
  },
]
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="animate-fadeInUp">
              ...
              <p className="text-xl lg:text-2xl text-purple-100 mb-8 leading-relaxed">
                Why cross the border to Chandigarh? Get <strong>same quality NEET coaching</strong>{' '}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Why Panchkula Students Should <span className="text-red-600">NOT</span> Go to
              Chandigarh
            </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Premium NEET coaching delivered to your Haryana home
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Online classes accessible across Panchkula district
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {panchkulaAreas.map((area, index) => (
              ...
              >
                ...
                <div
                  className={`text-sm ${area.priority === 'high' ? 'text-purple-100' : 'text-gray-600'}`}
                >
                  {area.students} students
                </div>
                <div
                  className={`text-xs mt-1 ${area.priority === 'high' ? 'text-purple-200' : 'text-gray-500'}`}
                >
                  {area.highlight}
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-red-50 p-8 rounded-2xl border border-red-200">
              <h3 className="text-xl font-bold text-red-700 mb-6">
                Chandigarh Coaching (from Panchkula)
              </h3>
              <ul className="space-y-3">
                <li className="flex justify-between">
                  <span>Tuition Fee</span>
                  <span className="font-bold">₹1,50,000 - ₹3,50,000</span>
                </li>
                <li className="flex justify-between">
                  <span>Transport (yearly)</span>
                  <span className="font-bold">₹30,000 - ₹48,000</span>
                </li>
                <li className="flex justify-between">
                  <span>Time Wasted (hrs/year)</span>
                  <span className="font-bold">500+ hours</span>
                </li>
                <li className="flex justify-between">
                  <span>Batch Size</span>
                  <span className="font-bold">60-120 students</span>
                </li>
                <li className="flex justify-between border-t pt-3 text-lg">
                  <span>Total Cost</span>
                  <span className="font-bold text-red-700">₹1,80,000+</span>
                </li>
              </ul>
            </div>
            <div className="bg-green-50 p-8 rounded-2xl border border-green-200">
              <h3 className="text-xl font-bold text-green-700 mb-6">
                Cerebrum Online (From Panchkula)
              </h3>
              <ul className="space-y-3">
                <li className="flex justify-between">
                  <span>Tuition Fee</span>
                  <span className="font-bold">₹24,000 - ₹68,000</span>
                </li>
                <li className="flex justify-between">
                  <span>Transport</span>
                ...
                <li className="flex justify-between">
                  <span>Batch Size</span>
                  <span className="font-bold">10-15 students</span>
                </li>
                <li className="flex justify-between border-t pt-3 text-lg">
                  <span>Total Cost</span>
                  <span className="font-bold text-green-700">₹24,000 - ₹68,000</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-gray-900">
              Free NEET Tools for Panchkula Students
            </h2>
          </div>
      ...
      <nav className="py-4 bg-gray-100">
        <div className="container mx-auto px-4">
          <ol className="flex flex-wrap items-center gap-2 text-sm text-gray-600">
            ...
            <li>/</li>
            <li>
              <Link href="/neet-coaching-chandigarh" className="hover:text-purple-600">
