...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      'en-IN': 'https://cerebrumbiologyacademy.com/olympiad-preparation',
      en: 'https://cerebrumbiologyacademy.com/olympiad-preparation',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: 'https://cerebrumbiologyacademy.com/olympiad-preparation',
    },
  ],
}
