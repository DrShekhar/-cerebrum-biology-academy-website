  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-4 gap-6 mt-12">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
                ...
                <div className="text-3xl font-bold">{successAnalyticsData.topRanks}</div>
                <div className="text-green-100">Top 1000 Ranks</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
                <TrendingUp className="w-8 h-8 mx-auto mb-3" />
                <div className="text-3xl font-bold">{successAnalyticsData.averageImprovement}+</div>
                <div className="text-green-100">Avg. Improvement</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
                <Users className="w-8 h-8 mx-auto mb-3" />
                <div className="text-3xl font-bold">{successAnalyticsData.successRate}%</div>
                <div className="text-green-100">Success Rate</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
                <Target className="w-8 h-8 mx-auto mb-3" />
                <div className="text-3xl font-bold">{successStoriesData.length}</div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Featured Video Stories</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Amazing Achievements</h2>
            <p className="text-xl text-gray-600">
