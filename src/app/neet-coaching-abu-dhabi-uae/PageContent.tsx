      ...
      <section className="relative py-16 bg-gradient-to-r from-blue-700 via-blue-600 to-teal-700 text-white">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-6">
            Capital city with large Indian expat community. NEET exam center available. Premium
            coaching online.
          </p>
          <div className="flex flex-wrap justify-center gap-4 mb-6">
            <Link
              href="https://wa.me/918826444334?text=Hi%20I%20am%20from%20Abu%20Dhabi%20interested%20in%20NEET%20coaching"
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm">
            ...
            <span className="flex items-center gap-1">
              <CheckCircle className="w-4 h-4" /> 30+ CBSE Schools
            </span>
            <span className="flex items-center gap-1">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-10">
            Why Abu Dhabi Students Choose Cerebrum
          </h2>
          ...
          {[
            {
              ...
              score: '628/720',
              quote:
                'Abu Dhabi to AIIMS was a dream. Cerebrum made it possible with their expert faculty and flexible timings.',
              college: 'AIIMS Delhi',
            },
            {
              name: 'Fatima Sheikh',
              ...
              score: '612/720',
              quote:
                'The best part was not having to leave Abu Dhabi for coaching. Online classes were as effective as in-person.',
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 mb-8 text-lg">
            Join Indian students in Abu Dhabi already preparing with expert AIIMS faculty. Book a
            free demo today.
          </p>
          <Link
            href="https://wa.me/918826444334?text=Hi%20I%20am%20from%20Abu%20Dhabi%20interested%20in%20NEET%20coaching"
