...
export const metadata: Metadata = {
  ...
  description:
    'NEET Foundation Class 9 in Madurai — AIIMS-trained faculty, online live. Serving Anna Nagar, KK Nagar, Tallakulam, Villapuram, Thirunagar. From Rs 35,000/year.',
  keywords: [
    'neet foundation class 9 madurai',
    'class 9 biology coaching madurai',
    'class 9 neet madurai',
  ],
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: 'NEET Foundation Class 9 Madurai',
    url: PAGE_URL,
    locale: 'en_IN',
    type: 'website',
  },
...
const wa =
  ...
  encodeURIComponent('Hi — Class 9 student in Madurai, want NEET Foundation details.')
const faqs = [
  {
    question: 'Is Class 9 too early for NEET in Madurai?',
  ...
  return (
    <main className="min-h-screen bg-white">
      <CerebrumPersonSchema
        knowsAbout={['NEET Foundation Madurai', 'Class 9 Biology Tamil Nadu']}
      />
      <LocalBusinessSchema />
      ...
      <section className="bg-gradient-to-br from-emerald-900 to-green-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            NEET Foundation Class 9 in Madurai
          </h1>
      ...
      <FoundationCityEnrichment slug="madurai" classLevel={9} />
