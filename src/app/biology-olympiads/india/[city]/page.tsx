...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [
      ...
      `biology olympiad tutor ${entry.city.toLowerCase()}`,
      `biology olympiad tutor near me ${entry.city.toLowerCase()}`,
      `NSEB coaching ${entry.city.toLowerCase()}`,
      `NSEB tutor ${entry.city.toLowerCase()}`,
      `NSEB tutor near me ${entry.city.toLowerCase()}`,
      `INBO preparation ${entry.city.toLowerCase()}`,
      `INBO tutor ${entry.city.toLowerCase()}`,
      `INBO tutor near me ${entry.city.toLowerCase()}`,
      `olympiad classes ${entry.city.toLowerCase()}`,
      `IBO coaching ${entry.city.toLowerCase()}`,
      `IBO tutor near me ${entry.city.toLowerCase()}`,
      `biology olympiad preparation ${entry.city.toLowerCase()}`,
      `best biology olympiad tutor ${entry.city.toLowerCase()}`,
      `private biology olympiad tutor ${entry.city.toLowerCase()}`,
