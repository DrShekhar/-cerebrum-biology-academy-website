...
export default function ClassroomCoachingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            ...
            <div className="flex flex-col md:flex-row gap-3 sm:gap-4 justify-center mb-8 sm:mb-12">
              <Link
                ...
                className="bg-white text-green-600 px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:bg-green-50 transition-colors inline-flex items-center justify-center text-base sm:text-lg min-h-[44px] w-full md:w-auto"
              >
                Book Campus Visit
              ...
              <Link
                href="#demo"
                className="border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:bg-white hover:text-green-600 transition-colors text-base sm:text-lg min-h-[44px] w-full md:w-auto"
              >
                Attend Demo Class
              </Link>
            </div>
      ...
      {/* CTA Section */}
      <section className="py-8 sm:py-12 md:py-16 bg-[#4a5d4a] text-white">
