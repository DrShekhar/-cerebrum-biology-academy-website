...
import { CheckCircle, Clock, Users, Award, BookOpen, Target, Star, ArrowRight, Trophy, MessageCircle, Phone, Video, Zap } from 'lucide-react'

export const metadata: Metadata = {
  title: '24/7 Doubt Resolution | Instant Biology Help | NEET Support | Cerebrum Biology Academy',
  description: '24/7 doubt clearing support for NEET Biology students. Instant help via WhatsApp, live chat, video calls. Expert faculty available round the clock.',
  keywords: '24/7 doubt resolution, NEET Biology help, instant doubt clearing, biology questions, student support',
}
...
export default function DoubtResolutionPage() {
  const supportChannels = [
    {
      ...
      features: ['Text & Voice Messages', 'Image-based Doubts', 'Quick Explanations', 'Follow-up Support'],
    ...
    },
    {
      ...
      features: ['Face-to-face Interaction', 'Whiteboard Explanations', 'Detailed Solutions', 'Screen Sharing'],
    ...
    },
    {
      ...
      features: ['Personal Discussion', 'Detailed Explanations', 'Concept Building', 'Study Guidance'],
  ...
  const doubtTypes = [
    {
      ...
      examples: ['What is osmosis?', 'Difference between mitosis and meiosis', 'Function of ribosomes'],
  ...
  const successStories = [
    {
      ...
      story: 'Used doubt resolution 150+ times in 6 months. The 24/7 support helped me clear concepts immediately without waiting for the next class.',
    ...
    },
    {
      ...
      story: 'The instant video calls for complex genetics problems were a game-changer. Faculty explained each step until I was completely clear.',
    ...
    },
    {
      ...
      story: 'WhatsApp support was perfect for me. I could ask doubts even during late-night study sessions and get immediate help.',
  ...
  const responseGuarantees = [
    ...
    { type: 'Regular Doubts', time: '30 minutes - 2 hours', description: 'General concept clarifications' },
    { type: 'Complex Problems', time: '2-6 hours', description: 'Detailed numerical and theoretical problems' },
    { type: 'Study Planning', time: '24 hours', description: 'Comprehensive guidance and strategy' }
  ]
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl font-bold mb-6">
                Never Let a Doubt Stop You
              </h1>
              <p className="text-xl text-red-100 mb-8">
                24/7 doubt resolution support that ensures no question goes unanswered. 
                Get instant help from expert NEET Biology faculty anytime, anywhere.
              </p>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Industry-leading support statistics that speak for our commitment</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Choose the support method that works best for you. All channels connected to expert faculty
            </p>
          </div>
                  ...
                  <div className="flex items-start mb-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="text-sm text-blue-600 font-medium">{channel.responseTime}</div>
                      </div>
                    </div>
                  </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">No question is too small or too complex for our expert faculty</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            {doubtTypes.map((doubt, index) => (
              <div key={index} className={`bg-white rounded-xl p-6 shadow-lg border-l-4 ${getColorClasses(doubt.color)} hover:shadow-xl transition-shadow`}>
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Success Through Doubt Resolution</h2>
            <p className="text-gray-600">How our 24/7 support helped students achieve their NEET dreams</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              <div key={index} className={`bg-white rounded-xl p-8 shadow-lg ${plan.popular ? 'ring-2 ring-red-600 relative' : ''} hover:shadow-xl transition-shadow`}>
                {plan.popular && (
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Start Getting Your Doubts Resolved Today</h2>
          
          <div className="bg-white rounded-3xl shadow-xl p-8 mb-8">
            <div className="mb-6">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Remember: No Question is Too Small!</h3>
              <p className="text-gray-600 mb-6">
                Every expert was once a beginner. Every concept you master starts with asking the right questions. 
                Our faculty is here to support your learning journey without any judgment.
              </p>
            </div>
          ...
          <div className="bg-green-100 border border-green-300 rounded-xl p-6">
            ...
            <p className="text-green-700">
              Students who actively ask doubts score 40+ marks higher in NEET Biology. Don't let confusion become your weakness!
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-600">
                No! We encourage unlimited questioning. With our courses, doubt resolution is completely free with no restrictions. 
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-600">
                Our faculty understands that every student learns differently. We create a judgment-free environment where 
                basic questions are welcomed. Remember, clarifying fundamentals is key to NEET success.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-600">
                All doubts are answered by AIIMS and top medical college graduates with 5+ years of NEET coaching experience. 
                Each faculty member specializes in specific Biology topics for accurate, detailed explanations.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-600">
                Absolutely! Our doubt resolution includes comprehensive academic guidance - study schedules, exam strategies, 
                topic prioritization, and performance improvement suggestions tailored to your progress.
              </p>
            </div>
          </div>
        </div>
