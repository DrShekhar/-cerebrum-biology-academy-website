...
export const metadata: Metadata = {
  title: 'International NEET Biology Programs | Global Medical Education | Cerebrum Biology Academy',
  description: 'Comprehensive NEET Biology coaching for international students and Indians abroad. IGCSE, IB, AP Biology support, global university prep, 24/7 timezone support. Starting $599.',
  keywords: 'international NEET coaching, global Biology education, IGCSE Biology, IB Biology, AP Biology, medical admissions abroad, international students NEET, overseas education, global medical programs, timezone flexible coaching',
}
...
export default function InternationalProgramsPage() {
  ...
  const globalAdvantages = [
    {
      ...
      description: 'Comprehensive support for IGCSE, IB, AP Biology, A-Levels, and international curricula alongside NEET preparation',
    ...
    },
    {
      ...
      description: 'Live classes scheduled across all major time zones with recorded sessions available 24/7 for maximum flexibility',
    ...
    },
    {
      ...
      description: 'Faculty support in English, Hindi, Spanish, French, and Arabic to help international students grasp complex concepts',
    ...
    },
    {
      ...
      description: 'Expert counseling for medical admissions in India, USA, UK, Canada, Australia, and other leading medical destinations',
    ...
    },
    {
      ...
      description: 'Complete assistance with educational transcripts, equivalency certificates, and visa documentation for medical admissions',
    ...
    },
    {
      ...
      description: 'Special orientation programs and cultural adaptation support to help students integrate with Indian medical education systems',
  ...
  const internationalSuccessStories = [
    {
      ...
      college: 'AIIMS Delhi',
      story: 'Moving from IGCSE to NEET seemed impossible, but Cerebrum\'s international program made it seamless. The timezone-flexible classes and cultural orientation helped me adapt to the Indian system while maintaining my Canadian study schedule.',
    ...
    },
    {
      ...
      story: 'The multilingual support in Arabic and English was incredible. Faculty understood both IB standards and NEET requirements, helping me leverage my IB knowledge for NEET success while managing the time difference perfectly.',
    ...
    },
    {
      ...
      college: 'MAMC Delhi',
      story: 'Despite the 8.5-hour time difference, I never felt disconnected. The recorded lectures and Portuguese translation support made complex Biology concepts accessible. The visa guidance was invaluable for my India move.',
  ...
  const internationalFaqs = [
    ...
    },
    {
      ...
      answer: 'We offer live classes across all major time zones with multiple batch timings. All sessions are recorded in HD and available 24/7. We also provide makeup classes and one-on-one sessions scheduled according to your local time zone. Our support team is available 24/7 for urgent queries.'
    },
    {
      question: 'Do you provide support for medical admissions outside India?',
      answer: 'Yes, we offer comprehensive guidance for medical admissions globally including MCAT preparation for US/Canada, UCAT/BMAT for UK/Australia, and other regional entrance exams. Our counselors help you create a strategy for multiple countries to maximize your admission opportunities.'
    },
    {
      question: 'How do you assist with documentation and visa processes?',
      answer: 'We provide complete documentation support including transcript evaluation, equivalency certificates, visa documentation assistance, and guidance on meeting specific requirements for Indian medical colleges. Our team has helped students from 47+ countries navigate these processes successfully.'
    },
    {
      question: 'What language support is available for non-English speakers?',
      answer: 'While our primary instruction is in English, we provide support in Hindi, Spanish, French, and Arabic. We offer subtitles, translated materials, and multilingual doubt-clearing sessions. Our international faculty can explain complex concepts in multiple languages.'
    },
    {
      question: 'How do you ensure quality education despite distance and time differences?',
      answer: 'We use advanced technology including HD live streaming, interactive whiteboards, real-time doubt resolution, and comprehensive recorded content. Our quality assurance team monitors all international sessions. Student progress is tracked closely with regular assessments and personalized feedback.'
    }
  ]
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-purple-100 mb-8 max-w-3xl mx-auto">
              Comprehensive NEET Biology coaching designed for international students and Indians abroad. 
              Seamlessly bridge global curricula with Indian medical entrance requirements across 47+ countries.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Specialized coaching that understands the unique challenges faced by international students 
              and provides comprehensive support for global medical aspirations
            </p>
          </div>
      ...
      <section className="py-16 bg-purple-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              No matter where you are in the world, we have live classes and support available in your time zone
            </p>
          </div>
                ...
                <div key={index} className="bg-white rounded-xl p-8 shadow-lg">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-purple-600 font-medium">{zone.time}</p>
                    </div>
                  </div>

                  <div className="mb-6">
                    <h4 className="font-semibold text-gray-800 mb-3">Countries Served:</h4>
                    <div className="flex flex-wrap gap-2">
                      {zone.countries.map((country, countryIndex) => (
                        <span key={countryIndex} className="px-3 py-1 bg-purple-100 text-purple-800 text-sm rounded-full">
                          {country}
                        </span>
                      ))}
                    </div>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800 mb-3">Available Batch Times:</h4>
                    <div className="space-y-2">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              International students who successfully transitioned to Indian medical colleges through our programs
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {internationalSuccessStories.map((story, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4 flex-1">
                    <div className="flex items-center">
                      <h3 className="font-semibold text-gray-900 mr-2">{story.name}</h3>
                ...
                <div className="mb-4">
                  <div className="text-lg font-bold text-purple-600 mb-1">{story.score}</div>
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Competitive international pricing with comprehensive support for global medical aspirations
            </p>
          </div>

          <div className="grid lg:grid-cols-3 gap-8">
            {pricingTiers.map((tier, index) => (
              <div key={index} className={`bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow ${tier.popular ? 'ring-2 ring-purple-500 relative' : ''}`}>
                {tier.popular && (
                ...
                <div className="p-8">
                  ...
                  <div className="flex items-center mb-4">
                    <span className="text-sm text-gray-500 line-through mr-2">{tier.originalPrice}</span>
                    <span className="text-sm text-green-600 font-semibold">{tier.savings}</span>
                  </div>
                  
                  <div className="text-sm text-purple-600 font-medium mb-6">{tier.bestFor}</div>
          ...
          <div className="text-center mt-8">
            <p className="text-gray-600 mb-4">🌍 Free consultation and curriculum assessment for all international students</p>
            <p className="text-sm text-gray-500">Multiple payment options • Currency conversion available • Regional pricing adjustments</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-xl p-6 text-center shadow-lg">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Global Helpline</h3>
            ...
            <div className="bg-white rounded-xl p-6 text-center shadow-lg">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Regional Email Support</h3>
              <div className="text-sm text-gray-600 space-y-1">
      ...
      <section className="py-16 bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold mb-8">Ready to Begin Your Global Medical Journey?</h2>
          
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 mb-8">
            <h3 className="text-2xl font-bold mb-6">🌍 Join Students from 47+ Countries</h3>
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="text-center">
                <div className="text-3xl font-bold mb-2">Free</div>
                <div className="text-purple-100">Global Consultation & Assessment</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold mb-2">24/7</div>
                <div className="text-purple-100">Multilingual Support</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold mb-2">92.3%</div>
                <div className="text-purple-100">International Success Rate</div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <Link 
                href="/admissions"
                className="block bg-white text-purple-600 px-8 py-4 rounded-lg font-semibold hover:bg-purple-50 transition-colors text-lg"
              >
                Start Your Global Application - No Commitment Required
              </Link>
              <Link 
                href="/contact"
                className="block border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-purple-600 transition-colors"
              >
