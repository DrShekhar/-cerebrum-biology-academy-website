/**
 * /neet-foundation-class-10-delhi
 *
 * NEET Foundation Class 10 city page — Delhi proper. Closes the Delhi
 * gap in the existing Foundation city cluster.
 */
...
export const metadata: Metadata = {
  ...
  description:
    'NEET Foundation Class 10 in Delhi at Cerebrum Biology Academy — South Extension flagship, Rohini, Green Park. CBSE / ICSE boards + NEET parallel pedagogy. AIIMS-trained faculty, batches of 15-20. ₹35K-95K/year.',
  keywords: [
    'neet foundation class 10 delhi',
    'class 10 biology coaching delhi',
    'class 10 cbse board biology delhi',
    'class 10 icse biology delhi',
    'class 10 neet south extension',
    'class 10 neet rohini',
    'best class 10 foundation delhi',
  ],
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: 'NEET Foundation Class 10 in Delhi | Cerebrum Biology Academy',
    description:
      'Class 10 NEET Foundation in Delhi — boards + NEET parallel. AIIMS-trained, 15-20 student batches.',
    url: PAGE_URL,
    locale: 'en_IN',
    type: 'website',
  },
...
const faqs = [
  {
    question: 'Can Cerebrum Delhi prepare my child for Class 10 boards AND NEET at the same time?',
    answer:
      'Yes — this is the core differentiator of Cerebrum Class 10 Foundation in Delhi. The same AIIMS-trained biology faculty teach both CBSE / ICSE Class 10 syllabus depth (Life Processes, Control and Coordination, How Do Organisms Reproduce, Heredity and Evolution, Our Environment) AND NEET-pattern MCQ drilling. Separate weekly tests in board format (long-answer with diagrams) and NEET MCQ format. Class 10 board results from Cerebrum Foundation Delhi students consistently average 90%+ in biology while simultaneously building NEET-ready conceptual foundations for Class 11.',
  },
  {
    question: 'Which Delhi centres run Class 10 NEET Foundation?',
    answer:
      "Three offline Delhi centres serve Class 10 Foundation. South Extension Part II (flagship, full faculty access including Dr. Shekhar Pinnacle micro-batches; serves DPS Mathura Road, Sardar Patel Vidyalaya, Vasant Valley, Modern Vasant Vihar families). Rohini (West/North Delhi catchment; serves DPS Rohini, Bal Bharati Rohini, Modern Public School families). Green Park (South Delhi catchment near Hauz Khas; serves DPS RK Puram, Modern Barakhamba, Sanskriti, Mother's International families). Online live Class 10 Foundation is also available for East Delhi, Dwarka, and other catchments where offline commute is impractical.",
  },
  {
    question: 'What is the Class 10 Foundation timing in Delhi?',
    answer:
  ...
  {
    question: 'How does Cerebrum Delhi compare to Allen Scholastics in Delhi for Class 10?',
    answer:
      'Three structural differences specifically for Class 10. (1) Subject focus: Cerebrum Delhi is biology-only specialist with AIIMS-trained Class 10 faculty; Allen Scholastics is combined PCB Foundation with school-teacher-level Class 10 instructors. (2) Batch size: Cerebrum 15-20 students vs Allen 200-300+. (3) Board strategy: Cerebrum runs separate weekly board-format mocks with examiner-aligned answer-writing standards; Allen deprioritises boards in favour of NEET-only drilling. For students targeting 90%+ in Class 10 boards AND NEET-ready foundations, Cerebrum Delhi is structurally different.',
  },
  {
    question: 'What does Class 10 NEET Foundation cost in Delhi?',
    answer:
      'Cerebrum Class 10 Foundation in Delhi runs ₹35,000-₹95,000/year. Pursuit (small-batch 30-40): ₹35K-55K. Ascent (pro batch 16-25 with weekly 1:1 doubt slots): ₹55K-75K. Pinnacle (direct Dr. Shekhar 10-12 student micro-batch at South Extension flagship): ₹75K-95K. Ad-hoc 1:1 Class 10 hourly: ₹2,000-3,500/hr. Board exam preparation included in all tiers. Compared to Allen Scholastics combined PCB Foundation Class 10 in Delhi (~₹95K-1.2L/year, 250-student batch), Cerebrum biology-only Ascent at ₹65K offers deeper biology pedagogy and 15-20 student structure at lower price.',
  },
  {
    question:
...
const courseSchema = {
  ...
  '@type': 'Course',
  name: 'NEET Foundation Class 10 Biology in Delhi',
  description:
    'Class 10 NEET Foundation biology coaching in Delhi at Cerebrum Biology Academy — three offline centres (South Extension, Rohini, Green Park) plus online live. CBSE / ICSE boards + NEET parallel pedagogy from AIIMS-trained faculty.',
  url: PAGE_URL,
  inLanguage: 'en-IN',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Delhi', item: PAGE_URL },
  ],
}
...
const wa =
  ...
  encodeURIComponent(
    'Hi — my child is in Class 10 in Delhi and we want to start NEET Foundation alongside CBSE / ICSE board preparation. Please share Cerebrum Delhi details — South Extension / Rohini / Green Park, pricing, schedule.'
  )
      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            NEET Foundation Class 10 in Delhi
          </h1>
          <p className="text-xl text-slate-300 mb-6 max-w-3xl">
            Class 10 NEET Foundation Biology at Cerebrum Delhi — three offline centres (South
            Extension flagship, Rohini, Green Park) plus pan-India online live. AIIMS-trained
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 prose prose-slate max-w-none">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">
            Three Delhi centres + online live for Class 10 NEET Foundation
          </h2>
          <ul>
            <li>
            ...
            <li>
              <strong>Rohini</strong> — West/North Delhi catchment. DPS Rohini, Bal Bharati Rohini,
              Modern Public School Sector 17 Rohini, Mt. Abu Public School feeder families.
            </li>
            <li>
          ...
          <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">Related Delhi pages</h2>
          <ul>
            <li>
            ...
            <li>
              <Link href="/neet-foundation-class-9-delhi" className="text-blue-600 hover:underline">
                Class 9 Foundation in Delhi
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link
                href="/class-10-biology-coaching-delhi"
                className="text-blue-600 hover:underline"
              >
                Class 10 Biology coaching Delhi (programme detail)
              </Link>
            </li>
          </ul>
        </div>
      ...
      <section className="py-16 bg-gradient-to-br from-blue-600 to-purple-600">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Book a free Class 10 demo at Cerebrum Delhi
          </h2>
