...
export default function NEETFoundationClass10NoidaContent({ faqs }: { faqs: FAQ[] }) {
  const [openFaq, setOpenFaq] = useState<number | null>(null)

  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'foundation-class10-noida',
      message:
        'Hi! I am a Class 10 student from Noida interested in NEET Foundation course. Please share details.',
      campaign: 'foundation-class10-noida',
    })
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              ...
              <span className="block text-blue-400 mt-2">in Noida</span>
            </h1>
      ...
      <section className="py-16 bg-gradient-to-br from-blue-600 to-teal-600 text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-8 animate-fadeInUp">
            ...
            <p className="text-blue-100">Trusted by students from top schools in Noida</p>
          </div>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            <Link
              href="/class-10-biology-coaching-noida"
              className="bg-gray-50 p-4 rounded-xl hover:shadow-md"
            >
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-blue-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join Cerebrum Biology Academy Noida and leverage the 40% syllabus overlap
          </p>
