...
export const metadata: Metadata = {
  title: 'Best NEET Coaching in Karnal 2026 | KCGMC City',
  description:
  ...
  twitter: {
    ...
    title: 'Best NEET Coaching in Karnal 2026 | KCGMC City',
    description:
      'Top NEET coaching for Karnal students. 98% success rate. Online classes from AIIMS faculty.',
  },
  alternates: {
