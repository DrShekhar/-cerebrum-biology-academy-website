...
const cityName = 'Chandigarh'
const citySlug = 'chandigarh'
...
export const metadata: Metadata = {
  ...
  keywords: ['neet dropper batch chandigarh', 'neet repeater course chandigarh', 'best dropper batch neet chandigarh'],
  alternates: { canonical: `https://cerebrumbiologyacademy.com/neet-dropper-batch-chandigarh` },
  openGraph: { title: `NEET Dropper Batch 2026-27 ${cityName}`, url: `https://cerebrumbiologyacademy.com/neet-dropper-batch-chandigarh`, locale: 'en_IN', type: 'website' },
