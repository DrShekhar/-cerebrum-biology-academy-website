...
export const metadata: Metadata = {
  ...
  description:
    "India's top NEET coaching — Physics, Chemistry & Biology by AIIMS Alumnus Dr. Shekhar C Singh. 98% success, 67+ AIIMS selections, 15,000+ students. 5 centers: South Extension, Green Park, Rohini, Gurugram, Faridabad + Online. Call 88264-44334. Free Demo!",
  keywords: [
    'NEET coaching',
    'NEET 2027 coaching',
