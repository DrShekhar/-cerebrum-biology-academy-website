    ...
    <main className="bg-white">
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-6 inline-block">
            <span className="bg-purple-200 text-purple-900 px-6 py-2 rounded-full text-sm font-semibold">
              Trusted by 15,000+ Students
            </span>
          </div>
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Best NEET Coaching for Indian Students in Doha
          </h1>
          <p className="text-xl md:text-2xl mb-12 text-purple-100">
            Expert AIIMS Faculty • 98% Success Rate • 695/720 Top Score • Serving DPS Doha &
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            ...
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg border border-white/20">
              ...
              <p className="text-sm text-purple-200">5.0/5 Rating</p>
            </div>
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg border border-white/20">
              <Users className="w-8 h-8 mx-auto mb-2 text-yellow-300" />
              <p className="text-sm text-purple-200">15,000+ Students</p>
            </div>
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg border border-white/20">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/918826444334?text=Hi%20Cerebrum%21%20I%20want%20to%20join%20NEET%20coaching%20in%20Doha"
              target="_blank"
      ...
      >
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-4">
            Why Choose Cerebrum for NEET in Doha?
          </h2>
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Specialized coaching for DPS Doha and international school students with proven success
          </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Doha is 3.5 hours ahead, making afternoon classes in Doha coincide with evening
                    in India. Morning India classes = afternoon Doha. Perfect fit for school
                    schedules.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-8 rounded-lg border border-purple-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Deep expertise with DPS Doha curriculum and students. Understand school schedule
                    and exam patterns. Many DPS Doha parent recommendations. Specialized batches
                    available.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    ...
                    within minutes. Video calls available for complex biology and chemistry topics.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 bg-purple-50 p-8 rounded-lg border-l-4 border-purple-600">
            <p className="text-gray-700">
              ...
              international schools in Doha. DPS Doha students form our core audience with proven
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 text-center mb-12">
            Everything you need to know about NEET coaching in Doha
          </p>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-purple-900 to-pink-900 text-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-purple-100 mb-8">
            Get expert NEET guidance for Doha students. Perfect timezone fit for DPS students. Free
            demo available now.
          </p>
