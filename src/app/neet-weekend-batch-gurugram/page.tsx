...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'weekend neet coaching gurugram',
    'neet classes for school students',
    'part time neet coaching',
    'weekend biology classes gurugram',
    'neet coaching saturday sunday gurgaon',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link
                href="/neet-evening-batch-gurugram"
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Course',
            name: 'NEET Weekend Batch Gurugram',
            description: 'Weekend NEET biology coaching for school students in Gurugram',
            provider: {
              '@type': 'Organization',
