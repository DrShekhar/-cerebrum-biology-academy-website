...
const PAGE_URL = 'https://cerebrumbiologyacademy.com/neet-coaching-near-me-nashik'

export const metadata: Metadata = {
  title: 'NEET Coaching Near Me Nashik | Cerebrum',
  description: 'NEET Coaching Near Me in Nashik — AIIMS-trained faculty, online live. Serving College Road, Gangapur Road, Panchavati, CIDCO. From Rs 48,000/yr.',
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">NEET Coaching Near Me in Nashik</h1>
