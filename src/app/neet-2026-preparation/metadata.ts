...
export const metadata: Metadata = {
  title: 'NEET 2027 Preparation | Best Biology Coaching | 98% Success Rate',
  description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'NEET 2027 Preparation - Cerebrum Biology Academy',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'NEET 2027 Preparation | 98% Success Rate | Free Demo',
    description:
