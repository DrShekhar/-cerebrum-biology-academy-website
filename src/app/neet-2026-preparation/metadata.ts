...
export const metadata: Metadata = {
  title: 'NEET 2026 Preparation | Best Biology Coaching | 98% Success Rate',
  description:
    "Start NEET 2026 preparation with India's #1 biology coaching. 98% success rate, 67+ AIIMS selections, AIIMS faculty. Online & offline classes in Delhi NCR. Book FREE demo!",
  keywords:
  ...
  openGraph: {
    title: 'NEET 2026 Preparation | #1 Biology Coaching | 98% Success',
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'NEET 2026 Preparation - Cerebrum Biology Academy',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'NEET 2026 Preparation | 98% Success Rate | Free Demo',
    description:
      'Start NEET 2026 preparation with expert AIIMS faculty. 67+ AIIMS selections yearly. Book FREE demo!',
  },
  alternates: {
