...
const TRACK_OPTIONS: TrackOption[] = [
  {
    ...
    goals: ['NEET 2027', 'NEET 2027', 'NEET 2027', 'NEET Dropper'],
...
/**
 * DEMO MODE - Onboarding Flow Testing
 * This page allows testing the onboarding flow without authentication
 */
export default function OnboardingDemoPage() {
  ...
  const handleComplete = () => {
    ...
    setTimeout(() => {
      ...
      // Save demo profile to localStorage for testing
      const demoProfile = {
        track: selectedTrack,
        goal: selectedGoal,
        ...
        <div className="bg-yellow-50 border-2 border-yellow-400 rounded-xl p-4 flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-yellow-700">
              This is a demo for testing. Data will be saved to localStorage only.
            </p>
          </div>
        </div>
      </div>
              ...
              <div className="space-y-6 animate-fadeInUp">
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600">
                    We'll help you track your progress towards this goal
                  </p>
                </div>
