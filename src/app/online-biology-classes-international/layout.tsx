...
export const metadata: Metadata = {
  ...
  description:
    'Expert online biology classes for international curricula. A-Level, IB Biology (HL/SL), AP Biology, IGCSE. 15,000+ students from 50+ countries. Global timezone support.',
  keywords: [
