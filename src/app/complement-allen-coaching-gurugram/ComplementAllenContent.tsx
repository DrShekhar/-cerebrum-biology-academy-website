...
const benefits = [
  { title: 'Same Building Location', description: 'Zero extra commute. Cerebrum is in M2K Corporate Park - same building as Allen Gurugram.', icon: MapPin },
  { title: 'Flexible Scheduling', description: 'Weekend intensives or evening sessions. Choose what fits your Allen schedule.', icon: Calendar },
  { title: 'Biology Deep-Dive', description: 'While Allen covers breadth, we focus on depth. Master concepts that matter for NEET.', icon: BookOpen },
  { title: 'Personal Attention', description: '10-20 students vs Allen\'s 100+. Your doubts get answered properly.', icon: Users },
]
...
const testimonials = [
  { name: 'Rohit M.', score: '615/720', combo: 'Allen + Cerebrum', quote: 'Continued Allen for Physics/Chemistry but joined Cerebrum for Biology. Best decision - Biology became my strongest subject with 340/360.' },
  { name: 'Ananya S.', score: '642/720', combo: 'Allen + Cerebrum Weekend', quote: 'The weekend batch at Cerebrum perfectly complemented my Allen weekday classes. Same building made it so convenient!' },
  { name: 'Vikram R.', score: '598/720', combo: 'Allen + Cerebrum Evening', quote: 'My Biology score jumped from 260 to 310 after joining Cerebrum evening sessions. The personal attention made all the difference.' },
]
...
export default function ComplementAllenContent({ faqs }: { faqs: FAQ[] }) {
  const [openFaq, setOpenFaq] = useState<number | null>(null)

  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'complement-allen-coaching-gurugram',
      message: 'Hi! I am an Allen student in Gurugram and want to join Cerebrum for extra Biology coaching. Please share the schedule and fees.',
  ...
  return (
    <main className="min-h-screen bg-white">
      <nav className="bg-gray-100 py-3 px-4">
        <div className="max-w-7xl mx-auto">
          <ol className="flex items-center flex-wrap gap-1 text-sm">
            ...
            <li className="flex items-center"><ChevronRight className="w-4 h-4 text-gray-400 mx-1" /><span className="text-teal-700 font-medium">Complement Allen Coaching</span></li>
          </ol>
        </div>
      </nav>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <motion.button whileHover={{ scale: 1.02 }} onClick={handleWhatsApp}
                ...
                <Phone className="w-5 h-5" />Get Schedule for Allen Students
              </motion.button>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Why Allen Students Add Cerebrum</h2>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Flexible Batches for Allen Students</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {scheduleOptions.map((option, index) => (
              <motion.div key={option.name} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }}
                className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-2xl p-6 border border-teal-100">
          ...
          <div className="text-center mt-8">
            <motion.button whileHover={{ scale: 1.02 }} onClick={handleWhatsApp}
              className="inline-flex items-center gap-2 bg-teal-600 hover:bg-teal-700 text-white px-6 py-3 rounded-xl font-semibold">
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Allen + Cerebrum Success Stories</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <p className="text-xl text-blue-100 mb-6">
                Cerebrum is located in <strong>M2K Corporate Park, Sector 51</strong> - the same building as Allen Career Institute Gurugram.
                Walk from Allen to Cerebrum in under 2 minutes.
              </p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-green-400" />Finish Allen class, start Cerebrum session</li>
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
              ...
              <p className="text-sm text-blue-200 mt-4">*Fee depends on batch type and intensity. Discounts for Allen referrals.</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <Link href="/allen-alternative-gurugram" className="bg-gray-50 p-4 rounded-xl hover:shadow-md"><h3 className="font-semibold text-teal-600">Allen Alternative</h3><p className="text-sm text-gray-600">Full switch from Allen</p></Link>
            <Link href="/complement-aakash-coaching-gurugram" className="bg-gray-50 p-4 rounded-xl hover:shadow-md"><h3 className="font-semibold text-teal-600">Complement Aakash</h3><p className="text-sm text-gray-600">For Aakash students</p></Link>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-blue-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">Join 200+ Allen students who complement their coaching with Cerebrum</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/demo-booking"><Button variant="secondary" size="xl" className="bg-white text-blue-600 hover:bg-gray-100 font-bold"><Play className="w-5 h-5 mr-2" />Book Free Trial</Button></Link>
