...
export const metadata: Metadata = {
  ...
  description: 'Experience the future of Biology education with our AI-powered tutoring system. 24/7 doubt resolution, personalized assessments, and intelligent study materials.',
  keywords: [
    'AI tutoring',
    'Biology education',
    'NEET preparation',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-800 max-w-3xl mx-auto font-medium">
              Experience the most advanced AI tutoring system designed specifically for Biology education.
              From doubt resolution to performance prediction, everything is powered by cutting-edge AI.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Instant doubt resolution with detailed explanations, diagrams, and mnemonics',
                features: [
              ...
              },
              {
                ...
                description: 'ML-powered predictions for exam success and personalized study plans',
                features: [
      ...
      <section className="bg-gradient-to-br from-gray-50 to-blue-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { metric: '40%', label: 'Increased Engagement', description: 'Students spend more time learning' },
              { metric: '25%', label: 'Faster Learning', description: 'Accelerated concept mastery' },
              { metric: '94.2%', label: 'Success Rate', description: 'NEET qualification rate' },
              { metric: '<2min', label: 'Response Time', description: 'Average doubt resolution' }
            ].map((stat, index) => (
