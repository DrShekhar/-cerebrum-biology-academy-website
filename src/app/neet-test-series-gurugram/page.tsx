...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/neet-test-series-gurugram',
  },

  twitter: {
    card: 'summary_large_image' as const,
    title: 'NEET Test Series in Gurugram | 50+ Mock Tests with Analysis',
    description: 'Join our comprehensive NEET Biology test series in Gurugram (Gurgaon). 50+ full-length mock tests, detailed analysis, rank prediction. Online and offline options. Starting ₹8,000.',
  },
}
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Yes, all tests are available both online and offline. Online tests can be taken from home with the same interface as the actual NEET exam. Offline tests are conducted at our Sector 51 center.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes! Our test series is available as a standalone product. Many students from the largest national NEET chain, the 2nd-largest national NEET chain, and other institutes join our test series for additional practice and analysis.',
  },
  {
...
export default function NEETTestSeriesGurugramPage() {
  const courseSchema = {
