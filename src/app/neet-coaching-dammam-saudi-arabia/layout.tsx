...
export const metadata: Metadata = {
  ...
  description:
    'Expert NEET coaching in Dammam, Saudi Arabia. 98% success rate, expert faculty, comprehensive study materials. Join 5000+ successful students.',
  keywords:
    'NEET coaching Dammam, NEET exam center Dammam, best NEET classes Dammam, NEET preparation Saudi Arabia',
  openGraph: {
    title: 'NEET Coaching in Dammam, Saudi Arabia | 98% Success Rate',
    description:
      'Premium NEET coaching center in Dammam. Dr. Shekhar C Singh & expert faculty. Start your medical journey today.',
