...
export const metadata: Metadata = {
  ...
  description:
    'RE-NEET 2026 coaching for Mumbai students (Andheri, Thane, Borivali) after the 12 May NEET cancellation. Online biology-only AIIMS-trained crash — alongside your Mahesh Tutorials / Aakash Mumbai / Allen main coaching.',
  keywords: [
    're-neet 2026 mumbai',
