...
export default function ChapterNotesContent({ chapter, slug }: ChapterNotesContentProps) {
    ...
    topics: [
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded space-y-3">
              <div>
                ...
                <p className="text-sm text-gray-700 mt-1">
                  Used <strong>Streptococcus pneumoniae</strong> bacteria. Identified the
                  "transforming principle" that could transfer genetic information from dead smooth
                  strain (S) to live rough strain (R), making R pathogenic.
                </p>
              ...
              <div>
                ...
                <p className="text-sm text-gray-700 mt-1">
                  Proved that <strong>DNA</strong> (not protein) is the transforming principle by
                  using enzymes that digested different molecules and testing transformation.
                </p>
                <p className="text-xs text-gray-600 mt-1 italic">
              ...
              <div>
                ...
                <p className="text-sm text-gray-700 mt-1">
                  Used <strong>T2 bacteriophages</strong> with radioactive labeling (³²P for DNA,
                  ³⁵S for protein). Proved that DNA, not protein, enters the bacterial cell during
                  infection and directs viral replication.
                </p>
                <p className="text-xs text-gray-600 mt-1 italic">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 p-4 rounded">
              <div className="space-y-3 text-sm">
                <p>
                  <strong>Structure:</strong> Double helix consisting of two antiparallel
                  polynucleotide chains
                </p>
                <p>
                  <strong>Components:</strong> Deoxyribose sugar, phosphate groups, and nitrogenous
                  bases (A, G, C, T)
                </p>
                <div className="bg-white p-3 rounded border border-blue-200">
                  ...
                  <ul className="space-y-1 text-xs text-gray-700">
                    <li>
                      • <strong>Pitch (Turn):</strong> 3.4 nm (10 bp per turn)
                    </li>
                    <li>
                      • <strong>Diameter:</strong> 2 nm
                    </li>
                    <li>
                      • <strong>Distance between bp:</strong> 0.34 nm
                    </li>
                  </ul>
                </div>
                <p>
                  <strong>Base Pairing:</strong> A-T (2 H-bonds), G-C (3 H-bonds) - Chargaff&apos;s
                  rules
                </p>
              </div>
            </div>
        ...
        content: (
          <div className="space-y-4">
            <p className="text-sm text-gray-700">
              DNA in eukaryotes is packaged with histone proteins into progressively higher order
              structures.
            </p>
            ...
            <div className="bg-purple-50 border border-purple-200 rounded p-4">
              ...
              <ol className="space-y-2 text-sm">
                <li>
                  <strong className="text-purple-700">1. Nucleosome:</strong> DNA wrapped around
                  histone octamer (~200 bp of DNA, 2 turns)
                </li>
                <li>
                  <strong className="text-purple-700">2. Chromatin Fiber (30 nm):</strong>{' '}
                  Beads-on-a-string structure with histone H1
                </li>
                <li>
                  <strong className="text-purple-700">3. Higher-order Loops:</strong> 300 nm fiber
                  formed by looping of chromatin fiber
                </li>
                <li>
                  <strong className="text-purple-700">4. Metaphase Chromosome:</strong> Condensed
                  chromatin (~1400 nm) visible under light microscope
                </li>
              </ol>
            </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-700">
              Each daughter DNA molecule contains one original strand and one newly synthesized
              strand.
            </p>
            ...
            <div className="bg-green-50 border border-green-200 rounded p-4">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li>
                  • Used <strong>¹⁵N</strong> (heavy) and <strong>¹⁴N</strong> (light) nitrogen
                  isotopes to label DNA
                </li>
                <li>• After 1st replication: Hybrid DNA (¹⁵N-¹⁴N) - hybrid density</li>
                <li>• After 2nd replication: 50% hybrid DNA + 50% light DNA (¹⁴N-¹⁴N)</li>
                <li>
            ...
            <h4 className="font-semibold text-lg text-blue-900 mt-4">
              Enzymes and Proteins Involved
            </h4>
            <div className="space-y-2 text-sm">
              <div className="bg-gray-50 p-2 rounded border border-gray-200">
                <strong className="text-gray-900">DNA Helicase:</strong> Unwinds double helix,
                breaks hydrogen bonds
              </div>
              <div className="bg-gray-50 p-2 rounded border border-gray-200">
                <strong className="text-gray-900">Primase:</strong> Synthesizes RNA primers to
                initiate DNA synthesis
              </div>
              <div className="bg-gray-50 p-2 rounded border border-gray-200">
                <strong className="text-gray-900">DNA Polymerase III:</strong> Main enzyme for DNA
                synthesis (3&apos; to 5&apos;), has 3D exonuclease activity (proofreading)
              </div>
              <div className="bg-gray-50 p-2 rounded border border-gray-200">
                <strong className="text-gray-900">DNA Polymerase I:</strong> Removes RNA primers and
                fills gaps
              </div>
              <div className="bg-gray-50 p-2 rounded border border-gray-200">
                <strong className="text-gray-900">DNA Ligase:</strong> Forms phosphodiester bonds
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-sm text-gray-700">
              Process of synthesizing RNA from DNA template. Occurs in nucleus (eukaryotes) and
            ...
            <div className="space-y-2">
              <div className="bg-cyan-50 border-l-4 border-cyan-500 p-3 rounded">
                ...
                <p className="text-sm text-gray-700 mt-1">
                  RNA Polymerase II recognizes promoter (TATA box at -25), binds with transcription
                  factors, DNA unwinds
                </p>
              </div>
              <div className="bg-teal-50 border-l-4 border-teal-500 p-3 rounded">
                ...
                <p className="text-sm text-gray-700 mt-1">
                  RNA polymerase moves along template strand (3&apos; to 5&apos;), adds
                  complementary RNA nucleotides (5&apos; to 3&apos;)
                </p>
              </div>
              <div className="bg-emerald-50 border-l-4 border-emerald-500 p-3 rounded">
                ...
                <p className="text-sm text-gray-700 mt-1">
                  RNA polymerase reaches termination signal (AATAAA in eukaryotes), transcript is
                  released
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2 text-sm">
              <div className="bg-pink-50 p-2 rounded border border-pink-200">
                <strong className="text-pink-900">5&apos; Capping:</strong> Addition of
                7-methylguanosine cap (m7G) - protection, translation initiation
              </div>
              <div className="bg-pink-50 p-2 rounded border border-pink-200">
                <strong className="text-pink-900">3&apos; Polyadenylation:</strong> Addition of ~200
                adenine nucleotides (poly-A tail) - stability, translation, export
              </div>
              <div className="bg-pink-50 p-2 rounded border border-pink-200">
                <strong className="text-pink-900">Splicing:</strong> Removal of introns and joining
                of exons by snRNPs in spliceosome
              </div>
            </div>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-sm text-gray-700">
              Process of synthesizing protein from mRNA template. Occurs on ribosomes (80S in
              eukaryotes, 70S in prokaryotes).
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="bg-purple-50 border border-purple-200 p-3 rounded text-sm">
                ...
                <p className="text-gray-700">
                  64 codons for 20 amino acids (multiple codons per amino acid)
                </p>
              </div>
              <div className="bg-purple-50 border border-purple-200 p-3 rounded text-sm">
                <p className="font-bold text-purple-900 mb-2">Universal:</p>
                <p className="text-gray-700">
                  Same across most organisms (with rare exceptions in mitochondria)
                </p>
              </div>
              <div className="bg-purple-50 border border-purple-200 p-3 rounded text-sm">
            ...
            <div className="bg-green-50 border border-green-200 p-3 rounded">
              ...
              <p className="text-sm mt-1">
                <strong className="text-green-900">Stop codons:</strong> UAA (Ochre), UAG (Amber),
                UGA (Opal)
              </p>
            </div>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded p-4 space-y-3">
              <p className="text-sm text-gray-700">
                Clover-leaf secondary structure, L-shaped tertiary structure. Contains anticodon and
              ...
              <div className="bg-white p-2 rounded border border-orange-200 text-xs">
                ...
                <p className="text-gray-700">
                  3rd position of codon pairs with 1st position of anticodon loosely (Crick&apos;s
                  Wobble Hypothesis) - explains degeneracy of genetic code
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2 text-sm">
              <div className="bg-indigo-50 p-2 rounded border border-indigo-200">
                <strong className="text-indigo-900">Eukaryotic Ribosome (80S):</strong> 60S (large)
                + 40S (small) subunits
              </div>
              <div className="bg-indigo-50 p-2 rounded border border-indigo-200">
                <strong className="text-indigo-900">Prokaryotic Ribosome (70S):</strong> 50S (large)
                + 30S (small) subunits
              </div>
              <div className="bg-indigo-50 p-2 rounded border border-indigo-200">
                <strong className="text-indigo-900">Sites on Ribosome:</strong> A (Aminoacyl), P
                (Peptidyl), E (Exit)
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="bg-sky-50 border-l-4 border-sky-500 p-3 rounded">
                ...
                <p className="text-sm text-gray-700 mt-1">
                  mRNA binds 40S ribosomal subunit, initiator tRNA (fMet-tRNA) binds AUG, 60S
                  subunit joins. Initiation complex forms with help of initiation factors.
                </p>
              </div>
              <div className="bg-blue-50 border-l-4 border-blue-500 p-3 rounded">
                <h5 className="font-bold text-blue-900">2. Elongation</h5>
                <p className="text-sm text-gray-700 mt-1">
                  Aminoacyl-tRNA enters A site, peptide bond forms between P and A site tRNAs,
                  ribosome translocates. Repeats until stop codon.
                </p>
              </div>
              <div className="bg-slate-50 border-l-4 border-slate-500 p-3 rounded">
                <h5 className="font-bold text-slate-900">3. Termination</h5>
                <p className="text-sm text-gray-700 mt-1">
                  Stop codon recognized by release factors, polypeptide chain released, ribosomal
                  subunits dissociate from mRNA.
                </p>
              </div>
            </div>
          </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-sm text-gray-700">
              Classical example of prokaryotic gene regulation in E. coli. Demonstrates inducible
              enzyme system.
            </p>
            ...
            <div className="bg-rose-50 border border-rose-200 rounded p-4">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li>
                  <strong className="text-rose-700">Structural Genes:</strong> lacZ
                  (β-galactosidase), lacY (permease), lacA (transacetylase)
                </li>
                <li>
                  <strong className="text-rose-700">Regulatory Gene:</strong> lacI (repressor
                  protein)
                </li>
                <li>
            ...
            <div className="bg-amber-50 border border-amber-200 p-3 rounded text-sm">
              ...
              <p className="text-gray-700">
                In low glucose, cAMP-CAP complex helps RNA polymerase bind promoter efficiently,
          ...
          <div className="space-y-4">
            <div className="bg-green-50 border border-green-200 rounded p-4">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                ...
                <li>
                  <strong className="text-green-700">Human DNA:</strong> ~3 billion base pairs, 46
                  chromosomes
                </li>
                <li>
                  <strong className="text-green-700">Genes:</strong> ~20,000-25,000 protein-coding
                  genes
                </li>
                <li>
                  <strong className="text-green-700">Techniques:</strong> Restriction mapping, DNA
                  sequencing, chromosome walking
                </li>
              </ul>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded p-4 space-y-2 text-sm">
              <p>
                ...
                <br />
                ✓ Understanding gene mutations and variations
                <br />✓ Discovery of single nucleotide polymorphisms (SNPs)
              </p>
            </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-sm text-gray-700">
              Technique for identification using highly variable regions of DNA (Variable Number
              Tandem Repeats).
            </p>
            ...
            <div className="bg-indigo-50 border border-indigo-200 rounded p-4">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li>
                  • Repetitive DNA sequences (10-100 bp repeats) that vary in number between
                  individuals
                </li>
                <li>• Located at multiple loci on different chromosomes</li>
                <li>• Highly polymorphic - useful for identification</li>
              </ul>
            </div>
            ...
            <ol className="space-y-2 text-sm">
              <li className="bg-orange-50 border-l-4 border-orange-500 p-2 pl-3">
                <strong className="text-orange-900">1. DNA Extraction:</strong> From blood, saliva,
                hair, semen
              </li>
              <li className="bg-yellow-50 border-l-4 border-yellow-500 p-2 pl-3">
                <strong className="text-yellow-900">2. Restriction Digestion:</strong> Cut DNA with
                restriction enzymes at VNTR sites
              </li>
              <li className="bg-lime-50 border-l-4 border-lime-500 p-2 pl-3">
                <strong className="text-lime-900">3. Gel Electrophoresis:</strong> Separate DNA
                fragments by size
              </li>
              <li className="bg-green-50 border-l-4 border-green-500 p-2 pl-3">
                <strong className="text-green-900">4. Southern Blotting:</strong> Transfer to
                nitrocellulose/nylon membrane
              </li>
              <li className="bg-blue-50 border-l-4 border-blue-500 p-2 pl-3">
                <strong className="text-blue-900">5. Probe Hybridization:</strong>{' '}
                Radiolabeled/fluorescent VNTR probe binds to complementary sequences
              </li>
              <li className="bg-indigo-50 border-l-4 border-indigo-500 p-2 pl-3">
                <strong className="text-indigo-900">6. Detection:</strong> Autoradiography shows
                band pattern (DNA fingerprint)
              </li>
            </ol>
    ...
    topics: [
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-blue-50 to-cyan-50 border-2 border-blue-400 rounded p-4">
              <p className="text-sm text-gray-700 mb-3">
                Based on Mendel&apos;s experiments with <strong>Pisum sativum</strong> (garden pea
                plant) across 7 traits
              </p>
            </div>
            ...
            <div className="bg-orange-50 border border-orange-200 p-4 rounded space-y-2 text-sm">
              <p className="font-bold text-orange-900">
                When two contrasting alleles present, dominant trait expresses in F1.
              </p>
              <p className="text-gray-700">
                <strong>Example:</strong> Tall (T) × Short (t) → F1 all Tall (Tt shows dominance of
                T over t)
              </p>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 p-4 rounded space-y-2 text-sm">
              <p className="font-bold text-green-900">
                Allelic pairs segregate during gamete formation; each gamete receives only one
                allele.
              </p>
              <p className="text-gray-700">
                <strong>Example:</strong> F1 (Tt) × F1 (Tt) → F2 (1 TT : 2 Tt : 1 tt) = 3 Dominant :
                1 Recessive
              </p>
            </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 p-3 rounded text-sm">
              <p className="font-bold text-yellow-900 mb-1">
                Mnemonic - Mendel&apos;s 7 Traits Studied:
              </p>
              <p className="text-gray-700">
                Seed color, Seed shape, Flower color, Flower position, Pod color, Pod shape, Plant
                height
              </p>
            </div>
          </div>
        ...
        content: (
          <div className="space-y-4">
            ...
            <div className="bg-cyan-50 border border-cyan-200 rounded p-4 space-y-3 text-sm">
              <p>
                More than two alleles of a gene exist in a population. Individual has maximum 2
                (diploid).
              </p>
            ...
            <div className="bg-lime-50 border border-lime-200 rounded p-4 space-y-3 text-sm">
              <p>One gene affects multiple, often unrelated, characters (pleiotrophic effects).</p>
              <p className="font-bold text-lime-900">Example - Phenylketonuria (PKU):</p>
              <p className="text-gray-700">
                Single gene mutation → affects amino acid metabolism → causes intellectual
                disability, light skin color, musty odor
              </p>
              <p className="font-bold text-lime-900 mt-2">Example - White eye in Drosophila:</p>
              <p className="text-gray-700">White eyes, reduced sperm count, shortened lifespan</p>
            </div>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-sm text-gray-700">
              Deviation from Mendel&apos;s Law of Independent Assortment when genes are located on
              same chromosome.
            </p>
            ...
            <div className="bg-purple-50 border border-purple-200 rounded p-4 space-y-3">
              <p className="text-sm text-gray-700">
                Genes on same chromosome tend to be inherited together. Distance between genes
                determines likelihood of separation.
              </p>
              <div className="bg-white p-3 rounded border border-purple-200 text-sm">
                ...
                <p className="text-gray-700">
                  <strong>Map Unit (centimorgan):</strong> 1% recombination frequency = 1 map unit =
                  1 cM
                </p>
              </div>
            </div>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded p-4 space-y-3 text-sm">
              <p>
                <strong>Organism:</strong> Fruit fly (Drosophila melanogaster) - small size, short
                life cycle, easily observed mutations
              </p>
              <p>
            ...
            <div className="bg-emerald-50 border border-emerald-200 rounded p-4 space-y-3 text-sm">
              <p>
                Exchange of genetic material between homologous chromosomes during prophase I of
                meiosis.
              </p>
              ...
              <p className="text-gray-700">
                Uses three linked genes to determine gene order and distances; identifies
        ...
        content: (
          <div className="space-y-4">
            ...
            <div className="bg-indigo-50 border border-indigo-200 p-3 rounded text-sm mt-4">
              ...
              <p className="text-gray-700">
                Y chromosome carries testis-determining factor (TDF/SRY gene) → male development.
                Without Y chromosome → female development (default pathway)
              </p>
            </div>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-sm text-gray-700">
              Genes located on sex chromosomes (X or Y) show inheritance patterns different from
              autosomal genes.
            </p>
            ...
            <div className="bg-red-50 border border-red-200 rounded p-4 space-y-3">
              <p className="text-sm text-gray-700">
                <strong>Genotype:</strong> X^B X^B or X^B X^b (female normal), X^b X^b (female
                colour blind), X^B Y (male normal), X^b Y (male colour blind)
              </p>
              <p className="text-sm text-gray-700">
                <strong>Type:</strong> Recessive, X-linked
              </p>
              <p className="text-sm text-gray-700">
                <strong>Key Point:</strong> More common in males (hemizygous) than females (must be
                homozygous)
              </p>
              <div className="bg-white p-2 rounded border border-red-200 text-sm">
                <p className="font-bold text-red-900 mb-1">
                  Cross Example: Normal female (X^B X^b) × Colour blind male (X^b Y)
                </p>
                <p className="text-gray-700 text-xs mt-1">
                  Offspring: 25% X^B X^b (carrier female), 25% X^b X^b (colour blind female), 25%
                  X^B Y (normal male), 25% X^b Y (colour blind male)
                </p>
              </div>
            </div>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded p-4 space-y-3">
              <p className="text-sm text-gray-700">
                <strong>Nature:</strong> Deficiency of clotting factors (VIII or IX), recessive
                X-linked disorder
              </p>
              <p className="text-sm text-gray-700">
                <strong>Genotypes:</strong> X^H X^H, X^H X^h (female normal/carrier), X^h X^h
                (female affected), X^H Y (male normal), X^h Y (male affected)
              </p>
              <p className="text-sm text-gray-700">
                <strong>Historical Note:</strong> Queen Victoria was carrier; spread through
            ...
            <div className="bg-yellow-50 border border-yellow-200 p-3 rounded text-sm mt-4">
              ...
              <p className="text-gray-700">
                X-linked recessive traits skip generations, showing pattern: affected male → carrier
                female → affected male in next generation
              </p>
            </div>
          </div>
        ),
          ...
          <div className="space-y-4">
            ...
            <div className="bg-pink-50 border border-pink-200 rounded p-4 space-y-2 text-sm">
              ...
              <div className="flex items-center gap-2">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'linear-gradient(45deg, transparent 40%, gray 40%, gray 60%, transparent 60%)',
                  }}
                ></div>
            ...
            <div className="space-y-3 text-sm">
              <div className="bg-green-50 border border-green-200 p-3 rounded">
                ...
                <p className="text-gray-700">
                  Affected individuals in every generation, both males and females equally, appears
                  in both parents of affected person
                </p>
              </div>
              <div className="bg-blue-50 border border-blue-200 p-3 rounded">
                <p className="font-bold text-blue-900">Autosomal Recessive:</p>
                <p className="text-gray-700">
                  Skips generations, both males and females equally affected, parents usually
                  carriers (unaffected)
                </p>
              </div>
              <div className="bg-purple-50 border border-purple-200 p-3 rounded">
                ...
                <p className="text-gray-700">
                  More males affected, criss-cross pattern, carrier mothers have affected sons,
          ...
          <div className="space-y-4">
            ...
            <div className="bg-red-50 border border-red-200 rounded p-4 space-y-3">
              ...
              <div className="space-y-2 text-sm text-gray-700">
                ...
                <p>
                  <strong>Symptoms:</strong> Intellectual disability, flat face, short stature,
                  characteristic palm crease, congenital heart defects
                </p>
                <p>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded p-4 space-y-3">
              ...
              <div className="space-y-2 text-sm text-gray-700">
                ...
                <p>
                  <strong>Symptoms:</strong> Short stature, streak gonads (infertile), webbed neck,
                  cardiovascular abnormalities, intellectual disability mild to moderate
                </p>
                <p>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded p-4 space-y-3">
              ...
              <div className="space-y-2 text-sm text-gray-700">
                ...
                <p>
                  <strong>Symptoms:</strong> Tall stature, small testes, reduced testosterone,
                  infertility (azoospermia), gynecomastia (breast development)
                </p>
                <p>
            ...
            <div className="space-y-2 text-sm">
              <div className="bg-purple-50 p-2 rounded border border-purple-200">
                <strong className="text-purple-900">Deletion:</strong> Loss of chromosome segment
                (loss of genes)
              </div>
              <div className="bg-purple-50 p-2 rounded border border-purple-200">
                <strong className="text-purple-900">Duplication:</strong> Repetition of chromosome
                segment (extra gene copies)
              </div>
              <div className="bg-purple-50 p-2 rounded border border-purple-200">
                <strong className="text-purple-900">Inversion:</strong> Reversal of chromosome
                segment (gene order changed)
              </div>
              <div className="bg-purple-50 p-2 rounded border border-purple-200">
                <strong className="text-purple-900">Translocation:</strong> Transfer of segment to
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-sm text-gray-700">
              Genetic disorders following Mendelian inheritance patterns due to single gene
              mutations.
            </p>
            ...
            <div className="bg-red-50 border border-red-200 rounded p-4 space-y-3">
              ...
              <div className="space-y-2 text-sm text-gray-700">
                ...
                <p className="mt-2">
                  <strong>Result:</strong> Hemoglobin polymerizes under low oxygen → RBCs become
                  sickle-shaped → hemolysis, pain, organ damage
                </p>
                <p className="mt-2">
                  <strong>Geographic Note:</strong> Common in Africa, Mediterranean, Middle East
            ...
            <div className="bg-blue-50 border border-blue-200 rounded p-4 space-y-3">
              ...
              <div className="space-y-2 text-sm text-gray-700">
                ...
                <p>
                  <strong>Biochemistry:</strong> Phenylalanine cannot be converted to tyrosine →
                  accumulates in blood and tissues
                </p>
                <p>
                  <strong>Symptoms:</strong> Intellectual disability (if untreated), light skin,
                  blonde hair, characteristic "mousy" odor of sweat/urine
                </p>
                <p>
                  <strong>Treatment:</strong> Phenylalanine-restricted diet from infancy → normal
            ...
            <div className="bg-purple-50 border border-purple-200 rounded p-4 space-y-3">
              ...
              <div className="space-y-2 text-sm text-gray-700">
                ...
                <p>
                  <strong>Mutation:</strong> Defects in α or β-globin genes (β-thalassemia more
                  common)
                </p>
                <p>
                  <strong>Result:</strong> Reduced or absent hemoglobin production → hemolytic
                  anemia, splenomegaly, facial bone deformities
                </p>
                <p>
    ...
    topics: [
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded space-y-3">
              <div>
                ...
                <p className="text-sm text-gray-700 mt-1">
                  The alimentary canal is a continuous muscular tube (~9 metres) running from the{' '}
                  <strong>mouth to the anus</strong>. It includes the buccal cavity, pharynx,
                  oesophagus, stomach, small intestine (duodenum, jejunum, ileum), large intestine
              ...
              <div>
                ...
                <p className="text-sm text-gray-700 mt-1">
                  <strong>Salivary glands</strong> (parotid, sublingual, submandibular) secrete
                  saliva with <strong>salivary amylase</strong> (pH 6.8). <strong>Liver</strong> is
                  the largest gland, secretes bile (no enzymes, emulsifies fats).{' '}
                  <strong>Pancreas</strong> is a mixed gland secreting pancreatic juice with
                  trypsinogen, chymotrypsinogen, lipase, amylase, and nucleases.
                </p>
              </div>
            </div>
              ...
              <table className="min-w-full text-xs border border-gray-200 rounded">
                ...
                <tbody>
                  <tr className="border-t">
                    <td className="px-3 py-2">Mouth</td>
                    <td className="px-3 py-2">Salivary amylase</td>
                    <td className="px-3 py-2">Starch</td>
                    <td className="px-3 py-2">Maltose</td>
                    <td className="px-3 py-2">6.8</td>
                  </tr>
                  <tr className="border-t bg-gray-50">
                    <td className="px-3 py-2">Stomach</td>
                    <td className="px-3 py-2">Pepsin</td>
                    <td className="px-3 py-2">Proteins</td>
                    <td className="px-3 py-2">Peptones</td>
                    <td className="px-3 py-2">1.8</td>
                  </tr>
                  <tr className="border-t">
                    <td className="px-3 py-2">Duodenum</td>
                    <td className="px-3 py-2">Trypsin</td>
                    <td className="px-3 py-2">Proteins</td>
                    <td className="px-3 py-2">Peptides</td>
                    <td className="px-3 py-2">7.8</td>
                  </tr>
                  <tr className="border-t bg-gray-50">
                    <td className="px-3 py-2">Duodenum</td>
                    <td className="px-3 py-2">Pancreatic lipase</td>
                    <td className="px-3 py-2">Fats</td>
                    <td className="px-3 py-2">Fatty acids + Glycerol</td>
                    <td className="px-3 py-2">7.8</td>
                  </tr>
                  <tr className="border-t">
                    <td className="px-3 py-2">Intestine</td>
                    <td className="px-3 py-2">Maltase, Lactase, Sucrase</td>
                    <td className="px-3 py-2">Disaccharides</td>
                    <td className="px-3 py-2">Monosaccharides</td>
                    <td className="px-3 py-2">7.8</td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="bg-green-50 border border-green-200 p-3 rounded text-sm mt-4">
              ...
              <ul className="text-gray-700 space-y-1 text-xs">
                <li>
                  &#8226; <strong>Small intestine</strong> is the principal site of absorption
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded space-y-3">
              <div>
                ...
                <p className="text-sm text-gray-700 mt-1">
                  Consists of nostrils, nasal passages, pharynx, larynx, trachea, bronchi,
                  bronchioles, and <strong>alveoli</strong> (about 300 million per lung). Lungs are
                  covered by a double-layered <strong>pleural membrane</strong> with pleural fluid
                  between them.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-gray-700 mt-1">
                  <strong>Inspiration</strong>: Diaphragm contracts (flattens) + external
                  intercostal muscles contract → thoracic volume increases → intrapulmonary pressure
                  decreases → air rushes in.
                  <strong> Expiration</strong>: Diaphragm relaxes (dome-shaped) + internal
                  intercostal muscles contract → thoracic volume decreases → air is expelled.
                </p>
              </div>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full text-xs border border-gray-200 rounded">
                ...
                <tbody>
                  <tr className="border-t">
                    <td className="px-3 py-2 font-bold">Tidal Volume (TV)</td>
                    <td className="px-3 py-2">500 mL</td>
                    <td className="px-3 py-2">Air inhaled/exhaled in normal breathing</td>
                  </tr>
                  <tr className="border-t bg-gray-50">
                    <td className="px-3 py-2 font-bold">IRV</td>
                    <td className="px-3 py-2">2500-3000 mL</td>
                    <td className="px-3 py-2">Extra air inhaled after normal inspiration</td>
                  </tr>
                  <tr className="border-t">
                    <td className="px-3 py-2 font-bold">ERV</td>
                    <td className="px-3 py-2">1000-1100 mL</td>
                    <td className="px-3 py-2">Extra air exhaled after normal expiration</td>
                  </tr>
                  <tr className="border-t bg-gray-50">
                    <td className="px-3 py-2 font-bold">Residual Volume (RV)</td>
                    <td className="px-3 py-2">1100-1200 mL</td>
                    <td className="px-3 py-2">Air remaining after forceful expiration</td>
                  </tr>
                  <tr className="border-t">
                    <td className="px-3 py-2 font-bold">Vital Capacity (VC)</td>
                    <td className="px-3 py-2">3400-4800 mL</td>
                    <td className="px-3 py-2">TV + IRV + ERV</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 p-3 rounded text-sm">
              ...
              <ul className="text-gray-700 space-y-1 text-xs">
                <li>
                  &#8226; ~97% bound to <strong>haemoglobin</strong> as oxyhaemoglobin (HbO&#8322;)
                </li>
                <li>&#8226; ~3% dissolved in plasma</li>
                <li>
                  &#8226; Each Hb binds 4 O&#8322; molecules (cooperative binding = sigmoidal curve)
                </li>
                <li>
                  &#8226; Factors shifting O&#8322; dissociation curve RIGHT: &#8593;pCO&#8322;,
                  &#8593;H&#8314;, &#8593;temp (Bohr effect)
                </li>
              </ul>
            ...
            <div className="bg-purple-50 border border-purple-200 p-3 rounded text-sm mt-3">
              <p className="font-bold text-purple-900">
                Mnemonic: "70-23-7" for CO&#8322; transport
              </p>
              <p className="text-xs text-gray-700">
                70% bicarbonate, 23% carbaminohaemoglobin, 7% dissolved
              </p>
            </div>
            <p className="text-xs text-gray-600 italic">
              PYQ Pattern: Lung volume calculations, O&#8322; dissociation curve, Bohr effect,
              chloride shift
            </p>
          </div>
        ),
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded space-y-3">
              <div>
                ...
                <p className="text-sm text-gray-700 mt-1">
                  Blood is a connective tissue (~5-5.5 litres in adults). It consists of{' '}
                  <strong>plasma</strong> (~55%) and <strong>formed elements</strong> (~45%). Plasma
                  contains water (90-92%), proteins (albumin, globulin, fibrinogen), and minerals.
                </p>
              </div>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full text-xs border border-gray-200 rounded">
                ...
                <tbody>
                  <tr className="border-t">
                    <td className="px-3 py-2 font-bold">RBCs</td>
                    <td className="px-3 py-2">5-5.5 million/mm&#179;</td>
                    <td className="px-3 py-2">O&#8322; transport</td>
                    <td className="px-3 py-2">Enucleated, biconcave, 120-day lifespan</td>
                  </tr>
                  <tr className="border-t bg-gray-50">
                    <td className="px-3 py-2 font-bold">WBCs</td>
                    <td className="px-3 py-2">6000-8000/mm&#179;</td>
                    <td className="px-3 py-2">Defence and immunity</td>
                    <td className="px-3 py-2">Nucleated, 5 types (N,E,B,L,M)</td>
                  </tr>
                  <tr className="border-t">
                    <td className="px-3 py-2 font-bold">Platelets</td>
                    <td className="px-3 py-2">1.5-3.5 lakh/mm&#179;</td>
                    <td className="px-3 py-2">Blood clotting</td>
                    <td className="px-3 py-2">Cell fragments, no nucleus</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded space-y-3">
              <div>
                ...
                <p className="text-sm text-gray-700 mt-1">
                  Four-chambered heart (2 atria + 2 ventricles). <strong>Left ventricle</strong> has
                  the thickest wall (pumps blood to the entire body). Valves prevent backflow:{' '}
                  <strong>tricuspid</strong> (right AV), <strong>bicuspid/mitral</strong> (left AV),
                  and two semilunar valves (pulmonary and aortic).
                </p>
              </div>
              <div>
                <h5 className="font-bold text-red-900">Cardiac Cycle (~0.8 seconds)</h5>
                <p className="text-sm text-gray-700 mt-1">
                  <strong>Atrial systole</strong> (0.1s) → <strong>Ventricular systole</strong>{' '}
                  (0.3s) → <strong>Joint diastole</strong> (0.4s). Cardiac output = Stroke volume x
                  Heart rate = ~70 mL x 72 = ~5040 mL/min (~5 litres/min).
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-gray-700 mt-1">
                  <strong>SA node</strong> (pacemaker) generates ~72 impulses/min. Located in the
                  right atrial wall. The heart is <strong>myogenic</strong> (impulse originates from
                  muscle itself, not nerve).
                </p>
              </div>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 p-3 rounded text-sm">
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full text-xs border border-gray-200 rounded mt-1">
                  ...
                  <tbody>
                    <tr className="border-t">
                      <td className="px-2 py-1 font-bold">A</td>
                      <td className="px-2 py-1">A</td>
                      <td className="px-2 py-1">Anti-B</td>
                      <td className="px-2 py-1">A, AB</td>
                      <td className="px-2 py-1">A, O</td>
                    </tr>
                    <tr className="border-t bg-gray-50">
                      <td className="px-2 py-1 font-bold">B</td>
                      <td className="px-2 py-1">B</td>
                      <td className="px-2 py-1">Anti-A</td>
                      <td className="px-2 py-1">B, AB</td>
                      <td className="px-2 py-1">B, O</td>
                    </tr>
                    <tr className="border-t">
                      <td className="px-2 py-1 font-bold">AB</td>
                      <td className="px-2 py-1">A &amp; B</td>
                      <td className="px-2 py-1">None</td>
                      <td className="px-2 py-1">AB only</td>
                      <td className="px-2 py-1">All (universal acceptor)</td>
                    </tr>
                    <tr className="border-t bg-gray-50">
                      <td className="px-2 py-1 font-bold">O</td>
                      <td className="px-2 py-1">None</td>
                      <td className="px-2 py-1">Anti-A &amp; Anti-B</td>
                      <td className="px-2 py-1">All (universal donor)</td>
                      <td className="px-2 py-1">O only</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <p className="text-gray-700 mt-2 text-xs">
                <strong>Rh factor:</strong> Rh+ (antigen present) vs Rh- (absent). Erythroblastosis
                fetalis occurs when Rh- mother carries Rh+ foetus (second pregnancy onward).
              </p>
            </div>
            <p className="text-xs text-gray-600 italic">
              PYQ Pattern: Cardiac cycle timings, SA node function, blood group compatibility, ECG
              wave interpretation
            </p>
          </div>
        ),
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded space-y-3">
              <div>
                ...
                <p className="text-sm text-gray-700 mt-1">
                  Consists of a pair of <strong>kidneys</strong> (bean-shaped, ~11 cm), ureters,
                  urinary bladder, and urethra. Each kidney has an outer <strong>cortex</strong> and
                  inner <strong>medulla</strong> with renal pyramids. The functional unit is the{' '}
                  <strong>nephron</strong> (about 1 million per kidney).
                </p>
              </div>
              <div>
                <h5 className="font-bold text-blue-900">Types of Nephrons</h5>
                <p className="text-sm text-gray-700 mt-1">
                  <strong>Cortical nephrons</strong> (~85%): Short loop of Henle, in cortex.{' '}
                  <strong>Juxtamedullary nephrons</strong> (~15%): Long loop of Henle extending deep
                  into medulla, essential for concentrating urine.
                </p>
              </div>
            </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 p-3 rounded text-sm">
              ...
              <div className="space-y-2 text-xs text-gray-700">
                <div className="bg-white p-2 rounded border border-yellow-100">
                  <p>
                    <strong>1. Glomerular Filtration (Ultrafiltration)</strong>
                  </p>
                  <p>
                    Blood filtered in <strong>Bowman&#39;s capsule</strong> under high pressure. GFR
                    = ~125 mL/min (~180 L/day). Filters all plasma components except proteins and
                    blood cells.
                  </p>
                </div>
                <div className="bg-white p-2 rounded border border-yellow-100">
                  <p>
                    <strong>2. Tubular Reabsorption</strong>
                  </p>
                  <p>
                    ~99% of filtrate reabsorbed. PCT: glucose, amino acids, Na&#8314;,
                    HCO&#8323;&#8315; (obligatory reabsorption). Loop of Henle: countercurrent
                    mechanism. DCT &amp; CD: facultative reabsorption (ADH-dependent).
                  </p>
                </div>
                <div className="bg-white p-2 rounded border border-yellow-100">
                  <p>
                    <strong>3. Tubular Secretion</strong>
                  </p>
                  <p>
                    H&#8314;, K&#8314;, urea, and certain drugs secreted from peritubular
                    capillaries into tubular fluid. Helps maintain blood pH and ionic balance.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-indigo-50 border border-indigo-200 p-3 rounded text-sm">
              ...
              <p className="text-xs text-gray-700">
                The <strong>loop of Henle</strong> and <strong>vasa recta</strong> operate as a
                countercurrent system. The descending limb is permeable to water but not NaCl. The
                ascending limb is impermeable to water but actively transports NaCl out. This
                creates a hyperosmotic medullary interstitium (300 to 1200 mOsmol/L), allowing water
                reabsorption from collecting ducts under ADH influence.
              </p>
            </div>
            ...
            <div className="bg-purple-50 border border-purple-200 p-3 rounded text-sm mt-3">
              ...
              <ul className="text-gray-700 space-y-1 text-xs">
                <li>
                  &#8226; <strong>ADH (Vasopressin)</strong>: Increases water reabsorption in DCT
                  and collecting duct
                </li>
                <li>
                  &#8226; <strong>Aldosterone</strong>: Increases Na&#8314; reabsorption in DCT
                  (RAAS pathway)
                </li>
                <li>
                  &#8226; <strong>ANF (Atrial Natriuretic Factor)</strong>: Decreases Na&#8314;
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <h4 className="font-semibold text-lg text-blue-900">
              Types of Muscles and Skeletal System
            </h4>
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded space-y-3">
              <div>
                ...
                <div className="overflow-x-auto mt-2">
                  <table className="min-w-full text-xs border border-gray-200 rounded">
                    ...
                    <tbody>
                      <tr className="border-t">
                        <td className="px-2 py-1">Striation</td>
                        <td className="px-2 py-1">Striated</td>
                        <td className="px-2 py-1">Non-striated</td>
                        <td className="px-2 py-1">Striated</td>
                      </tr>
                      <tr className="border-t bg-gray-50">
                        <td className="px-2 py-1">Control</td>
                        <td className="px-2 py-1">Voluntary</td>
                        <td className="px-2 py-1">Involuntary</td>
                        <td className="px-2 py-1">Involuntary</td>
                      </tr>
                      <tr className="border-t">
                        <td className="px-2 py-1">Nuclei</td>
                        <td className="px-2 py-1">Multinucleated</td>
                        <td className="px-2 py-1">Uninucleated</td>
                        <td className="px-2 py-1">Uninucleated</td>
                      </tr>
                      <tr className="border-t bg-gray-50">
                        <td className="px-2 py-1">Intercalated discs</td>
                        <td className="px-2 py-1">Absent</td>
                        <td className="px-2 py-1">Absent</td>
                        <td className="px-2 py-1">Present</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 p-3 rounded text-sm">
              ...
              <ol className="text-gray-700 space-y-1 text-xs list-decimal list-inside">
                <li>
                  Neural signal releases <strong>acetylcholine</strong> at neuromuscular junction
                </li>
                <li>Action potential spreads along sarcolemma and T-tubules</li>
                <li>
                  Ca&#178;&#8314; released from <strong>sarcoplasmic reticulum</strong>
                </li>
                <li>
                  Ca&#178;&#8314; binds troponin → tropomyosin shifts → exposes actin binding sites
                </li>
                <li>Myosin heads bind actin (cross-bridge formation) using ATP</li>
                <li>
                  <strong>Power stroke</strong>: Myosin pulls actin towards centre (A-band stays
                  same, I-band and H-zone narrow)
                </li>
            ...
            <div className="bg-green-50 border border-green-200 p-3 rounded text-sm">
              ...
              <ul className="text-gray-700 space-y-1 text-xs">
                <li>
                  &#8226; <strong>Axial skeleton</strong> (80 bones): Skull (22), Vertebral column
                  (26), Sternum (1), Ribs (24), Hyoid (1), Ear ossicles (6)
                </li>
                <li>
                  &#8226; <strong>Appendicular skeleton</strong> (126 bones): Pectoral girdle (4),
                  Upper limbs (60), Pelvic girdle (2), Lower limbs (60)
                </li>
                <li>
                  &#8226; Smallest bone: <strong>Stapes</strong> (middle ear)
                </li>
                <li>
                  &#8226; Longest bone: <strong>Femur</strong> (thigh)
                </li>
              </ul>
            </div>
            ...
            <div className="bg-indigo-50 border border-indigo-200 p-3 rounded text-sm mt-3">
              ...
              <ul className="text-gray-700 space-y-1 text-xs">
                <li>
                  &#8226; <strong>Fibrous (immovable)</strong>: Skull sutures
                </li>
                <li>
                  &#8226; <strong>Cartilaginous (slightly movable)</strong>: Vertebrae, pubic
                  symphysis
                </li>
                <li>
                  &#8226; <strong>Synovial (freely movable)</strong>: Ball-and-socket (hip,
                  shoulder), Hinge (knee, elbow), Pivot (atlas-axis), Gliding (wrist), Saddle
                  (thumb)
                </li>
              </ul>
            </div>
            <p className="text-xs text-gray-600 italic">
              PYQ Pattern: Sliding filament mechanism, sarcomere structure, types of joints, bone
              count
            </p>
          </div>
        ),
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded space-y-3">
              <div>
                ...
                <p className="text-sm text-gray-700 mt-1">
                  The structural and functional unit of the nervous system. Consists of{' '}
                  <strong>cell body</strong> (cyton), <strong>dendrites</strong> (receive impulses),
                  and <strong>axon</strong> (transmits impulses away from cell body). Axon is
                  covered by <strong>myelin sheath</strong> (Schwann cells in PNS, oligodendrocytes
                  in CNS) with gaps called <strong>Nodes of Ranvier</strong>.
                </p>
              </div>
              <div>
                <h5 className="font-bold text-blue-900">Nerve Impulse Transmission</h5>
                <p className="text-sm text-gray-700 mt-1">
                  <strong>Resting potential</strong>: -70 mV (inside negative due to
                  Na&#8314;/K&#8314; ATPase pump: 3 Na&#8314; out, 2 K&#8314; in).
                  <strong> Depolarisation</strong>: Na&#8314; channels open → Na&#8314; rushes in →
                  inside becomes +30 mV.
                  <strong> Repolarisation</strong>: K&#8314; channels open → K&#8314; moves out →
                  membrane returns to -70 mV.
                  <strong> Saltatory conduction</strong>: Impulse jumps between Nodes of Ranvier in
                  myelinated neurons (faster).
                </p>
              </div>
            </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 p-3 rounded text-sm">
              ...
              <p className="text-xs text-gray-700">
                When action potential reaches the <strong>synaptic knob</strong>, Ca&#178;&#8314;
                enters → synaptic vesicles fuse with presynaptic membrane →{' '}
                <strong>neurotransmitter</strong> (e.g. acetylcholine) released into synaptic cleft
                → binds receptors on postsynaptic membrane → new action potential generated.
                Neurotransmitter is then broken down by enzymes (e.g. acetylcholinesterase).
              </p>
            </div>
            ...
            <div className="bg-red-50 border border-red-200 p-3 rounded text-sm">
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full text-xs border border-gray-200 rounded mt-1">
                  ...
                  <tbody>
                    <tr className="border-t">
                      <td className="px-2 py-1 font-bold">Cerebrum</td>
                      <td className="px-2 py-1">Forebrain</td>
                      <td className="px-2 py-1">
                        Intelligence, memory, speech, voluntary movements, sensory processing
                      </td>
                    </tr>
                    <tr className="border-t bg-gray-50">
                      <td className="px-2 py-1 font-bold">Thalamus</td>
                      <td className="px-2 py-1">Forebrain</td>
                      <td className="px-2 py-1">
                        Relay station for sensory signals (except smell)
                      </td>
                    </tr>
                    <tr className="border-t">
                      <td className="px-2 py-1 font-bold">Hypothalamus</td>
                      <td className="px-2 py-1">Forebrain</td>
                      <td className="px-2 py-1">
                        Body temperature, hunger, thirst, circadian rhythms, pituitary control
                      </td>
                    </tr>
                    <tr className="border-t bg-gray-50">
                      <td className="px-2 py-1 font-bold">Cerebellum</td>
                      <td className="px-2 py-1">Hindbrain</td>
                      <td className="px-2 py-1">
                        Balance, posture, coordination of voluntary movements
                      </td>
                    </tr>
                    <tr className="border-t">
                      <td className="px-2 py-1 font-bold">Medulla oblongata</td>
                      <td className="px-2 py-1">Hindbrain</td>
                      <td className="px-2 py-1">
                        Breathing, heart rate, blood pressure, vomiting, swallowing
                      </td>
                    </tr>
                    <tr className="border-t bg-gray-50">
                      <td className="px-2 py-1 font-bold">Pons</td>
                      <td className="px-2 py-1">Hindbrain</td>
                      <td className="px-2 py-1">
                        Relay between cerebrum and cerebellum, sleep regulation
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="bg-green-50 border border-green-200 p-3 rounded text-sm mt-3">
              ...
              <p className="text-xs text-gray-700">
                <strong>
                  Receptor → Afferent (sensory) neuron → Integration centre (spinal cord) → Efferent
                  (motor) neuron → Effector (muscle/gland)
                </strong>
                . Reflex actions are involuntary, automatic responses. Example: knee-jerk reflex
                (monosynaptic), withdrawal reflex (polysynaptic).
              </p>
            </div>
            <p className="text-xs text-gray-600 italic">
              PYQ Pattern: Action potential mechanism, synapse transmission, brain parts and
              functions, reflex arc, cranial nerves
            </p>
          </div>
        ),
      },
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded space-y-3">
              <div>
                ...
                <p className="text-sm text-gray-700 mt-1">
                  Endocrine glands are ductless glands that secrete <strong>hormones</strong>{' '}
                  directly into the blood. Hormones act on specific <strong>target organs</strong>{' '}
                  via receptors. They regulate metabolism, growth, reproduction, and homeostasis.
                </p>
              </div>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full text-xs border border-gray-200 rounded">
                ...
                <tbody>
                  <tr className="border-t">
                    <td className="px-2 py-1 font-bold">Pituitary (anterior)</td>
                    <td className="px-2 py-1">GH</td>
                    <td className="px-2 py-1">Growth of bones and tissues</td>
                    <td className="px-2 py-1">Gigantism / Dwarfism / Acromegaly</td>
                  </tr>
                  <tr className="border-t bg-gray-50">
                    <td className="px-2 py-1 font-bold">Pituitary (anterior)</td>
                    <td className="px-2 py-1">TSH, ACTH, FSH, LH, Prolactin</td>
                    <td className="px-2 py-1">Regulate other endocrine glands</td>
                    <td className="px-2 py-1">Various</td>
                  </tr>
                  <tr className="border-t">
                    <td className="px-2 py-1 font-bold">Pituitary (posterior)</td>
                    <td className="px-2 py-1">ADH (Vasopressin)</td>
                    <td className="px-2 py-1">Water reabsorption in kidneys</td>
                    <td className="px-2 py-1">Diabetes insipidus</td>
                  </tr>
                  <tr className="border-t bg-gray-50">
                    <td className="px-2 py-1 font-bold">Pituitary (posterior)</td>
                    <td className="px-2 py-1">Oxytocin</td>
                    <td className="px-2 py-1">Uterine contractions, milk ejection</td>
                    <td className="px-2 py-1">-</td>
                  </tr>
                  <tr className="border-t">
                    <td className="px-2 py-1 font-bold">Thyroid</td>
                    <td className="px-2 py-1">T&#8323; and T&#8324;</td>
                    <td className="px-2 py-1">BMR regulation, growth</td>
                    <td className="px-2 py-1">Goitre / Cretinism / Myxoedema / Graves&apos;</td>
                  </tr>
                  <tr className="border-t bg-gray-50">
                    <td className="px-2 py-1 font-bold">Thyroid</td>
                    <td className="px-2 py-1">Calcitonin (TCT)</td>
                    <td className="px-2 py-1">Lowers blood Ca&#178;&#8314;</td>
                    <td className="px-2 py-1">-</td>
                  </tr>
                  <tr className="border-t">
                    <td className="px-2 py-1 font-bold">Parathyroid</td>
                    <td className="px-2 py-1">PTH (Parathormone)</td>
                    <td className="px-2 py-1">Raises blood Ca&#178;&#8314;</td>
                    <td className="px-2 py-1">Osteoporosis (hypo)</td>
                  </tr>
                  <tr className="border-t bg-gray-50">
                    <td className="px-2 py-1 font-bold">Adrenal cortex</td>
                    <td className="px-2 py-1">Cortisol, Aldosterone</td>
                    <td className="px-2 py-1">Stress response, Na&#8314;/K&#8314; balance</td>
                    <td className="px-2 py-1">
                      Addison&apos;s / Cushing&apos;s / Conn&apos;s syndrome
                    </td>
                  </tr>
                  <tr className="border-t">
                    <td className="px-2 py-1 font-bold">Adrenal medulla</td>
                    <td className="px-2 py-1">Adrenaline, Noradrenaline</td>
                    <td className="px-2 py-1">Fight-or-flight response</td>
                    <td className="px-2 py-1">-</td>
                  </tr>
                  <tr className="border-t bg-gray-50">
                    <td className="px-2 py-1 font-bold">Pancreas (Islets)</td>
                    <td className="px-2 py-1">Insulin (β-cells)</td>
                    <td className="px-2 py-1">Lowers blood glucose</td>
                    <td className="px-2 py-1">Diabetes mellitus (Type I)</td>
                  </tr>
                  <tr className="border-t">
                    <td className="px-2 py-1 font-bold">Pancreas (Islets)</td>
                    <td className="px-2 py-1">Glucagon (α-cells)</td>
                    <td className="px-2 py-1">Raises blood glucose</td>
                    <td className="px-2 py-1">-</td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="bg-yellow-50 border border-yellow-200 p-3 rounded text-sm">
              <div className="space-y-2 text-xs text-gray-700">
                <div className="bg-white p-2 rounded border border-yellow-100">
                  <p>
                    <strong>Peptide/Protein Hormones (Water-soluble)</strong>
                  </p>
                  <p>
                    Cannot enter cell. Bind to <strong>membrane receptors</strong> → activate
                    secondary messengers (cAMP, IP&#8323;, Ca&#178;&#8314;) → cellular response.
                    Examples: Insulin, GH, TSH, ADH.
                  </p>
                </div>
                <div className="bg-white p-2 rounded border border-yellow-100">
                  <p>
                    <strong>Steroid Hormones (Lipid-soluble)</strong>
                  </p>
                  <p>
                    Enter cell and bind <strong>intracellular receptors</strong> → hormone-receptor
                    complex acts as transcription factor → gene expression changes. Examples:
            ...
            <div className="bg-purple-50 border border-purple-200 p-3 rounded text-sm mt-3">
              ...
              <p className="text-xs text-gray-700">
                Most hormones regulated by <strong>negative feedback</strong> (e.g. high
                T&#8323;/T&#8324; → inhibits TSH release from pituitary).{' '}
                <strong>Positive feedback</strong> is rare (e.g. oxytocin during labour, LH surge
                during ovulation).
              </p>
            </div>
            <p className="text-xs text-gray-600 italic">
              PYQ Pattern: Hormone-gland matching, disorders, mechanism of action (second messenger
              vs intracellular), feedback loops
            </p>
          </div>
        ),
      },
          ...
          <div className="space-y-4">
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-blue-200 text-sm space-y-2">
                <p>
                  <strong>Proposed by:</strong> A.I. Oparin (1924) &amp; J.B.S. Haldane (1928)
                </p>
                <p>
                  <strong>Theory:</strong> Life originated from non-living matter through chemical
                  evolution
                </p>
                <p>
                  <strong>Key Idea:</strong> Early Earth had reducing atmosphere with inorganic
                  molecules that gradually formed organic compounds
                </p>
              </div>
            </div>
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-blue-200 text-sm space-y-2">
                <p>
                  <strong>Objective:</strong> Simulate primitive Earth atmosphere in laboratory
                </p>
                <p>
                  <strong>Setup:</strong> Flask containing CH₄ (methane), NH₃ (ammonia), H₂
                  (hydrogen), H₂O (water vapor)
                </p>
                <p>
                  <strong>Conditions:</strong> Electric sparks &amp; heat to simulate lightning
                  &amp; UV radiation
                </p>
                <p>
                  <strong>Result:</strong> Synthesized amino acids (5 types initially), sugars, and
                  other organic compounds
                </p>
                <p>
                  <strong>Significance:</strong> Proved that organic molecules could form from
                  inorganic precursors under early Earth conditions
                </p>
              </div>
              <p className="text-xs text-gray-600 mt-1 italic">
                PYQ Hint: Questions often ask about setup, raw materials, or what was synthesized
              </p>
            </div>
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-blue-200 text-sm space-y-2">
                <p>
                  <strong>Stage 1:</strong> Formation of simple inorganic molecules (H₂O, CH₄, NH₃,
                  H₂S)
                </p>
                <p>
                  <strong>Stage 2:</strong> Formation of simple organic molecules (amino acids,
                  nucleotides, sugars)
                </p>
                <p>
                  <strong>Stage 3:</strong> Formation of complex molecules (proteins, nucleic acids)
                </p>
                <p>
                  <strong>Stage 4:</strong> Formation of self-replicating molecules (RNA) &amp;
                  protocells
                </p>
                <p>
                  <strong>Stage 5:</strong> Origin of first cells (chemoheterotrophic prokaryotes)
                </p>
              </div>
            </div>
          </div>
        ...
        content: (
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-blue-200 text-sm space-y-2">
                <p>
                  <strong>Nictitating membrane (3rd eyelid):</strong> Vestigial in humans,
                  functional in birds &amp; reptiles
                </p>
                <p>
                  <strong>Wisdom teeth (3rd molars):</strong> Reduced in size, often impacted
                </p>
                <p>
                  <strong>Vermiform appendix:</strong> Involved in cellulose digestion in
                  herbivorous ancestors
                </p>
                <p>
                  <strong>Coccyx (tailbone):</strong> Fused vertebrae; remnant of ancestral tail
                </p>
              </div>
            </div>
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-blue-200 text-sm space-y-2">
                <p>
                  <strong>Von Baer&apos;s Law:</strong> Embryos of different vertebrates are more
                  similar at early stages; differences appear gradually
                </p>
                <p>
                  <strong>Darwin&apos;s Finches:</strong> ~14 species evolved from single ancestor
                  on Galapagos Islands with different beak shapes adapted to different food sources
                  — classic example of adaptive radiation
                </p>
                <p>
                  <strong>Marsupials in Australia:</strong> Isolated continent led to unique fauna;
                  evolved independently from placental mammals
                </p>
              </div>
            </div>
          </div>
        ...
        content: (
          <div className="space-y-4">
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-blue-200 text-sm space-y-2">
                <p>
                  <strong>1. Variation:</strong> Individuals within a population show differences
                  (genetic variation)
                </p>
                <p>
                  <strong>2. Struggle for Existence:</strong> Competition for limited resources
                  (food, space, mates)
                </p>
                <p>
                  <strong>3. Survival of the Fittest:</strong> Organisms best adapted to environment
                  survive &amp; reproduce
                </p>
                <p>
                  <strong>4. Natural Selection:</strong> Differential reproductive success based on
                  adaptation
                </p>
                <p>
                  <strong>5. Speciation:</strong> Over time, isolated populations accumulate
                  different traits forming new species
                </p>
              </div>
            </div>
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-blue-200 text-sm space-y-2">
                <p>
                  <strong>Pre-Industrial:</strong> Light-colored moths dominant on lichen-covered
                  bark
                </p>
                <p>
                  <strong>Industrial Revolution:</strong> Pollution darkened bark with soot; dark
                  moths survived better (directional selection)
                </p>
                <p>
                  <strong>Result:</strong> Dark form increased from &lt;1% to &gt;90% in Manchester
                  in 50 years
                </p>
                <p>
                  <strong>After Clean Air Act:</strong> Pollution decreased, light moths increased
                  again
                </p>
                <p>
                  <strong>Significance:</strong> Direct evidence of natural selection in real-time
                </p>
              </div>
              <p className="text-xs text-gray-600 mt-1 italic">
                PYQ Hint: Explain this example to demonstrate natural selection driven by
          ...
          <div className="space-y-4">
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-blue-200 text-sm space-y-3">
                <p>
                  <strong>Definition:</strong> In absence of evolutionary forces, allele &amp;
                  genotype frequencies remain constant across generations
                </p>
                ...
                <p>
                  <strong>Where:</strong> p = frequency of dominant allele (A), q = frequency of
                  recessive allele (a), p² = AA, 2pq = Aa, q² = aa
                </p>
                <p>
                  <strong>Assumptions:</strong> No mutations, random mating, no gene flow, no
                  genetic drift (large population), no natural selection
                </p>
              </div>
              <p className="text-xs text-gray-600 mt-2 italic">
                PYQ Hint: Calculate allele/genotype frequencies; identify which factor violated H-W
                equilibrium
              </p>
            </div>
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-blue-200 text-sm space-y-2">
                <p>
                  <strong>Founder Effect:</strong> Small group establishes new population; carries
                  only subset of genetic variation from source. Example: Amish population in
                  Pennsylvania
                </p>
                <p>
                  <strong>Bottleneck Effect:</strong> Large population suddenly reduces in size;
                  survivors carry fraction of genetic variation. Example: Northern elephant seal
                  (hunted to ~20 individuals)
                </p>
                <p>
                  <strong>Key Point:</strong> Drift is stronger in small populations; negligible in
                  large populations
                </p>
              </div>
            </div>
        ...
        content: (
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-blue-200 text-sm space-y-2">
                <p>
                  <strong>1. Bipedalism:</strong> Earliest distinguishing feature
                  (Australopithecus); freed hands for tool use; structural changes in spine, pelvis
                </p>
                <p>
                  <strong>2. Brain Size Increase:</strong> 400 cc (Dryopithecus) → 1400 cc (Homo
                  sapiens); enabled complex cognition, language
                </p>
                <p>
                  <strong>3. Tool Development:</strong> Stone choppers (habilis) → hand axes/fire
                  (erectus) → complex weapons (neanderthalensis) → sophisticated tools/art (sapiens)
                </p>
                <p>
                  <strong>4. Facial Reduction:</strong> Smaller face, teeth, jaw from ape-like to
                  modern human form
                </p>
                <p>
                  <strong>5. Language:</strong> Proto-language (erectus) → limited vocal
                  communication (neanderthalensis) → complex grammar &amp; abstract thought
                  (sapiens)
                </p>
              </div>
            </div>
            <div className="bg-yellow-50 border border-yellow-200 p-3 rounded mt-3">
              <p className="text-sm">
                <strong>Mnemonic:</strong> DRAHHNS — Dryopithecus, Ramapithecus, Australopithecus,
                Habilis, (H.) erectus, Neanderthalensis, Sapiens
              </p>
            </div>
          </div>
        ),
            ...
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-green-200">
                <ul className="text-sm space-y-2 text-gray-700">
                  <li>
                    <strong>Regulate:</strong> Maintain constant internal conditions (homeostasis) —
                    e.g., humans regulating body temperature
                  </li>
                  <li>
                    <strong>Conform:</strong> Internal conditions match external environment — e.g.,
                    cold-blooded reptiles
                  </li>
                  <li>
                    <strong>Migrate:</strong> Move to more favorable habitats — e.g., bird migration
                  </li>
                  <li>
                    <strong>Suspend:</strong> Reduce metabolic activity — Dormancy (seeds),
                    Hibernation (winter), Aestivation (summer, e.g., lungfish)
                  </li>
                </ul>
              </div>
            </div>
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-green-200 text-sm space-y-2">
                ...
                <p>
                  ...
                  reduce surface area-to-volume ratio and conserve heat
                </p>
              </div>
            </div>
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-green-200 text-sm mt-2">
                <p>
                  ...
                  <strong>K</strong> = carrying capacity &nbsp;|&nbsp; <strong>N</strong> =
                  population size
                </p>
              </div>
              <p className="text-xs text-gray-600 mt-2 italic">
                PYQ Hint: Compare curves and explain why real populations follow logistic model
              </p>
            </div>
          </div>
        ),
        ...
        content: (
          <div className="space-y-4">
            ...
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-green-200 text-sm space-y-2">
                <p>
                  <strong>Gause&apos;s Competitive Exclusion:</strong> Two species competing for
                  identical niche cannot coexist; one eliminates the other
                </p>
                <p>
                  <strong>Ectoparasites vs Endoparasites:</strong> Ectoparasites live on surface
                  (lice, ticks); endoparasites live inside host (tapeworm, malaria parasite)
                </p>
                <p>
                  <strong>Brood Parasitism:</strong> Cuckoo lays eggs in other birds&apos; nests;
                  host bird raises cuckoo chick at expense of own offspring
                </p>
              </div>
              <p className="text-xs text-gray-600 mt-2 italic">
                PYQ Hint: Identify interaction type from given scenario; very frequently tested
              </p>
            </div>
          </div>
        ),
        ...
        content: (
          <div className="space-y-4">
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-green-200 text-sm space-y-2">
                <p>
                  <strong>GPP (Gross Primary Productivity):</strong> Total carbon fixed by plants
                  via photosynthesis
                </p>
                <p>
                  <strong>NPP (Net Primary Productivity):</strong> GPP minus plant respiration;
                  available for consumers. Formula: NPP = GPP - Respiration
                </p>
                <p>
                  <strong>Secondary Productivity:</strong> Energy fixed by consumers (herbivores,
                  carnivores)
                </p>
                <p>
                  <strong>Global NPP:</strong> ~170 billion tons of organic matter/year
                </p>
              </div>
            </div>
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-green-200 text-sm space-y-2">
                <p>
                  <strong>1. Fragmentation:</strong> Physical breakdown by detritivores (earthworms,
                  termites)
                </p>
                <p>
                  <strong>2. Leaching:</strong> Water-soluble substances wash out into soil
                </p>
                <p>
                  <strong>3. Catabolism:</strong> Bacterial &amp; fungal enzymes break down organic
                  compounds
                </p>
                <p>
                  <strong>4. Humification:</strong> Partially decomposed matter forms humus (dark,
                  stable compound)
                </p>
                <p>
                  <strong>5. Mineralization:</strong> Release of inorganic nutrients available for
                  plants
                </p>
              </div>
            </div>
        ...
        content: (
          <div className="space-y-4">
            ...
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-green-200 text-sm space-y-2">
                <p>
                  <strong>Pyramid of Numbers:</strong> Upright in grassland; inverted in tree
                  ecosystem (one tree supports many insects)
                </p>
                <p>
                  <strong>Pyramid of Biomass:</strong> Inverted in aquatic (phytoplankton biomass
                  &lt; zooplankton due to fast turnover)
                </p>
                <p>
                  <strong>Pyramid of Energy:</strong> ALWAYS upright — follows 2nd law of
                  thermodynamics; energy lost as heat at each level
                </p>
              </div>
              <p className="text-xs text-gray-600 mt-2 italic">
                PYQ Hint: Explain why pyramid of energy can never be inverted
              </p>
            </div>
          </div>
        ),
        ...
        content: (
          <div className="space-y-4">
            ...
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-green-200 text-sm space-y-2">
                <p>
                  Pollination, oxygen production, nutrient cycling, water purification, climate
                  regulation, genetic resources for medicine
                </p>
                <p>
                  <strong>Robert Costanza (1997):</strong> Global ecosystem services estimated at
                  ~$33 trillion/year
                </p>
              </div>
            </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
              <h4 className="font-semibold text-green-900 mb-3">
                Species Diversity &amp; Species-Area Relationship
              </h4>
              <div className="bg-white p-3 rounded border border-green-200 text-sm space-y-2">
                <p>
                  <strong>Alpha (α):</strong> Diversity within a single community
                </p>
                <p>
                  <strong>Beta (β):</strong> Diversity between communities (species turnover)
                </p>
                <p>
                  <strong>Gamma (γ):</strong> Total regional diversity
                </p>
                <p className="bg-gray-100 p-2 rounded font-mono text-xs font-semibold mt-2">
                  Species-Area: log S = log C + Z log A
                </p>
                <p>
                  <strong>Z values:</strong> 0.1-0.2 (within continents) | 0.6-1.2 (islands —
                  steeper slope)
                </p>
              </div>
            </div>
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
              <h4 className="font-semibold text-green-900 mb-3">
                Latitudinal Gradient &amp; Causes of Loss
              </h4>
              <div className="bg-white p-3 rounded border border-green-200 text-sm space-y-2">
                <p>
                  <strong>Pattern:</strong> Tropics have highest diversity (40% of species in 10% of
                  area); richness decreases toward poles
                </p>
                <p>
                  <strong>HIPPO — Causes of biodiversity loss:</strong>
                </p>
                <p>
                  <strong>H</strong>abitat loss (#1 threat) | <strong>I</strong>nvasive species |{' '}
                  <strong>P</strong>ollution | <strong>P</strong>opulation growth |{' '}
                  <strong>O</strong>verexploitation
                </p>
              </div>
            </div>
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
            ...
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
              ...
              <div className="bg-white p-3 rounded border border-green-200 text-sm space-y-2">
                <p>
                  <strong>Status:</strong> One of 12 mega-diversity nations (7-8% of world&apos;s
                  species on 2% land)
                </p>
                <p>
                  <strong>4 Biodiversity Hotspots:</strong> Western Ghats, Himalayas, Indo-Burma,
                  Sundaland (Andaman/Nicobar)
                </p>
              </div>
              <p className="text-xs text-gray-600 mt-2 italic">
                PYQ Hint: Name conservation areas; explain HIPPO; species-area relationship
                calculations
              </p>
            </div>
          </div>
  ...
  const cellUnitOfLifeContent = {
    topics: [
      {
        title: 'Cell Theory & Cell Discovery',
        pyqFrequency: 'Medium' as const,
        content: (
          <div className="space-y-4">
            <div className="bg-blue-50 border-l-4 border-blue-400 p-3">
              <p className="font-semibold text-blue-900">Cell Theory (3 postulates):</p>
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Virchow's principle is high priority. Focus on exceptions — frequently
                tested.
              </p>
            </div>
          </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: 70S = prokaryotes & mitochondria/plastids; 80S = eukaryotic cytoplasm.
                Comparison questions appear almost every exam.
              </p>
            </div>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="space-y-4">
            ...
            <p className="font-semibold text-green-800">
              Lysosomes: Acid hydrolases (pH ~4.8). Autophagy, phagocytosis, apoptosis. Absent in
              plant cells.
            </p>
            <p className="font-semibold text-green-800">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: "DNA found besides nucleus?" → Mitochondria & plastids. Know all organelle
                functions.
              </p>
            </div>
          </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-sm">
              Interconnected organelles: ER → Golgi → Lysosomes → Plasma membrane (excludes
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="font-semibold text-green-800">
              Fluid Mosaic Model (Singer & Nicolson, 1972): Phospholipid bilayer with embedded
              proteins.
            </p>
            <ul className="list-disc pl-6 text-sm">
              <li>Amphipathic phospholipids: heads outward, tails inward; ~7.5 nm thick</li>
              <li>
                Integral proteins: span bilayer (channels, receptors); Peripheral: surface only
              </li>
    ...
    topics: [
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="font-semibold text-green-800">
              Amino acids: -NH₂ + -COOH + R-group on α-carbon. Peptide bond: C-N covalent
              (dehydration).
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                ESSENTIAL AAs MNEMONIC: "PVT TIM HaLL" = Phe, Val, Thr, Trp, Ile, Met, His, Leu, Lys
                (9 total)
              </p>
            </div>
            <table className="w-full border-collapse border border-gray-300 my-4 text-xs">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET: Disulfide bonds between cysteine residues. Denaturation disrupts 2°/3° but NOT
                1° structure.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                ...
                peptidoglycan synthesis. Enzyme classification very frequent.
              </p>
            </div>
          </div>
        ),
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET: "PURe As Gold" — Purines have 2 rings. Chargaff's rules calculations frequent.
      ...
      {
        title: 'Metabolic Basis of Living',
        pyqFrequency: 'Medium' as const,
        content: (
          <div className="space-y-4">
            <table className="w-full border-collapse border border-gray-300 my-4 text-xs">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET: Primary vs secondary metabolite distinction is a direct MCQ topic.
              </p>
            </div>
          </div>
        ),
    ...
    topics: [
      {
        ...
        content: (
          <div className="space-y-4">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: G1 is longest phase. p53 at G1/S checkpoint. Cyclin B-CDK1 triggers
                mitosis entry.
              </p>
            </div>
          </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Metaphase = aligned; Anaphase = separating. Plant vs animal cytokinesis
                HIGH-frequency.
              </p>
            </div>
          </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-sm">
              Reductional: 2n → four unique n gametes. Meiosis I (reductional) + Meiosis II
              (equational).
            </p>
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                ...
                individual chromosomes. Two sources of variation: crossing over + independent
                assortment.
              </p>
            </div>
          </div>
      ...
      {
        title: 'Significance of Cell Division',
        pyqFrequency: 'Medium' as const,
        content: (
          <div className="space-y-4">
            <p className="font-semibold text-green-800">
              Mitosis: Growth, tissue repair (skin 2-4 weeks, RBCs ~120 days), asexual reproduction,
              chromosome maintenance (2n→2n).
            </p>
            <p className="font-semibold text-green-800 mt-2">
              Meiosis: Gamete formation (n), genetic variation (crossing over + independent
              assortment), prevents chromosome doubling, raw material for evolution.
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Why meiosis essential? → Genetic variation + chromosome reduction. Without
                it: 2n→4n→8n each generation.
              </p>
            </div>
          </div>
        ),
  ...
  const reproductionContent = {
    topics: [
        ...
        content: (
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm">
                <span className="font-semibold text-green-800">Binary fission:</span> Division into
                two equal halves (bacteria, Amoeba).{' '}
                <span className="font-semibold text-green-800">Budding:</span> Outgrowth develops
                into new organism (Hydra, yeast).{' '}
                <span className="font-semibold text-green-800">Fragmentation:</span> Body breaks
                into fragments, each regenerates (Spirogyra, starfish).{' '}
                <span className="font-semibold text-green-800">Sporulation:</span> Formation of
                spores (Rhizopus).{' '}
                <span className="font-semibold text-green-800">Vegetative propagation:</span> From
                vegetative parts (potato tubers, runners in strawberry).
              </p>
            </div>
            <div>
              <p className="font-semibold text-green-800">Events in Sexual Reproduction</p>
              <p className="text-sm">
                <span className="font-semibold text-green-800">Pre-fertilisation:</span>{' '}
                Gametogenesis, gamete transfer.{' '}
                <span className="font-semibold text-green-800">Fertilisation:</span> Fusion of male
                and female gametes forming zygote.{' '}
                <span className="font-semibold text-green-800">Post-fertilisation:</span> Embryo
                development, organogenesis, growth.
              </p>
            </div>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Zoospores are motile asexual spores with flagella. Conidia are non-motile
                asexual spores. Meiocytes are always 2n diploid cells that undergo meiosis to
                produce n haploid gametes.
              </p>
            </div>
          </div>
        ),
        ...
        content: (
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm">
                <span className="font-semibold text-green-800">Microsporogenesis:</span> Microspore
                mother cell (2n) undergoes meiosis → 4 microspores (n) → develops into pollen grain
                with vegetative and generative cells.{' '}
                <span className="font-semibold text-green-800">Megasporogenesis:</span> Megaspore
                mother cell (2n) undergoes meiosis → 4 megaspores (n) → usually 3 degenerate, 1
            ...
            <div>
              ...
              <p className="text-sm">
                <span className="font-semibold text-green-800">Autogamy:</span> Same flower
                self-pollination. <span className="font-semibold text-green-800">Geitonogamy:</span>{' '}
                Different flower, same plant (genetically self-pollination).{' '}
                <span className="font-semibold text-green-800">Xenogamy:</span> Cross-pollination
                between different plants (promotes genetic variation).
              </p>
            </div>
            <div>
              <p className="font-semibold text-green-800">Double Fertilisation</p>
              <p className="text-sm">
                <span className="font-semibold text-green-800">Syngamy:</span> Male gamete + egg
                cell (n + n = 2n zygote) → embryo.{' '}
                <span className="font-semibold text-green-800">Triple fusion:</span> Male gamete + 2
                polar nuclei (n + n + n = 3n) → endosperm. Endosperm types: Nuclear (coconut),
                Cellular, Helobial.
              </p>
            </div>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Megaspore mother cell (2n) → 4 megaspores (n) → only 1 functional. Double
                fertilisation (syngamy + triple fusion) is UNIQUE to angiosperms. Always remember: 7
                cells, 8 nuclei in mature embryo sac.
              </p>
            </div>
          </div>
        ),
      ...
      {
        title: 'Human Reproduction — Male System',
        pyqFrequency: 'High' as const,
        content: (
          <div className="space-y-4">
            <div>
              <p className="font-semibold text-green-800">Male Reproductive Anatomy</p>
              <p className="text-sm">
                <span className="font-semibold text-green-800">Testes:</span> Paired organs in
                scrotum (2-3°C below body temp), produce sperm + testosterone.{' '}
                <span className="font-semibold text-green-800">Epididymis:</span> Sperm storage and
                maturation. <span className="font-semibold text-green-800">Vas deferens:</span>{' '}
                Sperm transport.{' '}
                <span className="font-semibold text-green-800">Accessory glands:</span> Seminal
                vesicles (fructose), prostate (enzymes), bulbourethral glands (mucus).
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm">
                <span className="font-semibold text-green-800">Head:</span> Nucleus + acrosome
                (enzymes for egg penetration).{' '}
                <span className="font-semibold text-green-800">Neck:</span> Centrioles.{' '}
                <span className="font-semibold text-green-800">Middle piece:</span> Mitochondrial
                helix (ATP). <span className="font-semibold text-green-800">Tail:</span> Flagellum
                for motility.
              </p>
            </div>
            <div>
              <p className="font-semibold text-green-800">Hormonal Control</p>
              <p className="text-sm">
                Hypothalamus → GnRH → Anterior pituitary → FSH (spermatogenesis via Sertoli cells) +
                LH (testosterone via Leydig cells). Testosterone: secondary sexual characters +
                negative feedback.
              </p>
            </div>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Sertoli cells = nutrition/support to developing sperm. Leydig cells =
                testosterone secretion. Spermatogenesis starts at puberty, continues throughout
                life. Scrotum = 2-3°C below body temperature.
              </p>
            </div>
          </div>
        ),
      ...
      {
        title: 'Human Reproduction — Female System & Development',
        pyqFrequency: 'Very High' as const,
        content: (
          <div className="space-y-4">
            <div>
            ...
            <div>
              ...
              <p className="text-sm">
                Fertilisation in ampulla of fallopian tube (12-24 hrs post-ovulation). Zygote →
                cleavage → blastocyst reaches uterus day 5-6. Implantation day 7-12. hCG from
                trophoblast maintains corpus luteum. Placenta: O<sub>2</sub>/nutrient transfer,
                hormone production (progesterone after week 8). Parturition: oxytocin → uterine
                contractions. Lactation: prolactin → milk; colostrum rich in IgA antibodies.
              </p>
            </div>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Ovulation = Day 14 (LH surge). Corpus luteum → progesterone. hCG detected
                in pregnancy tests. Primary oocyte arrested in Prophase I until ovulation. Gestation
        ...
        content: (
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm">
                <span className="font-semibold text-green-800">Bacterial:</span> Gonorrhoea
                (Neisseria), Syphilis (Treponema pallidum).{' '}
                <span className="font-semibold text-green-800">Viral:</span> HIV/AIDS (retrovirus,
                CD4<sup>+</sup> T cells), Hepatitis B, Genital herpes (HSV-2). Prevention: safe sex,
                condoms, awareness.
              </p>
            </div>
            <div>
              <p className="font-semibold text-green-800">Infertility &amp; ART</p>
              <p className="text-sm">
                <span className="font-semibold text-green-800">IVF:</span> Fertilisation outside
                body, embryo transferred to uterus.{' '}
                <span className="font-semibold text-green-800">ZIFT:</span> Zygote transferred to
                fallopian tube. <span className="font-semibold text-green-800">GIFT:</span> Gametes
                placed in fallopian tube.{' '}
                <span className="font-semibold text-green-800">ICSI:</span> Single sperm injected
                into egg. <span className="font-semibold text-green-800">AI:</span> Semen introduced
                into female tract. Amniocentesis: detects chromosomal abnormalities (banned for sex
                determination).
              </p>
            </div>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: IVF = in vitro (outside body). ZIFT = zygote in fallopian tube. GIFT =
                gametes in fallopian tube. Remember: GIFT (unfertilised) → ZIFT (zygote) → IVF
                (embryo). Amniocentesis banned for sex determination in India.
              </p>
            </div>
          </div>
        ),
  ...
  const biotechnologyContent = {
    topics: [
      {
        title: 'Genetic Engineering Tools',
        pyqFrequency: 'Very High' as const,
        content: (
          <div className="space-y-4">
            <p className="text-sm">
              <span className="font-semibold text-green-800">Restriction Enzymes:</span> EcoRI
              recognizes palindromic sequence 5&apos;-GAATTC-3&apos;; produces sticky ends
              (preferred for cloning). Nomenclature: E (genus Escherichia) + co (species coli) + R
              (strain RY13) + I (first enzyme).
            </p>
            <div>
            ...
            <p className="text-sm">
              ...
              fragments), DNA polymerase (synthesizes DNA), Reverse transcriptase (RNA → cDNA).{' '}
              <span className="font-semibold text-green-800">Insertional inactivation:</span>{' '}
              Foreign DNA inserted into antibiotic resistance gene → loss of resistance identifies
              recombinants.
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: EcoRI = E.coli RY13, first enzyme (I). Palindromic sequences read same
                5&apos;→3&apos; on both strands. Sticky ends preferred — they base-pair easily with
                compatible ends.
              </p>
            </div>
          </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="font-semibold text-green-800">Steps of rDNA Technology</p>
            <p className="text-sm">
              (1) DNA isolation → (2) Restriction enzyme cutting → (3) PCR amplification → (4)
              Ligation with vector → (5) Transfer into host → (6) Screening and selection.
            </p>
            <div>
            ...
            <p className="text-sm">
              ...
              fragments separated by size in agarose gel; smaller fragments move faster; ethidium
              bromide staining under UV.{' '}
              <span className="font-semibold text-green-800">Bioreactors:</span> Stirred tank
              bioreactors for large-scale recombinant protein production.
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: PCR = 3 steps repeated 30+ cycles. Taq polymerase from Thermus aquaticus
                (thermostable). DNA is negatively charged — smaller fragments migrate faster in gel
                electrophoresis.
              </p>
            </div>
          </div>
        ...
        content: (
          <div className="space-y-4">
            ...
            <p className="text-sm">
              ...
              protoxin → activated in alkaline insect midgut → pore formation in epithelial cells →
              cell lysis → insect death. Harmless to humans (requires pH &gt;9).
            </p>
            <p className="text-sm">
              <span className="font-semibold text-green-800">RNA Interference (RNAi):</span> dsRNA
              triggers gene silencing. Meloidogyne incognita (root-knot nematode) controlled in
              transgenic tobacco using nematode-specific dsRNA.
            </p>
            <p className="text-sm">
              <span className="font-semibold text-green-800">Golden Rice:</span> Transgenic rice
              enriched with beta-carotene (provitamin A) to address vitamin A deficiency.
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Bt = Bacillus thuringiensis. cry genes encode crystal proteins. Bt toxin
                requires alkaline pH — safe for mammals. RNAi = targeted gene silencing without DNA
                modification.
              </p>
            </div>
          </div>
        ...
        content: (
          <div className="space-y-4">
            <p className="text-sm">
              ...
              Human insulin gene inserted into E. coli. Synthesized as proinsulin (single chain) →
              cleaved to mature insulin (A chain + B chain joined by disulfide bonds).
            </p>
            <p className="text-sm">
              <span className="font-semibold text-green-800">Gene Therapy:</span> ADA deficiency
              (adenosine deaminase) → SCID. First successful gene therapy: ex vivo approach (patient
              cells modified outside body, reintroduced).
            </p>
            <div>
            ...
            <p className="text-sm">
              ...
              gene regulation studies, therapeutic protein production (pharming), toxicity testing,
              disease modeling.
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Humulin = first genetically engineered human insulin from E. coli.
                ADA-SCID = adenosine deaminase deficiency. ELISA = antigen-antibody quantification.
                PCR enables rapid disease diagnosis.
              </p>
            </div>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-sm">
              <span className="font-semibold text-green-800">Ethical Issues:</span> GMO safety
              (allergenicity, toxicity), biopiracy (unauthorized commercial use of biological
              resources), patent monopolies on biological resources.
            </p>
            <div>
            ...
            <p className="text-sm">
              ...
              Appraisal Committee): Reviews GMO research, approves releases in India.{' '}
              <span className="font-semibold text-green-800">
                Traditional Knowledge Digital Library (TKDL):
              </span>{' '}
              Documents Indian traditional knowledge to prevent biopiracy patents.
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: GEAC = regulatory body for GMO biosafety in India. India fights biopiracy
                through TKDL. Benefit-sharing required under Convention on Biological Diversity
                (CBD).
              </p>
            </div>
          </div>
    ...
    topics: [
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-sm">
              Whittaker's classification (1969) uses five criteria:{' '}
              <span className="font-semibold text-green-800">
                cell structure, body organisation, mode of nutrition, reproduction, and phylogenetic
                relationships
              </span>
              .
            </p>
            ...
            <p className="text-sm">
              ...
              based on cell structure and nutrition mode.
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Whittaker proposed 5 kingdoms in 1969. Classification criteria: cell
                structure, nutrition mode, body organization, reproduction, and phylogenetic
                relationships.
              </p>
            </div>
          </div>
        ...
        content: (
          <div className="space-y-4">
            ...
            <p className="text-sm">
              ...
              Photoheterotroph (light + organic), Chemoheterotroph (organic compounds).
            </p>
            <p className="text-sm">
              <span className="font-semibold text-green-800">Archaebacteria:</span> Methanogens
              (produce CH<sub>4</sub>), Halophiles (extreme salt), Thermoacidophiles (hot acidic).{' '}
              <span className="font-semibold text-green-800">Cyanobacteria:</span> Photosynthetic
              prokaryotes with heterocysts for N<sub>2</sub> fixation.{' '}
              <span className="font-semibold text-green-800">Mycoplasma:</span> Smallest living
              organism, no cell wall, pathogenic.
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Archaebacteria thrive in extreme environments. Mycoplasma = smallest cell,
                lacks cell wall. Cyanobacteria = photosynthetic prokaryotes with heterocysts for
                nitrogen fixation.
              </p>
            </div>
          </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-sm">
              <span className="font-semibold text-green-800">Chrysophytes:</span> Diatoms
              (diatomaceous earth, silica shells), Desmids.{' '}
              <span className="font-semibold text-green-800">Dinoflagellates:</span> Cause red
              tides, bioluminescent (Noctiluca).{' '}
              <span className="font-semibold text-green-800">Euglenoids:</span> Mixotrophic
              (Euglena), pellicle not cell wall.{' '}
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                ...
                link (autotrophic + heterotrophic). Plasmodium = Sporozoan causing malaria.
              </p>
            </div>
          </div>
        ),
        ...
        content: (
          <div className="space-y-4">
            ...
            <p className="text-sm">
              ...
              <span className="font-semibold text-green-800">Lichens:</span> Algae (phycobiont) +
              Fungi (mycobiont) symbiosis.{' '}
              <span className="font-semibold text-green-800">Mycorrhiza:</span> Fungal association
              with plant roots.
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Deuteromycetes = &quot;imperfect fungi&quot; (no sexual stage known).
                Lichens = pollution indicators. Neurospora = genetics model organism.
              </p>
            </div>
          </div>
        ),
        ...
        content: (
          <div className="space-y-4">
            ...
            <p className="text-sm">
              ...
              <span className="font-semibold text-green-800">Prions:</span> Misfolded proteins, no
              nucleic acid (Mad Cow Disease, Creutzfeldt-Jakob Disease).
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Viroids discovered by Diener (1971). Prions identified by Stanley
                Prusiner. TMV discovered by Ivanowsky (1892), crystallised by Stanley (1935).
              </p>
            </div>
          </div>
        ),
    ...
    topics: [
      {
        ...
        content: (
          <div className="space-y-4">
            <div>
              <p className="font-semibold text-green-800">Properties of Living Organisms</p>
              <p className="text-sm">
                <span className="font-semibold text-green-800">Growth:</span> Increase in
                mass/number. Plants have open growth (throughout life), animals have closed growth
                (to a point). <span className="font-semibold text-green-800">Reproduction:</span>{' '}
                Not a defining feature (mules, worker bees don&apos;t reproduce).{' '}
                <span className="font-semibold text-green-800">Metabolism:</span> SUM of all
                chemical reactions — most defining feature of life.{' '}
                <span className="font-semibold text-green-800">Cellular Organization:</span> All
                living things are made of cells.{' '}
                <span className="font-semibold text-green-800">Consciousness:</span> Response to
                stimuli — most defining property (even plants respond).
              </p>
            </div>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Metabolism is the DEFINING property of life. Growth alone doesn&apos;t
                define life (crystals grow). Reproduction is NOT universal (mules are sterile).
                Consciousness/irritability is shown by all living organisms.
              </p>
            </div>
          </div>
        ),
      ...
      {
        title: 'Biodiversity and Need for Classification',
        pyqFrequency: 'Medium' as const,
        content: (
          <div className="space-y-4">
            <p className="text-sm">
              <span className="font-semibold text-green-800">Biodiversity:</span> Approximately
              1.7-1.8 million species described on Earth.
            </p>
            <p className="text-sm">
              <span className="font-semibold text-green-800">Nomenclature:</span> ICBN
              (International Code of Botanical Nomenclature) for plants; ICZN (International Code of
              Zoological Nomenclature) for animals.
            </p>
            <p className="text-sm">
              <span className="font-semibold text-green-800">
                Binomial Nomenclature (Linnaeus):
              </span>{' '}
              Genus + species. Italicized, genus capitalized. Rules: Latin/derived from Latin,
              printed in italics, handwritten underlined separately, author name at end.
            </p>
            <p className="text-sm">
              Identification, classification, and nomenclature are the three steps of taxonomy.
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Binomial nomenclature = Carolus Linnaeus. ICBN for plants, ICZN for
                animals. Scientific names are ALWAYS in italics or underlined separately.
              </p>
            </div>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="space-y-4">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Mnemonic: &quot;King Philip Came Over For Good Spaghetti&quot;. Species is
                the basic unit. Moving up hierarchy = fewer shared characters, more organisms.
              </p>
            </div>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-sm">
              <span className="font-semibold text-green-800">Herbarium:</span> Dried, pressed plant
              specimens on sheets with collection data.{' '}
              <span className="font-semibold text-green-800">Botanical Gardens:</span> Living plant
              collections (Kew Gardens London, Indian Botanical Garden Kolkata).{' '}
              <span className="font-semibold text-green-800">Museum:</span> Preserved specimens in
              jars with formalin.{' '}
              <span className="font-semibold text-green-800">Zoological Parks:</span> Wild animals
              in captivity for study and conservation.
            </p>
            <p className="text-sm">
              <span className="font-semibold text-green-800">Taxonomic Keys:</span> Paired
              contrasting characters (couplets) for identification. Based on dichotomous choice.{' '}
              <span className="font-semibold text-green-800">Taxonomic Literature:</span> Flora
              (plants of area), Fauna (animals of area), Monograph (detailed study of one group),
              Manual (identification guide).
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Keys use DICHOTOMOUS (two contrasting) characters in couplets. Herbarium =
                dried pressed plants. Flora = plants of region. Manual = practical identification
                guide.
              </p>
            </div>
          </div>
      ...
      },
      {
        ...
        pyqFrequency: 'Low' as const,
        content: (
          <div className="space-y-4">
            <p className="text-sm">
              <span className="font-semibold text-green-800">Taxonomy:</span> Study of principles of
              identification, nomenclature, and classification.{' '}
              <span className="font-semibold text-green-800">Systematics:</span> Study of diversity
              and evolutionary relationships of organisms (broader than taxonomy).
            </p>
            <p className="text-sm">
              <span className="font-semibold text-green-800">Processes:</span> Characterization →
              Identification → Nomenclature → Classification.{' '}
              <span className="font-semibold text-green-800">New Systematics/Biosystematics:</span>{' '}
              Considers morphological + ecological + genetic data (molecular, chromosomal).
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Taxonomy = classification. Systematics = evolutionary relationships. New
                systematics considers ALL types of data (morphology, ecology, genetics).
              </p>
            </div>
          </div>
        ),
    ...
    topics: [
        ...
        content: (
          <div className="space-y-4">
            ...
            <p className="text-sm">
              ...
              <span className="font-semibold text-green-800">Reproduction:</span> Vegetative
              (fragmentation), Asexual (zoospores), Sexual (isogamous, anisogamous, oogamous).
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Chlorophyceae = green (freshwater). Phaeophyceae = brown (marine).
                Rhodophyceae = red (marine, deepest). Agar from red algae. Oogamy = large non-motile
                egg + small motile sperm.
              </p>
            </div>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="space-y-4">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Bryophytes = &quot;amphibians of plant kingdom&quot;. Gametophyte
                DOMINANT. Mosses show protonema stage. Sphagnum = peat moss.
              </p>
            </div>
          </div>
        ),
        ...
        content: (
          <div className="space-y-4">
            ...
            <p className="text-sm">
              ...
              underside of fronds. Life cycle: sporophyte → spores → prothallus (gametophyte) →
              gametes → sporophyte.
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Pteridophytes = first vascular cryptogams. Sporophyte DOMINANT.
                Selaginella = heterosporous (forerunner of seed habit). Prothallus = independent
                gametophyte.
              </p>
            </div>
          </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-sm">
              <span className="font-semibold text-green-800">&quot;Naked seeds&quot;</span> — ovules
              not enclosed in ovary. Examples: Cycas (coralloid roots with cyanobacteria for N
              <sub>2</sub> fixation), Pinus, Ginkgo (living fossil), Sequoia (tallest tree), Cedrus.
            </p>
            <p className="text-sm">
              <span className="font-semibold text-green-800">Heterosporous:</span> Male cones
              (microsporangia → pollen). Female cones (megasporangia → ovules). Pollination by wind
              (anemophily). Pollen tube → siphonogamy (no water needed).
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Gymnosperms = &quot;naked seeds&quot;. Sequoia = tallest. Cycas has
                coralloid roots (N<sub>2</sub> fixation). Pollen tube = siphonogamy. Endosperm is
                haploid (n) in gymnosperms vs triploid (3n) in angiosperms.
              </p>
            </div>
          </div>
        ),
      ...
      {
        title: 'Angiosperms and Alternation of Generations',
        pyqFrequency: 'Very High' as const,
        content: (
          <div className="space-y-4">
            <p className="text-sm">
            ...
            <p className="text-sm">
              ...
              gymnosperms/angiosperms), Haplo-diplontic (bryophytes/pteridophytes).
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Double fertilisation UNIQUE to angiosperms. Haplontic = dominant
                gametophyte. Diplontic = dominant sporophyte. Dicot vs Monocot differences are
                HIGH-frequency NEET questions.
              </p>
            </div>
          </div>
        ),
    ...
    topics: [
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-sm">
              <span className="font-semibold text-green-800">Levels of Organisation:</span> Cellular
              (Porifera), Tissue (Cnidaria), Organ (Platyhelminthes), Organ system (Annelida
              onwards). <span className="font-semibold text-green-800">Symmetry:</span> Asymmetrical
              (sponges), Radial (Cnidaria, Echinodermata), Bilateral (most animals).
            </p>
            <p className="text-sm">
              <span className="font-semibold text-green-800">Germ Layers:</span> Diploblastic = 2
              layers (Cnidaria). Triploblastic = 3 layers (Platyhelminthes onwards).{' '}
              <span className="font-semibold text-green-800">Coelom:</span> Acoelomate
              (Platyhelminthes), Pseudocoelomate (Aschelminthes), Coelomate (Annelida onwards).
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Diploblastic = Cnidaria ONLY. Pseudocoelom = derived from blastocoel. True
                coelom = lined by mesoderm. Echinoderms have radial symmetry as adults but bilateral
                larvae.
              </p>
            </div>
          </div>
      ...
      {
        title: 'Non-Chordata: Porifera to Ctenophora',
        pyqFrequency: 'High' as const,
        content: (
          <div className="space-y-4">
            <p className="text-sm">
              <span className="font-semibold text-green-800">Porifera:</span> Pore-bearing,
              choanocytes (collar cells), spicules. Examples: Sycon, Euspongia, Spongilla.{' '}
              <span className="font-semibold text-green-800">Cnidaria:</span>{' '}
              Cnidocytes/nematocysts, polyp &amp; medusa forms. Examples: Hydra, Obelia, Aurelia,
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                ...
                Cnidaria. Corals = colonial cnidarians with CaCO<sub>3</sub> skeleton.
              </p>
            </div>
          </div>
        ),
      ...
      {
        title: 'Platyhelminthes to Aschelminthes',
        pyqFrequency: 'High' as const,
        content: (
          <div className="space-y-4">
            <table className="w-full border-collapse border border-gray-300 my-4 text-xs">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                ...
                complete gut. Flame cells = excretory in Platyhelminthes. Wuchereria causes
          ...
          <div className="space-y-4">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                ...
                (haemocoel). Closed circulation in Annelida. Malpighian tubules = excretory in
                Arthropoda.
              </p>
            </div>
          </div>
      ...
      {
        title: 'Echinodermata to Hemichordata',
        pyqFrequency: 'High' as const,
        content: (
          <div className="space-y-4">
            <p className="text-sm">
              <span className="font-semibold text-green-800">Echinodermata:</span> Spiny skin, water
              vascular system (tube feet), radial symmetry (adults), bilateral (larvae),
              endoskeleton of calcareous ossicles. Examples: Asterias, Echinus, Antedon, Cucumaria,
              Ophiura.
            </p>
            <p className="text-sm">
              <span className="font-semibold text-green-800">Hemichordata:</span> Stomochord
              (rudimentary notochord-like), gill slits. Examples: Balanoglossus, Saccoglossus.
              Previously classified with Chordates, now separate.
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                NEET TIP: Water vascular system UNIQUE to Echinoderms. Echinoderms = ONLY
                non-chordate coelomates with radial symmetry. Hemichordata has stomochord (NOT true
                notochord).
              </p>
            </div>
          </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-sm">
              <span className="font-semibold text-green-800">3 Defining Features:</span> Notochord,
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3">
              <p className="font-semibold text-yellow-800 text-sm">
                ...
                fish). Platypus &amp; Echidna = egg-laying mammals (Prototheria). Ostrich = largest
                living bird (flightless).
              </p>
            </div>
          </div>
        ),
    ...
    topics: [
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              Roots are classified into two main types based on plant type:{' '}
              <span className="font-semibold text-green-800">Tap roots</span> (found in dicots like
              mustard and mango) develop from a single primary root, while{' '}
              <span className="font-semibold text-green-800">Fibrous roots</span> (found in monocots
              like wheat and rice) consist of many fine, thread-like roots of similar size.
            </p>

            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800">
              <strong>NEET TIP:</strong> Sweet potato is a modified{' '}
              <span className="font-semibold">ADVENTITIOUS root</span> (not tap root). Carrot and
              turnip are modified <span className="font-semibold">TAP roots</span>. Pneumatophores
              have lenticels for gas exchange.
            </div>

            <p>
              <strong>Root Modifications:</strong>
            </p>
            <ul className="list-disc list-inside space-y-2">
              <li>
                <span className="font-semibold text-green-800">Pneumatophores</span> (Rhizophora
                mangrove) - aerial roots that breathe through lenticels
              </li>
              <li>
                <span className="font-semibold text-green-800">Prop roots</span> (Banyan tree) -
                provide mechanical support
              </li>
              <li>
                <span className="font-semibold text-green-800">Stilt roots</span> (Maize, Sugarcane)
                - adventitious roots extending from stem for support
              </li>
              <li>
                <span className="font-semibold text-green-800">Storage roots</span> - conical
                (Carrot), napiform (Turnip), fusiform (Radish), tuberous/adventitious (Sweet potato)
              </li>
            </ul>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              <span className="font-semibold text-green-800">Stem modifications</span> are
              adaptations of stems to perform specialized functions like storage, support, or
              protection. They are classified based on their position relative to the ground.
            </p>

            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800">
              <strong>NEET TIP:</strong> Potato is a modified{' '}
              <span className="font-semibold">STEM</span> (has nodes/eyes/buds). Sweet potato is a
              modified <span className="font-semibold">ROOT</span> (no nodes). Thorn of
              Bougainvillea is an axillary bud modified as a thorn. Spine of cactus is a modified{' '}
              <span className="font-semibold">LEAF</span>.
            </div>

            <p>
              <strong>Underground Stem Modifications:</strong>
            </p>
            <ul className="list-disc list-inside space-y-2">
              <li>
                <span className="font-semibold text-green-800">Rhizome</span> (Ginger) - horizontal
                underground stem with nodes and internodes
              </li>
              <li>
                <span className="font-semibold text-green-800">Tuber</span> (Potato) - swollen
                underground stem; eyes are nodes containing buds
              </li>
              <li>
                <span className="font-semibold text-green-800">Bulb</span> (Onion) - underground
                stem surrounded by fleshy leaf bases
              </li>
              <li>
                <span className="font-semibold text-green-800">Corm</span> (Colocasia) - short,
                solid, underground stem
              </li>
            </ul>

            <p>
              <strong>Aerial Stem Modifications:</strong>
            </p>
            <ul className="list-disc list-inside space-y-2">
              <li>
                <span className="font-semibold text-green-800">Tendril</span> (Grape vine) -
                modified stem for climbing support
              </li>
              <li>
                <span className="font-semibold text-green-800">Thorn</span> (Bougainvillea) -
                axillary bud modified for protection
              </li>
              <li>
                <span className="font-semibold text-green-800">Phylloclade</span> (Opuntia) -
                flattened stem for photosynthesis; functions as leaf
              </li>
            </ul>

            <p>
              <strong>Sub-aerial Stem Modifications (Runners &amp; Stolons):</strong>
            </p>
            <ul className="list-disc list-inside space-y-2">
              <li>
                <span className="font-semibold text-green-800">Runner</span> (Grass) - horizontal
                stem growing along ground with long internodes
              </li>
              <li>
                <span className="font-semibold text-green-800">Stolon</span> (Strawberry) -
                prostrate stem with short internodes, produces plantlets at nodes
              </li>
              <li>
                <span className="font-semibold text-green-800">Offset</span> (Water
                hyacinth/Eichhornia) - short lateral branch for vegetative reproduction
              </li>
              <li>
                <span className="font-semibold text-green-800">Sucker</span> (Mint) - underground
                lateral stem that produces adventitious roots and shoots
              </li>
            </ul>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              <span className="font-semibold text-green-800">Leaves</span> are the primary
              photosynthetic organs. A typical leaf consists of a{' '}
              <span className="font-semibold text-green-800">lamina</span> (blade),{' '}
              <span className="font-semibold text-green-800">petiole</span> (stalk), and{' '}
              <span className="font-semibold text-green-800">leaf base</span>.
            </p>

            <p>
              <strong>Venation Patterns:</strong>
            </p>
            <ul className="list-disc list-inside space-y-2">
              <li>
                <span className="font-semibold text-green-800">Reticulate venation</span> - net-like
                vein pattern; found in dicots
              </li>
              <li>
                <span className="font-semibold text-green-800">Parallel venation</span> - parallel
                veins; found in monocots
              </li>
            </ul>

            <p>
              <strong>Leaf Types:</strong>
            </p>
            <ul className="list-disc list-inside space-y-2">
              <li>
                <span className="font-semibold text-green-800">Simple leaves</span> - single lamina
                (e.g., mango)
              </li>
              <li>
                <span className="font-semibold text-green-800">Compound leaves</span> - lamina
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800">
              <strong>NEET TIP:</strong> Spines of cactus are modified{' '}
              <span className="font-semibold">LEAVES</span>. Thorns of Bougainvillea are modified{' '}
              <span className="font-semibold">STEM</span> (axillary bud). Tendrils of pea are
              modified <span className="font-semibold">LEAF</span>. Tendrils of grape are modified{' '}
              <span className="font-semibold">STEM</span>.{' '}
              <span className="font-semibold">Very frequently confused in NEET!</span>
            </div>

            <p>
              <strong>Phyllotaxy (Leaf Arrangement):</strong>
            </p>
            <ul className="list-disc list-inside space-y-2">
              <li>
                <span className="font-semibold text-green-800">Alternate</span> - one leaf per node
                on alternate sides (Sunflower)
              </li>
              <li>
                <span className="font-semibold text-green-800">Opposite</span> - two leaves per node
                on opposite sides (Calotropis)
              </li>
              <li>
                <span className="font-semibold text-green-800">Whorled</span> - three or more leaves
                per node (Alstonia)
              </li>
            </ul>

            <p>
              <strong>Leaf Modifications:</strong>
            </p>
            <ul className="list-disc list-inside space-y-2">
              <li>
                <span className="font-semibold text-green-800">Tendril</span> (Pea) - modified leaf
                for climbing; terminal leaflet becomes tendril
              </li>
              <li>
                <span className="font-semibold text-green-800">Spine</span> (Cactus) - modified leaf
                for protection; reduces transpiration in xerophytes
              </li>
              <li>
                <span className="font-semibold text-green-800">Storage leaves</span> (Onion) -
                fleshy leaves storing food &amp; water
              </li>
              <li>
                <span className="font-semibold text-green-800">Phyllode</span> (Australian Acacia) -
                petiole becomes flattened &amp; leaf-like; performs photosynthesis
              </li>
              <li>
                <span className="font-semibold text-green-800">Insectivorous leaves:</span>
                <ul className="list-circle list-inside ml-4 space-y-1">
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              <span className="font-semibold text-green-800">Inflorescence</span> is the arrangement
              of flowers on the main axis of the plant.{' '}
              <span className="font-semibold text-green-800">Flower</span> is the reproductive organ
              containing male &amp; female parts.
            </p>

            <p>
              <strong>Types of Inflorescence:</strong>
            </p>
            <p>
              <span className="font-semibold text-green-800">Racemose Inflorescence</span> (main
              axis shows unlimited growth):
            </p>
            <ul className="list-disc list-inside space-y-2">
              <li>
                <span className="font-semibold text-green-800">Raceme</span> - flowers on pedicels
                arising from main axis (mustard)
              </li>
              <li>
                <span className="font-semibold text-green-800">Spike</span> - flowers sessile on
                main axis (wheat)
              </li>
              <li>
                <span className="font-semibold text-green-800">Umbel</span> - pedicels arise from
                same point on axis (carrot, fennel)
              </li>
              <li>
                <span className="font-semibold text-green-800">Capitulum</span> - flat receptacle
                with many sessile flowers (Sunflower) -{' '}
                <span className="font-semibold">NOT a single flower</span>
              </li>
            </ul>

            <p>
              <span className="font-semibold text-green-800">Cymose Inflorescence</span> (main axis
              shows limited growth):
            </p>
            <ul className="list-disc list-inside space-y-2">
              <li>
                <span className="font-semibold text-green-800">Monochasial cyme</span> - one lateral
                branch at each node
              </li>
              <li>
                <span className="font-semibold text-green-800">Dichasial cyme</span> - two lateral
                branches at each node
              </li>
              <li>
                <span className="font-semibold text-green-800">Polychasial cyme</span> - more than
                two lateral branches at each node
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                <span className="font-semibold text-green-800">Calyx</span> - outermost whorl;
                consists of sepals (protective function)
              </li>
              <li>
                <span className="font-semibold text-green-800">Corolla</span> - second whorl;
                consists of petals (colorful, attracts pollinators)
              </li>
              <li>
                <span className="font-semibold text-green-800">Androecium</span> - third whorl; male
                reproductive organ consisting of stamens (filament + anther)
              </li>
              <li>
                <span className="font-semibold text-green-800">Gynoecium</span> - fourth whorl;
                female reproductive organ consisting of pistil (stigma + style + ovary)
              </li>
            </ul>

            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800">
              <strong>NEET TIP:</strong> Capitulum is an{' '}
              <span className="font-semibold">INFLORESCENCE</span> of sunflower, not a single
              flower. Pea flower has <span className="font-semibold">vexillary aestivation</span>{' '}
              (papilionaceous). Placentation types are{' '}
              <span className="font-semibold">HIGH FREQUENCY</span>. Mustard = parietal, Pea =
              marginal, Lemon = axile.
            </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              NEET frequently tests the{' '}
              <span className="font-semibold text-green-800">
                key characteristics, floral formulae, and economic importance
              </span>{' '}
              of these three major flowering plant families. All three family details are{' '}
              <span className="font-semibold">EXTREMELY HIGH frequency in NEET.</span>
            </p>

            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800">
              <strong>NEET TIP:</strong> Fabaceae has{' '}
              <span className="font-semibold">
                MARGINAL placentation + diadelphous (9+1) stamens
              </span>
              . Solanaceae has{' '}
              <span className="font-semibold">AXILE placentation + epipetalous stamens</span>.
              Liliaceae is <span className="font-semibold">TRIMEROUS (3-merous)</span>. Remember the
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                <span className="font-semibold text-green-800">Fabaceae:</span> Pulses (pea, gram,
                lentil), nitrogen fixation through root nodules, animal feed, edible oils
                (groundnut)
              </li>
              <li>
                <span className="font-semibold text-green-800">Solanaceae:</span> Food crops
                (potato, tomato, eggplant), condiments (chili, black pepper), medicinal plants
                (Belladonna), alkaloid production (tobacco)
              </li>
              <li>
                <span className="font-semibold text-green-800">Liliaceae:</span> Vegetables (onion,
                garlic), spices (asafoetida), medicinal uses (Aloe vera), ornamental flowers (lily,
                tulip)
              </li>
            </ul>

            <p>
              <strong>Key Distinguishing Features for NEET:</strong>
            </p>
            <ul className="list-disc list-inside space-y-2">
              <li>
                <strong>Fabaceae vs Others:</strong> Diadelphous stamens (9+1) + Marginal
                placentation = unique to Fabaceae
              </li>
              <li>
                <strong>Solanaceae vs Liliaceae:</strong> Solanaceae is dicot (reticulate venation,
                tap root); Liliaceae is monocot (parallel venation, fibrous root)
              </li>
              <li>
                <strong>Solanaceae vs Fabaceae:</strong> Axile placentation (Solanaceae) vs Marginal
                placentation (Fabaceae); Epipetalous stamens (Solanaceae) vs Diadelphous stamens
                (Fabaceae)
              </li>
              <li>
                <strong>Liliaceae Feature:</strong> Trimerous flowers (3-merous) - 6 tepals, 6
                stamens, 3 carpels (or multiples of 3)
              </li>
            </ul>
          </div>
        ),
          ...
          <div className="space-y-4">
            <div>
              ...
              <ul className="list-disc list-inside ml-2 text-sm">
                <li>
                  <span className="font-semibold text-green-800">Apical meristem:</span> Root and
                  shoot tips — primary growth
                </li>
                <li>
                  <span className="font-semibold text-green-800">Lateral meristem:</span> Vascular
                  cambium (secondary xylem/phloem) &amp; cork cambium
                </li>
                <li>
                  <span className="font-semibold text-green-800">Intercalary meristem:</span> Base
                  of internodes in grasses
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside ml-2 text-sm">
                <li>
                  <span className="font-semibold text-green-800">Parenchyma:</span> Thin walls,
                  living, storage &amp; photosynthesis
                </li>
                <li>
                  <span className="font-semibold text-green-800">Collenchyma:</span> Corner
                  thickening, flexible, below epidermis
                </li>
                <li>
                  <span className="font-semibold text-green-800">Sclerenchyma:</span> Uniformly
                  thick, lignified, dead (fibres &amp; sclereids)
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside ml-2 text-sm">
                <li>
                  <span className="font-semibold text-green-800">Xylem:</span> Tracheids, vessels,
                  xylem parenchyma, xylem fibres — water transport
                </li>
                <li>
                  <span className="font-semibold text-green-800">Phloem:</span> Sieve tubes,
                  companion cells, phloem parenchyma, phloem fibres — food transport
                </li>
              </ul>
            </div>
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800 text-sm">
              ...
              parenchyma). Phloem = living (except phloem fibres). Vessels absent in gymnosperms
              (only tracheids). Companion cells UNIQUE to angiosperms.
            </div>
          </div>
        ),
      },
        ...
        content: (
          <div className="space-y-4">
            <div>
              ...
              <ul className="list-disc list-inside ml-2 text-sm">
                <li>
                  Epidermis (with root hairs) → Cortex (parenchyma) → Endodermis (Casparian strips)
                  → Pericycle → Vascular bundles (radial, xylem 2–6 = diarch to hexarch) → Pith
                  (small/absent)
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside ml-2 text-sm">
                <li>
                  Epidermis → Cortex → Endodermis (Casparian strips) → Pericycle → Vascular bundles
                  (radial, xylem polyarch = many protoxylem points) → Pith (large)
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside ml-2 text-sm">
                <li>
                  <span className="font-semibold text-green-800">Casparian strip:</span> Waterproof
                  suberin barrier in endodermis, forces water through symplastic pathway
                </li>
                <li>
                  <span className="font-semibold text-green-800">Passage cells:</span> Thin-walled
                  endodermal cells opposite protoxylem for water passage
                </li>
              </ul>
            </div>
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800 text-sm">
              ...
              (diarch-hexarch). Monocot = polyarch (many arms). Casparian strips force water into
              symplast. Secondary growth ONLY in dicot roots (vascular cambium).
            </div>
          </div>
        ),
      },
        ...
        content: (
          <div className="space-y-4">
            <div>
              ...
              <ul className="list-disc list-inside ml-2 text-sm">
                <li>
                  Epidermis → Cortex (collenchyma + parenchyma) → Endodermis → Pericycle → Vascular
                  bundles (conjoint, collateral, OPEN = cambium present, ring arrangement) → Pith
                  (central)
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside ml-2 text-sm">
                <li>
                  Epidermis → Hypodermis (sclerenchyma) → Ground tissue → Vascular bundles
                  (conjoint, collateral, CLOSED = no cambium, SCATTERED, surrounded by sclerenchyma
                  sheath) → No distinct pith
                </li>
              </ul>
            </div>
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800 text-sm">
              ...
              RING arrangement → secondary growth. Monocot = CLOSED bundles + SCATTERED → NO
              secondary growth. MOST asked anatomy topic.
            </div>
          </div>
        ),
      },
        ...
        content: (
          <div className="space-y-4">
            <div>
              ...
              <ul className="list-disc list-inside ml-2 text-sm">
                <li>
                  <span className="font-semibold text-green-800">Intrafascicular cambium:</span>{' '}
                  Within vascular bundles
                </li>
                <li>
                  <span className="font-semibold text-green-800">Interfascicular cambium:</span>{' '}
                  Between bundles → forms complete cambium ring
                </li>
                <li>
                  Produces secondary xylem (inward) + secondary phloem (outward). More xylem than
                  phloem produced
                </li>
                <li>
                  <span className="font-semibold text-green-800">Heartwood &amp; Sapwood:</span>{' '}
                  Heartwood = dark, dead, filled with tannins/resins (central). Sapwood = light,
                  living, functional (peripheral)
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside ml-2 text-sm">
                ...
                <li>
                  Produces phellem (cork, outer, dead) + phelloderm (secondary cortex, inner,
                  living)
                </li>
                <li>
                  Together called <span className="font-semibold text-green-800">Periderm</span>{' '}
                  (replaces epidermis)
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside ml-2 text-sm">
                <li>
                  <span className="font-semibold text-green-800">Spring wood:</span> Large vessels,
                  light colour (rapid growth)
                </li>
                <li>
                  <span className="font-semibold text-green-800">Autumn wood:</span> Small vessels,
                  dark colour (slow growth)
                </li>
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800 text-sm">
              ...
              xylem INWARD and secondary phloem OUTWARD. More xylem than phloem. Annual rings =
              spring wood + autumn wood. Heartwood = non-functional but durable. Bark = all tissues
        ...
        content: (
          <div className="space-y-4">
            <div>
              ...
              <ul className="list-disc list-inside ml-2 text-sm">
                <li>
                  Upper epidermis (few/no stomata) →{' '}
                  <span className="font-semibold text-green-800">Palisade mesophyll</span>{' '}
                  (elongated, tightly packed, more chloroplasts) →{' '}
                  <span className="font-semibold text-green-800">Spongy mesophyll</span> (loosely
                  packed, intercellular air spaces) → Lower epidermis (more stomata)
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside ml-2 text-sm">
                ...
                <li>
                  <span className="font-semibold text-green-800">Bulliform cells:</span> Large motor
                  cells present, cause leaf rolling in drought
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside ml-2 text-sm">
                ...
                <li>
                  <span className="font-semibold text-green-800">Bundle sheath cells:</span> Large,
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800 text-sm">
              ...
              lower). Monocot = isobilateral (stomata both sides). Bulliform cells UNIQUE to
              monocots (leaf rolling in drought). Kranz anatomy = C4 plants ONLY.
            </div>
          </div>
        ),
      },
    ...
    topics: [
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              Epithelial tissues form protective, absorptive, and secretory surfaces throughout the
              body.
            </p>
            ...
            <div className="space-y-2">
              <p>
                <span className="font-semibold text-green-800">Glandular Epithelium:</span>
              </p>
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  <span className="font-semibold text-green-800">Exocrine glands:</span> Have ducts,
                  secrete to surface (sweat glands, salivary glands, sebaceous glands)
                </li>
                <li>
                  <span className="font-semibold text-green-800">Endocrine glands:</span> Ductless,
                  secrete hormones directly to blood (thyroid, pituitary, adrenal)
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-2">
              <p>
                <span className="font-semibold text-green-800">Key Features:</span> Cells tightly
                packed with minimal intercellular matrix, rest on basement membrane, avascular (no
                blood vessels)
              </p>
              <p>
                <span className="font-semibold text-green-800">Functions:</span> Protection,
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800">
              <p>
                <span className="font-semibold">NEET TIP:</span> Simple squamous in blood vessels =
                ENDOTHELIUM; in body cavities = MESOTHELIUM. Transitional epithelium = stretches
                (urinary bladder). Compound epithelium = protection; Simple = secretion/absorption.
              </p>
            </div>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              Connective tissues are the most abundant tissues, providing structural support with
            ...
            <div className="space-y-2">
              <p>
                <span className="font-semibold text-green-800">Blood Composition:</span>
              </p>
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  <span className="font-semibold text-green-800">Plasma (55%):</span> Water,
                  proteins (albumin, globulins, fibrinogen), dissolved substances
                </li>
                <li>
                  <span className="font-semibold text-green-800">RBCs (Erythrocytes):</span> No
                  nucleus in mammals, biconcave disc, contain haemoglobin for O₂ transport
                </li>
                <li>
                  <span className="font-semibold text-green-800">WBCs (Leukocytes):</span>{' '}
                  Granulocytes (neutrophils, eosinophils, basophils) &amp; agranulocytes
                  (lymphocytes, monocytes)
                </li>
                <li>
                  <span className="font-semibold text-green-800">Platelets (Thrombocytes):</span>{' '}
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800">
              <p>
                <span className="font-semibold">NEET TIP:</span> Tendon = muscle to bone
                (inelastic); Ligament = bone to bone (elastic). RBCs lack nucleus in mammals.
                Cartilage = avascular; Bone = vascular (Haversian canals). Adipose tissue stores fat
                in white (energy) &amp; brown (heat) forms.
              </p>
            </div>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              Muscle tissues are specialized for contraction, enabling movement and force
              generation.
            </p>
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  <span className="font-semibold text-green-800">Z-line (Z-disc):</span> Boundaries
                  of sarcomere
                </li>
                <li>
                  <span className="font-semibold text-green-800">A-band (Anisotropic):</span> Dark
                  band containing thick myosin filaments &amp; partial thin actin filaments
                </li>
                <li>
                  <span className="font-semibold text-green-800">I-band (Isotropic):</span> Light
                  band containing only thin actin filaments
                </li>
                <li>
                  <span className="font-semibold text-green-800">H-zone (Hensen's zone):</span>{' '}
                  Central region of A-band with only myosin
                </li>
                <li>
                  <span className="font-semibold text-green-800">M-line:</span> Centre of H-zone
            ...
            <div className="space-y-2">
              <p>
                <span className="font-semibold text-green-800">
                  Intercalated Discs (Cardiac muscle only):
                </span>{' '}
                Specialized junctions containing gap junctions &amp; desmosomes that allow
                synchronized contraction between cardiac cells
              </p>
            </div>

            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800">
              <p>
                <span className="font-semibold">NEET TIP:</span> Cardiac muscle = striated BUT
                involuntary (unique combination). Intercalated discs = ONLY in cardiac muscle.
                Skeletal = only VOLUNTARY muscle. Smooth muscle = fusiform shape, spindle-shaped
                cells. Contraction: Thin (actin) &amp; thick (myosin) filaments slide over each
                other.
              </p>
            </div>
          </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              Neural tissue is specialized for electrical signaling and rapid communication
              throughout the body.
            </p>

            <div className="space-y-2">
              <p>
                <span className="font-semibold text-green-800">Neuron Structure:</span>
              </p>
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  <span className="font-semibold text-green-800">Cell body (Soma/Cyton):</span>{' '}
                  Contains nucleus, organelles, produces neurotransmitters
                </li>
                <li>
                  <span className="font-semibold text-green-800">Dendrites:</span> Multiple, short,
                  branched processes that receive impulses from other neurons
                </li>
                <li>
                  <span className="font-semibold text-green-800">Axon:</span> Single, long process
                  that transmits impulses away from cell body to other neurons/muscles
                </li>
                <li>
                  <span className="font-semibold text-green-800">Myelin sheath:</span> Insulating
                  layer formed by Schwann cells (PNS) or oligodendrocytes (CNS)
                </li>
                <li>
                  <span className="font-semibold text-green-800">Nodes of Ranvier:</span> Gaps in
                  myelin sheath between Schwann cells
                </li>
                <li>
                  <span className="font-semibold text-green-800">Synaptic knob (Terminal):</span>{' '}
                  Enlarged end of axon containing neurotransmitter vesicles
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-2">
              <p>
                <span className="font-semibold text-green-800">Neuron Types by Function:</span>
              </p>
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  <span className="font-semibold text-green-800">Sensory neurons (Afferent):</span>{' '}
                  Carry impulses from receptors to CNS
                </li>
                <li>
                  <span className="font-semibold text-green-800">Motor neurons (Efferent):</span>{' '}
            ...
            <div className="space-y-2">
              <p>
                <span className="font-semibold text-green-800">Neuron Types by Structure:</span>
              </p>
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  <span className="font-semibold text-green-800">Unipolar:</span> Single process
                  from cell body (sensory neurons)
                </li>
                <li>
                  <span className="font-semibold text-green-800">Bipolar:</span> Two processes, one
                  dendrite &amp; one axon (retina, olfactory epithelium)
                </li>
                <li>
                  <span className="font-semibold text-green-800">Multipolar:</span> Many dendrites
                  &amp; one axon (most common, cerebral cortex, motor neurons)
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-2">
              <p>
                <span className="font-semibold text-green-800">
                  Neuroglia (Support cells, ~50% of CNS cells):
                </span>
              </p>
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  <span className="font-semibold text-green-800">Astrocytes:</span> Provide
                  structural &amp; metabolic support, control extracellular K⁺
                </li>
                <li>
                  <span className="font-semibold text-green-800">Oligodendrocytes:</span> Form
                  myelin in CNS (one cell myelinates multiple axons)
                </li>
                <li>
                  <span className="font-semibold text-green-800">Microglia:</span> Immune cells,
                  phagocytose pathogens &amp; debris
                </li>
                <li>
                  <span className="font-semibold text-green-800">Ependymal cells:</span> Produce
                  cerebrospinal fluid
                </li>
                <li>
                  <span className="font-semibold text-green-800">Schwann cells:</span> Form myelin
                  in PNS (one cell for one segment)
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-2">
              <p>
                <span className="font-semibold text-green-800">Synapse:</span> Junction between
                neurons allowing impulse transmission
              </p>
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  <span className="font-semibold text-green-800">Presynaptic membrane:</span> Axon
                  terminal of transmitting neuron with neurotransmitter vesicles
                </li>
                <li>
                  <span className="font-semibold text-green-800">Synaptic cleft:</span> 20 nm gap
                  between neurons
                </li>
                <li>
                  <span className="font-semibold text-green-800">Postsynaptic membrane:</span>{' '}
                  Membrane of receiving neuron with receptors
                </li>
                <li>
                  <span className="font-semibold text-green-800">Common neurotransmitters:</span>{' '}
                  Acetylcholine (skeletal muscle), Dopamine (movement), GABA (inhibitory), Glutamate
                  (excitatory)
                </li>
              </ul>
            </div>
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800">
              <p>
                <span className="font-semibold">NEET TIP:</span> Myelinated axons = faster
                conduction (saltatory conduction). Nodes of Ranvier = gaps in myelin sheath. Most
                neurons are multipolar. Schwann cells form myelin in PNS; oligodendrocytes in CNS
                (one oligodendrocyte myelinates multiple axons). Synapse is ONE-WAY transmission.
              </p>
            </div>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              The cockroach is a commonly studied arthropod specimen representing insect external
              &amp; internal anatomy.
            </p>

            <div className="space-y-2">
              <p>
                <span className="font-semibold text-green-800">External Morphology:</span>
              </p>
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  <span className="font-semibold text-green-800">Head:</span> Compound eyes (facets
                  for vision), pair of antennae (long, segmented, sensory), mouthparts (labrum,
                  mandibles for cutting, maxillae with palps, labium)
                </li>
                <li>
                  <span className="font-semibold text-green-800">Thorax:</span> 3 segments, each
                  with pair of jointed legs, first 2 segments with wings (tegmina = leathery
                  forewings, membranous hindwings)
                </li>
                <li>
                  <span className="font-semibold text-green-800">Abdomen:</span> 10 visible
                  segments, 11th segment reduced, anal cerci (paired posterior appendages), males
                  have anal styles
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-2">
              <p>
                <span className="font-semibold text-green-800">Haemolymph (Insect Blood):</span>{' '}
                Colourless fluid WITHOUT respiratory pigments (no haemoglobin), does NOT transport
                oxygen; oxygen transport via direct tracheae to tissues
              </p>
            </div>

            <div className="space-y-2">
              <p>
                <span className="font-semibold text-green-800">Distinguishing Features:</span>
              </p>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800">
              <p>
                <span className="font-semibold">NEET TIP:</span> Cockroach is URICOTELIC (excretes
                uric acid). Blood = haemolymph (NO haemoglobin, NO O₂ transport). 10 pairs spiracles
                (2 thoracic + 8 abdominal). Malpighian tubules for excretion. Males have anal styles
                (females lack). Hepatic caeca = 6-8 at junction of foregut-midgut. Compound eyes,
                long antennae for sensory input. Tegmina + membranous wings on thorax.
              </p>
            </div>
          </div>
        ),
    ...
    topics: [
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              <span className="font-semibold text-green-800">Location:</span> Thylakoid membrane
              (grana lamellae) of chloroplasts.
            </p>

            <p>
              <span className="font-semibold text-green-800">Photosystems:</span>{' '}
              <span className="font-semibold text-green-800">Photosystem II (P680)</span> absorbs
              light at 680 nm wavelength.{' '}
              <span className="font-semibold text-green-800">Photosystem I (P700)</span> absorbs
              light at 700 nm wavelength. PS II is involved in photolysis of water &amp; occurs on
              the lumen side.
            </p>

            <p>
              <span className="font-semibold text-green-800">Photolysis of Water:</span> 2H
              <sub>2</sub>O → 4H<sup>+</sup> + 4e<sup>−</sup> + O<sub>2</sub>. Occurs at PS II
              through the{' '}
              <span className="font-semibold text-green-800">Oxygen Evolving Complex (OEC)</span>. O
              <sub>2</sub> is released as a byproduct (Hill proved O<sub>2</sub> comes from water,
              not CO<sub>2</sub>).
            </p>

            <p>
              <span className="font-semibold text-green-800">Electron Transport Chain:</span> PS II
              → Plastoquinone (PQ) → Cytochrome b<sub>6</sub>f complex → Plastocyanin (PC) → PS I →
              Ferredoxin (Fd) → NADP<sup>+</sup> reductase → NADPH formation.
            </p>
            ...
            <p>
              ...
              H<sup>+</sup> ions accumulate in thylakoid lumen creating a proton gradient
              (electrochemical gradient). This gradient drives ATP synthase (CF<sub>0</sub>-CF
              <sub>1</sub>) to phosphorylate ADP into ATP. This process is called
              photophosphorylation.
            </p>

            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800">
              <p>
                <span className="font-semibold">NEET TIP:</span> O<sub>2</sub> comes from WATER (not
                CO<sub>2</sub>) — proved by Hill &amp; Ruben. PS II has P680, PS I has P700. Cyclic
                photophosphorylation produces ONLY ATP, no NADPH, no O<sub>2</sub>. Non-cyclic
                produces both ATP &amp; NADPH. Photolysis occurs at PS II lumen side with the OEC.
                Photolysis: 2H<sub>2</sub>O → O<sub>2</sub> + 4e<sup>−</sup> + 4H<sup>+</sup>.
              </p>
            </div>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              <span className="font-semibold text-green-800">Location &amp; Discovery:</span> Occurs
              in the stroma of chloroplasts. Discovered by{' '}
              <span className="font-semibold text-green-800">Melvin Calvin</span> (also called the
              Calvin-Benson cycle or reductive pentose phosphate cycle).
            </p>

            <p>
              <span className="font-semibold text-green-800">Three Phases of Calvin Cycle:</span>
            </p>
            <ul className="list-disc ml-5 space-y-2 text-sm">
              <li>
                <span className="font-semibold text-green-800">Carbon Fixation:</span> CO
                <sub>2</sub> combines with RuBP (ribulose-1,5-bisphosphate) via the enzyme{' '}
                <span className="font-semibold text-green-800">RuBisCO</span> to form
                3-phosphoglycerate (3-PGA, 3C compound). Reaction: CO<sub>2</sub> + RuBP (5C) → 2 ×
                3-PGA (3C).
              </li>
              <li>
                <span className="font-semibold text-green-800">Reduction Phase:</span> 3-PGA is
                phosphorylated to 1,3-bisphosphoglycerate (ATP used) then reduced to
                glyceraldehyde-3-phosphate (G3P) using NADPH. Energy required: 2 ATP + 2 NADPH per
                3-PGA.
              </li>
              <li>
                <span className="font-semibold text-green-800">Regeneration of RuBP:</span> 5 G3P
                molecules (15C) regenerate 3 RuBP molecules (15C) using ATP. For every 1 G3P that
                exits the cycle, 5 G3P must be regenerated.
              </li>
            </ul>

            <p>
              <span className="font-semibold text-green-800">
                ATP &amp; NADPH Consumption per Glucose:
              </span>{' '}
              To produce 1 glucose (6C), the cycle must turn 6 times, fixing 6 CO<sub>2</sub>{' '}
              molecules. This requires:{' '}
              <span className="font-semibold text-green-800">18 ATP + 12 NADPH</span>.
            </p>
            ...
            <p>
              ...
              Most abundant enzyme on Earth. Has dual enzymatic activity:{' '}
              <span className="font-semibold text-green-800">carboxylase activity</span> (fixes CO
              <sub>2</sub> in Calvin cycle) &amp;{' '}
              <span className="font-semibold text-green-800">oxygenase activity</span> (uses O
              <sub>2</sub> instead, initiates photorespiration).
            </p>
            ...
            <p>
              ...
              first fixed in mesophyll cells via{' '}
              <span className="font-semibold text-green-800">PEP carboxylase</span> (more efficient
              than RuBisCO) to form OAA, then transported to bundle sheath cells where Calvin cycle
              operates. This concentrates CO<sub>2</sub> around RuBisCO, reducing oxygenase
              activity.
            </p>
            ...
            <p>
              ...
              Succulent plants like{' '}
              <span className="font-semibold text-green-800">
                Opuntia (prickly pear), pineapple, agave
              </span>
              . Stomata open at NIGHT to fix CO<sub>2</sub> into malic acid &amp; stored in
              vacuoles. Calvin cycle operates during the DAY using stored CO<sub>2</sub>. Adaptation
              to xeric (dry) conditions.
            </p>

            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800">
              <p>
                <span className="font-semibold">NEET TIP:</span> RuBisCO = both carboxylase +
                oxygenase enzyme. C3 first product = 3-PGA (3-carbon compound). C4 first product =
                OAA (4-carbon oxaloacetate). C4 plants have special{' '}
                <span className="font-semibold">Kranz anatomy</span> with bundle sheath cells
                surrounding veins. Photorespiration = wasteful process using O<sub>2</sub>, releases
                CO<sub>2</sub>, consumes ATP, produces no useful products. C4 &amp; CAM plants
                minimize photorespiration. CAM = nocturnal stomatal opening.
              </p>
            </div>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              <span className="font-semibold text-green-800">Location &amp; Universality:</span>{' '}
              Occurs in the cytoplasm/cytosol. Universal pathway common to ALL organisms (both
              aerobic &amp; anaerobic). Does NOT require oxygen.
            </p>

            <p>
              <span className="font-semibold text-green-800">Overall Reaction:</span> Glucose (C
              <sub>6</sub>H<sub>12</sub>O<sub>6</sub>) → 2 Pyruvate (C<sub>3</sub>H<sub>4</sub>O
              <sub>3</sub>). Net yield:{' '}
              <span className="font-semibold text-green-800">2 ATP + 2 NADH</span> per glucose.
            </p>

            <p>
              <span className="font-semibold text-green-800">
                Key Steps &amp; Enzymes (10 reactions):
              </span>
            </p>
            <ul className="list-disc ml-5 space-y-2 text-sm">
              <li>
                <span className="font-semibold text-green-800">Glucose activation:</span> Glucose →
                Glucose-6-phosphate (enzyme: hexokinase, uses 1 ATP)
              </li>
              <li>
                <span className="font-semibold text-green-800">Isomerization:</span>{' '}
                Glucose-6-phosphate → Fructose-6-phosphate
              </li>
              <li>
                <span className="font-semibold text-green-800">Second phosphorylation:</span>{' '}
                Fructose-6-phosphate → Fructose-1,6-bisphosphate (enzyme:{' '}
                <span className="font-semibold text-green-800">phosphofructokinase (PFK)</span> —
                rate-limiting enzyme, uses 1 ATP)
              </li>
              <li>
                <span className="font-semibold text-green-800">Cleavage:</span>{' '}
                Fructose-1,6-bisphosphate → 2 × Glyceraldehyde-3-phosphate (G3P)
              </li>
              <li>
                <span className="font-semibold text-green-800">
                  Oxidation &amp; phosphorylation:
                </span>{' '}
                2 × G3P → 2 × 1,3-bisphosphoglycerate (uses NADH, produces 2 NADH)
              </li>
              <li>
                <span className="font-semibold text-green-800">First ATP formation:</span> 2 ×
                1,3-bisphosphoglycerate → 2 × 3-phosphoglycerate (produces 2 ATP)
              </li>
              <li>
                <span className="font-semibold text-green-800">Phosphoryl group shift:</span> 2 ×
                3-phosphoglycerate → 2 × 2-phosphoglycerate
              </li>
              <li>
                <span className="font-semibold text-green-800">Dehydration:</span> 2 ×
                2-phosphoglycerate → 2 × Phosphoenolpyruvate (PEP)
              </li>
              <li>
                <span className="font-semibold text-green-800">Second ATP formation:</span> 2 × PEP
                → 2 × Pyruvate (enzyme: pyruvate kinase, produces 2 ATP)
              </li>
            </ul>

            <p>
              <span className="font-semibold text-green-800">ATP Summary:</span> Investment phase =
              2 ATP used. Payoff phase = 4 ATP produced.{' '}
              <span className="font-semibold text-green-800">Net ATP gain = 2 ATP per glucose</span>
              .
            </p>
            ...
            <p>
              ...
              Process that regenerates NAD<sup>+</sup> from NADH to allow glycolysis to continue
              without oxygen.
            </p>
            <ul className="list-disc ml-5 space-y-2 text-sm">
              <li>
                <span className="font-semibold text-green-800">Alcoholic Fermentation:</span> Occurs
                in yeast &amp; some bacteria. Pyruvate → Ethanol + CO<sub>2</sub>. Enzymes: pyruvate
                decarboxylase (removes CO<sub>2</sub>) &amp; alcohol dehydrogenase (reduces
                acetaldehyde to ethanol). Used in bread-making, beer &amp; wine production.
              </li>
              <li>
                <span className="font-semibold text-green-800">Lactic Acid Fermentation:</span>{' '}
                Occurs in muscle cells &amp; lactobacilli. Pyruvate → Lactic acid. Enzyme: lactate
                dehydrogenase. Occurs during intense exercise when O<sub>2</sub> is insufficient.
              </li>
            </ul>

            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800">
              <p>
                <span className="font-semibold">NEET TIP:</span> Glycolysis = 10 sequential steps,
                universally conserved. 2 ATP invested (priming phase), 4 ATP produced (payoff
                phase), NET = 2 ATP gain.{' '}
                <span className="font-semibold">PFK (phosphofructokinase)</span> is the
                rate-limiting/key regulatory enzyme. Fermentation = incomplete oxidation, occurs in
                cytoplasm WITHOUT oxygen. Alcoholic fermentation used in bread/beer making (produces
                CO<sub>2</sub>). Lactic acid fermentation causes muscle fatigue during intense
                exercise.
              </p>
            </div>
          </div>
        ...
        content: (
          <div className="space-y-4">
            <p>
              ...
              Pyruvate (3C) enters mitochondrial matrix where enzyme{' '}
              <span className="font-semibold text-green-800">pyruvate dehydrogenase complex</span>{' '}
              converts it to Acetyl CoA (2C) + CO<sub>2</sub> + NADH. Produces 1 NADH per pyruvate.
              For 1 glucose: 2 Acetyl CoA formed.
            </p>
            ...
            <p>
              ...
              Occurs in mitochondrial matrix. Circular pathway where Acetyl CoA (2C) combines with
              Oxaloacetate (4C) to form Citrate (6C), which is progressively oxidized, releasing 2
              CO<sub>2</sub> molecules, regenerating Oxaloacetate.
            </p>

            <p>
              <span className="font-semibold text-green-800">Krebs Cycle Steps:</span>
            </p>
            <ul className="list-disc ml-5 space-y-1 text-sm">
              <li>Acetyl CoA + Oxaloacetate → Citrate (enzyme: citrate synthase)</li>
              <li>Citrate → Isocitrate (enzyme: aconitase)</li>
              <li>
                Isocitrate → α-Ketoglutarate + CO<sub>2</sub> + NADH (enzyme: isocitrate
                dehydrogenase)
              </li>
              <li>
                α-Ketoglutarate → Succinyl CoA + CO<sub>2</sub> + NADH (enzyme: α-ketoglutarate
                dehydrogenase)
              </li>
              <li>
                Succinyl CoA → Succinate + GTP (or ATP) (enzyme: succinyl CoA synthetase) — only
                substrate-level phosphorylation in Krebs
              </li>
              <li>
                Succinate → Fumarate + FADH<sub>2</sub> (enzyme: succinate dehydrogenase)
              </li>
            ...
            <p>
              <span className="font-semibold text-green-800">Products per Acetyl CoA:</span> 3 NADH
              + 1 FADH<sub>2</sub> + 1 GTP (≈ATP) + 2 CO<sub>2</sub>. Per glucose (2 Acetyl CoA): 6
              NADH + 2 FADH<sub>2</sub> + 2 GTP + 4 CO<sub>2</sub>.
            </p>

            <p>
              <span className="font-semibold text-green-800">Electron Transport Chain (ETC):</span>{' '}
              Located on inner mitochondrial membrane (cristae). Series of protein complexes
              transfer electrons &amp; pump H<sup>+</sup> ions.
            </p>

            <p>
              <span className="font-semibold text-green-800">ETC Complexes:</span>
            </p>
            <ul className="list-disc ml-5 space-y-1 text-sm">
              <li>
                <span className="font-semibold text-green-800">
                ...
                NADH → Ubiquinone (UQ). Pumps 4 H<sup>+</sup>
              </li>
              <li>
                <span className="font-semibold text-green-800">
                  Complex II (Succinate dehydrogenase):
                </span>{' '}
                FADH<sub>2</sub> → Ubiquinone. Pumps 0 H<sup>+</sup> (only transfers electrons)
              </li>
              <li>
                <span className="font-semibold text-green-800">
                  Complex III (Cytochrome bc<sub>1</sub>):
                </span>{' '}
                Ubiquinone → Cytochrome c. Pumps 4 H<sup>+</sup>
              </li>
              <li>
                <span className="font-semibold text-green-800">
                  Complex IV (Cytochrome c oxidase):
                </span>{' '}
                Cytochrome c → O<sub>2</sub>. Pumps 2 H<sup>+</sup>. O<sub>2</sub> is final electron
                acceptor forming H<sub>2</sub>O
              </li>
              <li>
                <span className="font-semibold text-green-800">Complex V (ATP synthase):</span> H
                <sup>+</sup> gradient → ATP synthesis via chemiosmosis
              </li>
            </ul>

            <p>
              <span className="font-semibold text-green-800">Electron Transport Sequence:</span>{' '}
              NADH → Complex I → UQ → Complex III → Cyt c → Complex IV → O<sub>2</sub> (forms H
              <sub>2</sub>O). FADH<sub>2</sub> enters at Complex II, bypassing Complex I (fewer H
              <sup>+</sup> pumped).
            </p>
            ...
            <p>
              ...
              H<sup>+</sup> gradient (high in matrix, low in intermembrane space) created by
              electron transport drives ATP synthase to phosphorylate ADP + Pi → ATP. Gradient is
              dissipated through ATP synthase channel.
            </p>
            ...
            <p>
              ...
              serves dual roles: <span className="font-semibold text-green-800">Catabolic</span>{' '}
              (breaks down carbon compounds for energy) &amp;{' '}
              <span className="font-semibold text-green-800">Anabolic</span> (intermediates used for
              synthesis of amino acids, nucleotides, fatty acids, chlorophyll).
            </p>

            <p>
              <span className="font-semibold text-green-800">Respiratory Quotient (RQ):</span> RQ =
              CO<sub>2</sub> released / O<sub>2</sub> consumed. For carbohydrates: RQ = 1. For fats:
              RQ &lt; 1 (≈0.7). For proteins: RQ ≈ 0.8-0.9.
            </p>

            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800">
              <p>
                <span className="font-semibold">NEET TIP:</span> Total ATP per glucose ={' '}
                <span className="font-semibold">~30-32 ATP</span> (NOT 36-38 — older calculation). O
                <sub>2</sub> is the final electron acceptor in ETC, producing H<sub>2</sub>O. Krebs
                cycle is <span className="font-semibold">AMPHIBOLIC</span> (both catabolic &amp;
                anabolic). Each NADH yields ~2.5 ATP, each FADH<sub>2</sub> yields ~1.5 ATP
                (accounting for P/O ratios &amp; transport costs). Complex I pumps most H
                <sup>+</sup> (4). Complex II enters at UQ, bypasses Complex I. ATP synthase needs ~3
                H<sup>+</sup> per ATP.
              </p>
            </div>
          </div>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              <span className="font-semibold text-green-800">Phases of Plant Growth:</span>
            </p>
            <ul className="list-disc ml-5 space-y-2 text-sm">
              <li>
                <span className="font-semibold text-green-800">Meristematic Phase:</span> Active
                cell division in meristems. Cells are small, isodiametric, with dense cytoplasm.
              </li>
              <li>
                <span className="font-semibold text-green-800">Elongation Phase:</span> Cells
                increase in size through vacuolation &amp; water uptake. Cell wall expands.
              </li>
              <li>
                <span className="font-semibold text-green-800">
                  Maturation/Differentiation Phase:
                </span>{' '}
                Cells specialize &amp; develop specific structure &amp; function. Growth ceases.
              </li>
            </ul>

            <p>
              <span className="font-semibold text-green-800">Growth Rate Patterns:</span>
            </p>
            <ul className="list-disc ml-5 space-y-2 text-sm">
              <li>
                <span className="font-semibold text-green-800">Arithmetic Growth:</span>{' '}
                Constant/linear increase in size. Length = a + bt (straight line graph). Example:
                root elongation.
              </li>
              <li>
                <span className="font-semibold text-green-800">Geometric/Exponential Growth:</span>{' '}
                Doubling of size in equal time intervals. Length = ae<sup>rt</sup> (exponential
                curve). Example: bacterial population, fungal growth.
              </li>
            </ul>
            ...
            <p>
              ...
              acid (IAA) is primary natural auxin. Produced at shoot apex, transported basipetally
              (downward) in a polar manner. Promotes cell wall loosening via{' '}
              <span className="font-semibold text-green-800">acid growth theory</span> (H
              <sup>+</sup> efflux acidifies cell wall, activating expansins that loosen cellulose).{' '}
              <span className="font-semibold text-green-800">
                Low concentration promotes growth, high concentration inhibits growth
              </span>
              .
            </p>

            <p>
              <span className="font-semibold text-green-800">Gibberellin Function:</span> GA
              <sub>3</sub> (gibberellic acid) is most abundant. Promotes{' '}
              <span className="font-semibold text-green-800">bolting</span> in rosette plants
              (sudden elongation before flowering). Overcomes seed dormancy. Induces enzyme
              production for seed germination (α-amylase for starch breakdown).
            </p>

            <p>
              <span className="font-semibold text-green-800">Cytokinin Role:</span> Promotes cell
              division (cytokinesis). Delays leaf senescence (promotes chlorophyll synthesis).
              Antagonizes apical dominance (promotes lateral bud growth when applied).
            </p>

            <p>
              <span className="font-semibold text-green-800">ABA as Stress Hormone:</span>{' '}
              Accumulates during stress (drought, cold, salinity). Closes stomata by increasing
              turgor loss in guard cells (reduces water loss). Induces dormancy in seeds &amp; buds.
              Inhibits growth.
            </p>

            <p>
              <span className="font-semibold text-green-800">Ethylene Characteristics:</span> ONLY
              gaseous hormone (C<sub>2</sub>H<sub>4</sub>). Promotes fruit ripening (climacteric
              fruits like mango, banana). Triggers senescence &amp; leaf abscission (leaf fall in
              autumn). Shows <span className="font-semibold text-green-800">triple response</span>{' '}
              in seedlings: inhibition of elongation, radial swelling, horizontal growth.
            </p>

            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800">
              <p>
                <span className="font-semibold">NEET TIP:</span>{' '}
                <span className="font-semibold">Auxins</span> = low concentration promotes, high
                inhibits. <span className="font-semibold">ABA</span> = "stress hormone," closes
                stomata in drought, maintains seed dormancy.{' '}
                <span className="font-semibold">Ethylene</span> = ONLY gaseous hormone, promotes
                ripening &amp; senescence. <span className="font-semibold">Gibberellins</span> cause
                bolting (sudden stem elongation in rosette plants).{' '}
                <span className="font-semibold">Cytokinins</span> delay leaf senescence, promote
                lateral bud growth. <span className="font-semibold">Apical dominance</span> =
                suppression of lateral growth by auxin from apex; broken by cytokinins.
              </p>
            </div>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              <span className="font-semibold text-green-800">Photoperiodism:</span> Physiological
              response of plants to the relative length of day &amp; night (photoperiod). Controls
              flowering, dormancy, growth form.{' '}
              <span className="font-semibold text-green-800">Photoreceptor:</span>{' '}
              <span className="font-semibold text-green-800">Phytochrome</span> (blue &amp; red
              light receptor).
            </p>

            <p>
              <span className="font-semibold text-green-800">Phytochrome &amp; Its Forms:</span>{' '}
              Reversible pigment with two interconvertible forms.{' '}
              <span className="font-semibold text-green-800">Pr (red-light absorbing form):</span>{' '}
              Inactive form.{' '}
              <span className="font-semibold text-green-800">
                Pfr (far-red light absorbing form):
              </span>{' '}
              Active form (Pfr is the physiologically active form). Red light converts Pr → Pfr
              (day). Far-red light converts Pfr → Pr (night/darkness). Pfr accumulates during day,
              decays in darkness.
            </p>

            <p>
              <span className="font-semibold text-green-800">
                Categories Based on Critical Photoperiod:
              </span>
            </p>
            <ul className="list-disc ml-5 space-y-2 text-sm">
              <li>
                <span className="font-semibold text-green-800">Short Day Plants (SDP):</span> Flower
                when day length is LESS than critical photoperiod (actually requires long night).
                Examples: rice, tobacco, chrysanthemum, soybean, cotton. Also called "long-night
                plants."
              </li>
              <li>
                <span className="font-semibold text-green-800">Long Day Plants (LDP):</span> Flower
                when day length is MORE than critical photoperiod (requires short night). Examples:
                wheat, barley, radish, spinach, lettuce. Temperate zone plants.
              </li>
              <li>
                <span className="font-semibold text-green-800">Day Neutral Plants:</span> Flowering
                independent of photoperiod (respond to other factors like age). Examples: tomato,
                cucumber, maize, sunflower.
              </li>
            </ul>
            ...
            <p>
              ...
              Critical dark period is actually the determining factor (not day length). Interrupting
              long dark period with a brief light flash (red light creating Pfr) prevents SDP from
              flowering. This demonstrates Pfr is the active form monitoring night length.
            </p>

            <p>
              <span className="font-semibold text-green-800">Vernalisation:</span> Exposure to
              prolonged cold temperatures (low temperature for specific period, typically 4-10°C for
              weeks) required to induce/accelerate flowering. Breaking dormancy to allow flowering.
            </p>

            <p>
              <span className="font-semibold text-green-800">
                Vernalisation Examples &amp; Effect:
              </span>
            </p>
            <ul className="list-disc ml-5 space-y-2 text-sm">
              <li>
                <span className="font-semibold text-green-800">Winter wheat:</span> Requires cold
                (winter vernalisation) to flower. Biennial becomes annual after cold treatment.
              </li>
              <li>
                <span className="font-semibold text-green-800">Cabbage, carrot:</span> Root
                vegetables requiring cold for bolting (flowering). Prevents premature flowering in
                warm seasons.
              </li>
              <li>
                <span className="font-semibold text-green-800">Effect:</span> Cold induces formation
                of flowering hormone(s), increases Gibberellins levels, or causes epigenetic changes
                in FLC (FLOWERING LOCUS C) gene, allowing flowering genes to be expressed.
              </li>
            </ul>

            <p>
              <span className="font-semibold text-green-800">Proposed Vernalisation Hormone:</span>{' '}
              <span className="font-semibold text-green-800">Vernalin</span> (still hypothetical) —
              proposed to be produced in cold-exposed leaves &amp; transported to shoot apex to
              trigger flowering.
            </p>

            <p>
              <span className="font-semibold text-green-800">Seed Dormancy:</span> State of
              metabolic inactivity &amp; arrested growth.{' '}
              <span className="font-semibold text-green-800">Maintenance:</span> ABA maintains
              dormancy (prevents germination).{' '}
              <span className="font-semibold text-green-800">Breaking dormancy:</span> Gibberellins
              (GA<sub>3</sub>) breaks dormancy. Stratification (cold moist treatment, mimics winter)
              overcomes dormancy. Some seeds require light (photoblastism).
            </p>

            <p>
              <span className="font-semibold text-green-800">Stratification:</span> Exposure of
              seeds to cold moist conditions (0-5°C for days/weeks) to break dormancy. Mimics
              natural winter conditions. Softens seed coat, activates enzymes for germination.
            </p>

            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 my-3 text-yellow-800">
              <p>
                <span className="font-semibold">NEET TIP:</span> Critical{' '}
                <span className="font-semibold">
                  photoperiod is determined by dark period length
                </span>{' '}
                (not day length). SDP = actually "long-night plants" (flower with long nights).
                Interrupting dark period with red light flash prevents SDP flowering (Pfr = active
                form). <span className="font-semibold">Phytochrome:</span> Pr (inactive) ↔ Pfr
                (active). Red light (day) → Pfr. Far-red light (night) → Pr. Pfr decays in darkness.
                Vernalisation = cold exposure induces flowering.{' '}
                <span className="font-semibold">ABA maintains dormancy, GA breaks it.</span>{' '}
                Stratification = cold moist treatment breaks seed dormancy. Winter wheat becomes
                capable of flowering after vernalisation.
              </p>
            </div>
          </div>
        ),
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-start justify-between gap-6">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div
                className={`${getDifficultyColor(chapter.difficulty).replace('text-', '').replace('bg-', '').replace('border-', 'bg-')} rounded-lg p-4 text-center border`}
              >
          ...
          {content.topics.map((topic, idx) => (
            <div
              ...
              className={`bg-white rounded-lg border-2 overflow-hidden ${
                activeSection === null || activeSection === topic.title
                  ? 'border-blue-200'
                  : 'border-gray-200'
              }`}
            >
                ...
                <div className="flex items-center gap-3 text-left">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Frequently asked in PYQs:{' '}
                      <span className="font-bold text-blue-600">{topic.pyqFrequency}</span>
                    </p>
                  </div>
                </div>
                <ChevronDown
              ...
              {expandedTopic === idx && (
                <div className="border-t border-gray-200 px-6 py-6 bg-gradient-to-b from-white to-slate-50">
                  {topic.content}
                </div>
              )}
            </div>
      ...
      {/* CTA Section */}
      <div className="bg-gradient-to-r from-indigo-600 to-blue-600 text-white py-12 px-4 sm:px-6 lg:px-8 mt-12">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-center text-indigo-100 text-sm mt-6">Available 24/7</p>
        </div>
      </div>
      ...
      <div className="bg-white border-t border-gray-200 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <p className="text-center text-gray-600 text-sm">
            ...
            <br />
            Regular updates are made to ensure accuracy and relevance for current examination
            standards.
          </p>
        </div>
      </div>
