...
const PAGE_URL = 'https://cerebrumbiologyacademy.com/neet-coaching-near-me-chandigarh'

export const metadata: Metadata = {
  title: 'NEET Coaching Near Me Chandigarh | Cerebrum Biology Academy',
  description: 'NEET Coaching Near Me in Chandigarh — AIIMS-trained faculty, online live. Serving Sector 17, 22, 34, 35, 43, Mohali, Panchkula, Zirakpur. From Rs 48,000/yr.',
  keywords: ['neet coaching near me chandigarh', 'NEET biology chandigarh', 'best NEET chandigarh'],
  alternates: { canonical: PAGE_URL },
  openGraph: { title: 'NEET Coaching Near Me Chandigarh', url: PAGE_URL, locale: 'en_IN', type: 'website' },
}
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">NEET Coaching Near Me in Chandigarh</h1>
          <p className="text-xl text-slate-300 mb-6 max-w-3xl">NEET Biology coaching for Chandigarh (Punjab/Haryana). AIIMS-trained faculty, online live. Serving Sector 17, 22, 34, 35, 43, Mohali, Panchkula, Zirakpur.</p>
