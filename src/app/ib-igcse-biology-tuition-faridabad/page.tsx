...
const WA_LINK =
  'https://wa.me/918826444334?text=Hi%2C%20I%20want%20to%20know%20about%20IB%2FIGCSE%20Biology%20tuition%20in%20Faridabad'

export const metadata: Metadata = {
  title: 'IB & IGCSE Biology Tuition Faridabad | AIIMS Doctor | DPS, Manav Rachna, Apeejay',
  description:
    'IB HL/SL & IGCSE Biology tuition in Faridabad by AIIMS Alumnus. Serving DPS Faridabad, Manav Rachna International School, Apeejay, Ryan International. IA/EE support, dual NEET prep. Visit our Sector 17 centre. Call 88264-44334.',
  keywords:
    'IB biology tuition faridabad, IGCSE biology tuition faridabad, IB biology tutor faridabad, IGCSE biology coaching faridabad, IB HL biology faridabad, international school biology tuition faridabad, DPS faridabad biology tutor, manav rachna biology coaching',
  openGraph: {
    locale: 'en_IN',
    title: 'IB & IGCSE Biology Tuition Faridabad | AIIMS Doctor | DPS, Manav Rachna, Apeejay',
    description:
      'IB HL/SL & IGCSE Biology tuition in Faridabad by AIIMS Alumnus. Serving DPS Faridabad, Manav Rachna International School, Apeejay, Ryan International. IA/EE support, dual NEET prep. Visit our Sector 17 centre.',
    type: 'website',
    url: 'https://cerebrumbiologyacademy.com/ib-igcse-biology-tuition-faridabad',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'IB & IGCSE Biology Tuition Faridabad | AIIMS Doctor | DPS, Manav Rachna, Apeejay',
    description:
      'IB HL/SL & IGCSE Biology tuition in Faridabad by AIIMS Alumnus. Serving DPS Faridabad, Manav Rachna International School, Apeejay, Ryan International.',
  },
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/ib-igcse-biology-tuition-faridabad',
  },
}
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes — and we are among the very few institutes in Faridabad that offer integrated IB + NEET preparation. 70% of IB Biology HL overlaps with NEET syllabus. We cover the overlapping topics together and add NEET-specific MCQ practice on top, which is ideal if your family is weighing Indian medical entrance alongside the international boards.',
  },
  {
    q: 'Where is your Faridabad centre and do you teach online?',
    a: 'Our Faridabad centre is at SCF-130, 2nd Floor, Above Union Bank, Huda Market, Sector 17, Faridabad - 121002. We teach both in-person and via live online classes, so your child can attend from Sector 15, Sector 16, Sector 21, NIT Faridabad, Old Faridabad, Greater Faridabad or Ballabhgarh the way that suits you best.',
  },
]
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          '@type': 'ListItem',
          position: 2,
          name: 'IB & IGCSE Biology Tuition Faridabad',
          item: 'https://cerebrumbiologyacademy.com/ib-igcse-biology-tuition-faridabad',
        },
      ],
    },
    {
...
export default function IBIGCSEBiologyTuitionFaridabadPage() {
  return (
    <>
      ...
      />
      <DelhiAreaSchema
        pageSlug="ib-igcse-biology-tuition-faridabad"
        subRegion="ncr"
        serviceName="IB & IGCSE Biology Tuition Faridabad"
        description="IB HL/SL and IGCSE (Cambridge 0610) Biology tuition for Faridabad students. Cerebrum Biology Academy's Sector 17 centre serves DPS Faridabad, Manav Rachna International School, Apeejay, Ryan International and other IB/IGCSE families with AIIMS-trained faculty, IA/EE support, and dual IB+NEET preparation."
      />
      <script
      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-20 text-center text-white">
        <div className="mx-auto max-w-4xl px-4">
          <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-yellow-400">
            IB &amp; IGCSE Biology — Faridabad
          </p>
          <h1 className="mb-4 text-4xl font-bold leading-tight md:text-5xl">
            IB &amp; IGCSE Biology Tuition in Faridabad —{' '}
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-4xl px-4">
          <h2 className="mb-10 text-center text-3xl font-bold text-slate-900">
            Schools We Serve in Faridabad
          </h2>
          <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
            {[
              'Delhi Public School (DPS) Faridabad',
          ...
          <p className="mt-6 text-center text-slate-500">
            And other IB/IGCSE and international schools across Faridabad
          </p>
        </div>
      </section>
      ...
      <section className="bg-teal-50 py-16">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <p className="mb-8 text-center text-lg text-slate-600">
            If your child is in the IB Diploma at DPS Faridabad or Manav Rachna and you are weighing
            Indian medical entrance alongside the IB — here is why it works:
          </p>
      ...
      <section className="bg-teal-600 py-16 text-white">
        <div className="mx-auto max-w-3xl px-4 text-center">
          <h2 className="mb-4 text-3xl font-bold">Visit Our Faridabad Centre</h2>
          <p className="mb-2 text-xl">
            SCF-130, 2nd Floor, Above Union Bank, Huda Market, Sector 17, Faridabad - 121002
          </p>
          <p className="mb-6 text-lg text-teal-100">
            In Huda Market, Sector 17 &bull; Close to Sector 16 &amp; NIT Faridabad &bull; Easy
            reach from Old Faridabad, Greater Faridabad &amp; Ballabhgarh &bull; In-person + live
            online
          </p>
          <div className="flex flex-col items-center justify-center gap-4 md:flex-row">
            <a
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-4xl px-4">
          <h3 className="mb-6 text-center text-xl font-bold text-slate-900">
            Explore More for Faridabad
          </h3>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <Link
              href="/ib-biology/faridabad"
            ...
            >
              IB Biology Faridabad
            </Link>
            <Link
              href="/a-level-biology/faridabad"
              className="rounded-lg border border-slate-200 bg-slate-50 p-4 text-center font-medium text-teal-700 hover:border-teal-300 hover:bg-teal-50"
            >
              A-Level Biology Faridabad
            </Link>
            <Link
            ...
            <Link
              href="/biology-olympiads/india/faridabad"
              className="rounded-lg border border-slate-200 bg-slate-50 p-4 text-center font-medium text-teal-700 hover:border-teal-300 hover:bg-teal-50"
            >
              Biology Olympiads Faridabad
            </Link>
          </div>
        </div>
      </section>
