        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8 inline-block">
            <span className="text-sm font-semibold text-blue-600 bg-blue-50 px-4 py-2 rounded-full">
              Best NEET Coaching in Raipur, CG
            </span>
          </div>

          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-gray-900 mb-6 leading-tight">
            Best NEET Coaching
            <br className="hidden sm:block" /> in <span className="text-blue-600">Raipur</span>
          </h1>

          <p className="text-xl sm:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto font-light">
            Top NEET Biology coaching in Raipur. AIIMS faculty. 98% success rate. 695/720 top score.
            CG Board integration.
          </p>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl sm:text-5xl font-bold text-center text-gray-900 mb-16">
            Why Choose Cerebrum for NEET in Raipur?
          </h2>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">
                    Expert faculty trained to teach Chhattisgarh board students with perfect
                    NEET-board balance.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">
                    Direct guidance from AIIMS doctors. Personal mentors for every student. Weekly
                    progress tracking.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">
                    Online + Offline batches. Live interactive sessions. Recorded classes with
                    lifetime access.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">
                    NCERT-based + advanced notes. 100+ chapter tests. 12 full-length mock NEET
                    papers.
                  </p>
                </div>
              </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl sm:text-5xl font-bold text-center text-gray-900 mb-4">
            NEET Coaching in Raipur Areas
          </h2>
          <p className="text-center text-gray-600 mb-16 max-w-2xl mx-auto">
            Coaching centers across major localities in Raipur, Chhattisgarh
          </p>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">
            Start Your NEET Journey in Raipur!
          </h2>
          <p className="text-xl text-blue-100 mb-8">
            Join our successful NEET students from Chhattisgarh. Limited seats per batch. Enroll
            now!
          </p>
