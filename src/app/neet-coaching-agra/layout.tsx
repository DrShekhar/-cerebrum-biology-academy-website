...
export const metadata: Metadata = {
  ...
  description:
    'Top NEET biology coaching in Agra for UP students. SN Medical College focused preparation! 98% success rate, AIIMS faculty. Tajganj, Civil Lines, Kamla Nagar, Sikandra, Dayalbagh. 15,000+ students. Book free demo!',
  keywords:
