...
export const metadata: Metadata = {
  title: 'Best NEET Coaching in Agra | Tajganj, Civil Lines, Kamla Nagar',
  description:
    'Top NEET biology coaching in Agra for UP students. SN Medical College focused preparation! 98% success rate, AIIMS faculty. Tajganj, Civil Lines, Kamla Nagar, Sikandra, Dayalbagh. 1,50,000+ students. Book free demo!',
  keywords:
  ...
  openGraph: {
    title: 'Best NEET Coaching in Agra | Uttar Pradesh',
    description:
  ...
  twitter: {
    ...
    title: 'Best NEET Coaching in Agra',
    description:
