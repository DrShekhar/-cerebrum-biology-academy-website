...
export const metadata: Metadata = {
  ...
  description:
    'Top NEET biology coaching in Agra for UP students. SN Medical College focused preparation! 94.2% success rate, AIIMS faculty. Tajganj, Civil Lines, Kamla Nagar, Sikandra, Dayalbagh. 2,500+ students. Book free demo!',
  keywords:
  ...
  openGraph: {
    ...
    description:
      'Top NEET biology coaching in Agra with 94.2% success rate. SN Medical College focused preparation! AIIMS faculty, small batches. Join 2,500+ UP students from Tajganj, Civil Lines.',
  ...
  twitter: {
    ...
    description:
      'Top NEET biology coaching in Agra. SN Medical College focused! 94.2% success rate. Tajganj, Civil Lines, Kamla Nagar, Sikandra.',
  },
  alternates: {
