...
export default function NEETTestSeriesGreaterNoidaContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      ...
      message:
        'Hi! I am a Greater Noida student interested in the NEET Biology test series. Please share the packages and registration details.',
      campaign: 'test-series-greater-noida',
    })
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              NEET Test Series
              <span className="block text-yellow-400 mt-2">50+ Mock Tests in Greater Noida</span>
            </h1>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="bg-purple-50 rounded-xl p-6">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle className="w-5 h-5 text-green-500" />
                    Online access for Greater Noida students
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            >
              ...
              <p className="text-sm text-gray-600">Live classes from home</p>
            </Link>
            <Link
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Start with a free mock test from your Greater Noida home — see where you stand
          </p>
