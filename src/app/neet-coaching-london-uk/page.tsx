...
export const metadata: Metadata = {
  ...
  description:
    "Expert NEET coaching for London, UK students. 98% success rate. Dr. Shekhar C Singh's specialized curriculum. Join 50+ top scorers.",
  keywords:
    'NEET coaching london, NEET classes london, medical entrance exam london, biology coaching london, Cerebrum Biology Academy london',
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/neet-coaching-london-uk',
  },
