...
export const metadata: Metadata = {
  title: 'Tamil Nadu State Board Biology Tuition Online | NEET + Board Prep',
  description:
    'Best Tamil Nadu State Board Biology tuition online. 98% success rate. AIIMS faculty. Bridge TN syllabus with NCERT for NEET. Chennai, Coimbatore, Madurai. Fee ₹24,000+. Book free demo!',
  keywords:
  ...
  openGraph: {
    title: 'Tamil Nadu State Board Biology Tuition Online | NEET + Board Prep',
    description:
      'Best Tamil Nadu Biology tuition with 98% success rate. AIIMS faculty. Bridge TN-NCERT gap. Chennai, Coimbatore, Madurai.',
  ...
  twitter: {
    ...
    title: 'Tamil Nadu Biology Tuition Online',
    description:
      'Best Tamil Nadu Biology tuition online. 98% success rate. Chennai, Coimbatore, Madurai.',
  },
  alternates: {
