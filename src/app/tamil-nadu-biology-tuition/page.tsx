...
export const metadata: Metadata = {
  title: 'Best Tamil Nadu Biology Tuition Online | 94.2% Success Rate | Cerebrum',
  description: 'Expert online biology tuition for Tamil Nadu State Board students preparing for NEET. AIIMS faculty, 94.2% success rate, small batches (10-15). Join 1,500+ students across Chennai, Coimbatore, Madurai, Vellore.',
  keywords: [
  ...
  openGraph: {
    title: 'Best Tamil Nadu Biology Tuition Online | 94.2% Success Rate',
...
const faqs = [
  ...
  { q: 'What is the success rate for Tamil Nadu students?', a: 'Our success rate for TN Board Biology students is 94.2% with an average score of 358/720 in NEET. We have 58+ TN Board toppers in the last two years across all Tamil Nadu districts.' },
...
export default function TamilNaduBiologyTuitionPage() {
  return (
    <>
      <LocalitySchema locality="Chennai" slug="tamil-nadu-biology-tuition" pageTitle="Best Tamil Nadu Biology Tuition Online" pageDescription="Expert online biology tuition for Tamil Nadu State Board (Samacheer Kalvi) students preparing for NEET with AIIMS faculty and 94.2% success rate." pageType="coaching" coordinates={{ lat: "13.0827", lng: "80.2707" }} faqs={faqs} />
      <PageContent />
    </>
  )
}
