...
export const metadata: Metadata = {
  title: 'RE-NEET 2026 Coaching in Delhi NCR | 5 Centres + Online Crash Course',
  description:
    'RE-NEET 2026 coaching for Delhi NCR students after the 12 May NEET cancellation. 5 offline centres (South Ext, Rohini, Green Park, Gurugram, Faridabad) + online live AIIMS-trained crash course.',
  keywords: [
    're-neet 2026 delhi',
  ...
  openGraph: {
    locale: 'en_IN',
    title: 'RE-NEET 2026 Coaching in Delhi NCR | 5 Centres + Online',
    description: '5 NCR centres + online live AIIMS-trained RE-NEET crash course.',
