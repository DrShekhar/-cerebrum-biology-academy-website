...
export const metadata: Metadata = {
  title: 'Best Biology Coaching for NEET Droppers | Repeater Batch 2026-2027',
  description:
  ...
  keywords:
    'NEET dropper coaching, biology coaching for droppers, NEET repeater batch, dropper batch biology, NEET second attempt coaching, NEET 2027 dropper, biology tuition for droppers, NEET dropper course, repeater biology coaching, NEET dropper online coaching, biology for NEET repeaters, gap year NEET coaching',
  openGraph: {
