...
const northDelhiAreas = [
  { name: 'Rohini', distance: '40 km from center', available: 'Online' },
  { name: 'Pitampura', distance: '38 km from center', available: 'Online' },
  { name: 'Model Town', distance: '35 km from center', available: 'Online' },
  { name: 'Civil Lines', distance: '30 km from center', available: 'Online' },
  { name: 'Kamla Nagar', distance: '28 km from center', available: 'Online' },
  { name: 'Mukherjee Nagar', distance: '32 km from center', available: 'Online' },
  { name: 'GTB Nagar', distance: '30 km from center', available: 'Online' },
  { name: 'Shalimar Bagh', distance: '42 km from center', available: 'Online' },
]
...
const whyChooseUs = [
  ...
  },
  {
    ...
    description: '67+ AIIMS selections. Many from North Delhi localities.',
  },
  {
    icon: Clock,
    title: 'Flexible Timings',
    description: 'Online classes available for North Delhi students. Study from home comfort.',
  },
  {
    icon: Star,
...
const faqs = [
  {
    question: 'Do you have offline classes in North Delhi?',
    answer:
      'Our center is located in Greater Noida. For North Delhi students, we offer high-quality live online classes with the same teaching quality. Many North Delhi students prefer online mode as it saves 2-3 hours of daily commute time.',
  },
  {
    question: 'How can Rohini students join your classes?',
    answer:
      'Rohini students can easily join our live online classes. We have many successful students from Rohini Sectors. All you need is a laptop/tablet and stable internet. Classes are recorded for revision.',
  },
  {
    question: 'What is the fee structure for online classes?',
    answer:
      'Our online classes are priced competitively compared to North Delhi coaching centers. Plus, you save on travel costs and time. Contact us for current fee structure and available discounts.',
  },
  {
    question: 'Do you provide study material for online students?',
    answer:
      'Yes! Complete digital study material including notes, DPPs, previous year papers, and mock tests. Physical books can be couriered to your North Delhi address on request.',
  },
]

export default function BiologyTutorNorthDelhiPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      />
      <DelhiAreaSchema pageSlug="biology-tutor-north-delhi" />
      <script
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Biology%20coaching%20in%20North%20Delhi.%20Please%20share%20available%20timings."
                target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              North Delhi Areas We Serve
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Online classes available for all North Delhi localities
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              Why North Delhi Students Choose Us
            </h2>
          </div>
