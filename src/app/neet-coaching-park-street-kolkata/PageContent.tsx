...
const localBusinessSchema = {
  ...
  description:
    'Best NEET Coaching for Park Street Kolkata - Premium Coaching for Central Kolkata Professionals',
...
export default function PageContent() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              Expert NEET coaching for Park Street, Chowringhee, and central Kolkata areas. Learn
              from accomplished medical faculty trusted by{' '}
              <strong>business professionals and corporate families</strong>. Premium online classes
              with recorded lectures and proven 685+ NEET results.
            </p>
      ...
      <PricingSection cityName="Park Street" />
      <CostComparisonSection cityName="Park Street" />
      ...
      <RelatedCityLinks currentCity="park-street-kolkata" variant="default" />
    </div>
  )
}
