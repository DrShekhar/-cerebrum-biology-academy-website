...
export default function PricingPage() {
  ...
  const tierOrder: Record<TierLevel, number> = { pursuit: 0, ascent: 1, pinnacle: 2 }
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 overflow-x-hidden">
        ...
        <div className="relative bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-900 text-white py-8 sm:py-10 lg:py-12 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div
              ref={statsRef}
              className="grid grid-cols-3 gap-3 sm:gap-4 max-w-3xl mx-auto animate-fade-in-up"
        ...
        <div className="bg-red-600 text-white py-3">
          <div className="max-w-7xl mx-auto px-4 flex flex-wrap items-center justify-center gap-2 sm:gap-3 text-xs sm:text-sm font-medium">
            ...
            <span className="bg-white/20 px-2 sm:px-3 py-1 rounded-full">
              Pinnacle: 3 seats left
            </span>
            <span className="bg-white/20 px-2 sm:px-3 py-1 rounded-full">Ascent: 8 seats left</span>
            <button
              onClick={() =>
                trackAndOpenWhatsApp({
                  source: 'pricing-urgency-banner',
                  message:
                    'Hi! I want to reserve my seat for the April 2026 batch. Please share available slots and enrollment process.',
                  campaign: 'pricing-urgency',
                })
              }
            ...
            <button
              onClick={() =>
                trackAndOpenWhatsApp({
                  source: 'pricing-help',
                  message:
                    "Hi! I'm on the pricing page but not sure which course/tier is right for me. Can you help me choose?",
                  campaign: 'pricing-help',
                })
              }
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b-2 border-gray-200">
                    <th className="pb-4 pl-4 font-semibold text-gray-500 text-sm uppercase tracking-wide">
                      Feature
                    </th>
                ...
                <tbody>
                  {[
                    ...
                    {
                      feature: 'Weekly Hours',
                      pursuit: '4.5 hrs',
                      ascent: '4.5 hrs',
                      pinnacle: '4.5-6.0 hrs',
                    },
                    {
                    ...
                    >
                      <td className="py-3.5 pl-4 font-medium text-gray-900 text-sm">
                        {row.feature}
                      </td>
                      <td className="py-3.5 text-center text-sm">
                        {typeof row.pursuit === 'boolean' ? (
                          ...
                          <span className={row.highlight ? 'font-semibold text-green-700' : ''}>
                            {row.pursuit}
                          </span>
                        )}
                      </td>
                      <td className="py-3.5 text-center text-sm bg-blue-50/60">
                        {typeof row.ascent === 'boolean' ? (
                          ...
                          <span className={row.highlight ? 'font-semibold text-blue-700' : ''}>
                            {row.ascent}
                          </span>
                        )}
                      </td>
                      <td className="py-3.5 text-center text-sm">
                        {typeof row.pinnacle === 'boolean' ? (
                          ...
                          <span className={row.highlight ? 'font-semibold text-purple-700' : ''}>
                            {row.pinnacle}
                          </span>
                        )}
                      </td>
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6 sm:p-10 mb-16">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-sm sm:text-base">
                See why 15,000+ students choose us over Kota coaching and big EdTech
              </p>
            </div>
                ...
                <tbody className="divide-y divide-gray-100">
                  {[
                    ...
                    <tr key={idx} className="hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4 text-center font-semibold text-blue-700 bg-blue-50">
                        {cerebrum}
                      </td>
                    </tr>
                  ))}
            ...
            <div className="space-y-3 max-w-3xl mx-auto">
              {[
                ...
                },
                {
                  ...
                  a: 'Refund eligibility, timelines, and conditions are detailed in our <a href="/refund-policy" class="text-blue-600 underline hover:no-underline">Refund Policy</a>. Please review it before enrolling — for any clarification, message us on WhatsApp.',
                },
                {
              ...
              <div className="relative text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
                  <button
                    onClick={() =>
                      trackAndOpenWhatsApp({
                        source: 'pricing-bottom-enroll',
                        message:
                          "Hi! I'm ready to enroll at Cerebrum Biology Academy. Please share available courses and batch timings for my class.",
                  ...
                  <button
                    onClick={() =>
                      trackAndOpenWhatsApp({
                        source: 'pricing-bottom-demo',
                        message:
                          'Hi! I want to book a FREE demo class before enrolling. Please share available timings.',
                        campaign: 'pricing-bottom',
                      })
                    }
        ...
        <div className="fixed bottom-0 left-0 right-0 md:hidden bg-white/95 backdrop-blur-lg border-t border-gray-200/80 px-4 py-3 shadow-[0_-4px_30px_rgba(0,0,0,0.08)] z-50 safe-area-pb">
          <button
            onClick={() =>
              trackAndOpenWhatsApp({
                source: 'pricing-sticky-mobile',
                message:
                  "Hi! I'm on the pricing page and want to enroll. Please help me choose the right course and plan.",
                campaign: 'pricing-sticky',
              })
            }
