          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
                Small batches, personalized attention, and proven results. Choose your path to
                medical college success.
              </p>
            </div>

            <div ref={statsRef} className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-6 text-center">
                <div className="text-4xl font-bold mb-2">{stats.tiers}</div>
            ...
            <div className="mb-6">
              <div className="relative max-w-2xl mx-auto">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-4 rounded-2xl border-2 border-gray-200 focus:border-blue-500 focus:outline-none focus:shadow-[0_0_0_4px_rgba(59,130,246,0.1)] text-gray-700 shadow-sm transition-shadow duration-200"
                />
                {searchQuery && (
                  <button
            ...
            <div className="space-y-6 max-w-3xl mx-auto">
              ...
              <details className="group">
                ...
                <p className="text-gray-600 mt-3 pl-4">
                  ...
                  <br />
                  <strong>Pursuit (30-40 students):</strong> Quality education at an affordable
                  price, perfect for budget-conscious students.
                </p>
              </details>
              ...
              <details className="group">
                ...
                <p className="text-gray-600 mt-3 pl-4">
                  Yes, Pinnacle and Ascent tiers come with a 30-day money-back guarantee if you're
                  not satisfied with the quality of teaching.
                </p>
              </details>
              ...
              <details className="group">
                ...
                <p className="text-gray-600 mt-3 pl-4">
                  All live classes are recorded and available for lifetime access. You can watch
                  them anytime from your student dashboard.
                </p>
              </details>
