...
const comparisonData = [
  {
    ...
    aakash: '60-80+ students (Knowledge Park)',
    winner: 'cerebrum',
  },
  {
...
const reasons = [
  ...
  },
  {
    ...
    description:
      'Generic coaching covers Biology superficially. Our AIIMS faculty dives deep into concepts that matter for NEET.',
    icon: BookOpen,
  },
  {
...
export default function AakashAlternativeGreaterNoidaContent({ faqs }: { faqs: FAQ[] }) {
