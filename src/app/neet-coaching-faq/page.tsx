...
const faqData = {
  ...
  about: [
    ...
    },
    {
      ...
      answer:
        'Dr. Shekhar C Singh is an AIIMS Delhi graduate (2014) who scored 680/720 in NEET Biology. After observing thousands of students struggle with Biology despite expensive coaching, he chose teaching over medical practice. With 15+ years of faculty experience at premier coaching institutes, he founded Cerebrum to bring AIIMS-level instruction at affordable fees. He is known for his "Concept Pyramid" methodology that simplifies complex topics.',
    },
    {
  ...
  studyTips: [
    ...
    },
    {
      ...
      answer:
        "Free online resources: (1) NCERT videos on YouTube (official NCERT channel), (2) Previous year NEET questions on aakash.ac.in and Aakash.in (free practice), (3) Doubtnut app (free, but has ads) - Instant video solutions, (4) Khan Academy Biology (free English lessons), (5) Our channel @cerebrumbiologyacademy (YouTube - concept explanations, error analysis). Paid resources: (1) PhysicsWallah and Unacademy Plus/Plus Pro: Live classes + recorded lectures, (2) Toppr: Interactive learning platform, (3) Byjus: Comprehensive but expensive. Cerebrum recommendation: Use free resources for concepts, use Cerebrum lectures for NEET-specific approach, use mock tests for practice. Don't overwhelm yourself with too many platforms - One good source beats 10 mediocre sources.",
    },
    {
