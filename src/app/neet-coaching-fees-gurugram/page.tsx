...
export const metadata: Metadata = {
  ...
  description:
    'Compare NEET coaching fees in Gurugram for 2026. Allen, Aakash, Cerebrum fees compared. Scholarships, EMI options. Find affordable NEET coaching in Gurgaon.',
  keywords: [
  ...
  twitter: {
    ...
    title: 'NEET Coaching Fees in Gurugram 2026 | Fee Comparison | ₹45K-2L',
    description:
      'Compare NEET coaching fees in Gurugram for 2026. Allen, Aakash, Cerebrum fees compared. Scholarships, EMI options. Find affordable NEET coachi...',
  },
}
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Cerebrum Biology Academy offers the best value at ₹60,000-75,000/year with AIIMS faculty and 15-20 student batches. This is 50-60% lower than Allen/Aakash while maintaining 98% success rate.',
  },
  {
  ...
  {
    question: 'Why is Cerebrum cheaper than Allen/Aakash?',
    answer:
