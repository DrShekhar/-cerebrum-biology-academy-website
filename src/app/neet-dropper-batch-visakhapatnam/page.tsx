...
const cityName = 'Visakhapatnam'
const citySlug = 'visakhapatnam'
...
export const metadata: Metadata = {
  ...
  keywords: ['neet dropper batch visakhapatnam', 'neet repeater course visakhapatnam', 'best dropper batch neet visakhapatnam'],
  alternates: { canonical: `https://cerebrumbiologyacademy.com/neet-dropper-batch-visakhapatnam` },
  openGraph: { title: `NEET Dropper Batch 2026-27 ${cityName}`, url: `https://cerebrumbiologyacademy.com/neet-dropper-batch-visakhapatnam`, locale: 'en_IN', type: 'website' },
