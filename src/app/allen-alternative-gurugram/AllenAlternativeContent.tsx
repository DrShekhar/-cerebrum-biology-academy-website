        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              Tired of 100+ student batches? Want personal attention from AIIMS faculty? Discover
              why 500+ Gurugram students chose Cerebrum for focused NEET Biology preparation.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeInUp">
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  Same building as Allen - no extra travel
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-4">
                  Conveniently Located Near Allen
                </h2>
                <p className="text-slate-600 mb-6">
                  Our Gurugram center is in the <strong>same building as Allen</strong> - M2K
                  Corporate Park, Sector 51. Whether you're switching or complementing, there's no
                  extra travel time.
                </p>
                <div className="space-y-3 mb-6">
                  ...
                  <p className="flex items-center gap-2">
                    <Clock className="w-5 h-5 text-red-600" />5 min walk from Sector 55-56 Rapid
                    Metro
                  </p>
                </div>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            <Link
              href="/complement-allen-coaching-gurugram"
              className="bg-gray-50 p-4 rounded-xl hover:shadow-md"
            >
