...
export default function NEETCoachingCRParkPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero */}
      <section className="relative bg-gradient-to-br from-orange-800 via-red-700 to-purple-900 text-white py-20 overflow-hidden">
      ...
      {/* CTA */}
      <section className="py-20 bg-gradient-to-r from-orange-600 via-red-600 to-purple-700 text-white">
      ...
      <section className="py-12 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link
              href="/biology-tutor-greater-kailash"
              className="bg-white px-6 py-3 rounded-lg shadow hover:shadow-md transition"
            >
              Greater Kailash
            </Link>
