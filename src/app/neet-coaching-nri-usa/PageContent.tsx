  ...
  const whyChoose = [
    {
      ...
      description:
        "Dr. Shekhar C Singh — AIIMS Alumnus, India's Top Biology Teacher for NEET & Olympiads, Best Biology Educator Globally, with 15+ years experience",
      icon: '👨‍🏫',
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-8">
                USA's AP Biology is excellent preparation for NEET with the right bridge. We help
                the 5.16M Indian diaspora optimize their pre-med pathway, combining AP/SAT
                excellence with NEET mastery. Many students pursue MD in India while maintaining US
                residency benefits.
              </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-6">
            Cities We Serve in United States of America
          </h2>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">
            Class Timings for United States of America
          </h2>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-blue-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">
            United States of America to NEET Bridge
          </h2>
          <div className="bg-white p-8 rounded-lg shadow-md">
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              Our specialized curriculum bridges United States of America's education system with
              NEET requirements. With 2 CBSE schools in New York, California, Texas, Illinois, we
            ...
            <ul className="space-y-3 mb-6">
              <li className="flex items-start">
                ...
                <span className="text-gray-700">
                  Converting United States of America curriculum to NEET format
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">✓</span>
                <span className="text-gray-700">
                  NEET exam registration guidance & India travel logistics
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">✓</span>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-4">
            Success Stories from United States of America
          </h2>
          <p className="text-center text-gray-600 mb-12">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-blue-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">
            NEET Coaching Plans for United States of America
          </h2>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Cerebrum is Cost-Effective for United States of America Students
          </h2>
