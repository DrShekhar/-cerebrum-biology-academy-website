...
export default function PageContent() {
  ...
  const whyChoose = [
    ...
    },
    {
      ...
      description: "Proven track record with United States of America NRI students",
      icon: "🎯",
    },
    {
      title: "EST/PST Batches",
      description: "Classes scheduled for United States of America's timezone flexibility",
      icon: "⏰",
    },
    {
    ...
    },
    {
      ...
      description: "Connect with United States of America peers and alumni network",
      icon: "🤝",
    },
    {
  ...
  const classTimings = [
    {
      ...
      days: "Mon-Fri, 6:00 PM - 8:30 PM EST",
      focus: "Foundation building with United States of America curriculum bridge",
    },
    {
      level: "Class 12",
      timing: "Intensive batch",
      days: "Mon-Sat, 4:00 PM - 7:00 PM EST",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">
                NEET Coaching for United States of America
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                98% Success Rate • 2 CBSE Schools • 5.16M Indians
              </p>
              <p className="text-lg text-gray-700 mb-8">
                USA's AP Biology is excellent preparation for NEET with the right bridge. We help the 5.16M Indian diaspora optimize their pre-med pathway, combining AP/SAT excellence with NEET mastery. Many students pursue MD in India while maintaining US residency benefits.
              </p>
            ...
            <div className="relative h-96 bg-gradient-to-br from-slate-900 to-slate-800 rounded-lg shadow-lg flex items-center justify-center">
              <div className="text-center text-white/70">
                ...
                <p className="text-lg font-medium">NEET Coaching in United States of America</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-6">Cities We Serve in United States of America</h2>
          <p className="text-center text-gray-600 mb-12">
            Serving 2 CBSE schools across New York, California, Texas, Illinois
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {['New York', 'Los Angeles', 'Chicago', 'Houston', 'San Francisco', 'Dallas', 'Edison'].map((city) => (
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg mb-8 opacity-90">
            Join 1000+ United States of America students who achieved their medical dreams with us
          </p>
          <SmartWhatsAppCTA
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Class Timings for United States of America</h2>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-blue-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">United States of America to NEET Bridge</h2>
          <div className="bg-white p-8 rounded-lg shadow-md">
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              Our specialized curriculum bridges United States of America's education system with NEET requirements. 
              With 2 CBSE schools in New York, California, Texas, Illinois, we have deep expertise in:
            </p>
            <ul className="space-y-3 mb-6">
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">✓</span>
                <span className="text-gray-700">Converting United States of America curriculum to NEET format</span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">✓</span>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-4">Success Stories from United States of America</h2>
          <p className="text-center text-gray-600 mb-12">
            Watch how our United States of America students achieved their medical dreams
          </p>
          <VideoTestimonialsSection country="United States of America" />
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-blue-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">NEET Coaching Plans for United States of America</h2>
          <PricingSection country="United States of America" />
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Why Cerebrum is Cost-Effective for United States of America Students</h2>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6">
            Join 1000+ United States of America Students Preparing for NEET
          </h2>
          <p className="text-lg mb-8 opacity-90">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-white border-t">
        <div className="max-w-6xl mx-auto">
          ...
          <RelatedCityLinks currentCountry="United States of America" />
        </div>
      </section>
