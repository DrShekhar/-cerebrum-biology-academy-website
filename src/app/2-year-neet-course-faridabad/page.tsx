...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'two year neet coaching faridabad',
    'class 11 neet course',
    'class 11 12 integrated neet',
    '2 year neet program faridabad',
    'foundation neet course class 11',
    'neet from class 11 faridabad',
    'neet 2027 2 year course',
    'best 2 year neet coaching',
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Our schedule is designed for balance: 3-4 hours coaching daily (evening batch) + 2 hours self-study. Weekends: 4-5 hours. Total: 25-30 hours/week for NEET + full school attendance. Many DPS Faridabad, Manav Rachna, DAV students manage both successfully.',
  },
  {
...
export default function TwoYearNEETCourseFaridabad() {
  return (
      ...
      <section className="bg-gradient-to-r from-emerald-800 to-emerald-600 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">2 Year NEET Course in Faridabad</h1>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link
                href="/1-year-neet-course-faridabad"
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-2xl font-bold text-emerald-600">24 Months</div>
              <div className="text-gray-600">Course Duration</div>
            </div>
            <div className="text-center">
              <Clock className="w-8 h-8 text-emerald-500 mx-auto mb-2" />
              <div className="text-2xl font-bold text-emerald-600">1500+ Hrs</div>
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-emerald-600">350+</div>
              ...
              <div className="bg-emerald-600 text-white py-4 px-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-emerald-200">Foundation Building</p>
                  </div>
                </div>
              </div>
              <div className="p-6">
                ...
                <p className="mt-4 text-sm text-gray-500 bg-emerald-50 p-3 rounded-lg">
              ...
              <div className="bg-emerald-700 text-white py-4 px-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-emerald-200">Advanced + Revision</p>
                  </div>
                </div>
              </div>
              <div className="p-6">
              ...
              <table className="w-full">
                ...
                <tbody>
                  <tr className="bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-center font-bold text-emerald-600">98%</td>
                    <td className="px-6 py-4 text-center">94%</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 font-medium">Daily Study Hours</td>
                    <td className="px-6 py-4 text-center font-bold text-emerald-600">3-4 hours</td>
                    <td className="px-6 py-4 text-center">6+ hours</td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="px-6 py-4 font-medium">Revision Cycles</td>
                    <td className="px-6 py-4 text-center font-bold text-emerald-600">3 times</td>
                  ...
                  <tr className="bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-center font-bold text-emerald-600">65%</td>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-xl mx-auto">
            <div className="bg-white border-2 border-emerald-400 rounded-2xl shadow-lg overflow-hidden">
              <div className="bg-emerald-700 text-white py-4 text-center">
                ...
                <p className="text-emerald-200">Class 11 + Class 12 (2025-2027)</p>
              </div>
              <div className="p-8">
                <div className="text-center mb-6">
                  <span className="text-4xl font-bold text-emerald-600">₹1,20,000 - 1,40,000</span>
                  <p className="text-sm text-gray-500 mt-1">Complete 2-year package</p>
                  <p className="text-sm text-emerald-600 font-medium">₹60,000-70,000 per year</p>
                </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-semibold text-emerald-700 mb-3">Weekdays (Mon-Fri)</h4>
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between bg-emerald-50 p-2 rounded border border-emerald-200">
                      <span className="text-emerald-700">Coaching</span>
                      <span className="font-medium text-emerald-700">5 - 8 PM</span>
                    </div>
                    <div className="flex justify-between bg-gray-50 p-2 rounded">
                ...
                <div>
                  <h4 className="font-semibold text-emerald-700 mb-3">Weekend (Sat-Sun)</h4>
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between bg-emerald-50 p-2 rounded border border-emerald-200">
                      <span className="text-emerald-700">Coaching (Sat)</span>
                      <span className="font-medium text-emerald-700">9 AM - 1 PM</span>
                    </div>
                    <div className="flex justify-between bg-gray-50 p-2 rounded">
                      <span>Self-Study</span>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Course',
            name: '2 Year NEET Course Faridabad',
            description: 'Comprehensive 2-year NEET biology coaching from Class 11 in Faridabad',
            provider: {
              '@type': 'Organization',
