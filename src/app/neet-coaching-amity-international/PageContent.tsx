        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center mb-8">
              ...
              <a
                href="https://wa.me/918826444334?text=Hi!%20I%20am%20on%20your%20NEET%20Coaching%20Amity%20International%20page%20and%20want%20to%20know%20more%20about%20batches%2C%20fees%2C%20and%20admission."
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {campuses.map((campus, index) => (
              <div
                key={index}
                className="bg-white rounded-xl p-6 shadow-lg border-t-4 border-purple-600 text-center animate-fadeInUp"
              >
