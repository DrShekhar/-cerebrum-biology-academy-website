...
import { Phone, Star, CheckCircle, Download, Users, Award, Calendar } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-b from-teal-50 via-white to-gray-50">
      ...
      <section className="relative py-16 bg-gradient-to-r from-teal-700 via-teal-600 to-teal-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-teal-100 mb-2">
            Day-by-Day Schedule Designed by AIIMS Toppers
          </p>
          <p className="text-lg text-teal-200 max-w-2xl mx-auto mb-8">
            A complete 12-month roadmap covering chapter allocation, revision cycles, mock test
            schedules, and daily time management designed by students who scored 680+ in NEET.
          </p>
          <Link
      ...
      <section className="py-12 max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-4">
          <Link href="/pricing" className="text-teal-600 hover:text-teal-800 font-semibold">
            View Courses &rarr;
          </Link>
          <Link href="/nri-students" className="text-teal-600 hover:text-teal-800 font-semibold">
            NRI Students &rarr;
          </Link>
          <Link href="/free-resources" className="text-teal-600 hover:text-teal-800 font-semibold">
