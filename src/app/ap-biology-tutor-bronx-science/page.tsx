...
export const metadata: Metadata = buildAPBiologySchoolMetadata({
  ...
  description:
    'AP Biology tutoring for Bronx High School of Science students — AIIMS-trained faculty, FRQ rubric mastery, USABO Semifinal track. ET live classes. From $2,500/yr (1:1 from $40/hr).',
  keywords: [
    'AP Biology tutor Bronx Science',
