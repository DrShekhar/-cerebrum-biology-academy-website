...
import NEETCrashCourseGhaziabadContent from './NEETCrashCourseGhaziabadContent'
import { CerebrumPersonSchema } from '@/components/seo/CerebrumPersonSchema'

export const metadata: Metadata = {
  title: 'NEET Crash Course in Ghaziabad | 45-Day Intensive Biology Program',
  description:
    'Join our 45-day NEET Biology crash course for Ghaziabad students. Complete syllabus revision, 1000+ questions, daily tests. Perfect for last-minute preparation. Starting Rs 25,000.',
  keywords: [
    'neet crash course ghaziabad',
    'neet biology crash course ghaziabad',
    '45 day neet course ghaziabad',
    'neet last minute preparation ghaziabad',
    'neet revision course ghaziabad',
    'intensive neet biology ghaziabad',
    'neet quick revision',
  ...
  openGraph: {
    ...
    url: 'https://cerebrumbiologyacademy.com/neet-crash-course-ghaziabad',
  },
  alternates: {
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Crash course runs 6 hours daily (9 AM - 3 PM or 2 PM - 8 PM) as live online classes. Weekend batches available with 8-hour sessions. Ghaziabad students attend from home - no travel needed.',
  },
  {
    question: 'What is the fee for the crash course for Ghaziabad students?',
    answer:
...
export default function NEETCrashCourseGhaziabadPage() {
  const courseSchema = {
    '@context': 'https://schema.org',
    '@type': 'Course',
    name: 'NEET Biology Crash Course - Ghaziabad',
    description:
      '45-day intensive NEET Biology revision course for Ghaziabad students with complete syllabus coverage and 1000+ practice questions',
    provider: {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: 'Crash Course',
        item: 'https://cerebrumbiologyacademy.com/neet-crash-course-ghaziabad',
      },
    ],
  }
  ...
  return (
    <>
      ...
      />
      <NEETCrashCourseGhaziabadContent faqs={faqs} />
    </>
  )
}
