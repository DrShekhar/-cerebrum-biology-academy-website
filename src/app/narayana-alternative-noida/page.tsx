...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'narayana vs cerebrum noida',
    'small batch neet coaching',
    'narayana noida fees comparison',
    'switch from narayana noida',
    'narayana competitor noida',
  ...
  openGraph: {
    locale: 'en_IN',
    title: 'Best a leading national educational institution Alternative in Noida 2026',
    description:
      'Tired of crowded a leading national educational institution batches? Get personal attention with 25-student batches.',
    url: 'https://cerebrumbiologyacademy.com/narayana-alternative-noida',
  },
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/narayana-alternative-noida',
  },
}
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'a leading national educational institution Noida: ₹1.2-1.8 Lakh/year for NEET programs. Cerebrum: ₹45,000-75,000/year for comprehensive NEET biology coaching. Save ₹75K-1L while getting 4x more personal attention per student.',
  },
  {
    question: 'Is a leading national educational institution good for NEET in Noida?',
    answer:
      "a leading national educational institution has a strong brand but Noida branches are known for limited personal attention and large batches (100-150 students). Good for self-motivated students who don't need much personal guidance. If you need doubt resolution and personal attention, smaller batches work better.",
  },
  {
    question: 'What is the main problem with a leading national educational institution Noida?',
    answer:
...
export default function NarayanaAlternativeNoida() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <span className="inline-block bg-yellow-500 text-green-900 px-4 py-1 rounded-full text-sm font-semibold mb-4">
              a leading national educational institution Alternative in Noida
            </span>
