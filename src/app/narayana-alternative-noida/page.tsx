...
export const metadata: Metadata = {
  title: 'Best Narayana Alternative in Noida 2026 | Small Batch Personal Attention | Cerebrum',
  description:
  ...
  openGraph: {
    title: 'Best Narayana Alternative in Noida 2026 | Cerebrum Biology Academy',
    description:
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Narayana Noida: ₹1.2-1.8 Lakh/year for NEET programs. Cerebrum: ₹45,000-75,000/year for comprehensive NEET biology coaching. Save ₹75K-1L while getting 4x more personal attention per student.',
  },
  {
    question: 'Is Narayana good for NEET in Noida?',
    answer:
      "Narayana has a strong brand but Noida branches are known for limited personal attention and large batches (100-150 students). Good for self-motivated students who don't need much personal guidance. If you need doubt resolution and personal attention, smaller batches work better.",
  },
  {
    question: 'What is the main problem with Narayana Noida?',
    answer:
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <span className="inline-block bg-yellow-500 text-green-900 px-4 py-1 rounded-full text-sm font-semibold mb-4">
              Narayana Alternative in Noida
            </span>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Best Narayana Alternative in Noida
            </h1>
