...
const faqs = [
  ...
  {
    question:
      'How does Cerebrum compare to Sri Chaitanya and Narayana / PhysicsWallah (PW) / Allen NEET Foundation in Hyderabad for Class 10?',
    answer:
      "Hyderabad's local NEET coaching market is dominated by Sri Chaitanya and Narayana and PhysicsWallah (PW) — both run mass-batch operations with 300-400+ student Class 10 Foundation batches. Allen Scholastics Hyderabad runs ~6 centres with 200-300 student batches. For Class 10 boards specifically, all three local chains optimise for Telangana / AP SSC + IPE pathway rather than NCERT depth. Cerebrum is biology-only NCERT-mapped specialist with 15-20 student batches and AIIMS-trained faculty — structurally different positioning. Many Hyderabad families combine Cerebrum biology (₹55K-75K Ascent) with Sri Chaitanya and Narayana / PhysicsWallah (PW) for PC for total ₹1L-1.4L.",
  },
  {
    question: 'What does Class 10 NEET Foundation cost in Hyderabad?',
    answer:
      'Cerebrum Class 10 Foundation pricing for Hyderabad families (pan-India online): Pursuit ₹35K-55K, Ascent ₹55K-75K, Pinnacle ₹75K-95K, ad-hoc 1:1 ₹2,000-3,500/hr. Hyderabad Class 10 specifically: Sri Chaitanya and Narayana integrated Class 10 Foundation (~₹85K-1.1L, 350-student) traditionally dominates this segment because of integrated school + coaching bundling that locks Class 10 → Intermediate → NEET in one ecosystem. PhysicsWallah (PW) similar (~₹85K-1.05L, 300-student). Allen Scholastics Class 10 (~₹95K-1.2L, 250-student). Cerebrum biology-only Ascent (₹65K) is the structural alternative for families targeting AIIMS/JIPMER (where small-batch depth beats mass-volume drilling) rather than median state quota. Common Hyderabad pattern: Cerebrum biology + Sri Chaitanya and Narayana/PhysicsWallah (PW) PC stream for combined PCB at lower total cost than full Allen.',
  },
]
