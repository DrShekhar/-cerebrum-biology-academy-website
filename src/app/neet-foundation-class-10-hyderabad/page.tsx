...
const faqs = [
  ...
  {
    question:
      'How does Cerebrum compare to other South-Indian chains / a leading national educational institution / the 2nd-largest national NEET chain NEET Foundation in Hyderabad for Class 10?',
    answer:
      "Hyderabad's local NEET coaching market is dominated by other South-Indian chains and a leading national educational institution — both run mass-batch operations with 300-400+ student Class 10 Foundation batches. the 2nd-largest national NEET chain Scholastics Hyderabad runs ~6 centres with 200-300 student batches. For Class 10 boards specifically, all three local chains optimise for Telangana / AP SSC + IPE pathway rather than NCERT depth. Cerebrum is biology-only NCERT-mapped specialist with 15-20 student batches and AIIMS-trained faculty — structurally different positioning. Many Hyderabad families combine Cerebrum biology (₹55K-75K Ascent) with other South-Indian chains / a leading national educational institution for PC for total ₹1L-1.4L.",
  },
  {
    question: 'What does Class 10 NEET Foundation cost in Hyderabad?',
    answer:
      'Cerebrum Class 10 Foundation pricing for Hyderabad families (pan-India online): Pursuit ₹35K-55K, Ascent ₹55K-75K, Pinnacle ₹75K-95K, ad-hoc 1:1 ₹2,000-3,500/hr. Hyderabad Class 10 specifically: other South-Indian chains integrated Class 10 Foundation (~₹85K-1.1L, 350-student) traditionally dominates this segment because of integrated school + coaching bundling that locks Class 10 → Intermediate → NEET in one ecosystem. a leading national educational institution similar (~₹85K-1.05L, 300-student). the 2nd-largest national NEET chain Scholastics Class 10 (~₹95K-1.2L, 250-student). Cerebrum biology-only Ascent (₹65K) is the structural alternative for families targeting AIIMS/JIPMER (where small-batch depth beats mass-volume drilling) rather than median state quota. Common Hyderabad pattern: Cerebrum biology + other South-Indian chains/a leading national educational institution PC stream for combined PCB at lower total cost than full the 2nd-largest national NEET chain.',
  },
]
