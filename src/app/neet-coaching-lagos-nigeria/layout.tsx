...
export const metadata: Metadata = {
  ...
  description:
    'Expert NEET coaching in Lagos, Nigeria. 98% success rate, expert faculty, comprehensive study materials. Join 5000+ successful students.',
  keywords:
    'NEET coaching Lagos, NEET exam center Lagos, best NEET classes Lagos, NEET preparation Nigeria',
  openGraph: {
    title: 'NEET Coaching in Lagos, Nigeria | 98% Success Rate',
    description:
      'Premium NEET coaching center in Lagos. Dr. Shekhar C Singh & expert faculty. Start your medical journey today.',
