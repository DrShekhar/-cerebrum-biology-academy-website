...
export function PageContent({ city, country }: PageContentProps) {
  ...
  const faqs: FAQ[] = [
    {
      id: 'faq-1',
      question: 'Why are there timezone challenges for Lagos students?',
      answer:
        'Lagos is 5.5 hours behind IST. Recorded lectures allow flexible learning. Weekend live sessions on Sunday/Monday evenings.',
    },
    {
      id: 'faq-2',
      question: 'Is NEET recognized in Nigeria for medical admission?',
      answer:
        'Not directly. But many Nigerian-Indian students score well in NEET and pursue MBBS in India to return to Nigeria practice.',
    },
    {
      id: 'faq-3',
      question: "What's the Indian community size in Lagos?",
      answer:
        '100,000+ strong Indian community. This is the largest Indian diaspora in West Africa.',
    },
    {
      id: 'faq-4',
      question: 'How do recorded lectures help for Lagos timezone?',
      answer:
        'All classes recorded same day. Students watch during daytime convenience. Doubt sessions in evening/weekend.',
    },
    {
      id: 'faq-5',
      question: 'Do you arrange travel for NEET exams?',
      answer:
        'Yes, we partner with travel agencies for exam center visits. Many Lagos students appear in Delhi/Bangalore centers.',
    },
    {
      id: 'faq-6',
      question: "What's the success rate for West African students?",
      answer:
        '98% qualified. 2023-24: 12 Lagos students in top 5000 ranks. Many studying in AIIMS/AFMC now.',
    },
  ]
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border-l-4 border-blue-500">
              ...
              <p className="text-gray-600">
                WAT timezone challenges overcome with recorded lectures
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-sm border-l-4 border-blue-500">
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-700 text-lg">
                  Lagos NEET exam center with 150 seats (managed through NEO partnership)
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-lg whitespace-pre-wrap">
                  Recorded Lectures + Weekend Sessions | Sunday & Monday: 6:00 PM - 10:00 PM WAT
                </p>
              </div>
            </div>
          </div>
