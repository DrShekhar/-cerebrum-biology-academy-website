...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'neet from class 11 gurgaon',
    'neet 2027 2 year course',
    'best 2 year neet coaching',
    'neet biology 2 year course',
  ],
  openGraph: {
    title: '2 Year NEET Course Gurugram 2026 | Cerebrum Biology Academy',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link
                href="/1-year-neet-course-gurugram"
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Course',
            name: '2 Year NEET Course Gurugram',
            description: 'Comprehensive 2-year NEET biology coaching from Class 11 in Gurugram',
            provider: {
              '@type': 'Organization',
