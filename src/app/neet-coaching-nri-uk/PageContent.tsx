...
export default function PageContent() {
  ...
  const faqs = [
    {
      id: 'faq-1',
      question: 'Can NEET get me into a UK medical school?',
      answer:
    ...
    {
      id: 'faq-2',
      question: 'What is the realistic pathway from NEET to the NHS?',
      answer:
        'It is multi-step: (1) qualify NEET-UG and complete an MBBS degree in India (typically 5.5 years), (2) return to the UK, (3) pass the UKMLA (UK Medical Licensing Assessment) to register with the GMC, (4) apply for UK Foundation training to enter NHS practice. NEET alone does not lead to NHS — it opens the Indian MBBS route, which is one option to eventually practise in the UK.',
    },
    {
      id: 'faq-3',
      question: 'Is there a NEET exam centre in the UK?',
      answer:
        'No. The NTA does not operate a NEET exam centre in the UK. The nearest overseas centres are Dubai, Abu Dhabi, Sharjah, Manama, Muscat and Doha — most UK candidates fly to one of these, or to India, to sit NEET-UG. We help enrolled students plan registration and exam travel.',
    },
    {
      id: 'faq-4',
      question: 'Can I prepare for NEET while doing A-Levels or IGCSE?',
      answer:
        'Yes. Many UK students run A-Level Biology and NEET prep in parallel — the concepts overlap significantly. Our Biology curriculum is NCERT-aligned and adds the NEET-specific depth beyond A-Level syllabus. We work around your school exam calendar.',
    },
    {
      id: 'faq-5',
    ...
    },
    {
      ...
      answer:
        '15% of seats at eligible Indian medical colleges are reserved for NRI/OCI candidates. We help you understand which colleges offer NRI seats, typical NEET cut-offs for those seats, and broad admission timelines. We are not an admissions consultancy.',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-8">
                The UK's A-Level system is fundamentally different from NEET. We bridge this gap,
                helping A-Level Biology students master NEET concepts while preserving their A-Level
            ...
            <div className="relative h-96 bg-gradient-to-br from-slate-900 to-slate-800 rounded-lg shadow-lg flex items-center justify-center">
              <div className="text-center text-white/70">
                ...
                <p className="text-lg font-medium">NEET Coaching in United Kingdom</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {['London', 'Birmingham', 'Leicester', 'Manchester', 'Leeds', 'Bradford', 'Slough'].map(
              (city) => (
                <div
                  key={city}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              Our specialized curriculum bridges United Kingdom's education system with NEET
              requirements. With 3 CBSE schools in London, Birmingham, Leicester, Manchester, we
            ...
            <ul className="space-y-3 mb-6">
              <li className="flex items-start">
                ...
                <span className="text-gray-700">
                  Converting United Kingdom curriculum to NEET format
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">✓</span>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-blue-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">
            NEET Coaching Plans for United Kingdom
          </h2>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Cerebrum is Cost-Effective for United Kingdom Students
          </h2>
