      ...
      <section className="py-12 bg-white border-t border-slate-200">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-slate-900 mb-2">
            Other Biology Programmes for UK Students
          </h2>
          <p className="text-slate-600 mb-6">
            Beyond NEET, Cerebrum serves UK students across GAMSAT, BBO, A-Level Biology, and IB
            Biology.
          </p>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
            ...
            <Link
              href="/gamsat-biology-tutor-edinburgh"
              className="block p-3 rounded-lg border border-slate-200 hover:border-purple-400 hover:shadow text-center transition"
            >
