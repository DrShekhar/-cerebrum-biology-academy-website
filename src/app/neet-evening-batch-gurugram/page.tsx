...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'evening neet coaching gurugram',
    'neet classes 5 pm to 8 pm',
    '5 to 8 neet coaching gurgaon',
    'evening biology classes gurugram',
  ...
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/neet-evening-batch-gurugram',
  },
...
const compatibleSchools = [
  { name: 'DPS Sector 45/67', endTime: '2:30 PM' },
  { name: 'Ryan International', endTime: '2:00 PM' },
  { name: 'GD Goenka', endTime: '2:30 PM' },
  { name: 'Shiv Nadar School', endTime: '3:00 PM' },
  { name: 'Scottish High', endTime: '2:30 PM' },
  { name: 'Heritage Xperiential', endTime: '3:00 PM' },
  { name: 'Pathways World School', endTime: '3:30 PM' },
  { name: 'Amity International', endTime: '2:30 PM' },
]
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link
                href="/neet-weekend-batch-gurugram"
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Course',
            name: 'NEET Evening Batch Gurugram',
            description: 'Evening NEET biology coaching after school hours in Gurugram',
            provider: {
              '@type': 'Organization',
