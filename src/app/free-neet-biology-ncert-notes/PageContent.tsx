...
import { Phone, Star, CheckCircle, Download, Users, Award, BookOpen } from 'lucide-react'
import Link from 'next/link'

const benefits = [
  'All 38 NCERT chapters summarized',
  'Key points highlighted for NEET',
  'Important diagrams included',
  'NCERT line references for each point',
...
export default function PageContent() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 via-white to-gray-50">
      {/* Hero */}
      <section className="relative py-16 bg-gradient-to-r from-orange-700 via-orange-600 to-orange-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            NEET Biology NCERT Quick Revision Notes
          </h1>
          <p className="text-xl text-orange-100 mb-2">
            All 38 Chapters Summarized for Quick Revision
          </p>
          <p className="text-lg text-orange-200 max-w-2xl mx-auto mb-8">
            Concise, exam-focused summaries of all NCERT Biology chapters (Class 11 + 12). Perfect
            for last-minute revision before NEET. Created by AIIMS faculty who know what matters.
          </p>
          <Link
            href="https://wa.me/918826444334?text=Hi%20I%20want%20the%20free%20ncert%20notes"
      ...
      <section className="py-12 max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-4">
          <Link href="/pricing" className="text-orange-600 hover:text-orange-800 font-semibold">
            View Courses &rarr;
          </Link>
          <Link
            href="/nri-students"
