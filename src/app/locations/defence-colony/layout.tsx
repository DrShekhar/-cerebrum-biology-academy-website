...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'NEET Biology Coaching Defence Colony Delhi',
    description:
      'Best NEET Biology coaching for Defence Colony students. AIIMS faculty, small batches, 98% success rate.',
  },
  alternates: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 3,
                name: 'Defence Colony',
                item: 'https://cerebrumbiologyacademy.com/locations/defence-colony',
              },
            ],
          }),
        }}
