...
export default function DefenceColonyPage() {
  ...
  const handleWhatsApp = async () => {
    await trackAndOpenWhatsApp({
      source: 'defence-colony-area-page',
      message: 'Hi! I am from Defence Colony and interested in NEET Biology coaching.',
      campaign: 'location-defence-colony',
    })
  }
  ...
  const faqs = [
    {
      q: 'How close is the center from Defence Colony?',
      a: 'Our South Extension flagship center is just 3 minutes from Defence Colony. You can reach via the Outer Ring Road or Lajpat Nagar Metro.',
    },
    {
      q: 'What boards do you cover?',
      a: 'We cover NEET Biology, CBSE, ICSE, and also offer IB/IGCSE Biology coaching for students from international schools.',
    },
    {
      q: 'Do you have weekend batches?',
      a: 'Yes! We have weekday and weekend batches available at South Extension center to suit different school schedules.',
    },
  ]
  ...
  return (
    <>
      <NEETSchemaStack
        pageUrl="https://cerebrumbiologyacademy.com/locations/defence-colony"
        pageName="NEET Biology Coaching for Defence Colony Students"
        parentHub={{
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center animate-fadeInUp">
              ...
              <h1 className="text-3xl md:text-5xl font-bold mb-4">
                NEET Biology Coaching for <span className="text-yellow-400">Defence Colony</span>{' '}
                Students
              </h1>
              <p className="text-lg md:text-xl text-gray-300 mb-6">
                Join our flagship South Extension center - just 3 minutes away. Expert AIIMS
                faculty, small batches.
              </p>
                ...
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-4 px-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-yellow-100 text-sm">Just 3 Min from Defence Colony</p>
                    </div>
                  </div>
                </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <LazyGoogleMap
                ...
                title={`South Extension Center - Nearest to Defence Colony`}
                height={300}
              />
            </div>
          </div>
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-green-50 to-teal-50">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">
              Why Defence Colony Families Choose <span className="text-green-600">Cerebrum</span>
            </h2>
            <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              {[
                { icon: MapPin, title: 'Closest Center', desc: 'Just 3 min away' },
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-2xl font-bold text-center mb-6">
                Schools & Connectivity Near Defence Colony
              </h2>
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  ...
                  <ul className="space-y-1 text-gray-600 text-sm">
                    {areaDetails['defence-colony'].schools.map((s) => (
                      <li key={s}>• {s}</li>
                    ))}
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-1 text-gray-600 text-sm">
                    {areaDetails['defence-colony'].nearbyMetro.map((m) => (
                      <li key={m}>• {m}</li>
                    ))}
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-1 text-gray-600 text-sm">
                    {areaDetails['defence-colony'].landmarks.map((l) => (
                      <li key={l}>• {l}</li>
                    ))}
                  </ul>
                </div>
        ...
        <RelatedLocations
          currentLocation="Defence Colony"
          locations={getRelatedLocations('defence-colony')}
          className="bg-white"
        />
      ...
      <ExploreCourses />
      <MobilePhoneStickyBar source="defence-colony-area" />
    </>
  )
}
