...
export default function WestendPage() {
  ...
  const handleWhatsApp = async () => {
    await trackAndOpenWhatsApp({
      source: 'westend-area-page',
      message: 'Hi! I am from Westend and interested in NEET Biology coaching.',
      campaign: 'location-westend',
    })
  }
  ...
  const faqs = [
    {
      q: 'Why do Westend & Vasant Vihar families choose Cerebrum?',
      a: 'Families from Westend and Vasant Vihar value academic excellence. Cerebrum offers AIIMS-qualified faculty led by Dr. Shekhar, small batch sizes of 15-20 students, and a 98% success rate. Many DPS RK Puram students study with us.',
    },
    {
      q: 'How do I reach the center from Westend?',
      a: 'From Westend/Vasant Vihar, take the Outer Ring Road towards South Extension - about 15-20 minutes. You can also take RK Puram Metro and connect to Lajpat Nagar Metro via Violet Line.',
    },
    {
      q: 'Do you offer IB and IGCSE Biology coaching?',
      a: 'Yes! Many students from American Embassy School and British School join us for IB/IGCSE Biology alongside NEET preparation. We offer specialized international board coaching.',
    },
  ]
  ...
  return (
    <>
      <NEETSchemaStack
        ...
        personKnowsAbout={[
          'NEET West End',
          'NEET Biology West End',
          'Medical entrance coaching West End',
        ]}
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center animate-fadeInUp">
              ...
              <h1 className="text-3xl md:text-5xl font-bold mb-4">
                NEET Biology Coaching for <span className="text-yellow-400">Westend</span> & Vasant
                Vihar Students
              </h1>
              <p className="text-lg md:text-xl text-gray-300 mb-6">
                Premium coaching near DPS RK Puram & Vasant Vihar. AIIMS faculty, IB/IGCSE support,
                ...
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-4 px-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-yellow-100 text-sm">15-20 Min from Westend</p>
                    </div>
                  </div>
                </div>
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-gray-700">
                      Via Outer Ring Road or RK Puram Metro → Lajpat Nagar Metro
                    </p>
                  </div>
                  <div className="border-t pt-4 mt-4">
                    <h3 className="font-semibold text-gray-900 mb-3">
                      Why Westend Families Trust Us
                    </h3>
                    {[
                      'Dr. Shekhar personally teaches - AIIMS alumnus',
                      'IB/IGCSE Biology support available',
                      'Small batches - maximum 15-20 students',
                      'DPS RK Puram students success stories',
                    ].map((f, i) => (
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <LazyGoogleMap
                ...
                title={`South Extension Center - Nearest to Westend`}
                height={300}
              />
            </div>
          </div>
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-blue-50 to-sky-50">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">
              Why Westend Families Choose <span className="text-blue-600">Cerebrum</span>
            </h2>
            <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              {[
                { icon: GraduationCap, title: 'Top Schools', desc: 'DPS RK Puram students' },
                { icon: Users, title: 'Small Batches', desc: '15-20 students max' },
                { icon: Trophy, title: '98% Success', desc: '695/720 top score' },
                { icon: Star, title: 'IB/IGCSE', desc: 'International boards' },
              ].map((item, idx) => (
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-wrap justify-center gap-3 max-w-4xl mx-auto">
              {nearbySchools.map((s, i) => (
                <span
                  key={i}
                  className="bg-blue-50 px-4 py-2 rounded-full text-sm border border-blue-200 text-blue-700"
                >
                  {s}
                </span>
              ))}
        ...
        <RelatedLocations
          ...
          locations={getRelatedLocations('westend')}
          className="bg-white"
        />
        ...
        <section className="py-12 bg-gradient-to-r from-blue-600 to-sky-600 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Start Your Medical Journey!</h2>
      ...
      <ExploreCourses />
      <MobilePhoneStickyBar source="westend-area" />
    </>
  )
}
