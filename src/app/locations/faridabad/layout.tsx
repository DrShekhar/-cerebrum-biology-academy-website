    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Cerebrum Biology Academy has a center at SCF-130, 2nd Floor, Above Union Bank, Huda Market, Sector 17, Faridabad. The center is just 5 minutes from Bata Chowk Metro Station (Violet Line) and serves students from all sectors of Faridabad.',
        },
      },
      {
        '@type': 'Question',
