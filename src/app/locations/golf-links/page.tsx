...
export default function GolfLinksPage() {
  ...
  return (
    <>
      <NEETSchemaStack
        pageUrl="https://cerebrumbiologyacademy.com/locations/golf-links"
        pageName="NEET Biology Coaching for Golf Links Students"
        parentHub={{ name: 'NEET Biology Coaching India', url: 'https://cerebrumbiologyacademy.com/neet-biology-coaching-india' }}
        personKnowsAbout={['NEET Golf Links', 'NEET Biology Golf Links', 'Medical entrance coaching Golf Links']}
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <LazyGoogleMap
                ...
                title={`South Extension Center - Nearest to Golf Links`}
                height={300}
              />
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-2xl font-bold text-center mb-6">
                Schools & Connectivity Near Golf Links
              </h2>
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  ...
                  <ul className="space-y-1 text-gray-600 text-sm">
                    {areaDetails['golf-links'].schools.map((s) => (
                      <li key={s}>• {s}</li>
                    ))}
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-1 text-gray-600 text-sm">
                    {areaDetails['golf-links'].nearbyMetro.map((m) => (
                      <li key={m}>• {m}</li>
                    ))}
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-1 text-gray-600 text-sm">
                    {areaDetails['golf-links'].landmarks.map((l) => (
                      <li key={l}>• {l}</li>
                    ))}
                  </ul>
                </div>
