              ...
              >
                ...
                <div className="p-6 space-y-3">
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-2 w-full bg-blue-600 text-white py-2 rounded-lg font-semibold hover:bg-blue-700 transition-all mt-2"
                  >
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <LazyGoogleMap
                ...
                title={`South Extension Center - Nearest to Panchsheel`}
                height={300}
              />
            </div>
          </div>
