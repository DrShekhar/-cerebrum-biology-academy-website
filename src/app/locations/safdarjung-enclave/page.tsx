...
export default function SafdarjungEnclavePage() {
  ...
  return (
    <>
      <NEETSchemaStack
        pageUrl="https://cerebrumbiologyacademy.com/locations/safdarjung-enclave"
        pageName="NEET Biology Coaching for Safdarjung Enclave Students"
        parentHub={{
          name: 'NEET Biology Coaching India',
          url: 'https://cerebrumbiologyacademy.com/neet-biology-coaching-india',
        }}
        personKnowsAbout={[
          'NEET Safdarjung Enclave',
          'NEET Biology Safdarjung Enclave',
          'Medical entrance coaching Safdarjung Enclave',
        ]}
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center animate-fadeInUp">
              ...
              <h1 className="text-3xl md:text-5xl font-bold mb-4">
                ...
                <span className="text-yellow-400">Safdarjung Enclave</span> Students
              </h1>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-gray-700">
                      Via Outer Ring Road or Green Park Metro → Lajpat Nagar Metro
                    </p>
                  </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <LazyGoogleMap
                ...
                title={`South Extension Center - Nearest to Safdarjung Enclave`}
                height={300}
              />
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-2xl font-bold text-center mb-6">
                Schools & Connectivity Near Safdarjung Enclave
              </h2>
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  ...
                  <ul className="space-y-1 text-gray-600 text-sm">
                    {areaDetails['safdarjung-enclave'].schools.map((s) => (
                      <li key={s}>• {s}</li>
                    ))}
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-1 text-gray-600 text-sm">
                    {areaDetails['safdarjung-enclave'].nearbyMetro.map((m) => (
                      <li key={m}>• {m}</li>
                    ))}
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-1 text-gray-600 text-sm">
                    {areaDetails['safdarjung-enclave'].landmarks.map((l) => (
                      <li key={l}>• {l}</li>
                    ))}
                  </ul>
                </div>
