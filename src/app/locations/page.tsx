      ...
      <section className="relative py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-blue-600 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
            <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20%E2%80%94%20interested%20in%20locations.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
              <Button
                size="lg"
