          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                ...
                personalized attention, 90% success rate. No need to travel to Delhi!
              </p>
            ...
            >
              <iframe
                src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3507.2!2d${CONTACT_INFO.location.gurugram.geo.longitude}!3d${CONTACT_INFO.location.gurugram.geo.latitude}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjjCsDI3JzM0LjIiTiA3N8KwMDEnMzUuOCJF!5e0!3m2!1sen!2sin!4v1234567890`}
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Cerebrum Biology Academy Gurugram Location"
              />
            </motion.div>
          </div>
        </div>
