...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'NEET Biology Coaching Jor Bagh | Near Safdarjung',
    description:
      'Premium NEET Biology coaching for Jor Bagh students. Ultra-elite locality near Safdarjung Tomb, Lodhi Gardens.',
  },
  alternates: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 3,
                name: 'Jor Bagh',
                item: 'https://cerebrumbiologyacademy.com/locations/jor-bagh',
              },
            ],
          }),
        }}
