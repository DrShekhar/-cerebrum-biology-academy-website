...
export default function AnandNiketanPage() {
  ...
  const handleWhatsApp = async () => {
    await trackAndOpenWhatsApp({
      source: 'anand-niketan-area-page',
      message: 'Hi! I am from Anand Niketan and interested in NEET Biology coaching.',
      campaign: 'location-anand-niketan',
    })
  }
  ...
  const faqs = [
    {
      q: 'How do I reach the center from Anand Niketan?',
      a: 'From Anand Niketan, drive via Ring Road and Africa Avenue to South Extension - approximately 20-25 minutes. Many families use cab services or arrange carpools with other students.',
    },
    {
      q: 'Do diplomat families send their children to Cerebrum?',
      a: 'Yes, we have students from diplomatic families who value quality education and discrete, professional environment. Our flexible scheduling accommodates international school timings.',
    },
    {
      q: 'What about students from international curriculum schools?',
      a: 'We cater to students from all boards including IB, IGCSE, and Cambridge. Our course includes NCERT-based NEET preparation alongside board-specific support.',
    },
  ]
  ...
  return (
    <>
      <NEETSchemaStack
        pageUrl="https://cerebrumbiologyacademy.com/locations/anand-niketan"
        pageName="NEET Biology Coaching for Anand Niketan Students"
        parentHub={{ name: 'NEET Biology Coaching India', url: 'https://cerebrumbiologyacademy.com/neet-biology-coaching-india' }}
        personKnowsAbout={['NEET Anand Niketan', 'NEET Biology Anand Niketan', 'Medical entrance coaching Anand Niketan']}
        faqs={faqs.map((f) => ({ question: f.q, answer: f.a }))}
      />
      <div className="min-h-screen bg-gray-50">
        <section className="bg-gradient-to-br from-indigo-900 via-blue-800 to-indigo-900 text-white py-12 md:py-20">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-3xl md:text-5xl font-bold mb-4">
                NEET Biology Coaching for <span className="text-yellow-400">Anand Niketan</span>{' '}
                Families
              </h1>
              <p className="text-lg md:text-xl text-gray-300 mb-6">
                Premium coaching near Chanakyapuri and Diplomatic Enclave. AIIMS faculty,
                international curriculum support, personalized attention.
              </p>
              ...
              >
                <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-4 px-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-yellow-100 text-sm">20-25 Min from Anand Niketan</p>
                    </div>
                  </div>
                </div>
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-gray-700">Via Ring Road & Africa Avenue - 20-25 min</p>
                  </div>
                  <div className="border-t pt-4 mt-4">
                    <h3 className="font-semibold text-gray-900 mb-3">
                      Why Anand Niketan Families Trust Us
                    </h3>
                    {[
                      'Premium environment matching diplomatic standards',
                      'Support for IB, IGCSE & international curricula',
                      'AIIMS faculty led by Dr. Shekhar',
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <LazyGoogleMap
                ...
                title={`South Extension Center - Nearest to Anand Niketan`}
                height={300}
              />
            </div>
          </div>
        ...
        <section className="py-12 md:py-16 bg-gradient-to-br from-indigo-50 to-blue-50">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">
              Why Anand Niketan Families Choose <span className="text-indigo-600">Cerebrum</span>
            </h2>
            <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              {[
                { icon: Globe, title: 'International', desc: 'IB/IGCSE support' },
        ...
        <RelatedLocations
          currentLocation="Anand Niketan"
          locations={getRelatedLocations('anand-niketan')}
          className="bg-white"
        />
      ...
      <ExploreCourses />
      <MobilePhoneStickyBar source="anand-niketan-area" />
    </>
  )
}
