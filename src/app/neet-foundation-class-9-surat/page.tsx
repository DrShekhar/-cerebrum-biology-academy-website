...
const PAGE_URL = 'https://cerebrumbiologyacademy.com/neet-foundation-class-9-surat'
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'class 9 biology coaching surat',
    'class 9 neet preparation surat',
    'best class 9 foundation surat',
    'online class 9 neet surat',
  ],
...
export default function Page() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <FoundationCityEnrichment slug="surat" classLevel={9} showIntro={false} />
