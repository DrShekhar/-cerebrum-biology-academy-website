...
const visakhapatnamAreas = [
  ...
  { name: 'Rushikonda', distance: '10 km', landmark: 'Beach Zone' },
  { name: 'Gajuwaka', distance: '14 km', landmark: 'Suburban Area' },
  { name: 'Visakhapatnam Port', distance: '5 km', landmark: 'Business Zone' },
]
...
const whyChooseUs = [
  ...
  {
    icon: Target,
    title: 'Weak NEET Coaching Ecosystem',
    description:
      'Unlike metros, Vizag lacks robust, structured NEET-only coaching centers. Cerebrum fills this gap with expert online classes, proper curriculum, and result-oriented approach.',
  },
  {
    icon: Building,
    title: 'Near Top Medical Colleges',
    description:
      'Proximity to Andhra Medical College, GITAM Dental, and other top institutions. Our coaching aligns with AP Inter + CBSE patterns and medical college entrance requirements.',
  },
  {
    icon: GraduationCap,
    title: 'Expert AP Curriculum Faculty',
    description:
      'AIIMS-trained instructors familiar with AP Inter Board + CBSE requirements. Comprehensive coverage of Andhra Pradesh education patterns.',
  },
]

const faqs = [
  {
    question: 'Do you have a physical center in Visakhapatnam?',
    answer:
      'We provide premium online NEET coaching for all Vizag students - MVP Colony, Dwaraka Nagar, Seethammadhara, Madhurawada, and beyond. Online format ensures students benefit from expert AIIMS faculty without commute constraints, with interactive doubt-clearing sessions.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'We have students from Delhi Public School Vizag, Timpany School, Oakridge, and other reputed institutions across Visakhapatnam. These quality schools produce disciplined students who thrive in our structured NEET preparation.',
  },
  {
    ...
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Online NEET Coaching in <span className="text-yellow-400">Visakhapatnam</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <a
                href="https://wa.me/918826444334?text=Hi%2C%20I%20am%20from%20Visakhapatnam%20and%20interested%20in%20NEET%20coaching"
                target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              Visakhapatnam & Nearby Localities
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Online NEET coaching accessible from every corner of Visakhapatnam city
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {visakhapatnamAreas.map((area, index) => (
              <div
                key={area.name}
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              Why Visakhapatnam Students Choose Cerebrum
            </h2>
          </div>
