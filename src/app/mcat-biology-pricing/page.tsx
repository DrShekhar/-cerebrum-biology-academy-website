      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          <nav className="text-sm text-slate-400 mb-6" aria-label="Breadcrumb">
            ...
            <Link href="/mcat-biology-preparation" className="hover:text-white">MCAT Biology</Link>
            <span className="mx-2">/</span>
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="overflow-x-auto">
            ...
            <tr className="border-b border-slate-100">
              <td className="py-3 px-4 text-slate-700">Princeton Review MCAT (all 4 sections)</td>
