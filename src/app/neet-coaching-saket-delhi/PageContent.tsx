...
const saketAreas = [
  ...
  { name: 'Saket Metro', distance: '19 km', landmark: 'Yellow Line' },
  { name: 'Press Enclave', distance: '21 km', landmark: 'Near PVR' },
  { name: 'Khirki Extension', distance: '22 km', landmark: 'Near Saket' },
  { name: 'Sheikh Sarai', distance: '17 km', landmark: 'Near Malviya Nagar' },
  { name: 'Lado Sarai', distance: '23 km', landmark: 'Art District' },
  { name: 'Qutub Institutional Area', distance: '25 km', landmark: 'Near QIA' },
]
...
const whyChooseUs = [
  ...
  },
  {
    icon: GraduationCap,
    title: 'AIIMS Faculty',
    description: 'Dr. Shekhar C Singh, AIIMS Alumnus with 15+ years experience in NEET Biology.',
  },
  {
    icon: Star,
...
const faqs = [
  {
    question: 'Do you have a coaching center in Saket?',
    answer:
      'Our main center is in Greater Noida. For Saket students, we offer premium live online NEET classes. Saket residents appreciate our modern online approach - no traffic hassles, attend from the comfort of home near Select City Walk. Our quality matches the best coaching centers.',
  },
  {
    question: 'How do Saket students benefit from online classes?',
    answer:
      'Saket is well-connected but traffic can be unpredictable. Our online NEET classes save 2-3 hours of daily commute. Students can revise using recorded lectures, get doubt clearing via WhatsApp, and attend from anywhere. Many Saket families appreciate this modern approach.',
  },
  {
    question: 'What schools do your Saket area students come from?',
    answer:
      'We have students from DPS Vasant Kunj, Amity Saket, Lotus Valley Noida, Delhi Public Library School, and schools in Malviya Nagar area. The student community around Saket-Malviya Nagar is highly motivated for NEET.',
  },
  {
    question: 'Do you offer weekend batches for Saket students?',
    answer:
      'Yes! We understand Saket families have busy weekday schedules. Our weekend intensive batches cover the complete NEET syllabus. We also have flexible weekday evening batches for students with school commitments.',
  },
]
...
const localBusinessSchema = {
  '@context': 'https://schema.org',
  '@type': 'LocalBusiness',
  name: 'Cerebrum Biology Academy - NEET Coaching Saket',
  description: 'Best NEET Coaching for Saket students - Modern South Delhi NEET Preparation',
  ...
  areaServed: ['Saket', 'Malviya Nagar', 'Press Enclave', 'Sheikh Sarai', 'Lado Sarai'],
  priceRange: '$$',
}
...
export default function PageContent() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero */}
      <section className="relative bg-gradient-to-br from-indigo-900 via-indigo-800 to-purple-900 text-white py-12 md:py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              ...
              Modern South Delhi | AIIMS Faculty
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Biology%20coaching%20in%20Saket.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer">
                <Button
                  variant="secondary"
                  size="xl"
      ...
      {/* CTA */}
      <section className="py-12 md:py-20 bg-gradient-to-r from-indigo-600 via-indigo-700 to-purple-700 text-white">
      ...
      <PricingSection cityName="Saket" />
      <CostComparisonSection cityName="Saket" />
      ...
      <section className="py-12 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link
              href="/biology-tutor-malviya-nagar"
              className="bg-white px-6 py-3 rounded-lg shadow hover:shadow-md transition"
            >
              Malviya Nagar
            </Link>
      ...
      <RelatedCityLinks currentCity="saket-delhi" variant="default" />
    </div>
  )
}
