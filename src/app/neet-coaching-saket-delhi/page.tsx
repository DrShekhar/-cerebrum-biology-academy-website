...
export default function NEETCoachingSaketPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero */}
      <section className="relative bg-gradient-to-br from-indigo-900 via-indigo-800 to-purple-900 text-white py-20 overflow-hidden">
      ...
      {/* CTA */}
      <section className="py-20 bg-gradient-to-r from-indigo-600 via-indigo-700 to-purple-700 text-white">
      ...
      <section className="py-12 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link
              href="/biology-classes-malviya-nagar"
              className="bg-white px-6 py-3 rounded-lg shadow hover:shadow-md transition"
            >
              Malviya Nagar
            </Link>
