...
import NEETCrashCourseFaridabadContent from './NEETCrashCourseFaridabadContent'
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'neet revision course faridabad',
  ...
  openGraph: {
    ...
    url: 'https://cerebrumbiologyacademy.com/neet-crash-course-faridabad',
  },
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/neet-crash-course-faridabad',
  },
}
...
export default function NEETCrashCourseFaridabadPage() {
  const courseSchema = {
    '@context': 'https://schema.org',
    '@type': 'Course',
    name: 'NEET Biology Crash Course - Faridabad',
    description:
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: 'Crash Course',
        item: 'https://cerebrumbiologyacademy.com/neet-crash-course-faridabad',
      },
    ],
  }
  ...
  return (
    <>
      ...
      />
      <NEETCrashCourseFaridabadContent faqs={faqs} />
    </>
  )
}
