...
export const metadata: Metadata = {
  ...
  description:
    'IB Biology tutoring pricing — $6,000/year Complete Programme, $8,000/year 1:1 Elite, $3,500/year Group Batch. 55 cities, local-currency options. 2025 syllabus, IA + EE coaching included.',
  keywords: [
    'IB biology pricing',
...
const wa =
  ...
  encodeURIComponent(
    'Hi — I want to discuss IB Biology pricing and which tier fits my goals. Please share programme details.'
  )
      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            IB Biology Pricing | HL & SL Tutoring Packages
          </h1>
          <p className="text-xl text-slate-300 mb-6 max-w-3xl">
            IB Biology tutoring pricing — $6,000/year Complete Programme, $8,000/year 1:1 Elite,
            $3,500/year Group Batch. 55 cities, local-currency options. 2025 syllabus, IA + EE
            coaching included.
          </p>
          <a
            href={wa}
              ...
              <tbody>
                <tr className="border-b border-slate-100">
                  <td className="py-3 px-4 font-medium text-slate-900">
                    IB Biology — Ascent (2-year)
                  </td>
                  <td className="py-3 px-4 text-green-700 font-bold">$6,000/year</td>
                  <td className="py-3 px-4 text-slate-600 text-sm">
                    HL + SL, 150+ hours, small batch 4–8, IA guidance, past-paper bank
                  </td>
                </tr>
                <tr className="border-b border-slate-100">
                  <td className="py-3 px-4 font-medium text-slate-900">
                    IB Biology — Pinnacle (1:1)
                  </td>
                  <td className="py-3 px-4 text-green-700 font-bold">$8,000/year</td>
                  <td className="py-3 px-4 text-slate-600 text-sm">
                    Examiner-led, fully customised, IA moderation-level feedback
                  </td>
                </tr>
                <tr className="border-b border-slate-100">
                  <td className="py-3 px-4 font-medium text-slate-900">
                    IB Biology — Pursuit (group)
                  </td>
                  <td className="py-3 px-4 text-green-700 font-bold">$3,500/year</td>
                  <td className="py-3 px-4 text-slate-600 text-sm">
                    Fixed weekly schedule, peer discussion, most affordable route
                  </td>
                </tr>
              </tbody>
            </table>
              ...
              <tbody>
                ...
                <tr className="border-b border-slate-100">
                  <td className="py-3 px-4 text-slate-700">
                    Local IB tutors (Singapore/Dubai/London)
                  </td>
