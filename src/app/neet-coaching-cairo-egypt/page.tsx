...
export const metadata: Metadata = {
  title: 'Best NEET Coaching in Cairo | 98% Success Rate | Cerebrum',
...
export default function NEETCoachingCairoPage() {
  return (
    <>
      <LocalitySchema locality="Cairo" slug="neet-coaching-cairo-egypt" pageTitle="Best NEET Coaching in Cairo" pageDescription="Expert NEET coaching for Indian students in Cairo serving Indian schools with 98% success rate." pageType="coaching" />
      <PageContent />
    </>
  )
}
