...
export default function PageContent() {
  ...
  const schools = [
    'Delhi Public School Cairo',
    'Bharatiya Vidya Bhavan Cairo',
    'Modern Indian School Cairo',
    'Future International School',
    'El Alsson International',
    'Cairo English School',
    'CBSE Schools Egypt',
    'Indian Schools Cairo',
  ]
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'We have 15+ years of NEET coaching experience. 98% success rate, 695/720 top score, and 15,000+ successful students. Specialized attention for Indian expat students. 24/7 WhatsApp support ensures quick doubt resolution.',
    },
    {
  ...
  return (
    <main className="bg-white">
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-6 inline-block">
            <span className="bg-blue-200 text-blue-900 px-6 py-2 rounded-full text-sm font-semibold">
              Trusted by 15,000+ Students
            </span>
          </div>
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Best NEET Coaching for Indian Students in Cairo
          </h1>
          <p className="text-xl md:text-2xl mb-12 text-blue-100">
            Expert AIIMS Faculty • 98% Success Rate • 695/720 Top Score • Serving Modern Indian
            School Cairo
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            ...
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg border border-white/20">
              ...
              <p className="text-sm text-blue-200">15,000+ Students</p>
            </div>
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg border border-white/20">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/918826444334?text=Hi%20Cerebrum%21%20I%20want%20to%20join%20NEET%20coaching%20in%20Cairo"
              target="_blank"
      ...
      <section
        ...
        className={`py-20 px-4 transition-opacity duration-1000 ${whyChooseSection.isVisible ? 'opacity-100' : 'opacity-0'}`}
      >
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-4">
            Why Choose Cerebrum for NEET in Cairo?
          </h2>
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Specialized coaching for Indian expat students in Egypt with proven success
          </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Flexible scheduling around Egypt timezone. Classes arranged to avoid school
                    hours. Morning/evening options available. Recorded sessions for maximum
                    flexibility.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-8 rounded-lg border border-blue-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Expert faculty from top AIIMS colleges with 15+ years of NEET coaching
                    experience. Proven track record of 695/720 top scores and medical college
                    admissions.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-8 rounded-lg border border-blue-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Small batch sizes ensure individual focus. Each student gets personalized study
                    plans based on strength and weakness analysis. One-on-one mentoring available.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-8 rounded-lg border border-blue-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Instant doubt clearing on WhatsApp. Our faculty responds within minutes. Video
                    calls available for complex topics. Regular progress tracking updates.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section
        ref={schoolsSection.ref}
        className={`py-20 px-4 bg-gray-50 transition-opacity duration-1000 ${schoolsSection.isVisible ? 'opacity-100' : 'opacity-0'}`}
      >
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-4">Schools We Support in Cairo</h2>
          <p className="text-gray-600 text-center mb-12">
            Students from these schools have achieved 98% success rate in NEET
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {schools.map((school, idx) => (
              <div
                key={idx}
                className="flex items-start gap-3 bg-white p-6 rounded-lg border border-gray-200"
              >
          ...
          <div className="mt-12 bg-blue-50 p-8 rounded-lg border-l-4 border-blue-600">
            <p className="text-gray-700">
              <strong>From another school?</strong> We support students from all CBSE and
              international schools in Cairo. Modern Indian School Cairo students are our main
              focus, but we welcome all Indian expat students in Egypt.
            </p>
          </div>
        </div>
      </section>
      ...
      <section
        ref={faqSection.ref}
        className={`py-20 px-4 transition-opacity duration-1000 ${faqSection.isVisible ? 'opacity-100' : 'opacity-0'}`}
      >
        <div className="max-w-3xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-4">Frequently Asked Questions</h2>
          <p className="text-gray-600 text-center mb-12">
            Everything you need to know about NEET coaching in Cairo
          </p>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-blue-900 to-purple-900 text-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Get expert NEET guidance for Cairo students. Free demo class available now.
          </p>
