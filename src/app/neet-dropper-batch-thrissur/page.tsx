...
const cityName = 'Thrissur'
const citySlug = 'thrissur'
...
export const metadata: Metadata = {
  ...
  keywords: ['neet dropper batch thrissur', 'neet repeater course thrissur', 'best dropper batch neet thrissur'],
  alternates: { canonical: `https://cerebrumbiologyacademy.com/neet-dropper-batch-thrissur` },
  openGraph: { title: `NEET Dropper Batch 2026-27 ${cityName}`, url: `https://cerebrumbiologyacademy.com/neet-dropper-batch-thrissur`, locale: 'en_IN', type: 'website' },
}
