...
const revisionHighlights = [
  {
    icon: RefreshCw,
    title: '2x Syllabus Coverage',
    description: 'Complete Biology covered twice in 3 months',
  },
...
const monthlyPlan = [
  {
    month: 'Month 1',
    focus: 'Rapid Concept Revision',
    topics: 'Complete NCERT line-by-line',
    mcqs: '600+',
  },
  {
    month: 'Month 2',
    focus: 'High-Yield Deep Dive',
    topics: 'Top 20 chapters in detail',
    mcqs: '800+',
  },
  {
    month: 'Month 3',
    focus: 'Test & Analysis',
    topics: 'Mock tests + weak area focus',
    mcqs: '600+',
  },
]
...
export default function NEETRevisionBatchFaridabadContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      ...
      message:
        'Hi! I am interested in the NEET Biology revision batch in Faridabad. Please share the next batch dates and fee details.',
      ...
      <nav className="bg-gray-100 py-3 px-4">
        <div className="max-w-7xl mx-auto">
          <ol className="flex items-center flex-wrap gap-1 text-sm">
            ...
            <li className="flex items-center">
              <ChevronRight className="w-4 h-4 text-gray-400 mx-1" />
              <span className="text-teal-700 font-medium">Revision Batch</span>
            </li>
          </ol>
        </div>
      </nav>
          ...
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 mb-8 inline-block">
              <p className="text-white text-lg">
                3-Month Program: <span className="text-yellow-400 font-bold text-2xl">₹40,000</span>
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            ...
            <p className="text-xl text-slate-600">
              Complete revision package for final preparation
            </p>
          </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <Link
              href="/neet-crash-course-faridabad"
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-teal-600 to-green-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join our revision batch and improve by 40-80 marks
          </p>
