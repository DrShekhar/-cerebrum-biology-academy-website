...
export const metadata: Metadata = {
  ...
  description:
    'Best NEET coaching for DPS International School Gurugram (Gurgaon) students. IGCSE/IB to NEET transition. 15 min from campus. AIIMS faculty, 98% success rate. Call 88264-44334!',
  keywords: [
...
const whyDPSIStudents = [
  {
    ...
    description:
      'Specialized modules to bridge international curriculum gaps for NEET requirements.',
    icon: Globe,
  },
  {
...
const faqs = [
  {
    ...
    answer:
      'Our center at M2K Corporate Park, Sector 51 is approximately 8-10 km from DPS International School. Via Golf Course Road, it takes 12-15 minutes.',
  },
  {
    question: 'Do you support IGCSE students for NEET?',
    answer:
      'Yes! IGCSE biology differs significantly from NEET syllabus. We have specific bridge modules covering gaps in Ecology, Human Physiology, and Plant Biology.',
  },
  {
    question: 'How is your approach different for international school students?',
    answer:
      "We focus on concept application rather than rote learning - matching your school style. MCQ training is added systematically as international curricula often don't emphasize this.",
  },
  {
    question: 'Can DPSI students balance school and NEET prep?',
    answer:
      'Absolutely. Our evening and weekend batches accommodate international school schedules. We also offer hybrid (online + offline) options for flexibility.',
  },
]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-white">
      ...
      <GurgaonGurugramAreaSchema
        spelling="gurugram"
        pageSlug="neet-coaching-dps-international-gurugram"
        subArea="DPS International Gurugram"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              NEET Coaching for DPS International
            </h1>
            <p className="text-xl text-indigo-100 mb-4">
              IGCSE/IB to NEET transition program at M2K Sector 51
            </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why DPS International Students Choose Us
          </h2>
              ...
              <div className="md:w-1/2 p-8">
                ...
                <div className="bg-indigo-50 p-4 rounded-lg mb-4">
                  <p className="text-sm text-indigo-800">
                    <strong>Route:</strong> DPSI → Golf Course Road → Sector 54 → Sector 51
                  </p>
                </div>
                <a
                  href="tel:+918826444334"
      ...
      <section className="py-16 bg-indigo-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-indigo-100 mb-8">
            Bridge the international curriculum to NEET with expert guidance.
          </p>
          <a
            href="tel:+918826444334"
