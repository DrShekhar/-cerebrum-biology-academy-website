    ...
    <main className="bg-white">
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-6 inline-block">
            <span className="bg-emerald-200 text-emerald-900 px-6 py-2 rounded-full text-sm font-semibold">
              Trusted by 15,000+ Students
            </span>
          </div>
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Best NEET Coaching for Indian Students in Jeddah
          </h1>
          <p className="text-xl md:text-2xl mb-12 text-emerald-100">
            Expert AIIMS Faculty • 98% Success Rate • 695/720 Top Score • Timezone-Friendly Online
            Classes
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            ...
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg border border-white/20">
              ...
              <p className="text-sm text-emerald-200">5.0/5 Rating</p>
            </div>
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg border border-white/20">
              <Users className="w-8 h-8 mx-auto mb-2 text-yellow-300" />
              <p className="text-sm text-emerald-200">15,000+ Students</p>
            </div>
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg border border-white/20">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/918826444334?text=Hi%20Cerebrum%21%20I%20want%20to%20join%20NEET%20coaching%20in%20Jeddah"
              target="_blank"
      ...
      >
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-4">
            Why Choose Cerebrum for NEET in Jeddah?
          </h2>
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Specialized coaching designed for Indian expat students with unique timezone and
            curriculum needs
          </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Classes scheduled for Saudi Arabia timezone. No clash with school hours. Live
                    interactive sessions at convenient times for Jeddah students.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    ...
                    experience. Proven track record of 695/720 top scores.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    ...
                    plans based on strength and weakness analysis.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    ...
                    calls available for complex topics.
                  </p>
                </div>
              </div>
            </div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 bg-emerald-50 p-8 rounded-lg border-l-4 border-emerald-600">
            <p className="text-gray-700">
              <strong>Not from these schools?</strong> We support students from all CBSE and
              international schools in Jeddah. Contact us to discuss your specific curriculum and
              requirements.
            </p>
          </div>
        </div>
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 text-center mb-12">
            Everything you need to know about NEET coaching in Jeddah
          </p>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-emerald-900 to-teal-900 text-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-emerald-100 mb-8">
            Get expert NEET guidance for Jeddah students. Free demo class available now.
          </p>
