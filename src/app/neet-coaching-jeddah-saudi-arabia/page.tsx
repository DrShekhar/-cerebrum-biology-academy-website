...
export default function NEETCoachingJeddahPage() {
  return (
    <>
      <LocalitySchema locality="Jeddah" slug="neet-coaching-jeddah-saudi-arabia" pageTitle="Best NEET Coaching in Jeddah" pageDescription="Expert NEET coaching for Indian students in Jeddah with 98% success rate and timezone-friendly online classes." pageType="coaching" />
      <PageContent />
    </>
  )
}
