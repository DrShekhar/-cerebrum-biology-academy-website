    ...
    <main className="bg-white">
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-6 inline-block">
            <span className="bg-indigo-200 text-indigo-900 px-6 py-2 rounded-full text-sm font-semibold">
              Trusted by 15,000+ Students
            </span>
          </div>
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Best NEET Coaching for Indian Students in Muscat
          </h1>
          <p className="text-xl md:text-2xl mb-12 text-indigo-100">
            Expert AIIMS Faculty • 98% Success Rate • 695/720 Top Score • Serving Indian Schools in
            Oman
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            ...
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg border border-white/20">
              ...
              <p className="text-sm text-indigo-200">5.0/5 Rating</p>
            </div>
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg border border-white/20">
              <Users className="w-8 h-8 mx-auto mb-2 text-yellow-300" />
              <p className="text-sm text-indigo-200">15,000+ Students</p>
            </div>
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg border border-white/20">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/918826444334?text=Hi%20Cerebrum%21%20I%20want%20to%20join%20NEET%20coaching%20in%20Muscat"
              target="_blank"
      ...
      >
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-4">
            Why Choose Cerebrum for NEET in Muscat?
          </h2>
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Specialized coaching for Indian expat students in Oman with proven success
          </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Muscat is 2.5 hours ahead of India. Classes scheduled to work perfectly with
                    Muscat school hours. Evening classes in Muscat = afternoon in India. Maximum
                    convenience.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-blue-50 p-8 rounded-lg border border-indigo-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Deep expertise with Indian School Muscat and Indian School Al Ghubra curricula.
                    Understand school schedules and exam patterns. Many family recommendations.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-blue-50 p-8 rounded-lg border border-indigo-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Instant doubt clearing on WhatsApp. No international charges for Oman. Faculty
                    responds within minutes. Video calls for complex biology and chemistry topics.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 bg-indigo-50 p-8 rounded-lg border-l-4 border-indigo-600">
            <p className="text-gray-700">
              ...
              international schools in Muscat and Oman. Indian School Muscat and Indian School Al
              Ghubra students form our core community.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 text-center mb-12">
            Everything you need to know about NEET coaching in Muscat
          </p>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-indigo-900 to-blue-900 text-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-indigo-100 mb-8">
            Get expert NEET guidance for Muscat students. Perfect timezone fit. Free demo available
            now.
          </p>
