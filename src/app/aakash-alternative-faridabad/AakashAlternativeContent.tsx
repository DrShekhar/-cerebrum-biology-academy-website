...
export default function AakashAlternativeFaridabadContent({ faqs }: { faqs: FAQ[] }) {
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              ...
              Discover why 400+ Faridabad students chose Cerebrum for focused NEET Biology
              preparation.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeInUp">
              ...
              <Link href="/complement-aakash-coaching-faridabad">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-slate-600 mb-6">
                  Our Faridabad center is at <strong>Sector 17</strong> - near Bata Chowk Metro (5
                  min walk). Perfect location for students from all parts of Faridabad.
                </p>
