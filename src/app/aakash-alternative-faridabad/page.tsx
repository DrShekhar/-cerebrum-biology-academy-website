...
export const metadata: Metadata = {
  title: 'Aakash Alternative in Faridabad | NEET Biology Coaching',
  description:
  ...
  twitter: {
    ...
    title: 'Aakash Alternative in Faridabad | NEET Biology Coaching',
    description:
      'Looking for Aakash alternative in Faridabad? Cerebrum Biology Academy offers personalized NEET coaching with smaller batches (10-20 students), AIIMS faculty, and 98% su...',
  },
}
...
export default function AakashAlternativeFaridabadPage() {
  const comparisonSchema = {
    ...
    description:
      'Comparison of Cerebrum Biology Academy vs Aakash for NEET preparation in Faridabad',
    mainEntity: {
