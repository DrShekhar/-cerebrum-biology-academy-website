...
const hub = getCountryHub('uk')!

export const metadata: Metadata = {
  title: hub.metaTitle,
  description: hub.metaDescription,
  keywords: hub.keywords.join(', '),
  alternates: { canonical: `https://cerebrumbiologyacademy.com/ib-biology-tutor-uk` },
  openGraph: {
    title: hub.metaTitle,
    description: hub.metaDescription,
    type: 'website',
    locale: 'en_IN',
    url: `https://cerebrumbiologyacademy.com/ib-biology-tutor-uk`,
  },
  twitter: {
