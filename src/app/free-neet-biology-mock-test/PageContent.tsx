...
import { Phone, Star, CheckCircle, Download, Users, Award, ClipboardCheck } from 'lucide-react'
import Link from 'next/link'

const benefits = [
  '90 questions in NTA NEET pattern',
  'Detailed solutions for every question',
  'Performance analysis and weak areas',
  'Difficulty level matching real NEET',
    ...
    <div className="min-h-screen bg-gradient-to-b from-red-50 via-white to-gray-50">
      ...
      <section className="relative py-16 bg-gradient-to-r from-red-700 via-red-600 to-red-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Free NEET Biology Mock Test 2026</h1>
          <p className="text-xl text-red-100 mb-2">
            90 Questions | NTA Pattern | Detailed Solutions
          </p>
          <p className="text-lg text-red-200 max-w-2xl mx-auto mb-8">
            Test your NEET readiness with our expertly crafted mock test. 90 questions matching the
            exact NTA pattern, with detailed solutions and performance analysis.
          </p>
          <Link
            href="https://wa.me/918826444334?text=Hi%20I%20want%20the%20free%20mock%20test"
          ...
          <p className="text-sm text-red-200 mt-3">WhatsApp +91-8826444334 to receive instantly</p>
        </div>
      </section>
      ...
      <section className="py-12 max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-4">
          <Link href="/pricing" className="text-red-600 hover:text-red-800 font-semibold">
            View Courses &rarr;
          </Link>
          <Link href="/nri-students" className="text-red-600 hover:text-red-800 font-semibold">
            NRI Students &rarr;
          </Link>
          <Link href="/free-resources" className="text-red-600 hover:text-red-800 font-semibold">
