...
export const metadata: Metadata = {
  ...
  description:
    'Real NEET success stories at Cerebrum Academy — 67+ AIIMS selections, 98% success rate, 15,000+ students trained. Watch video testimonials today!',
  keywords:
  ...
  openGraph: {
    title: 'NEET Success Stories | 15,000+ Students Trained',
    description:
