...
export const metadata: Metadata = {
  title: 'Free NEET Demo Class Ghaziabad | Book Now | Cerebrum Biology Academy',
  description:
  ...
  keywords: [
    ...
    'neet biology free demo ghaziabad',
    'free neet coaching demo ghaziabad',
    'try neet classes free ghaziabad',
    'neet demo class near me ghaziabad',
    'free biology class neet ghaziabad',
    'book free neet class ghaziabad',
  ],
  openGraph: {
    title: 'Free NEET Demo Class Ghaziabad | Cerebrum Biology Academy',
    description: 'Book your FREE NEET demo class. Experience our teaching before you decide.',
    url: 'https://cerebrumbiologyacademy.com/free-neet-demo-class-ghaziabad',
  },
  alternates: {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Free NEET Demo Class for Ghaziabad Students
            </h1>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            '@type': 'Event',
            name: 'Free NEET Biology Demo Class for Ghaziabad Students',
            description:
