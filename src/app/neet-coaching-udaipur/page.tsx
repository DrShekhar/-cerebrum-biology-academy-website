...
const features = [
  {
    ...
    description: 'Real-time teaching from the City of Lakes',
  },
  {
    icon: Users,
  ...
  {
    icon: BookOpen,
    title: 'RNT Medical College Focused',
    description: 'Coaching for RNT and Rajasthan medical colleges',
  },
  {
    icon: Clock,
  ...
  },
  {
    ...
    description: 'No need to migrate to Kota - get top coaching from the City of Lakes',
  },
]
...
const faqs = [
  {
    question: 'Why choose online coaching for NEET preparation in Udaipur?',
    answer:
      'Udaipur students often migrate to Kota. Our online coaching delivers same quality at Rs 24,000-48,000/year. Stay in the City of Lakes with family.',
  },
  {
    question: 'Which areas in Udaipur do you serve?',
    answer:
      'We serve Hiran Magri, Fateh Sagar, Chetak Circle, Sector 14, and all Udaipur localities.',
  },
  {
    question: 'What is the fee for NEET coaching in Udaipur?',
    answer: 'Our NEET Biology course ranges from Rs 24,000 to Rs 48,000 per year.',
  },
  {
    question: 'Do you understand RBSE patterns?',
    answer: 'Yes! We have specialized batches for RBSE students.',
  },
]
...
export default function NeetCoachingUdaipurPage() {
  const handleDemoBooking = () => {
    if (typeof window !== 'undefined' && (window as any).gtag) {
      ;(window as any).gtag('event', 'demo_booking_udaipur', {
        event_category: 'conversion',
        event_label: 'neet_coaching_udaipur_page',
        value: 1,
      })
    }
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto animate-fadeInUp">
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              ...
              City of Lakes | RNT Medical College Focused
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Best <span className="text-yellow-300">NEET Coaching in Udaipur</span>
            </h1>
            <h2 className="text-xl md:text-2xl opacity-90 mb-4">
              Hiran Magri | Fateh Sagar | Chetak Circle | Sector 14
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16 animate-fadeInUp">
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              NEET Coaching Across All Udaipur Localities
            </h2>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="animate-fadeInUp">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center mb-12">
              ...
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I'm%20interested%20in%20coaching%20udaipur.%20Please%20share%20fee%20structure%20and%20enrolment%20details."
                target="_blank"
                rel="noopener noreferrer"
              >
                <Button
