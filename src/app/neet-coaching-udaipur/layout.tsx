...
export const metadata: Metadata = {
  ...
  description:
    'Top NEET biology coaching in Udaipur for Rajasthan students. RNT Medical College focused! 94.2% success rate, AIIMS faculty. Hiran Magri, Fateh Sagar, Chetak Circle. 1,600+ students. Book free demo!',
  keywords:
  ...
  openGraph: {
    ...
    description:
      'Top NEET biology coaching in Udaipur with 94.2% success rate. RNT Medical College focused! AIIMS faculty.',
  ...
  twitter: {
    ...
    description:
      'Top NEET biology coaching in Udaipur. RNT focused! 94.2% success rate. Hiran Magri, Fateh Sagar.',
  },
  alternates: {
