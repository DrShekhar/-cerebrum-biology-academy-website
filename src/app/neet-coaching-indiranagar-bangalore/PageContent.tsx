...
const localBusinessSchema = {
  ...
  description:
    'Best NEET Coaching for Indiranagar Bangalore - Trusted by Premium Retail & Families',
...
export default function PageContent() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              ...
              Indiranagar's established families.
            </p>
      ...
      <PricingSection cityName="Indiranagar" />
      <CostComparisonSection cityName="Indiranagar" />
