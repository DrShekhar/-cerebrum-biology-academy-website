...
export const metadata: Metadata = {
  title:
    'Best NEET Coaching in Indiranagar Bangalore | 100 Feet Road, HAL | Cerebrum Academy',
  description:
  ...
  openGraph: {
    ...
    description:
      'Premium NEET biology coaching in Indiranagar with 94.2% success rate. AIIMS faculty, small batches. Perfect for East Bangalore elite families.',
  ...
  twitter: {
    ...
    description:
      'Premium NEET biology coaching in Indiranagar. 94.2% success rate. 100 Feet Road, HAL, CMH Road, Domlur.',
  },
  alternates: {
...
export default function IndiranagarBangaloreCoachingLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>
}
