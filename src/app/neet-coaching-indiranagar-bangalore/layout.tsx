...
export const metadata: Metadata = {
  title: 'Best NEET Coaching in Indiranagar Bangalore | 100 Feet Road, HAL',
  description:
  ...
  openGraph: {
    title: 'Best NEET Coaching in Indiranagar Bangalore | East Premium',
    description:
  ...
  twitter: {
    ...
    title: 'Best NEET Coaching in Indiranagar Bangalore',
    description:
