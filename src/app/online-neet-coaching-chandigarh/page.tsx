...
const PAGE_URL = 'https://cerebrumbiologyacademy.com/online-neet-coaching-chandigarh'

export const metadata: Metadata = {
  title: 'Online NEET Coaching Chandigarh | Cerebrum Biology Academy',
  description: 'Online NEET Coaching in Chandigarh — AIIMS-trained faculty, online live. Serving Sector 17, 22, 34, 35, 43, Mohali, Panchkula. From Rs 48,000/yr.',
  keywords: ['online neet coaching chandigarh', 'NEET biology chandigarh', 'best NEET chandigarh'],
  alternates: { canonical: PAGE_URL },
  openGraph: { title: 'Online NEET Coaching Chandigarh', url: PAGE_URL, locale: 'en_IN', type: 'website' },
}
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Online NEET Coaching in Chandigarh</h1>
          <p className="text-xl text-slate-300 mb-6 max-w-3xl">NEET Biology coaching for Chandigarh (Punjab/Haryana). AIIMS-trained faculty, online live. Serving Sector 17, 22, 34, 35, 43, Mohali, Panchkula.</p>
