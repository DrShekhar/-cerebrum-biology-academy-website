...
export default function NEETTestSeriesContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      ...
      message:
        'Hi! I am interested in the NEET Biology test series in Faridabad. Please share the packages and registration details.',
      campaign: 'test-series-faridabad',
    })
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              NEET Test Series
              <span className="block text-yellow-400 mt-2">50+ Mock Tests in Faridabad</span>
            </h1>

            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              Comprehensive test series with detailed analysis, rank prediction, and personalized
              improvement suggestions. Join 1,50,000+ students preparing with us.
            </p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            <Link
              href="/neet-revision-batch-faridabad"
              className="bg-white p-4 rounded-xl hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">Revision Batch</h3>
