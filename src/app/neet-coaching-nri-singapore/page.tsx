    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Neet Coaching Singapore — Cerebrum Biology Academy',
      },
    ],
  },
}
      ...
      <section className="py-12 bg-white border-t border-slate-200">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-slate-900 mb-2">
            Other Biology Programmes in Singapore
          </h2>
          <p className="text-slate-600 mb-6">
            Beyond NEET, Cerebrum serves Singapore students across IB Biology, AP Biology, GAMSAT,
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
            ...
            >
              <span className="font-medium text-slate-900 text-sm">IB Biology UWCSEA</span>
            </Link>
            <Link
            ...
            >
              <span className="font-medium text-slate-900 text-sm">
                IB Biology Stamford American
              </span>
            </Link>
            <Link
              href="/ib-biology-tutor-tanglin-trust"
              className="block p-3 rounded-lg border border-slate-200 hover:border-blue-400 hover:shadow text-center transition"
            >
              <span className="font-medium text-slate-900 text-sm">IB Biology Tanglin Trust</span>
            </Link>
            <Link
              href="/ap-biology-tutor-singapore"
              className="block p-3 rounded-lg border border-slate-200 hover:border-blue-400 hover:shadow text-center transition"
            >
              <span className="font-medium text-slate-900 text-sm">AP Biology Singapore</span>
            </Link>
            <Link
              href="/sbo-coaching"
              className="block p-3 rounded-lg border border-slate-200 hover:border-blue-400 hover:shadow text-center transition"
