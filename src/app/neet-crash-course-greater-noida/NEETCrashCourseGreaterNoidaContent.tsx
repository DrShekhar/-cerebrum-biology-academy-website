...
export default function NEETCrashCourseGreaterNoidaContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      ...
      message:
        'Hi! I am interested in the NEET Biology crash course for Greater Noida students. Please share the next batch dates and fee details.',
      campaign: 'crash-course-greater-noida',
    })
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              45-Day NEET
              <span className="block text-yellow-400 mt-2">Crash Course for Greater Noida</span>
            </h1>
