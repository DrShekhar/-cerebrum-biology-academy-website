...
export const metadata: Metadata = {
  ...
  description:
    'Top NEET biology coaching in Prayagraj (Allahabad) for UP students. MLN Medical College focused! 94.2% success rate, AIIMS faculty. Civil Lines, Tagore Town, George Town, Katra. 2,800+ students. Book free demo!',
  keywords:
  ...
  openGraph: {
    ...
    description:
      'Top NEET biology coaching in Prayagraj with 94.2% success rate. MLN Medical College focused! AIIMS faculty, small batches. Join 2,800+ UP students from Civil Lines, Tagore Town.',
  ...
  twitter: {
    ...
    description:
      'Top NEET biology coaching in Prayagraj. MLN focused! 94.2% success rate. Civil Lines, Tagore Town, George Town, Katra.',
  },
  alternates: {
