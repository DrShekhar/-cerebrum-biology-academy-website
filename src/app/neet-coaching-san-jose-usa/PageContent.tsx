  ...
  const faqData = [
    {
      ...
      answer: 'Cerebrum Academy offers 98% success rate with personalized coaching from Dr. Shekhar C Singh. We understand San Jose student needs and provide curriculum-aligned preparation.'
    },
    {
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-r from-blue-600 to-purple-700 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-blue-100">
            Contact Dr. Shekhar C Singh today for personalized NEET coaching in San Jose
          </p>
