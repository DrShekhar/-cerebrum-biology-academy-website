...
export default function NEETCoachingPageContent() {
  const faqData = [
    {
      question: 'Why choose Cerebrum Biology Academy for NEET coaching in San Jose?',
      answer: 'Cerebrum Academy offers 98% success rate with personalized coaching from Dr. Shekhar C Singh — AIIMS Alumnus, India\'s Top Biology Teacher for NEET & Olympiads, Best Biology Educator Globally, with 15+ years of experience. We understand San Jose student needs and provide curriculum-aligned preparation.'
    },
    {
      question: 'What is the success rate for students in San Jose?',
      answer: 'Our San Jose center maintains a consistent 98% success rate with students regularly scoring in top percentiles.'
    },
    {
      question: 'Do you offer online NEET coaching for San Jose students?',
    ...
    {
      question: 'What are the class timings at San Jose center?',
      answer: 'We offer flexible batches in morning, afternoon, and evening aligned with PST timezone, accommodating school schedules.'
    },
    {
  ...
  return (
    <>
      <LocalitySchema
        name="Cerebrum Biology Academy - San Jose Center"
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center mb-12 text-gray-900">
            Why Choose Cerebrum Academy in San Jose?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div key="0" className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              <h3 className="font-bold text-lg mb-2 text-gray-900">Highest Indian-American concentration in USA</h3>
            ...
            <div key="1" className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              <h3 className="font-bold text-lg mb-2 text-gray-900">Silicon Valley tech families' preferred coaching</h3>
              <p className="text-gray-700">Expert coaching aligned with local education standards.</p>
            </div>
            <div key="2" className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              <h3 className="font-bold text-lg mb-2 text-gray-900">Proximity to Cupertino and Sunnyvale tech hubs</h3>
              <p className="text-gray-700">Expert coaching aligned with local education standards.</p>
            </div>
            <div key="3" className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              <h3 className="font-bold text-lg mb-2 text-gray-900">Support for Monta Vista and Lynbrook High School students</h3>
              <p className="text-gray-700">Expert coaching aligned with local education standards.</p>
            </div>
            <div key="4" className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              <h3 className="font-bold text-lg mb-2 text-gray-900">Integration with tech-forward learning methods</h3>
              <p className="text-gray-700">Expert coaching aligned with local education standards.</p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div key="0" className="bg-blue-50 p-4 rounded-lg border border-blue-200">Monta Vista High School</div>
            <div key="1" className="bg-blue-50 p-4 rounded-lg border border-blue-200">Lynbrook High School</div>
            <div key="2" className="bg-blue-50 p-4 rounded-lg border border-blue-200">Homestead High School</div>
            <div key="3" className="bg-blue-50 p-4 rounded-lg border border-blue-200">Fremont High School</div>
            <div key="4" className="bg-blue-50 p-4 rounded-lg border border-blue-200">Cupertino High School</div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 bg-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl sm:text-4xl font-bold mb-8 text-gray-900">
            Class Timings in San Jose
          </h2>
          <p className="text-lg text-gray-700 mb-6">
            Afternoon and evening batches aligned with PST timezone, flexible for tech family schedules
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="font-bold text-lg mb-3">Weekday Classes</h3>
              <p className="text-gray-700">Evening: 6:00 PM - 8:30 PM (PST)</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="font-bold text-lg mb-3">Weekend Classes</h3>
              <p className="text-gray-700">Saturday & Sunday: 10:00 AM - 1:00 PM (PST)</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-r from-blue-600 to-purple-700 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-blue-100">
            Contact Dr. Shekhar C Singh — AIIMS Alumnus, India's Top Biology Teacher, Best Biology Educator Globally — for personalized NEET coaching in San Jose
          </p>
      ...
      {/* Related Cities */}
      <RelatedCityLinks currentCity="San Jose" />
    </>
  );
}
