...
const startingPoints = [
  {
    ...
    advantages: [
      ...
      'No pressure, gradual learning',
      'Time for Olympiads and extra activities',
    ],
  ...
  },
  {
    ...
    color: 'blue',
    advantages: [
      'Perfect balance of time and focus',
      '2 full years for preparation',
      'Can cover syllabus twice',
    ],
...
const monthlyTimeline = [
  {
    month: 'April-June (Class 11)',
    focus: 'Foundation: Basic Biology, Physics mechanics, Chemistry basics',
  },
...
const faqs = [
  {
    ...
    answer:
      'Not too late, but challenging. You have 1 year - join an intensive batch, study 8-10 hours daily, and focus on high-weightage chapters. Many students crack NEET starting from Class 12.',
  },
  {
    question: 'Should I start NEET preparation from Class 9?',
    answer:
      'Not intensive preparation, but foundation building. Focus on understanding concepts, reading NCERT, and developing interest in Biology. Formal coaching can wait until Class 11.',
  },
  {
    question: 'Can I crack NEET in 6 months?',
    answer:
      'Possible if you have strong Class 11-12 base. Join a crash course, study 10-12 hours daily, focus on Biology (50% marks), and attempt 50+ mock tests. Success rate is lower but achievable.',
  },
  {
    question: "What if I'm already in Class 12 and haven't started?",
    answer:
      'Start immediately! Join a 1-year program or crash course. Focus on NCERT first, prioritize Biology, then tackle Physics numericals and Chemistry formulas. Still 10-12 months left.',
  },
  {
    question: 'Is dropping a year for NEET worth it?',
    answer:
      'If you scored 550+ in first attempt, dropping can help reach 650+. If below 500, analyze why - was it preparation or aptitude? Dropping only works with changed strategy.',
  },
]
    ...
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-orange-100 mb-8">
              Expert guide on ideal timing for maximum success
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-gradient-to-r from-orange-50 to-amber-50 border-l-4 border-orange-500 p-6 rounded-lg mb-8">
              ...
              <p className="text-lg text-orange-800">
                <strong>Ideal: Start of Class 11.</strong> This gives you 2 full years for
                comprehensive preparation. However, students successfully crack NEET starting from
                Class 12 (1 year) or even as droppers. The key is not when you start, but how
                effectively you use the time you have.
              </p>
            </div>
          </div>
        </div>
            ...
            {startingPoints.map((point, index) => (
              ...
              >
                ...
                <div className="bg-gray-50 p-3 rounded-lg">
                  <p className="text-sm">
                    <strong>Approach:</strong> {point.approach}
                  </p>
                </div>
              </div>
            ))}
              ...
              {monthlyTimeline.map((item, index) => (
                <div key={index} className="flex gap-4 mb-4">
                  <div className="flex flex-col items-center">
                    <div
                      className={`w-4 h-4 rounded-full ${index < 3 ? 'bg-blue-500' : index < 5 ? 'bg-orange-500' : 'bg-green-500'}`}
                    />
                    {index < monthlyTimeline.length - 1 && (
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-amber-800 mb-4">
                  If you're starting in Class 12 or later, here's what to prioritize:
                </p>
                <ul className="space-y-2 text-amber-800">
                  <li>
                    • <strong>Biology first</strong> - 50% marks, most scoring
                  </li>
                  <li>
                    • <strong>High-weightage chapters</strong> - Focus on what matters most
                  </li>
                  <li>
                    • <strong>NCERT only initially</strong> - Master before moving to reference
                    books
                  </li>
                  <li>
                    • <strong>Mock tests early</strong> - Start from day 1 with chapter-wise tests
                  </li>
                  <li>
                    • <strong>Join crash course</strong> - Structured approach saves time
                  </li>
                </ul>
              </div>
            </div>
      ...
      <section className="py-16 bg-orange-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-orange-100 mb-8">
            Get personalized guidance on the right program for your stage.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 bg-orange-800 text-white px-8 py-3 rounded-lg font-semibold hover:bg-orange-900 transition"
            >
              Book Free Demo
