  ...
  const faqData = [
    {
      ...
      answer:
        'Cerebrum Academy offers 98% success rate with personalized coaching from Dr. Shekhar C Singh. We understand Manila student needs and provide curriculum-aligned preparation.',
    },
    {
      question: 'What is the success rate for students in Manila?',
      answer:
        'Our Manila center maintains a consistent 98% success rate with students regularly scoring in top percentiles.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'We offer flexible batches in morning, afternoon, and evening aligned with PHT timezone, accommodating school schedules.',
    },
    {
      question: 'How does Cerebrum Academy help with curriculum transition?',
      answer:
        'We provide comprehensive curriculum bridge programs connecting Philippines school education with NEET requirements.',
    },
    {
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
          <div className="text-center">
            ...
            <p className="text-xl sm:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto">
              NEET Coaching in Manila - Philippines' premier medical entrance hub with International
              School Manila partnerships and business community support.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div key="1" className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              <h3 className="font-bold text-lg mb-2 text-gray-900">
                International School Manila partnerships
              </h3>
              <p className="text-gray-700">
                Expert coaching aligned with local education standards.
              </p>
            ...
            <div key="2" className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              <h3 className="font-bold text-lg mb-2 text-gray-900">
                Beacon Academy and Brent connections
              </h3>
              <p className="text-gray-700">
                Expert coaching aligned with local education standards.
              </p>
            ...
            <div key="4" className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              <h3 className="font-bold text-lg mb-2 text-gray-900">
                Gateway to medical excellence in Asia
              </h3>
              <p className="text-gray-700">
                Expert coaching aligned with local education standards.
              </p>
