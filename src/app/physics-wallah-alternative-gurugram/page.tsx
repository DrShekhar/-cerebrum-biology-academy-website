...
export const metadata: Metadata = {
  title: 'PhysicsWallah Alternative Gurugram | Offline Expert Biology',
  description:
    'Need offline alternative to PhysicsWallah in Gurugram (Gurgaon)? Cerebrum: Real classroom experience, AIIMS faculty, 98% success rate. Better than video lectures. Call 88264-44334!',
  keywords: [
    'physics wallah alternative gurugram',
    'physics wallah alternative gurgaon',
    'offline neet coaching gurugram',
    'pw alternative gurugram',
    'better than physics wallah',
    'pw vidyapeeth alternative',
    'real classroom neet coaching',
    'offline biology classes gurugram',
    'neet biology coaching gurugram',
    'physics wallah supplement gurugram',
  ],
  openGraph: {
    locale: 'en_IN',
    title: 'PhysicsWallah Alternative Gurugram',
    description:
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <span className="inline-block bg-yellow-500 text-purple-900 px-4 py-1 rounded-full text-sm font-semibold mb-4">
              PhysicsWallah Alternative in Gurugram
            </span>
