...
export const metadata: Metadata = {
  ...
  description:
    'Best biology tuition & NEET coaching in Surat. 94.2% success rate. AIIMS faculty. Adajan, Vesu, Athwa, City Light. Online live classes. Fee ₹24,000+. Book free demo!',
  keywords:
  ...
  openGraph: {
    title: 'Best Biology Tuition in Surat | NEET Coaching | Cerebrum Academy',
    description:
      'Best biology tuition in Surat with 94.2% success rate. AIIMS faculty. Adajan, Vesu, Athwa, City Light.',
