...
export const metadata: Metadata = {
  title: 'Best Biology Tuition in Surat | NEET Coaching',
  description:
  ...
  twitter: {
    ...
    title: 'Best Biology Tuition in Surat | NEET Coaching',
    description:
      'Best biology tuition & NEET coaching in Surat. 98% success rate. AIIMS faculty. Adajan, Vesu, Athwa, City Light.',
  },
  alternates: {
