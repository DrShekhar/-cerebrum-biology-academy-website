...
const WHATSAPP_MESSAGE = encodeURIComponent('Hi! I am interested in biology tuition in Surat. Please share details.')
...
const features = [
  { icon: Video, title: 'Live Interactive Classes', description: 'Real-time online coaching for Surat students. No commute needed.' },
  { icon: Users, title: 'Small Batches (10-15)', description: 'Personalized attention unlike crowded Surat coaching centers.' },
  { icon: Award, title: 'AIIMS Trained Faculty', description: 'Expert doctors and teachers from premier medical institutions.' },
  { icon: BookOpen, title: 'CBSE + Gujarat Board', description: 'Complete biology coaching for both board exams and NEET.' },
  { icon: Clock, title: 'Flexible Timings', description: 'Morning, afternoon, evening batches. Fit your school schedule.' },
  { icon: Shield, title: 'All Surat Covered', description: 'Adajan, Vesu, Athwa, City Light - all served with same quality.' },
]
...
const faqs = [
  { question: 'Why choose online biology tuition over Surat coaching centers?', answer: 'Surat coaching centers typically have large batches. Our online classes limit to 10-15 students. Save commute time across Surat\'s busy roads, get personalized attention, same 94.2% success rate.' },
  { question: 'Which areas in Surat do you serve?', answer: 'We serve all Surat areas including Adajan, Vesu, Athwa, City Light, Piplod, Pal, Katargam, Varachha, and surrounding areas. Online live classes mean you can join from anywhere in Surat.' },
  { question: 'What is the fee for NEET coaching in Surat?', answer: 'Our comprehensive NEET Biology coaching ranges from Rs 24,000 to Rs 68,000 per year. Competitive pricing with much smaller batches and personalized attention. EMI available.' },
  { question: 'Which medical colleges can Surat students target?', answer: 'With strong NEET scores, Surat students can target: Government Medical College Surat, B.J. Medical College Ahmedabad, AIIMS, GMERS colleges across Gujarat, plus other all-India institutes.' },
  { question: 'Do you cover Gujarat Board (GSEB) syllabus?', answer: 'We focus on English medium students. While Gujarat Board has some differences, our NCERT-focused approach ensures complete NEET coverage. CBSE and English medium GSEB students benefit most.' },
  { question: 'How is Surat\'s NEET preparation scenario?', answer: 'Surat has a growing NEET aspirant community with many students traveling to Ahmedabad or Rajkot for coaching. Our online format brings quality AIIMS faculty to Surat without the travel hassle.' },
]

const premiumSchools = ['Delhi Public School Surat', 'SGVP International School', 'Shree Swaminarayan Gurukul', 'The New Tulip International', 'Udgam School for Children', 'Podar International Surat', 'Vibgyor High Surat', 'St. Xaviers High School']
...
export default function BiologyTuitionSuratPage() {
  const handleWhatsAppClick = () => {
    if (typeof window !== 'undefined' && (window as any).gtag) {
      ;(window as any).gtag('event', 'whatsapp_click', { event_category: 'conversion', event_label: 'surat_biology_page' })
    }
  ...
  return (
    <div className="min-h-screen">
      <CitySchema cityName="Surat" citySlug="surat" state="Gujarat" localities={localities.map((l) => l.name)} faqs={faqs} studentCount="680" coordinates={{ lat: '21.1702', lng: '72.8311' }} />
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <motion.div className="text-center max-w-4xl mx-auto" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              <MapPin className="w-5 h-5 mr-2" />Diamond City | Gujarat
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Best <span className="text-[#4ade80]">Biology Tuition in Surat</span></h1>
            <h2 className="text-xl md:text-2xl opacity-90 mb-4">Adajan | Vesu | Athwa | City Light | All Surat</h2>
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">Premium Biology tuition & NEET coaching for Surat students. 94.2% success rate, AIIMS faculty. Target GMC Surat, AIIMS. Join 680+ Surat students!</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div className="text-center mb-16"><h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">Biology Tuition Across Surat</h2></motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div className="text-center mb-16"><h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">Why Surat Students Choose Us</h2></motion.div>
      ...
      <section className="py-16 bg-gray-50"><div className="max-w-7xl mx-auto px-4"><div className="bg-white rounded-2xl p-8 shadow-lg"><h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Students from These Surat Schools Trust Us</h3><div className="flex flex-wrap justify-center gap-4">{premiumSchools.map((school) => (<span key={school} className="bg-gray-100 text-gray-700 px-4 py-2 rounded-full font-medium">{school}</span>))}</div></div></div></section>

      <VideoTestimonialsSection />

      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div className="text-center mb-16"><h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">FAQs - Biology Tuition Surat</h2></motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#1e3a5f] via-[#2d5a87] to-[#3d7ab5] text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}>
            <h2 className="text-3xl md:text-5xl font-bold mb-6">Ready to Excel in Biology & NEET from Surat?</h2>
            <p className="text-xl md:text-2xl mb-8 opacity-90">Join 680+ Surat students. Target GMC Surat, AIIMS. 94.2% success rate!</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Button variant="secondary" size="xl" onClick={handleWhatsAppClick} className="bg-[#25D366] text-white hover:bg-[#20BD5A] flex items-center justify-center gap-2"><MessageCircle className="w-6 h-6" /><span>WhatsApp Us Now</span></Button>
