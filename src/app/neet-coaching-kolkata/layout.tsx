...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Top NEET biology coaching in Kolkata with 94.2% success rate. AIIMS faculty, small batches. Join 4,000+ West Bengal students from Salt Lake, Park Street, New Town.',
  ...
  twitter: {
    ...
    description:
      'Top NEET biology coaching in Kolkata. 94.2% success rate. Salt Lake, Park Street, New Town, Howrah, Jadavpur.',
  },
  alternates: {
