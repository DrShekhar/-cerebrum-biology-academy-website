      ...
      <section className="bg-gradient-to-r from-purple-600 to-blue-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center">
            ...
            >
              Transparent pricing with flexible payment options. No hidden charges, 
              multiple EMI plans, and scholarship opportunities available.
            </motion.p>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Choose the program that best fits your needs and budget</p>
          </div>
                ...
                <div className="text-center mb-6">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex items-center justify-center">
                      <span className="text-lg text-gray-500 line-through mr-2">₹{course.originalPrice.toLocaleString()}</span>
            ...
            >
              ...
              <div className="mt-8 bg-blue-50 border border-blue-200 rounded-2xl p-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-blue-900 mb-2">EMI Terms & Conditions</h4>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {scholarships.map((scholarship, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
              >
                <div className={`w-12 h-12 ${scholarship.color} rounded-full flex items-center justify-center mx-auto mb-4`}>
