...
export default function BrochurePage() {
  ...
  const brochures = [
    ...
    },
    {
      ...
      pages: 16,
      features: ['Curriculum overview', 'Study methodology', 'Assessment pattern', 'Sample materials'],
      type: 'class-11'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center">
            ...
            >
              Get detailed information about our NEET Biology courses, faculty profiles, 
              success stories, and fee structure. Everything you need to make an informed decision.
            </motion.p>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Choose the brochure that matches your course interest</p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Fill this form to receive detailed course brochures</p>
          </div>
          ...
          >
            {submitted ? (
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Brochures Sent Successfully!</h3>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Cerebrum Biology Academy?</h2>
            <p className="text-xl text-gray-600">Discover what makes us India's leading NEET Biology coaching institute</p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button variant="primary" size="xl" className="bg-white text-indigo-600 hover:bg-gray-100">
