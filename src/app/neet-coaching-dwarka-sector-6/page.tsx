...
const faqStructuredData = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'How do Dwarka Sector 6 students reach Cerebrum Biology Academy?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Students from Dwarka Sector 6 can walk to Dwarka Sector 9 Metro (5-8 min), take Blue Line to Rajiv Chowk, then Yellow Line to Rohini West. Total journey is about 28 minutes. Many Sector 6 students prefer our online classes for convenience.',
      },
    },
    {
      '@type': 'Question',
      name: 'What is the fee for NEET coaching for Dwarka Sector 6 students?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Our comprehensive NEET biology course fee is Rs 75,000/year for Class 12 students. We offer EMI options and scholarships up to 50% for deserving students. Online and offline fees are the same. Contact us at 88264-44334 for details.',
      },
    },
    {
      '@type': 'Question',
      name: 'Do students from Dwarka Sector 6 schools join Cerebrum?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes! We have students from DAV Public School, Mount Carmel School, Ryan International, and other top schools in Dwarka Sector 6 and nearby areas. Our flexible online and offline options suit all students.',
      },
    },
    {
      '@type': 'Question',
      name: 'What batch timings are available for Dwarka Sector 6 students?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'We offer Morning (8 AM - 10 AM), Afternoon (2 PM - 4 PM), and Evening (6 PM - 8 PM) batches. Weekend batches (Saturday-Sunday) are very popular. Online live classes available in all slots.',
      },
    },
  ],
}
...
const nearbyAreas = [
  ...
  { name: 'Dwarka Sector 7', distance: '5 min', link: '/neet-coaching-dwarka' },
  { name: 'Dwarka Sector 8', distance: '8 min', link: '/neet-coaching-dwarka' },
  { name: 'Dwarka Sector 9', distance: '5 min to Metro', link: '/neet-coaching-dwarka' },
...
const testimonials = [
  {
    ...
    college: 'MAMC Delhi',
    mode: 'Online',
    quote: 'I chose 100% online classes because of convenience. The live classes with Dr. Shekhar Sir are so interactive. From 520 to 672, I cracked MAMC Delhi through online coaching!',
  },
  {
    name: 'Karan Mehta',
    location: 'Dwarka Sector 6',
    ...
    college: 'UCMS Delhi',
    mode: 'Hybrid',
    quote: 'Hybrid mode was perfect for me - online classes on weekdays and visited Rohini on weekends. The metro from Sector 9 is very convenient. Improved 150+ marks!',
  },
]

const handleWhatsAppClick = (location: string) => {
  trackAndOpenWhatsApp({
    source: `neet-coaching-dwarka-sector-6-${location.toLowerCase().replace(/\s+/g, '-')}`,
    ...
    campaign: 'dwarka-sector-6',
  })
}

export default function NEETCoachingDwarkaSector6Page() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-white/20 px-4 py-2 rounded-full mb-6">
                ...
                <span className="font-medium">NEET Coaching for Dwarka Sector 6 Students</span>
              </div>

              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Best NEET Coaching in Dwarka Sector 6 - Biology Classes
              </h1>

              <p className="text-xl text-blue-100 mb-4 max-w-3xl mx-auto">
                Join Cerebrum Biology Academy for expert NEET biology coaching. Dwarka Sector 6 students
                can attend via <strong>Online Classes</strong> or visit Rohini center (28 min via Dwarka Sector 9 Metro).
              </p>
              ...
              <div className="inline-flex items-center bg-green-500/20 backdrop-blur-sm px-4 py-2 rounded-full mb-8">
                ...
                <span className="text-green-200 font-medium">Online Classes Available - Most Popular Choice!</span>
              </div>

              <div className="flex flex-wrap justify-center gap-4">
                <button
                  onClick={() => handleWhatsAppClick('Dwarka Sector 6')}
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap items-center justify-center gap-6 text-center">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700"><strong>28 min</strong> from Rohini Center via Metro</span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700"><strong>5-8 min walk</strong> to Dwarka Sector 9 Metro</span>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              >
                <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                  ...
                  Metro Route from Dwarka Sector 6
                </h2>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="flex items-center gap-3 bg-white rounded-lg p-4 shadow-sm">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900">Dwarka Sector 9 Metro</p>
                        <p className="text-sm text-gray-600">5-8 min walk from Sector 6</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 bg-white rounded-lg p-4 shadow-sm">
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-sm">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-center gap-2">
                        ...
                        <span>Total Time: ~28 minutes</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <CheckCircle className="w-5 h-5 text-green-600" />
                      ...
                      <li className="flex items-center gap-2">
                        <CheckCircle className="w-5 h-5 text-green-600" />
                        <span>AC Metro - Comfortable travel</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <CheckCircle className="w-5 h-5 text-green-600" />
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
                Free NEET Tools for Dwarka Sector 6 Students
              </h2>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl font-bold text-gray-800 mb-4">
                Success Stories from Dwarka Sector 6
              </h2>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl font-bold text-gray-800 mb-4">
                FAQs - NEET Coaching Dwarka Sector 6
              </h2>
            </motion.div>
        ...
        <section className="py-16 bg-gradient-to-br from-blue-600 to-indigo-700 text-white">
          <div className="container mx-auto px-4 text-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-bold mb-4">Start Your NEET Journey from Dwarka Sector 6!</h2>
              <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
                Join successful NEET aspirants from Dwarka Sector 6. Book your free demo class today - Online or Offline!
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <button
                  onClick={() => handleWhatsAppClick('Dwarka Sector 6')}
