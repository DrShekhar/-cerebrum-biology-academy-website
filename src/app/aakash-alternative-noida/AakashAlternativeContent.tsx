...
const testimonials = [
  {
    ...
    quote:
      'Left Aakash Noida after Class 11. The personal mentorship at Cerebrum helped me focus on my weak areas. Biology score improved by 50 marks.',
  },
  {
    name: 'Arjun P.',
    score: '625/720',
...
export default function AakashAlternativeNoidaContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      ...
      message:
        'Hi! I am currently at Aakash/considering Aakash Noida and want to know about Cerebrum as an alternative for NEET Biology. Please share details.',
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Looking for an
              <span className="block text-yellow-400 mt-2">Aakash Alternative in Noida?</span>
            </h1>
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              ...
              Aakash Noida (Sector 18, Sector 62) has large batches - we offer a better alternative.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              Why Students Switch from Aakash Noida
            </h2>
