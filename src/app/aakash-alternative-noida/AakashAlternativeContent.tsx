...
const reasons = [
  ...
  },
  {
    ...
    description:
      'Generic coaching covers Biology superficially. Our AIIMS faculty dives deep into concepts that matter.',
    icon: BookOpen,
  },
  {
    title: 'Concerned About Stability?',
    description:
      "BYJU's acquisition brought uncertainty. Cerebrum is an independent, focused institute with stable leadership.",
    icon: AlertTriangle,
  },
  {
...
const testimonials = [
  {
    ...
    quote:
      'Left the 2nd-largest national NEET chain Noida after Class 11. The personal mentorship at Cerebrum helped me focus on my weak areas. Biology score improved by 50 marks.',
  },
  {
    name: 'Arjun P.',
    score: '625/720',
  ...
  },
  {
    ...
    quote:
      'After a disappointing first attempt, switched to Cerebrum Noida. The small batch and focused approach helped me crack NEET in second attempt.',
  },
]

export default function AakashAlternativeNoidaContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      ...
      message:
        'Hi! I am currently at the 2nd-largest national NEET chain/considering the 2nd-largest national NEET chain Noida and want to know about Cerebrum as an alternative for NEET Biology. Please share details.',
      campaign: 'aakash-alternative-noida',
    })
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Looking for an
              <span className="block text-yellow-400 mt-2">the 2nd-largest national NEET chain Alternative in Noida?</span>
            </h1>

            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              Overwhelmed by digital overload? Want real classroom interaction with expert faculty?
              Discover why 400+ Noida students chose Cerebrum for focused NEET Biology preparation.
              the 2nd-largest national NEET chain Noida (Sector 18, Sector 62) has large batches - we offer a better alternative.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              Why Students Switch from the 2nd-largest national NEET chain Noida
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeInUp">
              ...
              <Link href="/complement-aakash-coaching-noida">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 animate-fadeInUp">
              ...
              {testimonials.slice(1, 2).map((t) => (
                <div key={t.name} className="mb-6">
                  <p className="text-indigo-100 italic">&ldquo;{t.quote}&rdquo;</p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            >
              ...
              <p className="text-sm text-gray-600">Compare all institutes</p>
            </Link>
            <Link
              href="/neet-evening-batch-noida"
              className="bg-gray-50 p-4 rounded-xl hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">Evening Batch</h3>
              <p className="text-sm text-gray-600">After-school coaching</p>
            </Link>
            <Link
