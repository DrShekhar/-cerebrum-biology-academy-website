...
export const metadata: Metadata = {
  title: 'Aakash Alternative in Noida | Personalized NEET Biology Coaching',
  description:
  ...
  openGraph: {
    title: 'Aakash Alternative in Noida | Personalized NEET Biology Coaching',
    description:
      'Why 400+ Noida students chose Cerebrum over Aakash for NEET Biology preparation.',
...
export default function AakashAlternativeNoidaPage() {
  const comparisonSchema = {
    ...
    description:
      'Comparison of Cerebrum Biology Academy vs Aakash Institute for NEET preparation in Noida',
    mainEntity: {
