...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Three key differences: (1) Exclusive Biology focus — Biology is 50% of NEET marks (360/720), (2) Small batches of 15-20 students vs 50-100+ at Aakash and Allen, (3) AIIMS-trained faculty led by Dr. Shekhar C Singh. Our 98% success rate and 680+ medical college selections prove the difference.',
  },
  {
        ...
        <section className="py-16 bg-white">
          <div className="max-w-5xl mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12">
              Why Students Choose Cerebrum Over Aakash, the 2nd-largest national NEET chain & PW
            </h2>
