...
export default function PageContent() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              ...
              experienced medical faculty trusted by{' '}
              <strong>IT professionals and business families</strong>. Premium online classes with
              recorded lectures and regular assessments.
            </p>
      ...
      <PricingSection cityName="Salt Lake" />
      <CostComparisonSection cityName="Salt Lake" />
      ...
      <RelatedCityLinks currentCity="salt-lake-kolkata" variant="default" />
    </div>
  )
}
