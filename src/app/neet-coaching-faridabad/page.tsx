            ...
            <div>
              ...
              <div className="rounded-xl overflow-hidden shadow-lg mb-4">
                <LazyGoogleMap
                  ...
                  placeholder={{
                    lat: 28.4089,
                    lng: 77.3178,
                    address: 'Cerebrum Biology Academy, SCF-130, Huda Market, Sector 17, Faridabad',
                  }}
                />
              </div>
              <div className="space-y-2 text-gray-700">
                <div className="flex items-start">
                  ...
                  <span>
                    <strong>Physical Center:</strong> SCF-130, 2nd Floor, Above Union Bank, HUDA
      ...
      <section className="py-12 bg-white border-t border-slate-200">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-slate-600 mb-6">
            Compare fees, alternatives, test series, and foundation programmes available in
            Faridabad.
          </p>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
            ...
            <Link
              href="/parents-guide-neet-coaching-faridabad"
              className="block p-3 rounded-lg border border-slate-200 hover:border-green-400 hover:shadow text-center transition"
            >
