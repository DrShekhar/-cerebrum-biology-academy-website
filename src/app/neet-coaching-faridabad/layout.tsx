...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Best NEET Coaching in Faridabad | Greater Faridabad, NIT',
    description:
  ...
  twitter: {
    ...
    title: 'Best NEET Coaching in Faridabad',
    description:
  ...
  return (
    <>
      ...
      <NearMeKeywordInjector
        ...
        centerAddress="SCF 124, Second Floor, Above Union Bank of India, Huda Market, Sector 17, Faridabad - 121002"
