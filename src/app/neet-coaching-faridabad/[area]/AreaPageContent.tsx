...
import { getFaridabadEnrichment } from '@/data/faridabad-enriched'
...
export default function AreaPageContent({ area, areaSlug }: AreaPageContentProps) {
  ...
  return (
    <div className="min-h-screen">
      ...
      {(() => {
        const enrichment = getFaridabadEnrichment(areaSlug)
        if (!enrichment) return null
        return (
          <section className="py-10 bg-white border-b border-gray-100">
            <div className="max-w-4xl mx-auto px-4">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
                NEET Biology coaching in {area.name}, Faridabad
              </h2>
      ...
      <AreaTestimonials citySlug="faridabad" areaName={area.name} cityName="Faridabad" />
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="animate-fadeInUp">
            ...
            <p className="text-xl mb-4 opacity-90">
              Join hundreds of successful students from {area.name}. Visit our Faridabad Sector 17
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <Link href={`/demo-booking?center=faridabad&area=${areaSlug}`}>
                <Button
                  variant="secondary"
                  size="xl"
                  onClick={handleDemoBooking}
