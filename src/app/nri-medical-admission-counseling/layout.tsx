...
export const metadata: Metadata = {
  ...
  keywords:
    'NRI medical admission counseling, NRI quota medical colleges, Indian medical admission',
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/nri-medical-admission-counseling',
  },
