      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl mb-6 opacity-90">
            Comprehensive counseling for NRI families navigating Indian medical admissions.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            <p className="text-lg text-gray-700 mb-4">
              <strong>Target Audience:</strong> NRI families navigating Indian medical admissions
            </p>
            <p className="text-lg text-gray-700 mb-4">
              <strong>Program Duration:</strong> Comprehensive guidance process
            </p>
            <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Key Features</h3>
            <ul className="space-y-3">
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">•</span>
                <span className="text-gray-700">Complete 15% NRI quota explanation</span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">•</span>
                <span className="text-gray-700">Medical college selection guidance</span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">•</span>
                <span className="text-gray-700">Fee structure comparison across colleges</span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">•</span>
                <span className="text-gray-700">Document preparation and verification</span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">•</span>
                <span className="text-gray-700">Counseling process step-by-step guidance</span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">•</span>
                <span className="text-gray-700">Post-admission support</span>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
              ...
              <ul className="space-y-2 mb-6">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">15% NRI quota explained</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
                  <span className="text-gray-700">College list PDF</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
                  <span className="text-gray-700">Fee structure comparison</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
              ...
              <ul className="space-y-2 mb-6">
                ...
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
                  <span className="text-gray-700">1-on-1 counseling sessions</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
                  <span className="text-gray-700">College recommendation</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
                  <span className="text-gray-700">Document preparation guide</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
              ...
              <ul className="space-y-2 mb-6">
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
                  <span className="text-gray-700">All Full Counseling features</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
                  <span className="text-gray-700">Unlimited counseling sessions</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
                  <span className="text-gray-700">Admission process assistance</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
                  <span className="text-gray-700">Bank loan guidance</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">✓</span>
                  <span className="text-gray-700">Post-admission support</span>
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">
                What is the 15% NRI quota in Indian medical colleges?
              </h3>
              <p className="text-gray-700 leading-relaxed">
                The 15% NRI quota is a separate merit-based category for Non-Resident Indians.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">
                What score is needed for NRI quota medical admission?
              </h3>
              <p className="text-gray-700 leading-relaxed">
                Generally, scores range from 550-650+ depending on the college's reputation.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">
                Which medical colleges have the best NRI quota programs?
              </h3>
              <p className="text-gray-700 leading-relaxed">
                Top colleges like AIIMS Delhi, JIPMER Puducherry, CMC Vellore have good NRI
                programs.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">
                What documents are required for NRI medical admission?
              </h3>
              <p className="text-gray-700 leading-relaxed">
                Key documents include passport, NEET scorecard, school certificates, and domicile
                proof.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">
                How is the NRI counseling process different from general admission?
              </h3>
              <p className="text-gray-700 leading-relaxed">
                NRI counseling follows a separate process with registration, merit list, and
                document verification.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">
                Can you help with admission to private medical colleges as well?
              </h3>
              <p className="text-gray-700 leading-relaxed">
                Yes! We guide families on private college options with fee structure comparison.
              </p>
            </div>
          </div>
          <div className="mt-8 text-center">
