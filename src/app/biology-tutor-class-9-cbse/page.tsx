...
export default function BiologyTutorClass9CBSEPage() {
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-emerald-900 via-teal-800 to-green-900 text-white py-20 overflow-hidden">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-emerald-600 via-teal-600 to-green-600 text-white">
