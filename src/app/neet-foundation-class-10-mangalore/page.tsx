...
export const metadata: Metadata = {
  ...
  description:
    'NEET Foundation Class 10 in Mangalore — AIIMS-trained faculty, online live. Serving Balmatta, Hampankatta, Bejai, Kadri, Surathkal, Manipal Road. From Rs 35,000/year.',
  keywords: [
    'neet foundation class 10 mangalore',
    'class 10 biology coaching mangalore',
    'class 10 neet mangalore',
  ],
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: 'NEET Foundation Class 10 Mangalore',
    url: PAGE_URL,
    locale: 'en_IN',
    type: 'website',
  },
...
const wa =
  ...
  encodeURIComponent('Hi — Class 10 student in Mangalore, want NEET Foundation details.')
const faqs = [
  {
    question: 'Is Class 10 too early for NEET in Mangalore?',
  ...
  return (
    <main className="min-h-screen bg-white">
      <CerebrumPersonSchema
        knowsAbout={['NEET Foundation Mangalore', 'Class 10 Biology Karnataka']}
      />
      <LocalBusinessSchema />
      ...
      <section className="bg-gradient-to-br from-emerald-900 to-green-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            NEET Foundation Class 10 in Mangalore
          </h1>
      ...
      <FoundationCityEnrichment slug="mangalore" classLevel={10} />
