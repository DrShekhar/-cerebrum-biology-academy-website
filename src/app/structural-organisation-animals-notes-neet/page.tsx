...
import { chapterNotesSEOPages } from '@/data/seo-landing'

const content = chapterNotesSEOPages['structural-organisation-animals-notes-neet']
...
export default function StructuralOrganisationAnimalsNotesNeetPage() {
  return (
    <>
      <script
