...
export const metadata: Metadata = {
  title: 'Best NEET Coaching in Dehradun | Rajpur Road, Clock Tower | Cerebrum Academy',
  description:
    'Top NEET biology coaching in Dehradun for Uttarakhand students. 94.2% success rate, AIIMS faculty. Rajpur Road, Clock Tower, Prem Nagar, Clement Town. 1,800+ students. Book free demo!',
  keywords:
  ...
  openGraph: {
    title: 'Best NEET Coaching in Dehradun | Uttarakhand | Cerebrum Academy',
    description:
      'Top NEET biology coaching in Dehradun with 94.2% success rate. AIIMS faculty, small batches. Join 1,800+ Uttarakhand students.',
  ...
  twitter: {
    ...
    title: 'Best NEET Coaching in Dehradun | Cerebrum Biology Academy',
    description:
      'Top NEET biology coaching in Dehradun. 94.2% success rate. Rajpur Road, Clock Tower, Prem Nagar.',
  },
  alternates: {
