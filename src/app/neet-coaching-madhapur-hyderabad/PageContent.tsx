...
import { Trophy, Users, MessageCircle, Play, Headphones, MapPin, Building, Zap } from 'lucide-react'
...
export default function PageContent() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <PricingSection cityName="Madhapur" />
      <CostComparisonSection cityName="Madhapur" />
