...
export const metadata: Metadata = {
  ...
  description:
    'Top NEET biology coaching in Kanpur for UP students. GSVM-focused preparation! 94.2% success rate, AIIMS faculty. Civil Lines, Swaroop Nagar, Kakadeo, Kidwai Nagar. 3,200+ students. Book free demo!',
  keywords:
  ...
  openGraph: {
    ...
    description:
      'Top NEET biology coaching in Kanpur with 94.2% success rate. GSVM-focused preparation! AIIMS faculty, small batches. Join 3,200+ UP students from Civil Lines, Swaroop Nagar.',
  ...
  twitter: {
    ...
    description:
      'Top NEET biology coaching in Kanpur. GSVM-focused! 94.2% success rate. Civil Lines, Swaroop Nagar, Kakadeo, Kidwai Nagar.',
  },
  alternates: {
