            ...
            <div className="container mx-auto px-4 relative z-10">
              <div className="text-center max-w-5xl mx-auto animate-fadeInUp">
                ...
                <p className="text-lg md:text-xl text-slate-300 mb-8 max-w-3xl mx-auto leading-relaxed">
                  Top-rated online NEET coaching for students from Mandi, Sundernagar, Nerchowk &
                  entire Sadar district.
                  <span className="text-indigo-400 font-semibold">
                    {' '}
                    SLBSGMC is just 18 km away
                  </span>{' '}
                  - prepare from home with AIIMS faculty.
                </p>
            ...
            <div className="container mx-auto px-4">
              <div className="animate-fadeInUp">
                ...
                <p className="text-slate-400 text-center mb-12 max-w-2xl mx-auto">
                  From Mandi town to Jogindernagar, we help students across the entire district
                  prepare for NEET from home
                </p>
          ...
          <section className="py-16 bg-slate-900/50">
            <div className="container mx-auto px-4">
              <div className="animate-fadeInUp">
                ...
                <p className="text-slate-400 text-center mb-12 max-w-2xl mx-auto">
                  SLBSGMC Nerchowk is in your own district! Multiple HP medical colleges within
                  reach
                </p>
                        ...
                        >
                          <td className="py-4 px-4">
                            <div className="flex items-center gap-2">
                              ...
                              <span
                                className={
                                  college.highlight ? 'text-indigo-300 font-semibold' : 'text-white'
                                }
                              >
                                {college.name}
                              </span>
            ...
            <div className="container mx-auto px-4">
              <div className="text-center max-w-3xl mx-auto animate-fadeInUp">
                ...
                <p className="text-xl text-slate-300 mb-8">
                  SLBSGMC Nerchowk is just 18 km away. Join Cerebrum Academy and make your medical
                  dream a reality - from home!
                </p>
