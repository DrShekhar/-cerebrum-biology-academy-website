...
const PAGE_URL = 'https://cerebrumbiologyacademy.com/neet-foundation-class-10-surat'

export const metadata: Metadata = {
  title: 'NEET Foundation Class 10 in Surat | AIIMS-Trained Online Live',
  description:
    'NEET Foundation Class 10 in Surat — AIIMS-trained faculty, online live. CBSE / ICSE / State Board + NEET parallel. Serving Adajan, Vesu, Piplod, Athwa. From Rs 35,000/year.',
  keywords: [
    'neet foundation class 10 surat',
    'class 10 biology coaching surat',
    'class 10 neet preparation surat',
    'best class 10 foundation surat',
    'online class 10 neet surat',
  ],
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: 'NEET Foundation Class 10 Surat | Cerebrum',
    description: 'NEET Foundation Class 10 in Surat. AIIMS-trained faculty, online live.',
...
const faqs = [
  { question: 'Is Class 10 too early to start NEET preparation in Surat?', answer: 'No — Class 10 is the ideal time to build the Biology foundation that NEET demands. NCERT Class 10 Biology (cell biology, tissues, diversity in organisms) directly maps to NEET syllabus. Starting early gives Surat students a 2-3 year advantage over those who start in Class 11.' },
  ...
  { question: 'What does NEET Foundation Class 10 cost in Surat?', answer: 'Foundation Pursuit: Rs 35,000/year. Foundation Ascent: Rs 50,000/year (bi-weekly 1:1). Foundation Pinnacle: Rs 70,000/year (weekly 1:1). Same pricing pan-India for online live.' },
...
export default function Page() {
  return (
    <main className="min-h-screen bg-white">
      <CerebrumPersonSchema knowsAbout={['NEET Foundation Surat', 'Class 10 Biology Surat', 'Early NEET preparation Gujarat']} />
      ...
      <section className="bg-gradient-to-br from-emerald-900 to-green-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          <nav className="text-sm text-emerald-300 mb-6" aria-label="Breadcrumb">
            ...
            <span className="text-white">Class 10 Surat</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">NEET Foundation Class 10 in Surat</h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 prose prose-slate max-w-none">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">Why start NEET Foundation in Class 10 from Surat?</h2>
          <p>Class 10 is the ideal entry point for NEET preparation. NCERT Class 10 Biology covers foundational concepts (cell biology, tissues, diversity in living organisms, motion, force) that directly map to high-weightage NEET chapters. Students in Surat who start in Class 10 have a 2-3 year head start over those who begin in Class 11 — this compounds into 50-100 marks of advantage on exam day.</p>
          ...
          <ul>
            ...
            <li><Link href="/neet-foundation-class-9-surat" className="text-blue-600 hover:underline">Foundation Class 9 Surat</Link></li>
