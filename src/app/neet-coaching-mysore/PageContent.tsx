    ...
    <div className="w-full">
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8 inline-block">
            <span className="text-sm font-semibold text-blue-600 bg-blue-50 px-4 py-2 rounded-full">Heritage City - Best NEET Coaching in Mysore</span>
          </div>
          
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-gray-900 mb-6 leading-tight">
            Best NEET Coaching<br className="hidden sm:block" /> in <span className="text-blue-600">Mysore</span>
          </h1>
          
          <p className="text-xl sm:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto font-light">
            Top NEET Biology coaching in heritage city Mysore. AIIMS faculty. 98% success rate. 695/720 top score.
          </p>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl sm:text-5xl font-bold text-center text-gray-900 mb-16">Why Choose Cerebrum for NEET in Mysore?</h2>
          ...
          <div ref={features.ref} className={`grid grid-cols-1 md:grid-cols-2 gap-8 transition-opacity duration-1000 ${features.isVisible ? 'opacity-100' : 'opacity-0'}`}>
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Excellence in Heritage Environment</h3>
                  <p className="text-gray-600">Mysore's cultural and academic traditions merged with modern NEET preparation techniques.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Personalized Mentoring</h3>
                  <p className="text-gray-600">Small batch sizes. One-on-one guidance from AIIMS faculty. Focus on individual strengths.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Flexible Study Options</h3>
                  <p className="text-gray-600">Online + offline classes. Recorded sessions. Live doubt solving twice weekly.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Comprehensive Material</h3>
                  <p className="text-gray-600">Complete NCERT notes, advanced reference, chapter tests, 12 full-length mocks.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl sm:text-5xl font-bold text-center text-gray-900 mb-4">NEET Coaching in Mysore Areas</h2>
          <p className="text-center text-gray-600 mb-16 max-w-2xl mx-auto">Coaching centers across major localities in Mysore, Karnataka</p>
          ...
          <div ref={areas.ref} className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 transition-opacity duration-1000 ${areas.isVisible ? 'opacity-100' : 'opacity-0'}`}>
            {['Gokulam', 'Vijayanagar', 'Kuvempunagar', 'Rajendra Nagar', 'Vanivilas Road', 'University Road', 'Chamarajpet', 'Laskar Mohalla'].map((area) => (
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div ref={faq.ref} className={`space-y-6 transition-opacity duration-1000 ${faq.isVisible ? 'opacity-100' : 'opacity-0'}`}>
            {[
              {
                q: 'Is Mysore suitable for NEET preparation?',
                a: 'Excellent choice! Peaceful environment, good colleges, AIIMS faculty presence, and quality infrastructure perfect for focused NEET study.'
              },
              {
                q: 'Do you have center in Gokulam/Vijayanagar?',
                a: 'Yes! Centers in premium localities with online support across all Mysore areas.'
              },
              {
                q: 'What is the batch strength?',
                a: 'Small batches (15-20 students) for maximum personalized attention and interactive learning.'
              },
              {
                q: 'How are mock tests scheduled?',
                a: 'Monthly full-length NEET mocks with rank prediction, detailed analysis, and one-on-one feedback.'
              },
              {
                q: 'Can I combine with board exams preparation?',
                a: 'Yes! Our curriculum integrates PUC board exams with NEET preparation for holistic academic excellence.'
              }
            ].map((item, idx) => (
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">Start NEET Prep in Mysore Today!</h2>
          <p className="text-xl text-blue-100 mb-8">Join peaceful city with excellent study environment. AIIMS mentorship available.</p>
