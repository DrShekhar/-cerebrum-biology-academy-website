...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'NEET Coaching for DPS RK Puram Students | AIIMS Faculty | Cerebrum',
    description: 'NEET biology coaching for DPS RK Puram Class 11–12 students. AIIMS-trained Dr. Shekhar C Singh, small batches of 15–20, NCERT line-by-line, weekly 1:1 doubt slots. 680+ medical college selections.',
  },
}
...
export default function FeederSchoolPage() {
  return (
    <>
      <DelhiAreaSchema pageSlug="neet-coaching-dps-rk-puram-delhi" />
      <BestVerticalLanding config={buildNEETFeederSchoolConfig('dps-rk-puram-delhi')} />
    </>
  )
}
