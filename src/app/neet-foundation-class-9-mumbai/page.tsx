...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Allen Scholastics Mumbai operates ~12 centres (Andheri, Thane, Borivali, Powai, Mulund, BKC, Goregaon, Vashi, Dadar, Chembur, Kandivali, Vile Parle) with combined PCB Foundation batches of 150-300 students. Aakash Mumbai operates ~6 centres. Cerebrum is biology-only with 15-20 student online live batches and AIIMS-trained biology faculty (Dr. Shekhar C Singh) leading curriculum directly. Many Mumbai families combine Cerebrum biology (₹55K-75K Ascent) with Allen or Aakash for PC, total ₹1L-1.4L — comparable to single-shop pricing with better biology pedagogy.',
  },
  {
