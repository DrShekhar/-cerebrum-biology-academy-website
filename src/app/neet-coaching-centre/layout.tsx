...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'NEET Coaching Centre Near Me | Best NEET Coaching Centres in Delhi NCR',
    description:
      'Find the best NEET coaching centre near you. 5 centers in Delhi NCR: Rohini, Gurugram, South Extension, Faridabad, Green Park. 98% success rate!',
    type: 'website',
    locale: 'en_IN',
  ...
  twitter: {
    ...
    description:
      'Find the best NEET coaching centre near you. 5 centers + online classes. 98% success rate!',
  },
  alternates: {
