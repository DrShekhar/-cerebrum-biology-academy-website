...
export const metadata: Metadata = {
  ...
  description: 'NSEB (National Standard Examination in Biology) coaching for Kochi students. NSEB → INBO → OCSC → IBO pathway. AIIMS-trained faculty, online live.',
  keywords: ['NSEB coaching kochi', 'biology olympiad kochi', 'NSEB preparation kochi', 'INBO coaching kochi', 'IBO preparation kochi'],
  alternates: { canonical: PAGE_URL },
  openGraph: { title: 'NSEB Coaching Kochi | Cerebrum', url: PAGE_URL, locale: 'en_IN', type: 'website' },

  twitter: { card: 'summary_large_image' as const },
}

const wa = 'https://wa.me/918826444334?text=' + encodeURIComponent("Hi — my child in Kochi is interested in NSEB/Biology Olympiad coaching. Please share programme details.")
...
const faqs = [
  ...
  { question: 'How does NSEB coaching work from Kochi?', answer: 'Live online sessions via Zoom, IST evenings and weekends. Campbell Biology + Alberts Molecular Biology depth. Weekly past-paper drilling. Kochi students join pan-India NSEB cohort.' },
...
export default function Page() {
  return (
    <main className="min-h-screen bg-white">
      <CerebrumPersonSchema knowsAbout={['NSEB Kochi', 'Biology Olympiad Kerala', 'INBO preparation', 'IBO coaching']} />
      ...
      <section className="bg-gradient-to-br from-amber-900 to-yellow-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">NSEB Coaching for Kochi Students</h1>
          <p className="text-xl text-amber-200 mb-6 max-w-3xl">Biology Olympiad coaching for Kochi (Kerala). NSEB → INBO → OCSC → IBO pathway. AIIMS-trained faculty, Campbell + Alberts depth. Online live. Pursuit Rs 2,500/yr to Pinnacle Rs 6,000/yr.</p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 prose prose-slate max-w-none">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">NSEB → INBO → IBO pathway from Kochi</h2>
          ...
          <ul>
            ...
            <li><Link href="/neet-coaching-kochi" className="text-blue-600 hover:underline">NEET Coaching Kochi</Link></li>
          </ul>
        </div>
      </section>
