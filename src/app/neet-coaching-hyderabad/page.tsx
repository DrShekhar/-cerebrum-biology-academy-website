...
const features = [
  ...
  alternates: { canonical: 'https://cerebrumbiologyacademy.com/neet-coaching-hyderabad' },
    description:
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Yes! Our 98% success rate and 67+ AIIMS selections prove that online coaching is highly effective. Hyderabad students particularly benefit as they save commute time for self-study. Our interactive live classes, doubt sessions, and AI-powered practice tests ensure comprehensive preparation.',
  },
  {
  ...
  return (
    <div className="min-h-screen">
      <CitySchema
        ...
        citySlug="hyderabad"
        state="Telangana"
        localities={hyderabadLocalities.map((l) => l.name)}
        faqs={faqs}
        studentCount="2200"
      ...
      <StickyMobileCTABar waUrl="https://wa.me/918826444334?text=Hi!%20I%20want%20a%20FREE%20demo%20for%20NEET%20Biology%20coaching%20in%20Hyderabad.%20Please%20share%20timings." />
    </div>
  )
}
