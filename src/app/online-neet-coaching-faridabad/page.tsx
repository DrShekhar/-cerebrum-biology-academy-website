...
export const metadata: Metadata = {
  title: 'Online NEET Coaching for Faridabad Students | Live & Hybrid Mode | Cerebrum',
  description:
  ...
  keywords: [
    ...
    'neet online classes greater faridabad',
    'live neet classes faridabad',
    'hybrid neet coaching faridabad',
    'neet classes from home faridabad',
    'online biology coaching faridabad',
  ],
  openGraph: {
    title: 'Online NEET Coaching for Faridabad | Live Interactive Sessions',
    description:
      'Study NEET Biology from your Faridabad home. Live classes, instant doubts, recorded lectures. Hybrid mode available.',
    url: 'https://cerebrumbiologyacademy.com/online-neet-coaching-faridabad',
  },
  alternates: {
...
const travelTimes = [
  { area: 'Badarpur (Delhi Border)', time: '0 min', mode: 'Study from home!' },
  { area: 'Greater Faridabad (Sec 75-89)', time: '0 min', mode: 'Study from home!' },
  { area: 'Palwal', time: '0 min', mode: 'Study from home!' },
  { area: 'Ballabgarh', time: '0 min', mode: 'Study from home!' },
  { area: 'Sector 62 (New Area)', time: '0 min', mode: 'Study from home!' },
  { area: 'To Sector 17 Center (Weekend)', time: 'Varies by area', mode: 'For offline sessions' },
]
...
const hybridBenefits = [
  ...
  'Weekly mock tests at Sector 17 center',
...
const faqs = [
  {
    question: 'How do online NEET classes work for Faridabad students?',
    answer:
      'Our online classes are live, interactive sessions conducted via Zoom/Google Meet. You attend from your Faridabad home, ask questions in real-time, and get instant feedback. Classes are also recorded for later revision. Most Faridabad students prefer this mode as it saves 1-2 hours of daily travel.',
  },
  {
    question: 'What is hybrid mode for Faridabad students?',
    answer:
      'Hybrid mode combines online weekday classes with weekend offline sessions at our Sector 17, Faridabad center. You attend 5-6 online classes per week from home, and visit Sector 17 on Saturdays/Sundays for mock tests, doubt sessions, and face-to-face interaction.',
  },
  {
    question: 'Which mode is better - online or hybrid?',
    answer:
      'For most Faridabad students, online mode works best due to minimal travel time. However, if you need classroom environment motivation or struggle with self-discipline, hybrid mode provides weekly accountability. We recommend starting with online and upgrading to hybrid if needed.',
  },
  {
    question: 'Is online coaching as effective as offline?',
    answer:
      'Yes! Our online students consistently score 650+ in NEET. The key advantages: more study time (no travel), recorded lectures for revision, instant doubt resolution via WhatsApp, and comfortable home environment. 800+ Faridabad area students are currently enrolled in our online program.',
  },
  {
...
export default function OnlineNEETCoachingFaridabadPage() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Online NEET Coaching for Faridabad Students
            </h1>
            <p className="text-xl text-indigo-100 mb-6">
              Study from your Faridabad home. Live interactive Biology classes with AIIMS faculty.
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            <div className="text-center p-4 bg-indigo-50 rounded-xl">
              ...
              <p className="text-sm text-gray-600">Faridabad Students Online</p>
            </div>
            <div className="text-center p-4 bg-indigo-50 rounded-xl">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Why Faridabad Students Love Online Classes
          </h2>
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            No travel. No traffic. Study from your home. See how much time you save:
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <div className="bg-indigo-50 rounded-2xl p-6 border-2 border-indigo-200">
              ...
              <p className="text-gray-600 mb-4">
                Study entirely from your Faridabad home. Zero travel.
              </p>
            ...
            <div className="bg-yellow-400 rounded-2xl p-6 relative transform md:scale-105">
              ...
              <p className="text-indigo-900 mb-4">
                Online + Weekend offline at Sector 17, Faridabad.
              </p>
              <ul className="space-y-2 text-sm mb-6">
            ...
            <div className="bg-gray-50 rounded-2xl p-6 border-2 border-gray-200">
              ...
              <p className="text-gray-600 mb-4">Daily classes at Sector 17, Faridabad center.</p>
              <ul className="space-y-2 text-sm mb-6">
                <li className="flex items-center gap-2">
              ...
              <p className="text-sm text-gray-500 mt-2">Near Bata Chowk Metro Station</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-indigo-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-indigo-200 mb-8">
            Join 800+ Faridabad students already learning online
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="tel:+918826444334"
            ...
            >
              View All Faridabad Programs <ArrowRight className="w-5 h-5" />
            </Link>
          </div>
        </div>
      </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Course',
            name: 'Online NEET Biology Coaching for Faridabad Students',
            description:
              'Online NEET Biology classes for Faridabad students. Live interactive sessions + hybrid mode with weekend offline at Sector 17, Faridabad.',
            provider: {
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 3,
                name: 'Online Classes',
                item: 'https://cerebrumbiologyacademy.com/online-neet-coaching-faridabad',
              },
            ],
          }),
        }}
