...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'better than fiitjee gurugram',
    'fiitjee vs cerebrum gurugram',
    'neet coaching cheaper than fiitjee',
    'fiitjee gurugram fees comparison',
    'switch from fiitjee gurugram',
  ...
  twitter: {
    ...
    title: 'Best FIITJEE Alternative in Gurugram 2026 | Better Results, Lower Fees',
    description:
      'Looking for FIITJEE alternative in Gurugram (Gurgaon)? Cerebrum Biology Academy: Same quality, 60% lower fees. AIIMS faculty, 98% success rate. Compare before you join. Call 8...',
  },
}
