        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg p-6 sm:p-8 md:p-12">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
            ...
            <p className="text-blue-800">
              We are committed to providing high-quality educational services and want our students
              to be satisfied with their learning experience. Please read this policy carefully to
          ...
          <div className="space-y-6 sm:space-y-8">
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <h3 className="text-lg font-semibold text-gray-900">
                  1.2 Course Cancellation by Academy
                </h3>
                <p>
                  If we cancel a course due to insufficient enrollment or other reasons, students
                  will receive a 100% refund or can transfer to another suitable batch.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p>
                  In case of serious illness or medical emergency (with proper medical
                  documentation), we may offer course freeze or transfer to next batch instead of
                  refund.
                </p>

                <h3 className="text-lg font-semibold text-gray-900">3.2 Technical Issues</h3>
                <p>
                  If you experience persistent technical issues that prevent access to course
                  content, and our technical team cannot resolve them within 15 days, you may be
                  eligible for a partial refund.
                </p>

                <h3 className="text-lg font-semibold text-gray-900">3.3 Course Quality Issues</h3>
                <p>
                  If course content significantly differs from what was advertised, or quality
                  issues are identified, we will work to resolve the issue or provide appropriate
                  compensation.
                </p>
              </div>
            </section>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">
                5. Installment Payment Refunds
              </h2>
              <div className="space-y-4 text-gray-700">
                <p>For courses paid in installments:</p>
                <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">
                6. Course Transfer Policy
              </h2>
              <div className="space-y-4 text-gray-700">
                <p>As an alternative to refunds, we offer course transfers:</p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p>
                  <strong>Transfer Fee:</strong> ₹1,000 administrative fee applies for voluntary
                  transfers.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p>We are committed to fair resolution of all refund disputes.</p>
              </div>
            </section>

            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">
                8. Important Terms and Conditions
              </h2>
              <div className="space-y-4 text-gray-700">
                <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <p>
                    <strong>WhatsApp:</strong> +91 88264 44334
                  </p>
                  <p>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
              ...
              <p className="text-yellow-700">
                We encourage you to contact our student support team if you're facing any issues
                with your course. Often, we can resolve problems and ensure you get the most value
                from your learning investment.
              </p>
            </div>
          </div>
        </div>
