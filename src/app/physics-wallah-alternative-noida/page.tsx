...
export const metadata: Metadata = {
  title: 'other online-only platforms Alternative Noida | Offline Expert Biology',
  description:
    'Need offline alternative to other online-only platforms in Noida? Cerebrum: Real classroom experience, AIIMS faculty, 98% success rate. Better than video lectures. Call 99536-43938!',
  keywords: [
  ...
  openGraph: {
    locale: 'en_IN',
    title: 'other online-only platforms Alternative Noida',
    description:
  ...
  twitter: {
    ...
    title: 'other online-only platforms Alternative Noida | Offline Expert Biology',
    description: 'Need offline alternative to other online-only platforms in Noida? Cerebrum: Real classroom experience, AIIMS faculty, 98% success rate. Better than video lectures. Call 99536-43938!',
  },
}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <span className="inline-block bg-yellow-500 text-purple-900 px-4 py-1 rounded-full text-sm font-semibold mb-4">
              other online-only platforms Alternative in Noida
            </span>
