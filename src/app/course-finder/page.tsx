        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6 text-center">
            <div className="bg-slate-800/50 rounded-xl p-6">
              <div className="text-2xl font-bold text-emerald-400 mb-2">60 Seconds</div>
            ...
            <div className="bg-slate-800/50 rounded-xl p-6">
              <div className="text-2xl font-bold text-blue-400 mb-2">Smart Algorithm</div>
              <div className="text-white font-medium mb-1">AI-Powered Matching</div>
              <div className="text-gray-400 text-sm">Based on 5000+ successful student data</div>
            </div>
            <div className="bg-slate-800/50 rounded-xl p-6">
          ...
          {/* Why Take This Quiz */}
          <div className="mt-12 bg-slate-800/30 rounded-2xl p-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                <h3 className="text-lg font-semibold text-blue-400 mb-3">Data-Driven Insights</h3>
                <ul className="space-y-2 text-gray-300">
