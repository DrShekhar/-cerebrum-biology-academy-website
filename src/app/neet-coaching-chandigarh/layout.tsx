...
export const metadata: Metadata = {
  ...
  description:
    'Best NEET biology coaching in Chandigarh. 94.2% success rate. AIIMS faculty. Sector 17, 22, 35, Panchkula, Mohali. Online live classes. Fee ₹24,000+. Book free demo!',
  keywords:
  ...
  openGraph: {
    title: 'Best NEET Coaching in Chandigarh | Biology Classes | Cerebrum Academy',
    description:
      'Best NEET biology coaching in Chandigarh with 94.2% success rate. AIIMS faculty. Sector 17, 22, Panchkula, Mohali.',
