...
const WHATSAPP_MESSAGE = encodeURIComponent('Hi! I am interested in NEET coaching in Indore. Please share details.')
...
const features = [
  { icon: Video, title: 'Live Interactive Classes', description: 'Real-time online coaching for Indore students. No commute to Vijay Nagar coaching hubs.' },
  { icon: Users, title: 'Small Batches (10-15)', description: 'Personalized attention unlike crowded Indore coaching centers.' },
  ...
  { icon: Shield, title: 'All Indore Covered', description: 'Vijay Nagar, Palasia, Rau, AB Road - all served with same quality.' },
]
...
const faqs = [
  { question: 'Why choose online NEET coaching over Indore coaching centers?', answer: 'Indore has become a coaching hub with centers in Vijay Nagar and Rau having 100+ students per batch. Our online classes limit to 10-15 students. Save commute time, get personalized attention, same 94.2% success rate.' },
  { question: 'Which areas in Indore do you serve?', answer: 'We serve all Indore areas including Vijay Nagar, Palasia, Rau, Bhawarkua, Sapna Sangeeta, Scheme 78, MR-10, AB Road, and surrounding areas. Online live classes mean you can join from anywhere.' },
  { question: 'What is the fee for NEET coaching in Indore?', answer: 'Our comprehensive NEET Biology coaching ranges from Rs 24,000 to Rs 68,000 per year depending on the program. Competitive with Indore coaching centers but with much smaller batches. EMI available.' },
  { question: 'Which medical colleges can Indore students target?', answer: 'With strong NEET scores, Indore students can target: MGM Medical College Indore, Gandhi Medical College Bhopal, AIIMS Bhopal, Index Medical College, plus other all-India institutes.' },
  { question: 'How is Indore as a coaching destination?', answer: 'Indore has emerged as a major NEET coaching hub in MP. While physical coaching centers are good, our online format offers smaller batches, flexible timings, and saves 1-2 hours daily commute time.' },
  { question: 'Do you cover MP Board syllabus?', answer: 'Yes! We cater to English medium students from both CBSE and MP Board. Our NCERT-focused approach ensures complete NEET syllabus coverage while bridging any board-specific gaps.' },
]

const premiumSchools = ['Delhi Public School Indore', 'Emerald Heights School', 'The Daly College', 'Choithram School', 'St. Pauls Higher Secondary', 'Queen Mary Convent', 'MGM School', 'Indore Public School']
...
export default function NEETCoachingIndorePage() {
  const handleWhatsAppClick = () => {
    if (typeof window !== 'undefined' && (window as any).gtag) {
      ;(window as any).gtag('event', 'whatsapp_click', { event_category: 'conversion', event_label: 'indore_neet_page' })
    }
  ...
  return (
    <div className="min-h-screen">
      <CitySchema cityName="Indore" citySlug="indore" state="Madhya Pradesh" localities={localities.map((l) => l.name)} faqs={faqs} studentCount="720" coordinates={{ lat: '22.7196', lng: '75.8577' }} />
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <motion.div className="text-center max-w-4xl mx-auto" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              <MapPin className="w-5 h-5 mr-2" />Cleanest City | Mini Mumbai
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Best <span className="text-[#4ade80]">NEET Coaching in Indore</span></h1>
            <h2 className="text-xl md:text-2xl opacity-90 mb-4">Vijay Nagar | Palasia | Rau | All Indore</h2>
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">Premium NEET Biology coaching for Indore students. 94.2% success rate, AIIMS faculty. Target MGM Indore, AIIMS Bhopal. Join 720+ Indore students!</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div className="text-center mb-16"><h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">NEET Coaching Across Indore</h2></motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div className="text-center mb-16"><h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">Why Indore Students Choose Us</h2></motion.div>
      ...
      <section className="py-16 bg-gray-50"><div className="max-w-7xl mx-auto px-4"><div className="bg-white rounded-2xl p-8 shadow-lg"><h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Students from These Indore Schools Trust Us</h3><div className="flex flex-wrap justify-center gap-4">{premiumSchools.map((school) => (<span key={school} className="bg-gray-100 text-gray-700 px-4 py-2 rounded-full font-medium">{school}</span>))}</div></div></div></section>

      <VideoTestimonialsSection />

      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div className="text-center mb-16"><h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">FAQs - NEET Coaching Indore</h2></motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#1e3a5f] via-[#2d5a87] to-[#3d7ab5] text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}>
            <h2 className="text-3xl md:text-5xl font-bold mb-6">Ready to Crack NEET from Indore?</h2>
            <p className="text-xl md:text-2xl mb-8 opacity-90">Join 720+ Indore students. Target MGM, AIIMS Bhopal. 94.2% success rate!</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Button variant="secondary" size="xl" onClick={handleWhatsAppClick} className="bg-[#25D366] text-white hover:bg-[#20BD5A] flex items-center justify-center gap-2"><MessageCircle className="w-6 h-6" /><span>WhatsApp Us Now</span></Button>
