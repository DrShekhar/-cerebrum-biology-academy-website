...
export default function NEETCoachingIndorePage() {
  const handleWhatsAppClick = async () => {
    await trackAndOpenWhatsApp({
      ...
      message: "Hi! I'm from Indore and interested in NEET coaching. Please share details.",
      campaign: 'neet-coaching-indore',
    })
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Biology%20coaching%20in%20Indore.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer">
                <Button
                  variant="secondary"
                  size="xl"
