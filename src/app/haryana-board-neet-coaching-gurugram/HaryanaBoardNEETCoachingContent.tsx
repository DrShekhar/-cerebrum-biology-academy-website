      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div
              className="bg-gray-50 rounded-2xl p-8 border-2 border-gray-200 animate-fadeInUp">
            ...
            <div
              className="bg-green-50 rounded-2xl p-8 border-2 border-green-500 relative animate-fadeInUp">
