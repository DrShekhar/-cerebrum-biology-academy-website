...
const cityName = 'Rajkot'
const citySlug = 'rajkot'
...
export const metadata: Metadata = {
  ...
  keywords: ['neet dropper batch rajkot', 'neet repeater course rajkot', 'best dropper batch neet rajkot'],
  alternates: { canonical: `https://cerebrumbiologyacademy.com/neet-dropper-batch-rajkot` },
  openGraph: { title: `NEET Dropper Batch 2026-27 ${cityName}`, url: `https://cerebrumbiologyacademy.com/neet-dropper-batch-rajkot`, locale: 'en_IN', type: 'website' },
}
