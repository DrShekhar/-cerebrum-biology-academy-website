...
const PAGE_URL = 'https://cerebrumbiologyacademy.com/middle-school-biology-olympiad-usa'
...
const realCompetitions = [
  {
    ...
    detail:
      'The #1 legitimate middle-school pathway. Real biology events: Anatomy & Physiology, Heredity, Ecology, Microbe Mission, Disease Detectives, and Botany. We coach these directly.',
    can: true,
  },
  {
...
const whyUs = [
  ...
  },
  {
    ...
    description:
      'Live classes scheduled in ET / CT / MT / PT evening slots, so they fit around school. Recordings and notes are provided.',
  },
  {
    icon: Sprout,
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'The program comes in three batch lengths, all priced in US dollars: a 6-month batch for $1,500, a 1-year (academic year) batch for $2,500, and a 2-year batch for $4,500. Every batch covers live online classes in small batches, recordings, and notes. There are no hidden India-specific fees — this is a US program priced in US dollars.',
  },
  {
    question: 'What grade levels is this for?',
    answer:
      'US students in grades 6-8 (ages roughly 11-14). It suits families who want an early, rigorous-but-age-appropriate biology foundation before high school — whether the goal is Science Olympiad, future USABO/AP Biology readiness, or simply getting genuinely good at biology early.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Live online sessions with a real instructor and a small group of students, scheduled in US evening timezones (ET/CT/MT/PT). Sessions are interactive — diagrams, worked reasoning, data-reading practice, and competition-style questions pitched at the right level. Recordings and notes are shared so nothing is lost if a class is missed.',
  },
  {
  ...
  {
    question: 'Is Brain Bee an option for middle schoolers?',
    answer:
      'Effectively no. The International Brain Bee has an age-13 floor AND requires enrollment in an accredited US high school, so it is a high-school competition in practice. The sensible plan is to prepare in grade 8 so a student can compete as a grade-9 freshman. We keep families accurately informed rather than implying eligibility that does not exist.',
  },
]
...
const personSchema = {
  ...
  description:
    'AIIMS New Delhi alumnus and founder of Cerebrum Biology Academy. Designs the age-appropriate middle-school biology foundation curriculum and the honest early-prep pathway toward high-school biology olympiads.',
  alumniOf: {
...
const courseSchema = {
  '@context': 'https://schema.org',
  '@type': 'Course',
  name: 'Middle School Biology Foundation (USA) — Grades 6-8',
  description:
    'Online biology foundation and enrichment program for US middle schoolers (grades 6-8, ages 11-14). Age-appropriate conceptual biology plus honest early preparation for the biology olympiad pathway (Science Olympiad Division B, National Biology Bowl) and future high-school USABO/AP Biology readiness. Live small-batch classes in US timezones, taught by AIIMS-trained specialists.',
  url: PAGE_URL,
  inLanguage: 'en-US',
  ...
  audience: {
    ...
    audienceType: 'US middle school students in grades 6-8 (ages 11-14)',
  },
  offers: [
    {
      '@type': 'Offer',
...
export default function MiddleSchoolBiologyOlympiadPage() {
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'ms-biology-foundation-usa',
      campaign: 'middle-school-biology-olympiad-usa',
      message:
        'Hi! I want details about the Middle School Biology Foundation program (grades 6-8). Please share the schedule, timezones, and how to enroll.',
    })
  }
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              ...
              USA · Grades 6-8 · Online
            </div>

            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Middle School <span className="text-green-400">Biology Foundation</span>
            </h1>

            <h2 className="text-xl md:text-2xl opacity-90 mb-4">
              Honest early-prep for the biology olympiad pathway — built for ages 11-14
            </h2>

            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              A rigorous-but-age-appropriate online biology program for US students in grades 6-8.
              We build a genuine foundation and guide your family to the competitions a middle
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Who this is for</h2>
          <p className="text-lg text-gray-700 mb-6 max-w-3xl">
            This program is built for US families who want their child to get a real head start in
            biology — the &quot;start early, do it right&quot; approach — without pushing college
            material onto a kid who is not ready for it. It is a strong fit if your child:
          </p>
          <div className="grid md:grid-cols-2 gap-4">
            {[
              'Is in grades 6-8 (roughly ages 11-14) at a US school.',
              ...
              'Needs a schedule that respects a busy US middle-school workload.',
            ].map((item) => (
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Competitions a middle schooler can actually enter
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              These are real recorded live biology classes taught by Dr. Shekhar. Watch a few
              minutes to see the teaching style and depth before you decide — the same live,
              interactive approach your child gets, taught at an age-appropriate level.
            </p>
          </div>
          <div className="grid gap-6 md:grid-cols-2 md:gap-8">
            {[
              ...
              <div key={v.id} className="rounded-xl bg-white p-4 shadow-lg">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-center text-sm text-gray-500">
            Sample recorded classes from our YouTube channel. Note: USABO is a high-school (grades
            9-12) competition — these clips are shown so you can judge our teaching style and depth.
            Middle-school students learn the same way, at a level built for ages 11-14.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-[#3d4d3d] text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 opacity-90">
            Tell us your child&apos;s grade and timezone, and we&apos;ll share the schedule.
          </p>
          <button
            onClick={handleWhatsApp}
            className="inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-400 text-black font-bold py-4 px-8 rounded-xl shadow-xl transition-all duration-300"
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              {
                href: '/blog/middle-school-to-premed-biology-roadmap',
                label: 'Middle School → Pre-Med Roadmap',
              },
