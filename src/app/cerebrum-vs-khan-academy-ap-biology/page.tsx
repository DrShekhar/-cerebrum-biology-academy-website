...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/cerebrum-vs-khan-academy-ap-biology',
  },
...
const config: CompetitorComparisonConfig = {
  ...
  table: [
    {
      criterion: 'Cost',
      cerebrum: '$2,500–$5,760 (12–48 hr packages)',
      competitor: 'Free',
      cerebrumWins: false,
    },
    {
    ...
    {
      criterion: 'FRQ Rubric Coaching',
      cerebrum: 'Explicit rubric drilling (main score lever)',
      competitor: 'Minimal FRQ-specific content',
      cerebrumWins: true,
    },
    {
      criterion: 'Content Depth',
      cerebrum: 'Campbell Biology end-to-end, college-level',
      competitor: 'AP-level review (condensed)',
      cerebrumWins: true,
    },
    {
      criterion: 'USABO Bridge',
      cerebrum: 'Integrated for semifinal candidates',
    ...
    {
      criterion: 'Personalisation',
      cerebrum: 'Diagnostic-driven study plan',
      competitor: 'Self-directed, no personalisation',
      cerebrumWins: true,
    },
    {
      criterion: 'Accessibility',
      cerebrum: 'Online, scheduled sessions',
      competitor: 'Anytime, anywhere, any pace',
      cerebrumWins: false,
    },
  ],
  whyChooseCerebrum: [
    {
      ...
      description:
        'The AP Biology exam is 50% FRQ. Khan Academy covers content but barely touches FRQ technique. Cerebrum drills the exact rubric patterns that earn full marks — this is the single biggest score lever for 4-to-5 jumps.',
    },
    {
    ...
    },
    {
      title: 'USABO Bridge',
      description:
        'For students targeting both AP-5 and USABO Semifinal, Cerebrum integrates olympiad-level content extensions. Khan Academy has no olympiad pathway.',
    },
    {
      title: 'Diagnostic-Driven Personalisation',
      description:
        'We identify your weak units and allocate session time accordingly. Khan Academy gives the same content to everyone — you decide what to watch, which often means avoiding weak topics.',
    },
  ],
  ...
  testimonials: [
    {
      name: 'Junior, Stuyvesant NYC',
      score: 'AP Biology: 5',
      college: 'Targeting Columbia, Cornell pre-med',
      quote:
        "Watched all Khan Academy videos but was stuck at 4 on practice exams. Cerebrum's FRQ drilling was what got me to 5 — Khan doesn't teach you how to write for the rubric.",
    },
    {
      name: 'Sophomore, TJHSST Virginia',
      score: 'AP Biology: 5 + USABO Semifinal',
      college: 'Targeting MIT, Stanford',
      quote:
        'Khan Academy was my baseline content review. Cerebrum layered the FRQ technique and USABO bridge on top. The combination worked — AP-5 and USABO Semifinal in the same year.',
    },
  ],
  faqs: [
    {
      question: 'Is Khan Academy enough for AP Biology score 5?',
      answer:
        'For students with strong self-discipline and natural biology aptitude (scoring 4+ on diagnostics), Khan Academy content plus official College Board practice can be sufficient. For students scoring 3–4 who need the jump to 5, live coaching on FRQ technique is usually the missing piece — and Khan Academy does not provide that.',
    },
    {
      question: 'Can I use Khan Academy alongside Cerebrum?',
      answer:
        'Absolutely — this is the recommended approach. Khan Academy for free content review and practice questions; Cerebrum for live FRQ coaching, 1:1 feedback, and USABO bridge. No overlap since Khan is self-paced content and Cerebrum is live instruction.',
    },
    {
      question: 'Why is Cerebrum worth paying for when Khan is free?',
      answer:
        'Khan Academy covers content but cannot assess your FRQ writing, identify your specific weak patterns, or provide real-time faculty feedback. The 3-to-5 jump almost always requires FRQ technique — which is a coached skill, not a watched-video skill. Our $2,500 senior-faculty package for 12 hours of live coaching delivers more score lift per hour than 100 hours of video review.',
    },
    {
      question: 'Does Khan Academy offer USABO prep?',
      answer:
        'No. Khan Academy covers the AP Biology curriculum only. Cerebrum bridges AP Biology to USABO for students targeting the Semifinal — extending content into evolutionary biology, population genetics, and experimental design at the olympiad level.',
    },
  ],
  whatsappMessage:
