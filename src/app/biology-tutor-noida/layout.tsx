...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'Biology Tutor in Noida',
    description: 'Expert NEET Biology coaching in Noida.',
  },
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/biology-tutor-noida',
  },
}

export default function BiologyTutorNoidaLayout({ children }: { children: React.ReactNode }) {
  return children
}
