...
const whyChooseUs = [
  ...
  },
  {
    ...
    description: 'Proven track record with many students from Noida sectors.',
  },
  {
    icon: Star,
    title: 'Top Results',
    description: 'Many Noida students scored 650+ in NEET with our guidance.',
  },
]
...
export default function BiologyTutorNoidaPage() {
