  ...
  const faqs = [
    {
      ...
      answer:
        'Cerebrum Biology Academy offers a 98% success rate with personalized coaching tailored to the Ghana educational context. Our expert faculty, led by Dr. Shekhar C Singh, uses evidence-based teaching methods proven to maximize student performance.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Yes, we provide curriculum customization for Ghana boards while maintaining NEET alignment. Our biology-focused approach ensures mastery of all concepts required for top scores.',
    },
    {
    ...
    <main>
      <section className="hero-section">
        <div className="container">
          ...
          <p className="lead">
            Accra, Ghana's capital, hosts a growing Indian business diaspora and is establishing
            itself as a leading tech hub in West Africa. Cerebrum Biology Academy brings expert NEET
            coaching to Accra with a proven 98% success rate and personalized learning paths.
          </p>
      ...
      <section className="highlights-section">
        <div className="container">
          ...
          <p>
            Indian business diaspora, growing tech hub, affordable coaching, West African gateway
          </p>
          <ul>
