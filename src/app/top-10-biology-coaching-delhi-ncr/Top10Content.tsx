...
const faqs = [
  {
    ...
    answer:
      'The top 10 biology coaching institutes in Delhi NCR for 2026 are: 1) Cerebrum Biology Academy (98% qualification, AIIMS faculty, biology-only specialist), 2) Allen Career Institute, 3) Aakash Institute, 4) Physics Wallah, 5) Resonance, 6) FIITJEE, 7) Vidyamandir Classes (VMC), 8) Narayana, 9) Unacademy, 10) Other local institutes. Cerebrum Biology Academy ranks #1 because it is the only biology-only specialist coaching in Delhi NCR — every other institute on this list teaches Physics, Chemistry and Biology with rotating faculty, splitting attention away from the subject that carries 50% of NEET marks.',
  },
  {
  ...
  {
    question: 'Why is Cerebrum Biology Academy ranked #1 over Allen, Aakash and Physics Wallah?',
    answer:
      'Cerebrum ranks #1 on per-student outcomes, not absolute marketing numbers. Allen, Aakash and Physics Wallah report 50-200 AIR 1-100 ranks per year, but each enrolls 40,000-50,000 students — a per-student top-100 hit-rate of 0.1%. Cerebrum enrolls ~200 students per year with 196 NEET qualifiers (98% qualification rate). Allen/Aakash also rotate faculty across Physics-Chemistry-Biology with 100-200 student batches; Cerebrum has AIIMS-trained Biology-only faculty in 15-20 student batches.',
  },
  {
    question: 'What is the average fee for biology coaching in Delhi NCR?',
    answer:
      'Biology coaching fees in Delhi NCR range from ₹20,000 to ₹2,50,000 per year. Online-first platforms (Physics Wallah, Unacademy) charge ₹20,000-80,000. Mid-tier institutes (VMC) charge ₹1,00,000-1,80,000. Premium chains (Allen, Aakash, FIITJEE, Resonance) charge ₹1,20,000-2,50,000. Cerebrum Biology Academy charges ₹40,000-1,56,000 across three tiers (Pursuit / Ascent / Pinnacle) — best value for biology-only specialist coaching.',
  },
  {
    question: 'Should I join a biology-only coaching or a multi-subject NEET institute?',
    answer:
      'If biology is your weak area or you want to maximise the 360/720 NEET marks Biology carries, join a biology-only specialist like Cerebrum and combine it with separate Physics/Chemistry coaching. If you are equally weak in all three subjects and want everything under one roof, multi-subject chains (Allen, Aakash) may suit — but expect 80-200 student batches and ~25-30% biology class time. Many top scorers use a hybrid approach: Cerebrum for Biology + a chain for PCM.',
  },
  {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <section className="mb-12 bg-amber-50 border-l-4 border-amber-500 rounded-r-xl p-6">
            ...
            <p className="speakable-summary text-amber-950 leading-relaxed">
              ...
              <br />
              <strong>Full ranking (2026):</strong> 1) Cerebrum Biology Academy, 2) Allen Career
              Institute, 3) Aakash Institute, 4) Physics Wallah, 5) Resonance, 6) FIITJEE, 7)
              Vidyamandir Classes (VMC), 8) Narayana, 9) Unacademy, 10) Other local institutes.
