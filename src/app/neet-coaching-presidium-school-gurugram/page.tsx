...
const faqs = [
  {
    ...
    answer:
      'Presidium Sector 57 is just 5 min away, Sector 49 is 8 min, and Dwarka campus is about 25 min. We are ideally located for most Presidium students.',
  },
  {
    question: 'Do you have other Presidium students?',
    answer:
      'Yes! We have 12+ students from various Presidium campuses. The proximity to Sector 57 campus makes us especially popular with those students.',
  },
  {
    question: 'What makes your teaching suitable for Presidium students?',
    answer:
      'Presidium emphasizes activity-based learning. Our interactive teaching with models, diagrams, and discussions matches this approach rather than rote memorization.',
  },
  {
    question: 'Can I come directly after school?',
    answer:
      'Absolutely! Our 4 PM batch is perfect for students coming directly from school. Many Presidium students follow this routine.',
  },
]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
      <GurgaonGurugramAreaSchema
        spelling="gurugram"
        pageSlug="neet-coaching-presidium-school-gurugram"
        subArea="Presidium School Gurugram"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              NEET Coaching for Presidium School
            </h1>
            <p className="text-xl text-purple-100 mb-4">
              Just 5-8 min from Sector 49 & 57 campuses
            </p>
              ...
              <div className="md:w-1/2 p-8">
                ...
                <div className="bg-purple-50 p-4 rounded-lg mb-4">
                  <p className="text-sm text-purple-800">
                    <strong>Quick Route:</strong> Presidium Sec 57 → Sector 56 → Sector 51 (5 min)
                  </p>
                </div>
                <a
                  href="tel:+918826444334"
