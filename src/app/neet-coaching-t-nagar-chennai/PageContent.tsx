...
export default function PageContent() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              Premium NEET coaching for T Nagar, Pondy Bazaar, commercial families & nearby areas.
              Learn from Dr. Shekhar C Singh, AIIMS Alumnus - trusted by business families.
            </p>
      ...
      <PricingSection cityName="T Nagar" />
      <CostComparisonSection cityName="T Nagar" />
