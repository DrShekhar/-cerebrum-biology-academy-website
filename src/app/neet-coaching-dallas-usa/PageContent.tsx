...
export default function NEETCoachingPageContent() {
  const faqData = [
    ...
    },
    {
      ...
      answer: 'Our Dallas center maintains a consistent 98% success rate with students regularly scoring in top percentiles.'
    },
    {
      question: 'Do you offer online NEET coaching for Dallas students?',
    ...
    {
      question: 'What are the class timings at Dallas center?',
  ...
  return (
    <>
      <LocalitySchema
        name="Cerebrum Biology Academy - Dallas Center"
        address="Dallas, USA"
        city="Dallas"
        country="USA"
        latitude={32.7767}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div key="0" className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              <h3 className="font-bold text-lg mb-2 text-gray-900">Growing Indian tech community in DFW</h3>
            ...
            <div key="1" className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              <h3 className="font-bold text-lg mb-2 text-gray-900">Strong Plano and Frisco Indian populations</h3>
              <p className="text-gray-700">Expert coaching aligned with local education standards.</p>
            </div>
            <div key="2" className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              <h3 className="font-bold text-lg mb-2 text-gray-900">Texas Instruments industry connections</h3>
              <p className="text-gray-700">Expert coaching aligned with local education standards.</p>
            </div>
            <div key="3" className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              <h3 className="font-bold text-lg mb-2 text-gray-900">CBSE school partnerships in Richardson</h3>
              <p className="text-gray-700">Expert coaching aligned with local education standards.</p>
            </div>
            <div key="4" className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-600">
              <h3 className="font-bold text-lg mb-2 text-gray-900">Affordable living with premium coaching</h3>
              <p className="text-gray-700">Expert coaching aligned with local education standards.</p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div key="0" className="bg-blue-50 p-4 rounded-lg border border-blue-200">Plano Senior High School</div>
