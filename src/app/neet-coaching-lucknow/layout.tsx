...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Top NEET biology coaching in Lucknow with 94.2% success rate. KGMU-focused preparation! AIIMS faculty, small batches. Join 4,500+ UP students from Gomti Nagar, Hazratganj.',
  ...
  twitter: {
    ...
    description:
      'Top NEET biology coaching in Lucknow. KGMU-focused! 94.2% success rate. Gomti Nagar, Hazratganj, Aliganj, Indira Nagar.',
  },
  alternates: {
