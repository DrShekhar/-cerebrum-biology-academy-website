...
export const metadata: Metadata = {
  title: 'NEET Evening Batch Noida 2026 | After-School Classes 5-8 PM | Cerebrum',
  description:
    'Join NEET evening batch in Noida - 5 PM to 8 PM classes after school. Perfect for Class 11-12 students. Sector 62. Call 99536-43938!',
  keywords: [
    'neet evening batch noida',
    'neet evening classes noida',
    'after school neet coaching',
    'evening neet coaching noida',
    'neet classes 5 pm to 8 pm',
    '5 to 8 neet coaching noida',
    'evening biology classes noida',
    'after school biology coaching',
    'school students neet evening batch',
    'dps noida students neet coaching',
  ],
  openGraph: {
    title: 'NEET Evening Batch Noida 2026 | Cerebrum Biology Academy',
...
const compatibleSchools = [
  { name: 'DPS Noida (Sector 30)', endTime: '2:30 PM' },
  { name: 'Ryan International Noida', endTime: '2:00 PM' },
  { name: 'GD Goenka Noida (Sector 22)', endTime: '2:30 PM' },
  { name: 'Amity International (Sector 44)', endTime: '3:00 PM' },
  { name: 'Lotus Valley International (Sector 100)', endTime: '2:30 PM' },
  { name: 'Apeejay School (Sector 16A)', endTime: '3:00 PM' },
  { name: 'Vidya Niketan (Sector 50)', endTime: '3:30 PM' },
  { name: 'Khaitan School (Noida)', endTime: '2:30 PM' },
]
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Ideal for students from: DPS Noida, Ryan International Noida, GD Goenka Noida, Amity International (Sector 44), Lotus Valley International, Apeejay School, Vidya Niketan (Sector 50), Khaitan School. All these schools end by 3-4 PM.',
  },
  {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Course',
            name: 'NEET Evening Batch Noida',
            description: 'Evening NEET biology coaching after school hours in Noida',
            provider: {
              '@type': 'Organization',
