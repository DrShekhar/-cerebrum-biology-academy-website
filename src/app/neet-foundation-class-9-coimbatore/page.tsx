...
const wa =
  ...
  encodeURIComponent(
    'Hi — I want to enroll my child (Class 9) in NEET Foundation from Coimbatore. Please share batch details and demo timings.'
  )
...
const faqs = [
  {
    ...
    answer:
      'No — Class 9 is the ideal time to build the Biology foundation that NEET demands. NCERT Class 9 Biology (cell biology, tissues, diversity in organisms) directly maps to NEET syllabus. Starting early gives Coimbatore students a 2-3 year advantage over those who start in Class 11.',
  },
  {
  ...
  {
    question: 'What does NEET Foundation Class 9 cost in Coimbatore?',
    answer:
...
export default function Page() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-emerald-900 to-green-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            NEET Foundation Class 9 in Coimbatore
          </h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 prose prose-slate max-w-none">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">
            Why start NEET Foundation in Class 9 from Coimbatore?
          </h2>
          <p>
            ...
            start in Class 9 have a 2-3 year head start over those who begin in Class 11 — this
          ...
          <ul>
            ...
            <li>
              <Link
                href="/neet-foundation-class-10-coimbatore"
                className="text-blue-600 hover:underline"
              >
                Foundation Class 10 Coimbatore
              </Link>
            </li>
            <li>
      ...
      <FoundationCityEnrichment slug="coimbatore" classLevel={9} showIntro={false} />
