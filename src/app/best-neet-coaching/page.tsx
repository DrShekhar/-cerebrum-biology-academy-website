...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Yes! We offer both offline classes at our 5 centers (Rohini, Gurugram, South Extension, Faridabad, Green Park) and live online classes. Online students get the same quality teaching with recorded lectures for revision.',
  },
  {
          ...
          <div className="relative max-w-7xl mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto animate-fadeInUp">
              ...
              <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
                Looking for the best coaching for NEET? Join India&apos;s top-rated NEET coaching
                with proven results, expert faculty, and personalized attention. Start your medical
                journey today!
              </p>
          ...
          <div className="max-w-4xl mx-auto px-4 text-center">
            <div className="animate-fadeInUp">
              ...
              <p className="text-xl md:text-2xl mb-8 opacity-90">
                98% success rate, AIIMS trained faculty, 15,000+ selections. Your medical dream
                starts here!
              </p>
              ...
              <div className="flex flex-col md:flex-row gap-4 justify-center mb-12">
                ...
                <Link
                  href="https://wa.me/918826444334?text=Hi!%20I'm%20interested%20in%20neet%20coaching.%20Please%20share%20fee%20structure%20and%20enrolment%20details."
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <Button
