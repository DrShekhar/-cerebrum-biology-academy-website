...
export const metadata: Metadata = {
  ...
  description:
    'Expert NEET coaching in Singapore City, Singapore. 98% success rate, expert faculty, comprehensive study materials. Join 5000+ successful students.',
  keywords:
    'NEET coaching Singapore City, NEET exam center Singapore City, best NEET classes Singapore City, NEET preparation Singapore',
  openGraph: {
    title: 'NEET Coaching in Singapore City, Singapore | 98% Success Rate',
    description:
      'Premium NEET coaching center in Singapore City. Dr. Shekhar C Singh & expert faculty. Start your medical journey today.',
