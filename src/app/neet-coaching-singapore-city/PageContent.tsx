...
export function PageContent({ city, country }: PageContentProps) {
  ...
  const faqs: FAQ[] = [
    {
      id: 'faq-1',
      question: 'How does IB curriculum map to NEET syllabus?',
      answer:
        'Our bridge program directly correlates IB HL Biology/Chemistry with NEET topics. We use IB concepts to teach NEET in 6 months.',
    },
    {
      id: 'faq-2',
      question: "What's the advantage of NEET coaching in Singapore?",
      answer:
        'Premium education system, focus on conceptual clarity, small batches, and 100% English medium with international faculty.',
    },
    {
      id: 'faq-3',
      question: 'Are small batch sizes better for NEET preparation?',
      answer:
        'Yes. Our max 8-student batches ensure personalized doubt sessions and 1-on-1 mentoring for each student.',
    },
    {
      id: 'faq-4',
      question: "What's the success rate for IB school students?",
      answer:
        '98% qualified for NEET. Average score: 620 marks. Multiple selections in top AIIMS/JIPMER.',
    },
    {
      id: 'faq-5',
      question: 'Do you provide recorded sessions?',
      answer:
        'Yes, all classes are recorded. Access 24/7 for revision and catching up on missed sessions.',
    },
    {
      id: 'faq-6',
      question: 'How do we handle the Indian vs IGCSE syllabus difference?',
      answer:
        'First month covers NCERT + IGCSE reconciliation. We teach Indian board content in international teaching approach.',
    },
  ]
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-700 text-lg">
                  Singapore's authorized NEET exam center under NEO (NEET Education Organisation)
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-lg whitespace-pre-wrap">
                  8:00 AM - 12:00 PM SGT (Morning) | 6:00 PM - 10:00 PM SGT (Evening)
                </p>
              </div>
            </div>
          </div>
