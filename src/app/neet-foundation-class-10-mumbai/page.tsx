...
const faqs = [
  ...
  {
    question: 'How does Cerebrum Mumbai compare to Aakash Scholastics / Allen Foundation Mumbai?',
    answer:
      'Aakash Scholastics Mumbai operates ~12 centres with 150-300 student PCB Foundation batches. Allen Mumbai operates ~6 centres. Cerebrum is biology-only with 15-20 student online live batches and AIIMS-trained biology faculty (Dr. Shekhar C Singh) directly leading curriculum. For Class 10 specifically, Cerebrum runs separate board-format weekly mocks (Aakash deprioritises boards). Many Mumbai families pair Cerebrum biology (₹55K-75K Ascent) with Aakash / Allen for PC for total ₹1L-1.4L — comparable to single-shop pricing with materially better biology and board parallel pedagogy.',
  },
  {
