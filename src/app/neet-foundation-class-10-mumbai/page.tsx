...
const faqs = [
  ...
  {
    question: 'How does Cerebrum Mumbai compare to the 2nd-largest national NEET chain Scholastics / the largest national NEET chain Foundation Mumbai?',
    answer:
      'the 2nd-largest national NEET chain Scholastics Mumbai operates ~12 centres with 150-300 student PCB Foundation batches. the largest national NEET chain Mumbai operates ~6 centres. Cerebrum is biology-only with 15-20 student online live batches and AIIMS-trained biology faculty (Dr. Shekhar C Singh) directly leading curriculum. For Class 10 specifically, Cerebrum runs separate board-format weekly mocks (the 2nd-largest national NEET chain deprioritises boards). Many Mumbai families pair Cerebrum biology (₹55K-75K Ascent) with the 2nd-largest national NEET chain / the largest national NEET chain for PC for total ₹1L-1.4L — comparable to single-shop pricing with materially better biology and board parallel pedagogy.',
  },
  {
    question: 'What does Class 10 NEET Foundation cost in Mumbai?',
    answer:
      'Cerebrum Class 10 Foundation pricing for Mumbai families (pan-India online): Pursuit ₹35K-55K, Ascent ₹55K-75K (with weekly 1:1 doubt slots + biweekly board + NEET mocks), Pinnacle ₹75K-95K (direct Dr. Shekhar micro-batch 10-12). Ad-hoc 1:1 hourly ₹2,000-3,500. Three Mumbai-specific cost comparisons: (1) the 2nd-largest national NEET chain Scholastics Mumbai Class 10 combined PCB Foundation runs ~₹95K-1.2L/year at 250-student batches across Andheri/Borivali/Thane/Powai centres; (2) the largest national NEET chain Mumbai Class 10 Foundation ~₹1.1L-1.3L at 6 centres; (3) The hidden Mumbai cost: 8-12 hours weekly commute saved by Cerebrum online vs offline centres in Borivali or Thane. Cerebrum biology-only Ascent ₹65K + other online-only platforms PCB ₹15K = ₹80K total with better biology pedagogy than the 2nd-largest national NEET chain standalone — common Mumbai pattern for CBSE families targeting AIIMS / state quota via SSC parallel.',
  },
]
