...
const faqs = [
  {
    ...
    answer:
      'Our center at M2K Corporate Park, Sector 51 is approximately 12-14 km from Pathways World School Aravali campus. Via Gurgaon-Faridabad Road, it takes 15-18 minutes.',
  },
  {
    question: 'Do you support IB Biology students for NEET?',
    answer:
      'Yes! We have specific modules to bridge IB HL/SL Biology to NEET syllabus. Key gaps like Ecology depth, Human Physiology details, and NCERT-specific topics are covered.',
  },
  {
    question: 'Can Pathways students balance school and NEET prep?',
    answer:
      'Absolutely. Our evening (4-7 PM) and weekend batches are designed for international school students. We also offer online sessions for flexibility.',
  },
  {
    question: 'What about IGCSE students?',
    answer:
      'IGCSE students need more extensive bridging as the syllabus differs significantly. We recommend starting NEET prep from Grade 10 or early Grade 11 for IGCSE students.',
  },
]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white">
      ...
      <GurgaonGurugramAreaSchema
        spelling="gurugram"
        pageSlug="neet-coaching-pathways-world-school-gurugram"
        subArea="Pathways World School Gurugram"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              NEET Coaching for Pathways World School
            </h1>
            <p className="text-xl text-emerald-100 mb-4">
              Specialized IB/IGCSE to NEET transition program at M2K Sector 51
            </p>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      Detailed NCERT Ecology concepts
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
                      Human Physiology depth (IB HL gap)
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
                      Plant Biology detailed coverage
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
                      Genetics & Evolution specifics
                    </li>
                  </ul>
                </div>
                <div>
              ...
              <div className="md:w-1/2 p-8">
                ...
                <div className="bg-emerald-50 p-4 rounded-lg mb-4">
                  <p className="text-sm text-emerald-800">
                    <strong>Route:</strong> Pathways → Gurgaon-Faridabad Rd → Sector 56 → Sector 51
                  </p>
                </div>
                <a
                  href="tel:+918826444334"
      ...
      <section className="py-16 bg-emerald-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-emerald-100 mb-8">
            Bridge the IB-NEET gap with expert guidance.
          </p>
          <a
            href="tel:+918826444334"
