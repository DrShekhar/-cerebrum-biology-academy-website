...
export const metadata: Metadata = {
  ...
  description:
    'Premium NEET biology coaching in Gachibowli IT Hub, Hyderabad. 98% success rate, AIIMS faculty. Financial District, Kondapur, Nanakramguda, Manikonda. IT families. Fee ₹24,000+. Book free demo!',
  keywords:
