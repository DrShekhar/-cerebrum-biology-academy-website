...
export const metadata: Metadata = {
  ...
  keywords: ['neet dropper batch varanasi', 'neet repeater course varanasi', 'best dropper batch neet varanasi'],
  alternates: { canonical: `https://cerebrumbiologyacademy.com/neet-dropper-batch-varanasi` },
  openGraph: { title: `NEET Dropper Batch 2026-27 ${cityName}`, url: `https://cerebrumbiologyacademy.com/neet-dropper-batch-varanasi`, locale: 'en_IN', type: 'website' },
