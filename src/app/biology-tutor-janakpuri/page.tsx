  ...
  return (
    <div className="min-h-screen">
      <CerebrumPersonSchema
        knowsAbout={[
          'NEET Janakpuri',
          'NEET Biology Janakpuri',
          'Medical entrance coaching Janakpuri',
        ]}
      />
      <script
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              'Best Biology Tutor for Janakpuri students - NEET & Board exam preparation',
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Biology Tutor in <span className="text-yellow-400">Janakpuri</span>
            </h1>
            ...
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              Expert Biology coaching for Janakpuri, Tilak Nagar, Vikaspuri, and nearby areas. Learn
              from <strong>Dr. Shekhar C Singh, AIIMS Alumnus</strong>.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Biology%20coaching%20in%20Janakpuri.%20Please%20share%20available%20timings."
                target="_blank"
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 via-green-700 to-blue-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-6">Janakpuri Students, Join Us!</h2>
