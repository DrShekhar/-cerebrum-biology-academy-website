    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-gray-50">
      ...
      <section className="relative py-16 bg-gradient-to-r from-blue-700 via-blue-600 to-blue-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-2">Based on 10-Year Previous Year Question Analysis by AIIMS Faculty</p>
          <p className="text-lg text-blue-200 max-w-2xl mx-auto mb-8">
            Know exactly which chapters to focus on. Our AIIMS faculty has analyzed 10 years of NEET papers to identify high-yield chapters that consistently carry 60%+ weightage.
          </p>
          <Link
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 mb-8 text-lg">Join 10,000+ NEET aspirants who have already downloaded this resource.</p>
          <Link
            href="https://wa.me/918826444334?text=Hi%20I%20want%20the%20free%20chapter%20weightage"
            className="inline-flex bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-lg font-bold text-lg items-center gap-2 transition-colors shadow-lg"
          >
          ...
          <p className="text-sm text-blue-200 mt-4">Instant delivery on WhatsApp | 100% Free | No spam</p>
        </div>
      </section>
      ...
      <section className="py-12 max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-4">
          <Link href="/pricing" className="text-blue-600 hover:text-blue-800 font-semibold">View Courses &rarr;</Link>
          <Link href="/nri-students" className="text-blue-600 hover:text-blue-800 font-semibold">NRI Students &rarr;</Link>
          <Link href="/free-resources" className="text-blue-600 hover:text-blue-800 font-semibold">More Free Resources &rarr;</Link>
        </div>
      </section>
    </div>
  )
