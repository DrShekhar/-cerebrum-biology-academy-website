    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
        ...
        <div className="max-w-4xl mx-auto px-4 -mt-8">
          <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 animate-fadeInUp">
            {/* Google Review CTA */}
        ...
        <div className="bg-gradient-to-r from-purple-50 to-blue-50 py-12">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-gray-600 max-w-xl mx-auto">
              Your feedback helps us improve and helps future NEET aspirants make informed
              decisions. We truly appreciate you taking the time to share your experience.
            </p>
          </div>
        </div>
