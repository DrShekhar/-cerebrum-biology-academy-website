...
const WHATSAPP_MESSAGE = encodeURIComponent('Hi! I am interested in NEET coaching in Viman Nagar Pune. Please share details.')
...
const features = [
  { icon: Video, title: 'Live Interactive Classes', description: 'Premium online coaching - no airport road traffic. World-class teaching from your Viman Nagar home.' },
  { icon: Users, title: 'Elite Small Batches (10-15)', description: 'Exclusive batches for Viman Nagar students with personalized attention.' },
  ...
  { icon: Clock, title: 'Flexible Timings', description: 'Morning, afternoon, evening batches to complement international school schedules.' },
  { icon: Shield, title: 'Zero Commute Stress', description: 'No traffic to coaching hubs in FC Road. Learn from your premium residence.' },
]
...
const faqs = [
  { question: 'Why do Viman Nagar students choose online NEET coaching?', answer: 'Viman Nagar has excellent international schools like Symbiosis, Vikhe Patil, and DAIS with demanding schedules. Our online classes offer flexibility that physical coaching in FC Road cannot. Save 2-3 hours daily on Pune traffic. Our 94.2% success rate proves online is equally effective.' },
  { question: 'Which areas in Viman Nagar do you serve?', answer: 'We serve all Viman Nagar localities including Viman Nagar Main, Kalyani Nagar, Kharadi, Wadgaon Sheri, Yerawada, Dhanori, Lohegaon, Vishrantwadi, and all surrounding IT corridor areas. Students from anywhere in East Pune can join our online live classes.' },
  { question: 'What is the fee for premium NEET coaching in Viman Nagar?', answer: 'Our complete NEET Biology course ranges from Rs 24,000 to Rs 68,000 per year depending on the program chosen. This is competitive with Pune coaching centers while offering superior flexibility and smaller batches. EMI options available.' },
  { question: 'How does this compare to coaching centers in FC Road or Deccan?', answer: 'Unlike physical coaching centers where batches have 50-100 students, we limit batches to 10-15 students. This means every doubt gets addressed, every student gets personal attention. Plus, you save hours on Pune traffic daily.' },
  { question: 'What medical colleges can Viman Nagar students target?', answer: 'With proper NEET preparation, Viman Nagar students can target top colleges like BJ Medical College, Armed Forces Medical College (AFMC), Symbiosis Medical College, DY Patil Medical College, and all-India institutes like AIIMS and JIPMER.' },
  { question: 'Do you understand international school patterns?', answer: 'Yes! We have specialized batches for international school students (IB, IGCSE, Cambridge). Our faculty understands how to bridge international curriculum with NEET Biology requirements. Many of our Viman Nagar students are from Symbiosis, Mercedes-Benz International, and DAIS Pune.' },
]

const premiumSchools = ['Symbiosis International School', 'Vikhe Patil Memorial School', 'DAIS Pune', 'Mercedes-Benz International', 'Indus International School', 'The Orchid School', 'Delhi Public School Pune', 'Bishops School Kalyani Nagar', 'Euro School Airoli', 'Vibgyor High School']
...
const whyVimanNagar = [
  { icon: Sparkles, title: 'Premium Quality, Zero Commute', description: 'Get world-class NEET coaching without leaving Viman Nagar. No traffic to FC Road coaching hubs.' },
...
export default function NeetCoachingVimanNagarPage() {
  const handleWhatsAppClick = () => {
    if (typeof window !== 'undefined' && (window as any).gtag) {
      ;(window as any).gtag('event', 'whatsapp_click', { event_category: 'conversion', event_label: 'vimannagar_neet_page' })
    }
  ...
  return (
    <div className="min-h-screen">
      <CitySchema cityName="Viman Nagar" citySlug="viman-nagar-pune" state="Maharashtra" localities={localities.map((l) => l.name)} faqs={faqs} studentCount="890" coordinates={{ lat: '18.5679', lng: '73.9143' }} />
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <motion.div className="text-center max-w-4xl mx-auto" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              <MapPin className="w-5 h-5 mr-2" />Pune IT Corridor | Premium NEET Coaching
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Best <span className="text-[#4ade80]">NEET Coaching in Viman Nagar</span>, Pune</h1>
            <h2 className="text-xl md:text-2xl opacity-90 mb-4">Kalyani Nagar | Kharadi | Wadgaon Sheri | Yerawada | Dhanori</h2>
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">Premium NEET Biology coaching for Viman Nagar&apos;s international schools. 94.2% success rate, AIIMS faculty, zero traffic commute. Join 890+ students from Symbiosis, Vikhe Patil, DAIS!</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div className="text-center mb-16"><h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">NEET Coaching Across Viman Nagar & East Pune</h2></motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div className="text-center mb-16"><h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">Why Viman Nagar IT Families Choose Cerebrum</h2></motion.div>
          ...
          <div className="bg-gray-50 rounded-2xl p-8"><h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Students from These Viman Nagar Schools Trust Us</h3><div className="flex flex-wrap justify-center gap-4">{premiumSchools.map((school) => (<span key={school} className="bg-white text-gray-700 px-4 py-2 rounded-full font-medium shadow-sm">{school}</span>))}</div></div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div className="text-center mb-16"><h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">FAQs - NEET Coaching Viman Nagar</h2></motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#1e3a5f] via-[#2d5a87] to-[#3d7ab5] text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}>
            <h2 className="text-3xl md:text-5xl font-bold mb-6">Join Viman Nagar&apos;s Elite NEET Aspirants</h2>
