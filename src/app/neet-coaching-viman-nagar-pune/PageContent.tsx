...
export default function PageContent() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              Premium NEET coaching for Viman Nagar and Airport Road area residents. Learn from{' '}
              <strong>Dr. Shekhar C Singh, AIIMS Alumnus</strong> - trusted by Viman Nagar's elite
              families.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <a
                href="https://wa.me/918826444334?text=Hi%2C%20I%20am%20from%20Viman%20Nagar%20and%20interested%20in%20NEET%20coaching"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Button
      ...
      <PricingSection cityName="Viman Nagar" />
      <CostComparisonSection cityName="Viman Nagar" />
      ...
      <section className="py-12 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link
              href="/neet-coaching-kalyani-nagar-pune"
              className="bg-white px-6 py-3 rounded-lg shadow hover:shadow-md transition"
            >
