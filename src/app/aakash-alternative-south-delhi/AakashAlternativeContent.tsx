...
const comparisonData = [
  ...
  },
  {
    ...
    aakash: 'Low - Mass batches',
    winner: 'cerebrum',
  },
  {
    feature: 'Faculty',
    cerebrum: 'AIIMS Alumnus (Dr. Shekhar)',
    aakash: 'Rotating faculty',
    winner: 'cerebrum',
  },
  {
    feature: 'Subject Focus',
    cerebrum: 'Biology Specialized (360/720 marks)',
    aakash: 'All subjects',
    winner: 'cerebrum',
  },
  {
    ...
    aakash: 'App-based + counters',
    winner: 'cerebrum',
  },
  {
    feature: 'Study Material',
    cerebrum: 'Curated NCERT-focused',
    aakash: 'Comprehensive + digital',
    winner: 'tie',
  },
  {
    feature: 'Mock Tests',
    cerebrum: '50+ NEET pattern tests',
    aakash: '40+ tests (digital)',
    winner: 'tie',
  },
  {
    feature: 'Fee Structure',
    cerebrum: '₹45K - ₹1.56L/year',
    aakash: '₹1.5L - ₹2.5L/year',
    winner: 'cerebrum',
  },
  {
    feature: 'Success Rate',
    cerebrum: '98% (Biology)',
    aakash: '~80% (All subjects)',
    winner: 'cerebrum',
  },
  {
    feature: 'South Delhi Location',
    cerebrum: 'D-35 South Extension Part 2 + Gulmohar Park',
    aakash: 'South Extension Part 1 + Kalu Sarai',
    winner: 'tie',
  },
]
...
const reasons = [
  {
    ...
    description:
      'Big integrated centres run 60-80+ student halls. At Cerebrum, batches are 15-20 and every student is known by name.',
    icon: Users,
  },
  {
    title: 'Biology Needs Depth',
    description:
      'Biology alone is 360 of the 720 NEET marks. Our AIIMS-trained faculty dives deep into the concepts that matter.',
    icon: BookOpen,
  },
  {
    title: 'Across the Road',
    description:
      'Our flagship at D-35 South Extension Part 2 is directly across the road from Aakash South Extension Part 1. Comparing is easy — walk over for a trial.',
    icon: MapPin,
  },
  {
    title: 'Value for Money',
    description:
      'Get premium coaching at 30-40% lower fees with significantly better student-teacher ratio.',
    icon: Target,
  },
]
...
export default function AakashAlternativeContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'aakash-alternative-south-delhi',
      message:
        'Hi! I am currently at Aakash/considering Aakash in South Delhi and want to know about Cerebrum as an alternative for NEET Biology. Please share details.',
      campaign: 'aakash-alternative-south-delhi',
    })
  }
        ...
        <div className="max-w-7xl mx-auto">
          <ol className="flex items-center flex-wrap gap-1 text-sm">
            ...
            <li className="flex items-center">
              ...
              <Link href="/neet-coaching-south-delhi" className="text-gray-600 hover:text-teal-600">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            <div className="inline-flex items-center gap-2 bg-purple-500/20 text-purple-200 px-4 py-2 rounded-full text-sm font-medium mb-6">
              ...
              Biology-Only Specialist Since 2014
            </div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Looking for an
              <span className="block text-yellow-400 mt-2">Aakash Alternative in South Delhi?</span>
            </h1>

            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              Want a biology specialist instead of a large integrated hall? Our flagship is directly
              across the road from Aakash South Extension Part 1 — discover why South Delhi students
              choose Cerebrum for focused NEET Biology preparation.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4 mb-8">
              ...
              <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-lg text-white">
                ...
                <span>Across the Road from Aakash South Ex</span>
              </div>
            </div>

            <div className="flex flex-col md:flex-row gap-4">
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Biology%20coaching%20in%20South%20Delhi.%20Please%20share%20available%20timings."
                target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              Why Students Compare Aakash with Cerebrum
            </h2>
            <p className="text-xl text-slate-600">
              Common reasons South Delhi students look for a biology specialist
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            ...
            <p className="text-xl text-slate-600">
              An honest look at specialist coaching vs integrated batches
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeInUp">
              ...
              <p className="text-xl text-indigo-100 mb-6">
                ...
                specifically for Biology. With our flagship across the road from Aakash South
                Extension Part 1, you get the best of both worlds.
              </p>
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  Across the road — zero extra commute
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
              ...
              <Link href="/complement-aakash-coaching-south-delhi">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-4">
                  Across the Road from Aakash South Extension
                </h2>
                <p className="text-slate-600 mb-6">
                  Our flagship centre is at <strong>D-35, South Extension Part 2</strong> — near
                  AIIMS and steps from South Extension Metro, directly across the road from Aakash
                  South Extension Part 1. We also have a second South Delhi centre at{' '}
                  <strong>B-113 Gulmohar Park</strong> (Green Park). Outstation students in the Ber
                  Sarai, Katwaria Sarai, and Lajpat Nagar PG belts reach us in a short ride.
                </p>
                <div className="space-y-3 mb-6">
                  <p className="flex items-center gap-2">
                    <MapPin className="w-5 h-5 text-purple-600" />
                    {CONTACT_INFO.centers.southExtension.streetAddress}, New Delhi 110049
                  </p>
                  <p className="flex items-center gap-2">
                    <Clock className="w-5 h-5 text-purple-600" />
                    Steps from South Extension Metro, near AIIMS
                  </p>
                </div>
                <div className="flex gap-4">
                  ...
                  <a
                    href={CONTACT_INFO.centers.southExtension.mapUrl}
                    target="_blank"
                    rel="noopener"
                  >
                    <Button>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between py-2 border-b">
                    <span>Biology-Only Specialist</span>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <Link
              href="/allen-alternative-south-delhi"
            ...
            <Link
              ...
              className="bg-gray-50 p-4 rounded-xl hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">NEET Coaching South Delhi</h3>
            ...
            <Link
              ...
              className="bg-gray-50 p-4 rounded-xl hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">Biology Tutor South Delhi</h3>
              <p className="text-sm text-gray-600">Personal Biology tutoring</p>
            </Link>
            <Link
              href="/neet-coaching-south-delhi/ber-sarai"
              className="bg-gray-50 p-4 rounded-xl hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">NEET Coaching Ber Sarai</h3>
              <p className="text-sm text-gray-600">For PG & hostel students</p>
            </Link>
            <Link
              href="/neet-coaching-south-delhi/katwaria-sarai"
              className="bg-gray-50 p-4 rounded-xl hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">NEET Coaching Katwaria Sarai</h3>
              <p className="text-sm text-gray-600">For PG & hostel students</p>
            </Link>
          </div>
        </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join South Delhi students who chose a biology specialist for focused NEET preparation
          </p>
