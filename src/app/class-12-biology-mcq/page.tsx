...
const class12Topics = [
  { name: 'Reproduction', chapters: 4, questions: 400 },
  { name: 'Genetics and Evolution', chapters: 5, questions: 450 },
  { name: 'Biology and Human Welfare', chapters: 3, questions: 250 },
  { name: 'Biotechnology and Its Applications', chapters: 2, questions: 250 },
  { name: 'Ecology and Environment', chapters: 4, questions: 250 },
]

export default function Class12BiologyMCQPage() {
  const totalQuestions = class12Topics.reduce((sum, t) => sum + t.questions, 0)
  const totalChapters = class12Topics.reduce((sum, t) => sum + t.chapters, 0)

  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Quiz',
    name: 'Class 12 Biology MCQ Practice',
    description:
      'Free online MCQ practice for Class 12 Biology based on NCERT curriculum. 1,600+ questions covering all units.',
        ...
        <nav className="bg-white/90 backdrop-blur-md border-b border-stone-200/50 sticky top-0 z-40">
          <div className="max-w-4xl mx-auto px-4 py-4">
            <div className="flex items-center gap-2 text-sm text-stone-600">
              ...
              <span className="text-stone-400">/</span>
              <span className="text-sage-600 font-medium">Class 12</span>
            </div>
          </div>
        </nav>
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <header className="text-center mb-12">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-ink mb-4 tracking-tight">
              Class 12 Biology MCQ Practice
            </h1>
            <p className="text-lg text-stone-600 max-w-2xl mx-auto">
              Master Class 12 Biology with {totalQuestions.toLocaleString()}+ free MCQs aligned to
              NCERT. Covers all {totalChapters} chapters across 5 units — perfect for board exams
              and NEET.
            </p>
          </header>
          ...
          <div className="text-center mb-12">
            <Link
              href="/neet-biology-mcq?source=ncert&ncertClass=12"
            ...
            >
              Start Class 12 MCQ Practice
            </Link>
          </div>

          <section className="bg-white rounded-xl p-6 shadow-sm border border-stone-200/50 mb-8">
            <h2 className="text-xl font-bold text-ink mb-4">Class 12 NCERT Units & Topics</h2>
            <div className="space-y-4">
              {class12Topics.map((unit, index) => (
                <div
                  key={index}
          ...
          <section className="prose prose-stone max-w-none mb-10">
            ...
            <ul>
              <li>Select Class 12 as your source in the MCQ tool</li>
              <li>Focus on high-weightage units like Genetics and Reproduction</li>
              <li>Review detailed explanations for every question</li>
              <li>Track your chapter-wise accuracy to find weak spots</li>
            </ul>
          </section>
