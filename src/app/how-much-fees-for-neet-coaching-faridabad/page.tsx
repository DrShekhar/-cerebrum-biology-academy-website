...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'NEET Coaching Fees in Faridabad 2026 | ₹45K-₹3L Comparison',
    description:
      "NEET coaching fees in Faridabad range from ₹45,000 to ₹3,00,000. Compare Velocity, YVS, Cerebrum fees. What's included, hidden costs, and best value.",
  },
}
    ...
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-gradient-to-r from-emerald-50 to-teal-50 border-l-4 border-emerald-600 p-6 rounded-lg mb-8">
              ...
              <p className="text-lg text-emerald-800">
                NEET coaching fees in Faridabad range from <strong>₹45,000 to ₹3,00,000</strong>{' '}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-8">
              Cerebrum Academy Fees (Best Value in Faridabad)
            </h2>
      ...
      <section className="py-16 bg-emerald-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-emerald-100 mb-8">
            Call us for scholarship eligibility and EMI options. Cerebrum Biology Academy, Sector
            17, Faridabad.
          </p>
