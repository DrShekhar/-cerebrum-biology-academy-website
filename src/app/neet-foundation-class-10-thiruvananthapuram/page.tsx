...
const PAGE_URL = 'https://cerebrumbiologyacademy.com/neet-foundation-class-10-thiruvananthapuram'
export const metadata: Metadata = {
  ...
  keywords: ['neet foundation class 10 thiruvananthapuram', 'class 10 biology coaching thiruvananthapuram', 'class 10 neet thiruvananthapuram'],
...
const faqs = [
  { question: 'Is Class 10 too early for NEET in Thiruvananthapuram?', answer: 'No — ideal start. NCERT Class 10 Biology maps directly to NEET.' },
  { question: 'Cost?', answer: 'Foundation Pursuit Rs 35,000/yr. Ascent Rs 50,000/yr. Pinnacle Rs 70,000/yr.' },
]
export default function Page() {
  return (
    <main className="min-h-screen bg-white">
      <CerebrumPersonSchema knowsAbout={['NEET Foundation Thiruvananthapuram', 'Class 10 Biology Kerala']} />
      <LocalBusinessSchema />
      ...
      <section className="bg-gradient-to-br from-emerald-900 to-green-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          <nav className="text-sm text-emerald-300 mb-6" aria-label="Breadcrumb"><Link href="/" className="hover:text-white">Home</Link><span className="mx-2">/</span><Link href="/neet-coaching-thiruvananthapuram" className="hover:text-white">NEET Thiruvananthapuram</Link><span className="mx-2">/</span><span className="text-white">Foundation Class 10</span></nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">NEET Foundation Class 10 in Thiruvananthapuram</h1>
