...
const seniorFacultyPricing = [
  ...
  },
  {
    ...
    features: [
      ...
      'Full OCSC preparation',
      'IBO theory + practicals',
      'Team India pathway guidance',
    ],
  },
]
...
const batchPricing = [
  {
    ...
    perHour: 1500,
    students: '4-8',
    features: ['16 hours (8 sessions)', 'NSEB focus', 'Weekly assignments', 'Group discussions'],
  },
  {
    name: 'INBiO Prep',
    duration: '12 weeks',
