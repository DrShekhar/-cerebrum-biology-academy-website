...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'neet coaching scholarship greater noida',
    'free neet coaching scholarship greater noida',
    'merit scholarship neet greater noida',
    'neet fee concession greater noida',
    'scholarship test neet greater noida',
    'neet coaching financial aid greater noida',
    'biology scholarship greater noida',
  ...
  openGraph: {
    ...
    description:
      'Merit-based NEET scholarships up to 100% fee waiver for Greater Noida students. Apply now!',
  ...
  twitter: {
    ...
    title: 'NEET Scholarship Greater Noida 2026 | Up to 100% Fee Waiver',
    description:
      'Apply for NEET scholarship for Greater Noida students. Merit-based scholarships up to 100% fee waiver. Online + hybrid classes available. Based on 10th/12th marks or scholarship test. Limited seats...',
  },
}
...
const eligibility = [
  ...
  'Greater Noida / NCR residents preferred (online + hybrid available for all)',
]
...
const faqs = [
  {
    question: 'Who is eligible for the NEET scholarship for Greater Noida students?',
    answer:
      'Students with 75%+ marks in Class 10/11/12 are eligible. Greater Noida students can attend online + hybrid classes. Scholarship is based on academic merit or performance in our scholarship test.',
  },
  {
  ...
  {
    question: 'Is scholarship available for online students from Greater Noida?',
    answer:
      'Yes! Greater Noida students attending online or hybrid classes can apply for scholarship. Same eligibility criteria apply. The scholarship test can be taken online via proctored mode.',
  },
  {
...
const testimonials = [
  {
    ...
    batch: 'Class 12 - 2025 (Ryan International Greater Noida)',
    quote: 'Got 75% scholarship with my 93% Class 11 marks. Saved over Rs 50,000 on fees!',
  },
  {
    name: 'Rohit Kumar',
    scholarship: '50% Scholarship',
    batch: 'Dropper - 2025 (DPS Greater Noida)',
    quote:
  ...
  },
  {
    ...
    batch: 'Class 11 - 2024 (Amity International)',
    quote: 'Topped the scholarship test and got 100% fee waiver. Best decision of my life!',
  },
]

export default function NEETScholarshipGreaterNoida() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              NEET Scholarship Greater Noida 2026
            </h1>
            <p className="text-xl text-yellow-100 mb-4">
              Up to 100% fee waiver based on merit! Online + hybrid classes for Greater Noida
              students. Don&apos;t let finances stop your medical dream.
            </p>
      ...
      <section className="py-16 bg-gradient-to-r from-yellow-600 to-orange-500 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Don&apos;t Let Fees Stop Your Dream</h2>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            '@type': 'Scholarship',
            name: 'Cerebrum NEET Biology Scholarship 2026 - Greater Noida',
            description:
              'Merit-based scholarship for NEET Biology preparation for Greater Noida students, up to 100% fee waiver. Online + hybrid classes available.',
            provider: {
