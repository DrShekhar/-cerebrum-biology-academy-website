...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Complete comparison of top national NEET coaching chains for NEET coaching in Faridabad.',
  ...
  twitter: {
    ...
    title: 'Aakash vs Allen: Which is Better for NEET in Faridabad? 2026',
    description:
      'Aakash vs Allen comparison for NEET coaching in Faridabad. Fees, faculty, results, batch size compared. Plus a better alternative with 98% suc...',
  },
}
