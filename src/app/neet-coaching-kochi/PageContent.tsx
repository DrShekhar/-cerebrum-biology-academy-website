...
const kochiAreas = [
  { name: 'Kochi', distance: '0 km', landmark: 'City Center' },
  { name: 'Ernakulam', distance: '5 km', landmark: 'Main Hub' },
  { name: 'Kakkanad', distance: '12 km', landmark: 'Tech Park Area' },
  { name: 'Edappally', distance: '8 km', landmark: 'Residential Zone' },
  { name: 'Vyttila', distance: '6 km', landmark: 'Urban Center' },
  { name: 'Aluva', distance: '15 km', landmark: 'Suburban Area' },
  { name: 'Tripunithura', distance: '18 km', landmark: 'Heritage Locality' },
  { name: 'Marine Drive', distance: '3 km', landmark: 'Waterfront Area' },
]
...
const whyChooseUs = [
  ...
  {
    icon: Target,
    title: '15,000+ Annual Aspirants',
    description:
      'Kerala has significant NEET aspirant population. Tutor-based coaching dominates - Cerebrum brings structured, online premium classes without local competition.',
  },
  {
    icon: Building,
    title: 'Near Top Medical Colleges',
    description:
      'Proximity to Amrita, KUHS-affiliated colleges, and other premium institutions. Our coaching aligns with Kerala medical education standards and entrance patterns.',
  },
  {
    icon: GraduationCap,
    title: 'Expert Kerala-Plus Faculty',
    description:
      'AIIMS-trained instructors familiar with Kerala board + CBSE requirements. Covers Kerala HSC, ISC, and CBSE curricula comprehensively.',
  },
]
...
const localBusinessSchema = {
  ...
  areaServed: ['Kochi', 'Ernakulam', 'Kakkanad', 'Edappally', 'Vyttila', 'Aluva'],
  priceRange: '$$',
}
...
export default function PageContent() {
  ...
  return (
    <div className="min-h-screen">
      <CityBreadcrumb cityName="Kochi" stateName="Kerala" stateSlug="kerala" />
      <script
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Online NEET Coaching in <span className="text-yellow-400">Kochi</span>
            </h1>
            ...
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              Online NEET coaching for Kochi, Ernakulam, Kakkanad & nearby areas. Learn from
              <strong> AIIMS-trained faculty</strong> - comprehensive Kerala + CBSE curriculum for
              15,000+ annual aspirants.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <a
                href="https://wa.me/918826444334?text=Hi%2C%20I%20am%20from%20Kochi%20and%20interested%20in%20NEET%20coaching"
                target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              Kochi & Nearby Localities
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Online NEET coaching accessible from every corner of Kochi metro area
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {kochiAreas.map((area, index) => (
              <div
                key={area.name}
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              Why Kochi Families Choose Cerebrum
            </h2>
          </div>
      ...
      <RelatedCityLinks currentCity="kochi" variant="default" />
    </div>
  )
}
