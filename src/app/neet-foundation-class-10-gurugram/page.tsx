...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'class 10 biology for neet gurugram',
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Located at ${gurugramLocation.streetAddress}, same building as Allen Career Institute, easily accessible from all Gurugram areas.`,
  },
]
...
export default function NEETFoundationClass10GurugramPage() {
  const courseSchema = {
    ...
    '@type': 'Course',
    name: 'NEET Foundation Class 10 - Gurugram',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: 'https://cerebrumbiologyacademy.com/neet-foundation-class-10-gurugram',
      },
    ],
  }
