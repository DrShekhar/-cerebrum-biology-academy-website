...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Cerebrum Class 9 Foundation pricing for Pune families (pan-India online): Pursuit ₹35K-50K, Ascent ₹55K-70K, Pinnacle ₹75K-90K, ad-hoc 1:1 ₹2,000-3,500/hr. Pune-specific competitive context: the 2nd-largest national NEET chain Scholastics Pune Class 9 combined PCB (~₹85K-1L, 200-student, 5 centres Camp/Pimpri/Kothrud/Aundh/Hadapsar); Sinhgad Foundation Class 9 (Pune-headquartered, ~₹70K-90K, 250-student); Lakshya by Bansal Pune (~₹75K-95K); the largest national NEET chain Pune (~₹95K-1.15L). Pune's postgraduate-medical-family demographic disproportionately selects pedagogy depth over mass-batch test series — Cerebrum biology Ascent (₹65K) + other online-only platforms PC (₹15K) = ₹80K total with materially deeper biology than the 2nd-largest national NEET chain standalone, and AIIMS faculty resonates with AFMC/BJMC academic-family preference.",
  },
]
