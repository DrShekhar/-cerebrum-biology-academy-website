...
const cityName = 'Vijayawada'
const citySlug = 'vijayawada'
...
export const metadata: Metadata = {
  ...
  keywords: ['neet dropper batch vijayawada', 'neet repeater course vijayawada', 'best dropper batch neet vijayawada'],
  alternates: { canonical: `https://cerebrumbiologyacademy.com/neet-dropper-batch-vijayawada` },
  openGraph: { title: `NEET Dropper Batch 2026-27 ${cityName}`, url: `https://cerebrumbiologyacademy.com/neet-dropper-batch-vijayawada`, locale: 'en_IN', type: 'website' },
