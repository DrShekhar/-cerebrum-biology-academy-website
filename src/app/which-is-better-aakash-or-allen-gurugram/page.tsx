...
import { Phone, ArrowRight, CheckCircle, XCircle, Users, Building, Award, Target } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Aakash vs Allen: Which is Better for NEET in Gurugram? 2025',
  description:
    'Aakash vs Allen comparison for NEET coaching in Gurugram. Fees, faculty, results, batch size compared. Plus a better alternative with 98% success. Call 88264-44334!',
  keywords: [
...
const comparison = [
  ...
  { factor: 'Batch Size', aakash: '80-150 students', allen: '100-200 students', winner: 'Aakash' },
  { factor: 'Annual Fees (2-year)', aakash: '₹2-3 Lakh', allen: '₹1.8-2.8 Lakh', winner: 'Allen' },
  { factor: 'Study Material', aakash: 'Comprehensive', allen: 'Very Detailed', winner: 'Allen' },
...
const faqs = [
  {
    ...
    answer: 'Nationally, Allen has edge with more NEET toppers. In Gurugram specifically, results are comparable. However, individual results depend more on student effort than institute choice.',
  },
  {
    question: 'Is Allen or Aakash better for Biology?',
    answer: 'Allen\'s Biology material is considered slightly better. However, for focused Biology coaching with AIIMS faculty, specialized Biology academies outperform both.',
  },
  {
    question: 'Can I switch from Aakash to Allen mid-course?',
    answer: 'Technically yes, but not recommended. Switching mid-course disrupts preparation. If unhappy, complete current year and switch for next year if needed.',
  },
  {
    question: 'Is there a better alternative in Gurugram?',
    answer: 'Yes! Boutique coaching like Cerebrum Biology Academy offers 20-student batches, AIIMS faculty, and 98% success rate at half the fees. Consider smaller institutes for better attention.',
  },
]
    ...
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-white">
      <section className="bg-gradient-to-r from-indigo-700 to-indigo-600 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Aakash vs Allen: Which is Better?</h1>
            <p className="text-xl text-indigo-100 mb-8">Unbiased comparison for NEET coaching in Gurugram</p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 border-l-4 border-indigo-600 p-6 rounded-lg mb-8">
              ...
              <p className="text-lg text-indigo-800">
                <strong>Allen has slight edge</strong> in study material and test series. <strong>Aakash has better Gurugram presence</strong> with more centers. However, both have similar issues: large batches (100+ students) and limited personal attention. For better results, consider smaller batch coaching with specialized faculty.
              </p>
            </div>
          </div>
        </div>
                  ...
                  <tr key={index} className={index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                    ...
                    <td className="px-4 py-3 text-center">
                      <span className={`px-2 py-1 rounded text-xs font-semibold ${
                        row.winner === 'Aakash' ? 'bg-blue-100 text-blue-700' :
                        row.winner === 'Allen' ? 'bg-green-100 text-green-700' :
                        row.winner === 'Neither' ? 'bg-red-100 text-red-700' :
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-center text-gray-700 mb-6">
                Cerebrum Biology Academy offers what Aakash and Allen can't: <strong>small batches, personal attention, and AIIMS faculty</strong> at half the price.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <Link href="/aakash-vs-cerebrum-neet-coaching" className="text-indigo-600 hover:underline">Aakash vs Cerebrum →</Link>
                <Link href="/allen-vs-cerebrum-neet-coaching" className="text-indigo-600 hover:underline">Allen vs Cerebrum →</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-indigo-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-indigo-100 mb-8">Talk to our counselors. We'll help you make the right choice.</p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link href="/free-neet-demo-class-gurugram" className="inline-flex items-center gap-2 bg-white/20 text-white px-8 py-3 rounded-lg font-semibold hover:bg-white/30 transition">
              Try Our Free Demo<ArrowRight className="w-5 h-5" />
            </Link>
          </div>
        </div>
      </section>
