...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Our NEET Biology coaching fees range from Rs 24,000 to Rs 48,000 per year. This is significantly lower than Allen, Aakash or FIITJEE while offering superior quality with AIIMS faculty and smaller batches of 15-20 students.',
  },
  {
...
export default function NeetCoachingGhaziabadPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Areas Coverage - replaced by AreasServedSection below */}
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {nearbySchools.map((school, index) => (
              <div key={school.name} className="bg-white rounded-xl p-4 shadow-md animate-fadeInUp">
      ...
      <AreasServedSection cityName="Ghaziabad" areas={areasForAccordion} />
      ...
      <StickyMobileCTABar waUrl="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Biology%20coaching%20in%20Ghaziabad.%20Please%20share%20available%20timings." />
