...
const faqs = [
  {
    q: 'Can AP Biology to NEET students prepare for NEET?',
    a: 'Yes! Our bridge course fills curriculum gaps comprehensively.',
  },
  ...
  { q: 'How long is the program?', a: 'Typically 6-8 months depending on your background' },
  {
    ...
    a: 'Yes! We have students from multiple countries with online access',
  },
  {
    q: 'What is the pricing?',
    a: 'Plans start from Rs 32000. Contact via WhatsApp for custom pricing',
  },
]
