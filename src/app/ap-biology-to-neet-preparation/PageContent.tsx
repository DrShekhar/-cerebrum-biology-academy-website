...
const bridgeFeatures = [
  {
    ...
    description: 'Map board concepts to NCERT and identify gaps in Indian medical curriculum.',
  },
  {
    icon: Target,
    title: 'NEET-Specific Strategy',
    description: 'Convert understanding into NEET speed and pattern mastery.',
  },
  {
    icon: Headphones,
    title: 'Doubt Clearing',
    description: '24/7 chat support + weekly live doubt clearing sessions.',
  },
  {
    icon: Play,
    title: 'MCQ Mastery',
    description: 'Master NEET-style MCQs with 4000+ curated questions.',
  },
  {
    icon: Shield,
    title: 'Medical Context',
    description: 'Focus on applied medical biology relevant to NEET.',
  },
  {
    icon: Star,
    title: 'Fast-Track Module',
    description: 'Accelerated bridging option for students starting late.',
  },
]
...
const methodologySteps = [
  {
    number: '1',
    title: 'Gap Analysis',
    description: 'Comprehensive assessment of board topics vs NEET syllabus.',
  },
  ...
  { number: '5', title: 'Mentoring & Support', description: 'Weekly mentoring with NEET experts.' },
  {
    number: '6',
    title: 'Final Polish',
    description: 'Advanced test series and readiness sessions.',
  },
]

const faqData = [
  {
    question: 'How different is board biology from NEET?',
    answer:
      'Board focuses on broad conceptual understanding. NEET requires Indian medical focus, faster pace, and NCERT-specific patterns. We bridge this gap effectively with targeted coaching.',
  },
  {
    question: 'Can I prepare for NEET after board?',
    answer:
      'Yes! With 5-8 months of focused bridging, board students achieve excellent NEET results. Your conceptual foundation is a strong advantage.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Typically 5-8 months depending on your background. We offer accelerated 3-month gap filling modules or complete 8-month programs.',
  },
  {
    question: 'Do you provide study material?',
    answer:
      'Yes. NCERT summaries, board-NEET comparison charts, 4000+ MCQs, previous year papers, and board-specific test series.',
  },
  {
...
// USD equivalents at ~83 INR/USD, rounded to a cleaner anchor for
// non-IN visitors. Shown only after a client-side geo lookup so we
// don't clutter the INR-primary view for Indian families.
const pricingTiers = [
  {
    name: 'Bridge Course',
    duration: '3 months',
    price: '₹35,000',
    priceUsd: '$420',
    features: ['Gap analysis', 'Essential topics', '3x/week classes', 'Doubt clearing'],
  },
  {
    ...
    price: '₹55,000',
    priceUsd: '$665',
    features: ['Full coverage', 'All gap topics', '5x/week classes', '4000+ MCQs', 'Weekly tests'],
  },
  {
...
export default function PageContent() {
  ...
  // Show USD equivalents only for non-IN visitors. Same pattern as the
  // home-page geo banner — fetches /api/geo/country, falls back to INR-
  // only for Indian visitors and unknown-country fetches.
    ...
    <div className="min-h-screen bg-white">
      <section
        ...
        className={
          ...
          (heroSection.isVisible ? '' : 'opacity-0 translate-y-8')
        }
      >
              ...
              <div>
                ...
                <div className="space-y-4 mb-8">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-lg">15,000+ Students Prepared</span>
                  </div>
                  <div className="flex items-center gap-3">
            ...
            {bridgeFeatures.map((feature, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className={
                    'p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-all ' +
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {methodologySteps.map((step, idx) => (
              <div
                key={idx}
                className={
                  'p-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 ' +
                  (methodologySection.isVisible ? 'opacity-100' : 'opacity-0')
                }
                style={{ transitionDelay: `${idx * 100}ms` }}
              >
          ...
          testimonials={[
            {
              ...
              score: '720',
              school: 'DPS Delhi',
              quote: 'Bridge program helped me transition seamlessly to NEET style.',
            },
            {
              name: 'Priya Gupta',
              score: '698',
              school: 'Cathedral School, Mumbai',
              quote: 'Structured approach made the learning efficient and effective.',
            },
            {
              name: 'Rohit Verma',
              score: '685',
              school: 'DPS, Bangalore',
              quote: 'Expert guidance elevated my preparation significantly.',
            },
          ]}
        />
      </section>
      ...
      <section className="py-20 px-4 md:px-8 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-blue-100 mt-6">
            Call:{' '}
            <a href="tel:+918826444334" className="underline font-semibold">
              +918826444334
            </a>{' '}
            | WhatsApp: 918826444334
          </p>
          <p className="text-blue-100 text-sm mt-4">
            Coached by: Dr. Shekhar C Singh and NEET Expert Faculty
          </p>
        </div>
      </section>
    </div>
