...
const config: BestVerticalConfig = {
  ...
  pages: [
    ...
    { title: 'Austin', href: '/ap-biology-tutor-austin' },
    { title: 'Denver', href: '/ap-biology-tutor-denver' },
    { title: 'Miami', href: '/ap-biology-tutor-miami' },
    { title: 'Phoenix', href: '/ap-biology-tutor-phoenix' },
    { title: 'Portland', href: '/ap-biology-tutor-portland' },
    { title: 'San Diego', href: '/ap-biology-tutor-san-diego' },
    { title: 'Gurugram', href: '/ap-biology-tutor-gurugram' },
    { title: 'Noida', href: '/ap-biology-tutor-noida' },
    { title: 'Faridabad', href: '/ap-biology-tutor-faridabad' },
    { title: 'Ghaziabad', href: '/ap-biology-tutor-ghaziabad' },
    { title: 'Beijing', href: '/ap-biology-tutor-beijing' },
    { title: 'Shanghai', href: '/ap-biology-tutor-shanghai' },
