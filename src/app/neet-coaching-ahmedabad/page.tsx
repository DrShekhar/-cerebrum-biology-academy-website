...
export default function NeetCoachingAhmedabadPage() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {whyAhmedabad.map((item, index) => (
              <div
                key={item.title}
                className="bg-blue-50 rounded-xl p-8 border border-blue-100 animate-fadeInUp"
              >
      ...
      <StickyMobileCTABar waUrl="https://wa.me/918826444334?text=Hi!%20I%20want%20a%20FREE%20demo%20for%20NEET%20Biology%20coaching%20in%20Ahmedabad.%20Please%20share%20timings." />
    </div>
  )
}
