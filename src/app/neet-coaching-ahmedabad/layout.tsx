...
export const metadata: Metadata = {
  ...
  description:
    'Top NEET biology coaching in Ahmedabad for Gujarat students. 98% success rate, AIIMS faculty. Satellite, SG Highway, Bopal, Prahlad Nagar, Gandhinagar. 3,500+ students. Book free demo!',
  keywords:
  ...
  openGraph: {
    title: 'Best NEET Coaching in Ahmedabad | Gujarat',
    description:
      'Top NEET biology coaching in Ahmedabad with 98% success rate. AIIMS faculty, small batches. Join 3,500+ Gujarat students from Satellite, SG Highway, Bopal.',
  ...
  twitter: {
    ...
    title: 'Best NEET Coaching in Ahmedabad',
    description:
