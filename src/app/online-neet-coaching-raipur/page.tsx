...
const PAGE_URL = 'https://cerebrumbiologyacademy.com/online-neet-coaching-raipur'

export const metadata: Metadata = {
  title: 'Online NEET Coaching Raipur | Cerebrum',
  description: 'Online NEET Coaching in Raipur — AIIMS-trained faculty, online live. Serving Shankar Nagar, Devendra Nagar, Telibandha, Pandri. From Rs 48,000/yr.',
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Online NEET Coaching in Raipur</h1>
