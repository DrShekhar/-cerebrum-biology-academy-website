...
export const metadata: Metadata = {
  ...
  description: 'Best NEET coaching for Kharar Punjab students. 94.2% success rate, AIIMS faculty. Online classes - no travel to Chandigarh. Near Mohali. Fee ₹24,000+. Book free demo!',
  ...
  openGraph: {
    title: 'NEET Coaching in Kharar Punjab | Near Mohali | Cerebrum Academy',
    description: 'Best NEET coaching for Kharar students. 94.2% success rate, AIIMS faculty.',
