...
export const metadata: Metadata = {
  ...
  description:
    'NEET Foundation Class 9 in Kochi — AIIMS-trained faculty, online live. Serving Marine Drive, Edappally, Kakkanad, Vyttila, Aluva, Palarivattom, Infopark. From Rs 35,000/year.',
  keywords: [
    'neet foundation class 9 kochi',
    'class 9 biology coaching kochi',
    'class 9 neet kochi',
  ],
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: 'NEET Foundation Class 9 Kochi',
    url: PAGE_URL,
    locale: 'en_IN',
    type: 'website',
  },
...
const wa =
  ...
  encodeURIComponent('Hi — Class 9 student in Kochi, want NEET Foundation details.')
const faqs = [
  {
    question: 'Is Class 9 too early for NEET in Kochi?',
...
export default function Page() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-emerald-900 to-green-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            NEET Foundation Class 9 in Kochi
          </h1>
      ...
      <FoundationCityEnrichment slug="kochi" classLevel={9} />
