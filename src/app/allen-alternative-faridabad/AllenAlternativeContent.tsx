...
export default function AllenAlternativeFaridabadContent({ faqs }: { faqs: FAQ[] }) {
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              ...
              why 500+ Faridabad students chose Cerebrum for focused NEET Biology preparation.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeInUp">
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  Near Bata Chowk Metro - easy commute
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
              ...
              <Link href="/complement-allen-coaching-faridabad">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-slate-600 mb-6">
                  ...
                  min walk). Whether you're switching or complementing, easily accessible from all
                  parts of Faridabad.
                </p>
