...
export const metadata: Metadata = {
  ...
  description:
    'Top NEET coaching for Solan students. 94.2% success rate. Online classes from AIIMS faculty. Serving Solan, Kasauli, Baddi, Nalagarh. MMMC Solan has 150 MBBS seats in your city!',
  keywords:
  ...
  openGraph: {
    ...
    description:
      'Join the most trusted NEET coaching for Solan. Online classes from AIIMS-trained faculty. 94.2% success rate. MMMC Solan with 150 seats is in your city!',
  ...
  alternates: {
    canonical: 'https://cerebrumacademy.in/neet-coaching-solan',
  },
  other: {
    'geo.region': 'IN-HP',
    'geo.placename': 'Solan',
