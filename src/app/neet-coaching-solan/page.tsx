            ...
            <div className="container mx-auto px-4 relative z-10">
              <div className="text-center max-w-5xl mx-auto animate-fadeInUp">
                ...
                <p className="text-lg md:text-xl text-slate-300 mb-8 max-w-3xl mx-auto leading-relaxed">
                  ...
                  <span className="text-lime-400 font-semibold"> 150 MBBS seats</span> in one
                  college! Why travel to Chandigarh when you can become a doctor in Solan itself?
                </p>
          ...
          <section className="py-16">
            <div className="container mx-auto px-4">
              <div className="animate-fadeInUp">
                ...
                <p className="text-slate-400 text-center mb-12 max-w-2xl mx-auto">
                  Students from prestigious schools like Lawrence Sanawar trust us for NEET
                  preparation
                </p>
          ...
          <section className="py-16 bg-slate-900/50">
            <div className="container mx-auto px-4">
              <div className="animate-fadeInUp">
                ...
                <p className="text-slate-400 text-center mb-12 max-w-2xl mx-auto">
                  MMMC Solan (150 seats) is in your city! Plus Chandigarh colleges are just 45 km
                  away
                </p>
                        ...
                        >
                          <td className="py-4 px-4">
                            <div className="flex items-center gap-2">
                              ...
                              <span
                                className={
                                  college.highlight ? 'text-lime-300 font-semibold' : 'text-white'
                                }
                              >
                                {college.name}
                              </span>
            ...
            <div className="container mx-auto px-4">
              <div className="text-center max-w-3xl mx-auto animate-fadeInUp">
                ...
                <p className="text-xl text-slate-300 mb-8">
                  MMMC Solan has 150 MBBS seats waiting. Join Cerebrum and turn your medical dream
                  into reality!
                </p>
                ...
                <p className="text-slate-400 mt-6">
                  Join 350+ students from Solan district who chose smart preparation over daily
                  commute
                </p>
              </div>
            </div>
