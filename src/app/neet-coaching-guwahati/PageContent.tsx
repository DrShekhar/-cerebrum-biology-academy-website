    ...
    <div className="w-full">
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8 inline-block">
            <span className="text-sm font-semibold text-blue-600 bg-blue-50 px-4 py-2 rounded-full">NE India Hub - Best NEET Coaching in Guwahati</span>
          </div>
          
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-gray-900 mb-6 leading-tight">
            Best NEET Coaching<br className="hidden sm:block" /> in <span className="text-blue-600">Guwahati</span>
          </h1>
          
          <p className="text-xl sm:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto font-light">
            Top NEET Biology coaching in NE India hub Guwahati. AIIMS faculty. 98% success rate. AHSEC board integration.
          </p>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl sm:text-5xl font-bold text-center text-gray-900 mb-16">Why Choose Cerebrum for NEET in Guwahati?</h2>
          ...
          <div ref={features.ref} className={`grid grid-cols-1 md:grid-cols-2 gap-8 transition-opacity duration-1000 ${features.isVisible ? 'opacity-100' : 'opacity-0'}`}>
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">AHSEC Board Expertise</h3>
                  <p className="text-gray-600">Specialized curriculum for Assam students. Perfect board + NEET balance.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">AIIMS Mentorship</h3>
                  <p className="text-gray-600">Direct guidance from AIIMS doctors. Weekly progress tracking & personalized plans.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Hybrid Learning Platform</h3>
                  <p className="text-gray-600">Online + offline batches, live doubt sessions, recorded classes available 24x7.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Complete Study Resources</h3>
                  <p className="text-gray-600">NCERT + advanced notes, chapter tests, 12 full-length mocks, career guidance.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl sm:text-5xl font-bold text-center text-gray-900 mb-4">NEET Coaching in Guwahati Areas</h2>
          <p className="text-center text-gray-600 mb-16 max-w-2xl mx-auto">Coaching centers across major localities in Guwahati, Assam</p>
          ...
          <div ref={areas.ref} className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 transition-opacity duration-1000 ${areas.isVisible ? 'opacity-100' : 'opacity-0'}`}>
            {['Dispur', 'Chandmari', 'Paltan Bazaar', 'G.S. Road', 'Uzan Bazaar', 'Christianbasti', 'Panbazar', 'Rehabari'].map((area) => (
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div ref={faq.ref} className={`space-y-6 transition-opacity duration-1000 ${faq.isVisible ? 'opacity-100' : 'opacity-0'}`}>
            {[
              {
                q: 'Do you specialize in AHSEC board students?',
                a: 'Yes! Dedicated AHSEC curriculum mapping with NEET syllabus. Helps in both board and competitive exams.'
              },
              {
                q: 'Is Guwahati a good place for NEET preparation?',
                a: 'Excellent! NE hub with peaceful environment, good colleges, and AIIMS faculty availability.'
              },
              {
                q: 'Do you have centers in Dispur/Chandmari?',
                a: 'Yes! Main center strategically located with online batches covering entire Assam and NE region.'
              },
              {
                q: 'What is batch strength and mentoring format?',
                a: 'Small batches (15-20 students) with personalized mentoring, weekly progress meetings, and doubt sessions.'
              },
              {
                q: 'How many full-length mocks are conducted?',
                a: 'Minimum 12 full-length NEET mocks annually with detailed rank prediction and feedback analysis.'
              }
            ].map((item, idx) => (
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">Excel in NEET from Guwahati!</h2>
          <p className="text-xl text-blue-100 mb-8">Join NE India's premier NEET coaching. AHSEC + NEET integrated success.</p>
      ...
      <PricingSection cityName="Guwahati" />
      <CostComparisonSection cityName="Guwahati" />
      <RelatedCityLinks currentCity="guwahati" variant="default" />
    </div>
  )
}
