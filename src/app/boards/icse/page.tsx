...
import { CheckCircle, Clock, Users, Award, BookOpen, Target, Star, ArrowRight, Trophy, Brain, Microscope } from 'lucide-react'
...
export const metadata: Metadata = {
  ...
  keywords: 'ICSE Biology coaching, ICSE board exam, detailed Biology curriculum, medical entrance, practical Biology',
}
...
export default function ICSEBiologyPage() {
  ...
  const icseAdvantages = [
    {
      ...
      description: 'ICSE provides comprehensive Biology coverage with greater depth than other boards'
    },
    {
      icon: Brain,
      title: 'Conceptual Clarity',
      description: 'Strong foundation building with emphasis on understanding rather than memorization'
    },
    {
      icon: Target,
  ...
  const examPattern = {
    theory: {
      ...
      marks: '80 marks',
      sections: [
        { type: 'Section A', description: 'Short Answer Questions (40 marks)', questions: '8 out of 10' },
        { type: 'Section B', description: 'Structured/Application Questions (40 marks)', questions: '6 out of 8' }
      ]
    },
    practical: {
      duration: '2 Hours',
      marks: '40 marks',
      components: [
        { type: 'Practical Work', marks: '20 marks', description: 'Laboratory experiments and observations' },
        { type: 'Project Work', marks: '20 marks', description: 'Individual research project and viva' }
      ]
    }
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8">
              <h3 className="text-2xl font-bold mb-6">ICSE Program Features</h3>
              <div className="space-y-4">
                <div className="flex items-center">
                  <BookOpen className="w-6 h-6 mr-3 text-green-300" />
                  <span>Detailed Curriculum Coverage</span>
                </div>
                <div className="flex items-center">
                  <Microscope className="w-6 h-6 mr-3 text-green-300" />
                  <span>Strong Practical Component</span>
                </div>
                <div className="flex items-center">
                  <Brain className="w-6 h-6 mr-3 text-green-300" />
                  <span>Conceptual Depth Learning</span>
                </div>
                <div className="flex items-center">
                  <Target className="w-6 h-6 mr-3 text-green-300" />
                  <span>Medical Entrance Preparation</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">ICSE Biology Success Record</h2>
            <p className="text-gray-600">Exceptional results in ICSE examinations with strong medical entrance preparation</p>
          </div>
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why ICSE is Ideal for Medical Aspirants</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              ICSE curriculum provides comprehensive Biology education with depth and practical focus
            </p>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Comprehensive ICSE Curriculum</h2>
            <p className="text-gray-600">Complete coverage of ICSE Biology syllabus with practical components</p>
          </div>
            ...
            {curriculum.map((classData, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg">
                <div className="flex justify-between items-center mb-6">
                  <h3 className="text-xl font-bold text-gray-900">{classData.class}</h3>
          ...
          <div className="bg-green-50 rounded-xl p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Practical Assessment Components</h3>
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">ICSE Biology Exam Pattern</h2>
            <p className="text-gray-600">Understanding the examination structure for optimal preparation</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8">
            {/* Theory Paper */}
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Theory Paper (Paper 1)</h3>
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="font-medium">Duration:</span>
                  <span className="text-green-600 font-semibold">{examPattern.theory.duration}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-medium">Total Marks:</span>
                  <span className="text-green-600 font-semibold">{examPattern.theory.marks}</span>
                </div>
                <div className="space-y-3">
                  {examPattern.theory.sections.map((section, index) => (
                    <div key={index} className="border border-gray-200 rounded-lg p-3">
                      ...
                      <div className="text-sm text-green-600 font-medium">Answer: {section.questions}</div>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {/* Practical Paper */}
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Practical Assessment (Paper 2)</h3>
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="font-medium">Duration:</span>
                  <span className="text-green-600 font-semibold">{examPattern.practical.duration}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-medium">Total Marks:</span>
                  <span className="text-green-600 font-semibold">{examPattern.practical.marks}</span>
                </div>
                <div className="space-y-3">
                  {examPattern.practical.components.map((component, index) => (
                    <div key={index} className="border border-gray-200 rounded-lg p-3">
                      <div className="flex justify-between items-center">
                        ...
                        <div className="text-green-600 font-semibold">{component.marks}</div>
                      </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">ICSE Course Features</h2>
          </div>
      ...
      <section className="py-16 bg-green-50">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Excel in ICSE Biology Today</h2>
          
          <div className="bg-white rounded-3xl shadow-xl p-8 mb-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">ICSE Biology Complete Course</h3>
                <div className="text-left space-y-3">
                  <div className="flex items-center">
                    <Star className="w-5 h-5 text-yellow-500 mr-2" />
                    <span>Complete ICSE curriculum coverage</span>
                  </div>
                  <div className="flex items-center">
                    <Star className="w-5 h-5 text-yellow-500 mr-2" />
                    <span>Practical work and project guidance</span>
                  </div>
                  <div className="flex items-center">
                    <Star className="w-5 h-5 text-yellow-500 mr-2" />
                    <span>Medical entrance preparation</span>
                  ...
                  <div className="flex items-center">
                    <Star className="w-5 h-5 text-yellow-500 mr-2" />
                    <span>85+ score guarantee</span>
                  </div>
                </div>
              </div>
              
              <div>
                <div className="text-4xl font-bold text-green-600 mb-4">₹32,999</div>
                <p className="text-gray-600 mb-6">Complete 2-year ICSE program</p>
                <div className="space-y-3">
                  <Link 
                    href="/admissions"
          ...
          <div className="bg-blue-100 border border-blue-300 rounded-xl p-6">
            <p className="text-blue-800 font-semibold mb-2">🔬 ICSE Special Offer</p>
            <p className="text-blue-700">
              Enroll now and get FREE laboratory manual + specimen collection for practical exam preparation worth ₹4,000!
            </p>
          </div>
        </div>
      </section>
