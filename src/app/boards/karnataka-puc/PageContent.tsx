          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="animate-fadeInUp">
              ...
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <a
                  href="https://wa.me/918826444334?text=Hi!%20I%20am%20on%20your%20Boards%20page%20and%20want%20to%20know%20more%20about%20batches%2C%20fees%2C%20and%20admission."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {syllabusCoverage.map((module, index) => (
              <div
                key={index}
                className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-orange-500 animate-fadeInUp"
              >
