...
import { CheckCircle, Clock, Users, Award, BookOpen, Target, Star, ArrowRight, Trophy, GraduationCap, Globe } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Board Preparation | CBSE, ICSE, IGCSE, IB Biology Coaching | Cerebrum Biology Academy',
  description: 'Expert Biology coaching for all major boards - CBSE, ICSE, IGCSE, IB, and State Boards. Score 90+ marks with our specialized board preparation programs.',
  keywords: 'board preparation, CBSE Biology, ICSE Biology, IGCSE Biology, IB Biology, state board, board exam coaching',
}
...
export default function BoardPreparationPage() {
  const boardTypes = [
    ...
    },
    {
      ...
      features: ['In-depth concept coverage', 'Practical-focused approach', 'High academic standards'],
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-indigo-100 mb-8">
                Master Biology for all major educational boards. Specialized coaching for CBSE, ICSE, 
                IGCSE, IB, and State Boards with board-specific teaching methodologies and expert faculty.
              </p>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Board Exam Success Record</h2>
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Choose Your Board</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Specialized preparation programs tailored for each board's unique curriculum and examination pattern
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {boardTypes.map((board, index) => (
              <div key={index} className={`bg-white rounded-xl p-6 shadow-lg border-l-4 ${getColorClasses(board.color)} hover:shadow-xl transition-shadow`}>
                <div className="mb-4">
                ...
                <Link 
                  ...
                  className={`block w-full text-center py-3 px-4 rounded-lg font-semibold transition-colors ${
                    board.color === 'blue' ? 'bg-blue-600 text-white hover:bg-blue-700' :
                    board.color === 'green' ? 'bg-green-600 text-white hover:bg-green-700' :
                    board.color === 'purple' ? 'bg-purple-600 text-white hover:bg-purple-700' :
                    board.color === 'red' ? 'bg-red-600 text-white hover:bg-red-700' :
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Our Board Preparation?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Comprehensive expertise across all major educational boards with proven teaching methodologies
            </p>
          </div>
      ...
      <section className="py-16 bg-indigo-50">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Ready to Excel in Your Board Exams?</h2>
          ...
          <div className="bg-green-100 border border-green-300 rounded-xl p-6">
            ...
            <p className="text-green-700">
              Get a FREE board-specific study plan and previous year question bank when you enroll before board registrations!
            </p>
          </div>
        </div>
      </section>
