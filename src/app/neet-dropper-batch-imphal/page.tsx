...
const cityName = 'Imphal'
const citySlug = 'imphal'
export const metadata: Metadata = {
  ...
  keywords: ['neet dropper batch imphal', 'neet repeater imphal'],
  alternates: { canonical: `https://cerebrumbiologyacademy.com/neet-dropper-batch-imphal` },
  openGraph: { title: `NEET Dropper Batch 2026-27 ${cityName}`, url: `https://cerebrumbiologyacademy.com/neet-dropper-batch-imphal`, locale: 'en_IN', type: 'website' },
