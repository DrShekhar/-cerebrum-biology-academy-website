...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Yes, FREE demo class available: Online Demo - Join live Zoom class (1 hour Biology lecture + 30 min doubt session), Recorded Demo - Watch sample lecture anytime. Book via: Website cerebrumbiologyacademy.com/book-free-demo, Phone +91 88264 44334, or WhatsApp. Demo includes interaction with Dr. Shekhar Sir and sample study material.',
  },
]
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="text-center max-w-5xl mx-auto animate-fadeInUp">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20%E2%80%94%20interested%20in%20coaching%20tagore%20garden.%20Please%20share%20available%20timings."
                target="_blank"
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="quick-answer bg-white rounded-xl p-6 shadow-md border-l-4 border-blue-600">
            ...
            <p className="text-gray-700">
              Cerebrum Biology Academy offers the best NEET coaching for students in Tagore Garden,
              West Delhi. Our Rohini center is just 20 minutes away via Blue Line Metro. We serve
              750+ students from Tagore Garden Extension, Kohli One Westend Greens, MIG Flats,
              Rajouri Garden, Janakpuri, and surrounding areas. With 98% success rate, AIIMS-trained
              faculty, and flexible online/offline options, we provide comprehensive NEET Biology
              preparation. Call +91 88264 44334 or book a free demo class today.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-lg opacity-90 mb-6">
                ...
                Tagore Garden Metro to Kashmere Gate, then switch to the Red Line to reach Rohini in
                just 20 minutes.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {nearbyAreas.map((item, index) => (
              <div
                key={item.area}
                className="bg-white rounded-xl shadow-md hover:shadow-xl p-5 transition-all hover:-translate-y-1 border border-gray-100 animate-fadeInUp"
              >
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Trusted by families from West Delhi&apos;s best residential complexes including Kohli
              One Westend Greens and MIG Flats Extension
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {premiumSocieties.map((society, index) => (
              <div
                key={society.name}
                className="bg-blue-50 rounded-xl p-5 border border-blue-100 animate-fadeInUp"
              >
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <div className="bg-white/10 backdrop-blur rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition animate-fadeInUp">
              ...
              <p className="text-slate-300 mb-4">
                Live interactive classes from your West Delhi home. No travel needed.
              </p>
            ...
            <div className="bg-yellow-500 rounded-2xl p-6 text-slate-900 relative overflow-hidden animate-fadeInUp">
              ...
              <p className="text-slate-700 mb-4">
                Online classes + Weekend offline sessions at Rohini center.
              </p>
              <ul className="space-y-2 text-sm">
                <li className="flex items-center gap-2">
            ...
            <div className="bg-white/10 backdrop-blur rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition animate-fadeInUp">
              ...
              <p className="text-slate-300 mb-4">
                Daily classes at our Rohini center, just 20 min from Tagore Garden.
              </p>
              <ul className="space-y-2 text-sm">
                <li className="flex items-center gap-2">
          ...
          <div className="mt-12 bg-white/5 rounded-2xl p-6 max-w-4xl mx-auto animate-fadeInUp">
            <div className="flex flex-col md:flex-row items-center gap-6">
              <div className="flex-1">
                ...
                <p className="text-slate-300 mb-4">
                  Our Rohini center is just 20 minutes from Tagore Garden via Delhi Metro Blue Line
                  to Red Line connection. Perfect for students preferring classroom learning.
                </p>
      ...
      <section className="py-16 md:py-20 bg-blue-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Trusted by students from leading schools in Tagore Garden, Rajouri Garden, Janakpuri
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {nearbySchools.map((school, index) => (
              <div
                key={school.name}
                className="bg-white rounded-xl shadow-md p-5 border border-gray-100 animate-fadeInUp"
              >
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {metroStations.map((station, index) => (
              <div
                key={station.name}
                className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-4 border border-blue-100 animate-fadeInUp"
              >
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              See what students and parents from Tagore Garden, Rajouri Garden, and Janakpuri say
              about us
            </p>
          </div>
            ...
            <div className="lg:col-span-2 space-y-5">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300 animate-fadeInUp">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="font-bold text-gray-900">
                        Priya, Tagore International School
                      </div>
                ...
                <p className="text-gray-700 leading-relaxed italic">
                  &quot;Best NEET Biology coaching accessible from Tagore Garden! The online classes
                  are amazing - I save 2 hours daily that I would have spent traveling. Scored
                  658/720 in NEET 2024. Dr. Shekhar Sir&apos;s teaching methodology is exceptional.
                  Highly recommend for West Delhi students!&quot;
                </p>
                <div className="mt-3 flex items-center text-sm text-teal-700">
                  <Trophy className="w-4 h-4 mr-1" />
                  <span className="font-semibold">
                    658/720 NEET 2024 | Government Medical College
                  </span>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300 animate-fadeInUp">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        MIG Flats Extension, Tagore Garden
                      </div>
                    </div>
                  </div>
                  <div className="flex">
                ...
                <p className="text-gray-700 leading-relaxed italic">
                  &quot;My son takes online classes from our MIG Flats home. The convenience is
                  unmatched - no travel stress and he can focus entirely on studies. His score
                  improved from 520 to 635 in just 6 months. Best investment for his NEET
                  preparation!&quot;
                </p>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300 animate-fadeInUp">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="font-bold text-gray-900">
                        Aditya, Bal Bharati Public School
                      </div>
                ...
                <p className="text-gray-700 leading-relaxed italic">
                  &quot;Perfect for students in West Delhi. The hybrid mode works great - online
                  classes during weekdays and offline tests on weekends at Rohini. Metro
                  connectivity makes it super easy. Scored 350/360 in Biology section!&quot;
                </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              'Online NEET Biology coaching for Tagore Garden and West Delhi students with optional offline classes at Rohini center. Serving Kohli One Westend Greens, MIG Flats Extension, Rajouri Garden, Janakpuri, and all premium West Delhi societies.',
            provider: {
            ...
            areaServed: [
              {
                '@type': 'Place',
                name: 'Tagore Garden',
                containedIn: { '@type': 'City', name: 'Delhi' },
              },
              {
                '@type': 'Place',
                name: 'Rajouri Garden',
