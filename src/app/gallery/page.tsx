...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description:
      'Explore our Wall of Excellence - celebrating student achievements, faculty expertise, and memorable moments.',
    images: ['/images/gallery/img-2854.jpg'],
  },
}
...
export default function GalleryPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'Gallery',
        item: 'https://cerebrumbiologyacademy.com/gallery',
      },
    ],
  }
  ...
  const collectionPageSchema = {
    ...
    description:
      'Celebrating student achievements, faculty expertise, campus events, seminars, and memorable moments at Cerebrum Biology Academy.',
