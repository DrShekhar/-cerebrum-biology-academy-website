...
export const metadata: Metadata = {
  ...
  description:
    'Top Class 12 biology coaching for NEET 2025. Expert AIIMS faculty, complete NCERT + advanced NEET prep. Genetics, Reproduction, Ecology, Biotechnology. 98% success rate. Book free demo!',
  keywords:
