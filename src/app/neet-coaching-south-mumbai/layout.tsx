...
export const metadata: Metadata = {
  title: 'Best NEET Coaching in South Mumbai | Colaba, Malabar Hill, Worli',
  description:
    'Ultra-premium NEET biology coaching in South Mumbai for elite schools. 98% success rate, AIIMS faculty. Colaba, Cuffe Parade, Malabar Hill, Breach Candy, Pedder Road, Worli. Fee ₹24,000+. Book free demo!',
  keywords:
  ...
  openGraph: {
    title: 'Best NEET Coaching in South Mumbai | Elite Education',
    description:
      'Ultra-premium NEET biology coaching in South Mumbai with 98% success rate. AIIMS faculty, concierge service. Cathedral, Campion, JBCN students.',
  ...
  twitter: {
    ...
    title: 'Best NEET Coaching in South Mumbai',
    description:
      'Ultra-premium NEET biology coaching in South Mumbai. 98% success rate. Colaba, Malabar Hill, Worli, Cuffe Parade.',
  },
  alternates: {
