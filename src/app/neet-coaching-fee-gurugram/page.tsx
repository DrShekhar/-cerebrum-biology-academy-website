...
const feeFactors = [
  {
    factor: 'Institute Reputation',
    impact: 'High',
    description: 'Established brands charge 2-3x more',
  },
  {
    factor: 'Batch Size',
    impact: 'High',
    description: 'Smaller batches = higher fees but better attention',
  },
  {
    factor: 'Subject Coverage',
    impact: 'Medium',
    description: 'Biology-only is 50-70% cheaper than full PCB',
  },
  {
    factor: 'Study Material',
    impact: 'Medium',
    description: 'Premium material adds Rs 10,000-20,000',
  },
...
const faqs = [
  {
    ...
    answer:
      'The average NEET coaching fee in Gurugram is Rs 80,000-1,20,000 per year for full NEET (PCB) coaching. Biology-only specialist coaching is more affordable at Rs 45,000-65,000 per year.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Not always. Success depends on teaching quality, batch size, and your dedication - not just fees. Many students from affordable coaching (Rs 50,000-80,000/year) crack NEET with good ranks. Focus on faculty quality and batch size over brand name.',
  },
  {
    question: 'Do NEET coaching institutes offer EMI or scholarships?',
    answer:
      'Yes, most institutes offer EMI options (3-12 months). Scholarships of 10-100% are available based on entrance tests or board marks. Cerebrum Academy offers up to 50% scholarship for meritorious students.',
  },
]
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            NEET Coaching Fee Comparison Gurugram 2026
          </h2>
          <p className="text-center text-gray-600 mb-8">
            Updated January 2026 | Verified fees from official sources
          </p>
            ...
            <table className="w-full border-collapse">
              ...
              <tbody>
                {feeComparison.map((item, index) => (
                  <tr
                    key={index}
                    className={`border-b ${item.highlight ? 'bg-green-50 font-medium' : index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}`}
                  >
          ...
          <p className="text-sm text-gray-500 text-center mt-4">
            * Fees are approximate and may vary. Contact institutes for exact pricing.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Factors Affecting NEET Coaching Fees
          </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-green-50 rounded-2xl p-8 border border-green-200">
            <h2 className="text-2xl font-bold text-green-800 mb-4">
              Why Cerebrum Offers Best Value for Money
            </h2>
            ...
            <div className="mt-6 p-4 bg-white rounded-lg">
              <div className="flex items-center gap-2 text-green-700">
                ...
                <span className="font-semibold">
                  Fee: Rs 45,000 - Rs 65,000/year | Scholarship up to 50%
                </span>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-green-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-green-100 mb-8">
            Small batches, expert faculty, affordable fees. Scholarship available!
          </p>
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 3,
                name: 'Fee Comparison',
                item: 'https://cerebrumbiologyacademy.com/neet-coaching-fee-gurugram',
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              'NEET coaching fees in Gurugram range from Rs 25,000 to Rs 3,50,000 per year.',
            speakable: {
