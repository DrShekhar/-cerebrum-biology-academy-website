...
const connaughtPlaceAreas = [
  { name: 'Connaught Place', distance: '6 km', landmark: 'Central Business Hub' },
  { name: 'Barakhamba Road', distance: '6 km', landmark: 'Book Center Area' },
  { name: 'Janpath', distance: '7 km', landmark: 'Shopping District' },
  { name: 'Mandi House', distance: '6 km', landmark: 'Cultural Center' },
  { name: 'Rajiv Chowk', distance: '5 km', landmark: 'Metro Hub' },
  { name: 'Patel Nagar', distance: '8 km', landmark: 'Educational Zone' },
  { name: 'Karol Bagh', distance: '9 km', landmark: 'Shopping Area' },
  { name: 'New Delhi', distance: '7 km', landmark: 'Railway Station' },
]
...
const whyChooseUs = [
  ...
  {
    icon: Target,
    title: 'Central Delhi Landmark',
    description:
      'Central location with excellent metro connectivity. Easy access from all parts of Delhi. Premium environment suited for serious NEET aspirants.',
  },
  {
    icon: GraduationCap,
...
const faqs = [
  ...
  {
    question: 'Can I attend NEET coaching from Connaught Place online?',
    answer:
      'Yes. Our live online classes are flexible for Connaught Place students. You get full recorded lecture access, doubt clearing sessions with AIIMS faculty, and monthly progress reviews - all accessible from CP area.',
  },
]
...
const localBusinessSchema = {
  '@context': 'https://schema.org',
  '@type': 'LocalBusiness',
  name: 'Cerebrum Biology Academy - NEET Coaching Connaught Place',
  description: 'Best NEET Coaching for Connaught Place - Premium School Catchment',
  url: 'https://cerebrumbiologyacademy.com/neet-coaching-connaught-place-delhi',
  ...
  areaServed: ['Connaught Place', 'Barakhamba Road', 'Janpath', 'Mandi House', 'Rajiv Chowk'],
  priceRange: '$$$',
}
    ...
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              ...
              Premium School Hub | AIIMS Faculty
            </div>

            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              NEET Coaching in <span className="text-yellow-400">Connaught Place</span>
            </h1>

            <h2 className="text-xl md:text-2xl opacity-90 mb-4">
              Central Delhi's Landmark Premium Coaching Hub
            </h2>

            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              Premium NEET coaching for Connaught Place, Barakhamba Road, Janpath & nearby areas.
              Learn from <strong>Dr. Shekhar C Singh, AIIMS Alumnus</strong> - trusted by Central
              Delhi's premium schools.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <a
                href="https://wa.me/918826444334?text=Hi%2C%20I%20am%20from%20Connaught%20Place%20and%20interested%20in%20NEET%20coaching"
                target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              Connaught Place & Nearby Areas
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Online NEET coaching for Central Delhi's premium locations
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {connaughtPlaceAreas.map((area, index) => (
              <div
                key={area.name}
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              Why Connaught Place Families Choose Us
            </h2>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              Connaught Place Students, Crack NEET Premium!
            </h2>
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              Central Delhi's landmark NEET coaching for premium schools
            </p>
      ...
      <PricingSection cityName="Connaught Place" />
      <CostComparisonSection cityName="Connaught Place" />
      ...
      <section className="py-12 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/neet-coaching-chandni-chowk-delhi"
              className="bg-white px-6 py-3 rounded-lg shadow hover:shadow-md transition"
            >
              Chandni Chowk NEET Coaching
            </Link>
            <Link
      ...
      <RelatedCityLinks currentCity="connaught-place-delhi" variant="default" />
    </div>
  )
}
