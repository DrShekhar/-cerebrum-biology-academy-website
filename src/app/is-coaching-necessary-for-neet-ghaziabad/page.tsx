...
export const metadata: Metadata = {
  ...
  description:
    'Is coaching necessary for NEET? Expert analysis from Ghaziabad NEET toppers. When coaching helps vs self-study works. Honest advice from AIIMS faculty. Call 88264-44334!',
  keywords: [
    'is coaching necessary for neet',
    'neet coaching vs self study',
    'do i need coaching for neet',
    'neet without coaching ghaziabad',
    'is neet coaching worth it',
    'neet preparation coaching or self study ghaziabad',
  ],
  openGraph: {
    locale: 'en_IN',
    ...
    url: 'https://cerebrumbiologyacademy.com/is-coaching-necessary-for-neet-ghaziabad',
  },
  alternates: {
...
export default function IsCoachingNecessaryForNEETGhaziabad() {
  return (
