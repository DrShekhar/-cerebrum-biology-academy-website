...
export default function PageContent() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <PricingSection cityName="Electronic City" />
      <CostComparisonSection cityName="Electronic City" />
      ...
      <RelatedCityLinks currentCity="electronic-city-bangalore" variant="default" />
    </div>
  )
}
