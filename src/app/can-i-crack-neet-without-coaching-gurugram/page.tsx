...
const selfStudyResources = [
  {
    resource: 'NCERT Biology (Class 11 & 12)',
    purpose: 'Foundation - 90% syllabus coverage',
    mandatory: true,
  },
  {
    resource: 'NCERT Physics & Chemistry',
    purpose: 'Foundation for Physics & Chemistry',
    mandatory: true,
  },
  ...
  {
    resource: 'Aakash and Allen Test Series',
...
const successStories = [
  {
    name: 'Ananya S.',
    score: '685/720',
    method: '100% Self-Study',
    note: 'NCERT + PYQs, 2nd attempt',
  },
  {
    name: 'Rohit M.',
    score: '650/720',
    method: 'Self-Study + Test Series',
    note: 'Used Aakash test series only',
  },
  {
    name: 'Priya K.',
    score: '640/720',
    method: 'Online + Self-Study',
    note: 'PW videos + self practice',
  },
]
...
const faqs = [
  {
    ...
    answer:
      'Approximately 15-20% of top rankers (AIR under 1000) claim to be primarily self-study. However, many of them had tutors, online courses, or test series - pure self-study is rare among toppers.',
  },
  {
    question: 'How many hours should I study for NEET without coaching?',
    answer:
      'Without coaching, you need 8-10 hours of focused self-study daily (vs 5-6 hours with coaching). This includes reading, practice, revision, and mock tests.',
  },
  {
    question: 'Can an average student crack NEET without coaching?',
    answer:
      "It's challenging but possible. Average students benefit most from structured coaching. If choosing self-study, join at least a test series and get periodic doubt sessions.",
  },
  {
    question: 'What if I fail without coaching?',
    answer:
      "Don't wait until you fail. If struggling after 3-4 months of self-study, consider joining coaching or at least hybrid support. Our weekend batch is designed for self-study students.",
  },
]
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-purple-100 mb-8">
              Honest analysis with actionable self-study strategy
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-gradient-to-r from-purple-50 to-indigo-50 border-l-4 border-purple-600 p-6 rounded-lg mb-8">
              ...
              <p className="text-lg text-purple-800">
                <strong>Yes, but it's difficult.</strong> About 15-20% of NEET toppers are
                self-study students. Success requires exceptional self-discipline, 8-10 hours daily
                study, strong NCERT foundation, and access to quality test series. Most self-study
                successes are 2nd/3rd attempt students who already scored 550+.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-4">
            {selfStudyResources.map((item, index) => (
              <div
                key={index}
                className={`p-4 rounded-lg border-2 ${item.mandatory ? 'border-purple-500 bg-purple-50' : 'border-gray-200 bg-gray-50'}`}
              >
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-4 text-amber-900 font-semibold">
                  In these cases, consider at least weekend coaching or hybrid support.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-8">
              Middle Ground: Self-Study + Support
            </h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <p className="text-sm text-gray-600">
                  Self-study weekdays, coaching Sat-Sun. Best of both worlds.
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <p className="text-sm text-gray-600">
                  Pay-per-session doubt clearing. ₹500-1000/session.
                </p>
              </div>
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <p className="text-sm text-gray-600">
                  Take mock tests with expert analysis and guidance.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-purple-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-purple-100 mb-8">
            Free counseling session to assess if self-study will work for you.
          </p>
