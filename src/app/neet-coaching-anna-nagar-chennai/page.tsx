...
const features = [
  ...
  alternates: { canonical: 'https://cerebrumbiologyacademy.com/neet-coaching-anna-nagar-chennai' },
    description:
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              Premium NEET Biology coaching for Anna Nagar&apos;s elite schools. 98% success rate,
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {whyAnnaNagar.map((item, index) => (
              <div
                key={item.title}
                className="bg-emerald-50 rounded-xl p-8 border border-emerald-100 animate-fadeInUp"
              >
          ...
          <div
           className="animate-fadeInUp">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              98% success rate, AIIMS faculty, premium small batches. Kilpauk Medical specialists!
            </p>
