...
export const metadata: Metadata = {
  title: 'Best NEET Coaching in Anna Nagar Chennai | East, West',
  description:
  ...
  openGraph: {
    title: 'Best NEET Coaching in Anna Nagar Chennai | Premium Hub',
    description:
  ...
  twitter: {
    ...
    title: 'Best NEET Coaching in Anna Nagar Chennai',
    description:
