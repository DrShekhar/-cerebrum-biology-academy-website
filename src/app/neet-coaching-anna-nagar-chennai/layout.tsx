...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Premium NEET biology coaching in Anna Nagar with 94.2% success rate. AIIMS faculty, small batches. Perfect for North Chennai families.',
  ...
  twitter: {
    ...
    description:
      'Premium NEET biology coaching in Anna Nagar. 94.2% success rate. East, West, Thirumangalam, Mogappair.',
  },
  alternates: {
