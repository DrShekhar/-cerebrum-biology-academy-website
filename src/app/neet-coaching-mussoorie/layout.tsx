...
export const metadata: Metadata = {
  ...
  description:
    'Top NEET biology coaching in Mussoorie for boarding school students. 94.2% success rate, AIIMS faculty. Mall Road, Landour, Library Chowk. Join from any hill station. Book free demo!',
  keywords:
  ...
  openGraph: {
    ...
    description:
      'Top NEET biology coaching in Mussoorie with 94.2% success rate. Perfect for boarding school students.',
  ...
  twitter: {
    ...
    description:
      'Top NEET biology coaching in Mussoorie. 94.2% success rate. Mall Road, Landour. Boarding school specialists.',
  },
  alternates: {
