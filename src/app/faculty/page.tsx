      ...
      <section className="relative py-12 sm:py-16 md:py-20 lg:py-28 bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-900 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
          <div className="text-center">
            ...
            >
              <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20Cerebrum%20faculty.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                <Button
                  variant="primary"
                  size="lg"
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-3">
                    ...
                    <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20Cerebrum%20faculty.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer" className="flex-1">
                      <Button
                        variant="primary"
                        size="sm"
