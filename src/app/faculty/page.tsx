        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center">
            ...
            >
              ...
              MBBS graduates from AIIMS, and industry experts with decades of NEET coaching experience.
            </motion.p>
            ...
            {specializations.map((spec, index) => (
              ...
              >
                <div className="flex items-center mb-6">
                  <div className={`w-16 h-16 ${spec.color} rounded-2xl flex items-center justify-center`}>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Our faculty employs research-backed teaching methodologies that ensure 
                deep conceptual understanding and excellent NEET performance.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Are you a passionate educator with expertise in biology? 
              Join our team of distinguished faculty and shape the future of medical education.
            </p>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-purple-100 mb-8">
            Experience world-class biology education with our expert faculty. 
            Book a demo class and see the difference quality teaching makes.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/contact">
              <Button variant="primary" size="xl" className="bg-white text-purple-600 hover:bg-gray-100">
...
export const metadata = {
  title: 'World-Class Faculty | Expert Biology Teachers | Cerebrum Biology Academy',
  description: 'Meet our expert faculty - PhD holders, MBBS graduates from AIIMS with 15+ years experience. 50+ faculty members specialized in NEET Biology coaching with 98% student satisfaction.',
  keywords: 'biology faculty, NEET teachers, AIIMS faculty, PhD biology teachers, expert coaching staff, medical college faculty, NEET biology experts',
}