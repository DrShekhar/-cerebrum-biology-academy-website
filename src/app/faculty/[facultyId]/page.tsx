...
export default function FacultyProfilePage({ params }: Props) {
  ...
  const relatedFaculty = facultyMembers
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              {faculty.achievements && (
                ...
                >
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">Achievements & Qualifications</h2>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-6">
            Ready to Learn from {faculty.name}?
          </h2>
          <p className="text-xl text-purple-100 mb-8">
            Join our academy and get personalized guidance from expert faculty 
            with proven track records in NEET coaching.
          </p>
