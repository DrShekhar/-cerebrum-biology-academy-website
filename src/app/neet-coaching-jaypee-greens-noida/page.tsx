...
const faqs = [
  {
    ...
    answer:
      'We offer online NEET Biology classes for Jaypee Greens students. Live interactive sessions from your home. For offline classes, our South Extension center is accessible via Noida Expressway (45-50 min).',
  },
  {
    question: 'What is the fee for NEET coaching for Jaypee Greens students?',
    answer:
      'Online Biology: Rs 45,000/year. Hybrid (online + weekend offline): Rs 55,000/year. Full offline at South Extension: Rs 65,000/year.',
  },
  {
    question: 'How do Jaypee Greens students attend classes?',
    answer:
      'Most Jaypee Greens students choose 100% online mode for convenience. Some opt for hybrid mode with weekend visits to South Extension for tests and doubt sessions.',
  },
]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white">
      <NEETSchemaStack
        ...
        pageName="NEET Coaching at Jaypee Greens Noida"
        parentHub={{
          name: 'NEET Biology Coaching India',
          url: 'https://cerebrumbiologyacademy.com/neet-biology-coaching-india',
        }}
        personKnowsAbout={[
          'NEET NEET Coaching at Jaypee Greens Noida',
          'NEET Biology NEET Coaching at Jaypee Greens Noida',
          'Medical entrance coaching NEET Coaching at Jaypee Greens Noida',
        ]}
      />
      {/* Hero */}
      <section className="bg-gradient-to-br from-emerald-800 to-emerald-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            NEET Coaching for Jaypee Greens Students
          </h1>
          <p className="text-xl text-emerald-100 mb-6 max-w-2xl mx-auto">
            Online Biology classes from your home. 55+ Jaypee Greens students enrolled. Hybrid mode
            available.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="tel:+918826444334"
              className="inline-flex items-center gap-2 bg-yellow-500 text-emerald-900 px-6 py-3 rounded-lg font-semibold hover:bg-yellow-400 transition"
            >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <div className="bg-yellow-400 rounded-2xl p-6 relative">
              <span className="absolute top-0 right-0 bg-emerald-800 text-white text-xs font-bold px-3 py-1 rounded-bl-lg">
                RECOMMENDED
              </span>
