...
export const metadata: Metadata = {
  ...
  description:
    'Top NEET biology coaching in Srinagar for Kashmir students. GMC Srinagar focused! 94.2% success rate, AIIMS faculty. Lal Chowk, Rajbagh, Hyderpora. 1,200+ students. Book free demo!',
  keywords:
  ...
  openGraph: {
    ...
    description:
      'Top NEET biology coaching in Srinagar with 94.2% success rate. GMC Srinagar focused! AIIMS faculty, small batches.',
  ...
  twitter: {
    ...
    description:
      'Top NEET biology coaching in Srinagar. GMC focused! 94.2% success rate. Lal Chowk, Rajbagh, Hyderpora.',
  },
  alternates: {
