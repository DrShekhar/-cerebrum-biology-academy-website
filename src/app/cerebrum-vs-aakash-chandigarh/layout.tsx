...
export const metadata: Metadata = {
  title: 'Cerebrum vs Aakash Chandigarh | NEET Biology Comparison',
  description:
    'Compare Cerebrum Biology Academy vs Aakash Chandigarh for NEET preparation. Batch size (10-15 vs 100+), fees (Rs 24K-68K vs Rs 1-3.5 Lakhs), AIIMS faculty, 98% success rate. All 7 Aakash centers compared.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Honest comparison of Cerebrum Biology Academy vs Aakash Chandigarh (7 centers). See why students switch from 100+ batches to personalized 10-15 student coaching with AIIMS faculty.',
  ...
  twitter: {
    ...
    title: 'Cerebrum vs Aakash Chandigarh | NEET Biology Comparison',
    description: 'Compare Cerebrum Biology Academy vs Aakash Chandigarh for NEET preparation.',
  },
  alternates: {
