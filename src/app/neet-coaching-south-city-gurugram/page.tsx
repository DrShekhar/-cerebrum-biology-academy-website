...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'NEET Coaching South City Gurugram | 12 Min Drive',
    description: 'Best NEET coaching near South City Gurugram (Gurgaon). Just 12 min drive to M2K Sector 51. AIIMS faculty, 98% success rate. Perfect for South City 1 & 2 residents. Call 88264-44334!',
  },
}
