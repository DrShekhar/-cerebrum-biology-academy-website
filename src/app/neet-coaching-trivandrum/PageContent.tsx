...
const trivandrumareas = [
  ...
  { name: 'Technopark', distance: '18 km', landmark: 'IT Zone' },
]
...
const whyChooseUs = [
  ...
  {
    icon: Target,
    title: '8,000+ Annual Aspirants',
    description:
      'Strong NEET aspirant population in Trivandrum. Weak local competition - mostly tutor-based coaching. Cerebrum brings structured, premium online classes.',
  },
  {
    icon: Building,
    title: 'Near Top Medical Colleges',
    description:
      'Proximity to Trivandrum Medical College, SUT Royal, and other top institutions. Our coaching aligns with Kerala medical education standards and entrance patterns.',
  },
  {
    icon: GraduationCap,
    title: 'Expert Kerala-Plus Faculty',
    description:
      'AIIMS-trained instructors familiar with Kerala board + CBSE requirements. Specialized approach for both local and national medical college preparation.',
  },
]

const faqs = [
  {
    question: 'Do you have a physical center in Trivandrum?',
    answer:
      'We operate premium online NEET classes for all Trivandrum students - Kowdiar, Pattom, Vazhuthacaud, Thampanoor, Kazhakkoottam, and beyond. Online format provides flexibility for NRI families while maintaining world-class instruction and personalized interactions.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Our Trivandrum students come from Loyola, Holy Angels, Christ Nagar, Arya Central, and other premier institutions. Many follow Kerala curriculum; some attend CBSE schools. We cover both pathways comprehensively.',
  },
  {
...
const localBusinessSchema = {
  ...
  areaServed: ['Trivandrum', 'Kowdiar', 'Pattom', 'Vazhuthacaud', 'Kazhakkoottam'],
  priceRange: '$$',
}
    ...
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Online NEET Coaching in <span className="text-yellow-400">Trivandrum</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <a
                href="https://wa.me/918826444334?text=Hi%2C%20I%20am%20from%20Trivandrum%20and%20interested%20in%20NEET%20coaching"
                target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              Trivandrum & Nearby Localities
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Online NEET coaching accessible from every corner of Trivandrum city
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {trivandrumareas.map((area, index) => (
              <div
                key={area.name}
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              Why Trivandrum Families Choose Cerebrum
            </h2>
          </div>
