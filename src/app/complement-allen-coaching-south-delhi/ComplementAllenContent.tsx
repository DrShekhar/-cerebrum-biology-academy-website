...
const benefits = [
  {
    title: 'One Ring Road Stop Away',
    description:
      'Allen Lajpat Nagar is one Ring Road stop from our D-35 South Extension Part 2 flagship. Practically zero extra commute.',
    icon: MapPin,
  },
  {
...
const testimonials = [
  ...
  },
  {
    ...
    quote:
      'The weekend batch at Cerebrum perfectly complemented my Allen weekday classes. The centres being so close made it so convenient!',
  },
  {
    name: 'Vikram R.',
    score: '598/720',
...
const successStats = [
  ...
  { stat: '1 stop', label: 'On Ring Road from Allen Lajpat Nagar' },
]
...
export default function ComplementAllenContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'complement-allen-coaching-south-delhi',
      message:
        'Hi! I am an Allen student in South Delhi and want to join Cerebrum for extra Biology coaching. Please share the schedule and fees.',
      campaign: 'complement-allen-south-delhi',
    })
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              Don't leave Allen. Keep Physics and Chemistry there, and add focused Biology coaching
              from AIIMS-trained faculty — one Ring Road stop from Allen Lajpat Nagar.
            </p>

            <div className="flex flex-wrap items-center gap-4 mb-8">
              <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-lg text-white">
                <MapPin className="w-5 h-5 text-yellow-400" />
                <span>1 Ring Road Stop from Allen Lajpat Nagar</span>
              </div>
              <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-lg text-white">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeInUp">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Same Part of South Delhi. Zero Extra Commute.
              </h2>
              <p className="text-xl text-blue-100 mb-6">
                Allen's South Delhi centres are at Lajpat Nagar and Kalu Sarai. Lajpat Nagar is just
                one Ring Road stop from our flagship at{' '}
                <strong>D-35, South Extension Part 2</strong> — near AIIMS and South Extension
                Metro.
              </p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  Keep Allen for Physics & Chemistry, add Cerebrum for Biology
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  Attend right after your Allen class — minutes away on Ring Road
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  Easy access for PG students from Ber Sarai, Katwaria Sarai & Lajpat Nagar
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
              ...
              <a href={CONTACT_INFO.centers.southExtension.mapUrl} target="_blank" rel="noopener">
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <Link
              href="/neet-coaching-lajpat-nagar"
              className="bg-gray-50 p-4 rounded-xl hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">NEET Coaching Lajpat Nagar</h3>
              <p className="text-sm text-gray-600">Near Allen Lajpat Nagar</p>
            </Link>
            <Link
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-blue-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Keep Allen for Physics & Chemistry — add Cerebrum as your Biology specialist
          </p>
