      ...
      <section className="relative py-16 bg-gradient-to-r from-blue-700 via-blue-600 to-teal-700 text-white">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-6">
            <Link
              href="https://wa.me/918826444334?text=Hi%20I%20am%20from%20Kuwait%20City%20interested%20in%20NEET%20coaching"
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm">
            ...
            <span className="flex items-center gap-1">
              <CheckCircle className="w-4 h-4" /> 18+ CBSE Schools
            </span>
            <span className="flex items-center gap-1">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-10">
            Why Kuwait City Students Choose Cerebrum
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-xl border border-green-100 bg-green-50">
              ...
              <p className="text-gray-600">
                Classes at 3:30 PM - 7:30 PM AST. Perfect timing after school hours. All sessions
          ...
          {[
            {
              ...
              score: '622/720',
              quote:
                'From Kuwait to a top Indian medical college. The NRI quota guidance from Cerebrum was invaluable.',
              college: 'AIIMS Delhi',
            },
            {
              name: 'Siddharth Jain',
              ...
              score: '608/720',
              quote:
                'The afternoon class timings worked perfectly with my school schedule. Never missed a single live session.',
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 mb-8 text-lg">
            Join Indian students in Kuwait City already preparing with expert AIIMS faculty. Book a
            free demo today.
          </p>
          <Link
            href="https://wa.me/918826444334?text=Hi%20I%20am%20from%20Kuwait%20City%20interested%20in%20NEET%20coaching"
