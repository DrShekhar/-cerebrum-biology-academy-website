...
const features = [
  {
    ...
    alternates: { canonical: 'https://cerebrumbiologyacademy.com/neet-coaching-bandra-mumbai' },
    description:
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto animate-fadeInUp">
            ...
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              Premium NEET Biology coaching for Bandra&apos;s elite schools. 98% success rate, AIIMS
