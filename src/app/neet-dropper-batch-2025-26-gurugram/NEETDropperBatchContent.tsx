...
const programHighlights = [
  { title: 'Previous Attempt Analysis', description: 'Detailed analysis of your NEET attempt to identify weak areas', icon: BarChart3 },
  { title: 'Personalized Strategy', description: 'Custom study plan based on your current level and target score', icon: Target },
  { title: 'Intensive Practice', description: '5000+ questions with detailed solutions and analysis', icon: BookOpen },
  { title: 'Small Batch', description: 'Maximum 20 students per batch for focused attention', icon: Users },
  { title: 'Daily Tests', description: 'Regular testing to track progress and build exam temperament', icon: RefreshCw },
  { title: 'Score Improvement', description: 'Average improvement of 100-150 marks in second attempt', icon: TrendingUp },
]

const improvementPlan = [
  { phase: 'Phase 1: Foundation Reset', duration: 'July - October', description: 'Re-learn concepts from scratch, fill gaps, build strong base', activities: ['Concept clarity sessions', 'NCERT line-by-line', 'Previous mistakes analysis'] },
  { phase: 'Phase 2: Practice Intensive', duration: 'November - February', description: 'Massive question practice, topic-wise tests, weak area focus', activities: ['5000+ questions', 'Weekly full tests', 'Error correction'] },
  { phase: 'Phase 3: Revision & Mock', duration: 'March - May', description: 'Full syllabus revision, mock tests, exam strategy', activities: ['30+ mock tests', 'Time management', 'Last month strategy'] },
]
...
export default function NEETDropperBatchContent({ faqs }: { faqs: FAQ[] }) {
  ...
  return (
    <main className="min-h-screen bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              Your second attempt is your best attempt. Join our specialized dropper program designed to help you
              improve by 100-150 marks. Previous attempt analysis + personalized strategy.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Dropper%20batch%20in%20Gurugram.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer">
                  ...
                  <div className="md:w-3/4">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {phase.activities.map((activity) => (
                        <span key={activity} className="flex items-center gap-2 bg-white/10 px-3 py-1 rounded-full text-sm">
                          <CheckCircle className="w-4 h-4 text-green-400" />{activity}
                        </span>
                      ))}
                    </div>
                  </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between py-3 border-b"><span className="text-slate-600">Duration</span><span className="font-semibold">1 Year (July 2025 - May 2026)</span></div>
                <div className="flex justify-between py-3 border-b"><span className="text-slate-600">Fee Range</span><span className="font-semibold text-green-600">₹90,000 - ₹1,56,000</span></div>
                ...
                <div className="flex justify-between py-3 border-b"><span className="text-slate-600">Tests</span><span className="font-semibold">Daily + Weekly + 50 Mocks</span></div>
                <div className="flex justify-between py-3"><span className="text-slate-600">Target</span><span className="font-semibold text-yellow-600">NEET 2026</span></div>
              </div>
              ...
              <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Dropper%20batch%20in%20Gurugram.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer" className="block mt-6">
      ...
      <NEETToolsWidget title="Free NEET Preparation Tools" subtitle="Analyze your previous attempt with our AI-powered tools" />
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <Link href="/one-year-dropper-course-gurugram" className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md"><h3 className="font-semibold text-teal-600">One Year Dropper Course</h3><p className="text-sm text-gray-600">Intensive program</p></Link>
            <Link href="/neet-coaching-gurugram" className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md"><h3 className="font-semibold text-teal-600">NEET Coaching Gurugram</h3><p className="text-sm text-gray-600">All NEET programs</p></Link>
            ...
            <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Dropper%20batch%20in%20Gurugram.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer" className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md"><h3 className="font-semibold text-teal-600">Book Demo</h3><p className="text-sm text-gray-600">Free counseling</p></Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-slate-900 to-slate-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Dropper%20batch%20in%20Gurugram.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer"><Button variant="secondary" size="xl" className="bg-yellow-500 text-slate-900 hover:bg-yellow-400 font-bold"><Play className="w-5 h-5 mr-2" />Book Free Counseling</Button></Link>
