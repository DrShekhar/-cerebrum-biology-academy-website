...
const WHATSAPP_MESSAGE = encodeURIComponent('Hi! I am interested in biology coaching in Nagpur. Please share details.')
...
const features = [
  { icon: Video, title: 'Live Interactive Classes', description: 'Real-time online coaching for Nagpur students. No commute needed.' },
  { icon: Users, title: 'Small Batches (10-15)', description: 'Personalized attention unlike crowded Nagpur coaching centers.' },
  { icon: Award, title: 'AIIMS Trained Faculty', description: 'Expert doctors and teachers from premier medical institutions.' },
  { icon: BookOpen, title: 'Maharashtra HSC Focus', description: 'Complete biology coaching for HSC boards and NEET.' },
  { icon: Clock, title: 'Flexible Timings', description: 'Morning, afternoon, evening batches. Fit your school schedule.' },
  { icon: Shield, title: 'All Nagpur Covered', description: 'Dharampeth, Civil Lines, Sadar - all served with same quality.' },
]
...
const faqs = [
  { question: 'Why choose online biology coaching over Nagpur coaching centers?', answer: 'Nagpur coaching centers typically have large batches. Our online classes limit to 10-15 students. Save commute time, get personalized attention, achieve same 94.2% success rate with expert faculty.' },
  { question: 'Which areas in Nagpur do you serve?', answer: 'We serve all Nagpur areas including Dharampeth, Civil Lines, Sadar, Sitabuldi, Ramdaspeth, Laxmi Nagar, Manewada, Wardha Road, and surrounding areas. Online live classes accessible from anywhere.' },
  { question: 'What is the fee for NEET coaching in Nagpur?', answer: 'Our comprehensive NEET Biology coaching ranges from Rs 24,000 to Rs 68,000 per year. Competitive pricing with much smaller batches and personalized attention. EMI available.' },
  { question: 'Which medical colleges can Nagpur students target?', answer: 'With strong NEET scores, Nagpur students can target: Government Medical College Nagpur, AIIMS Nagpur (top choice!), Indira Gandhi Medical College, GMC Akola, plus other all-India institutes.' },
  { question: 'Do you cover Maharashtra HSC syllabus?', answer: 'Yes! We cater to English medium students from both CBSE and Maharashtra HSC. Our program bridges HSC syllabus with NCERT for complete NEET preparation.' },
  { question: 'Why is Nagpur good for NEET aspirants?', answer: 'Nagpur is home to AIIMS Nagpur, making it a prime target for local students. With our coaching, you get quality preparation without traveling to Pune or Mumbai coaching hubs.' },
]

const premiumSchools = ['Centre Point School', 'Delhi Public School Nagpur', 'Bhavans BP Vidya Niketan', 'St. Francis de Sales', 'Hislop College', 'St. Xaviers Nagpur', 'Sandipani School', 'RS Mundle Dharampeth Arts']
...
export default function BiologyCoachingNagpurPage() {
  const handleWhatsAppClick = () => {
    if (typeof window !== 'undefined' && (window as any).gtag) {
      ;(window as any).gtag('event', 'whatsapp_click', { event_category: 'conversion', event_label: 'nagpur_biology_page' })
    }
  ...
  return (
    <div className="min-h-screen">
      <CitySchema cityName="Nagpur" citySlug="nagpur" state="Maharashtra" localities={localities.map((l) => l.name)} faqs={faqs} studentCount="580" coordinates={{ lat: '21.1458', lng: '79.0882' }} />
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <motion.div className="text-center max-w-4xl mx-auto" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              <MapPin className="w-5 h-5 mr-2" />Orange City | Central India Hub
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Best <span className="text-[#4ade80]">Biology Coaching in Nagpur</span></h1>
            <h2 className="text-xl md:text-2xl opacity-90 mb-4">Dharampeth | Civil Lines | Sadar | All Nagpur</h2>
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">Premium Biology coaching & NEET tuition for Nagpur students. 94.2% success rate, AIIMS faculty. Target AIIMS Nagpur, GMC. Join 580+ Nagpur students!</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div className="text-center mb-16"><h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">Biology Coaching Across Nagpur</h2></motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div className="text-center mb-16"><h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">Why Nagpur Students Choose Us</h2></motion.div>
      ...
      <section className="py-16 bg-gray-50"><div className="max-w-7xl mx-auto px-4"><div className="bg-white rounded-2xl p-8 shadow-lg"><h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Students from These Nagpur Schools Trust Us</h3><div className="flex flex-wrap justify-center gap-4">{premiumSchools.map((school) => (<span key={school} className="bg-gray-100 text-gray-700 px-4 py-2 rounded-full font-medium">{school}</span>))}</div></div></div></section>

      <VideoTestimonialsSection />

      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div className="text-center mb-16"><h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">FAQs - Biology Coaching Nagpur</h2></motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#1e3a5f] via-[#2d5a87] to-[#3d7ab5] text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}>
            <h2 className="text-3xl md:text-5xl font-bold mb-6">Ready to Excel in Biology & NEET from Nagpur?</h2>
            <p className="text-xl md:text-2xl mb-8 opacity-90">Join 580+ Nagpur students. Target AIIMS Nagpur, GMC. 94.2% success rate!</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Button variant="secondary" size="xl" onClick={handleWhatsAppClick} className="bg-[#25D366] text-white hover:bg-[#20BD5A] flex items-center justify-center gap-2"><MessageCircle className="w-6 h-6" /><span>WhatsApp Us Now</span></Button>
