...
export async function GET() {
  ...
  const mockLeads = [
    ...
    },
    {
      ...
      grade: 'DROPPER',
      city: 'Kota',
      school: 'XYZ Coaching (largest national NEET chain)',
    ...
    },
    {
      ...
      grade: 'CLASS_12',
      city: 'Hyderabad',
      school: 'a leading national educational institution IIT Academy',
    ...
    },
    {
      ...
      grade: 'DROPPER',
      city: 'Pune',
      school: 'other IIT-JEE-first coachings',
    ...
    },
    {
      ...
      grade: 'DROPPER',
      city: 'Surat',
      school: 'other Kota-origin chains',
      stage: 'CONTACTED',
      priority: 'HOT',
      source: 'YouTube',
      interestedCourse: 'NEET Dropper Program',
