...
export async function POST(request: NextRequest) {
  try {
    ...
    if (action === 'transcribe_and_answer' || action === 'transcribe_only') {
      ...
      transcriptionFormData.append('prompt', 'This is a biology student asking questions about NEET preparation, cell biology, genetics, physiology, or other biology topics.')
      ...
      try {
        const ttsResponse = await fetch('https://api.openai.com/v1/audio/speech', {
          ...
          body: JSON.stringify({
            ...
            voice: 'nova', // Clear, friendly voice for education
