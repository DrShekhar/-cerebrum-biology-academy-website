...
const PAGE_URL = 'https://cerebrumbiologyacademy.com/neet-foundation-class-9-indore'

export const metadata: Metadata = {
  title: 'NEET Foundation Class 9 in Indore | AIIMS-Trained Online Live',
  description:
    'NEET Foundation Class 9 in Indore — AIIMS-trained faculty, online live. CBSE / ICSE / State Board + NEET parallel. Serving Vijay Nagar, Palasia, AB Road. From Rs 35,000/year.',
  keywords: [
    'neet foundation class 9 indore',
    'class 9 biology coaching indore',
    'class 9 neet preparation indore',
    'best class 9 foundation indore',
    'online class 9 neet indore',
  ],
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: 'NEET Foundation Class 9 Indore | Cerebrum',
    description: 'NEET Foundation Class 9 in Indore. AIIMS-trained faculty, online live.',
...
const faqs = [
  { question: 'Is Class 9 too early to start NEET preparation in Indore?', answer: 'No — Class 9 is the ideal time to build the Biology foundation that NEET demands. NCERT Class 9 Biology (cell biology, tissues, diversity in organisms) directly maps to NEET syllabus. Starting early gives Indore students a 2-3 year advantage over those who start in Class 11.' },
  ...
  { question: 'What does NEET Foundation Class 9 cost in Indore?', answer: 'Foundation Pursuit: Rs 35,000/year. Foundation Ascent: Rs 50,000/year (bi-weekly 1:1). Foundation Pinnacle: Rs 70,000/year (weekly 1:1). Same pricing pan-India for online live.' },
...
export default function Page() {
  return (
    <main className="min-h-screen bg-white">
      <CerebrumPersonSchema knowsAbout={['NEET Foundation Indore', 'Class 9 Biology Indore', 'Early NEET preparation Madhya Pradesh']} />
      ...
      <section className="bg-gradient-to-br from-emerald-900 to-green-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          <nav className="text-sm text-emerald-300 mb-6" aria-label="Breadcrumb">
            ...
            <span className="text-white">Class 9 Indore</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">NEET Foundation Class 9 in Indore</h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 prose prose-slate max-w-none">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">Why start NEET Foundation in Class 9 from Indore?</h2>
          <p>Class 9 is the ideal entry point for NEET preparation. NCERT Class 9 Biology covers foundational concepts (cell biology, tissues, diversity in living organisms, motion, force) that directly map to high-weightage NEET chapters. Students in Indore who start in Class 9 have a 2-3 year head start over those who begin in Class 11 — this compounds into 50-100 marks of advantage on exam day.</p>
          ...
          <ul>
            ...
            <li><Link href="/neet-foundation-class-10-indore" className="text-blue-600 hover:underline">Foundation Class 10 Indore</Link></li>
