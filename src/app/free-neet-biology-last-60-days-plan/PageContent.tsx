...
import { Phone, Star, CheckCircle, Download, Users, Award, Target } from 'lucide-react'
import Link from 'next/link'

const benefits = [
  'Day-wise revision schedule (60 days)',
  'High-yield topics prioritized',
  'Mock test integration every week',
  'NCERT re-reading schedule',
...
export default function PageContent() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-white to-gray-50">
      {/* Hero */}
      <section className="relative py-16 bg-gradient-to-r from-amber-700 via-amber-600 to-amber-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            NEET Biology Last 60 Days Masterplan
          </h1>
          <p className="text-xl text-amber-100 mb-2">
            Day-wise Revision Strategy for Maximum Score Boost
          </p>
          <p className="text-lg text-amber-200 max-w-2xl mx-auto mb-8">
            The final 60 days before NEET are crucial. This plan maximizes your score with strategic
            revision cycles, mock test integration, and high-yield topic focus.
          </p>
          <Link
            href="https://wa.me/918826444334?text=Hi%20I%20want%20the%20free%20last%2060%20days%20plan"
      ...
      <section className="py-12 max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-4">
          <Link href="/pricing" className="text-amber-600 hover:text-amber-800 font-semibold">
            View Courses &rarr;
          </Link>
          <Link href="/nri-students" className="text-amber-600 hover:text-amber-800 font-semibold">
            NRI Students &rarr;
          </Link>
          <Link
            href="/free-resources"
