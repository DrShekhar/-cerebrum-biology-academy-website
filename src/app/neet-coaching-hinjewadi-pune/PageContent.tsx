        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              Exclusive NEET coaching for Hinjewadi and Rajiv Gandhi IT Park residents. Learn from{' '}
              <strong>Dr. Shekhar C Singh, AIIMS Alumnus</strong> - trusted by IT families.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <a
                href="https://wa.me/918826444334?text=Hi%2C%20I%20am%20from%20Hinjewadi%20and%20interested%20in%20NEET%20coaching"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Button
