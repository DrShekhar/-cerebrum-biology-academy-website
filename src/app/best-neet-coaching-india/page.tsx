        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto animate-fadeInUp">
            ...
            <h2 className="text-xl md:text-2xl opacity-90 mb-4">
              98% Success Rate • AIIMS Trained Faculty • 15,000+ Students
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20%E2%80%94%20interested%20in%20neet%20coaching%20india.%20Please%20share%20available%20timings."
                target="_blank"
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-sm leading-snug text-slate-700">
                ~22 lakh candidates affected. New exam expected late June / early July 2026. Our 6–8
                week crash course is built for the window — free demo today.
              </p>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="animate-fadeInUp">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I'm%20interested%20in%20neet%20coaching%20india.%20Please%20share%20fee%20structure%20and%20enrolment%20details."
                target="_blank"
                rel="noopener noreferrer"
              >
                <Button
