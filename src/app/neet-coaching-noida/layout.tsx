...
export const metadata: Metadata = {
  title: 'Best NEET Coaching in Noida | Sector 18, 62, 137, 150 | Cerebrum Biology Academy',
  description:
    'Top NEET biology coaching in Noida & Greater Noida. 98% success rate, AIIMS faculty. Best coaching near Gaur City, ATS Pristine, Sector 18, 62, 137. Class 11, 12 & droppers. Book free demo!',
  keywords:
  ...
  openGraph: {
    title: 'Best NEET Coaching in Noida | Sector 18, 62, 137, 150 | Cerebrum Academy',
    description:
