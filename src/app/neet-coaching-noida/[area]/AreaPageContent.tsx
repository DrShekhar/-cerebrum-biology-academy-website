...
export function AreaPageContent({
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gray-50 py-3 border-b">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <Link href="/neet-coaching-noida" className="hover:text-blue-600">
              NEET Coaching Noida
            </Link>
            <span className="mx-2">/</span>
      ...
      {(() => {
        const enrichment = getNoidaEnrichment(slug)
        if (!enrichment) return null
        return (
          <section className="py-10 bg-white border-b border-gray-100">
            <div className="max-w-4xl mx-auto px-4">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
                NEET Biology coaching in {area.name}, Noida
              </h2>
      ...
      <AreaTestimonials citySlug="noida" areaName={area.name} cityName="Noida" />
