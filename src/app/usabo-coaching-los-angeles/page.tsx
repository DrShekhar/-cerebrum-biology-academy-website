...
const faqs = [
  {
    ...
    answer:
      'Classes are 100% live online — no in-person centre in Greater Los Angeles (LA + Orange + Ventura counties + San Diego). The live format means our AIIMS-trained faculty teach the same students from across the metro, scheduled for PT (Pacific) evenings (typically 7-9 PM your local time). Recordings are available if a student misses a session.',
  },
  {
    question: 'Which Los Angeles schools do your students come from?',
    answer:
      'We have repeat enrolments from the high-USABO-density schools in Greater Los Angeles (LA + Orange + Ventura counties + San Diego) — listed above. We also coach students from any US high school; the schools listed are simply the ones where multiple students from the same school have trained with us.',
  },
  {
