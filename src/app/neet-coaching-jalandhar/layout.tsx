...
export const metadata: Metadata = {
  ...
  keywords:
    'NEET coaching Jalandhar, best NEET coaching Jalandhar Punjab, NEET preparation Jalandhar, NEET classes Model Town Jalandhar, biology coaching Jalandhar, medical entrance Jalandhar, NEET 2026 Jalandhar, online NEET coaching Doaba',
  openGraph: {
