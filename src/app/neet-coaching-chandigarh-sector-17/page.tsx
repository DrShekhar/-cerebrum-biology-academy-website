...
const faqs = [
  ...
  { question: 'How much does NEET coaching cost for Sector 17 students?', answer: 'Cerebrum fees: Foundation Rs 24,000/year, Comprehensive Rs 36,000/year, Dropper Rs 68,000/year. Compare to Sector 34: the largest national NEET chain Rs 1.5-2.5 Lakhs, the 2nd-largest national NEET chain Rs 1-3.5 Lakhs. Save 60-70%!' },
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
            {nearbyAreas.map((a, i) => (
              <div key={a.name} className={`p-4 rounded-xl text-center ${a.priority === 'high' ? 'bg-blue-600 text-white' : 'bg-white'}`}>
