...
export const metadata: Metadata = {
  ...
  description:
    'Best biology classes for Sector 73 Gurgaon students. Center in Sector 51 (20 min). AIIMS faculty, 15+ years exp, 98% success. Book demo: 88264-44334!',
  keywords: [
    'biology classes Sector 73 Gurgaon',
    'NEET coaching Sector 73',
