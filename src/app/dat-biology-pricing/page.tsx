...
export const metadata: Metadata = {
  ...
  description:
    'DAT Biology section tutoring pricing — $399 Self-Paced, $799 Small-Batch, $1,249 1:1 Senior Faculty. Compare vs DAT Bootcamp ($595) and Kaplan DAT ($1,599). Biology specialist.',
  keywords: [
    'DAT biology pricing',
    'DAT bio tutor cost',
      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            DAT Biology Pricing | Bio Section Packages
          </h1>
          <p className="text-xl text-slate-300 mb-6 max-w-3xl">
            DAT Biology section tutoring pricing — $399 Self-Paced, $799 Small-Batch, $1,249 1:1
            Senior Faculty. Compare vs DAT Bootcamp ($595) and Kaplan DAT ($1,599). Biology
            specialist.
          </p>
          <a
            href={wa}
              ...
              <tbody>
                <tr className="border-b border-slate-100">
                  ...
                  <td className="py-3 px-4 text-slate-600 text-sm">
                    3–5 months async, Campbell + ADA outline, 200+ questions, WhatsApp support
                  </td>
                </tr>
                <tr className="border-b border-slate-100">
                  ...
                  <td className="py-3 px-4 text-slate-600 text-sm">
                    Weekly 90-min live sessions + monthly section mocks
                  </td>
                </tr>
                <tr className="border-b border-slate-100">
                  ...
                  <td className="py-3 px-4 text-slate-600 text-sm">
                    Weekly 60-min 1:1 + personalised plan + faculty access
                  </td>
                </tr>
                <tr className="border-b border-slate-100">
                  ...
                  <td className="py-3 px-4 text-slate-600 text-sm">
                    Gap-fill, anatomy/physiology deep-dives, pre-test intensive
                  </td>
                </tr>
              </tbody>
            </table>
