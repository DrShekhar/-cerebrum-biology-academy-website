...
const faqs = [
  {
    ...
    answer:
      'We offer online NEET Biology classes for ATS Pristine students. Live interactive sessions from home with instant doubt resolution. For offline preference, our South Extension center is 50 minutes away via expressway.',
  },
  {
    question: 'What is the fee for online NEET coaching for Sector 150 students?',
    answer:
      'Online Biology classes: Rs 45,000/year. Hybrid mode (online + weekend offline at South Extension): Rs 55,000/year. Full offline: Rs 65,000/year.',
  },
  {
    question: 'How many ATS Pristine students are enrolled?',
    answer:
      '45+ students from ATS Pristine and nearby Sector 150 societies are currently enrolled in our online NEET Biology program.',
  },
]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <NEETSchemaStack
        ...
        personKnowsAbout={[
          'NEET NEET Coaching at ATS Pristine Noida',
          'NEET Biology NEET Coaching at ATS Pristine Noida',
          'Medical entrance coaching NEET Coaching at ATS Pristine Noida',
        ]}
      />
      {/* Hero */}
      <section className="bg-gradient-to-br from-blue-800 to-blue-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            NEET Coaching for ATS Pristine Students
          </h1>
          <p className="text-xl text-blue-100 mb-6 max-w-2xl mx-auto">
            Online Biology classes from your Sector 150 home. 45+ students enrolled. Hybrid mode
            with South Extension available.
          </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <div className="bg-yellow-400 rounded-2xl p-6 relative">
              <span className="absolute top-0 right-0 bg-blue-800 text-white text-xs font-bold px-3 py-1 rounded-bl-lg">
                RECOMMENDED
              </span>
      ...
      <section className="py-16 bg-blue-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Start your medical journey with expert guidance
          </p>
          <a
            href="tel:+918826444334"
