...
import { class9SEOPages } from '@/data/seo-landing'

const content = class9SEOPages.onlineBiologyClassesClass9
...
export default function OnlineBiologyClassesClass9Page() {
  return (
    <>
      <script
