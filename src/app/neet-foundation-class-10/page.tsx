  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="animate-fadeInUp">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              ...
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I'm%20interested%20in%20Foundation%20Biology%20(Class%209%2F10).%20Please%20share%20fee%20structure%20and%20enrolment%20details."
                target="_blank"
                rel="noopener noreferrer"
              >
                <Button
      ...
      <section className="py-12 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-6 rounded-2xl border border-fuchsia-200 bg-fuchsia-50 p-6 md:p-8">
            ...
            <Link
              ...
              className="whitespace-nowrap rounded-xl bg-fuchsia-600 px-6 py-3 font-semibold text-white transition hover:bg-fuchsia-700"
            >
