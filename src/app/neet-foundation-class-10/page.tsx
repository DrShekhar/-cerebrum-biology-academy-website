...
export default function NEETFoundationClass10Page() {
  return (
    <div className="min-h-screen">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {advantages.map((advantage, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gradient-to-br from-fuchsia-50 to-pink-50 rounded-xl p-6 border border-pink-100"
              >
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-fuchsia-600 via-pink-600 to-purple-600 text-white">
