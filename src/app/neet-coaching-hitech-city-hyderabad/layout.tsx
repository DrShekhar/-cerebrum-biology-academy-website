...
export const metadata: Metadata = {
  title:
    'Best NEET Coaching in Hitech City Hyderabad | Madhapur, Kukatpally | Cerebrum Academy',
  description:
  ...
  openGraph: {
    ...
    description:
      'Premium NEET biology coaching in Hitech City IT corridor with 94.2% success rate. AIIMS faculty, tech-forward platform. Perfect for IT families.',
  ...
  twitter: {
    ...
    description:
      'Premium NEET biology coaching in Hitech City IT corridor. 94.2% success rate. Madhapur, Kukatpally, KPHB, Miyapur.',
  },
  alternates: {
...
export default function HitechCityHyderabadCoachingLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>
}
