...
export const metadata: Metadata = {
  title: 'Best NEET Coaching in Hitech City Hyderabad | Madhapur, Kukatpally',
  description:
  ...
  openGraph: {
    title: 'Best NEET Coaching in Hitech City Hyderabad | IT Corridor',
    description:
  ...
  twitter: {
    ...
    title: 'Best NEET Coaching in Hitech City Hyderabad',
    description:
