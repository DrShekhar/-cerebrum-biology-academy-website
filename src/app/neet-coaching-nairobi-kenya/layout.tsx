...
export const metadata: Metadata = {
  ...
  description:
    'Expert NEET coaching in Nairobi, Kenya. 98% success rate. Biology-focused curriculum with Dr. Shekhar C Singh. Enroll now!',
  keywords:
    'NEET coaching Nairobi, NEET classes Kenya, biology tuition, medical entrance preparation',
  openGraph: {
    title: 'NEET Coaching in Nairobi, Kenya',
    description:
      'Expert NEET coaching with 98% success rate. Personalized biology curriculum tailored for Kenya students.',
...
export default function Layout({ children }: { children: React.ReactNode }) {
  return <div className="layout-neet-coaching-nairobi-kenya">{children}</div>
}
