...
const courseFeatures = [
  {
    ...
    description: '3 comprehensive cycles covering entire NEET Biology',
    icon: BookOpen,
  },
  {
    title: '5000+ Question Practice',
    description: 'Extensive question bank with detailed solutions',
    icon: FileText,
  },
  {
    title: '30+ Mock Tests',
    description: 'Full-length tests in actual NEET pattern',
    icon: Target,
  },
  {
    title: 'Daily Testing',
    description: 'Topic-wise tests to track daily progress',
    icon: Calendar,
  },
...
export default function OneYearDropperCourseContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      ...
      message:
        'Hi! I am interested in the One Year NEET Dropper Course in Gurugram. Please share complete details.',
  ...
  return (
    <main className="min-h-screen bg-white">
      <nav className="bg-gray-100 py-3 px-4">
        <div className="max-w-7xl mx-auto">
          <ol className="flex items-center flex-wrap gap-1 text-sm">
            ...
            <li className="flex items-center">
              <ChevronRight className="w-4 h-4 text-gray-400 mx-1" />
              <span className="text-teal-700 font-medium">One Year Dropper Course</span>
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              Intensive one-year program designed for complete NEET transformation. 3 revision
              cycles, 5000+ questions, 30+ mocks - everything you need to crack NEET in your next
              attempt.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Dropper%20batch%20in%20Gurugram.%20Please%20share%20available%20timings."
                target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {statistics.map((stat, index) => (
              <div key={stat.label} className="text-center text-white animate-fadeInUp">
            ...
            {syllabusCycles.map((cycle, index) => (
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <span
                    className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold ${cycle.color === 'blue' ? 'bg-blue-600' : cycle.color === 'purple' ? 'bg-purple-600' : 'bg-green-600'}`}
                  >
                    {index + 1}
                  </span>
                  <div>
                ...
                <p
                  className={`text-sm font-medium mb-4 ${cycle.color === 'blue' ? 'text-blue-700' : cycle.color === 'purple' ? 'text-purple-700' : 'text-green-700'}`}
                >
                  {cycle.focus}
                </p>
                <ul className="space-y-2">
                  {cycle.activities.map((activity) => (
                    <li key={activity} className="flex items-center gap-2 text-sm text-slate-600">
                      <CheckCircle
                        className={`w-4 h-4 ${cycle.color === 'blue' ? 'text-blue-500' : cycle.color === 'purple' ? 'text-purple-500' : 'text-green-500'}`}
                      />
                      {activity}
                    </li>
                  ))}
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-xl animate-fadeInUp">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between py-3 border-b">
                  ...
                  <span className="font-semibold text-indigo-600">₹90,000 - ₹1,56,000</span>
                </div>
                <div className="flex justify-between py-3 border-b">
                ...
                <div className="flex justify-between py-3 border-b">
                  ...
                  <span className="font-semibold">50+ Full Tests</span>
                </div>
                <div className="flex justify-between py-3">
                  <span className="text-slate-600">Study Material</span>
                  <span className="font-semibold">Complete Package Included</span>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-8 animate-fadeInUp">
      ...
      <NEETToolsWidget
        ...
        subtitle="Start your preparation with our AI-powered tools"
      />
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            >
              ...
              <p className="text-sm text-gray-600">Upcoming batch</p>
            </Link>
            <Link
            ...
            <Link
              ...
              className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">Gurugram Center</h3>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join our One Year Dropper Course and achieve your dream medical seat
          </p>
