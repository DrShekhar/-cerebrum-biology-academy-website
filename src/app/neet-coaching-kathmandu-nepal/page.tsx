...
export const metadata: Metadata = {
  ...
  description: `Live online NEET Biology coaching for Nepalese and Indian-origin Class 11-12 students in ${city.city}, ${city.country}. Schools we serve: ${city.indianSchools.slice(0, 3).join(', ')}. Batch slot: ${city.localBatchSlot}. Foreign-national + NRI quota guidance for AIIMS / JIPMER / KMC Mangalore. 98% success rate.`,
  keywords: [
