...
export default function NEETCoachingVasantKunjPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero */}
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-teal-900 text-white py-20 overflow-hidden">
      ...
      {/* CTA */}
      <section className="py-20 bg-gradient-to-r from-blue-600 via-blue-700 to-teal-700 text-white">
