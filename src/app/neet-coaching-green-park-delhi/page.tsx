...
export default function NEETCoachingGreenParkPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero */}
      <section className="relative bg-gradient-to-br from-green-900 via-green-800 to-teal-900 text-white py-20 overflow-hidden">
      ...
      {/* CTA */}
      <section className="py-20 bg-gradient-to-r from-green-600 via-green-700 to-teal-700 text-white">
      ...
      <section className="py-12 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link
              href="/biology-classes-hauz-khas"
              className="bg-white px-6 py-3 rounded-lg shadow hover:shadow-md transition"
            >
              Hauz Khas
            </Link>
