    ...
    <main className="bg-white">
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-6 inline-block">
            <span className="bg-red-200 text-red-900 px-6 py-2 rounded-full text-sm font-semibold">
              Trusted by 15,000+ Students
            </span>
          </div>
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Best NEET Coaching for Indian Students in Dhaka
          </h1>
          <p className="text-xl md:text-2xl mb-12 text-red-100">
            Medical Entrance Focus • 98% Success Rate • 695/720 Top Score • Bangladesh-Friendly
            Timing
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            ...
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg border border-white/20">
              ...
              <p className="text-sm text-red-200">5.0/5 Rating</p>
            </div>
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg border border-white/20">
              <Users className="w-8 h-8 mx-auto mb-2 text-yellow-300" />
              <p className="text-sm text-red-200">15,000+ Students</p>
            </div>
            <div className="bg-white/10 backdrop-blur p-6 rounded-lg border border-white/20">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/918826444334?text=Hi%20Cerebrum%21%20I%20want%20to%20join%20NEET%20coaching%20in%20Dhaka"
              target="_blank"
      ...
      >
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-4">
            Why Choose Cerebrum for NEET in Dhaka?
          </h2>
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Specialized coaching for Indian expat students with medical entrance focus and
            Bangladesh-friendly scheduling
          </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Only 30 minutes ahead of India. Classes fit perfectly with Dhaka evening
                    schedule. No early mornings, no late nights. Ideal balance for school and NEET
                    prep.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-red-50 to-orange-50 p-8 rounded-lg border border-red-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Dedicated curriculum for medical entrance exams. We understand both NEET and
                    Bangladesh medical admission patterns. Dual preparation possible.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    ...
                    within minutes. Video calls available for complex medical concepts.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 bg-red-50 p-8 rounded-lg border-l-4 border-red-600">
            <p className="text-gray-700">
              ...
              international schools in Dhaka. Many local schools also have students preparing for
              NEET. Contact us for your specific curriculum.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 text-center mb-12">
            Everything you need to know about NEET coaching in Dhaka
          </p>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-red-900 to-orange-900 text-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-red-100 mb-8">
            Get expert NEET guidance for Dhaka students. Perfect timing, medical focus, free demo
            available now.
          </p>
