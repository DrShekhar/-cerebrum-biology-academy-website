...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'narayana vs cerebrum faridabad',
    'small batch neet coaching',
    'narayana faridabad fees comparison',
    'switch from narayana faridabad',
    'narayana competitor faridabad',
  ...
  twitter: {
    ...
    title: 'Best Narayana Alternative in Faridabad 2026 | Small Batch Personal Attention',
    description:
      'Looking for Narayana alternative in Faridabad? Cerebrum: 25-student batches vs Narayana',
  },
}
...
export default function NarayanaAlternativeFaridabad() {
  return (
