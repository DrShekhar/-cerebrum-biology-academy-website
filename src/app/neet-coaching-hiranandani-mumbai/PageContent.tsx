...
const localBusinessSchema = {
  ...
  description:
    'Best NEET Coaching for Hiranandani - Premium coaching for gated community residents',
...
export default function PageContent() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <PricingSection cityName="Hiranandani" />
      <CostComparisonSection cityName="Hiranandani" />
      ...
      <RelatedCityLinks currentCity="hiranandani-mumbai" variant="default" />
    </div>
  )
}
