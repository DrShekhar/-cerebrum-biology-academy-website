      ...
      <section className="py-12 sm:py-16 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <a
              href="https://wa.me/918826444334?text=Hi!%20I%20am%20on%20your%20Cerebrum%20Vs%20Aakash%20page%20and%20want%20to%20know%20more%20about%20batches%2C%20fees%2C%20and%20admission."
              target="_blank"
