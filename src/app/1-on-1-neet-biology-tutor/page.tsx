...
const config: BestVerticalConfig = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        'Yes — and many serious aspirants do exactly this. Common pattern: students keep their main coaching at Aakash and Allen and online-first generalist platforms or other multi-subject tutoring platforms for Physics/Chemistry and add Cerebrum 1:1 specifically for Biology gap-fill. Ad-hoc hourly tutoring is designed for exactly this use case.',
    },
    {
