...
const materialIncludes = [
  {
    title: 'Theory Notes',
    description: '500+ pages of NCERT-based comprehensive notes with illustrations',
    icon: BookOpen,
    count: '500+ pages',
  },
  {
    title: 'MCQ Bank',
    description: 'Chapter-wise questions with detailed solutions and difficulty levels',
    icon: ClipboardList,
    count: '5000+ MCQs',
  },
  {
    title: 'Previous Year Questions',
    description: 'Complete PYQ collection from 2010-2024 with solutions',
    icon: FileText,
    count: '15 years',
  },
  {
    title: 'Chapter Tests',
    description: 'Practice tests for each chapter with OMR sheets',
    icon: ClipboardList,
    count: '100+ tests',
  },
  {
    title: 'Mock Tests',
    description: 'Full-length tests in NEET pattern with analysis',
    icon: Laptop,
    count: '20 mocks',
  },
  {
    title: 'Diagram Bank',
    description: 'High-quality diagrams and flowcharts for revision',
    icon: Image,
    count: '300+ diagrams',
  },
]
...
const pricingOptions = [
  {
    ...
    features: [
      'All notes in PDF',
      'MCQ bank (PDF + Online)',
      'PYQ PDFs with solutions',
      'Online test access',
      'Diagram bank (high-res)',
      '1 year validity',
    ],
  ...
  },
  {
    ...
    features: [
      'Printed notes (A4 bound)',
      'MCQ book (printed)',
      'PYQ book with solutions',
      'OMR sheets included',
      'Diagram booklet',
  ...
  },
  {
    ...
    features: [
      'Everything in Physical',
      'Everything in Digital',
      'Online test portal access',
      'Doubt support (30 days)',
      'Updates for 1 year',
      'Free sample tests',
    ],
...
const chapters = [
  {
    unit: 'Diversity',
    chapters: ['Living World', 'Biological Classification', 'Plant Kingdom', 'Animal Kingdom'],
  },
  {
  ...
  { unit: 'Genetics & Evolution', chapters: ['Inheritance', 'Molecular Basis', 'Evolution'] },
  {
    ...
    chapters: ['Human Health', 'Biotechnology Principles', 'Biotechnology Applications'],
  },
  {
    unit: 'Ecology',
    chapters: ['Organisms & Environment', 'Ecosystem', 'Biodiversity', 'Environmental Issues'],
  },
]
...
export default function NEETStudyMaterialContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      ...
      message:
        'Hi! I am interested in NEET Biology study material. Please share details about the material packages and how to order.',
    ...
    <main className="min-h-screen bg-white">
      <nav className="bg-gray-100 py-3 px-4">
        <div className="max-w-7xl mx-auto">
          <ol className="flex items-center flex-wrap gap-1 text-sm">
            ...
            <li className="flex items-center">
              <ChevronRight className="w-4 h-4 text-gray-400 mx-1" />
              <span className="text-orange-700 font-medium">Study Material</span>
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              Comprehensive NCERT-based study material with 5000+ MCQs, 15 years of PYQs, and
              chapter-wise tests. Physical or digital - choose what works for you.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            ...
            <p className="text-xl text-slate-600">
              Everything you need for NEET Biology preparation
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            ...
            <p className="text-xl text-slate-600">
              All NCERT chapters with extra focus on high-weightage topics
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-6">
            {chapters.map((unit, index) => (
              <div key={unit.unit} className="bg-white rounded-xl p-6 shadow-sm animate-fadeInUp">
      ...
      <section className="py-16 bg-gradient-to-br from-orange-600 to-red-600 text-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center animate-fadeInUp">
              <Download className="w-12 h-12 text-white mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">Instant Download</h3>
              <p className="text-orange-100 text-sm">
                For digital packages. Get PDF access immediately after payment.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center animate-fadeInUp">
              ...
              <p className="text-orange-100 text-sm">
                Visit our Sector 51 center. Mon-Sat 9 AM - 7 PM. No extra charge.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center animate-fadeInUp">
              ...
              <p className="text-orange-100 text-sm">
                Courier to your address. 3-5 days in Gurugram. ₹200 delivery charge.
              </p>
            </div>
          </div>
        </div>
      ...
      <NEETToolsWidget
        ...
        subtitle="Use our AI-powered tools alongside the study material"
      />
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            >
              ...
              <p className="text-sm text-gray-600">Material included in fee</p>
            </Link>
            <Link
              href="/neet-test-series-gurugram"
              className="bg-white p-4 rounded-xl hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">Test Series</h3>
              <p className="text-sm text-gray-600">Practice with mock tests</p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-gray-600">Digital material included</p>
            </Link>
            <Link href="/resources/free" className="bg-white p-4 rounded-xl hover:shadow-md">
              <h3 className="font-semibold text-teal-600">Free Resources</h3>
              <p className="text-sm text-gray-600">Sample chapters</p>
            </Link>
          </div>
        </div>
      </section>
