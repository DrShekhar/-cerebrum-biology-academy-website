  ...
  testimonials: [
    {
      ...
      quote:
        'Switched from Aakash Class 12 batch (320 students) to Cerebrum Pinnacle in October of Class 12. Genetics went from 60% accuracy to 95% in two months. AIIMS Delhi was the result.',
    },
    {
      name: 'Anika Reddy',
