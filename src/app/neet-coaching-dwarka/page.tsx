...
const faqs = [
  ...
  {
    question: 'How does Cerebrum compare to Allen / Aakash / FIITJEE for Dwarka students?',
    answer:
      'Allen / Aakash / FIITJEE Delhi run combined Physics + Chemistry + Biology batches of 200-400 students with rotating subject faculty (typically ₹1.4L-1.6L/year). Cerebrum is biology-only with 15-20 student batches and continuous AIIMS-trained faculty (₹40K-1.56L/year biology-only). Most strategic Dwarka pattern: Cerebrum biology + PhysicsWallah / Vedantu / Unacademy for PC = total ₹70K-1.1L with materially deeper biology pedagogy than full-Allen at half the all-in cost.',
  },
  {
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-5xl px-4 prose prose-slate max-w-none">
          ...
          <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-4">
            Getting to a Cerebrum centre from Dwarka
          </h2>
          <p>
