...
export const metadata: Metadata = {
  ...
  description:
    'Top NEET biology coaching in Gwalior for MP students. GRMC Gwalior focused! 94.2% success rate, AIIMS faculty. City Centre, Lashkar, Morar. 1,800+ students. Book free demo!',
  keywords:
  ...
  openGraph: {
    ...
    description:
      'Top NEET biology coaching in Gwalior with 94.2% success rate. GRMC Gwalior focused! AIIMS faculty.',
  ...
  twitter: {
    ...
    description:
      'Top NEET biology coaching in Gwalior. GRMC focused! 94.2% success rate. City Centre, Lashkar, Morar.',
  },
  alternates: {
