...
export default function PageContent() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              ...
              <strong>academics and professional families</strong>. Premium online classes with
              recorded lectures and proven 685+ NEET results.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20%E2%80%94%20interested%20in%20coaching%20bodakdev%20ahmedabad.%20Please%20share%20available%20timings."
                target="_blank"
      ...
      <PricingSection cityName="Bodakdev" />
      <CostComparisonSection cityName="Bodakdev" />
