...
const features = [
  {
    ...
    description: 'Quality coaching reaches the mountains',
  },
  {
    icon: Users,
    title: 'Small Batches (10-15)',
    description: 'Personal attention for hill station students',
  },
  { icon: Award, title: 'AIIMS Trained Faculties', description: 'Expert doctors teaching online' },
  {
    icon: BookOpen,
    title: 'HP Board Focus',
    description: 'Coaching for IGMC Shimla and HP medical colleges',
  },
...
const faqs = [
  {
    question: 'Why is online coaching ideal for Manali students?',
    answer:
      'Hill station students cant easily access quality coaching. Our online classes at Rs 24,000-48,000/year bring top faculty to your mountain home.',
  },
  {
    question: 'Which areas do you serve?',
    answer: 'We serve Manali, Old Manali, Kullu, Vashisht, Naggar, and all Kullu Valley areas.',
  },
  { question: 'What is the fee?', answer: 'Rs 24,000 to Rs 48,000 per year with EMI options.' },
  {
    question: 'Do you understand HP Board patterns?',
    answer: 'Yes! Our faculty understand HP Board patterns.',
  },
]

const premiumSchools = [
  'DAV Public School Manali',
  'Government Schools Kullu',
  'Kendriya Vidyalaya',
  'Jawahar Navodaya Vidyalaya',
  'Private Schools Manali',
  'Government Schools Manali',
]
...
export default function NeetCoachingManaliPage() {
  const handleDemoBooking = () => {
    if (typeof window !== 'undefined' && (window as any).gtag) {
      ;(window as any).gtag('event', 'demo_booking_manali', {
        event_category: 'conversion',
        event_label: 'neet_coaching_manali_page',
        value: 1,
      })
    }
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto animate-fadeInUp">
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              ...
              Kullu Valley | Quality Coaching for Mountain Students
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Best <span className="text-yellow-300">NEET Coaching in Manali</span>
            </h1>
            <h2 className="text-xl md:text-2xl opacity-90 mb-4">
              Mall Road | Old Manali | Kullu | Vashisht
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16 animate-fadeInUp">
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
              NEET Coaching Across Kullu Valley
            </h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-teal-50 rounded-xl p-8 border border-teal-100 animate-fadeInUp">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Study from Mountains</h3>
            ...
            <div className="bg-teal-50 rounded-xl p-8 border border-teal-100 animate-fadeInUp">
              ...
              <p className="text-gray-600">Hill students cracking NEET.</p>
            </div>
            <div className="bg-teal-50 rounded-xl p-8 border border-teal-100 animate-fadeInUp">
              <GraduationCap className="w-12 h-12 text-teal-600 mb-4" />
              <h3 className="text-xl font-bold text-gray-900 mb-2">HP Board Expert</h3>
              <p className="text-gray-600">Himachal board specialists.</p>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="animate-fadeInUp">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center mb-12">
              ...
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I'm%20interested%20in%20coaching%20manali.%20Please%20share%20fee%20structure%20and%20enrolment%20details."
                target="_blank"
                rel="noopener noreferrer"
              >
                <Button
