...
export const metadata: Metadata = {
  title: 'Biology Tuition in Noida 2026 | Class 9-12 & NEET | Rs 45,000/year',
  description:
    ...
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <span className="inline-flex items-center gap-2 bg-teal-500 text-white px-4 py-1 rounded-full text-sm font-semibold mb-4">
              <Star className="w-4 h-4" /> Rated 5.0/5 by 15,000+ Students
            </span>
      ...
      <section className="py-16 bg-gradient-to-br from-slate-900 to-slate-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-slate-300 mb-8">Join 15,000+ successful students from Noida</p>
