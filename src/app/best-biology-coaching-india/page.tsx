...
export const metadata: Metadata = {
  title: 'Best Biology Coaching in India 2026 — NEET · IB · AP · MCAT · Olympiads · Cerebrum',
  description:
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="mx-auto max-w-6xl px-4 pt-10 pb-14">
          ...
          <p className="mt-5 text-lg text-slate-600 leading-relaxed max-w-4xl">
            Cerebrum Biology Academy is India&rsquo;s biology-only specialist coaching, founded in
          ...
          <p className="mt-3 text-sm text-slate-500">
            Free 60-minute trial class with Dr. Shekhar. No card required, no pricing pressure.
          </p>
        </section>
          ...
          <div className="mx-auto max-w-6xl px-4 py-12">
            <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-indigo-200">NEET-UG qualification rate</p>
              </div>
              <div>
                <p className="text-4xl font-bold">30+</p>
                <p className="mt-1 text-sm text-indigo-200">Countries served via live online</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-6xl px-4 py-16">
          ...
          <p className="mt-3 text-slate-600 max-w-3xl">
            Pick the programme that matches your child&rsquo;s exam. Each vertical has its own
            dedicated landing with tier matrix, faculty, and curriculum detail.
          </p>
        ...
        <section className="bg-slate-50">
          <div className="mx-auto max-w-4xl px-4 py-16">
            ...
            <p className="mt-4 text-base text-slate-700 leading-relaxed">
              India\&rsquo;s biggest coaching brands &mdash; Allen, Aakash, Resonance, Sri
              Chaitanya, FIITJEE, PW &mdash; are full-PCM (or full-PCMB) coaching brands. They have
              to maintain faculty teams across physics, chemistry, and biology simultaneously. That
              means biology faculty depth is structurally limited because hiring + retaining elite
              biology specialists at scale is expensive when physics + chemistry are also competing
              for the hiring budget. The net result: in mass-coaching biology batches, you get a
              generalist NEET biology curriculum at a batch size of 150-200 students.
            </p>
            <p className="mt-4 text-base text-slate-700 leading-relaxed">
              Cerebrum is structurally different. Every faculty hire we make is biology. Every
              curriculum decision Dr. Shekhar personally reviews. Batch sizes stay small because
              we&rsquo;re not trying to fill physics + chemistry seats too. The depth on biology
              specifically is what wins NEET 360/360 outcomes (Sadhna Sirin 2023), IB HL 7/7
              outcomes, AP score-5 outcomes, and INBO/USABO/BBO olympiad qualifications &mdash; all
              from the same faculty team across cohorts.
            </p>
            <p className="mt-4 text-base text-slate-700 leading-relaxed">
              For families, this means a simple choice: keep your existing full-PCM coaching for
              physics + chemistry, add Cerebrum for biology. We don&rsquo;t replace your
              full-package coaching. We specialise where it matters.
            </p>

            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {[
                {
                  title: 'Biology-only faculty',
                  text: 'Every teacher specialises in biology by career, not by Tuesday/Thursday schedule',
                },
                {
                ...
                },
                {
                  ...
                  text: 'Dr. Shekhar personally reviews syllabus + assessments across all programmes',
                },
                {
                  title: 'NEET + IB + AP + Olympiad parallel',
                  text: 'Same faculty team teaches across these verticals — knowledge cross-pollinates',
                },
              ].map((b) => (
          ...
          <div className="mt-7 grid gap-5 md:grid-cols-2">
            <div className="rounded-xl bg-white p-6 ring-1 ring-slate-200">
              ...
              <ul className="mt-3 space-y-2 text-sm text-slate-700">
                {['South Extension (Delhi)', 'Rohini (Delhi)', 'Gurugram', 'Faridabad'].map((c) => (
