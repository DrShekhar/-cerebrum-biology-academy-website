...
export const metadata: Metadata = {
  ...
  description:
    'Master essential biology definitions for NEET 2027. Comprehensive glossary of 30+ important terms with examples, key points, and NEET relevance. Free study material by Dr. Shekhar C Singh.',
  keywords: [
