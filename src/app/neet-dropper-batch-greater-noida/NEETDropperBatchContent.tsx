...
export default function NEETDropperBatchContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'dropper-batch-2025-greater-noida',
      message:
        'Hi! I am interested in NEET Dropper Batch 2025-26 for Greater Noida. Please share details about the program.',
      campaign: 'dropper-batch-2025-greater-noida',
    })
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              ...
              <span className="block text-yellow-400 mt-2">for Greater Noida</span>
            </h1>
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              ...
              personalized strategy. Online + hybrid classes available for Greater Noida students.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-slate-800 to-slate-700 rounded-2xl p-8 text-white animate-fadeInUp">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold">Nearest Center for Greater Noida</h2>
              </div>
              ...
              <p className="text-slate-300 mb-4">
                ...
                Greater Noida to Noida, then Blue Line to Sector 62
              </p>
              <p className="text-slate-300 mb-4">
                <strong className="text-white">Online Option:</strong> Live Zoom classes with
                recording access - perfect for Greater Noida students
              </p>
              <p className="text-slate-300 mb-6">
                <strong className="text-white">Nearby areas served:</strong> Gaur City, Knowledge
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            <Link
              href="/neet-crash-course-greater-noida"
              className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md"
            >
