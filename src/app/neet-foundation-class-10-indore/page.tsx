...
const wa =
  ...
  encodeURIComponent(
    'Hi — I want to enroll my child (Class 10) in NEET Foundation from Indore. Please share batch details and demo timings.'
  )

const faqs = [
  {
    question: 'Is Class 10 too early to start NEET preparation in Indore?',
    answer:
      'No — Class 10 is the ideal time to build the Biology foundation that NEET demands. NCERT Class 10 Biology (cell biology, tissues, diversity in organisms) directly maps to NEET syllabus. Starting early gives Indore students a 2-3 year advantage over those who start in Class 11.',
  },
  {
  ...
  {
    question: 'What does NEET Foundation Class 10 cost in Indore?',
    answer:
  ...
  {
    question: 'Which Indore schools send students to Cerebrum Foundation?',
    answer:
      'Students from CBSE, ICSE, and state board schools across Vijay Nagar, Palasia, AB Road. The Foundation programme bridges school biology to NEET-level depth.',
  },
]
  ...
  return (
    <main className="min-h-screen bg-white">
      <CerebrumPersonSchema
        knowsAbout={[
          'NEET Foundation Indore',
          'Class 10 Biology Indore',
      ...
      <section className="bg-gradient-to-br from-emerald-900 to-green-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            NEET Foundation Class 10 in Indore
          </h1>
          <p className="text-xl text-emerald-200 mb-6 max-w-3xl">
            Start NEET preparation early from Indore. AIIMS-trained faculty, CBSE / ICSE / State
            Board + NEET parallel, online live sessions. Serving Vijay Nagar, Palasia, AB Road.
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 prose prose-slate max-w-none">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">
            Why start NEET Foundation in Class 10 from Indore?
          </h2>
          <p>
            ...
            force) that directly map to high-weightage NEET chapters. Students in Indore who start
          ...
          <ul>
            ...
            <li>
              <Link
                href="/neet-foundation-class-9-indore"
                className="text-blue-600 hover:underline"
              >
                Foundation Class 9 Indore
              </Link>
            </li>
            <li>
      ...
      <FoundationCityEnrichment slug="indore" classLevel={10} showIntro={false} />
