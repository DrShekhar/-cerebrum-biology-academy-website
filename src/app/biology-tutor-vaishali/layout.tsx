...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'Biology Tutor in Vaishali',
    description: 'Expert NEET Biology coaching in Vaishali.',
  },
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/biology-tutor-vaishali',
  },
}

export default function BiologyTutorVaishaliLayout({ children }: { children: React.ReactNode }) {
  return children
}
