...
export const metadata: Metadata = {
  ...
  description:
    'Top NEET Biology coaching Delhi NCR. 4 centers: South Extension, Rohini, Gurugram, Faridabad. AIIMS Trained faculty, 98% success, 67+ AIIMS selections. Class 11-12 & droppers. FREE demo!',
  keywords:
