...
const geistSans = Geist({
  ...
  subsets: ['latin'],
  display: 'swap', // LCP FIX: 'swap' shows text immediately with fallback, then swaps to Geist (~300ms LCP improvement vs 'optional' which hides text for 7+ seconds on slow networks)
  preload: true,
...
export const metadata: Metadata = {
  ...
  description:
    'Top NEET Biology coaching Delhi NCR. 5 centers: South Extension, Rohini, Green Park, Gurugram, Faridabad. AIIMS-trained faculty, 98% NEET qualification, 67+ AIIMS selections. Class 11-12 & droppers. FREE demo!',
  keywords:
    'NEET biology coaching, NEET coaching India, best NEET coaching Delhi NCR, NEET coaching South Extension, NEET coaching Rohini, NEET coaching Gurugram, NEET coaching Faridabad, NEET coaching Noida, NEET coaching Gurgaon, NEET coaching Dwarka, online NEET coaching India, NEET coaching Kota alternative, NEET coaching Hyderabad, NEET coaching Bangalore, NEET coaching Mumbai, NEET coaching Chennai, AIIMS faculty, biology coaching institute, NEET preparation, medical entrance coaching Delhi, biology classes Delhi, NEET 2027 coaching, online biology coaching, zoology coaching, botany coaching, human physiology, genetics coaching, ecology NEET, best biology teacher India, biology online classes India, NEET crash course, NEET dropper batch, Class 11 biology coaching, Class 12 biology coaching, affordable NEET coaching, small batch NEET coaching, NEET mock tests, NEET study material, NCERT biology NEET, NEET coaching near me, top 10 NEET coaching India, best NEET coaching 2026',
  ...
  openGraph: {
    ...
    description:
      'Top NEET Biology coaching Delhi NCR. AIIMS Trained faculty, 98% success, 67+ AIIMS selections. Class 11-12 & droppers. FREE demo!',
    images: [
      {
        url: '/og-image.jpg',
        width: 1200,
