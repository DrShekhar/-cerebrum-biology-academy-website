...
const faridabadAreas = [
  { name: 'Greater Faridabad', students: '280+', highlight: 'Premium Hub' },
  { name: 'NIT Faridabad', students: '120+', highlight: 'Educational Hub' },
  { name: 'Ballabgarh', students: '180+', highlight: 'Industrial Town' },
  { name: 'Sector 21', students: '150+', highlight: 'Commercial Hub' },
  { name: 'Neharpar', students: '200+', highlight: 'Mega Township' },
  { name: 'Sector 86', students: '110+', highlight: 'BPTP Area' },
]
...
const faqs = [
  {
    question: 'Which is the best biology tuition in Faridabad?',
    answer:
      'Cerebrum Biology Academy is rated the best biology tuition in Faridabad with 98% success rate. We offer specialized biology coaching for Class 9, 10, 11, 12 and NEET droppers. Our AIIMS-trained faculty and small batch sizes ensure personalized attention.',
  },
  {
    question: 'Do you offer biology tuition for Class 9 and 10 in Faridabad?',
    answer:
      'Yes! We offer foundation biology tuition for Class 9 and 10 students in Faridabad. This builds a strong base for future NEET preparation while ensuring excellent board exam results. Students from Greater Faridabad, NIT, and Ballabgarh join our foundation batches.',
  },
  {
    question: 'What are the fees for biology tuition in Faridabad?',
    answer:
  ...
  {
    question: 'Do you provide home tuition for biology in Faridabad?',
    answer:
      'We offer online live classes which are better than home tuition - same personalized attention but with recorded lectures, 24/7 doubt support, and comprehensive study materials. Students from Greater Faridabad, Neharpar, Ballabgarh can attend from home.',
  },
  {
...
export default function BiologyTuitionFaridabadPage() {
  const handleDemoBooking = () => {
    if (typeof window !== 'undefined' && (window as any).gtag) {
      ;(window as any).gtag('event', 'demo_booking_biology_faridabad', {
        event_category: 'conversion',
        event_label: 'biology_tuition_faridabad',
        value: 1,
      })
    }
  }
    ...
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              ...
              #1 Biology Tuition in Faridabad
            </div>
            ...
            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-4xl mx-auto">
              Expert biology coaching for all classes in Greater Faridabad, NIT, Ballabgarh &amp;
              all Faridabad areas. AIIMS faculty, 98% success rate, personalized attention.
            </p>
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center pt-4 border-t">
                    <div>
                      ...
                      <div className="text-lg font-bold text-orange-600">{program.fee}</div>
                    </div>
                    <Link href="/demo-booking">
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Biology Tuition Across Faridabad
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Students from all major Faridabad areas trust us for biology coaching
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {faridabadAreas.map((area, index) => (
              <div
                key={area.name}
                className="bg-orange-50 rounded-xl p-4 text-center border border-orange-100 animate-fadeInUp"
              >
                <MapPin className="w-6 h-6 text-orange-600 mx-auto mb-2" />
                <div className="font-bold text-gray-900">{area.name}</div>
                <div className="text-orange-600 font-semibold text-sm">{area.students}</div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Why Choose Our Biology Tuition in Faridabad
            </h2>
          </div>
          ...
          <div
           className="animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Start Your Biology Journey in Faridabad Today
            </h2>
            <p className="text-xl mb-8 opacity-90">
              Join 1,200+ students. Book your free demo class now!
            </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              'Best biology tuition in Faridabad for Class 9, 10, 11, 12 and NEET droppers. AIIMS faculty, 98% success rate.',
