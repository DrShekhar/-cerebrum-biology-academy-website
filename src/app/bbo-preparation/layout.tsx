...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'BBO tutor near me',
    'BBO tutor UK',
    'biology olympiad tutor near me UK',
    'biology olympiad tutor UK',
    'biology olympiad coaching near me UK',
    'UK biology olympiad',
    'BBO tutoring',
    'Royal Society of Biology',
    'biology olympiad UK',
    'IBO preparation UK',
    'private biology olympiad tutor UK',
    'best biology olympiad tutor UK',
  ],
  twitter: {
