...
export const metadata: Metadata = {
  ...
  description:
    'Comprehensive biology preparation for NEET 2027. AIIMS-trained faculty, complete NCERT coverage, 98% success rate. Join 10,000+ successful students. Book free demo!',
  keywords: [
    'biology for neet',
