...
export const metadata: Metadata = {
  ...
  description:
    'NEET coaching fees in Gurugram range from ₹45,000 to ₹3,00,000. Compare Aakash, Allen, Cerebrum fees. What\'s included, hidden costs, and best value. Call 88264-44334!',
  keywords: [
...
const feeComparison = [
  { institute: 'Large Coaching (Aakash/Allen)', fees: '₹1.5L - ₹3L', batch: '100-200', included: 'Books, Tests', hidden: 'Hostel, Extra courses' },
    ...
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-gradient-to-r from-emerald-50 to-teal-50 border-l-4 border-emerald-600 p-6 rounded-lg mb-8">
              ...
              <p className="text-lg text-emerald-800">
                NEET coaching fees in Gurugram range from <strong>₹45,000 to ₹3,00,000</strong> depending on institute type, course duration, and batch size. Average for quality coaching: <strong>₹80,000 - ₹1,50,000</strong> for a 1-year program. Best value: Small batch coaching with AIIMS faculty at ₹75K-₹1L.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 bg-emerald-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-8">Cerebrum Academy Fees (Best Value)</h2>
      ...
      <section className="py-16 bg-emerald-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-emerald-100 mb-8">Call us for scholarship eligibility and EMI options.</p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link href="/neet-scholarship-gurugram" className="inline-flex items-center gap-2 bg-white/20 text-white px-8 py-3 rounded-lg font-semibold hover:bg-white/30 transition">
