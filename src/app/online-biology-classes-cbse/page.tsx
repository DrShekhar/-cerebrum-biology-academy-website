        ...
        <div className="container relative mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20%E2%80%94%20interested%20in%20online%20biology%20classes%20cbse.%20Please%20share%20available%20timings."
                target="_blank"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {board.uniqueFeatures.map((feature, index) => (
              <div key={index} className="rounded-xl bg-blue-50 p-6 shadow-lg animate-fadeInUp">
