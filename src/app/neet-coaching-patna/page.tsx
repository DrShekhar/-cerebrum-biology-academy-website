...
export default function NEETCoachingPatnaPage() {
  return (
    <>
      <LocalitySchema locality="Patna" slug={slug} pageTitle="Best NEET Coaching in Patna" pageDescription="Top NEET Biology coaching in Patna, Bihar with AIIMS faculty and 98% success rate." pageType="coaching" />
      <PageContent />
    </>
  )
}
