...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Top NEET biology coaching in Patna with 94.2% success rate. No Kota migration needed! AIIMS faculty, small batches. Join 3,000+ Bihar students from Boring Road, Kankarbagh.',
  ...
  twitter: {
    ...
    description:
      'Top NEET biology coaching in Patna. No Kota migration needed! 94.2% success rate. Boring Road, Kankarbagh, Patliputra Colony.',
  },
  alternates: {
