...
const benefits = [
            'Topic-wise PYQ breakdown (2015-2025)',
...
export default function PageContent() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 via-white to-gray-50">
      {/* Hero */}
      <section className="relative py-16 bg-gradient-to-r from-green-700 via-green-600 to-green-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            NEET Biology PYQ Analysis 2015-2025
          </h1>
          <p className="text-xl text-green-100 mb-2">10 Years of Question Papers Analyzed Topic-wise</p>
          <p className="text-lg text-green-200 max-w-2xl mx-auto mb-8">
            Understand NEET question patterns with our comprehensive 10-year analysis. See which topics are repeated, difficulty trends, and what to expect in NEET 2026.
          </p>
          <Link
          ...
          <p className="text-sm text-green-200 mt-3">WhatsApp +91-8826444334 to receive instantly</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-green-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-green-100 mb-8 text-lg">Join 10,000+ NEET aspirants who have already downloaded this resource.</p>
          <Link
            href="https://wa.me/918826444334?text=Hi%20I%20want%20the%20free%20pyq%20analysis"
            className="inline-flex bg-green-500 hover:bg-green-400 text-white px-8 py-4 rounded-lg font-bold text-lg items-center gap-2 transition-colors shadow-lg"
          >
          ...
          <p className="text-sm text-green-200 mt-4">Instant delivery on WhatsApp | 100% Free | No spam</p>
        </div>
      </section>
      ...
      <section className="py-12 max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-4">
          <Link href="/pricing" className="text-green-600 hover:text-green-800 font-semibold">View Courses &rarr;</Link>
          <Link href="/nri-students" className="text-green-600 hover:text-green-800 font-semibold">NRI Students &rarr;</Link>
          <Link href="/free-resources" className="text-green-600 hover:text-green-800 font-semibold">More Free Resources &rarr;</Link>
        </div>
      </section>
    </div>
  )
