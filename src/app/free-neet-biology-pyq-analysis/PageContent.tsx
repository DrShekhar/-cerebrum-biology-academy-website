...
import { Phone, Star, CheckCircle, Download, Users, Award, FileSearch } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 via-white to-gray-50">
      ...
      <section className="relative py-16 bg-gradient-to-r from-green-700 via-green-600 to-green-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-green-100 mb-2">
            10 Years of Question Papers Analyzed Topic-wise
          </p>
      ...
      <section className="py-12 max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-4">
          <Link href="/pricing" className="text-green-600 hover:text-green-800 font-semibold">
            View Courses &rarr;
          </Link>
          <Link href="/nri-students" className="text-green-600 hover:text-green-800 font-semibold">
            NRI Students &rarr;
          </Link>
          <Link
            href="/free-resources"
