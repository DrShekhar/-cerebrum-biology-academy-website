...
const faqData: FAQItem[] = [
  {
    ...
    answer:
      'Yes! Sydney is an official NEET exam center managed by NTA. Students can take NEET directly in Sydney without traveling to India.',
  },
  {
    id: '1',
    question: 'How does NSW HSC integrate with NEET preparation?',
    answer:
      'NEET biology/chemistry covers all HSC topics with deeper depth. Our curriculum aligns perfectly allowing students to excel in both.',
  },
  {
    id: '2',
    question: 'What are the batch timings for Sydney students?',
    answer:
      'Sydney batches: 4:30 AM - 7:30 AM IST (10 PM - 1 AM AEDT previous day) or 6 PM - 9 PM IST (8 AM - 11 AM AEDT) for flexibility.',
  },
  {
    id: '3',
    question: 'Is there a strong Indian community for peer support?',
    answer:
      'Absolutely! 120,000+ Indians in Sydney means vibrant community. We organize monthly study marathons, mentor connections, and wellness sessions.',
  },
  {
    id: '4',
    question: "What's the success rate for Sydney students?",
    answer:
      '98% success with 65+ students securing 600+ marks. Many are now in AIIMS Delhi, AIIMS Hyderabad, and other top colleges.',
  },
  {
    id: '5',
    question: 'Can I work part-time while preparing for NEET?',
    answer:
      'Yes, many Sydney students balance part-time work with NEET prep. Our flexible online format allows this perfectly.',
  },
]
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="border-l-4 border-blue-600 pl-6">
              ...
              <p className="text-gray-700">
                Sydney-specific content aligned with local education boards and timezone
                optimization.
              </p>
            </div>
            <div className="border-l-4 border-blue-600 pl-6">
              ...
              <p className="text-gray-700">
                Join a vibrant Sydney community of NEET aspirants with peer mentorship and study
                groups.
              </p>
            </div>
            <div className="border-l-4 border-blue-600 pl-6">
