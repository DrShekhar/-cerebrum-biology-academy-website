...
const wa =
  ...
  encodeURIComponent(
    'Hi — I want to enroll my child (Class 9) in NEET Foundation from Dehradun. Please share batch details and demo timings.'
  )

const faqs = [
  {
    question: 'Is Class 9 too early to start NEET preparation in Dehradun?',
    answer:
      'No — Class 9 is the ideal time to build the Biology foundation that NEET demands. NCERT Class 9 Biology (cell biology, tissues, diversity in organisms) directly maps to NEET syllabus. Starting early gives Dehradun students a 2-3 year advantage over those who start in Class 11.',
  },
  {
  ...
  {
    question: 'What does NEET Foundation Class 9 cost in Dehradun?',
    answer:
  ...
  {
    question: 'Which Dehradun schools send students to Cerebrum Foundation?',
    answer:
      'Students from CBSE, ICSE, and state board schools across Rajpur Road, Clement Town, ISBT area. The Foundation programme bridges school biology to NEET-level depth.',
  },
]
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <CerebrumPersonSchema
        knowsAbout={[
          'NEET Foundation Dehradun',
          'Class 9 Biology Dehradun',
          'Early NEET preparation Uttarakhand',
        ]}
      />
      ...
      <section className="bg-gradient-to-br from-emerald-900 to-green-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            NEET Foundation Class 9 in Dehradun
          </h1>
          <p className="text-xl text-emerald-200 mb-6 max-w-3xl">
            Start NEET preparation early from Dehradun. AIIMS-trained faculty, CBSE / ICSE / State
            Board + NEET parallel, online live sessions. Serving Rajpur Road, Clement Town, ISBT
            area. Foundation from Rs 35,000/year.
          </p>
          <a
            href={wa}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 prose prose-slate max-w-none">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">
            Why start NEET Foundation in Class 9 from Dehradun?
          </h2>
          <p>
            ...
            force) that directly map to high-weightage NEET chapters. Students in Dehradun who start
            in Class 9 have a 2-3 year head start over those who begin in Class 11 — this compounds
          ...
          <ul>
            ...
            <li>
              <Link
                href="/neet-foundation-class-10-dehradun"
                className="text-blue-600 hover:underline"
              >
                Foundation Class 10 Dehradun
              </Link>
            </li>
            <li>
      ...
      <FoundationCityEnrichment slug="dehradun" classLevel={9} showIntro={false} />
      ...
      <section className="py-16 bg-gradient-to-br from-emerald-600 to-green-600">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Start NEET Foundation from Dehradun
          </h2>
          <a
            href={wa}
