...
const PAGE_URL = 'https://cerebrumbiologyacademy.com/neet-foundation-class-9-dehradun'

export const metadata: Metadata = {
  title: 'NEET Foundation Class 9 in Dehradun | AIIMS-Trained Online Live',
  description:
    'NEET Foundation Class 9 in Dehradun — AIIMS-trained faculty, online live. CBSE / ICSE / State Board + NEET parallel. Serving Rajpur Road, Clement Town, ISBT area. From Rs 35,000/year.',
  keywords: [
    'neet foundation class 9 dehradun',
    'class 9 biology coaching dehradun',
    'class 9 neet preparation dehradun',
    'best class 9 foundation dehradun',
    'online class 9 neet dehradun',
  ],
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: 'NEET Foundation Class 9 Dehradun | Cerebrum',
    description: 'NEET Foundation Class 9 in Dehradun. AIIMS-trained faculty, online live.',
  ...
  twitter: {
    ...
    title: 'NEET Foundation Class 9 in Dehradun | AIIMS-Trained Online Live',
    description: 'NEET Foundation Class 9 in Dehradun — AIIMS-trained faculty, online live. CBSE / ICSE / State Board + NEET parallel. Serving Rajpur Road, Clement Town, ISBT area. From Rs 35,000/year.',
  },
}

const wa = 'https://wa.me/918826444334?text=' + encodeURIComponent("Hi — I want to enroll my child (Class 9) in NEET Foundation from Dehradun. Please share batch details and demo timings.")

const faqs = [
  { question: 'Is Class 9 too early to start NEET preparation in Dehradun?', answer: 'No — Class 9 is the ideal time to build the Biology foundation that NEET demands. NCERT Class 9 Biology (cell biology, tissues, diversity in organisms) directly maps to NEET syllabus. Starting early gives Dehradun students a 2-3 year advantage over those who start in Class 11.' },
  ...
  { question: 'What does NEET Foundation Class 9 cost in Dehradun?', answer: 'Foundation Pursuit: Rs 35,000/year. Foundation Ascent: Rs 50,000/year (bi-weekly 1:1). Foundation Pinnacle: Rs 70,000/year (weekly 1:1). Same pricing pan-India for online live.' },
...
export default function Page() {
  return (
    <main className="min-h-screen bg-white">
      <LocalBusinessSchema />
      <CerebrumPersonSchema knowsAbout={['NEET Foundation Dehradun', 'Class 9 Biology Dehradun', 'Early NEET preparation Uttarakhand']} />
      ...
      <section className="bg-gradient-to-br from-emerald-900 to-green-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          <nav className="text-sm text-emerald-300 mb-6" aria-label="Breadcrumb">
            ...
            <span className="text-white">Class 9 Dehradun</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">NEET Foundation Class 9 in Dehradun</h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 prose prose-slate max-w-none">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">Why start NEET Foundation in Class 9 from Dehradun?</h2>
          <p>Class 9 is the ideal entry point for NEET preparation. NCERT Class 9 Biology covers foundational concepts (cell biology, tissues, diversity in living organisms, motion, force) that directly map to high-weightage NEET chapters. Students in Dehradun who start in Class 9 have a 2-3 year head start over those who begin in Class 11 — this compounds into 50-100 marks of advantage on exam day.</p>
          ...
          <ul>
            ...
            <li><Link href="/neet-foundation-class-10-dehradun" className="text-blue-600 hover:underline">Foundation Class 10 Dehradun</Link></li>
