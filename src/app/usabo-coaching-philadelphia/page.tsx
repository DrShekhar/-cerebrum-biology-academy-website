...
export default function Page() {
  return (
    <USABOCityTemplate
      ...
      faqs={[
        { question: 'Central HS or Masterman students — what level should they start at?', answer: 'Central and Masterman students typically have strong AP Biology foundations. Our USABO coaching extends to Alberts/Lehninger depth for Semifinal targeting. Start in October for the February Open.' },
        { question: 'Main Line private schools — same sessions as city students?', answer: 'Yes — all online. Haverford, Episcopal, Agnes Irwin, and Germantown Academy students join the same ET evening sessions.' },
        { question: 'Cherry Hill NJ students — can they join Philly sessions?', answer: 'Absolutely. All sessions are online — the NJ/PA state line is irrelevant. Cherry Hill students are part of our Philadelphia cohort.' },
        { question: 'How does USABO coaching complement AP Biology?', answer: 'USABO Open overlaps ~70% with AP Biology. The Semifinal requires Alberts-level depth beyond AP. We build on the AP foundation and add olympiad-level molecular biology, genetics, and experimental design.' },
