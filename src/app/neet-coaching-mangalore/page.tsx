...
export default function NEETCoachingMangarlorePage() {
  return (
    <>
      <LocalitySchema locality="Mangalore" slug={slug} pageTitle="Best NEET Coaching in Mangalore" pageDescription="Top NEET Biology coaching in Mangalore, Karnataka with AIIMS faculty and 98% success rate." pageType="coaching" />
      <PageContent />
    </>
  )
}
