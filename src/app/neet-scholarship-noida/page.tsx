...
export const metadata: Metadata = {
  title: 'NEET Scholarship Noida 2026 | Up to 100% Fee Waiver',
  description:
    'Apply for NEET scholarship in Noida. Merit-based scholarships up to 100% fee waiver. Based on 10th/12th marks or scholarship test. Limited seats. Apply now at Cerebrum Biology Academy!',
  keywords: [
    'neet scholarship noida',
    'neet coaching scholarship noida',
    'free neet coaching scholarship',
    'merit scholarship neet noida',
    'neet fee concession noida',
    'scholarship test neet noida',
    'neet coaching financial aid',
    'biology scholarship noida',
  ],
  openGraph: {
    locale: 'en_IN',
    title: 'NEET Scholarship Noida 2026',
    description: 'Merit-based NEET scholarships up to 100% fee waiver. Apply now!',
    url: 'https://cerebrumbiologyacademy.com/neet-scholarship-noida',
  },
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/neet-scholarship-noida',
  },

  twitter: {
    card: 'summary_large_image' as const,
    title: 'NEET Scholarship Noida 2026 | Up to 100% Fee Waiver',
    description: 'Apply for NEET scholarship in Noida. Merit-based scholarships up to 100% fee waiver. Based on 10th/12th marks or scholarship test. Limited seats. Apply now at Cerebrum Biology Academy!',
  },
}
...
const eligibility = [
  ...
  'Noida / NCR residents preferred (online available for others)',
]
...
const faqs = [
  {
    ...
    answer:
      'Students with 75%+ marks in Class 10/11/12 are eligible. Both Noida residents and online students can apply. Scholarship is based on academic merit or performance in our scholarship test.',
  },
  {
...
const testimonials = [
  ...
  },
  {
    ...
    batch: 'Class 11 - 2024 (Lotus Valley Noida)',
    quote: 'Topped the scholarship test and got 100% fee waiver. Best decision of my life!',
  },
]

export default function NEETScholarshipNoida() {
  return (
      ...
      <section className="bg-gradient-to-r from-yellow-600 to-orange-500 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">NEET Scholarship Noida 2026</h1>
            <p className="text-xl text-yellow-100 mb-4">
              Up to 100% fee waiver based on merit! Don&apos;t let finances stop your medical dream.
            </p>
