...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Premium NEET biology coaching in Baner IT corridor with 94.2% success rate. AIIMS faculty, tech-forward platform. Perfect for IT families.',
  ...
  twitter: {
    ...
    title: 'Best NEET Coaching in Baner Pune | Cerebrum Biology Academy',
    description:
      'Premium NEET biology coaching in Baner IT corridor. 94.2% success rate. Hinjewadi, Aundh, Balewadi, Wakad.',
  },
  alternates: {
