...
export default function PageContent() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center mb-12">
              ...
              <a
                href="https://wa.me/918826444334?text=Hi%2C%20I%20am%20from%20Baner%20and%20interested%20in%20NEET%20coaching"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Button
      ...
      <PricingSection cityName="Baner" />
      <CostComparisonSection cityName="Baner" />
      ...
      <RelatedCityLinks currentCity="baner-pune" variant="default" />
    </div>
  )
}
