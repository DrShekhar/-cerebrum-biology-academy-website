...
const WA_LINK =
  'https://wa.me/918826444334?text=Hi%2C%20I%20want%20to%20join%20the%20online%20NEET%20Biology%20class'
    ...
    <>
      ...
      <section className="bg-red-50 py-16">
        <div className="mx-auto max-w-4xl px-4 text-center">
          <h2 className="mb-10 text-3xl font-bold text-slate-900">Who Gets Their Doubt Cleared?</h2>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { name: 'PW', students: '50,000', color: 'border-red-300 bg-red-50' },
              {
                name: 'other multi-subject tutoring platforms',
                students: '200',
        ...
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="space-y-4">
            {[
              ...
              {
                time: '5:05 PM',
                event: 'Concept teaching with NCERT + beyond-NCERT depth',
                icon: '&#128218;',
              },
              {
                time: '5:30 PM',
                event: 'Doubt clearing — teacher calls you by name',
                icon: '&#9995;',
              },
              ...
              {
                time: '6:30 PM',
                event: 'Class ends — recording available in 2 hours',
                icon: '&#127909;',
              },
              {
                time: 'Till 10 PM',
                event: 'WhatsApp doubt support — send photo or voice note',
                icon: '&#128172;',
              },
            ].map((item) => (
              <div
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-xl bg-blue-50 p-8 text-center shadow-lg">
              ...
              <p className="text-sm text-slate-500">
                2-3 hrs/day commute x 300 days = 750 hours back
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-slate-900 py-16 text-white">
        <div className="mx-auto max-w-3xl px-4 text-center">
          <h2 className="mb-4 text-3xl font-bold">We Do Not Let Students Hide</h2>
          <p className="mb-6 text-lg text-slate-300">
            Camera ON is mandatory. The teacher calls you by name. If you zone out, you get called
            on. This is a classroom, not a YouTube stream.
          </p>
          <div className="rounded-xl bg-slate-800 p-8">
            ...
            <p className="text-slate-300">
              Track attendance, test scores, doubt frequency, teacher remarks, and chapter-wise
              progress — all in real-time from your phone.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r from-red-600 to-red-700 py-14 text-center text-white">
        <div className="mx-auto max-w-3xl px-4">
          ...
          <p className="mb-6 text-lg">
            Current batch is almost full. Next batch starts in April 2026.
          </p>
          <Link
            href="/book-free-demo"
      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16 text-center text-white">
        <div className="mx-auto max-w-3xl px-4">
          <h2 className="mb-4 text-3xl font-bold">
            Ready for an Online Class That Actually Works?
          </h2>
          <p className="mb-8 text-lg text-slate-300">
