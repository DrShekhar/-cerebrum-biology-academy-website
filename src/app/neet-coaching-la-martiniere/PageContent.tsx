        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div ref={heroAnim.ref} className={`text-center max-w-4xl mx-auto transition-all duration-700 ${heroAnim.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20%E2%80%94%20interested%20in%20coaching%20la%20martiniere.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer" className="bg-white text-red-700 px-8 py-3 rounded-lg font-semibold hover:bg-red-50 transition-colors inline-flex items-center justify-center">
                Book Free Demo
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {pricingPlans.map((plan, index) => (
              ...
              >
                ...
                <Link href="https://wa.me/918826444334?text=Hi!%20I'm%20interested%20in%20coaching%20la%20martiniere.%20Please%20share%20fee%20structure%20and%20enrolment%20details." target="_blank" rel="noopener noreferrer" className="block bg-red-600 text-white text-center py-2 rounded-lg font-semibold hover:bg-red-700 transition-colors">
                  Enroll Now
                </Link>
              </div>
            ))}
