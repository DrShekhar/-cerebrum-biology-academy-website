  ...
  const faqs = [
    {
      ...
      answer:
        'Yes, NEET is essential for admission to medical colleges in India. Our specialized coaching helps Saudi Arabia students master the NEET curriculum with Saudi Arabia-specific study schedules and exam center support.',
    },
    {
      id: 'faq-2',
      question: 'What is your success rate for Saudi Arabia students?',
      answer:
        'We maintain a 98% success rate for all students including Saudi Arabia NRI students. Many of our students secure admissions in top AIIMS and medical colleges.',
    },
    {
      id: 'faq-3',
      question: 'Do you offer online coaching for students in Saudi Arabia?',
      answer:
        "Yes, we offer both online and hybrid batches with flexible timings suitable for Saudi Arabia's timezone (AST).",
    },
    {
      id: 'faq-4',
      question: 'Can Saudi Arabia students take NEET exam in India?',
      answer:
        'Yes, we provide guidance for NEET exam registration and center allocation. Our exam centers are in Riyadh, Jeddah.',
    },
    {
      id: 'faq-5',
      question: 'What about visa support for medical education?',
      answer: 'Student visa sponsorship support for medical education in India',
    },
    {
      id: 'faq-6',
      question: 'How many students from Saudi Arabia study with us?',
      answer:
        'We have a thriving community of Saudi Arabia students with strong peer networks and regular success stories. Our community includes students from 42 CBSE schools.',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-8">
                Saudi Arabia's oil & gas industry offers excellent opportunities for medical
                graduates. Our coaching helps NRI students balance work, education, and NEET
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {['Riyadh', 'Jeddah', 'Dammam', 'Al Khobar', 'Makkah', 'Madinah', 'Jubail'].map(
              (city) => (
                <div
                  key={city}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              Our specialized curriculum bridges Saudi Arabia's education system with NEET
              requirements. With 42 CBSE schools in Riyadh, Jeddah, Dammam, Al Khobar, we have deep
              expertise in:
            </p>
            <ul className="space-y-3 mb-6">
              <li className="flex items-start">
                ...
                <span className="text-gray-700">
                  Converting Saudi Arabia curriculum to NEET format
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">✓</span>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-blue-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">
            NEET Coaching Plans for Saudi Arabia
          </h2>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Cerebrum is Cost-Effective for Saudi Arabia Students
          </h2>
