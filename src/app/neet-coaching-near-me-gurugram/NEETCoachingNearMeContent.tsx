...
const transportOptions = [
  {
    mode: 'By Car',
    icon: Car,
    details: 'Ample parking available at M2K Corporate Park. Easy access via NH-48 and Sohna Road.',
  },
  {
    mode: 'By Metro',
    icon: Train,
    details:
      'Nearest: Sector 53-54 Metro (2 km). Also accessible from HUDA City Centre and MG Road.',
  },
  {
    mode: 'By Auto/Cab',
    icon: Navigation,
    details:
      'Ola/Uber readily available. Shared autos from major junctions. Approx ₹100-200 from most areas.',
  },
]
...
const whyLocation = [
  {
    ...
    description:
      'Sector 51 is equidistant from all major Gurugram areas - DLF, Sohna Road, MG Road.',
    icon: Compass,
  },
  {
    title: 'Easy Metro Access',
    description: 'Just 2 km from Sector 53-54 Metro Station on Yellow Line.',
    icon: Train,
  },
  {
    title: 'Parking Available',
    description: 'Free parking for students at M2K Corporate Park building.',
    icon: Car,
  },
  {
    title: 'Safe Neighborhood',
    description: 'Located in a commercial hub with 24/7 security and well-lit surroundings.',
    icon: Building,
  },
]
...
export default function NEETCoachingNearMeContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      ...
      message:
        'Hi! I am looking for NEET coaching near me in Gurugram. Please share your location details and how to reach from my area.',
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              Looking for the best NEET coaching near you? Our Sector 51 center is centrally
              located, accessible within 15-20 minutes from all major Gurugram areas.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Why Sector 51 is the Perfect Location
            </h2>
            <p className="text-xl text-teal-100">
              Central position for students from all Gurugram areas
            </p>
          </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            >
              <h3 className="font-semibold text-teal-600">DLF Phase 1</h3>
              <p className="text-sm text-gray-600">8 km from center</p>
            </Link>
            <Link
              href="/neet-coaching-gurugram"
              className="bg-white p-4 rounded-xl hover:shadow-md"
            >
              ...
              <p className="text-sm text-gray-600">5 km from center</p>
            </Link>
            <Link
              href="/neet-coaching-gurugram"
              className="bg-white p-4 rounded-xl hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">Sohna Road</h3>
              <p className="text-sm text-gray-600">4 km from center</p>
            </Link>
            <Link
              href="/neet-coaching-gurugram"
              className="bg-white p-4 rounded-xl hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">All Gurugram Areas</h3>
              <p className="text-sm text-gray-600">View all localities</p>
            </Link>
          </div>
        </div>
      </section>
