...
import NEETTestSeriesGhaziabadContent from './NEETTestSeriesGhaziabadContent'
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'neet biology test series ghaziabad',
    'neet practice tests ghaziabad',
    'neet mock exam ghaziabad',
    'neet test series online ghaziabad',
    'neet rank predictor',
    'best neet test series ghaziabad',
  ],
  openGraph: {
    locale: 'en_IN',
    title: 'NEET Test Series in Ghaziabad | 50+ Mock Tests',
    description:
      'Comprehensive NEET test series with detailed analysis, rank prediction, and performance tracking.',
    url: 'https://cerebrumbiologyacademy.com/neet-test-series-ghaziabad',
  },
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/neet-test-series-ghaziabad',
  },

  twitter: {
    card: 'summary_large_image' as const,
    title: 'NEET Test Series in Ghaziabad | 50+ Mock Tests with Analysis',
    description: 'Join our comprehensive NEET Biology test series for Ghaziabad students. 50+ full-length mock tests, detailed analysis, rank prediction. Online and offline options. Starting ₹8,000.',
  },
}
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Yes! Our test series is available as a standalone product. Many students from the 2nd-largest national NEET chain Indirapuram, Smart Achievers, Gyanmudra, and other institutes join our test series for additional practice and analysis.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes, we provide All India Rank prediction based on your test scores compared to our database of 15,000+ students. Accuracy rate of 90% within ±5000 rank range.',
  },
]

export default function NEETTestSeriesGhaziabadPage() {
  const courseSchema = {
    '@context': 'https://schema.org',
    '@type': 'Course',
    name: 'NEET Biology Test Series - Ghaziabad',
    description:
      'Comprehensive NEET Biology mock test series with 50+ tests, detailed analysis, and rank prediction for Ghaziabad students',
    provider: {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: 'Test Series',
        item: 'https://cerebrumbiologyacademy.com/neet-test-series-ghaziabad',
      },
    ],
  }
  ...
  return (
    <>
      ...
      />
      <NEETTestSeriesGhaziabadContent faqs={faqs} />
    </>
  )
}
