...
const testTypes = [
  {
    ...
    title: 'Chapter Tests',
    count: '20',
    description: 'Topic-wise tests after each chapter',
  },
  {
    icon: FileText,
    title: 'Subject Tests',
    count: '15',
    description: 'Biology full subject tests',
  },
...
export default function NEETTestSeriesGhaziabadContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      ...
      message:
        'Hi! I am interested in the NEET Biology test series in Ghaziabad. Please share the packages and registration details.',
      campaign: 'test-series-ghaziabad',
    })
  }
      ...
      <nav className="bg-gray-100 py-3 px-4">
        <div className="max-w-7xl mx-auto">
          <ol className="flex items-center flex-wrap gap-1 text-sm">
            ...
            <li className="flex items-center">
              <ChevronRight className="w-4 h-4 text-gray-400 mx-1" />
              <span className="text-teal-700 font-medium">Test Series</span>
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              NEET Test Series
              <span className="block text-yellow-400 mt-2">50+ Mock Tests for Ghaziabad</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            ...
            <p className="text-xl text-slate-600">
              Comprehensive test coverage for complete preparation
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            ...
            <p className="text-xl text-slate-600">
              Know exactly where you stand and how to improve
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-slate-600 mb-6">
                  Tests are released weekly. Take them at your convenience with flexible timing
                  options.
                </p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            >
              <h3 className="font-semibold text-teal-600">Crash Course</h3>
            ...
            <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Biology.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer" className="bg-white p-4 rounded-xl hover:shadow-md">
