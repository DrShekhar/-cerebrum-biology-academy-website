...
const chapterWeightage = [
  ...
  {
    chapter: 'Plant & Animal Diversity',
    class: '11',
    weightage: 7,
    questions: 6,
    marks: 24,
...
const preparationStrategy = [
  {
    phase: 'Phase 1 (First 3 months)',
    focus: 'Class 11 basics + Human Physiology',
    chapters: 'Cell Biology, Plant Anatomy, Digestion, Respiration',
  },
  {
    phase: 'Phase 2 (Next 3 months)',
    focus: 'Genetics + Plant Physiology',
    chapters: 'Inheritance, DNA/RNA, Photosynthesis, Mineral Nutrition',
  },
  {
    phase: 'Phase 3 (Next 2 months)',
    focus: 'Ecology + Reproduction',
    chapters: 'Ecosystem, Biodiversity, Human & Plant Reproduction',
  },
  {
    phase: 'Phase 4 (Final 2 months)',
    focus: 'Revision + Mock Tests',
    chapters: 'All high-weightage chapters + Previous Year Questions',
  },
]
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Class 12 Biology is more important with 60% weightage (54 questions). However, Class 11 forms the foundation. Don't skip Class 11 - topics like Cell Biology and Plant Diversity are frequently asked.",
  },
  {
    question: 'How many questions come from NCERT in NEET Biology?',
    answer:
      'About 95% of NEET Biology questions are directly from NCERT or based on NCERT concepts. Read NCERT line-by-line at least 5-7 times. Every diagram, example, and footnote is important.',
  },
  {
    question: 'What is the best strategy for NEET Biology preparation?',
    answer:
      'Strategy: 1) Master NCERT thoroughly, 2) Focus on high-weightage chapters first (Human Physiology, Genetics), 3) Practice 50+ MCQs daily, 4) Solve last 10 years PYQs chapter-wise, 5) Take weekly mock tests.',
  },
]
    ...
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-white">
            ...
            <div className="bg-white/10 backdrop-blur rounded-2xl p-6 border border-white/20">
              ...
              <div className="mt-4 flex items-center gap-2 text-yellow-300">
                ...
                <span className="font-semibold">
                  Total: 90 Questions | 360 Marks | Focus on top 5 chapters = 70% marks
                </span>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-8">
            Based on analysis of last 10 years NEET papers
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-8">
            These 10 topics alone can fetch you 100+ marks
          </p>
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h3 className="font-bold text-xl mb-2">
                  Don't Just Know Weightage - Master the Chapters
                </h3>
                <p className="text-gray-600">
                  At Cerebrum Biology Academy, we don't just teach - we ensure you master every
                  high-weightage chapter with:
                </p>
              </div>
            </div>
      ...
      <section className="py-16 bg-teal-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-teal-100 mb-8">
            AIIMS faculty. Chapter-wise mastery. 98% success rate.
          </p>
