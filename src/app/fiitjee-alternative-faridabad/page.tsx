...
export const metadata: Metadata = {
  ...
  openGraph: {
    locale: 'en_IN',
    title: 'Best other IIT-JEE-first coachings Alternative in Faridabad 2026',
    description:
...
const faqs = [
  {
    question: 'Why consider Cerebrum over other IIT-JEE-first coachings Faridabad?',
    answer:
  ...
  },
  {
    ...
    answer:
      'other IIT-JEE-first coachings Faridabad: ₹1.8-2.5 Lakh/year for integrated programs. Cerebrum: ₹45,000-75,000/year for complete NEET biology coaching. You save ₹1.2-1.75 Lakh while getting specialized biology coaching with better student-teacher ratio.',
  },
  {
  ...
  {
    question: 'What if I am already enrolled in other IIT-JEE-first coachings Faridabad?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Yes, verified difference: other IIT-JEE-first coachings Faridabad has 50-80 students per batch. Cerebrum maintains strict 25-student limit for personal attention. This means 3x more doubt-resolution time per student and better faculty-student interaction.',
  },
  {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <span className="inline-block bg-yellow-500 text-blue-900 px-4 py-1 rounded-full text-sm font-semibold mb-4">
              other IIT-JEE-first coachings Alternative in Faridabad
            </span>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Best other IIT-JEE-first coachings Alternative in Faridabad
            </h1>
