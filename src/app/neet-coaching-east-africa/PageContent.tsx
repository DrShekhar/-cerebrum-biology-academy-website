...
const eastAfricaCountries = [
  {
    ...
    indianPop: '80K+',
    schools: 'Aga Khan, Brookhouse, Braeburn',
  },
  {
    country: 'Tanzania',
    cities: 'Dar es Salaam, Arusha',
    indianPop: '50K+',
    schools: 'IST, Aga Khan Dar, Diamond Jubilee',
  },
  {
    country: 'Uganda',
    cities: 'Kampala, Entebbe',
    indianPop: '30K+',
    schools: 'Aga Khan Kampala, ISU, Delhi Public School',
  },
  { country: 'Rwanda', cities: 'Kigali', indianPop: '5K+', schools: 'Green Hills, Riviera' },
  {
    ...
    cities: 'Addis Ababa',
    indianPop: '8K+',
    schools: 'Indian Community School',
  },
]
      ...
      <section className="relative py-16 bg-gradient-to-r from-orange-700 via-green-700 to-orange-800 text-white">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-orange-100 max-w-2xl mx-auto mb-8">
            Expert AIIMS faculty, EAT timezone classes, IGCSE/Cambridge bridge courses, and complete
            NRI quota admission guidance.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="https://wa.me/918826444334?text=Hi%20I%20am%20from%20East%20Africa%20interested%20in%20NEET%20coaching"
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-8 text-sm">
            <span className="flex items-center gap-1">
              <CheckCircle className="w-4 h-4" /> 170K+ Indian Families
            </span>
            <span className="flex items-center gap-1">
              <CheckCircle className="w-4 h-4" /> 98% Success Rate
            </span>
            <span className="flex items-center gap-1">
              <CheckCircle className="w-4 h-4" /> EAT Timezone Classes
            </span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="bg-orange-50 p-8 rounded-2xl">
            ...
            <p className="text-gray-500 mt-1">
              Same timezone for Kenya, Tanzania, Uganda, Ethiopia
            </p>
            <p className="text-sm text-gray-400 mt-3">
              Weekend batches also available | All classes recorded
            </p>
          </div>
        </div>
      </section>
          ...
          {[
            {
              ...
              score: '612/720',
              quote:
                'From Aga Khan Academy Nairobi to AIIMS. The IGCSE to NCERT bridge course was essential for my preparation.',
              college: 'AIIMS Delhi',
            },
            {
              name: 'Riya Shah',
              ...
              score: '595/720',
              quote:
                'EAT timezone classes at 4:30 PM were perfect. Cerebrum made quality NEET coaching accessible from Tanzania.',
      ...
      <section className="py-16 bg-gradient-to-r from-orange-600 to-green-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-orange-100 mb-8 text-lg">
            Join Indian students from Kenya, Tanzania and Uganda preparing with expert AIIMS
            faculty.
          </p>
          <Link
            href="https://wa.me/918826444334?text=Hi%20I%20am%20from%20East%20Africa%20interested%20in%20NEET%20coaching"
