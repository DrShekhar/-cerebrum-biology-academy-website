...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Yes! Our 98% success rate and 500+ medical college selections prove that online coaching is highly effective. Pune students particularly benefit as they save commute time for self-study. Our interactive live classes, doubt sessions, and AI-powered practice tests ensure comprehensive preparation.',
  },
]
...
export default function NeetCoachingPunePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-600 text-white">
