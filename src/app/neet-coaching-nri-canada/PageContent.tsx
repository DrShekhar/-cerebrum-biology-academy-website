...
const provincialBridgeTopics = [
  {
    province: 'Ontario (Grade 11-12)',
    topics: 'SBI3U/SBI4U to NCERT mapping, human anatomy depth, plant physiology bridge',
  },
  {
    province: 'British Columbia',
    topics: 'Life Sciences 11/12 to NCERT alignment, genetics depth, ecology NEET focus',
  },
  {
    province: 'Alberta',
    topics: 'Biology 20/30 to NCERT curriculum bridge, taxonomy and classification gap',
  },
]

const whyCanadaStudentsChooseNEET = [
  {
    title: 'Extreme Competition',
    desc: 'Canadian med schools have 3-5% acceptance rate. NEET opens a wider pathway.',
  },
  {
    title: 'Cost Advantage',
    desc: 'Indian MBBS costs CAD 30-80K total vs CAD 15-25K per year in Canada.',
  },
  {
    title: 'Quality Education',
    desc: 'Top Indian medical colleges (AIIMS, JIPMER, MAMC) are world-renowned.',
  },
  {
    title: 'Cultural Connection',
    desc: '1.8M Indo-Canadians maintain strong ties with Indian education system.',
  },
  {
    title: 'Global Recognition',
    desc: 'Indian MBBS recognized by WHO, eligible for MCCQE pathway back to Canada.',
  },
  {
    title: 'NRI Quota Seats',
    ...
    <div className="min-h-screen bg-gradient-to-b from-red-50 via-white to-red-50">
      ...
      <section className="relative py-16 bg-gradient-to-r from-red-700 via-red-600 to-red-800 text-white">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-red-100 max-w-2xl mx-auto mb-8">
            Expert AIIMS faculty, EST/PST friendly timings, Ontario/BC/Alberta curriculum bridge
            courses, and complete NRI quota admission guidance.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="https://wa.me/918826444334?text=Hi%20I%20am%20from%20Canada%20interested%20in%20NEET%20coaching"
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-8 text-sm">
            <span className="flex items-center gap-1">
              <CheckCircle className="w-4 h-4" /> 35+ Canadian Students
            </span>
            <span className="flex items-center gap-1">
      ...
      <section className="py-16 max-w-6xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-4">
          Why Indo-Canadian Students Choose NEET
        </h2>
        <p className="text-gray-600 text-center mb-10 max-w-2xl mx-auto">
          With Canadian medical schools accepting only 3-5% of applicants, NEET offers a proven
      ...
      <section className="py-16 max-w-6xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-4">
          Provincial Curriculum Bridge Courses
        </h2>
        <p className="text-gray-600 text-center mb-10 max-w-2xl mx-auto">
          We understand that Ontario, BC, and Alberta biology curricula differ from NCERT. Our
          bridge modules fill every gap.
        </p>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-50 to-red-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-10">
            Class Timings for Canadian Students
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
      ...
      <section className="py-16 bg-gradient-to-r from-red-600 to-red-800 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-red-100 mb-8 text-lg">
            Join 35+ Indo-Canadian students already preparing with us. Book a free demo class today.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="https://wa.me/918826444334?text=Hi%20I%20am%20from%20Canada%20interested%20in%20NEET%20coaching"
              className="bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-lg font-bold text-lg flex items-center gap-2 transition-colors"
            >
