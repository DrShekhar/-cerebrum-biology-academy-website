...
interface NSEBCoachingFaridabadContentProps {
  faqs: FAQ[]
}
...
export default function NSEBCoachingFaridabadContent({ faqs }: NSEBCoachingFaridabadContentProps) {
  const [openFaq, setOpenFaq] = useState<number | null>(null)

  const handleWhatsAppEnquiry = () => {
    trackAndOpenWhatsApp({
      source: 'nseb-faridabad-page',
      message:
        'Hi! I am from Faridabad and interested in NSEB coaching (National Standard Examination in Biology). Please share details about your program.',
      campaign: 'nseb-faridabad',
    })
  }
        ...
        <div className="max-w-7xl mx-auto">
          <ol className="flex items-center flex-wrap gap-1 text-sm">
            ...
            <li className="flex items-center">
              ...
              <Link href="/biology-olympiads" className="text-gray-600 hover:text-teal-600">
                Biology Olympiads
              </Link>
            </li>
            <li className="flex items-center">
              <ChevronRight className="w-4 h-4 text-gray-400 mx-1" />
              <span className="text-teal-700 font-medium">NSEB Coaching Faridabad</span>
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              NSEB Coaching
              <span className="block text-blue-400 mt-2">in Faridabad</span>
            </h1>

            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              Expert coaching for National Standard Examination in Biology (NSEB). Comprehensive
              preparation to qualify for INBO and represent India at IBO. Join our Sector 17,
              Faridabad center.
            </p>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NSEB%20Olympiad%20in%20Faridabad.%20Please%20share%20available%20timings."
                target="_blank"
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white px-6 py-4 rounded-xl font-semibold transition-colors animate-fadeInUp"
              >
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            ...
            <p className="text-xl text-slate-600">Expert preparation at our Faridabad center</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-2xl p-8">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Our Faridabad Center</h2>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <p className="text-gray-700 mb-4">
                  <strong>Address:</strong> {CONTACT_INFO.location.faridabad.streetAddress},{' '}
                  {CONTACT_INFO.location.faridabad.addressLocality} -{' '}
                  {CONTACT_INFO.location.faridabad.postalCode}
                </p>
                <p className="text-gray-700 mb-4">
                  <strong>Landmark:</strong> Above Union Bank, Huda Market — near Bata Chowk Metro
                </p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            >
              <h3 className="font-semibold text-teal-600">Biology Olympiads</h3>
            ...
            <Link
              href="/neet-foundation-class-9-faridabad"
              className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow"
            >
            ...
            <Link
              href="/online-neet-coaching-faridabad"
              className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow"
            >
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-blue-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join our expert coaching in Faridabad and qualify for INBO
          </p>
