...
const PAGE_URL = 'https://cerebrumbiologyacademy.com/neet-coaching-fees-shillong'
export const metadata: Metadata = {
  title: 'NEET Coaching Fees Shillong | Cerebrum',
  description: 'NEET Coaching Fees in Shillong — AIIMS-trained faculty, online live. Serving Laitumkhrah, Police Bazaar, Nongthymmai, Mawlai. From Rs 48,000/yr.',
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-slate-900 to-slate-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          <nav className="text-sm text-slate-400 mb-6" aria-label="Breadcrumb"><Link href="/" className="hover:text-white">Home</Link><span className="mx-2">/</span><Link href="/neet-coaching-shillong" className="hover:text-white">NEET Shillong</Link><span className="mx-2">/</span><span className="text-white">Coaching Fees</span></nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">NEET Coaching Fees in Shillong</h1>
