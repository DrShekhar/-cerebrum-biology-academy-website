...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for Cerebrum Biology Academy - How we collect, use, and protect your personal information.',
}
          ...
          <div className="space-y-8">
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  At Cerebrum Biology Academy, we collect information you provide directly to us, such as when you:
                </p>
                ...
                <p>
                  This information may include your name, email address, phone number, academic details, 
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li><strong>Service Providers:</strong> We may share information with trusted third parties who assist in operating our website and services</li>
                  ...
                  <li><strong>With Consent:</strong> We may share information for other purposes with your explicit consent</li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p>
                  You can control cookie preferences through your browser settings, but some features 
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  Our services are primarily designed for students aged 13 and above. We do not knowingly 
                  collect personal information from children under 13 without parental consent. If we become 
                  aware that we have collected personal information from a child under 13 without parental 
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  ...
                  We ensure that such transfers are made in accordance with applicable data protection 
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  ...
                  Your continued use of our services after such modifications constitutes acceptance of 
                  the updated policy.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <p><strong>Email:</strong> privacy@cerebrumbiologyacademy.com</p>
