...
const features = [
  ...
  },
  {
    ...
    description: 'Exclusive batches for Whitefield IT families with personalized attention.',
  },
  {
    icon: Award,
  ...
  },
  {
    ...
    description: 'IB, IGCSE, Cambridge curriculum specialists for Whitefield schools.',
  },
  {
    icon: Clock,
    title: 'Flexible Timings',
    description: 'Morning, afternoon, evening batches. Perfect for international school schedules.',
  },
  {
    icon: Shield,
    title: 'Zero Commute Stress',
    description: 'No Whitefield traffic hassle. Learn from your premium residence.',
  },
]
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'We serve all Whitefield localities including Whitefield Main, ITPL Area, Brookefield, Kadugodi, Hoodi, Varthur, Marathahalli, Kundalahalli, and all surrounding IT corridor areas. Students from anywhere in East Bangalore can join our online live classes.',
  },
  {
    question: 'What is the fee for premium NEET coaching in Whitefield?',
    answer:
      "Our complete NEET Biology course ranges from Rs 24,000 to Rs 68,000 per year depending on the program chosen. This is competitive with Whitefield's premium coaching centers while offering superior flexibility. EMI options available.",
  },
  {
    question: 'Do you understand international school patterns?',
    answer:
      'Yes! We have specialized batches for international school students (IB, IGCSE, Cambridge). Our faculty understands how to bridge international curriculum with NEET Biology requirements. Many of our Whitefield students are from Inventure Academy, Greenwood High, TISB, and Canadian International School.',
  },
  {
    question: 'What medical colleges can Whitefield students target?',
    answer:
      "With proper NEET preparation, Whitefield students can target top colleges like St. John's Medical College, BMCRI Bangalore, MS Ramaiah, Kempegowda Institute, and all-India institutes like AIIMS and JIPMER.",
  },
  {
    question: 'How does this compare to coaching centers in Koramangala or Indiranagar?',
    answer:
      'Unlike physical coaching centers with 50-100 students per batch, we limit batches to 10-15 students. Every doubt gets addressed. Plus, you save hours on Bangalore traffic daily - no need to travel to coaching hubs.',
  },
]
...
const whyWhitefield = [
  {
    ...
    description:
      'Get world-class NEET coaching without leaving Whitefield. No ORR traffic to coaching hubs.',
  },
  {
    icon: Building,
    title: 'International School Expert',
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Best <span className="text-[#4ade80]">NEET Coaching in Whitefield</span>, Bangalore
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="bg-gray-50 rounded-2xl p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">
              Students from These Whitefield Schools Trust Us
            </h3>
