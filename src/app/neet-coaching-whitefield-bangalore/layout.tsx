...
export const metadata: Metadata = {
  ...
  keywords:
    'NEET coaching Whitefield, best NEET biology coaching Whitefield Bangalore, biology tuition ITPL, NEET classes Brookefield, biology coaching Marathahalli, NEET preparation Bangalore, Whitefield NEET coaching online, international school NEET coaching',
  openGraph: {
    title: 'Best NEET Coaching in Whitefield Bangalore | Biology Classes | Cerebrum Academy',
    description:
