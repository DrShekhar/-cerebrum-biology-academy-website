...
const heroBlurb = "Stuyvesant, Bronx Science, Hunter, and the Long Island powerhouse cluster (Jericho, Great Neck, Roslyn, Syosset, Ward Melville) together produce 30–40 USABO Semifinalists each year. We coach students from all of these schools on a schedule that fits their AP Biology + magnet-program academic load."
const rigourBlurb = "New York students are already over-tutored — what they're missing is olympiad-grade depth. Cerebrum supplies that: AIIMS-trained, biology-only faculty teaching the Indian small-batch tradition. Weekly written feedback on every past-paper. Live ET-evening classes. The same rigour Stuyvesant students put into AMC/USAMO prep, applied to USABO."
const schools = [
  "Stuyvesant HS",
  "Bronx HS of Science",
  "Hunter College HS",
...
const faqs = [
  {
    ...
    "answer": "Classes are 100% live online — no in-person centre in New York City + Nassau + Suffolk + nearby Westchester. The live format means our AIIMS-trained faculty teach the same students from across the metro, scheduled for ET (Eastern) evenings (typically 7-9 PM your local time). Recordings are available if a student misses a session."
  },
  {
    "question": "Which New York City & Long Island schools do your students come from?",
    "answer": "We have repeat enrolments from the high-USABO-density schools in New York City + Nassau + Suffolk + nearby Westchester — listed above. We also coach students from any US high school; the schools listed are simply the ones where multiple students from the same school have trained with us."
  },
  {
    "question": "What's the time commitment for a New York City & Long Island student in 11th or 12th grade?",
  ...
  {
    "question": "How is your USABO coaching different from local New York City & Long Island tutoring?",
