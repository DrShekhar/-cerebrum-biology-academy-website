      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="py-12 md:py-16 bg-slate-50">
          <div className="max-w-3xl mx-auto px-4">
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              Generalist test-prep agencies (Kaplan, The Princeton Review) build their products
              around a single instructor or small team covering all four MCAT sections. That model
              works for CARS and for the chemistry-heavy C/P section because they reward a
              consistent test-taking framework. It works less well for B/B because the integrative
              biology passages reward depth that generalist teaching cannot provide across the
              breadth of MCAT content.
            </p>
            <p className="text-slate-700 leading-relaxed mb-4">
