...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'weekend neet coaching noida',
    'neet classes for school students',
    'part time neet coaching',
    'weekend biology classes noida',
    'neet coaching saturday sunday noida',
...
const faqs = [
  {
    question: 'What are the weekend batch timings in Noida?',
    answer:
...
export default function NEETWeekendBatchNoida() {
  return (
