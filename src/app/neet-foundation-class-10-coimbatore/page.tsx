...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'NEET Foundation Class 10 in Coimbatore | AIIMS-Trained Online Live',
    description: 'NEET Foundation Class 10 in Coimbatore — AIIMS-trained faculty, online live. CBSE / ICSE / Tamil Nadu Board + NEET parallel. Serving RS Puram, Peelamedu, Saibaba Colony. From Rs 35,000/year.',
  },
}

const wa = 'https://wa.me/918826444334?text=' + encodeURIComponent("Hi — I want to enroll my child (Class 10) in NEET Foundation from Coimbatore. Please share batch details and demo timings.")

const faqs = [
  { question: 'Is Class 10 too early to start NEET preparation in Coimbatore?', answer: 'No — Class 10 is the ideal time to build the Biology foundation that NEET demands. NCERT Class 10 Biology (cell biology, tissues, diversity in organisms) directly maps to NEET syllabus. Starting early gives Coimbatore students a 2-3 year advantage over those who start in Class 11.' },
  ...
  { question: 'What does NEET Foundation Class 10 cost in Coimbatore?', answer: 'Foundation Pursuit: Rs 35,000/year. Foundation Ascent: Rs 50,000/year (bi-weekly 1:1). Foundation Pinnacle: Rs 70,000/year (weekly 1:1). Same pricing pan-India for online live.' },
...
export default function Page() {
  return (
    <main className="min-h-screen bg-white">
      <CerebrumPersonSchema knowsAbout={['NEET Foundation Coimbatore', 'Class 10 Biology Coimbatore', 'Early NEET preparation Tamil Nadu']} />
      ...
      <section className="bg-gradient-to-br from-emerald-900 to-green-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">NEET Foundation Class 10 in Coimbatore</h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 prose prose-slate max-w-none">
          ...
          <ul>
            ...
            <li><Link href="/neet-foundation-class-9-coimbatore" className="text-blue-600 hover:underline">Foundation Class 9 Coimbatore</Link></li>
