...
const benefits = [
  ...
  },
  {
    ...
    description: 'Zero travel — join from your Greater Noida home',
    icon: GraduationCap,
  },
  {
...
export default function NEETFoundationClass9GreaterNoidaContent({ faqs }: { faqs: FAQ[] }) {
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              ...
              <span className="block text-green-400 mt-2">in Greater Noida</span>
            </h1>
      ...
      <section className="py-16 bg-gradient-to-br from-green-600 to-teal-600 text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-8 animate-fadeInUp">
            ...
            <p className="text-green-100">We have students from all major schools in Greater Noida</p>
          </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <Link
              href="/neet-foundation-class-10-greater-noida"
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-green-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Start Your NEET Journey from Class 9 in Greater Noida
          </h2>
          <p className="text-xl mb-8 opacity-90">
            Join Cerebrum Biology Academy and get a 4-year head start — online from home
          </p>
