...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'NEET Test Series in Noida | 50+ Mock Tests',
    description:
      'Comprehensive NEET test series with detailed analysis, rank prediction, and performance tracking.',
    url: 'https://cerebrumbiologyacademy.com/neet-test-series-noida',
  },
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/neet-test-series-noida',
  },
}
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Yes! Our test series is available as a standalone product. Many students from Allen, Aakash, Smart Achievers, and other institutes join our test series for additional practice and analysis.',
  },
  {
...
export default function NEETTestSeriesNoidaPage() {
  const courseSchema = {
    '@context': 'https://schema.org',
    '@type': 'Course',
    name: 'NEET Biology Test Series - Noida',
    description:
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: 'Test Series',
        item: 'https://cerebrumbiologyacademy.com/neet-test-series-noida',
      },
    ],
  }
  ...
  return (
    <>
      ...
      />
      <NEETTestSeriesNoidaContent faqs={faqs} />
    </>
  )
}
