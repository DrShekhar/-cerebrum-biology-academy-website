...
export default function NEETTestSeriesNoidaContent({ faqs }: { faqs: FAQ[] }) {
  const [openFaq, setOpenFaq] = useState<number | null>(null)

  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'neet-test-series-noida',
      message:
        'Hi! I am interested in the NEET Biology test series in Noida. Please share the packages and registration details.',
      campaign: 'test-series-noida',
    })
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              NEET Test Series
              <span className="block text-yellow-400 mt-2">50+ Mock Tests in Noida</span>
            </h1>
