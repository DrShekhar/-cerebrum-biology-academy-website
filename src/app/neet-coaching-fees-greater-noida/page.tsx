...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'best neet coaching fees greater noida',
    'cheapest neet coaching greater noida',
    'neet coaching fee comparison greater noida',
    'aakash fees greater noida',
    'neet biology coaching fees greater noida',
  ...
  openGraph: {
    ...
    url: 'https://cerebrumbiologyacademy.com/neet-coaching-fees-greater-noida',
  },
  alternates: {
    canonical: 'https://cerebrumbiologyacademy.com/neet-coaching-fees-greater-noida',
  },
}
...
const feeComparison = [
  ...
  {
    institute: 'WiseTurtle Academy (Greater Noida)',
    class11_12: '60,000-90,000',
    dropper: 'N/A',
    batchSize: '30-50',
    highlight: false,
  },
...
export default function NEETCoachingFeesGreaterNoidaPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              NEET Coaching Fees in Greater Noida
            </h1>
            <p className="text-xl text-blue-100 mb-8">
              Compare fees of all major coaching institutes for Greater Noida students. Find the
              best value for your NEET preparation without overpaying. Online + hybrid classes
              available for Greater Noida students.
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">
            Fee Comparison: NEET Coaching for Greater Noida Students
          </h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            Lower fees, smaller batches, better results. Here&apos;s why Greater Noida students
            choose us.
          </p>
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-teal-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
            ...
            11, 12, and Dropper students from Greater Noida.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link
