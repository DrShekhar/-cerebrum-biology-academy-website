...
export default function NEETCoachingDefenceColonyPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero */}
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-green-900 text-white py-20 overflow-hidden">
      ...
      {/* CTA */}
      <section className="py-20 bg-gradient-to-r from-slate-700 via-slate-800 to-green-800 text-white">
