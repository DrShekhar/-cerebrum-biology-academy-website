...
const defenceColonyAreas = [
  { name: 'Defence Colony', distance: '15 km', landmark: 'Near Defence Colony Club' },
  { name: 'Lajpat Nagar', distance: '14 km', landmark: 'Near Central Market' },
  { name: 'Jangpura', distance: '13 km', landmark: 'Near Bhogal' },
  { name: 'South Extension', distance: '16 km', landmark: 'Part 1 & 2' },
  { name: 'Andrews Ganj', distance: '17 km', landmark: 'Near South Ex' },
  ...
  { name: 'Moolchand', distance: '14 km', landmark: 'Near Metro Station' },
]
...
const faqs = [
  {
    question: 'Do you have a coaching center in Defence Colony?',
    answer:
      'Our main center is in Greater Noida. For Defence Colony students, we offer premium live online NEET classes. Many defence families prefer online classes as parents may have transferable postings. Our comprehensive material and recorded lectures ensure continuity in preparation.',
  },
  {
    question: 'How is your coaching suitable for children of defence personnel?',
    answer:
      'We understand defence families value discipline, structure, and results. Our coaching mirrors these values - fixed schedules, regular tests, progress reports, and result-oriented teaching. Many AFMC aspirants from Defence Colony have trained with us.',
  },
  {
    question: 'What schools do your Defence Colony students come from?',
    answer:
      'We have students from Army Public School, DPS Mathura Road, Springdales Dhaula Kuan, Sanskriti, Sardar Patel Vidyalaya, and Kendriya Vidyalayas. The disciplined environment of these schools complements our rigorous NEET preparation.',
  },
  {
    question: 'Do you prepare students for AFMC along with NEET?',
    answer:
      'Yes! AFMC uses NEET scores for admission. We cover complete NEET syllabus which serves AFMC aspirants perfectly. Many students from defence backgrounds aspire for AFMC and our coaching helps them achieve the required NEET score (650+).',
  },
]
...
const localBusinessSchema = {
  '@context': 'https://schema.org',
  '@type': 'LocalBusiness',
  name: 'Cerebrum Biology Academy - NEET Coaching Defence Colony',
  description: 'Best NEET Coaching for Defence Colony students - Trusted by Defence Families',
...
export default function PageContent() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              ...
              Trusted by Defence Families | AIIMS Faculty
            </div>
            ...
            <h2 className="text-xl md:text-2xl opacity-90 mb-4">
              Best Biology Coaching for South Delhi&apos;s Prestigious Locality
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20NEET%20Biology%20coaching%20in%20Defence%20Colony.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer">
                <Button
                  variant="secondary"
                  size="xl"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                ...
                <div className="text-2xl font-bold">AFMC</div>
                <div className="text-sm opacity-80">Aspirants Trained</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Online NEET coaching for Central-South Delhi students
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              Defence Colony Students, Crack NEET with Discipline!
            </h2>
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              Structured NEET coaching matching the disciplined values of defence families
            </p>
      ...
      <PricingSection cityName="Defence Colony" />
      <CostComparisonSection cityName="Defence Colony" />
      ...
      <RelatedCityLinks currentCity="defence-colony-delhi" variant="default" />
    </div>
  )
}
