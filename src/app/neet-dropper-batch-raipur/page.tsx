...
const cityName = 'Raipur'
const citySlug = 'raipur'
...
export const metadata: Metadata = {
  ...
  keywords: ['neet dropper batch raipur', 'neet repeater course raipur', 'best dropper batch neet raipur'],
  alternates: { canonical: `https://cerebrumbiologyacademy.com/neet-dropper-batch-raipur` },
  openGraph: { title: `NEET Dropper Batch 2026-27 ${cityName}`, url: `https://cerebrumbiologyacademy.com/neet-dropper-batch-raipur`, locale: 'en_IN', type: 'website' },
}
