...
const syllabusTopics = [
  {
    ...
    marks: 23,
    diagrams: ['Human Digestive System', 'Human Heart', 'Nephron'],
  },
  {
    unit: 'Control & Coordination',
    chapters: ['Nervous System', 'Human Brain', 'Hormones', 'Plant Hormones'],
    marks: 12,
    diagrams: ['Human Brain', 'Reflex Arc', 'Neuron'],
  },
  {
    unit: 'Reproduction',
    chapters: ['Asexual Reproduction', 'Sexual Reproduction in Plants', 'Human Reproduction'],
    marks: 12,
    diagrams: ['Flower Structure', 'Male/Female Reproductive System'],
  },
  {
    unit: 'Heredity & Evolution',
    chapters: ["Mendel's Laws", 'Sex Determination', 'Evolution', 'Speciation'],
    marks: 8,
    diagrams: ['Monohybrid Cross', 'Dihybrid Cross'],
  },
  {
    unit: 'Our Environment',
    chapters: ['Ecosystem', 'Food Chains', 'Ozone Depletion', 'Garbage Management'],
    marks: 5,
    diagrams: ['Food Web', 'Ecosystem Components'],
  },
]
...
const features = [
  {
    ...
    description: 'Focus on CBSE & ICSE board exam patterns and marking schemes',
    icon: Trophy,
  },
  {
    title: 'Diagram Practice',
    description: 'Extensive diagram practice - crucial for scoring 90+ in Biology',
    icon: PenTool,
  },
  {
    title: 'NCERT Complete Coverage',
    description: 'Line-by-line NCERT coverage for maximum marks',
    icon: BookOpen,
  },
  {
    title: 'Expert Teachers',
    description: 'Faculty with proven track record of producing toppers',
    icon: Users,
  },
...
export default function Class10BiologyCoachingContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      ...
      message:
        'Hi! I am interested in Class 10 Biology coaching in Gurugram for board exam preparation. Please share details.',
  ...
  return (
    <main className="min-h-screen bg-white">
      <nav className="bg-gray-100 py-3 px-4">
        <div className="max-w-7xl mx-auto">
          <ol className="flex items-center flex-wrap gap-1 text-sm">
            ...
            <li className="flex items-center">
              <ChevronRight className="w-4 h-4 text-gray-400 mx-1" />
              <span className="text-teal-700 font-medium">Class 10 Gurugram</span>
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              Expert coaching for CBSE & ICSE Class 10 board exams. Master diagrams, ace NCERT
              questions, and score 90+ in Biology at our Sector 51, Gurugram center.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20Class%2010%20Biology%20in%20Gurugram.%20Please%20share%20available%20timings."
                target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            ...
            <p className="text-xl text-slate-600">
              Board exam focused preparation with proven results
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            ...
            <p className="text-xl text-slate-600">
              Chapter-wise marks distribution and important diagrams
            </p>
          </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      {topic.chapters.map((chapter) => (
                        <span
                          key={chapter}
                          className="flex items-center gap-1 bg-gray-100 px-3 py-1 rounded-full text-sm text-slate-600"
                        >
                    ...
                    <ul className="text-sm text-slate-600 space-y-1">
                      {topic.diagrams.map((diagram) => (
                        <li key={diagram} className="flex items-center gap-2">
                          <PenTool className="w-3 h-3 text-red-500" />
                          {diagram}
                        </li>
                      ))}
                    </ul>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-8 animate-fadeInUp">
            ...
            <p className="text-orange-100">
              Trusted by students from CBSE & ICSE schools across Gurugram
            </p>
          </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-8 animate-fadeInUp">
              ...
              <div className="space-y-4">
                <div className="flex justify-between py-3 border-b border-orange-100">
                  ...
                  <span className="font-semibold">Class X Foundation (Board)</span>
                </div>
                <div className="flex justify-between py-3 border-b border-orange-100">
                ...
                <div className="flex justify-between py-3 border-b border-orange-100">
                  ...
                  <span className="font-semibold text-orange-600">₹40,000 - ₹60,000/year</span>
                </div>
                <div className="flex justify-between py-3 border-b border-orange-100">
                ...
                <div className="flex justify-between py-3">
                  ...
                  <span className="font-semibold">Materials + Mock Tests</span>
                </div>
              </div>
              <Link
                href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20Class%2010%20Biology%20in%20Gurugram.%20Please%20share%20available%20timings."
      ...
      <NEETToolsWidget
        title="Planning for NEET After Class 10?"
        subtitle="40% of NEET Biology overlaps with Class 10 - start using our tools"
      />
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <Link
              href="/class-9-biology-tuition-gurugram"
              className="bg-gray-50 p-4 rounded-xl hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">Class 9 Biology</h3>
            ...
            >
              ...
              <p className="text-sm text-gray-600">Board + NEET prep</p>
            </Link>
            <Link
            ...
            <Link
              ...
              className="bg-gray-50 p-4 rounded-xl hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">NEET Coaching</h3>
              <p className="text-sm text-gray-600">After Class 10</p>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-orange-600 to-red-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join the best Class 10 Biology coaching in Gurugram
          </p>
