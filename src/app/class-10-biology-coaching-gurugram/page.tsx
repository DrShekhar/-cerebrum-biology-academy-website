...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'icse class 10 biology gurugram',
...
const faqs = [
  {
    question: 'How do you help score high in Class 10 Biology boards?',
    answer:
      'We focus on NCERT mastery, diagram practice, and answering techniques. Regular mock tests and board-pattern papers help students score 90+ in Biology.',
  },
  {
    question: 'What is covered in Class 10 Biology?',
    answer:
      'Complete NCERT: Life Processes, Control & Coordination, How Do Organisms Reproduce, Heredity & Evolution, Our Environment, and Management of Natural Resources.',
  },
  {
    question: 'Is this coaching good for NEET foundation too?',
    answer:
      'Yes! 40% of NEET concepts are introduced in Class 10. Our coaching builds both board exam skills and NEET foundation.',
  },
  {
  ...
  },
  {
    ...
    answer: `At ${gurugramLocation.streetAddress}, same building as Allen Career Institute.`,
  },
]
...
export default function Class10BiologyCoachingGurugramPage() {
  const courseSchema = {
    ...
    '@type': 'Course',
    name: 'Class 10 Biology Coaching - Gurugram',
    description: 'CBSE & ICSE Class 10 Biology coaching for board exams',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        '@type': 'ListItem',
        position: 3,
        name: 'Class 10 Gurugram',
        item: 'https://cerebrumbiologyacademy.com/class-10-biology-coaching-gurugram',
      },
    ],
  }
  ...
  return (
    <>
      <GurgaonGurugramAreaSchema
        spelling="gurugram"
        pageSlug="class-10-biology-coaching-gurugram"
      />
      <script
