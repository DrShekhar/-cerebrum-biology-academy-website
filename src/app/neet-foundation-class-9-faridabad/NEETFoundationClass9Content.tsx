...
export default function NEETFoundationClass9Content({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'foundation-class9-faridabad',
      message:
        'Hi! I am a Class 9 student from Faridabad interested in NEET Foundation course. Please share details.',
      campaign: 'foundation-class9-faridabad',
    })
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              NEET Foundation Class 9<span className="block text-green-400 mt-2">in Faridabad</span>
            </h1>

            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              Start your medical dream journey from Class 9. Build strong biology foundation while
              excelling in board exams. Join our Sector 17, Faridabad center for expert guidance.
            </p>
      ...
      <section className="py-16 bg-gradient-to-br from-green-600 to-teal-600 text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-8 animate-fadeInUp">
            <h2 className="text-3xl font-bold mb-4">Students from Premium Faridabad Schools</h2>
            <p className="text-green-100">We have students from all major schools in Faridabad</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-green-50 to-teal-50 rounded-2xl p-8 animate-fadeInUp">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Our Faridabad Center</h2>
              </div>
              ...
              <p className="text-gray-700 mb-4">
                <strong>Landmark:</strong> Near Bata Chowk Metro (5 min walk)
              </p>
              <p className="text-gray-700 mb-6">
                <strong>Metro:</strong> Bata Chowk Metro (5 min walk)
              </p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <Link
              href="/neet-foundation-class-10-faridabad"
            ...
            <Link
              href="/class-9-biology-tuition-faridabad"
              className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md"
            >
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-green-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Start Your NEET Journey from Class 9
          </h2>
          <p className="text-xl mb-8 opacity-90">
            Join Cerebrum Biology Academy Faridabad and get a 4-year head start
          </p>
