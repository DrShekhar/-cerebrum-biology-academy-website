...
export const metadata: Metadata = {
  ...
  description:
    'Start NEET preparation from Class 9 in Faridabad. 4-year head start, NCERT foundation, board + NEET dual prep. Expert faculty at Sector 17 center. Book free demo.',
  keywords: [
    'neet foundation class 9 faridabad',
    'class 9 neet preparation faridabad',
    'early neet coaching faridabad',
    'neet foundation course class 9',
    'class 9 biology for neet faridabad',
    'neet preparation from class 9',
    '4 year neet preparation faridabad',
  ...
  openGraph: {
    ...
    url: 'https://cerebrumbiologyacademy.com/neet-foundation-class-9-faridabad',
  },
  alternates: {
...
const faqs = [
  ...
  {
    question: 'Where is the Faridabad center located?',
    answer: `Our center is at ${faridabadLocation.streetAddress}, ${faridabadLocation.addressLocality}. We are near Bata Chowk Metro (5 min walk), easily accessible from all Faridabad areas.`,
  },
]

export default function NEETFoundationClass9FaridabadPage() {
  const courseSchema = {
    '@context': 'https://schema.org',
    '@type': 'Course',
    name: 'NEET Foundation Class 9 - Faridabad',
    description:
      'Early NEET preparation program for Class 9 students in Faridabad. 4-year head start with strong conceptual foundation.',
    provider: {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: 'https://cerebrumbiologyacademy.com/neet-foundation-class-9-faridabad',
      },
    ],
  }
