...
const heroBlurb = "Atlanta's North Fulton and Forsyth corridor — Walton, Roswell, Alpharetta, Northview, Lambert — produces the South-East's strongest USABO concentration outside Houston. The Indian-American academic community across Alpharetta, Johns Creek, Cumming, and Suwanee drives consistent Semifinalist representation each year. ET-evening live classes fit AP and dual-enrolment workloads."
const rigourBlurb = "Atlanta families come to Cerebrum because local options are scarce on biology-specialist olympiad coaching — and AIIMS-trained, biology-only faculty teaching with weekly written feedback is genuinely differentiated. The Indian small-batch tradition produces national-tier biology depth; for students at Walton, Northview, Lambert, and Westminster aiming at Emory / Duke / Hopkins / Stanford for STEM, USABO Semifinalist standing is a meaningful credential."
const schools = [
  "Walton HS",
  "Roswell HS",
  "Alpharetta HS",
...
const faqs = [
  {
    ...
    "answer": "Classes are 100% live online — no in-person centre in Greater Atlanta (Fulton + Cobb + Gwinnett + Forsyth counties). The live format means our AIIMS-trained faculty teach the same students from across the metro, scheduled for ET (Eastern) evenings (typically 7-9 PM your local time). Recordings are available if a student misses a session."
  },
  {
    "question": "Which Atlanta schools do your students come from?",
    "answer": "We have repeat enrolments from the high-USABO-density schools in Greater Atlanta (Fulton + Cobb + Gwinnett + Forsyth counties) — listed above. We also coach students from any US high school; the schools listed are simply the ones where multiple students from the same school have trained with us."
  },
  {
