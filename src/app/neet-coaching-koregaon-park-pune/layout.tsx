...
export const metadata: Metadata = {
  title: 'Best NEET Coaching in Koregaon Park Pune | Kalyani Nagar, Viman Nagar',
  description:
    "Premium NEET biology coaching in Koregaon Park, Pune's elite address. 98% success rate, AIIMS faculty. KP Main, Kalyani Nagar, Viman Nagar, Kharadi. Fee ₹24,000+. Book free demo!",
  keywords:
  ...
  openGraph: {
    title: 'Best NEET Coaching in Koregaon Park Pune | Premium',
    description:
      'Premium NEET biology coaching in Koregaon Park with 98% success rate. AIIMS faculty, small batches. International school specialists.',
  ...
  twitter: {
    ...
    title: 'Best NEET Coaching in Koregaon Park Pune',
    description:
      'Premium NEET biology coaching in Koregaon Park. 98% success rate. Kalyani Nagar, Viman Nagar, Kharadi.',
  },
  alternates: {
