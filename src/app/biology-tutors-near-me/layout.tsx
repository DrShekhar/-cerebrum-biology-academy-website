...
export const metadata: Metadata = {
  ...
  description:
    'Looking for biology tutors near me? Find the best biology tutor in Delhi NCR with 5 offline centres or join online from anywhere. AIIMS trained faculty, 98% success rate.',
  keywords: [
  ...
  openGraph: {
    title: 'Biology Tutors Near Me | Find Best Biology Tutor 2027',
    description:
      'Find best biology tutors near you. 5 offline centres in Delhi NCR or join online from anywhere. AIIMS trained faculty, 98% success rate.',
    type: 'website',
    locale: 'en_IN',
