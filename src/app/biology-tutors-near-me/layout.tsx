...
export const metadata: Metadata = {
  ...
  description:
    'Looking for biology tutors near me? Find the best biology tutor in Delhi NCR with 6 offline centers or join online from anywhere. AIIMS trained faculty, 98% success rate.',
  keywords: [
  ...
  openGraph: {
    title: 'Biology Tutors Near Me | Find Best Biology Tutor 2027',
    description:
      'Find best biology tutors near you. 6 offline centers in Delhi NCR or join online from anywhere. AIIMS trained faculty, 98% success rate.',
    type: 'website',
    locale: 'en_IN',
