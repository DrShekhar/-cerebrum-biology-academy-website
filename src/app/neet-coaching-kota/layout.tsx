...
export const metadata: Metadata = {
  title: 'Best NEET Biology Coaching in Kota | Talwandi, Mahaveer Nagar',
  description:
  ...
  openGraph: {
    ...
    description:
      'Top NEET biology coaching in Kota with 98% success rate. AIIMS faculty, small batches. Fill the Biology gap in your Kota preparation. Join 15,000+ students.',
  ...
  twitter: {
    ...
    title: 'Best NEET Biology Coaching in Kota',
    description:
