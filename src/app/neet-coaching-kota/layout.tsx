...
export const metadata: Metadata = {
  title:
    'Best NEET Biology Coaching in Kota | Talwandi, Mahaveer Nagar | Cerebrum Academy',
  description:
    'Top NEET biology coaching in Kota - India\'s coaching capital. 94.2% success rate, AIIMS faculty. Fill the Biology gap in your Kota preparation. Talwandi, Mahaveer Nagar, Rajeev Gandhi Nagar. 2,500+ students. Book free demo!',
  keywords:
  ...
  openGraph: {
    ...
    description:
      'Top NEET biology coaching in Kota with 94.2% success rate. AIIMS faculty, small batches. Fill the Biology gap in your Kota preparation. Join 2,500+ students.',
  ...
  twitter: {
    ...
    description:
      'Top NEET biology coaching in Kota. 94.2% success rate. Talwandi, Mahaveer Nagar, Rajeev Gandhi Nagar.',
  },
  alternates: {
