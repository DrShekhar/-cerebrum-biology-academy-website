...
export const metadata: Metadata = {
  ...
  description:
    "Top NEET biology coaching in Kota - India's coaching capital. 98% success rate, AIIMS faculty. Fill the Biology gap in your Kota preparation. Talwandi, Mahaveer Nagar, Rajeev Gandhi Nagar. 2,500+ students. Book free demo!",
  keywords:
  ...
  openGraph: {
    ...
    description:
      'Top NEET biology coaching in Kota with 98% success rate. AIIMS faculty, small batches. Fill the Biology gap in your Kota preparation. Join 2,500+ students.',
