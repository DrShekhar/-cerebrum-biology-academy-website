...
const schoolData: Record<string, { title: string; description: string; canonical: string }> = {
  ...
  'dps-vasant-vihar': {
    title: 'NEET Coaching Near DPS Vasant Vihar | Biology Tuition',
    description:
  ...
  'vasant-valley-school': {
    title: 'NEET Coaching Near Vasant Valley School | Biology Classes',
    description:
  ...
  'modern-school-vasant-vihar': {
    title: 'NEET Coaching Near Modern School Vasant Vihar | Biology Tuition',
    description:
  ...
  'sanskriti-school': {
    title: 'NEET Coaching Near Sanskriti School | IB to NEET Transition',
    description:
  ...
  'shri-ram-school': {
    title: 'NEET Coaching Near The Shri Ram School | Biology Classes',
    description:
  ...
  'springdales-pusa-road': {
    title: 'NEET Coaching Near Springdales School Pusa Road | Biology Tuition',
    description:
  ...
  'dps-east-of-kailash': {
    title: 'NEET Coaching Near DPS East of Kailash | Biology Classes EOK',
    description:
...
export async function generateMetadata({
  ...
  if (!data) {
    return {
      title: 'NEET Coaching Near Schools',
