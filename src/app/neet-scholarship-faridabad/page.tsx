...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'neet coaching scholarship faridabad',
    'free neet coaching scholarship',
    'merit scholarship neet faridabad',
    'neet fee concession faridabad',
    'scholarship test neet faridabad',
...
const eligibility = [
  ...
  'Faridabad / NCR residents preferred (online available for others)',
]
...
const faqs = [
  {
    ...
    answer:
      'Students with 75%+ marks in Class 10/11/12 are eligible. Both Faridabad residents and online students can apply. Scholarship is based on academic merit or performance in our scholarship test.',
  },
  {
      ...
      <section className="bg-gradient-to-r from-yellow-600 to-orange-500 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">NEET Scholarship Faridabad 2026</h1>
