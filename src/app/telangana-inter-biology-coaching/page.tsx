...
const WHATSAPP_MESSAGE = encodeURIComponent('Hi! I am interested in Telangana Inter Biology coaching. Please share details.')
...
const features = [
  { icon: Video, title: 'Live Interactive Classes', description: 'Real-time online coaching aligned with Telangana Inter syllabus. English medium focus.' },
  { icon: Users, title: 'Small Batches (10-15)', description: 'Personalized attention for every Inter student. Doubt clearing until mastery.' },
  { icon: Award, title: 'AIIMS Trained Faculty', description: 'Expert teachers who understand both TSBIE pattern and NEET requirements.' },
  { icon: BookOpen, title: 'Inter + NEET Dual Focus', description: 'Comprehensive preparation covering both Telangana board and NEET biology.' },
  { icon: Clock, title: 'Flexible Timings', description: 'Morning, afternoon, and evening batches. Study after college hours.' },
  { icon: Shield, title: 'NCERT Aligned', description: 'Our curriculum bridges TSBIE syllabus with NCERT for complete NEET coverage.' },
]
...
const faqs = [
  {
    ...
    answer: 'Telangana Intermediate (TSBIE) Biology syllabus is approximately 75-80% aligned with NEET. The state follows a comprehensive curriculum based on SCERT Telangana, but gaps exist in Biotechnology Applications, detailed Ecology, and some advanced Genetics topics. Our coaching bridges these gaps with NCERT integration.',
  },
  {
    question: 'Which cities in Telangana do you serve?',
    answer: 'We serve students from all Telangana cities including Hyderabad, Secunderabad, Warangal, Nizamabad, Karimnagar, Khammam, Rangareddy, and more. Our online live classes are accessible from anywhere in Telangana.',
  },
  {
    question: 'What is the fee for Inter Biology + NEET coaching?',
    answer: 'Our comprehensive Inter + NEET Biology coaching ranges from Rs 24,000 to Rs 68,000 per year. This includes board exam preparation, NEET coaching, study materials, and unlimited doubt sessions. EMI options available.',
  },
  {
    question: 'Which medical colleges can Telangana students target?',
    answer: 'With strong NEET scores, Telangana students can target: Osmania Medical College, Gandhi Medical College, Kakatiya Medical College Warangal, Nizam\'s Institute of Medical Sciences, plus AIIMS, JIPMER, and other all-India institutes.',
  },
  {
    question: 'Do you teach in Telugu medium?',
    answer: 'We focus on English medium students whose syllabus aligns with CBSE/NCERT. Our teaching is in English to ensure NEET readiness. Students from English medium junior colleges or those comfortable with English benefit most from our program.',
  },
  {
    question: 'How is your coaching different from Hyderabad coaching centers?',
    answer: 'Unlike crowded coaching centers with 100+ students per batch, we limit to 10-15 students for personalized attention. Our online format saves 2-3 hours daily commute time. Same AIIMS faculty, better personal attention, flexible timings.',
  },
]

const premiumSchools = [
  'Narayana Junior Colleges', 'Sri Chaitanya Colleges', 'FIITJEE Junior College', 'Resonance Junior College',
  'Delhi Public School Hyderabad', 'Oakridge International', 'Chirec Public School', 'Glendale Academy',
  'Meridian School', 'Johnson Grammar School',
]
...
export default function TelanganaInterBiologyCoachingPage() {
  const handleWhatsAppClick = () => {
    if (typeof window !== 'undefined' && (window as any).gtag) {
      ;(window as any).gtag('event', 'whatsapp_click', { event_category: 'conversion', event_label: 'telangana_inter_biology_page' })
    }
  ...
  return (
    <div className="min-h-screen">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        name: 'Cerebrum Biology Academy - Telangana Inter Biology Coaching',
        description: 'Best online biology coaching for Telangana Intermediate students preparing for NEET',
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <motion.div className="text-center max-w-4xl mx-auto" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              <MapPin className="w-5 h-5 mr-2" />Telangana Inter Board | TSBIE + NEET Biology
            </div>
            ...
            <h2 className="text-xl md:text-2xl opacity-90 mb-4">Hyderabad | Secunderabad | Warangal | All Telangana Cities</h2>

            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              Expert Inter Biology coaching with NEET focus. 94.2% success rate, AIIMS faculty. Bridge the
              gap between TSBIE and NCERT syllabus. Join 1,600+ Telangana students!
            </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">Inter Biology Coaching Across Telangana</h2>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div className="text-center mb-16"><h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">Telangana Inter vs NEET Syllabus</h2></motion.div>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-green-50 rounded-2xl p-8 border border-green-200">
              <h3 className="text-2xl font-bold text-green-800 mb-6 flex items-center"><CheckCircle className="w-6 h-6 mr-2" />Common Topics (75-80%)</h3>
              <ul className="space-y-3">
                {['Cell Biology & Biomolecules', 'Plant & Animal Physiology', 'Reproduction Biology', 'Genetics & Evolution Basics', 'Classification', 'Structural Organisation', 'Body Fluids & Circulation'].map((topic, i) => (
            ...
            <div className="bg-red-50 rounded-2xl p-8 border border-red-200">
              ...
              <ul className="space-y-3">
                {['Biotechnology Applications', 'Ecosystem Dynamics', 'Biodiversity & Conservation', 'Microbes in Human Welfare', 'Evolution Mechanisms Detail', 'Human Health & Immunity', 'Environmental Issues'].map((topic, i) => (
                  <li key={i} className="flex items-center text-gray-700"><ArrowRight className="w-5 h-5 text-red-600 mr-2" />{topic}</li>
                ))}
              </ul>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div className="text-center mb-16"><h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">Why Telangana Students Choose Us</h2></motion.div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="bg-[#1e3a5f]/5 rounded-2xl p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Students from These Telangana Institutions Trust Us</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div className="text-center mb-16"><h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">FAQs - Telangana Inter Biology Coaching</h2></motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#1e3a5f] via-[#2d5a87] to-[#3d7ab5] text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
            <h2 className="text-3xl md:text-5xl font-bold mb-6">Ready to Excel in Inter Biology & NEET?</h2>
            <p className="text-xl md:text-2xl mb-8 opacity-90">Join 1,600+ Telangana students. 94.2% success rate. AIIMS faculty. Start today!</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Button variant="secondary" size="xl" onClick={handleWhatsAppClick} className="bg-[#25D366] text-white hover:bg-[#20BD5A] flex items-center justify-center gap-2">
                <MessageCircle className="w-6 h-6" /><span>WhatsApp Us Now</span>
              </Button>
