...
const faqs = [
  ...
  { q: 'What is the success rate for Telangana Inter students?', a: 'Our success rate for Telangana Inter Biology students is 98% with an average score of 358/720 in NEET. We have 62+ Inter toppers in the last two years across all Telangana districts.' },
...
export default function TelanganaInterBiologyCoachingPage() {
  return (
    <>
      <LocalitySchema locality="Hyderabad" slug="telangana-inter-biology-coaching" pageTitle="Best Telangana Inter Biology Coaching Online" pageDescription="Expert online biology coaching for Telangana Intermediate (TSBIE) students preparing for NEET with AIIMS faculty and 98% success rate." pageType="coaching" coordinates={{ lat: "17.3850", lng: "78.4867" }} faqs={faqs} />
      <PageContent />
    </>
  )
}
