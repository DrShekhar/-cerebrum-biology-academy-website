...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'cbse class 9 biology gurugram',
    'icse class 9 biology gurugram',
...
const faqs = [
  {
    question: 'Do you offer CBSE and ICSE Class 9 Biology tuition?',
    answer:
      'Yes, we offer tuition for both CBSE and ICSE Class 9 Biology. Our teachers are experienced with both board patterns and ensure complete syllabus coverage.',
  },
  {
    question: 'What topics are covered in Class 9 Biology?',
    answer:
      'We cover all NCERT topics: Cell - The Fundamental Unit of Life, Tissues, Diversity in Living Organisms, Why Do We Fall Ill, Natural Resources, and Improvement in Food Resources.',
  },
  {
    question: 'What is the fee for Class 9 Biology tuition?',
    answer:
      'Class IX Foundation (Academic) fees range from ₹40,000 to ₹60,000/year depending on the tier: Pursuit (₹40,000, 30-40 students), Ascent (₹50,000, 16-18 students), or Pinnacle (₹60,000, 10-12 students). All tiers include study materials, worksheets, and doubt clearing sessions.',
  },
  {
    question: 'What is the batch size and timing?',
    answer:
      'Small batches of maximum 15 students. Weekend and weekday evening batches available to suit school schedules.',
  },
  {
    question: 'Where is your Gurugram center?',
    answer: `Located at ${gurugramLocation.streetAddress}, same building as XYZ Coaching (largest national NEET chain).`,
  },
]
...
export default function Class9BiologyTuitionGurugramPage() {
  const courseSchema = {
    ...
    '@type': 'Course',
    name: 'Class 9 Biology Tuition - Gurugram',
    description: 'CBSE & ICSE Class 9 Biology tuition',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        '@type': 'ListItem',
        position: 3,
        name: 'Class 9 Gurugram',
        item: 'https://cerebrumbiologyacademy.com/class-9-biology-tuition-gurugram',
      },
    ],
  }
