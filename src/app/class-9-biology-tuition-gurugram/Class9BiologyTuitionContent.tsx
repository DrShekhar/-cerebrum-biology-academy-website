...
const features = [
  ...
  },
  {
    ...
    description: 'Faculty with 15+ years of teaching experience',
    icon: Users,
  },
  {
  ...
  },
  {
    ...
    description: 'Hands-on experiments and diagram practice',
    icon: Microscope,
  },
  { title: 'Regular Testing', description: 'Weekly tests and monthly assessments', icon: Target },
  {
    title: 'Doubt Sessions',
    description: 'Dedicated doubt clearing classes included',
    icon: BookOpen,
  },
]
    ...
    <main className="min-h-screen bg-white">
      <nav className="bg-gray-100 py-3 px-4">
        <div className="max-w-7xl mx-auto">
          <ol className="flex items-center flex-wrap gap-1 text-sm">
            ...
            <li className="flex items-center">
              <ChevronRight className="w-4 h-4 text-gray-400 mx-1" />
              <span className="text-teal-700 font-medium">Class 9 Gurugram</span>
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              Expert Class 9 Biology tuition for CBSE and ICSE boards. Build strong foundation for
              board exams with experienced teachers at our Sector 51, Gurugram center.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              Why Choose Our Class 9 Biology Tuition?
            </h2>
            <p className="text-xl text-slate-600">
              Comprehensive preparation for both CBSE and ICSE boards
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-purple-50 to-indigo-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              Complete Class 9 Biology Syllabus
            </h2>
            <p className="text-xl text-slate-600">
              All NCERT chapters covered with practical focus
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-2xl p-8 animate-fadeInUp">
              ...
              <div className="space-y-4">
                <div className="flex justify-between py-3 border-b border-purple-100">
                  ...
                  <span className="font-semibold">Class IX Foundation (Academic)</span>
                </div>
                <div className="flex justify-between py-3 border-b border-purple-100">
                ...
                <div className="flex justify-between py-3 border-b border-purple-100">
                  ...
                  <span className="font-semibold text-purple-600">₹40,000 - ₹60,000/year</span>
                </div>
                <div className="flex justify-between py-3 border-b border-purple-100">
      ...
      <NEETToolsWidget
        ...
        subtitle="Start using our free NEET preparation tools"
      />
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <Link
              href="/class-10-biology-coaching-gurugram"
              className="bg-gray-50 p-4 rounded-xl hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">Class 10 Biology</h3>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Start Your Class 9 Biology Journey
          </h2>
