...
const areaData: Record<string, { title: string; description: string; canonical: string }> = {
  'hauz-khas': {
    title: 'Biology Tuition Hauz Khas | Classes 9-12 Near IIT Delhi',
    description:
  ...
  'kalu-sarai': {
    title: 'Biology Tuition Kalu Sarai | Classes 9-12 Coaching Capital',
    description:
  ...
  'greater-kailash': {
    title: 'Biology Tuition Greater Kailash GK | Classes 9-12',
    description:
  ...
  'defence-colony': {
    title: 'Biology Tuition Defence Colony | Classes 9-12',
    description:
  ...
  'vasant-vihar': {
    title: 'Biology Tuition Vasant Vihar | Classes 9-12 Premium',
    description:
  ...
  'rk-puram': {
    title: 'Biology Tuition RK Puram | Classes 9-12 Govt Colony',
    description:
  ...
  'sarojini-nagar': {
    title: 'Biology Tuition Sarojini Nagar | Affordable Classes 9-12',
    description:
  ...
  'lodhi-colony': {
    title: 'Biology Tuition Lodhi Colony | Premium Classes 9-12',
    description:
  ...
  saket: {
    title: 'Biology Tuition Saket | Classes 9-12 Metro Connected',
    description:
  ...
  'malviya-nagar': {
    title: 'Biology Tuition Malviya Nagar | Affordable Classes 9-12',
    description:
  ...
  'green-park': {
    title: 'Biology Tuition Green Park | Central Location Classes 9-12',
    description:
  ...
  'cr-park': {
    title: 'Biology Tuition CR Park | Academic Community Classes 9-12',
    description:
  ...
  munirka: {
    title: 'Biology Tuition Munirka | Affordable Classes Near JNU',
    description:
  ...
  'lajpat-nagar': {
    title: 'Biology Tuition Lajpat Nagar | Metro Hub Classes 9-12',
    description:
  ...
  kalkaji: {
    title: 'Biology Tuition Kalkaji | Near Nehru Place Classes 9-12',
    description:
  ...
  'east-of-kailash': {
    title: 'Biology Tuition East of Kailash | DPS EOK Students',
    description:
...
export async function generateMetadata({
  ...
  if (!data) {
    return {
      title: 'Biology Tuition South Delhi',
