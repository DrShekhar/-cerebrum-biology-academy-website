...
export const metadata: Metadata = {
  title: 'Cerebrum vs Aakash for NEET Biology | Specialist vs Generalist Comparison',
  description:
...
const config: CompetitorComparisonConfig = {
  ...
  intro:
    "Aakash Institute (acquired by Byju's in 2021, now operating as Aakash Byju's) is one of India's largest NEET coaching chains, running 250+ centres with combined Physics + Chemistry + Biology curriculum. Cerebrum is a biology-only specialist run by Dr. Shekhar C Singh (AIIMS Delhi). The two operate fundamentally different pedagogy models — this comparison focuses specifically on NEET Biology outcomes.",
  table: [
    {
