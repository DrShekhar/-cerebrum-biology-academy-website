...
export const metadata: Metadata = {
  ...
  description:
    "Learn from India's best biology teacher online. AIIMS-trained Dr. Shekhar with 15+ years experience, 2500+ NEET selections. Live interactive classes, personalized mentoring. Join 1,50,000+ students!",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Learn from India's best online biology teacher. AIIMS-trained, 15+ years experience, 2500+ NEET selections. Book your free demo today!",
  ...
  twitter: {
    ...
    description: 'AIIMS-trained biology teacher with 15+ years experience. 2500+ NEET selections.',
