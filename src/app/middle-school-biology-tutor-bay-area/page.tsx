...
const PAGE_URL = 'https://cerebrumbiologyacademy.com/middle-school-biology-tutor-bay-area'
const PROGRAM_URL = 'https://cerebrumbiologyacademy.com/middle-school-biology-olympiad-usa'
...
const realCompetitions = [
  ...
  },
  {
    ...
    detail:
      'A middle-school-specific biology quiz-bowl, held online (typically late May). A great first taste of timed biology competition. We prepare students directly.',
    can: true,
  },
  {
...
const whyUs = [
  ...
  },
  {
    ...
    description:
      'Real teachers, real interaction — not a video library. Small groups so every Bay Area student gets attention and their questions answered.',
  },
  {
    icon: Clock,
    title: 'Pacific Time evening slots',
    description:
      'Live classes scheduled in Pacific Time (PT) evenings, after the school day — built to fit a busy Bay Area middle-school schedule. Recordings and notes provided.',
  },
  {
    icon: Sprout,
...
const faqs = [
  {
    question: 'Do you have a physical center in the Bay Area?',
    answer:
      'No — and that is by design. Cerebrum is an online biology academy, so your child learns live from home anywhere in the Bay Area, from San Jose and Cupertino to Fremont, Palo Alto, Saratoga, and San Francisco. Classes are scheduled in Pacific Time evening slots, so there is no commute across the 101 or 880 after a long school day. You get real, live, small-batch instruction without needing to drive to a learning center.',
  },
  {
    question: 'What time are the live classes for Bay Area families?',
    answer:
      'Classes for Bay Area students run in Pacific Time (PT) evening slots, after the regular school day. Because we teach live in small batches rather than shipping a video library, the schedule is set to fit Bay Area middle schoolers around school, sports, and other activities. Every session is also recorded, and notes are shared, so nothing is lost if your child has to miss a class.',
  },
  {
    question: 'Can my child take the USABO in middle school?',
    answer:
      'No. The USA Biology Olympiad (USABO) is open only to students in grades 9-12, and there is no middle-school or junior division. Any page that advertises a "USABO middle-school division" or "grades 6-7-8 USABO" is inaccurate. What a Bay Area middle schooler CAN do is build a strong foundation now so they are genuinely ready to enter USABO as a 9th-grader at their local high school. That foundation-first approach is exactly what this program is designed for.',
  },
  {
    question: 'Which competitions can a Bay Area middle schooler actually enter?',
    answer:
  ...
  },
  {
    ...
    answer:
      'No — that is the whole point of doing it right. The Bay Area’s competitive-STEM culture can push families toward cramming college material into young kids, which usually creates burnout rather than champions. We teach an age-appropriate foundation that emphasizes curiosity, conceptual understanding, and scientific thinking. We deliberately do NOT drill a college-level Campbell textbook into a middle schooler. We build the base the right way.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'US students in grades 6-8 (ages roughly 11-14). It suits Bay Area families who want an early, rigorous-but-age-appropriate biology foundation before high school — whether the goal is Science Olympiad, future USABO/AP Biology readiness at a school like Lynbrook or Gunn, or simply getting genuinely good at biology early.',
  },
  {
...
const personSchema = {
  ...
  description:
    'AIIMS New Delhi alumnus and founder of Cerebrum Biology Academy. Designs the age-appropriate middle-school biology foundation curriculum and the honest early-prep pathway toward high-school biology olympiads, delivered online to US families including the SF Bay Area.',
  alumniOf: {
...
const courseSchema = {
  '@context': 'https://schema.org',
  '@type': 'Course',
  name: 'Middle School Biology Tutor & Olympiad Prep — SF Bay Area (Online)',
  description:
    'Online middle school biology tutoring and honest olympiad prep for SF Bay Area families (grades 6-8, ages 11-14). Age-appropriate conceptual biology plus Science Olympiad Division B and National Biology Bowl coaching, with early preparation for future high-school USABO/AP Biology readiness. Live small-batch classes in Pacific Time evenings, taught by AIIMS-trained specialists.',
  url: PAGE_URL,
  inLanguage: 'en-US',
  ...
  audience: {
    ...
    audienceType: 'SF Bay Area middle school students in grades 6-8 (ages 11-14)',
  },
  offers: [
    {
      '@type': 'Offer',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      '@type': 'ListItem',
      position: 3,
      name: 'Middle School Biology Tutor — SF Bay Area',
      item: PAGE_URL,
    },
  ],
}

export default function MiddleSchoolBiologyTutorBayAreaPage() {
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'ms-biology-tutor-bay-area',
      campaign: 'middle-school-biology-tutor-bay-area',
      message:
        'Hi! We are a Bay Area family and want details about the Middle School Biology tutoring program (grades 6-8). Please share the Pacific Time schedule and how to enroll.',
    })
  }
    ...
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full text-sm font-medium mb-6">
              ...
              SF Bay Area · Grades 6-8 · Online (Pacific Time)
            </div>

            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Middle School Biology Tutor &amp; Olympiad Prep —{' '}
              <span className="text-green-400">SF Bay Area</span> (Online)
            </h1>

            <h2 className="text-xl md:text-2xl opacity-90 mb-4">
              Live online biology for grades 6-8, taught in Pacific Time evenings for Bay Area
              families
            </h2>

            <p className="text-lg md:text-xl opacity-80 mb-8 max-w-3xl mx-auto">
              The Bay Area runs on early, serious STEM prep — and biology is where a lot of that
              ambition lands. We give your child a genuine, age-appropriate biology foundation and
              honest Science Olympiad guidance, without the hype or a fake &quot;USABO junior
              division.&quot; Live small batches, real teachers, PT evening slots.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-4xl mx-auto">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 md:p-6">
                ...
                <div className="text-xl md:text-2xl font-bold">Pacific Time</div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            Biology tutoring built for the way the Bay Area does STEM
          </h2>
          <div className="space-y-5 text-lg text-gray-700 max-w-3xl">
            <p>
              If you are raising a middle schooler in Silicon Valley, you already know the culture.
              Public districts like Cupertino Union and Fremont Unified, and high schools such as
              Lynbrook, Monta Vista, Gunn, and Saratoga, are nationally known for intense,
              competitive STEM. Science Olympiad, math circles, and research fairs fill the
              calendar, and families start thinking about high-school rigor years before ninth
              grade.
            </p>
            <p>
              That energy is a gift — but it can also push kids into cramming college-level material
              far too early, especially in biology. We take a different line. For Bay Area students
              in grades 6-8, we teach a genuine, age-appropriate biology foundation and give you{' '}
              <strong>honest</strong> competition guidance, so your child gets ahead the right way
              instead of burning out on a Campbell textbook at twelve.
            </p>
            <p>
              Everything is online and scheduled in Pacific Time evenings, so there is no drive to a
              learning center after school — just live, small-batch classes with a real biology
              specialist, from wherever you are in the Bay, whether that is San Jose, Fremont, Palo
              Alto, or San Francisco.
            </p>
          </div>
          <p className="text-sm text-gray-500 mt-6 max-w-3xl">
            The schools and districts above are referenced as well-known Bay Area STEM context.
            Cerebrum is an independent online program and is not affiliated with, endorsed by, or
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-base md:text-lg text-gray-800">
                ...
                biology properly for ages 11-14, we coach the Bay Area&apos;s most popular
                middle-school science competition (Science Olympiad Division B), and we get your
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-lg text-gray-700 mb-6 max-w-3xl">
            This program is built for Bay Area families who want their child to get a real head
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              'Is in grades 6-8 (roughly ages 11-14) at a Bay Area public or private school.',
              'Is curious about biology and wants to go deeper than the school curriculum.',
              'Is on (or wants to join) a Science Olympiad Division B team.',
              ...
              'Needs a Pacific Time schedule that respects a packed Bay Area weekday.',
            ].map((item) => (
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Competitions a Bay Area middle schooler can actually enter
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              These are real, verified, middle-school-eligible options. Science Olympiad Division B
              in particular is very active at Bay Area schools. We coach the eligible ones directly
              and help your family choose the right fit.
            </p>
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                detail:
                  'This is when USABO eligibility starts. Students can now sit the USABO Open Exam and begin AP Biology at their Bay Area high school — arriving prepared, not starting from zero.',
                icon: Target,
              },
              {
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Bay Area families choose Cerebrum
            </h2>
          </div>
          ...
          <p className="text-center text-gray-600 mt-10 max-w-3xl mx-auto">
            This page is the Bay Area view of our national program. For the full curriculum,
            competition breakdown, and enrollment details, see the{' '}
            <Link
              href="/middle-school-biology-olympiad-usa"
              className="text-[#3d4d3d] font-semibold underline"
            >
              Middle School Biology Foundation (USA) program page
            </Link>
            .
          </p>
        </div>
          ...
          <div className="bg-white/10 border border-white/20 rounded-2xl p-6 md:p-8 max-w-md mx-auto">
            ...
            <ul className="text-left space-y-2 mb-8">
              {[
                ...
                'Pacific Time (PT) evening slots for Bay Area families',
      ...
      <section className="py-16 md:py-20 bg-[#3d4d3d] text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 opacity-90">
            Tell us your child&apos;s grade and your Bay Area town, and we&apos;ll share the Pacific
            Time schedule.
          </p>
          <button
            onClick={handleWhatsApp}
