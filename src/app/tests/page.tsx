      ...
      <section className="bg-indigo-500 text-white py-12 sm:py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-blue-100 max-w-3xl mx-auto mb-6 sm:mb-8">
            Practice with our comprehensive collection of NEET Biology tests. Get instant results,
            detailed analysis, and improve your preparation.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 max-w-4xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-6">
              <div className="text-xl sm:text-2xl md:text-3xl font-bold">{totalQuestions}</div>
              <div className="text-xs sm:text-sm md:text-base text-blue-100">Questions</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-6">
              <div className="text-xl sm:text-2xl md:text-3xl font-bold">
                {publishedTests.length}
              </div>
              <div className="text-xs sm:text-sm md:text-base text-blue-100">Tests</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-6">
              <div className="text-xl sm:text-2xl md:text-3xl font-bold">Free</div>
              <div className="text-xs sm:text-sm md:text-base text-blue-100">Access</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-6">
              <div className="text-xl sm:text-2xl md:text-3xl font-bold">Live</div>
              <div className="text-xs sm:text-sm md:text-base text-blue-100">Ready</div>
            </div>
          </div>
        </div>
      </section>
