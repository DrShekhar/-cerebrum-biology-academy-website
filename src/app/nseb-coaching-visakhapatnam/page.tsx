...
export const metadata: Metadata = {
  ...
  description: 'NSEB (National Standard Examination in Biology) coaching for Visakhapatnam students. NSEB → INBO → OCSC → IBO pathway. AIIMS-trained faculty, online live.',
...
const faqs = [
  ...
  { question: 'How does NSEB coaching work from Visakhapatnam?', answer: 'Live online sessions via Zoom, IST evenings and weekends. Campbell Biology + Alberts Molecular Biology depth. Weekly past-paper drilling. Visakhapatnam students join pan-India NSEB cohort.' },
...
export default function Page() {
  return (
    <main className="min-h-screen bg-white">
      <CerebrumPersonSchema knowsAbout={['NSEB Visakhapatnam', 'Biology Olympiad Andhra Pradesh', 'INBO preparation', 'IBO coaching']} />
      ...
      <section className="bg-gradient-to-br from-amber-900 to-yellow-800 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">NSEB Coaching for Visakhapatnam Students</h1>
          <p className="text-xl text-amber-200 mb-6 max-w-3xl">Biology Olympiad coaching for Visakhapatnam (Andhra Pradesh). NSEB → INBO → OCSC → IBO pathway. AIIMS-trained faculty, Campbell + Alberts depth. Online live. Pursuit Rs 2,500/yr to Pinnacle Rs 6,000/yr.</p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 prose prose-slate max-w-none">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">NSEB → INBO → IBO pathway from Visakhapatnam</h2>
          ...
          <ul>
            ...
            <li><Link href="/neet-coaching-visakhapatnam" className="text-blue-600 hover:underline">NEET Coaching Visakhapatnam</Link></li>
          </ul>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-br from-amber-600 to-yellow-600">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Start NSEB Coaching from Visakhapatnam</h2>
