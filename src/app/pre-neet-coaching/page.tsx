        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20pre-NEET%20Biology%20coaching.%20Please%20share%20available%20timings." target="_blank" rel="noopener noreferrer">
                <Button
                  variant="secondary"
                  size="xl"
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {targetAudience.map((item, index) => (
              <div
                key={item.class}
                className="bg-gradient-to-br from-rose-50 to-pink-50 rounded-xl p-8 border border-rose-100 animate-fadeInUp"
              >
          ...
          <div
           className="animate-fadeInUp">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="https://wa.me/918826444334?text=Hi!%20I'm%20interested%20in%20pre-NEET%20Biology%20coaching.%20Please%20share%20fee%20structure%20and%20enrolment%20details." target="_blank" rel="noopener noreferrer">
                <Button
                  variant="outline"
                  size="xl"
