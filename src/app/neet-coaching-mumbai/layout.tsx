...
export const metadata: Metadata = {
  ...
  description:
    'Top NEET coaching for Mumbai students. 94.2% success rate. Online classes from AIIMS faculty. Prepare for Seth GS, Grant Medical, KEM, LTMMC from home. Serving Andheri, Bandra, Borivali, Thane, Navi Mumbai.',
  keywords:
  ...
  openGraph: {
    ...
    description:
      'Join the most trusted NEET coaching for Mumbai. Online classes from AIIMS-trained faculty. 94.2% success rate. Prepare for top Maharashtra medical colleges from home.',
