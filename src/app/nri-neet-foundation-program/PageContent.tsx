...
const stats = [
  'Students start early score 50-80 marks higher',
  'NCERT foundation with NEET alignment',
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl mb-6 opacity-90">
            Early preparation program for Class 9-10 NRI students planning for NEET. Build strong
            biological concepts.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            <p className="text-lg text-gray-700 mb-4">
              <strong>Target Audience:</strong> Class 9-10 NRI students planning for NEET early
            </p>
            <p className="text-lg text-gray-700 mb-4">
              <strong>Program Duration:</strong> 2-year progressive program, can start mid-year
            </p>
            <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Key Features</h3>
            <ul className="space-y-3">
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">•</span>
                <span className="text-gray-700">NCERT-aligned foundation curriculum</span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">•</span>
                <span className="text-gray-700">Biology concept building from basics</span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">•</span>
                <span className="text-gray-700">Early exposure to NEET exam patterns</span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">•</span>
                <span className="text-gray-700">
                  Progressive difficulty increase year-over-year
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">•</span>
              ...
              <li className="flex items-start">
                <span className="text-blue-600 font-bold mr-3">•</span>
                <span className="text-gray-700">Flexible admission mid-year for Class 10</span>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">
                Is it too early to start NEET preparation in Class 9?
              </h3>
              <p className="text-gray-700 leading-relaxed">
                Not at all! Early preparation is highly beneficial. Students score 50-80 marks
                higher.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">
                How is this different from regular Class 9-10 Biology?
              </h3>
              <p className="text-gray-700 leading-relaxed">
                We align topics with NEET patterns while covering school curriculum completely.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">
                Can my child start mid-year if we enroll in Class 10?
              </h3>
              <p className="text-gray-700 leading-relaxed">
                Yes! You'll receive recorded sessions plus live access to ongoing classes.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">
                What's the teaching approach for foundation students?
              </h3>
              <p className="text-gray-700 leading-relaxed">
                We use concept-based learning with relatable examples rather than rote memorization.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">
                Are there tests and assessments for Class 9-10 students?
              </h3>
              <p className="text-gray-700 leading-relaxed">
                Yes, monthly tests in Class 9 and bi-weekly assessments in Class 10.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="font-bold text-gray-900 mb-3">
                Will this program prepare my child for board exams too?
              </h3>
              <p className="text-gray-700 leading-relaxed">
                Absolutely! Our curriculum covers complete board exam syllabus with deeper
                understanding.
              </p>
            </div>
          </div>
