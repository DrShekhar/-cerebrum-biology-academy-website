...
const benefits = [
  {
    ...
    description:
      'Cerebrum Sector 17 is centrally located in Faridabad, near Bata Chowk Metro. Easy access for the largest national NEET chain students.',
    icon: MapPin,
  },
  {
...
const testimonials = [
  ...
  },
  {
    ...
    quote:
      'The weekend batch at Cerebrum perfectly complemented my the largest national NEET chain weekday classes. Sector 17 location is very convenient.',
  },
  {
    name: 'Vikram R.',
    score: '598/720',
...
export default function ComplementAllenFaridabadContent({ faqs }: { faqs: FAQ[] }) {
  ...
  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      ...
      message:
        'Hi! I am an the largest national NEET chain student in Faridabad and want to join Cerebrum for extra Biology coaching. Please share the schedule and fees.',
      campaign: 'complement-allen-faridabad',
    })
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              ...
              Flexible timing, guaranteed improvement.
            </p>

            <div className="flex flex-wrap items-center gap-4 mb-8">
              <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-lg text-white">
                <MapPin className="w-5 h-5 text-yellow-400" />
                <span>Near Bata Chowk Metro</span>
              </div>
              <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-lg text-white">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeInUp">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Central Faridabad Location</h2>
              <p className="text-xl text-blue-100 mb-6">
                Cerebrum is located at <strong>Sector 17, Faridabad</strong> - near Bata Chowk Metro
                station. Easily accessible from all parts of Faridabad including NIT, Sector 15-17,
                and Old Faridabad.
              </p>
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  Accessible from DPS Faridabad, Manav Rachna, MVN School areas
                </li>
              </ul>
