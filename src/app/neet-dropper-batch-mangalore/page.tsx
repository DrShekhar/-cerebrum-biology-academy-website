...
const cityName = 'Mangalore'
const citySlug = 'mangalore'
...
export const metadata: Metadata = {
  ...
  keywords: ['neet dropper batch mangalore', 'neet repeater course mangalore', 'best dropper batch neet mangalore'],
  alternates: { canonical: `https://cerebrumbiologyacademy.com/neet-dropper-batch-mangalore` },
  openGraph: { title: `NEET Dropper Batch 2026-27 ${cityName}`, url: `https://cerebrumbiologyacademy.com/neet-dropper-batch-mangalore`, locale: 'en_IN', type: 'website' },
