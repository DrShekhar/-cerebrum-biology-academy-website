...
const benefits = [
  ...
  {
    title: 'Online for Greater Noida',
    description: 'Join from your Greater Noida home — zero commute',
    icon: GraduationCap,
  },
  {
...
const premiumSchools = [
  'Ryan International Greater Noida',
  'DPS Greater Noida',
  'Lotus Valley International',
  'Amity International Greater Noida',
  'K.R. Mangalam Greater Noida',
  'Cambridge School Greater Noida',
  'Pathways World School',
  'Step by Step School',
]

export default function NEETFoundationClass10GreaterNoidaContent({ faqs }: { faqs: FAQ[] }) {
  const [openFaq, setOpenFaq] = useState<number | null>(null)

  const handleWhatsApp = () => {
    trackAndOpenWhatsApp({
      source: 'foundation-class10-greater-noida',
      message:
        'Hi! I am a Class 10 student from Greater Noida interested in NEET Foundation course. Please share details about live online classes.',
      campaign: 'foundation-class10-greater-noida',
    })
  }
    ...
    <main className="min-h-screen bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="max-w-4xl animate-fadeInUp">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              ...
              <span className="block text-blue-400 mt-2">in Greater Noida</span>
            </h1>

            <p className="text-xl text-slate-300 mb-8 max-w-3xl">
              Class 10 is the ideal time to start NEET preparation. 40% of NEET Biology overlaps
              with your board syllabus. Get a 2-year head start with live online classes from
              Greater Noida — learn from home, no travel needed.
            </p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 animate-fadeInUp">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              Why Start NEET Prep from Class 10 in Greater Noida?
            </h2>
            <p className="text-xl text-slate-600">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl animate-fadeInUp">
              ...
              <div className="flex gap-4">
                ...
                <a
                  href="https://wa.me/918826444334?text=Hi!%20I%20want%20to%20book%20a%20FREE%20demo%20class%20for%20Foundation%20Biology%20(Class%2010)%20in%20Greater%20Noida."
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <Button>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <Link
              href="/neet-foundation-class-9-greater-noida"
            ...
            <Link
              href="/free-neet-demo-class-greater-noida"
              className="bg-gray-50 p-4 rounded-xl hover:shadow-md"
            >
              <h3 className="font-semibold text-teal-600">Free Demo</h3>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-blue-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Get 2-Year Head Start for NEET from Greater Noida
          </h2>
