...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'NEET Coaching for Paras World School Gurugram',
    description: 'Best NEET coaching for Paras World School Sector 46 students. Just 8 min drive. CBSE-NEET aligned preparation. AIIMS faculty, 98% success rate. Call 88264-44334!',
  },
}
...
const faqs = [
  {
    ...
    answer:
      'Our center at M2K Corporate Park, Sector 51 is approximately 3-4 km from Paras World School Sector 46. It takes just 6-8 minutes by car.',
  },
  {
    question: 'Why is proximity important for NEET coaching?',
    answer:
      'Less travel time = more study time. Paras students can attend evening batch (4-7 PM) and still reach home early. No fatigue from long commutes.',
  },
  {
    question: 'Do you have other Paras World School students?',
    answer:
      'Yes! We have 10+ students from Paras World School. Being one of the closest coaching centers to their school, we are a natural choice.',
  },
  {
    question: 'Can I come directly after school?',
    answer:
      'Absolutely! Many Paras students come directly after school for our 4 PM batch. The short distance makes this very convenient.',
  },
]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white">
      ...
      <GurgaonGurugramAreaSchema
        spelling="gurugram"
        pageSlug="neet-coaching-paras-world-school-gurugram"
        subArea="Paras World School Gurugram"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              NEET Coaching for Paras World School
            </h1>
            <p className="text-xl text-amber-100 mb-4">
              Closest quality NEET coaching to your school
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a
                ...
                className="bg-white text-amber-600 px-8 py-3 rounded-lg font-semibold flex items-center gap-2 hover:bg-amber-50 transition"
              >
              ...
              <Link
                ...
                className="bg-amber-700 text-white px-8 py-3 rounded-lg font-semibold flex items-center gap-2 hover:bg-amber-800 transition"
              >
                View All Locations
              ...
              <div className="md:w-1/2 p-8">
                ...
                <div className="bg-amber-50 p-4 rounded-lg mb-4">
                  <p className="text-sm text-amber-800">
                    <strong>Quick Route:</strong> Paras Sec 46 → Sector 50 → Sector 51 (8 min)
                  </p>
                </div>
                <a
                  href="tel:+918826444334"
      ...
      <section className="py-16 bg-amber-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-amber-100 mb-8">
            Shortest commute, highest quality. The smart choice.
          </p>
          <a
            href="tel:+918826444334"
