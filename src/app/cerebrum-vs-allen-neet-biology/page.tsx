...
export const metadata: Metadata = {
  title: 'Cerebrum vs Allen for NEET Biology | Biology Specialist vs Kota Generalist',
  description:
...
const config: CompetitorComparisonConfig = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "For most students, no — and this is increasingly the consensus across urban Tier 1 families. Three reasons. (1) Mental health: 16-17 year olds living alone in Kota for 2 years carries documented mental-health risks (well-publicised in 2023-2025 media). (2) Cost: ₹2L-2.5L all-in vs ₹70K-1.5L for biology-specialist + PCB online stack. (3) Biology pedagogy: Kota's strength is physics — Allen and Resonance both come from physics-engineering coaching roots. Biology depth is structurally weaker than dedicated biology specialists like Cerebrum.",
    },
    {
