...
export const metadata: Metadata = {
  title: 'Cerebrum vs Allen for NEET Biology | Specialist vs Kota',
  description:
    'Detailed Cerebrum vs Allen comparison for NEET Biology specifically. Biology-only AIIMS-trained specialist (Cerebrum, ₹40K-₹1.56L) vs Kota-based PCB-generalist with 200-400 student batches (Allen, ₹1.5L+). Faculty depth, batch size, pricing.',
  keywords: [
  ...
  openGraph: {
    title: 'Cerebrum vs Allen for NEET Biology | Cerebrum Biology Academy',
    description:
      'Side-by-side comparison of Cerebrum and Allen specifically for NEET Biology — Kota relocation vs Delhi NCR + online.',
  ...
  twitter: {
    ...
    title: 'Cerebrum vs Allen for NEET Biology | Specialist vs Kota',
    description:
      'Detailed Cerebrum vs Allen comparison for NEET Biology specifically. Biology-only AIIMS-trained specialist (Cerebrum, ₹40K-₹1.56L) vs Kota-based PCB-generalist with 200-40...',
  },
}
...
const config: CompetitorComparisonConfig = {
  ...
  headline: 'Cerebrum vs Allen — NEET Biology Specifically',
  ribbon: 'Biology-Only Specialist (Cerebrum, Delhi NCR + Online) vs Kota PCB-Generalist (Allen)',
  subheadline:
  ...
  table: [
    ...
    },
    {
      ...
      competitor: 'Yes — Allen has strong physics + chemistry depth too',
      cerebrumWins: false,
    },
  ],
  whyChooseCerebrum: [
  ...
  whenCompetitorMightBeBetter: [
    ...
    "You value Allen's test series infrastructure and national rank disclosure systems specifically.",
  ],
  testimonials: [
    {
      name: 'Priya Iyer',
    ...
    },
    {
      ...
      college: 'AIIMS Patna',
      quote:
        'Allen Kota biology rotated faculty three times in Class 11-12. Cerebrum Ascent gave me Dr. Shekhar continuity for 24 months. Same family budget, materially better biology.',
    },
    {
      name: 'Aanya Kapoor',
      ...
      quote:
        "Stayed home in Delhi, joined Cerebrum Pursuit + PhysicsWallah PCB. Total ₹85K vs my brother's ₹2.3L Allen Kota. Better outcome at one-third the cost.",
    },
  ],
  faqs: [
    {
      ...
      answer:
        'For NEET Biology specifically, yes — primarily because of the structural model differences. (1) Subject specialisation: Cerebrum is biology-only with single-faculty continuity (Dr. Shekhar C Singh, AIIMS Delhi); Allen is PCB-generalist with year-to-year faculty rotation. (2) Batch size: Cerebrum 15-20 students vs Allen 200-400+. (3) Cost: Cerebrum biology-only ₹40K-1.56L vs Allen combined PCB ₹1.5L+ tuition (₹2L-2.5L all-in including Kota relocation). Allen remains the better fit for students who specifically want Kota relocation and full PCB under one brand.',
    },
    {
      question:
        'What is the total cost difference between Cerebrum and Allen Kota for NEET preparation?',
      answer:
        "Allen Kota total annual cost: ₹1.5L+ tuition + ₹50K-1L hostel/mess + ₹20K-30K incidentals = ₹2L-2.5L total. Cerebrum Pinnacle (top tier with Dr. Shekhar 1:1 direct mentoring): ₹1.2L-1.56L total, with the student living at home. Cerebrum Ascent (the popular value tier): ₹58K-90K. Difference: roughly half the all-in cost at Cerebrum Pinnacle, or one-third at Ascent. Adding PhysicsWallah PCB (₹10K-20K) to a Cerebrum biology stack still totals ₹70K-1.7L vs Allen's ₹2L-2.5L.",
    },
    {
      question: 'Is Kota relocation worth it for NEET preparation in 2025-2026?',
      answer:
        "For most students, no — and this is increasingly the consensus across urban Tier 1 families. Three reasons. (1) Mental health: 16-17 year olds living alone in Kota for 2 years carries documented mental-health risks (well-publicised in 2023-2025 media). (2) Cost: ₹2L-2.5L all-in vs ₹70K-1.5L for biology-specialist + PCB online stack. (3) Biology pedagogy: Kota's strength is physics — Allen and Career Point both come from physics-engineering coaching roots. Biology depth is structurally weaker than dedicated biology specialists like Cerebrum.",
    },
    {
      question: 'Does Allen have biology-only courses for NEET?',
      answer:
        "Allen's primary NEET courses are combined PCB. Biology-only Allen modules typically appear as test series add-ons or weekend supplements — not full coaching courses with continuous faculty support and small-batch structure. Cerebrum is biology-only as the core product, with full pedagogy and batch structure built specifically around the biology subject and Dr. Shekhar's AIIMS-trained methodology.",
    },
    {
      question: 'Should I move from Allen Kota to Cerebrum mid-Class 12?',
      answer:
        "If your Allen biology mock scores are consistently below 320/360 and you're finding Kota life mentally taxing, switching to Cerebrum by October of Class 12 is high-leverage. Cerebrum runs an October-November join window specifically for mid-year switches from Kota institutes. WhatsApp +91 88264-44334 for a free 30-minute diagnostic. Switching after January is too compressed for full curriculum re-pacing — at that point, ad-hoc 1:1 hourly (₹2,500-4,500/hr) with Dr. Shekhar is the better intervention.",
    },
  ],
  whatsappMessage:
    "Hi! I'm considering Cerebrum vs Allen for NEET Biology (and the Kota relocation decision) — would like a free 30-minute diagnostic call. Please share available timings.",
}
