...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Starting early with Cerebrum was the best decision! The 2-year foundation program built my concepts from scratch. I went from struggling with basic biology to topping my school exams. Now I'm confident about NEET 2027!",
