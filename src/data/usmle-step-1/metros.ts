...
export const usmleMetros: Record<string, USMLEMetroConfig> = {
  'new-york': {
    ...
    keywords: ['USMLE Step 1 tutor New York', 'USMLE Step 1 tutor NYC', 'USMLE tutor Columbia VP&S', 'USMLE tutor NYU Grossman', 'USMLE tutor Weill Cornell', 'USMLE Step 1 biology coaching NYC', 'Step 1 dedicated period tutor NYC'],
    heroSubtitle:
    ...
    medSchools: [
      { name: 'Columbia VP&S', programmes: 'MD, MD/PhD (Vagelos College of Physicians and Surgeons)' },
    ...
    timezoneSection: 'All live sessions are in Eastern Time. Standard NYC small-batch slot is 8:00 PM to 10:00 PM ET on weekday evenings (after clinical rotations end). Weekend: 10:00 AM to 12:00 PM ET. Dedicated-period students can take daytime slots.',
    demographicSection: {
    ...
    faqs: [
      { question: 'Columbia or NYU M1/M2 — how does Step 1 prep fit the curriculum?', answer: 'Columbia VP&S and NYU Grossman both integrate basic sciences into the first two years. Our coaching supplements — not replaces — the school curriculum by drilling the biology-foundations content (biochemistry, microbiology, immunology, physiology) that Step 1 tests beyond the clinical-case focus of modern medical curricula. We schedule around the M1/M2 academic calendar.' },
      { question: 'IMG preparing in NYC — what is the planning conversation?', answer: 'For IMGs based in NYC (post-Caribbean, post-Indian medical school, or post-Pakistani medical school), the planning conversation covers: (a) current UWorld/NBME baseline, (b) dedicated-period duration (3–6 months typical), (c) biology foundations gaps vs clinical knowledge. We calibrate the programme to the IMG\'s specific baseline.' },
      { question: 'Step 1 is Pass/Fail — why invest in coaching?', answer: 'The 7% fail rate is a binary catastrophe (delays residency 1+ year). For IMGs, ~25% of residency programmes still use Step 1 performance signals for filtering. Our coaching reduces fail risk by strengthening the biology foundations that most candidates find hardest: biochemistry pathways, microbiology mechanisms, and immunology cascades.' },
      { question: 'How does Cerebrum compare to UWorld and Kaplan for Step 1?', answer: 'UWorld is a question bank — essential but not a teaching tool. Kaplan Step 1 is a generalist course (~$3,499) covering all disciplines. Cerebrum is a biology-foundations specialist ($799–$2,499) covering the ~55% of Step 1 that is biology-driven. Most students pair us with UWorld for question volume.' },
      { question: 'ET evening sessions for NYC medical students?', answer: 'Standard small-batch: 8:00–10:00 PM ET weekday evenings (after rotations). Weekend: 10:00 AM–12:00 PM ET. Dedicated-period students can take daytime slots at any ET time.' },
    ],
  },
  ...
  'los-angeles': {
    ...
    keywords: ['USMLE Step 1 tutor Los Angeles', 'USMLE tutor UCLA Geffen', 'USMLE tutor USC Keck', 'USMLE tutor UC Irvine', 'USMLE Step 1 biology coaching LA', 'Step 1 dedicated period tutor LA'],
    heroSubtitle:
    ...
    timezoneSection: 'All live sessions are in Pacific Time. Standard LA small-batch slot is 7:30 PM to 9:30 PM PT on weekday evenings. Weekend: 10:00 AM to 12:00 PM PT. Dedicated-period students can take daytime slots.',
    demographicSection: {
    ...
    faqs: [
      { question: 'UCLA or USC Keck M1/M2 — how does Step 1 prep fit?', answer: 'UCLA Geffen and USC Keck integrate basic sciences with early clinical exposure. Our coaching adds biology-foundations depth (biochemistry, microbiology, immunology) that supplements the clinical-case focus. We schedule around the M1/M2 calendar.' },
      { question: 'IMG in LA — planning conversation?', answer: 'For IMGs based in LA: (a) current UWorld/NBME baseline, (b) dedicated-period duration (3–6 months), (c) biology foundations gaps. Many LA-based IMGs are from Indian medical schools — we leverage the AIIMS-trained faculty alignment for these candidates.' },
      { question: 'How does Cerebrum compare to Kaplan Step 1 in LA?', answer: 'Kaplan Step 1 is ~$3,499 for all disciplines. Cerebrum is $799–$2,499 for biology foundations (~55% of Step 1). Most students pair us with UWorld for question volume and use us instead of Kaplan for the foundational sciences component.' },
      { question: 'PT evening sessions for LA medical students?', answer: 'Small-batch: 7:30–9:30 PM PT weekday evenings. Weekend: 10:00 AM–12:00 PM PT. Dedicated-period students can take daytime PT slots.' },
    ],
  },
  ...
  chicago: {
    ...
    keywords: ['USMLE Step 1 tutor Chicago', 'USMLE tutor Northwestern Feinberg', 'USMLE tutor Pritzker', 'USMLE tutor UIC COM', 'USMLE Step 1 biology coaching Chicago', 'Step 1 dedicated period tutor Chicago'],
    heroSubtitle:
    ...
    medSchools: [
      ...
      { name: 'UIC College of Medicine', programmes: 'MD (largest US medical school by enrollment)' },
    ...
    timezoneSection: 'All live sessions are in Central Time. Standard Chicago small-batch slot is 7:30 PM to 9:30 PM CT on weekday evenings. Weekend: 10:00 AM to 12:00 PM CT.',
    demographicSection: {
    ...
    faqs: [
      { question: 'Northwestern Feinberg or Pritzker M1/M2 — how does coaching fit?', answer: 'Both schools have accelerated curricula. Our coaching supplements with biology-foundations depth (biochemistry, microbiology, immunology). We schedule around the M1/M2 academic calendar and clinical rotation schedule.' },
      { question: 'UIC COM students — different from Northwestern/Pritzker?', answer: 'UIC COM has the largest class size in the US (~300/year). Students may have less individual faculty access. Our small-batch coaching (4–6 students) fills that gap with personalised biology-foundations review.' },
      { question: 'How does Cerebrum compare to Kaplan Step 1?', answer: 'Kaplan Step 1 is ~$3,499 for all disciplines. Cerebrum is $799–$2,499 for biology foundations. Most students pair us with UWorld and use us instead of Kaplan for foundational sciences.' },
      { question: 'CT evening sessions for Chicago medical students?', answer: 'Small-batch: 7:30–9:30 PM CT weekday evenings. Weekend: 10:00 AM–12:00 PM CT. Dedicated-period students can take daytime CT slots.' },
    ],
  },
  ...
  delhi: {
    ...
    keywords: ['USMLE Step 1 tutor Delhi', 'USMLE tutor AIIMS Delhi', 'USMLE tutor MAMC', 'USMLE tutor UCMS', 'USMLE Step 1 coaching Delhi', 'IMG ECFMG preparation Delhi', 'USMLE Step 1 biology coaching India'],
    heroSubtitle:
    ...
    medSchools: [
      ...
      { name: 'University College of Medical Sciences (UCMS)', programmes: 'MBBS, MD/MS (GTB Hospital)' },
    ...
    timezoneSection: 'All live sessions are timed for IST. Standard Delhi small-batch slot is 8:00 PM to 10:00 PM IST on weekday evenings. Weekend: 10:00 AM to 12:00 PM IST. Dedicated-period candidates can take daytime IST slots. IST-to-ET alignment means our faculty is available during US morning hours for candidates coordinating with US-based study groups.',
    demographicSection: {
    ...
    faqs: [
      { question: 'AIIMS or MAMC graduate — how is Step 1 prep different from standard Indian MBBS revision?', answer: 'Indian MBBS teaches biology as facts to memorise; USMLE Step 1 tests biology as mechanisms to reason through. The gap is biggest in biochemistry (pathway logic, not enzyme names) and immunology (cascade reasoning, not classification lists). Our coaching bridges this gap by teaching the "why" behind First Aid facts.' },
      { question: 'How long is the typical Delhi IMG dedicated period?', answer: 'Delhi IMGs with strong MBBS foundations (AIIMS, MAMC, UCMS) typically need 4–6 months of dedicated Step 1 prep. Candidates from private medical colleges may need 6–9 months. We calibrate based on the initial NBME baseline score.' },
      { question: 'INR pricing for Delhi candidates?', answer: 'Self-Paced: ₹39,999. Small-Batch: ₹79,999. 1:1 Senior Faculty: ₹1,24,999. Ad-hoc 1:1: ₹8,750/hour. INR transfer (HDFC/ICICI/SBI/Axis), UPI, and international card accepted.' },
      { question: 'Can Cerebrum help with ECFMG certification pathway beyond Step 1?', answer: 'We coach the biology-foundations component of Step 1 only. For Step 2 CK, OET (English test), and ECFMG pathway strategy, we recommend pairing with a full ECFMG advisory service. Our coaching ensures the Step 1 biology foundations are solid — which is the hardest part for most Indian IMGs.' },
      { question: 'IST evening sessions for Delhi candidates?', answer: 'Small-batch: 8:00–10:00 PM IST weekday evenings. Weekend: 10:00 AM–12:00 PM IST. Dedicated-period candidates can take daytime IST slots.' },
    ],
  },
  ...
  mumbai: {
    ...
    keywords: ['USMLE Step 1 tutor Mumbai', 'USMLE tutor Grant Medical', 'USMLE tutor Seth GS', 'USMLE tutor KEM Hospital', 'USMLE Step 1 coaching Mumbai', 'IMG ECFMG preparation Mumbai'],
    heroSubtitle:
    ...
    timezoneSection: 'All live sessions timed for IST. Standard Mumbai small-batch: 8:00 PM to 10:00 PM IST weekday evenings. Weekend: 10:00 AM to 12:00 PM IST.',
    demographicSection: {
    ...
    faqs: [
      { question: 'Grant or KEM graduate — how long is the typical dedicated period?', answer: 'Mumbai government-college graduates (Grant, Seth GS, KEM, Nair) typically need 4–6 months of dedicated Step 1 prep. Clinical exposure is strong — the gap is in basic-science conceptual depth, particularly biochemistry and immunology.' },
      { question: 'INR pricing for Mumbai candidates?', answer: 'Self-Paced: ₹39,999. Small-Batch: ₹79,999. 1:1 Senior Faculty: ₹1,24,999. INR transfer, UPI, and international card accepted.' },
      { question: 'How does Cerebrum compare to Mumbai USMLE coaching centres?', answer: 'Mumbai has several USMLE coaching centres charging ₹1.5L–₹3L for full Step 1 programmes. Cerebrum is a biology-foundations specialist at ₹39,999–₹1,24,999 for the ~55% of Step 1 that is biology-driven. Most candidates pair us with UWorld for question practice.' },
      { question: 'IST evening sessions for Mumbai candidates?', answer: 'Small-batch: 8:00–10:00 PM IST weekday evenings. Weekend: 10:00 AM–12:00 PM IST. Dedicated-period candidates can take daytime IST slots.' },
    ],
  },
  ...
  hyderabad: {
    ...
    keywords: ['USMLE Step 1 tutor Hyderabad', 'USMLE tutor Osmania Medical', 'USMLE tutor Gandhi Medical', 'USMLE Step 1 coaching Hyderabad', 'IMG ECFMG preparation Hyderabad', 'USMLE Step 1 biology coaching Telangana'],
    heroSubtitle:
    ...
    medSchools: [
      { name: 'Osmania Medical College', programmes: 'MBBS, MD/MS (Hyderabad\'s oldest medical school)' },
    ...
    timezoneSection: 'All live sessions timed for IST. Standard Hyderabad small-batch: 8:00 PM to 10:00 PM IST weekday evenings. Weekend: 10:00 AM to 12:00 PM IST.',
    demographicSection: {
    ...
    faqs: [
      { question: 'Osmania or Gandhi Medical graduate — typical dedicated period?', answer: 'Hyderabad government-college graduates typically need 4–6 months of dedicated Step 1 prep. The pattern is the same as Delhi/Mumbai: strong clinical, weaker basic-science conceptual depth.' },
      { question: 'INR pricing for Hyderabad candidates?', answer: 'Self-Paced: ₹39,999. Small-Batch: ₹79,999. 1:1 Senior Faculty: ₹1,24,999. INR transfer, UPI, and international card accepted.' },
      { question: 'How does Cerebrum compare to Hyderabad USMLE coaching?', answer: 'Hyderabad has several USMLE coaching centres charging ₹1.5L–₹3L. Cerebrum is a biology-foundations specialist at ₹39,999–₹1,24,999 for the ~55% of Step 1 that is biology-driven. Most candidates pair us with UWorld.' },
      { question: 'IST sessions for Hyderabad candidates?', answer: 'Small-batch: 8:00–10:00 PM IST weekday evenings. Weekend: 10:00 AM–12:00 PM IST. Dedicated-period candidates can take daytime IST slots.' },
    ],
  },
}
