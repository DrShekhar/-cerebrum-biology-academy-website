...
export const delhiNCRLocalityCues: Record<DelhiNCRLocalityKey, LocalityCuesProps> = {
  rohini: {
    ...
    localCompetitors: [
      { brand: 'Aakash Institute Rohini', note: 'Sector 18, 4 km' },
      { brand: 'Allen Career Institute Rohini', note: '~6 km' },
  ...
  'south-extension': {
    ...
    localCompetitors: [
      { brand: 'Aakash Institute South Delhi', note: 'Lajpat Nagar / Saket' },
      { brand: 'Allen Career Institute', note: 'Punjabi Bagh + multiple Delhi' },
      { brand: 'FIITJEE Kalu Sarai', note: '4 km · generalist' },
      { brand: 'PhysicsWallah Vidyapeeth', note: 'Online + select offline' },
    ],
  },
  ...
  gurugram: {
    ...
    localCompetitors: [
      { brand: 'Aakash Institute Gurugram', note: 'Sector 14 + Sector 56' },
      { brand: 'Allen Career Institute', note: 'Sector 27 · large batches' },
      { brand: 'FIITJEE Gurugram', note: 'Generalist NEET + JEE' },
      { brand: 'Resonance Gurugram', note: 'Sector 14 area' },
    ],
  },
  ...
  noida: {
    ...
    localCompetitors: [
      { brand: 'Aakash Institute Noida', note: 'Sector 50 + Sector 18' },
      { brand: 'Allen Career Institute', note: 'Sector 18 · large batches' },
      { brand: 'FIITJEE Noida', note: 'Sector 62 · generalist' },
      { brand: 'PhysicsWallah Noida', note: 'Multiple sectors' },
    ],
  },
  ...
  faridabad: {
    ...
    localCompetitors: [
      { brand: 'Aakash Institute Faridabad', note: 'Sector 15 · 2 km' },
      { brand: 'Allen Career Institute', note: 'Sector 16A · generalist' },
