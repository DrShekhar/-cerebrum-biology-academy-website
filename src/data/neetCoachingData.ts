...
export const comparisonData = {
  headers: ['Feature', 'Cerebrum', 'the largest national NEET chain', 'the 2nd-largest national NEET chain'],
  rows: [
