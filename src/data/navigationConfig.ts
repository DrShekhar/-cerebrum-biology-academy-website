    ...
    items: [
      {
        ...
        title: 'All Locations',
        href: '/all-locations',
        description: 'View all coaching centers and online class options',
        keywords: ['all locations', 'all centers', 'find center', 'near me'],
        isPopular: true,
      },
      {
        id: 'south-extension',
      ...
      },
      {
        ...
        description: 'North Delhi center near Rohini West Metro (Red Line)',
        keywords: ['rohini', 'dc chowk', 'north delhi', 'rohini west metro'],
      },
      {
        id: 'gurugram',
        title: 'Gurugram - Sector 51',
        href: '/locations/gurugram',
        description: 'M2K Corporate Park, near HUDA City Centre Metro',
        keywords: ['gurugram', 'gurgaon', 'sector 51', 'huda city centre'],
      },
      {
        id: 'faridabad',
...
export const footerNavigationConfig = {
  ...
  centers: [
    { title: 'South Extension (Flagship)', href: '/locations/south-extension' },
