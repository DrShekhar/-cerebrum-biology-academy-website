...
export const apBiologyMetros: APBiologyMetro[] = [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    addressRegion: 'Dubai',
    heroBlurb:
      'Dubai has become one of the strongest AP Biology markets outside North America. GEMS Dubai American Academy, Universal American School, Dubai American Academy, and American School of Dubai run deep AP cohorts, and the British-curriculum cluster (Repton, Nord Anglia, JESS) increasingly offers AP Biology as a Year 12–13 elective for US-college applicants. If you expect serious rigour with US-curriculum fidelity, that is exactly how our programme is built. Our GST evening live classes (6–9 PM Dubai time) slot cleanly into the AP-heavy junior and senior schedules these schools run.',
    positioningBlurb:
      'Most AP Biology tutoring in Dubai is sold through generalist agencies charging AED 220–400 per hour ($60–$110/hr) for a rotating freelance bench — often non-biology specialists working across multiple subjects. Cerebrum is set up differently: AIIMS-trained biology faculty as your dedicated tutor for the full year, weekly written feedback on every FRQ attempt against the College Board rubric, and the Indian small-batch coaching tradition (max 12 per batch) built around retrieval practice and timed mocks. Senior-faculty 1:1 starts at $1,800 for 12 hours — substantially below local hourly rates once you compare like for like.',
    schools: [
    ...
    faqs: [
      ...
      {
        question: 'How is your AP Biology coaching different from local Dubai tutoring agencies?',
        answer:
          'Three structural differences. First, faculty: we use AIIMS-trained biology faculty as your dedicated tutor for the year, not a rotating bench of generalist tutors hired on freelance terms. Second, methodology: retrieval-heavy small-batch coaching (Indian tradition) with weekly written FRQ feedback against the College Board rubric, not generic platform tutoring. Third, price: senior-faculty 1:1 at $1,800 for 12 hours works out to $150/hr versus the AED 220–400/hr ($60–$110/hr) typical of local agencies — and at those local rates you are usually getting undergraduate or master’s-level generalists, not full biology specialists.',
      },
      {
        question:
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    heroBlurb:
      'Abu Dhabi’s AP Biology demand is concentrated around the American cluster on Saadiyat and Khalifa City — GEMS American Academy Abu Dhabi, American Community School (ACS), Canadian International, Cranleigh, and the Aldar Academies network — plus Brighton College and Repton on the British side offering AP as a US-track elective. Whether you’re aiming at NYU Abu Dhabi’s admissions pool or US mainland universities, AP Biology is one of the cleanest signals you can add. GST evening live classes (6–9 PM Abu Dhabi time) work cleanly for the AP-heavy junior/senior schedules these schools run.',
    positioningBlurb:
      'AP tutoring supply in Abu Dhabi is thinner than in Dubai, and most local options charge AED 250–450 per hour ($70–$120/hr) for non-specialist generalists who often commute from Dubai. Cerebrum delivers AIIMS-trained biology faculty as a dedicated year-long tutor, weekly written FRQ feedback against the College Board rubric, and the Indian small-batch coaching tradition (max 12 per batch) calibrated to retrieval practice and timed mocks. Senior-faculty 1:1 from $1,800 for a 12-hour package, with no Dubai-commute premium or weekend-only constraint.',
    schools: [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    addressRegion: 'Delhi',
    heroBlurb:
      'Delhi NCR’s AP Biology demand clusters around the American Embassy School (AES) in Chanakyapuri, the Pathways network (Aravali, Gurgaon, Noida), Sanskriti School, Vasant Valley, and the GD Goenka / Heritage / Lancers international cohort. Whether you’re on the AES US-college track, a Pathways IBDP student layering AP for US apps, or a Modern / DPS International / Sanskriti CBSE-12 student dual-applying to Indian universities and US colleges, the programme is built around your path. Cerebrum’s South Extension hub sits 4 km from AIIMS Delhi — our senior faculty roster is drawn from that ecosystem and an occasional in-person consultation is available for NCR families who want it.',
    positioningBlurb:
      'Most AP Biology tutoring in Delhi NCR is bundled into broader SAT / ACT / IELTS / Common-App packages tutored by non-specialist staff at generalist test-prep agencies. Cerebrum is biology-only: AIIMS-trained biology faculty as your dedicated year-long tutor, weekly written FRQ feedback against the College Board rubric, IST evening live classes, and the option of in-person review at our South Extension hub for NCR-based families. Senior-faculty 1:1 begins at $1,800 for 12 hours — well below the $150–400/hr US-based tutors charge over Zoom.',
    schools: [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    heroBlurb:
      'Bangalore’s AP Biology demand is shaped by its international-school cluster across two distinct corridors: the Whitefield-Sarjapur tech-belt (Greenwood High, Indus, Inventure, Oakridge, NPS International) where AP layers cleanly onto a STEM-leaning cohort, and the central / south Bangalore axis (Stonehill, Canadian International, Mallya Aditi, TISB) where AP is more often paired with IB. Whether you’re pairing AP Biology with coding and accelerated math for MIT / Stanford / Carnegie Mellon applications, or adding it to an IB base as a US-college signal, the coaching fits around your school week — Saturday-morning IST batches work cleanly if you prefer to keep weekday evenings for school.',
    positioningBlurb:
      'If you like to scrutinise a tutoring service before committing, here is what you will find: most AP Biology tutoring in Bangalore is bundled into SAT / Common-App stacks staffed by rotating non-specialist tutors at generalist test-prep agencies. Cerebrum is structurally different: biology-only, AIIMS-trained biology faculty as your dedicated year-long tutor, transparent weekly written FRQ feedback (a deliverable you can actually measure), and IST evening or Saturday-morning live classes. Senior-faculty 1:1 from $1,800 for 12 hours ($150/hr) — well below US-based tutors’ $150–400/hr Zoom rates, with deeper subject specialism.',
    schools: [
      'Inventure Academy',
      'Trio World Academy',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Honestly, it depends on the student. The AP Calc BC + USACO Silver/Gold + AP Computer Science combination is one of the most common profiles we coach — students comfortably on top of that load absolutely add AP Biology in junior year for MIT / Stanford / CMU breadth signalling, while students already stretched by it over-extend and produce a 3 or 4 that hurts the application more than no AP Bio at all would have. The honest call: if your child is comfortably 5-track in math/CS already, AP Bio is a strong add. If they’re grinding to maintain those tracks, deepen what’s working rather than adding a fourth.',
      },
      {
        question:
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    heroBlurb:
      'Hyderabad’s AP Biology demand has grown sharply with the HiTech City and Gachibowli expansion: Oakridge International (Gachibowli + Bachupally), CHIREC International (Kondapur), Indus International, Glendale Academy, Sancta Maria, and the diplomatic-enclave International School of Hyderabad anchor the cluster, with Aga Khan Academy and Silver Oaks adding to the AP-friendly bench. If you’re targeting the Hyderabad → Carnegie Mellon / Purdue / UT Austin pipeline that has become a major regional pattern, our coaching is calibrated to exactly that track. IST evening live classes (6–9 PM) work cleanly for the post-school window.',
    positioningBlurb:
      'Hyderabad has fewer specialist AP tutoring options than Mumbai, Delhi, or Bangalore — most local coaching is built for JEE / NEET rather than AP Biology, and the few US-curriculum options bundle AP into broader SAT / Common-App stacks staffed by generalist tutors. Cerebrum is biology-only: AIIMS-trained biology faculty as your dedicated year-long tutor, weekly written FRQ feedback against the College Board rubric, IST evening live classes, and US-college-application context calibrated for Hyderabad families targeting US universities like CMU, Purdue, and UT Austin. Dedicated senior-faculty 1:1 from $1,800 / 12 hours.',
    schools: [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    addressRegion: 'ON',
    heroBlurb:
      'Peel Region — Brampton and Mississauga — has seen AP Biology demand grow sharply alongside the BCCAT-tracked 72% national AP expansion from 2006–2016 and sustained Ontario growth since. Peel feeder schools like Turner Fenton, Mayfield, Lorne Park, John Fraser, Glenforest, and Iona Catholic run committed AP cohorts, and if you’re dual-applying to UofT Mississauga, Western, Waterloo, and US universities, a clean AP-5 travels across both. If you grew up in Indian academic culture, our AIIMS-trained biology faculty and small-batch tradition will feel structurally familiar — same rigour, calibrated to North American admissions.',
    positioningBlurb:
      'Peel Region AP tutoring is thin: the local Mississauga / Brampton supply leans toward generalist test-prep franchises and individual freelancers at CAD $50–90/hr, with no biology specialism. Cerebrum brings the Indian small-batch coaching tradition (max 12, retrieval-heavy) with AIIMS-trained biology faculty as your dedicated year-long tutor, weekly written FRQ feedback against the College Board rubric, and ET-evening live classes (7–9 PM ET). Senior-faculty 1:1 from USD $1,800 for 12 hours — and if your family pays across two currencies, we make that easy.',
    schools: [
    ...
    faqs: [
      {
        ...
        answer:
          'Yes, in two practical ways. First, if you grew up with Indian academic culture, our AIIMS-trained biology faculty and small-batch coaching method will feel familiar — the rigour, the retrieval practice, the daily-discipline expectation. Second, we keep expectations honest: AP-5 is achievable for most committed students, but it is not a substitute for genuine biology depth, and we will say so. We do not over-promise, and the standard is rigorous without being unkind.',
      },
      {
        question:
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    heroBlurb:
      'Singapore’s AP Biology market is concentrated around Singapore American School (SAS) in Woodlands — the anchor with one of the deepest AP cohorts in Asia — and Stamford American International School (SAIS), which publicly reports 62% of its AP students scoring 4 or 5. Feeder cohorts come from GEMS World Academy, Hwa Chong International, NPS International, and the IB-primary UWC and ISS clusters where ambitious students add AP Biology for US-college applications. If you’re targeting the Ivy League, the UC system, Johns Hopkins, or Duke, a clean AP-5 in Biology is one of the strongest signals you can add. Live SGT evening classes (7–10 PM) fit SAS and SAIS schedules cleanly.',
    positioningBlurb:
      'Most local Singapore AP tutoring runs S$50–150/hr (~US$40–110/hr) through generalist agencies and a long tail of freelance undergraduates with no biology specialism. Cerebrum is structurally different: AIIMS-trained biology faculty as your dedicated year-long tutor, weekly written FRQ feedback against the College Board rubric, and the Indian small-batch coaching tradition (max 12) calibrated to retrieval practice and timed full-length mocks. SGT evening live classes (7–10 PM) slot cleanly into SAS, SAIS, and Hwa Chong International schedules. Senior-faculty 1:1 from US$1,800 for 12 hours — competitive once you compare like-for-like specialist depth.',
    schools: [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    faqs: [
      ...
      {
        question: 'How does Cerebrum compare to Hong Kong tutoring agencies on price and quality?',
        answer:
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    positioningBlurb:
      'Most AP tutoring in Shanghai splits between local Chinese-language agencies at CNY 500–1,500/hr (US$70–210/hr) and Western-style premium tutoring at US$250–500/hr — in both cases usually generalist tutors with mixed biology specialism. Cerebrum is structurally different: AIIMS-trained biology faculty as your dedicated year-long tutor, weekly written FRQ feedback against the College Board rubric, biology-only specialisation, and Indian small-batch coaching tradition (max 12) calibrated to retrieval practice. CST evening live classes (7–10 PM Shanghai time) slot cleanly into SAS, SHSID, and WLSA schedules. Senior-faculty 1:1 from US$1,800 for 12 hours — well below Western premium rates and comparable to the top local tier, with materially deeper biology pedagogy.',
    schools: [
    ...
    faqs: [
      ...
      {
        question:
          'How does Cerebrum compare to Shanghai’s local and Western tutoring agencies on price and quality?',
        answer:
          'Western-style premium agencies in Shanghai charge US$250–500/hr for senior tutors with broad academic backgrounds but mixed biology specialism; mid-range Western options run US$120–250/hr. Local Chinese-language agencies charge CNY 500–1,500/hr (US$70–210/hr) for tutors fluent in Mandarin and the Chinese-Western curriculum bridge, but again with mixed biology depth. Cerebrum is a biology-only specialist: AIIMS-trained biology faculty as your dedicated year-long tutor, weekly FRQ rubric calibration, and continuity across the full AP cycle. Senior-faculty 1:1 at US$1,800 for 12 hours works out to US$150/hr — well below Western premium rates and comparable to the top local tier, with materially deeper biology pedagogy.',
      },
      {
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    positioningBlurb:
      'Most AP tutoring in Beijing splits between local Chinese-language agencies at CNY 500–1,500/hr (US$70–210/hr), Western premium tutoring at US$250–500/hr, and freelance international-school teachers — in most cases generalist tutors with mixed biology specialism. Cerebrum is structurally different: AIIMS-trained biology faculty as your dedicated year-long tutor, weekly written FRQ feedback against the College Board rubric, biology-only specialisation, and Indian small-batch coaching tradition (max 12) calibrated to retrieval practice. CST evening live classes (7–10 PM Beijing time) slot cleanly into ISB and WAB schedules. Senior-faculty 1:1 from US$1,800 for 12 hours — well below Western premium rates and comparable to the top local tier, with materially deeper biology pedagogy.',
    schools: [
    ...
    faqs: [
      ...
      {
        question:
          'How does Cerebrum compare to Beijing tutoring agencies and freelance alumni tutors?',
        answer:
          'Western premium agencies in Beijing charge US$250–500/hr for senior tutors with broad academic backgrounds but mixed biology specialism. Local Chinese-language agencies charge CNY 500–1,500/hr (US$70–210/hr) for Mandarin-medium tutors with a strong Chinese-Western curriculum bridge but mixed biology depth. Freelance alumni tutors charge CNY 300–800/hr with variable expertise. Cerebrum is a biology-only specialist: AIIMS-trained biology faculty as your dedicated year-long tutor, weekly FRQ rubric calibration, and continuity across the full AP cycle. Senior-faculty 1:1 at US$1,800 for 12 hours = US$150/hr — well below Western premium rates and comparable to the top local tier, with materially deeper biology pedagogy.',
      },
      {
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    heroBlurb:
      "Faridabad's international-school cluster (Manav Rachna International, DPS Faridabad, Shri Ram Faridabad, Apeejay Faridabad, Modern DPS, Ryan International) layers AP Biology onto IBDP or CBSE Class 12 tracks — so whether your child is on an IB diploma or a CBSE base, AP slots in as the US-application layer. Faridabad sits closer to South Delhi than to central Gurgaon or Noida, which gives our South Extension hub a useful proximity advantage for the optional in-person consultations.",
    positioningBlurb:
      'Most AP Biology tutoring within reach of Faridabad is bundled into SAT / Common-App stacks tutored by rotating non-specialist staff at generalist test-prep agencies — most of them operating from Delhi-side branches rather than Faridabad itself. Cerebrum is structurally different: biology-only AIIMS-trained biology faculty as your dedicated year-long tutor, written FRQ feedback against the College Board rubric every week, IST evening live classes, and the option of in-person consultations at our South Extension hub (35-45 minutes from Faridabad via the new Faridabad-Noida-Ghaziabad Expressway off-peak). Our senior-faculty 1:1 starts at $1,800 (12 hours) ($150/hr).',
    schools: [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    addressRegion: 'Uttar Pradesh',
    heroBlurb:
      "Noida's AP Biology demand runs along the IT corridor — Sector 18 / 62 / 132 / 128, the Sector 50 and 93 residential clusters, and the Greater Noida international-school belt (Pathways Noida, Shiv Nadar School, Step by Step, Genesis Global, Lotus Valley, GD Goenka Public, Amity International Sector 44). Whether you're an IBDP or Cambridge IGCSE+A-Level student layering AP Biology for US college applications, or a CBSE Class 12 student dual-applying to Indian universities and US colleges, the programme fits around your school track. And if you like to scrutinise a tutoring service's methodology before committing, good — ours is built to stand up to exactly that.",
    positioningBlurb:
      "Most AP Biology tutoring in Noida is bundled into SAT / Common-App stacks tutored by rotating non-specialist staff at generalist test-prep agencies charging ₹2,500–4,500 per hour. Cerebrum is built on a different foundation: biology-only AIIMS-trained biology faculty as your dedicated year-long tutor, written FRQ feedback against the College Board rubric every week, IST evening live classes (so your child finishes by 7:30 PM regardless of which Noida sector you live in), and the option of in-person consultations at our South Extension hub (about 60 minutes via DND Flyway off-peak, longer at peak hours). Senior-faculty 1:1 from $1,800 for 12 hours ($150/hr) — well below US-based tutors' $150–400/hr Zoom rates.",
    schools: [
      'Pathways School Noida',
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    addressRegion: 'FL',
    heroBlurb:
      "Miami is South Florida's AP Biology hub — Design and Architecture Senior High (DASH), Miami Palmetto Senior, Coral Gables Senior, MAST Academy, Ransom Everglades, Gulliver Prep, and Palmer Trinity drive consistent AP-5 volume. If you're on a pre-med track in Weston, Davie, or Coral Springs, AP Biology is the natural anchor course.",
    positioningBlurb:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "If you're in Weston or Coral Springs on a pre-med track, we discuss: (a) target AP score (5 for college credit at UM, UF, FSU), (b) USABO bridge (for students targeting semifinal), (c) timeline (start sophomore summer for junior-year AP Bio). Most families here book the $1,800 senior-faculty package.",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "If you're in Chandler or Gilbert and thinking pre-med, we discuss: (a) target score (AP-5 for ASU Barrett Honors or out-of-state credit), (b) USABO bridge, (c) whether the student is at Basis (accelerated timeline) or a traditional school (standard junior-year AP Bio). Most families here book the senior-faculty 1:1 package.",
      },
      {
  ...
  },
  {
    ...
    addressRegion: 'CA',
    heroBlurb:
      "San Diego is a biotech-powered AP Biology market. Torrey Pines High School (ranked #1 STEM public in SD County), Canyon Crest Academy, La Jolla High, The Bishop's School, and Francis Parker drive AP-5 volume. If you're in the Sorrento Valley / Torrey Pines biotech corridor, you already know what real biology depth looks like — and that is the standard we coach to.",
    positioningBlurb:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'If you work in the biotech corridor, you already understand biology depth. We discuss: (a) AP-5 target + USABO semifinal bridge, (b) UCSD bio-research access for extracurriculars, (c) whether the student targets UC system or East Coast schools. Most families here book the senior-faculty 1:1 package.',
      },
      {
  ...
  },
  {
    ...
    addressRegion: 'CO',
    heroBlurb:
      "Denver is the Mountain West's strongest AP Biology market. Cherry Creek High School, ThunderRidge High School, Fairview High (Boulder), Kent Denver School, Colorado Academy, and Regis Jesuit anchor the AP-5 pipeline. If you're in Centennial, Lone Tree, or Highlands Ranch and thinking pre-med, AP Biology is the anchor course.",
    positioningBlurb:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "If you're in Centennial, Lone Tree, or Highlands Ranch and thinking pre-med, we discuss: (a) AP-5 target + CU Boulder or out-of-state pre-med, (b) USABO bridge, (c) Mountain Time scheduling. Most families here book the senior-faculty 1:1 package.",
      },
      {
  ...
  },
  {
    ...
    addressRegion: 'TX',
    heroBlurb:
      "Austin is Texas's fastest-growing AP Biology market. LASA (Liberal Arts and Science Academy), Westlake High School, Westwood High School (Round Rock), McNeil High School, and St. Stephen's Episcopal anchor the AP-5 pipeline. If you're in the Round Rock, Cedar Park, or Pflugerville tech corridor and thinking pre-med, AP Biology is the anchor course to get right.",
    positioningBlurb:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "If you're in the Round Rock / Cedar Park tech corridor, we discuss: (a) AP-5 target + UT Austin CNS pre-med or out-of-state, (b) USABO bridge, (c) Central Time scheduling. Most families here book the senior-faculty 1:1 package.",
      },
      {
  ...
  },
  {
    ...
    addressRegion: 'OR',
    heroBlurb:
      "Portland is the Pacific Northwest's secondary AP Biology market after Seattle. Lincoln High School, Catlin Gabel, Oregon Episcopal School, Lake Oswego High School, and Sunset High School (Beaverton) drive AP-5 volume. If you're in Beaverton or Hillsboro and thinking pre-med, AP Biology is the anchor course.",
    positioningBlurb:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "If you're in Beaverton or Hillsboro and thinking pre-med, we discuss: (a) AP-5 target + OHSU pipeline or out-of-state pre-med, (b) USABO bridge, (c) PT scheduling. Most families here book the senior-faculty 1:1 package.",
      },
      {
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    region: 'Philadelphia + Main Line + Magnet High Schools',
    timezone: 'ET (Eastern)',
    timezoneIana: 'America/New_York',
    addressRegion: 'PA',
    heroBlurb:
      'Philadelphia splits its strongest AP Biology talent between the suburban Main Line and the city magnet schools. Out along the R5, Lower Merion, Harriton, Radnor, and Conestoga (in Tredyffrin) run demanding AP Bio tracks; inside the city, Julia R. Masterman, Central High School, and the Girard Academic Music Program (GAMP) pull selective-admission students from every neighborhood. Our Philadelphia tutors keep students on the AP-5 path while leaving runway for the local pre-med pipelines at Penn, Drexel, and Jefferson.',
    positioningBlurb:
      'Main Line students typically carry a heavy AP load and need FRQ feedback their school sections rarely have time for; Masterman and Central students move fast but commute long hours across the city and value evening flexibility. We schedule 1:1 sessions in ET evenings and weekends, coach Campbell Biology end-to-end, and overlay the College Board FRQ rubric — the pattern that turns a strong school grade into a 5.',
    schools: [
      ...
      'Central High School',
      'Girard Academy Music Program (GAMP)',
    ...
    faqs: [
      {
        question: 'What is the best AP Biology tutor in Philadelphia?',
        answer:
          'Cerebrum offers 1:1 AP Biology tutoring in Eastern Time evenings and weekends with AIIMS-trained biology faculty, College Board–aligned curriculum, and FRQ rubric mastery. Our Philadelphia roster spans the Main Line (Lower Merion, Harriton, Radnor, Conestoga) and the city magnets (Masterman, Central, GAMP). AP annual programmes start at $2,500/yr; 1:1 from $40/hr.',
      },
      {
        question: 'How does AP Bio tutoring fit a Masterman or Central High School schedule?',
        answer:
          'Magnet-school students often commute long distances across Philadelphia and have packed weekdays. We schedule 90-minute sessions twice a week in ET evenings (7–9 PM) or weekend mornings, and we calibrate pace to your school’s AP Bio teacher so we reinforce rather than duplicate what is taught in class.',
      },
      {
        question: 'Do Main Line students at Lower Merion or Conestoga really need a tutor?',
        answer:
          'Lower Merion, Harriton, Radnor, and Conestoga all run strong, competitive AP Biology sections. A high school grade does not guarantee a 5 — the AP exam tests time-pressured MCQ and FRQ rubric skills that classroom assessments often under-drill. That FRQ gap is exactly what our 1:1 sessions close.',
      },
      {
        question: 'Does AP Biology help with Penn, Drexel, or Jefferson pre-med plans?',
        answer:
          'A 5 in AP Biology is a strong signal of biology readiness for the competitive pre-health tracks at Penn, Drexel, and Thomas Jefferson University. AP Bio credit is rarely accepted by medical schools as a prerequisite — students still take college biology — so we frame AP-5 as the foundation, not the substitute, for the pre-med pipeline.',
      },
      {
        question: 'Do you offer in-person tutoring on the Main Line or in Center City?',
        answer:
          'We coach 100% online via live video. This lets us match the best biology specialist to each student regardless of whether they are in Bryn Mawr, Wayne, or Center City. Families consistently tell us video 1:1 with a senior specialist beats in-person with a generalist.',
      },
      {
        question: 'How early should a Philadelphia student start AP Bio tutoring?',
        answer:
          'For a May exam, the ideal start is August or September of the academic year. Crash plans (8–12 weeks pre-exam) are possible but limit FRQ depth. Students aiming for USABO as well benefit from an October start to leave runway for the February Open.',
      },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    region: 'Nassau + Western Suffolk Counties',
    timezone: 'ET (Eastern)',
    timezoneIana: 'America/New_York',
    addressRegion: 'NY',
    heroBlurb:
      'Long Island is one of the most AP-intensive suburban markets in the country. The Nassau North Shore — Jericho, Syosset, Great Neck North and South, Roslyn, Manhasset — and Suffolk’s Half Hollow Hills consistently field deep AP Biology cohorts, and the region’s research culture (Intel/Regeneron Science Talent Search roots, Cold Spring Harbor’s DNA Learning Center) raises the bar on biology depth. Our Long Island tutors keep students on the AP-5 path while supporting the science-research electives many of these districts run.',
    positioningBlurb:
      'Long Island students often pair AP Biology with a multi-year science-research sequence, so they need a tutor who can engage with real lab questions, not just the textbook. Our senior faculty do both. We schedule 1:1 sessions in ET evenings and weekends around research and SAT commitments, coach Campbell Biology end-to-end, and drill the College Board FRQ rubric that separates a 4 from a 5.',
    schools: [
    ...
    faqs: [
      {
        question: 'What is the best AP Biology tutor on Long Island?',
        answer:
          'Cerebrum offers 1:1 AP Biology tutoring in Eastern Time evenings and weekends with AIIMS-trained biology faculty, College Board–aligned curriculum, and FRQ rubric mastery. Our Long Island roster spans the Nassau North Shore (Jericho, Syosset, Great Neck, Roslyn, Manhasset) and Suffolk (Half Hollow Hills, Ward Melville). AP annual programmes start at $2,500/yr; 1:1 from $40/hr.',
      },
      {
        question: 'How does AP Bio tutoring fit a Jericho or Syosset schedule?',
        answer:
          'Students in high-AP districts like Jericho, Syosset, and Great Neck often carry a heavy AP load plus a science-research sequence. We schedule 90-minute sessions twice a week in ET evenings (7–9 PM) or weekend mornings, and we calibrate pace to your school’s AP Bio teacher so we reinforce rather than duplicate classwork.',
      },
      {
        question:
          'Can you support a science-research student at Half Hollow Hills or Cold Spring Harbor?',
        answer:
          'Yes. Many Long Island students run a multi-year research sequence alongside AP Biology. Our senior faculty engage with the technical content — gel reads, primer design, qPCR data — and we adjust AP Bio pacing around lab and competition deadlines (Regeneron STS, JSHS).',
      },
      {
        question:
          'Is AP Biology worth it if my child already has high grades at Roslyn or Manhasset?',
        answer:
          'A strong school grade does not guarantee a 5 — the AP exam tests time-pressured MCQ and FRQ rubric skills that classroom assessments often under-drill. We regularly see students with school As score a 3 or 4 because they did not drill FRQ. That is the gap our 1:1 sessions close.',
      },
      {
        question: 'Do you offer in-person tutoring in Nassau or Suffolk?',
        answer:
          'We coach 100% online via live video. This lets us match the best biology specialist to each student regardless of which town they are in. Families consistently tell us video 1:1 with a senior specialist beats in-person with a generalist.',
      },
      {
        question: 'How early should a Long Island student start AP Bio tutoring?',
        answer:
          'For a May exam, the ideal start is August or September of the academic year. Students balancing a research sequence benefit from an even earlier start so AP review does not collide with competition season. Crash plans (8–12 weeks) are possible but limit FRQ depth.',
      },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    region: 'Fairfield County + Gold Coast',
    timezone: 'ET (Eastern)',
    timezoneIana: 'America/New_York',
    addressRegion: 'CT',
    heroBlurb:
      'Fairfield County — Connecticut’s Gold Coast — runs some of the best-resourced public high schools in the Northeast. Greenwich High School, Staples (Westport), Darien, New Canaan, Wilton, and Ridgefield all field strong AP Biology sections, and the corridor’s proximity to NYC means many families also weigh USABO and BS/MD pathways. Our Connecticut tutors keep students on the AP-5 path while supporting the heavy multi-AP loads typical of these districts.',
    positioningBlurb:
      'Fairfield County students often take 8+ APs across junior and senior year and need FRQ feedback their crowded school sections cannot always provide. We schedule 1:1 sessions in ET evenings and weekends around the demanding athletics and activities calendars common in Greenwich, Darien, and New Canaan, coach Campbell Biology end-to-end, and drill the College Board FRQ rubric that produces 5-scorers.',
    schools: [
    ...
    faqs: [
      {
        question: 'What is the best AP Biology tutor in Fairfield County, Connecticut?',
        answer:
          'Cerebrum offers 1:1 AP Biology tutoring in Eastern Time evenings and weekends with AIIMS-trained biology faculty, College Board–aligned curriculum, and FRQ rubric mastery. Our Connecticut roster spans Greenwich, Staples (Westport), Darien, New Canaan, Wilton, and Ridgefield. AP annual programmes start at $2,500/yr; 1:1 from $40/hr.',
      },
      {
        question: 'How does AP Bio tutoring fit a Greenwich or Staples schedule?',
        answer:
          'Students in Greenwich, Westport, Darien, and New Canaan typically carry a heavy AP load plus demanding athletics and activities. We schedule 90-minute sessions twice a week in ET evenings (7–9 PM) or weekend mornings, and we calibrate pace to your school’s AP Bio teacher so we reinforce rather than duplicate classwork.',
      },
      {
        question: 'Do New Canaan or Darien students really need an AP Bio tutor?',
        answer:
          'Darien, New Canaan, Wilton, and Ridgefield all run competitive AP Biology sections. A strong school grade does not guarantee a 5 — the AP exam tests time-pressured MCQ and FRQ rubric skills that classroom assessments often under-drill. That FRQ gap is exactly what our 1:1 sessions close.',
      },
      {
        question:
          'Does AP Biology help with Yale or competitive pre-med admissions from Connecticut?',
        answer:
          'A 5 in AP Biology is a strong signal of biology readiness for competitive pre-health tracks. AP Bio credit is rarely accepted by medical schools as a prerequisite — students still take college biology — so we frame AP-5 as the foundation, not the substitute, for the pre-med pipeline. For students who also want USABO, we run an integrated track.',
      },
      {
        question: 'Do you offer in-person tutoring in Greenwich or Westport?',
        answer:
          'We coach 100% online via live video. This lets us match the best biology specialist to each student regardless of which Fairfield County town they are in. Families consistently tell us video 1:1 with a senior specialist beats in-person with a generalist.',
      },
      {
        question: 'How early should a Connecticut student start AP Bio tutoring?',
        answer:
          'For a May exam, the ideal start is August or September of the academic year. Crash plans (8–12 weeks pre-exam) are possible but limit FRQ depth. Students also targeting USABO benefit from an October start to leave runway for the February Open.',
      },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    slug: 'columbus',
    cityName: 'Columbus',
    region: 'Central Ohio + Northern Suburbs',
    timezone: 'ET (Eastern)',
    timezoneIana: 'America/New_York',
    addressRegion: 'OH',
    pricingTier: 'standard',
    heroBlurb:
      'Central Ohio’s strongest AP Biology talent clusters in the northern suburbs of Columbus. Upper Arlington, Dublin Coffman and Dublin Jerome, Olentangy Liberty, Thomas Worthington, and New Albany all run rigorous AP Bio sections, and the gravity of Ohio State’s medical and research campus shapes how local families think about pre-med. Our Columbus tutors keep students on the AP-5 path while aligning to those districts’ AP calendars.',
    positioningBlurb:
      'Columbus-area AP Bio students often have strong classroom instruction but limited 1:1 FRQ feedback. We add that layer: Campbell Biology coached end-to-end plus the College Board FRQ rubric drilled against past exams. Sessions run in ET evenings and weekends — the same time zone as the school day — so there is no awkward scheduling around the East Coast.',
    schools: [
    ...
    faqs: [
      {
        question: 'What is the best AP Biology tutor in Columbus, Ohio?',
        answer:
          'Cerebrum offers 1:1 AP Biology tutoring in Eastern Time evenings and weekends with AIIMS-trained biology faculty, College Board–aligned curriculum, and FRQ rubric mastery. Our Columbus roster spans the northern suburbs — Upper Arlington, Dublin, Olentangy, Worthington, and New Albany. AP annual programmes start at $2,500/yr; 1:1 from $40/hr.',
      },
      {
        question: 'How does AP Bio tutoring fit a Dublin or Upper Arlington schedule?',
        answer:
          'Students in Dublin Coffman, Dublin Jerome, Upper Arlington, and Olentangy Liberty often carry a heavy AP load alongside activities. We schedule 90-minute sessions twice a week in ET evenings (7–9 PM) or weekend mornings, and we calibrate pace to your school’s AP Bio teacher so we reinforce rather than duplicate classwork.',
      },
      {
        question: 'Do strong students at New Albany or Thomas Worthington need a tutor?',
        answer:
          'New Albany, Thomas Worthington, and the Dublin schools all run competitive AP Biology sections. A strong school grade does not guarantee a 5 — the AP exam tests time-pressured MCQ and FRQ rubric skills that classroom assessments often under-drill. That FRQ gap is exactly what our 1:1 sessions close.',
      },
      {
        question: 'Does AP Biology help with Ohio State pre-med or BS/MD plans?',
        answer:
          'A 5 in AP Biology is a strong signal of biology readiness for competitive pre-health tracks, including Ohio State’s. AP Bio credit is rarely accepted by medical schools as a prerequisite — students still take college biology — so we frame AP-5 as the foundation, not the substitute, for the pre-med pipeline.',
      },
      {
        question: 'Do you offer in-person tutoring in Columbus?',
        answer:
          'We coach 100% online via live video. This lets us match the best biology specialist to each student regardless of which suburb they are in. Families consistently tell us video 1:1 with a senior specialist beats in-person with a generalist.',
      },
      {
        question: 'How early should a Columbus student start AP Bio tutoring?',
        answer:
          'For a May exam, the ideal start is August or September of the academic year. Crash plans (8–12 weeks pre-exam) are possible but limit FRQ depth.',
      },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    timezone: 'ET (Eastern)',
    timezoneIana: 'America/Detroit',
    addressRegion: 'MI',
    pricingTier: 'standard',
    heroBlurb:
      'Ann Arbor is a university town with an unusually research-literate high school population. Pioneer, Huron, and Skyline (the three Ann Arbor public highs), the independent Greenhills School, and the project-based Community High School all run strong AP Biology pathways, and the gravity of the University of Michigan’s medical and research campus shapes how local families approach biology. Our Ann Arbor tutors keep students on the AP-5 path while engaging with the lab questions many of these students bring back from U-M.',
    positioningBlurb:
      'Many Ann Arbor AP Bio students are connected to University of Michigan research through parents or summer programmes, so they need a tutor who can engage with real lab content, not just the textbook. Our senior faculty do both. We schedule 1:1 sessions in ET evenings and weekends around school and research, coach Campbell Biology end-to-end, and drill the College Board FRQ rubric.',
    schools: [
      'Pioneer High School',
      'Huron High School',
      'Skyline High School',
    ...
    faqs: [
      {
        question: 'What is the best AP Biology tutor in Ann Arbor?',
        answer:
          'Cerebrum offers 1:1 AP Biology tutoring in Eastern Time evenings and weekends with AIIMS-trained biology faculty, College Board–aligned curriculum, and FRQ rubric mastery. Our Ann Arbor roster spans Pioneer, Huron, Skyline, Greenhills, and Community High School. AP annual programmes start at $2,500/yr; 1:1 from $40/hr.',
      },
      {
        question: 'How does AP Bio tutoring fit a Pioneer or Huron schedule?',
        answer:
          'Pioneer, Huron, and Skyline students often carry a heavy AP load plus activities and, frequently, University of Michigan research connections. We schedule 90-minute sessions twice a week in ET evenings (7–9 PM) or weekend mornings, and we calibrate pace to your school’s AP Bio teacher so we reinforce rather than duplicate classwork.',
      },
      {
        question:
          'Can you support a research-active student connected to the University of Michigan?',
        answer:
          'Yes. Many Ann Arbor students work in or around U-M labs. Our senior faculty engage with the technical content — gel reads, plasmid maps, qPCR data — and adjust AP Bio pacing around lab hours, while keeping the May exam on track.',
      },
      {
        question: 'Is AP Biology worth it for a strong Greenhills or Community High student?',
        answer:
          'A strong school grade does not guarantee a 5 — the AP exam tests time-pressured MCQ and FRQ rubric skills that classroom assessments often under-drill. Project-based programmes like Community High build excellent conceptual depth but lighter timed-exam practice; that is exactly the gap our 1:1 sessions close.',
      },
      {
        question: 'Do you offer in-person tutoring in Ann Arbor?',
        answer:
          'We coach 100% online via live video. This lets us match the best biology specialist to each student regardless of location. Families consistently tell us video 1:1 with a senior specialist beats in-person with a generalist.',
      },
      {
        question: 'How early should an Ann Arbor student start AP Bio tutoring?',
        answer:
          'For a May exam, the ideal start is August or September of the academic year. Students balancing a research commitment benefit from an even earlier start. Crash plans (8–12 weeks) are possible but limit FRQ depth.',
      },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    slug: 'nashville',
    cityName: 'Nashville',
    region: 'Nashville + Williamson County',
    timezone: 'CT (Central)',
    timezoneIana: 'America/Chicago',
    addressRegion: 'TN',
    pricingTier: 'standard',
    heroBlurb:
      'Nashville pairs selective public magnets with strong independent and suburban schools. Hume-Fogg Academic Magnet and Martin Luther King Jr. Magnet (Pearl-Cohn) draw the city’s top academic students, the University School of Nashville anchors the independent side, and Ravenwood in Williamson County leads the fast-growing southern suburbs. With Vanderbilt’s medical campus in the city, pre-med ambition runs high. Our Nashville tutors keep students on the AP-5 path while aligning to those schools’ AP calendars.',
    positioningBlurb:
      'Nashville’s magnet students (Hume-Fogg, MLK) move fast but commute across the city and value evening flexibility, while Williamson County families at Ravenwood often pair AP Bio with a heavy activities load. We schedule 1:1 sessions in Central Time evenings and weekends, coach Campbell Biology end-to-end, and drill the College Board FRQ rubric that turns a strong school grade into a 5.',
    schools: [
    ...
    faqs: [
      {
        question: 'What is the best AP Biology tutor in Nashville?',
        answer:
          'Cerebrum offers 1:1 AP Biology tutoring in Central Time evenings and weekends with AIIMS-trained biology faculty, College Board–aligned curriculum, and FRQ rubric mastery. Our Nashville roster spans the magnets (Hume-Fogg, MLK), University School of Nashville, and Williamson County (Ravenwood, Brentwood, Franklin). AP annual programmes start at $2,500/yr; 1:1 from $40/hr.',
      },
      {
        question: 'How does AP Bio tutoring fit a Hume-Fogg or MLK Magnet schedule?',
        answer:
          'Magnet-school students often commute across Nashville and have packed weekdays. We schedule 90-minute sessions twice a week in Central Time evenings (7–9 PM) or weekend mornings, and we calibrate pace to your school’s AP Bio teacher so we reinforce rather than duplicate classwork.',
      },
      {
        question: 'Do Ravenwood or Brentwood students in Williamson County need a tutor?',
        answer:
          'Ravenwood, Brentwood, and Franklin all run competitive AP Biology sections in fast-growing Williamson County. A strong school grade does not guarantee a 5 — the AP exam tests time-pressured MCQ and FRQ rubric skills that classroom assessments often under-drill. That FRQ gap is exactly what our 1:1 sessions close.',
      },
      {
        question: 'Does AP Biology help with Vanderbilt or competitive pre-med plans?',
        answer:
          'A 5 in AP Biology is a strong signal of biology readiness for competitive pre-health tracks, including Vanderbilt’s. AP Bio credit is rarely accepted by medical schools as a prerequisite — students still take college biology — so we frame AP-5 as the foundation, not the substitute, for the pre-med pipeline.',
      },
      {
        question: 'Do you offer in-person tutoring in Nashville or Franklin?',
        answer:
          'We coach 100% online via live video. This lets us match the best biology specialist to each student regardless of whether they are in Nashville proper or Williamson County. Families consistently tell us video 1:1 with a senior specialist beats in-person with a generalist.',
      },
      {
        question: 'How early should a Nashville student start AP Bio tutoring?',
        answer:
          'For a May exam, the ideal start is August or September of the academic year. Crash plans (8–12 weeks pre-exam) are possible but limit FRQ depth.',
      },
    ],
