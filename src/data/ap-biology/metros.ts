...
export const apBiologyMetros: APBiologyMetro[] = [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    heroBlurb:
      "Lakeside School and Seattle's strong public AP cluster — Bellevue, International School, Mercer Island, Newport, Garfield — run rigorous AP Biology programmes. Many Seattle families also consider the BS/MD and biotech-research pipeline given the city\'s deep biotech industry (Fred Hutch, ISB, the largest national NEET chain Institute). Our Seattle programme runs in Pacific Time.",
    positioningBlurb:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'UW Biology is competitive at the college level — most Washington pre-meds and biotech students take college biology regardless of AP credit. AP-5 is foundational. The bigger value of strong AP Bio is research-readiness for Fred Hutch / ISB / the largest national NEET chain Institute internships during high school and college.',
      },
      {
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    faqs: [
      { question: 'Can Miami students do marine biology IAs alongside AP Biology prep?', answer: 'Yes — several Miami students combine AP Biology with marine-bio research at UM Rosenstiel School of Marine, Atmospheric, and Earth Science. We help students connect their AP Biology knowledge to marine-ecology research contexts, which strengthens both the AP exam performance and the college application narrative.' },
      { question: 'My family is in Weston / Coral Springs — what is the planning conversation?', answer: 'The Weston/Coral Springs South Asian corridor has strong pre-med culture. We discuss: (a) target AP score (5 for college credit at UM, UF, FSU), (b) USABO bridge (for students targeting semifinal), (c) timeline (start sophomore summer for junior-year AP Bio). Most Weston families book the $1,800 senior-faculty package.' },
      { question: 'Ransom Everglades or Gulliver Prep — does AP Bio differ?', answer: 'Both schools run rigorous AP Biology programmes. Ransom Everglades emphasises marine ecology (given its Key Biscayne proximity); Gulliver leans more toward molecular biology. We calibrate session content to whichever school\'s unit ordering your student follows.' },
      { question: 'How does Cerebrum compare to South Florida AP tutors?', answer: 'Miami-area AP Biology tutors typically charge $80–$150/hour. Cerebrum offers PhD-faculty 1:1 at $120–$150/hour with FRQ rubric mastery — the specific exam-technique layer that generic science tutors lack. Our Small-Batch at $40/hour is more accessible for families wanting group instruction.' },
      { question: 'ET evening sessions for Miami students?', answer: 'Standard small-batch: 7:00–9:00 PM ET weekday evenings. Weekend: 9:00–11:00 AM ET. 1:1 available at any ET slot. The 7 PM ET start works for students finishing after-school sports or research commitments by 5:30–6:00 PM.' },
    ],
  },
  {
    slug: 'phoenix',
    ...
    faqs: [
      { question: 'Basis Schools students — does Cerebrum add value on top of Basis\'s AP programme?', answer: 'Basis runs the most rigorous AP programme in the US — students often take 10+ APs. Our value-add is FRQ rubric precision: Basis teaches content comprehensively but moves fast, and students sometimes lose marks on FRQ technique rather than knowledge gaps. We drill the specific FRQ patterns that earn full marks.' },
      { question: 'My family is in Chandler / Gilbert — what is the planning conversation?', answer: 'The Chandler/Gilbert corridor (Intel, Microchip, Avnet families) has strong pre-med culture. We discuss: (a) target score (AP-5 for ASU Barrett Honors or out-of-state credit), (b) USABO bridge, (c) whether the student is at Basis (accelerated timeline) or a traditional school (standard junior-year AP Bio). Most Chandler families book the senior-faculty 1:1 package.' },
      { question: 'Arizona has no daylight saving time — does that affect scheduling?', answer: 'It simplifies it. MST is fixed year-round (GMT-7). Our sessions lock to MST, so there\'s no spring/fall clock-change disruption. During the school year, Arizona is the same as Pacific Time in winter and Mountain Time in summer relative to other US zones.' },
      { question: 'How does Cerebrum compare to Phoenix-area AP tutors?', answer: 'Phoenix-area AP Biology tutors charge $60–$120/hour. Cerebrum offers PhD-faculty 1:1 at $120–$150/hour with FRQ rubric mastery. Small-Batch at $40/hour. The FRQ technique layer is our differentiator — generic tutors teach content but rarely drill the rubric systematically.' },
      { question: 'MST evening sessions for Phoenix students?', answer: 'Standard small-batch: 6:30–8:30 PM MST weekday evenings. Weekend: 9:00–11:00 AM MST. 1:1 available at any MST slot.' },
    ],
  },
  {
    slug: 'san-diego',
    ...
    faqs: [
      { question: 'Torrey Pines or Canyon Crest students — does Cerebrum add value?', answer: 'Both schools run excellent AP Biology programmes. Our value-add is targeted FRQ rubric drilling and USABO bridge coaching. Torrey Pines students with Salk/Scripps research connections often want to connect AP content to their research context — we support that integration.' },
      { question: 'My family is in the Sorrento Valley biotech corridor — planning conversation?', answer: 'Biotech-corridor families (Illumina, Thermo Fisher, Pfizer) understand biology depth intuitively. We discuss: (a) AP-5 target + USABO semifinal bridge, (b) UCSD bio-research access for extracurriculars, (c) whether the student targets UC system or East Coast schools. Most SD biotech families book the senior-faculty 1:1 package.' },
      { question: 'How does Cerebrum compare to San Diego AP tutors?', answer: 'SD-area AP Biology tutors charge $70–$130/hour. Cerebrum offers PhD-faculty 1:1 at $120–$150/hour with FRQ rubric mastery. Small-Batch at $40/hour. The biotech-informed pedagogy is our differentiator for the Sorrento Valley cohort.' },
      { question: 'UCSD pre-med pipeline — does AP Biology help?', answer: 'AP Biology score of 5 earns credit at UCSD for BILD 1 (The Cell). More importantly, strong AP Bio performance demonstrates readiness for UCSD\'s rigorous biology major — a signal for pre-med advising and research-lab placement. We coach with the UCSD pipeline in mind.' },
      { question: 'PT evening sessions for San Diego students?', answer: 'Standard small-batch: 7:00–9:00 PM PT weekday evenings. Weekend: 9:00–11:00 AM PT. 1:1 available at any PT slot.' },
    ],
  },
  {
    slug: 'denver',
    ...
    faqs: [
      { question: 'Cherry Creek or ThunderRidge students — what does Cerebrum add?', answer: 'Both schools have strong AP Biology programmes in the Cherry Creek School District. Our value-add is FRQ rubric precision and USABO bridge coaching. Cherry Creek district students often compete in Colorado State Science Olympiad — our coaching complements that STEM trajectory.' },
      { question: 'My family is in Centennial / Lone Tree — planning conversation?', answer: 'The Centennial/Lone Tree/Highlands Ranch corridor has growing South Asian pre-med culture. We discuss: (a) AP-5 target + CU Boulder or out-of-state pre-med, (b) USABO bridge, (c) Mountain Time scheduling. Most families in this corridor book the senior-faculty 1:1 package.' },
      { question: 'Mountain Time scheduling for Denver students?', answer: 'Standard small-batch: 6:30–8:30 PM MT weekday evenings. Weekend: 9:00–11:00 AM MT. 1:1 available at any MT slot. MT fits well for students with after-school outdoor activities (skiing, hiking) in winter months.' },
      { question: 'How does Cerebrum compare to Denver-area AP tutors?', answer: 'Denver-area AP Biology tutors charge $60–$120/hour. Cerebrum offers PhD-faculty 1:1 at $120–$150/hour with FRQ rubric mastery. Small-Batch at $40/hour.' },
      { question: 'CU Boulder pre-med pipeline — does AP Biology help?', answer: 'AP Biology score of 5 earns credit at CU Boulder for EBIO 1210. Strong AP Bio performance signals readiness for CU\'s competitive Molecular, Cellular, and Developmental Biology (MCDB) programme — a key pre-med major. We coach with the CU pipeline in mind for Colorado-focused families.' },
    ],
  },
  {
    slug: 'austin',
    ...
    faqs: [
      { question: 'LASA or Westlake students — what does Cerebrum add?', answer: 'LASA is Austin\'s top STEM magnet; Westlake is the dominant comprehensive-school AP programme. Both have excellent AP Biology teachers. Our value-add is FRQ rubric drilling (the exam-technique layer) and USABO bridge coaching for students targeting the semifinal.' },
      { question: 'My family is in Round Rock / Cedar Park — planning conversation?', answer: 'The Round Rock/Cedar Park tech corridor (Apple, Samsung, Dell) has one of Texas\'s highest South Asian household densities. We discuss: (a) AP-5 target + UT Austin CNS pre-med or out-of-state, (b) USABO bridge, (c) Central Time scheduling. Most Round Rock families book the senior-faculty 1:1 package.' },
      { question: 'UT Austin pre-med pipeline — does AP Biology help?', answer: 'AP Biology score of 5 earns credit at UT Austin for BIO 311C. Strong AP Bio performance signals readiness for UT\'s competitive Biology or Biochemistry pre-med majors — a meaningful admissions signal for the College of Natural Sciences. We coach with the UT pipeline in mind for Texas-focused families.' },
      { question: 'How does Cerebrum compare to Austin-area AP tutors?', answer: 'Austin-area AP Biology tutors charge $60–$120/hour. Cerebrum offers PhD-faculty 1:1 at $120–$150/hour with FRQ rubric mastery. Small-Batch at $40/hour.' },
      { question: 'CT evening sessions for Austin students?', answer: 'Standard small-batch: 7:00–9:00 PM CT weekday evenings. Weekend: 9:00–11:00 AM CT. 1:1 available at any CT slot.' },
    ],
  },
  {
    slug: 'portland',
    ...
    faqs: [
      { question: 'Lincoln or Catlin Gabel students — what does Cerebrum add?', answer: 'Lincoln is Portland\'s top public IB/AP programme; Catlin Gabel is the leading independent school. Our value-add is FRQ rubric drilling and USABO bridge coaching. Portland\'s smaller AP Biology cohort means students benefit from the broader perspective our multi-city small batches provide.' },
      { question: 'My family is in Beaverton / Hillsboro — planning conversation?', answer: 'The Beaverton/Hillsboro corridor (Intel, Nike) has growing South Asian pre-med culture. We discuss: (a) AP-5 target + OHSU pipeline or out-of-state pre-med, (b) USABO bridge, (c) PT scheduling. Most Beaverton families book the senior-faculty 1:1 package.' },
      { question: 'OHSU pre-med pipeline — does AP Biology help?', answer: 'OHSU is Oregon\'s only medical school and extremely competitive for in-state applicants. AP Biology score of 5 earns credit at UO and OSU for introductory biology. Strong AP Bio performance signals science readiness for the OHSU pipeline — a meaningful signal in Oregon\'s small pre-med ecosystem.' },
      { question: 'How does Cerebrum compare to Portland-area AP tutors?', answer: 'Portland-area AP Biology tutors charge $55–$110/hour. Cerebrum offers PhD-faculty 1:1 at $120–$150/hour with FRQ rubric mastery. Small-Batch at $40/hour.' },
      { question: 'PT evening sessions for Portland students?', answer: 'Standard small-batch: 7:00–9:00 PM PT weekday evenings. Weekend: 9:00–11:00 AM PT. 1:1 available at any PT slot. Portland PT sessions can merge with Seattle and Bay Area small batches for a richer peer group.' },
    ],
  },
]
