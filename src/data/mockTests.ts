...
export const sampleQuestions: Question[] = [
  ...
  {
    id: 'q3',
    questionText: 'Which enzyme is responsible for joining Okazaki fragments during DNA replication?',
    options: [
...
export const mockTests: MockTest[] = [
  {
    ...
    seoMetadata: {
      ...
      description: 'Take free NEET Biology practice test on Cell Biology & Genetics. 15 questions, detailed solutions, performance analysis. Improve your NEET 2024 score.',
      keywords: ['NEET biology mock test', 'cell biology test', 'genetics practice test', 'free NEET test', 'biology questions NEET'],
  ...
  },
  {
    ...
    description: 'Quick 20-minute test focusing on plant physiology concepts. Test your knowledge of photosynthesis, respiration, and transport in plants.',
    ...
    seoMetadata: {
      ...
      description: 'Free plant physiology practice test for NEET. 10 questions on photosynthesis, respiration, transport. Quick 20-minute test with instant results.',
      keywords: ['plant physiology test', 'botany mock test', 'photosynthesis questions', 'NEET botany practice', 'plant biology test'],
  ...
  },
  {
    ...
    description: 'Collection of actual NEET questions from 2020-2023 focusing on human physiology. Excellent for understanding exam patterns.',
    ...
    seoMetadata: {
      ...
      description: 'Practice actual NEET human physiology questions from 2020-2023. 20 previous year questions with detailed solutions and exam pattern analysis.',
      keywords: ['NEET previous year questions', 'human physiology NEET', 'zoology previous papers', 'NEET 2020-2023 questions'],
...
export const testSeries: TestSeries[] = [
  {
    id: 'series-1',
    title: 'NEET 2024 Complete Biology Test Series',
    description: 'Comprehensive 12-week test series covering entire NEET Biology syllabus with weekly tests and detailed performance analysis.',
    slug: 'neet-2024-complete-biology-series',
    ...
    targetAudience: ['NEET 2024 aspirants', 'Class 12 students', 'Droppers'],
    features: [
    ...
    seoMetadata: {
      title: 'NEET 2024 Biology Test Series | 24 Mock Tests | Complete Preparation',
      description: 'Join NEET 2024 Biology Test Series. 24 comprehensive mock tests, weekly reports, video solutions. 3000+ students enrolled. Book now!',
      keywords: ['NEET 2024 test series', 'biology test series', 'NEET mock tests', 'biology preparation', 'test series online']
    }
  },
  {
    id: 'series-2',
    title: 'Topic-wise Biology Mastery Series',
    description: 'Focused test series targeting specific biology topics. Perfect for strengthening weak areas and concept building.',
    ...
    seoMetadata: {
      ...
      description: 'Master biology topics with focused test series. 15 topic-specific tests, adaptive difficulty, concept building approach. Start free trial!',
      keywords: ['topic wise biology tests', 'biology concept tests', 'NEET topic tests', 'biology mastery series']
    }
  }
]
