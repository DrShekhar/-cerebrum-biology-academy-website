...
export const mockTests: MockTest[] = [
  {
    ...
    description:
      'Comprehensive test covering cell biology fundamentals and genetic principles. Perfect for NEET 2027 preparation with detailed explanations.',
    ...
    seoMetadata: {
      ...
      description:
        'Take free NEET Biology practice test on Cell Biology & Genetics. 15 questions, detailed solutions, performance analysis. Improve your NEET 2027 score.',
      keywords: [
...
export const testSeries: TestSeries[] = [
  {
    id: 'series-1',
    title: 'NEET 2027 Complete Biology Test Series',
    description:
    ...
    targetAudience: ['NEET 2027 aspirants', 'Class 12 students', 'Droppers'],
    features: [
    ...
    seoMetadata: {
      title: 'NEET 2027 Biology Test Series | 24 Mock Tests | Complete Preparation',
      description:
        'Join NEET 2027 Biology Test Series. 24 comprehensive mock tests, weekly reports, video solutions. 3000+ students enrolled. Book now!',
      keywords: [
