...
const calculatePaymentOptions = (amount: number) => ({
  ...
  installment: {
    ...
    installments: [
      ...
      { amount: amount * 0.35, dueDate: '2 months after enrollment', description: 'Second installment' },
      { amount: amount * 0.35, dueDate: '4 months after enrollment', description: 'Final installment' }
    ],
    processingFee: 1000
  }
})
...
const class11BiologyModules: CurriculumModule[] = [
  {
    ...
    description: 'Introduction to diversity in the living world and basic principles of classification',
    duration: 32,
    topics: [
      'What is living?',
...
const class11BiologyFAQ: FAQ[] = [
  {
    ...
    answer: 'Class 11th Biology forms 50% of the NEET syllabus and establishes fundamental concepts. Topics like Cell Biology, Plant Physiology, and Biological Classification are heavily weighted in NEET. Mastering these concepts early provides a strong foundation for Class 12th topics and competitive exam success.',
    category: 'general',
    order: 1
  },
  {
    ...
    answer: 'Our integrated approach covers the complete NCERT syllabus while adding NEET-specific depth and practice. We provide board exam pattern questions alongside NEET-style MCQs, ensuring students excel in both areas without additional burden.',
    category: 'curriculum',
    order: 2
  },
  {
  ...
  },
  {
    ...
    answer: 'We recommend 2-3 hours daily: 1 hour for concept understanding, 1 hour for NCERT reading and diagrams, and 30 minutes for practice questions. Our course structure supports this with recorded lectures for flexible learning and doubt sessions for clarification.',
    category: 'general',
    order: 4
  },
  {
    ...
    answer: 'Our course includes 120+ hours of practical work covering all NCERT-prescribed experiments, microscopy sessions, dissections, field studies, and additional NEET-relevant practicals. Virtual labs supplement physical practicals for comprehensive learning.',
    category: 'curriculum',
    order: 5
  },
  {
    ...
    answer: 'Yes, we offer flexible joining with catch-up support. You\'ll receive recorded lectures for missed topics, personalized doubt sessions, and accelerated coverage plans. Our faculty ensures you\'re brought up to speed quickly without compromising learning quality.',
    category: 'admission',
    order: 6
  },
  {
    ...
    answer: 'We use multi-modal teaching: 3D animations for molecular processes, microscopic demonstrations, interactive models, step-by-step mechanism explanations, and extensive practice with varied question types. Each concept is reinforced through practical applications.',
    category: 'curriculum',
    order: 7
  },
  {
    ...
    answer: 'Complete package includes: Custom-designed textbooks aligned with NCERT, chapter-wise practice sheets, previous year NEET questions (topic-wise), practical lab manuals, quick revision notes, and access to digital content library with videos and interactive exercises.',
    category: 'program',
    order: 8
  },
  {
    ...
    answer: 'Weekly chapter tests, monthly comprehensive tests, quarterly NEET mock tests, and annual full syllabus tests. Each test includes detailed analysis, rank comparison, topic-wise performance insights, and personalized improvement strategies.',
  ...
  },
  {
    ...
    answer: 'Dedicated foundation modules, one-on-one mentoring sessions, basic concept reinforcement classes, peer study groups, parental counseling, and continuous progress monitoring. We ensure every student achieves their potential regardless of starting point.',
    category: 'support',
    order: 10
  }
]
...
const class11BiologyTestimonials: CourseTestimonial[] = [
  ...
  },
  {
    ...
    feedback: 'I was weak in Biology when I joined in Class 11th. The systematic approach and excellent faculty support transformed my understanding. The test series helped me identify weak areas early, and the doubt clearing sessions were incredibly helpful. Biology became my strongest subject by Class 12th.',
    rating: 5
  },
  {
    id: 'test-3',
    ...
    rank: 'NEET AIR 289',
    college: 'AFMC Pune',
    feedback: 'Starting NEET preparation from Class 11th at Cerebrum gave me a significant advantage. The comprehensive curriculum covered every detail, and the practical knowledge helped immensely in understanding complex processes. The faculty\'s expertise and personalized attention made all the difference.',
    rating: 5
  },
  {
    id: 'test-4',
    ...
    feedback: 'The two-year journey starting from Class 11th was perfectly planned. Each topic was covered with NEET perspective while ensuring board exam preparation. The biology practicals and regular assessments kept me consistently prepared. Highly recommend starting early with Cerebrum.',
    rating: 5
  }
]
...
export const class11BiologyData: CourseProgram = {
  ...
  description: 'Complete 2-year NEET Biology preparation starting from Class 11th. Foundation building + competitive exam readiness with integrated board preparation. Perfect launchpad for medical aspirations.',
  targetClass: '11th',
  duration: '2 years',
  teachingHours: 12,
  ...
  schedule: {
    daysPerWeek: 6,
    hoursPerDay: 2.5,
    timing: ['Morning Batch: 8:00 AM - 10:30 AM', 'Evening Batch: 4:00 PM - 6:30 PM', 'Weekend Intensive: 9:00 AM - 12:00 PM'],
  ...
  faculty: [
    {
      id: 'fac-003',
      name: 'Dr. Meena Patel',
      qualification: ['M.Sc Botany (Gold Medalist)', 'Ph.D Plant Taxonomy', 'CSIR-NET (JRF)', 'GATE Qualified'],
      experience: '15+ years',
      specialization: ['Plant Biology', 'Cell Biology', 'Taxonomy', 'NEET Biology Coaching', 'Research Methodology'],
      rating: 4.95,
    ...
    },
    {
      ...
      experience: '12+ years',
      specialization: ['Animal Biology', 'Cell Biology', 'Genetics', 'Evolution', 'Medical Entrance Coaching'],
      rating: 4.88,
  ...
  seoDescription: 'Start your NEET journey right with our Class 11th Biology comprehensive course. Expert faculty, complete curriculum coverage, practical training, and proven results. Enroll now for 2025-26 batch.'
}