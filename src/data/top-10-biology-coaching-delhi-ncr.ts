...
export const TOP_10_BIOLOGY_COACHING_DELHI_NCR: RankedItem[] = [
  ...
  {
    rank: 2,
    name: 'Allen Career Institute (Delhi NCR)',
    description:
      'National generalist chain with multiple Delhi NCR centres. Strong brand, large batch sizes, generalist Physics/Chemistry/Biology rotation.',
    score: 7.4,
    rating: 4.0,
    pros: [
    ...
    cons: [
      ...
      'Per-student success rate ~45% (not the top-ranker count they advertise)',
  ...
  {
    rank: 3,
    name: 'Aakash Institute (Delhi NCR)',
    description:
      'Established multi-subject chain with wide Delhi NCR centre coverage. Quality varies dramatically by centre.',
    score: 7.0,
    rating: 4.0,
    pros: [
    ...
    cons: [
      'Quality varies dramatically by centre (South Ex ≠ Rohini ≠ Dwarka)',
  ...
  {
    rank: 4,
    name: 'Physics Wallah (Delhi NCR Offline)',
    description:
      'Affordable online-first platform with developing Delhi NCR offline centres. Best for self-motivated students on tight budgets.',
    score: 6.6,
    rating: 4.1,
    pros: [
      'Most affordable price point in NCR',
      'Strong YouTube/recorded video library',
  ...
  {
    rank: 5,
    name: 'Resonance (Delhi NCR)',
    description:
      'Kota-origin chain extended to Delhi NCR. Pressure-based teaching culture suits some students, harms others.',
    score: 6.3,
    rating: 3.8,
  ...
  {
    rank: 6,
    name: 'FIITJEE (NEET Division)',
    description:
      'IIT-JEE specialist that runs NEET as a secondary programme. Strong on Physics, weak on Biology.',
    score: 5.9,
    rating: 3.9,
  ...
  {
    rank: 7,
    name: 'Vidyamandir Classes (VMC)',
    description:
      'Delhi-based mid-tier institute with balanced curriculum. Suits students who want decent quality at moderate price.',
    score: 5.7,
    rating: 3.8,
  ...
  {
    rank: 8,
    name: 'Narayana (Delhi NCR)',
    description:
      'South-Indian chain extending into Delhi NCR. Teaching style still adapting to NCR student profile.',
    score: 5.4,
    rating: 3.8,
  ...
  },
  {
    ...
    name: 'Unacademy (NEET)',
    description:
      'Online platform with no in-person mentorship. Quality varies dramatically by educator chosen.',
    score: 4.8,
    rating: 3.7,
  ...
  },
  {
    ...
    description:
      'Small Delhi NCR-area institutes. Quality varies dramatically — verify faculty credentials before enrolling.',
    score: 4.0,
    rating: 3.4,
    pros: [
      'Often have smaller batches than national chains',
