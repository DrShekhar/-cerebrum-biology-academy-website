...
export const cities: Record<CitySlug, CityConfig> = {
  ...
  kochi: {
    ...
    localHook:
      "Kochi is Kerala's commercial capital with India's highest literacy state (96%+). The IT corridor (Infopark, SmartCity) drives IB/ICSE demand. Kerala families are education-focused, English-fluent, and strongly aspire to medicine. IST evening sessions.",
  },
  'visakhapatnam-ib': {
    slug: 'visakhapatnam-ib',
    city: 'Visakhapatnam',
    country: 'India',
    countryCode: 'IN',
    ...
    timezoneAbbr: 'IST',
    currency: { code: 'INR', symbol: '₹' },
    pricing: { perHour: 2000, perHourText: '₹1,800–3,000/hr' },
    ibSchools: [
    ...
    localHook:
      "Vizag's Navy, steel (RINL), and pharma corridor drives international school demand. Oakridge International offers IB. Navy families maintain dual IB + NEET tracks. IST sessions.",
  },
  'mangalore-ib': {
    slug: 'mangalore-ib',
    city: 'Mangalore',
    ...
    localHook:
      "Mangalore has 5 medical colleges — highest in Karnataka outside Bangalore. Manipal (30 km) is India's premier private medical education hub. International school families keep IB + NEET dual-track. IST sessions.",
  },
  'surat-ib': {
    slug: 'surat-ib',
    city: 'Surat',
    ...
    pricing: { perHour: 2500, perHourText: '₹2,000–3,500/hr' },
    ibSchools: [
      'Fountainhead School (IB)',
      'P.P. Savani Cambridge International',
      'Delhi Public School Surat',
    ],
    neighbourhoods: ['Adajan', 'Vesu', 'Piplod', 'City Light', 'Athwa'],
    localHook:
      "Surat's diamond and textile industry families increasingly choose IB/Cambridge schools. Fountainhead School offers IB DP. The city's wealth drives premium education coaching demand. IST sessions.",
  },
  ...
  madrid: {
    ...
    timezoneAbbr: 'CET/CEST',
    currency: { code: 'EUR', symbol: '€' },
    pricing: { perHour: 60, perHourText: '€55–80/hr' },
    ibSchools: [
  ...
  barcelona: {
    ...
    localHook:
      "Barcelona's IB community is anchored by the American School of Barcelona and Benjamin Franklin International School — serving the tech, pharma, and creative-industry expat community. The city's 22@ tech district drives Indian-origin expat demand. CET evening sessions fit Catalan school schedules.",
  },
  milan: {
    slug: 'milan',
    city: 'Milan',
    ...
    localHook:
      "Milan's IB community is anchored by ASM and ISM — serving the fashion, finance, and pharmaceutical expat community. Università degli Studi di Milano medical school is the primary local target. CET evening sessions fit Italian school schedules.",
  },
  rome: {
    slug: 'rome',
    city: 'Rome',
    ...
    localHook:
      "Rome's IB community is anchored by St. Stephen's School and AOSR — serving the diplomatic (FAO, WFP, IFAD), Vatican, and UN agency expat community. Sapienza University of Rome medical school is the primary local target. CET evening sessions.",
  },
  lisbon: {
    slug: 'lisbon',
    city: 'Lisbon',
    ...
    currency: { code: 'EUR', symbol: '€' },
    pricing: { perHour: 55, perHourText: '€50–75/hr' },
    ibSchools: [
      "St. Julian's School",
    ...
    localHook:
      "Lisbon's IB community is growing rapidly — anchored by St. Julian's School and CAISL in the Cascais/Estoril corridor. Portugal's tech-visa ecosystem (Web Summit, startup ecosystem) drives increasing expat demand. WET evening sessions (same as GMT in winter).",
  },
  'sao-paulo': {
    slug: 'sao-paulo',
    city: 'São Paulo',
    ...
    timezoneAbbr: 'BRT (UTC-3)',
    currency: { code: 'BRL', symbol: 'R$' },
    pricing: { perHour: 350, perHourText: 'R$300–450/hr' },
    ibSchools: [
    ...
    localHook:
      "São Paulo's IB community is the largest in Latin America — anchored by Graded and St. Paul's School in the Morumbi/Jardins corridor. The wealthy Paulista business community drives pre-med aspirations. BRT evening sessions (6–9 PM São Paulo). Many SP IB students target US or UK medical pathways.",
  },
  'mexico-city': {
    slug: 'mexico-city',
    city: 'Mexico City',
    ...
    countryCode: 'MX',
    region: 'CDMX',
    timezoneAbbr: 'CST (UTC-6)',
    currency: { code: 'MXN', symbol: 'MX$' },
    pricing: { perHour: 1200, perHourText: 'MX$1,000–1,500/hr' },
    ibSchools: [
  ...
  'buenos-aires': {
    ...
    localHook:
      "Buenos Aires' IB community is anchored by Lincoln School and Belgrano Day School — serving the diplomatic and multinational expat community. USD pricing (Argentina's peso volatility makes local-currency impractical). ART evening sessions.",
  },
  bogota: {
    slug: 'bogota',
    city: 'Bogotá',
    ...
    localHook:
      "Bogotá's IB community is anchored by Colegio Nueva Granada (one of Latin America's top IB schools) in the Chicó/Usaquén corridor. The affluent northern Bogotá families drive pre-med aspirations via US university pipelines. COT sessions align with US Eastern Time.",
  },
  oslo: {
    slug: 'oslo',
    city: 'Oslo',
  ...
  helsinki: {
    ...
    ibSchools: [
      ...
      'Ressu Upper Secondary IB',
    ],
    neighbourhoods: ['Espoo', 'Kauniainen', 'Vantaa', 'Töölö', 'Kulosaari'],
    localHook:
      "Helsinki's IB community is anchored by ISH and Ressu Upper Secondary — serving the tech (Nokia, Supercell, Wolt), pharmaceutical, and diplomatic expat community. University of Helsinki medical school accepts IB. EET evening sessions (1 hour ahead of CET).",
  },
  auckland: {
    slug: 'auckland',
    city: 'Auckland',
    ...
    countryCode: 'NZ',
    region: 'Auckland',
    timezoneAbbr: 'NZST (UTC+12)',
    currency: { code: 'NZD', symbol: 'NZ$' },
    pricing: { perHour: 95, perHourText: 'NZ$80–120/hr' },
    ibSchools: [
      'Kristin School',
      'ACG Parnell College',
      'Rangitoto College IB',
      'Westlake Boys High School IB',
    ],
    neighbourhoods: ['Parnell', 'Remuera', 'Epsom', 'North Shore', 'Howick'],
    localHook:
      "Auckland's IB community is anchored by Kristin School and ACG Parnell — serving New Zealand's largest city. University of Auckland medical school is the primary target. NZST sessions (UTC+12) — our IST morning slots align with NZ evening.",
  },
  wellington: {
    slug: 'wellington',
    city: 'Wellington',
    ...
    pricing: { perHour: 95, perHourText: 'NZ$80–120/hr' },
    ibSchools: [
      'Scots College Wellington IB',
      'Wellington College IB',
      'Queen Margaret College IB',
    ],
    neighbourhoods: ['Kelburn', 'Karori', 'Khandallah', 'Lower Hutt', 'Petone'],
    localHook:
      "Wellington's IB community centres on Scots College and Wellington College — serving the diplomatic (New Zealand Parliament, embassies) and public-sector community. University of Otago medical school (Dunedin, with Wellington clinical campus) is the primary medical target. NZST evening sessions.",
  },
  cairo: {
    slug: 'cairo',
    city: 'Cairo',
    ...
    timezoneAbbr: 'EET (UTC+2)',
    currency: { code: 'USD', symbol: '$' },
    pricing: { perHour: 45, perHourText: '$40–60/hr' },
    ibSchools: [
    ...
    localHook:
      "Cairo's IB community is anchored by CAC in Maadi and BISC — serving the diplomatic, oil/gas, and multinational expat community. USD pricing (EGP volatility makes local currency impractical). EET evening sessions (UTC+2). Many Cairo IB students target UK Russell Group medical schools.",
  },
  amman: {
    slug: 'amman',
    city: 'Amman',
    ...
    localHook:
      "Amman's IB community is anchored by ABS and King's Academy (boarding, founded by King Abdullah II) — serving the diplomatic, UNRWA, and regional-HQ expat community. USD pricing. EET sessions. Many Amman IB students target UK/US medical pathways.",
  },
  johannesburg: {
    slug: 'johannesburg',
    city: 'Johannesburg',
    ...
    localHook:
      "Johannesburg's IB community is anchored by St. John's College and Crawford International — serving South Africa's business capital. The Sandton/Rosebank corridor has a growing Indian-origin community. University of Witwatersrand medical school is the primary local target. SAST sessions (UTC+2, same as EET).",
  },
  'cape-town': {
    slug: 'cape-town',
    city: 'Cape Town',
    ...
    ibSchools: [
      ...
      'Herschel Girls School (IB option)',
    ],
    neighbourhoods: [
      'Constantia',
      'Bishopscourt',
      'Camps Bay',
      'Sea Point',
      'Stellenbosch (commuter)',
    ],
    localHook:
      "Cape Town's IB community serves the tech, wine, and tourism industry expat community. University of Cape Town medical school (one of Africa's best) is the primary medical target. SAST sessions.",
  },
  nairobi: {
    slug: 'nairobi',
    city: 'Nairobi',
    ...
    timezoneAbbr: 'EAT (UTC+3)',
    currency: { code: 'USD', symbol: '$' },
    pricing: { perHour: 40, perHourText: '$35–55/hr' },
    ibSchools: [
    ...
    localHook:
      "Nairobi's IB community is anchored by ISK and Brookhouse — serving the UN (UNEP, UN-Habitat), diplomatic, and NGO expat community. The Karen/Lavington corridor drives IB demand. University of Nairobi medical school is the primary local target. EAT sessions (UTC+3).",
  },
  warsaw: {
    slug: 'warsaw',
    city: 'Warsaw',
    ...
    pricing: { perHour: 250, perHourText: 'zł 200–350/hr' },
    ibSchools: [
    ...
    localHook:
      "Warsaw's IB community is growing rapidly — anchored by the American School and British School. Poland's tech-sector growth (Google, Samsung, Amazon offices in Warsaw) drives increasing expat demand. Warsaw Medical University is the primary local target. CET evening sessions.",
  },
  prague: {
    slug: 'prague',
    city: 'Prague',
    ...
    pricing: { perHour: 1500, perHourText: 'Kč 1,200–2,000/hr' },
    ibSchools: [
    ...
    localHook:
      "Prague's IB community is anchored by ISP — one of Central Europe's oldest international schools. Charles University medical faculty is a popular pathway for English-language medical programmes. CET evening sessions.",
  },
  budapest: {
    slug: 'budapest',
    city: 'Budapest',
    ...
    timezoneAbbr: 'CET/CEST',
    currency: { code: 'EUR', symbol: '€' },
    pricing: { perHour: 50, perHourText: '€45–70/hr' },
    ibSchools: [
    ...
    localHook:
      "Budapest's IB community is anchored by AISB in District XII — serving the diplomatic, tech, and shared-services expat community. Semmelweis University medical school (English-programme) is a popular pathway for international students. CET evening sessions. EUR pricing.",
  },
  istanbul: {
    slug: 'istanbul',
    city: 'Istanbul',
    ...
    localHook:
      "Istanbul's IB community is the largest in Turkey — anchored by Robert College (one of the oldest American schools outside the US, founded 1863) and Koç School. The Bebek/Etiler/Levent corridor drives IB demand from Turkey's business elite. USD pricing (TRY volatility). TRT sessions (UTC+3).",
  },
  'tel-aviv': {
    slug: 'tel-aviv',
    city: 'Tel Aviv',
  ...
  doha: {
    ...
    countryCode: 'QA',
    region: 'Doha',
    timezoneAbbr: 'AST (UTC+3)',
    currency: { code: 'QAR', symbol: 'QR' },
    pricing: { perHour: 250, perHourText: 'QR 200–350/hr' },
    ibSchools: [
      'Qatar Academy Doha',
    ...
    localHook:
      "Doha's IB community is anchored by Qatar Academy and ASD — serving the energy sector, Al Jazeera, and Qatar Foundation expat community. Education City hosts branch campuses of Weill Cornell Medicine-Qatar and Georgetown-Qatar. AST sessions (UTC+3). QAR or USD pricing.",
  },
  riyadh: {
    slug: 'riyadh',
    city: 'Riyadh',
    ...
    localHook:
      "Riyadh's IB community is growing rapidly — anchored by AISR and BISR in the Diplomatic Quarter. Saudi Vision 2030 and NEOM drive increasing international school demand. The large Indian expat community (2.5M+ Indians in Saudi Arabia) creates NEET + IB dual demand. AST sessions (UTC+3). SAR or USD pricing.",
  },
}
