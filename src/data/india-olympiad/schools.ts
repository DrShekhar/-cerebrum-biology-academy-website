...
export const indiaOlympiadSchools: IndiaOlympiadSchool[] = [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    collegeContext:
      'Pathways Aravali graduates matriculate strongly to US T20 universities (Ivy+, Stanford, MIT, top liberal arts), UK Oxbridge / Imperial / Russell Group, Canadian universities (Toronto, McGill, UBC), Australian Group of Eight (Melbourne, Sydney, ANU), and selectively to Indian top-tier programmes (Ashoka, BITS Pilani, IISc BS Research for olympiad qualifiers). IB Diploma graduates here skew more strongly abroad than those of the average North Indian CBSE school.',
    paceAlignment:
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    collegeContext:
      'TSRS Aravali graduates matriculate strongly to US T20 universities (Ivy+, Stanford, MIT, top liberal arts), UK Oxbridge / Imperial / Russell Group, Canadian universities (Toronto, McGill, UBC), Australian Group of Eight, and selectively to Indian top-tier programmes (Ashoka, BITS Pilani, IISc BS Research — particularly attractive for INBO / IBO qualifiers). IB Diploma graduates split roughly evenly between abroad and India, with the abroad share slightly higher.',
    paceAlignment:
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    collegeContext:
      "Heritage Xperiential graduates matriculate strongly to US T20 universities (Ivy+, Stanford, MIT, top liberal arts), UK Oxbridge / Imperial / Russell Group, Canadian universities (Toronto, McGill, UBC), Australian Group of Eight, and selectively to Indian top-tier programmes (Ashoka, BITS Pilani, IISc BS Research). Graduates' inquiry-driven background lands particularly well in US research-oriented undergraduate programmes.",
    paceAlignment:
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    collegeContext:
      "Stonehill graduates matriculate strongly to US T20 universities (Ivy+, Stanford, MIT, top liberal arts), UK Oxbridge / Imperial / Russell Group, Canadian universities (Toronto, McGill, UBC), Australian Group of Eight, and selectively to Indian top-tier programmes (Ashoka, BITS Pilani, IISc BS Research — particularly attractive for INBO / IBO qualifiers given the school's Bangalore location). Graduates split roughly evenly between abroad and India biosciences pathways.",
    paceAlignment:
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    collegeContext:
      "Inventure graduates matriculate strongly to US T20 universities (Ivy+, Stanford, MIT, top liberal arts), UK Oxbridge / Imperial / Russell Group, Canadian universities (Toronto, McGill, UBC), and Indian top-tier programmes (Ashoka, BITS Pilani, IISc BS Research — INBO / IBO qualifiers find IISc particularly attractive given the school's Bangalore location). Graduates split roughly evenly between abroad and India biosciences pathways.",
    paceAlignment:
