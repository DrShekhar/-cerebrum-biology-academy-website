...
export const indiaOlympiadSchools: IndiaOlympiadSchool[] = [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    historyParagraphs: [
      ...
      'Because RK Puram families come from across South and South-West Delhi — Vasant Vihar, R K Puram, Munirka, Vasant Kunj, Safdarjung Enclave — commute fatigue is real for any after-school activity. Our 100% online format eliminates this. Live small-batch weekend sessions in IST mornings free up the rest of the day for board prep, NEET prep, or downtime, and recordings let students re-watch a complex topic (epistasis, chi-square interpretation, krebs cycle ATP accounting) without losing the live class discussion.',
    ],
    reputationBullets: [
      ...
      'Large Class 11-12 Science section with strong PCB representation',
      'Among the most consistent North Indian schools on the NSEB / INBO selection lists (per HBCSE publicly published lists)',
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    collegeContext:
      "Modern Barakhamba graduates matriculate strongly to AIIMS Delhi (for medicine), IIT Delhi (Biotech / Biological Sciences), IISc Bangalore (BS Research, particularly attractive for INBO / IBO qualifiers), BITS Pilani, the top Delhi University colleges (St Stephen's, Hindu, LSR for life sciences), and US T20 universities (Ivy+, Stanford, MIT, top liberal arts). Graduates are unusually well-distributed between India and abroad pathways, reflecting the school's bilingual urbane culture.",
    paceAlignment:
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    historyParagraphs: [
      ...
      "Sanskriti's small class sizes and academic intensity mean that students typically engage tutoring earlier than the average DPS or DAV student — many families come to us in Class 10 summer with the Class 11 NSEB cycle already on their radar. Our 100% online format works well here because it integrates with the other tutoring (NEET coaching, Olympiad maths, debate) that many Chanakyapuri families already run. Live small-batch weekend sessions, plus recordings, plus WhatsApp doubt resolution.",
    ],
    reputationBullets: [
      ...
      'Students drawn from civil-services, diplomatic, and academic communities',
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    schoolType: 'CBSE Premium',
    historyParagraphs: [
      'Vasant Valley School, established in 1990, is a co-educational CBSE-affiliated K-12 school in Vasant Kunj, South Delhi. The school is widely regarded as one of the most academically and culturally rigorous private schools in the National Capital Region (publicly reported in EducationWorld and the Times School Rankings) and serves families from across South Delhi. The campus combines a strong academic programme with an unusually deep arts, sports, and outdoor-education tradition.',
      "Vasant Valley's senior-school science programme is small relative to large CBSE schools — classes of 25-50 PCB students per year are typical — which makes for an intense, discussion-led classroom culture. The school's Biology faculty regularly orient interested students to the NSEB / INBO pathway. Per HBCSE's publicly available selection lists, Vasant Valley students appear in NSEB / INBO qualifier rosters in multiple years, and the school's own annual communications cite olympiad finalists across science and mathematics.",
      'Many Vasant Valley families also explore IB Diploma options for senior school (the school itself is CBSE), and a meaningful subset of students dual-track olympiad preparation with abroad-admission preparation. This shapes how students here think about biology olympiads — not just as an end in itself, but as a depth-builder that materially helps US / UK biosciences applications. Our coaching is olympiad-syllabus-aligned and we make that abroad-app-utility connection explicit during the year.',
    ...
    reputationBullets: [
      ...
      'Small senior-school PCB classes with high per-student attention',
      'Named on HBCSE NSEB / INBO selection lists in multiple years (publicly available)',
    ...
    collegeContext:
      "Vasant Valley graduates matriculate to AIIMS Delhi, IIT Delhi / Bombay (Biotech, Bioengineering, BS Biological Sciences), IISc Bangalore (BS Research — INBO / IBO qualifiers find this particularly attractive), BITS Pilani, top Delhi University colleges, Ashoka University (a popular destination for the school's liberal arts-inclined students), and US / UK universities (Ivy+, Stanford, MIT, Oxbridge, Imperial, top liberal arts). Graduates split roughly evenly between India and abroad pathways, with the abroad share noticeably above the average CBSE school.",
    paceAlignment:
    ...
    faqs: [
      ...
      {
        question:
          "Vasant Valley's classes are small — will my child find peers in your small-batch programme?",
        answer:
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    collegeContext:
      'Pathways Aravali graduates matriculate strongly to US T20 universities (Ivy+, Stanford, MIT, top liberal arts), UK Oxbridge / Imperial / Russell Group, Canadian universities (Toronto, McGill, UBC), Australian Group of Eight (Melbourne, Sydney, ANU), and selectively to leading Indian programmes (Ashoka, BITS Pilani, IISc BS Research for olympiad qualifiers). IB Diploma graduates here skew more strongly abroad than those of the average North Indian CBSE school.',
    paceAlignment:
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    collegeContext:
      'TSRS Aravali graduates matriculate strongly to US T20 universities (Ivy+, Stanford, MIT, top liberal arts), UK Oxbridge / Imperial / Russell Group, Canadian universities (Toronto, McGill, UBC), Australian Group of Eight, and selectively to leading Indian programmes (Ashoka, BITS Pilani, IISc BS Research — particularly attractive for INBO / IBO qualifiers). IB Diploma graduates split roughly evenly between abroad and India, with the abroad share slightly higher.',
    paceAlignment:
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    collegeContext:
      "Heritage Xperiential graduates matriculate strongly to US T20 universities (Ivy+, Stanford, MIT, top liberal arts), UK Oxbridge / Imperial / Russell Group, Canadian universities (Toronto, McGill, UBC), Australian Group of Eight, and selectively to leading Indian programmes (Ashoka, BITS Pilani, IISc BS Research). Graduates' inquiry-driven background lands particularly well in US research-oriented undergraduate programmes.",
    paceAlignment:
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    historyParagraphs: [
      ...
      'The Bandra / BKC / Juhu / Worli residential pattern means most DAIS parents are commute-sensitive on weekdays. Our 100% live online weekend small-batch format works well — Saturday or Sunday morning IST sessions, full recordings for missed sessions (family travel is common among DAIS families), and WhatsApp doubt resolution within 24 hours. The compact 2-3 hour weekly load fits alongside the IB DP workload.',
    ],
    reputationBullets: [
      'Established 2003 — Bandra Kurla Complex, Mumbai',
      "Consistently ranked India's top international school (EducationWorld)",
      "IB Diploma results average well above the global mean (per school's annual communications)",
    ...
    collegeContext:
      "DAIS graduates matriculate to the most selective US universities (Harvard, Yale, Princeton, MIT, Stanford, the Ivy+ band), UK (Oxbridge, Imperial, UCL, LSE), Canadian universities (Toronto, McGill, UBC), Australian Group of Eight, and selectively to Indian programmes (Ashoka, IISc BS Research). The school's matriculation record is the strongest in India (publicly reported); graduates skew strongly abroad, with biosciences pipelines through US pre-med and UK natural sciences.",
    paceAlignment:
      'DAIS students arrive at olympiad coaching with IB Biology HL depth at examiner-level standard already underway — our coaching focuses tightly on NSEB-specific format (90-min MCQ pace, NCERT-coverage chapters), and INBO long-form theory writing. Weekend small-batch (Saturday or Sunday morning IST) is the standard schedule. We coordinate around DP1 IA submission cycles and DP2 mock exam windows. DAIS students are unusually self-directed, which lets us run a higher-pace small-batch with deeper homework.',
    faqs: [
      {
        question:
          'DAIS is already academically the strongest IB school in India — what does outside olympiad coaching add?',
        answer:
          "Three things DAIS's IB classroom cannot fully scale at individual student level. First, NSEB-specific format (90-min MCQ pace, NCERT-coverage chapters that IB does not include). Second, structured INBO long-form theory writing under exam conditions. Third, the peer effect — discussion with NSEB / INBO candidates from other schools sharpens problem-solving in a way a single-school classroom cannot.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes — our weekend small-batch is intentionally compact (2-3 hours, Saturday or Sunday morning IST). DAIS students' self-direction lets us run higher-pace small-batches with deeper homework, so per-hour yield is unusually strong. We coordinate around IA submission deadlines and DP2 mock windows.",
      },
      {
        question: 'Do you coach NSEB Stage 1 and INBO Stage 2 together?',
        answer:
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    collegeContext:
      'Cathedral graduates matriculate to Mumbai medical colleges (KEM, GS Medical, Grant Medical, Seth GS Medical), AIIMS Delhi, IIT Bombay (for biotech / biosciences), IISc Bangalore, Ashoka University, US Ivy+ universities, UK Oxbridge / Imperial / Russell Group, and Canadian top universities. Graduates split roughly evenly between India professional pathways (medicine, law, finance) and abroad biosciences / liberal-arts programmes.',
    paceAlignment:
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    collegeContext:
      'ASB graduates matriculate strongly to US T20 universities (Harvard, Yale, Princeton, MIT, Stanford, the Ivy+ band, top liberal arts), UK (Oxbridge, Imperial, UCL, LSE), Canadian top universities, and selectively to Indian programmes (Ashoka, IISc BS Research for INBO / IBO qualifiers). The expat-heavy graduating classes skew strongly abroad; for Indian-passport-holding students, INBO / OCSC performance is a particularly strong pre-college signal.',
    paceAlignment:
    ...
    faqs: [
      ...
      {
        question: "How does your coaching adapt to ASB students' travel-heavy schedules?",
        answer:
          'Full session recordings, WhatsApp doubt resolution within 24 hours, and asynchronous past-paper review let students travel internationally for 1-3 weeks at a time without falling behind the batch. We have ASB students who attend live sessions from US summer or European holidays via Zoom.',
      },
      {
        question: 'Do you coach NSEB Stage 1 and INBO Stage 2 together?',
        answer:
      ...
      },
      {
        ...
        answer:
          'USD-denominated (which is convenient for the expat-heavy ASB community): Complete Olympiad Year $4,500 / year, 1:1 Elite Mentoring $90 / hour, Small-Batch Weekend $50 / hour (4-6 students). INR equivalents shown on the pricing page for Indian-passport-holding families paying locally.',
      },
      {
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    historyParagraphs: [
      ...
      "Stonehill's residential boarding component (a meaningful share of students are full-time residents) shapes scheduling. Our 100% live online weekend small-batch format fits the boarding-school weekend windows. Full recordings cover schedule conflicts (CAS trips, sport tournaments, Project Week), and WhatsApp doubt resolution within 24 hours keeps students connected between sessions. The compact 2-3 hour weekly load fits alongside the IB DP workload.",
    ],
    reputationBullets: [
    ...
    collegeContext:
      "Stonehill graduates matriculate strongly to US T20 universities (Ivy+, Stanford, MIT, top liberal arts), UK Oxbridge / Imperial / Russell Group, Canadian universities (Toronto, McGill, UBC), Australian Group of Eight, and selectively to leading Indian programmes (Ashoka, BITS Pilani, IISc BS Research — particularly attractive for INBO / IBO qualifiers given the school's Bangalore location). Graduates split roughly evenly between abroad and India biosciences pathways.",
    paceAlignment:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes. Our weekend small-batch (Saturday or Sunday morning IST, 2-3 hours) is built for boarding-school weekend windows. Full recordings cover schedule conflicts (CAS trips, sport tournaments, Project Week). WhatsApp doubt resolution within 24 hours keeps boarding students connected between sessions.',
      },
      {
        question: 'Do you coach NSEB Stage 1 and INBO Stage 2 together?',
        answer:
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    historyParagraphs: [
      ...
      "The Whitefield / Sarjapur / Outer Ring Road residential pattern is commute-dense in mid-week, so weekend coaching dominates. Our 100% live online weekend small-batch format works well — Saturday or Sunday morning IST sessions, full recordings for missed sessions (sport tournaments are common for Inventure students), WhatsApp doubt resolution within 24 hours. The compact 2-3 hour weekly load fits alongside the IB DP workload and the school's strong sports calendar.",
    ],
    reputationBullets: [
    ...
    collegeContext:
      "Inventure graduates matriculate strongly to US T20 universities (Ivy+, Stanford, MIT, top liberal arts), UK Oxbridge / Imperial / Russell Group, Canadian universities (Toronto, McGill, UBC), and leading Indian programmes (Ashoka, BITS Pilani, IISc BS Research — INBO / IBO qualifiers find IISc particularly attractive given the school's Bangalore location). Graduates split roughly evenly between abroad and India biosciences pathways.",
    paceAlignment:
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    reputationBullets: [
      ...
      'Large Class 11-12 PCB classes across campuses',
    ...
    collegeContext:
      'NPS Bangalore graduates matriculate strongly to NEET-route medical colleges (AIIMS Delhi, AIIMS Bengaluru, KMC, JIPMER, Bangalore Medical College and other top state colleges), IIT Bombay / Delhi / Madras (for Biotech / Biological Sciences), IISc Bangalore (BS Research — INBO / IBO qualifiers find this particularly attractive given the location), BITS Pilani, top Bangalore engineering colleges, and US / UK universities (Ivy+, Stanford, MIT, Oxbridge, Imperial). Graduates skew more strongly NEET than those of the average international school.',
    paceAlignment:
