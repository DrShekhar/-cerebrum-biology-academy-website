...
export const gamsatMetros: Record<string, GAMSATMetroConfig> = {
  melbourne: {
    ...
    keywords: [
      ...
      'GAMSAT tutor Deakin',
      'GAMSAT tutor Melbourne MD',
      'GAMSAT tutor Monash',
      'graduate medicine tutor Melbourne',
      'GAMSAT Section III Melbourne',
      'GAMSAT tutor Box Hill',
      'Indian Australian GAMSAT tutor Melbourne',
    ],
    heroSubtitle:
    ...
    medSchools: [
      {
        name: 'University of Melbourne MD',
        programmes: 'Doctor of Medicine (graduate entry, GAMSAT + interview)',
      },
      {
        name: 'Deakin University School of Medicine',
        programmes: 'MD (Geelong/Waurn Ponds, GAMSAT + MMI)',
      },
      {
        name: 'Monash University School of Medicine',
        programmes: 'MD (graduate entry stream, GAMSAT + interview)',
      },
      { name: 'La Trobe University', programmes: 'MD (Bendigo/Bundoora, regional pathway)' },
    ],
    timezoneSection:
      'All live sessions are timed for AEST. Standard Melbourne small-batch slot is 7:30 PM to 9:30 PM AEST on weekday evenings, with 10:00 AM to 12:00 PM AEST Saturday and Sunday options. Senior Faculty 1:1 can be scheduled at any AEST slot.',
    demographicSection: {
    ...
    faqs: [
      {
        question: 'Deakin or Melbourne MD — what GAMSAT Section III score is competitive?',
        answer:
          'Deakin typically requires GAMSAT overall 60+ with Section III 60+. Melbourne MD requires GAMSAT 62–65+ overall. Our coaching targets the Section III 65+ band — biology is where most candidates lose marks and where specialist coaching has the highest marginal return.',
      },
      {
        question: "I'm a working professional in IT — can I prepare for GAMSAT alongside my job?",
        answer:
          'Yes — this is our default Melbourne cohort. We schedule AEST evening sessions (7:30–9:30 PM) after standard work hours. The Self-Paced track ($A599) is designed for professionals who can study 8–10 hours/week over 4–6 months. The Small-Batch adds weekly live sessions for accountability.',
      },
      {
        question: 'March or September GAMSAT — which should I sit?',
        answer:
          'March is the dominant Australian sitting. Most Melbourne candidates start prep in November/December for a March sitting. September is a secondary option for retake candidates or those who missed March registration. We calibrate the study plan to whichever sitting you target.',
      },
      {
        question: 'Do you accept AUD payment?',
        answer:
          'Yes — AUD via Australian bank transfer (Commonwealth, ANZ, Westpac, NAB) or international Visa/Mastercard. INR via UPI/NEFT also available for Indian-origin candidates. Annual packages can be split across two AUD payments.',
      },
      {
        question: 'How does Cerebrum compare to Australian GAMSAT prep providers?',
        answer:
          'Australian GAMSAT providers charge A$1,000–A$3,000 for full-GAMSAT courses (all three sections). Cerebrum is a Section III biology specialist at A$599–A$1,799. Most Melbourne candidates pair us with a generalist for Section I (Reasoning) and Section II (Written Communication).',
      },
    ],
  },
  ...
  brisbane: {
    ...
    keywords: [
      'GAMSAT biology tutor Brisbane',
      'GAMSAT tutor Griffith',
      'GAMSAT tutor UQ',
      'GAMSAT tutor Bond',
      'graduate medicine tutor Brisbane',
      'GAMSAT Section III Brisbane',
      'Indian Australian GAMSAT tutor Brisbane',
    ],
    heroSubtitle:
    ...
    medSchools: [
      {
        name: 'Griffith University School of Medicine',
        programmes: 'MD (Gold Coast, GAMSAT + MMI)',
      },
      {
        name: 'University of Queensland Medical School',
        programmes: 'MD (graduate entry, GAMSAT + interview)',
      },
      {
        name: 'Bond University Medical Program',
        programmes: 'MD (accelerated, Gold Coast, GAMSAT-accepting)',
      },
    ],
    timezoneSection:
      'All live sessions are timed for AEST (same as Melbourne/Sydney). Standard Brisbane small-batch slot is 7:30 PM to 9:30 PM AEST on weekday evenings, with 10:00 AM to 12:00 PM AEST Saturday and Sunday options.',
    demographicSection: {
    ...
    faqs: [
      {
        question: 'Griffith, UQ, or Bond — what GAMSAT Section III score is competitive?',
        answer:
          'Griffith typically requires GAMSAT 58–60+ overall. UQ requires 60–63+. Bond accepts a broader range but is expensive (private university). Our coaching targets Section III 62+ to keep all three programmes in play.',
      },
      {
        question: "I'm on the Gold Coast — same sessions as Brisbane?",
        answer:
          'Yes — all sessions are online. Gold Coast candidates join the same AEST evening sessions. Griffith Medical School is on the Gold Coast campus, so many of our Brisbane-area candidates are actually Gold Coast-based.',
      },
      {
        question: 'Do you accept AUD payment?',
        answer:
          'Yes — AUD via Australian bank transfer or international Visa/Mastercard. INR also available for Indian-origin candidates.',
      },
      {
        question: 'March or September GAMSAT?',
        answer:
          'March is the dominant sitting in Australia. Brisbane candidates typically start prep in November/December. We calibrate the study plan to your target sitting.',
      },
      {
        question: 'How does Cerebrum compare to Australian GAMSAT prep?',
        answer:
          'Australian GAMSAT providers charge A$1,000–A$3,000 for all sections. Cerebrum is a Section III biology specialist at A$599–A$1,799. Most candidates pair us with a generalist for Section I and II.',
      },
    ],
  },
  ...
  dublin: {
    ...
    keywords: [
      ...
      'GAMSAT tutor UCC',
      'GAMSAT tutor UL',
      'graduate medicine tutor Dublin',
      'GAMSAT Section III Dublin',
      'GAMSAT Ireland',
      'Indian GAMSAT tutor Dublin',
    ],
    heroSubtitle:
    ...
    medSchools: [
      {
        name: 'RCSI (Royal College of Surgeons in Ireland)',
        programmes: 'Graduate Entry Medicine (GEM), GAMSAT + interview',
      },
      {
        name: 'UCC (University College Cork)',
        programmes: 'Graduate Entry Medicine, GAMSAT + MMI',
      },
      {
        name: 'UL (University of Limerick)',
        programmes: 'Graduate Entry Medical School, GAMSAT + interview',
      },
      {
        name: 'UCD (University College Dublin)',
        programmes: 'Graduate Entry Medicine (GAMSAT-accepting)',
      },
    ],
    timezoneSection:
    ...
    faqs: [
      {
        question: 'RCSI or UCC — what GAMSAT Section III score is competitive?',
        answer:
      ...
      {
        question: "I'm a tech professional at Google/Meta — can I prepare alongside my job?",
        answer:
      ...
      {
        question: 'Do I need the HPAT alongside GAMSAT for Irish programmes?',
        answer:
      ...
      {
        question: 'How does Cerebrum compare to Irish GAMSAT prep?',
        answer:
  ...
  edinburgh: {
    ...
    keywords: [
      'GAMSAT biology tutor Edinburgh',
      'GAMSAT tutor Edinburgh medical school',
      'GAMSAT tutor St Andrews',
      'GAMSAT tutor Glasgow',
      'graduate medicine tutor Scotland',
      'GAMSAT Section III Edinburgh',
      'GAMSAT Scotland',
      'Scottish graduate medicine GAMSAT',
    ],
    heroSubtitle:
    ...
    medSchools: [
      {
        ...
        programmes: 'MBChB (graduate entry stream, GAMSAT + interview)',
      },
      {
        name: 'University of St Andrews School of Medicine',
        programmes: 'BSc (Hons) + clinical years at partner schools',
      },
      {
        name: 'University of Glasgow School of Medicine',
        programmes: 'MBChB (graduate entry, ScotGEM programme)',
      },
      {
        name: 'University of Dundee School of Medicine',
        programmes: 'MBChB (graduate entry, GAMSAT-accepting)',
      },
    ],
    timezoneSection:
      'All live sessions are timed for GMT (BST during summer). Standard Edinburgh small-batch slot is 7:30 PM to 9:30 PM GMT on weekday evenings, with 10:00 AM to 12:00 PM GMT Saturday and Sunday options.',
    demographicSection: {
    ...
    faqs: [
      {
        question:
          'Edinburgh or Glasgow medical school — what GAMSAT Section III score is competitive?',
        answer:
          'Edinburgh Medical School requires GAMSAT 64+ overall with strong Section III. The ScotGEM programme (Glasgow/St Andrews) requires GAMSAT 60+. Dundee requires 58–62+. Our coaching targets Section III 65+ to keep all Scottish programmes competitive.',
      },
      {
        question: "I'm an NHS professional in Scotland — can I prepare alongside my shifts?",
        answer:
          'Yes — many Scottish GAMSAT candidates are NHS professionals (junior doctors, nurses, pharmacists, physiotherapists). We schedule GMT evening sessions (7:30–9:30 PM) to fit around standard NHS shift patterns. Weekend sessions accommodate those on rotating schedules.',
      },
      {
        question: 'What is the ScotGEM programme?',
        answer:
      ...
      },
      {
        ...
        answer:
          'Yes — GBP via UK bank transfer (Barclays, HSBC, Lloyds, NatWest, RBS) or international Visa/Mastercard. INR also available for Indian-origin candidates.',
      },
      {
        question: 'How does Cerebrum compare to UK GAMSAT prep providers?',
        answer:
          'UK GAMSAT providers charge £600–£1,500 for all three sections. Cerebrum is a Section III biology specialist at £399–£1,249. Most candidates pair us with a generalist for Section I (Reasoning) and Section II (Written Communication).',
      },
    ],
  },
  ...
  manchester: {
    ...
    keywords: [
      'GAMSAT biology tutor Manchester',
      'GAMSAT tutor Manchester medical school',
      'GAMSAT tutor Lancaster',
      'GAMSAT tutor Keele',
      'graduate medicine tutor Manchester',
      'GAMSAT Section III Manchester',
      'GAMSAT North West England',
    ],
    heroSubtitle:
    ...
    medSchools: [
      {
        name: 'University of Manchester Medical School',
        programmes: 'MBChB (graduate entry, GAMSAT + interview)',
      },
      {
      ...
      {
        name: 'Keele University School of Medicine',
        programmes: 'MBChB (graduate entry, GAMSAT-accepting)',
      },
      {
        name: 'University of Central Lancashire (UCLan)',
        programmes: 'MBBS (graduate entry pathway)',
      },
    ],
    timezoneSection:
      'All live sessions timed for GMT (BST during summer). Standard Manchester small-batch slot is 7:30 PM to 9:30 PM GMT on weekday evenings. Weekend: 10:00 AM to 12:00 PM GMT.',
    demographicSection: {
    ...
    faqs: [
      {
        question: 'Manchester Medical School — what GAMSAT Section III is competitive?',
        answer:
          'University of Manchester typically requires GAMSAT 62+ overall with strong Section III. Lancaster and Keele accept 58–62+. Our coaching targets Section III 63+ to keep all three North West programmes competitive.',
      },
      {
        question: "I'm an NHS professional in Manchester — can I prepare alongside shifts?",
        answer:
          'Yes — many Manchester GAMSAT candidates are NHS staff. We schedule GMT evening sessions (7:30–9:30 PM) after standard shifts. Weekend sessions accommodate rotating patterns.',
      },
      {
        question: 'Do you accept GBP payment?',
        answer:
          'Yes — GBP via UK bank transfer or international Visa/Mastercard. INR also available for Indian-origin candidates.',
      },
      {
        question: 'How does Cerebrum compare to Manchester GAMSAT providers?',
        answer:
          'UK GAMSAT providers charge £600–£1,500 for all sections. Cerebrum is a Section III biology specialist at £349–£1,099. Most candidates pair us with a generalist for Section I and II.',
      },
    ],
  },
  ...
  birmingham: {
    ...
    keywords: [
      'GAMSAT biology tutor Birmingham',
      'GAMSAT tutor Birmingham medical school',
      'GAMSAT tutor Warwick',
      'GAMSAT tutor Aston',
      'graduate medicine tutor Birmingham',
      'GAMSAT Section III Birmingham',
      'GAMSAT West Midlands',
    ],
    heroSubtitle:
    ...
    medSchools: [
      ...
      },
      {
        ...
        programmes: 'MB ChB (4-year graduate entry ONLY, GAMSAT + interview)',
      },
      { name: 'Aston Medical School', programmes: 'MBChB (graduate entry pathway)' },
      {
        name: 'University of Leicester (Midlands catchment)',
        programmes: 'MBChB (graduate entry, GAMSAT-accepting)',
      },
    ],
    timezoneSection:
      'All live sessions timed for GMT. Standard Birmingham small-batch slot is 7:30 PM to 9:30 PM GMT. Weekend: 10:00 AM to 12:00 PM GMT.',
    demographicSection: {
    ...
    faqs: [
      {
        question: 'Warwick Medical School — what GAMSAT score is competitive?',
        answer:
          'Warwick is among the most competitive GAMSAT programmes in the UK — median accepted GAMSAT is 65+. Our coaching targets Section III 66+ for Warwick candidates. Birmingham Medical School requires 62+; Leicester requires 60+.',
      },
      {
        question:
          "I'm a pharmacist in Birmingham considering graduate medicine — is this feasible?",
        answer:
          'Yes — pharmacists are one of the most common career-changer profiles in our Birmingham cohort. Your pharmacy degree provides strong biology foundations. Our coaching bridges the gap between pharmacy-level biology and GAMSAT Section III reasoning.',
      },
      {
        question: 'Do you accept GBP payment?',
        answer:
      ...
      {
        question: 'How does Cerebrum compare to Birmingham GAMSAT prep?',
        answer:
          'UK GAMSAT providers charge £600–£1,500 for all sections. Cerebrum is a Section III biology specialist at £349–£1,099. Most candidates pair us with a generalist for Section I and II.',
      },
    ],
  ...
  auckland: {
    ...
    keywords: [
      'GAMSAT biology tutor Auckland',
      'GAMSAT tutor Auckland',
      'GAMSAT tutor University of Auckland',
      'GAMSAT tutor Otago',
      'graduate medicine tutor New Zealand',
      'GAMSAT Section III Auckland',
      'GAMSAT New Zealand',
    ],
    heroSubtitle:
    ...
    medSchools: [
      {
        name: 'University of Auckland School of Medicine',
        programmes: 'MBChB (graduate entry, GAMSAT + MMI)',
      },
      {
        name: 'University of Otago (Dunedin + Auckland clinical campus)',
        programmes: 'MBChB (graduate entry, GAMSAT + interview)',
      },
    ],
    timezoneSection:
      'All live sessions timed for NZST (UTC+12). Standard Auckland small-batch: 7:30–9:30 PM NZST weekday evenings. Weekend: 10:00 AM–12:00 PM NZST. Our IST morning sessions align with NZ evenings.',
    demographicSection: {
    ...
    faqs: [
      {
        question: 'Auckland or Otago — what GAMSAT Section III is competitive?',
        answer:
          'University of Auckland typically requires GAMSAT 58–62+ overall. University of Otago requires similar. Our coaching targets Section III 63+ to keep both NZ programmes competitive.',
      },
      {
        question: "I'm a working professional in Auckland — can I prepare alongside work?",
        answer:
          'Yes — NZST evening sessions (7:30–9:30 PM) fit after standard work hours. Weekend sessions accommodate shift workers.',
      },
      {
        question: 'Do you accept NZD payment?',
        answer:
          'Yes — NZD via New Zealand bank transfer (ANZ NZ, ASB, BNZ, Westpac NZ) or international Visa/Mastercard.',
      },
      {
        question: 'How does Cerebrum compare to NZ GAMSAT prep?',
        answer:
          'NZ GAMSAT providers charge NZ$1,200–NZ$3,500 for all sections. Cerebrum is a Section III biology specialist at NZ$599–NZ$1,699. Most candidates pair us with a generalist for Section I and II.',
      },
    ],
  },
  ...
  wellington: {
    ...
    keywords: [
      'GAMSAT biology tutor Wellington',
      'GAMSAT tutor Wellington',
      'graduate medicine tutor Wellington',
      'GAMSAT Section III Wellington',
      'GAMSAT New Zealand Wellington',
    ],
    heroSubtitle:
    ...
    medSchools: [
      {
        name: 'University of Otago (Wellington clinical campus)',
        programmes: 'MBChB clinical years, research programmes',
      },
      { name: 'University of Auckland (remote application)', programmes: 'MBChB graduate entry' },
    ],
    timezoneSection:
      'All live sessions timed for NZST. Standard Wellington small-batch: 7:30–9:30 PM NZST. Weekend: 10:00 AM–12:00 PM NZST.',
    demographicSection: {
    ...
    faqs: [
      {
        question: 'Wellington vs Auckland — which medical school should I target?',
        answer:
          'Both use GAMSAT. University of Otago has a Wellington clinical campus for later years. University of Auckland is in Auckland. For Wellington-based candidates, Otago is the natural choice for local clinical placements.',
      },
      {
        question: 'Do you accept NZD payment?',
        answer: 'Yes — NZD via NZ bank transfer or international Visa/Mastercard.',
      },
      {
        question: 'How does Cerebrum compare to NZ GAMSAT prep?',
        answer:
          'NZ providers charge NZ$1,200–NZ$3,500 for all sections. Cerebrum is a Section III biology specialist at NZ$599–NZ$1,699.',
      },
    ],
  },
}
