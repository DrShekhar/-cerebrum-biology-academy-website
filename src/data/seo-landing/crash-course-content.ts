...
export const crashCourseSEOPages: Record<string, SEOLandingContent> = {
  ...
  'best-neet-crash-course': {
    ...
    cta: {
      ...
      subtitle: 'New batches start every week. Book your free assessment call to find the right crash course duration for your current preparation level.',
  ...
  'neet-crash-course-comparison': {
    ...
    cta: {
      ...
      subtitle: 'A 10-minute call with our academic counselor. We\'ll test your current level and recommend the perfect crash course duration. No pressure, no sales pitch.',
  ...
  'neet-biology-60-day-course': {
    ...
    cta: {
      ...
      subtitle: 'Only 12 seats per batch. Book your free diagnostic assessment to confirm the 60-day duration is right for your current level.',
  ...
  'neet-crash-course-fees': {
    ...
    cta: {
      ...
      subtitle: 'Quality doesn\'t mean expensive. Book a free counseling call to discuss the right plan for your budget and preparation level.',
