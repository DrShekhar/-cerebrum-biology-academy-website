...
export const crashCourseSEOPages: Record<string, SEOLandingContent> = {
  ...
  'best-neet-crash-course': {
    ...
    hero: {
      ...
      subheadline:
        "NEET is May 2, 2026. 500+ students chose Cerebrum's crash course over Aakash and Allen and online-first generalist platforms: 12-student batches, AIIMS faculty, 92% success rate. 30-day (₹14,999) and 45-day (₹34,999) batches starting NOW.",
      ...
      points: [
        {
          ...
          solution:
            'Cerebrum: Max 12 students per batch. Your teacher knows your weak chapters by name.',
        },
        {
          icon: '💸',
        ...
        },
        {
          ...
          solution:
            'Cerebrum: Average improvement of 80-120 marks. We focus on exam strategy, not just content.',
        },
      ],
    },
    benefits: {
      ...
      items: [
        {
          ...
          description:
            'Dr. Shekhar C Singh (Ph.D Botany, AIIMS-trained) teaches every batch personally. No junior faculty substitutions.',
        },
        {
          icon: '🎯',
          title: '12-Student Micro-Batches',
          description:
            'While Aakash and Allen run 60-100 student crash batches, we cap at 12. Every student gets daily doubt resolution.',
        },
        {
          icon: '📊',
          title: '92% Success Rate (Verified)',
          description:
            'Of 500+ crash course students over 3 years, 460+ scored above 550/720. Results verifiable with student names.',
        },
        {
          icon: '🧪',
          title: 'Biology-Only Specialization',
          description:
            "We don't teach Physics or Chemistry. 100% of our 4-5 daily hours go to Biology — your highest scoring subject.",
        },
      ],
    },
    stats: [
    ...
    testimonials: [
      {
        ...
        quote:
          "I tried a major national chain's crash course first — 80 students, zero personal attention. Switched to Cerebrum with 45 days left. Dr. Shekhar identified my weak areas in Day 1 and created a custom plan. Jumped from 520 to 678.",
        score: '678/720',
      },
      {
        name: 'Pooja Gupta',
        ...
        quote:
          'Compared 5 crash courses before choosing Cerebrum. The 12-student batch and daily PYQ practice made the difference. My Biology went from 130 to 172/180.',
        score: '642/720',
      },
      {
        name: 'Vikram Reddy',
        ...
        quote:
          "As a dropper, I needed a crash course that understood my gaps. Cerebrum didn't just repeat the syllabus — they pinpointed exactly which 15 chapters needed work and hammered them.",
        score: '615/720',
      },
    ],
    faqs: [
      {
        ...
        answer:
          'Three things: (1) AIIMS faculty teaching every batch personally — not junior teachers, (2) 12-student micro-batches where your teacher knows your weak chapters, and (3) 92% verified success rate over 500+ students. No other crash course in Delhi NCR offers all three.',
      },
      {
        question: 'How does Cerebrum compare to Aakash crash courses?',
        answer:
          'The Aakashs run 60-100 student crash batches, cost ₹40,000-80,000, and teach all 3 subjects (Physics, Chemistry, Biology). Cerebrum: 12-student batches, ₹14,999-34,999, Biology-only with 4-5 hours daily dedicated Biology teaching. Result: our students improve 80-120 marks vs 30-50 marks at chain coaching.',
      },
      {
        question: 'Which crash course duration should I choose?',
        answer:
          "NEET 2026 is on May 2. With ~40 days left, we offer: 30-day Sprint (₹14,999) if you have completed syllabus and need high-yield revision + mock exams. 45-day Intensive (₹34,999) if you need gap-filling + comprehensive revision with more personal attention. Book a free assessment — we'll recommend the right duration.",
      },
      {
        question: 'Is the crash course available online?',
        answer:
          'Yes, fully online with live interactive sessions (not recorded). Same AIIMS faculty, same 12-student batch, same daily tests. 70% of our crash course students are online. Recordings provided for revision. WhatsApp doubt support 7 AM - 11 PM.',
      },
      {
        question: 'What is the fee for the best NEET crash course?',
        answer:
          '30-day Sprint: ₹14,999. 45-day Intensive: ₹34,999. Both include study material, daily tests, mock exams, PYQ booklet, and WhatsApp doubt support. EMI available. Compare this to national NEET chains (₹45,000-60,000) or private tutors (₹1,500-3,000/hour). NEET is May 2 — enroll now.',
      },
      {
        question: 'Can I join if my basics are weak?',
        answer:
          'Yes, but we recommend the 90-day course. It includes a 2-week foundation bridge covering critical Class 11 concepts before intensive Class 12 + NEET revision. For very weak students, our 6-month program (₹45,000) is more suitable than a crash course.',
      },
    ],
    courseSummary: {
    ...
    cta: {
      ...
      subtitle:
        'New batches start every week. Book your free assessment call to find the right crash course duration for your current preparation level.',
      primaryButton: { text: 'Book Free Assessment', link: '/admissions' },
    },
    contactButtons: defaultContactButtons,
    toolsCTA: crashCourseToolsCTA,
    relatedPages: [
    ...
    schema: {
      ...
      provider: 'Cerebrum Biology Academy',
      description:
        'Ranked #1 NEET Biology crash course with 92% success rate, AIIMS faculty, and 12-student micro-batches',
      duration: '30-45 days',
      price: 14999,
      priceCurrency: 'INR',
    },
  ...
  'neet-crash-course-comparison': {
      ...
      points: [
        {
          ...
          solution:
            "If you've covered 80%+ syllabus: YES. Our 45-day plan focuses on high-weightage chapters (60% of marks from 15 chapters) + intensive PYQ practice.",
        },
        {
          icon: '⏳',
          question: 'Is 90 days too long for a crash course?',
          solution:
            'If starting from scratch or with weak basics: NO. Month 1 covers foundations, Month 2 full revision, Month 3 mock tests + exam strategy. Each day is purposeful.',
        },
        {
          icon: '💰',
          question: 'Should I pay more for a longer course?',
          solution:
            'Depends on your level. A 30-day sprint (₹14,999) with strong basics can be enough. If you have gaps, the 45-day intensive (₹34,999) gives deeper coverage. Take our free assessment to know your level.',
        },
      ],
    },
    benefits: {
      ...
      items: [
        {
          ...
          description:
            'Best for: Syllabus done, need revision + mock exams. Covers: Top 15 high-weightage chapters (60% of marks), daily PYQs, 10 full mocks. Result: Avg 50-80 marks improvement.',
        },
        {
          icon: '🎯',
          title: '45-Day Intensive (₹34,999) — Starting Now',
          description:
            'Best for: 60-80% syllabus done, gaps in 5-8 chapters. Covers: Complete syllabus revision, gap-filling, 15 mocks. Result: Avg 80-120 marks improvement.',
        },
        {
          icon: '📊',
          title: 'What About 60 or 90 Day Courses?',
          description:
            'With NEET on May 2, 2026, longer courses are no longer viable. If you have not covered the syllabus at all, join the 45-day batch immediately — it includes a foundation bridge in Week 1.',
        },
        {
          icon: '🏆',
          title: 'Not Sure? Free 10-Min Assessment',
          description:
            "Call us now. We'll test your current level in 10 minutes and recommend 30-day or 45-day. Every day you wait = 1 less day of preparation.",
        },
      ],
    },
    stats: [
    ...
    testimonials: [
      {
        ...
        quote:
          'I had good basics from school. The 45-day course was perfect — no wasted time on concepts I already knew. Pure revision + PYQ practice. Improved from 560 to 638.',
        score: '638/720',
      },
      {
        ...
        achievement: 'NEET 2024 - 612/720',
        quote:
          'I was a dropper with weak Class 11 basics. Needed the 90-day course to rebuild from scratch. Worth every rupee — went from 380 to 612. The first month of foundation was crucial.',
        score: '612/720',
      },
    ],
    faqs: [
      {
        ...
        answer:
          "Take our free 10-minute assessment. We'll evaluate your current Biology knowledge (Class 11 + 12), identify weak chapters, and recommend the optimal duration. 45-day if 80%+ prepared, 60-day if 60-80%, 90-day if below 60% or starting fresh.",
      },
      {
        question: 'Can I switch from 45-day to 90-day mid-course?',
        answer:
          "Yes! If you realize you need more time after starting a shorter course, you can upgrade by paying the difference. We'll seamlessly extend your program without restarting.",
      },
      {
        question: 'Is 45 days really enough to crack NEET?',
        answer:
          'If your foundation is solid (Class 11 + 12 syllabus covered once), yes. Our 45-day plan focuses on: (1) High-weightage 15 chapters = 60% marks, (2) Daily PYQ practice, (3) Exam strategy and time management. Students with good basics average 60-80 marks improvement.',
      },
      {
        question: 'What if I have 6 months — should I still do a crash course?',
        answer:
          "No. With 6 months, our regular 6-month program (₹45,000) is better — it covers everything at a sustainable pace. Crash courses are designed for students with less than 3 months remaining. Don't rush if you have time.",
      },
      {
        question: 'Do all durations have the same faculty?',
        answer:
          'Yes. Dr. Shekhar C Singh (AIIMS-trained, Ph.D Botany) teaches all crash course batches personally. Same quality of teaching across 45, 60, and 90-day programs. The only difference is depth and pace of coverage.',
      },
      {
        question: 'What is included in each crash course?',
        answer:
          'All durations include: live interactive classes (4-5 hrs/day), study material, daily chapter tests, full-length mock exams, PYQ booklet (10 years), WhatsApp doubt support (7 AM - 11 PM), and recorded class backup. Longer durations get more mock exams and revision cycles.',
      },
    ],
    courseSummary: {
    ...
    cta: {
      ...
      subtitle:
        "A 10-minute call with our academic counselor. We'll test your current level and recommend the perfect crash course duration. No pressure, no sales pitch.",
      primaryButton: { text: 'Book Free Assessment', link: '/contact' },
    },
    contactButtons: defaultContactButtons,
    toolsCTA: crashCourseToolsCTA,
    relatedPages: [
    ...
    schema: {
      ...
      provider: 'Cerebrum Biology Academy',
      description:
        'Compare NEET crash course durations side-by-side: fees, coverage, results, and who should choose which',
      duration: '30-45 days',
      price: 14999,
      priceCurrency: 'INR',
    },
  ...
  'neet-biology-60-day-course': {
      ...
      points: [
        {
          ...
          solution:
            'Week 1-2: Identify and fill specific gaps. Week 3-6: Full revision at NEET depth. Week 7-8: Mock exams + exam strategy.',
        },
        {
          icon: '⏰',
          question: 'Only 2 months left but need significant improvement?',
          solution:
            "60 days = 300+ hours of focused teaching. That's equivalent to 6 months of part-time coaching, compressed into daily 5-hour sessions.",
        },
        {
          icon: '📈',
          question: 'Scoring 450-550 and need 600+?',
          solution:
            "Our 60-day course is designed for exactly this range. Average improvement: 80-100 marks. We've seen students jump from 480 to 610.",
        },
      ],
    },
    benefits: {
      ...
      items: [
        {
          ...
          description:
            'Diagnostic test on Day 1. Identify weak chapters. Intensive coverage of Class 11 gaps (Cell Biology, Plant Anatomy, Biomolecules).',
        },
        {
          icon: '📚',
          title: 'Week 3-4: Class 11 Complete Revision',
          description:
            'All Class 11 chapters at NEET depth. Daily chapter tests. Focus on Diversity, Plant Physiology, Human Physiology basics.',
        },
        {
          icon: '📋',
          title: 'Week 5-6: Class 12 Complete Revision',
          description:
            'Genetics, Ecology, Reproduction, Biotechnology, Evolution. High-weightage chapter deep dives. Daily 100-MCQ practice.',
        },
        {
          icon: '🏆',
          title: 'Week 7-8: Mock Exams + Strategy',
          description:
            '8 full-length mock exams (NEET pattern). Detailed analysis after each mock. Time management training. Last-day strategy.',
        },
      ],
    },
    stats: [
    ...
    testimonials: [
      {
        ...
        quote:
          'The 60-day course was perfect for me. I had covered syllabus once in school but had gaps in Genetics and Ecology. Dr. Shekhar fixed those gaps in week 1-2, then the revision was smooth sailing. Went from 510 to 625.',
        score: '625/720',
      },
      {
        name: 'Kartik Mehta',
        ...
        quote:
          'I was confused between 45 and 90 days. The counselor recommended 60 after my assessment. Best decision — not too rushed, not too slow. Every day counted. Biology score: 162/180.',
        score: '598/720',
      },
    ],
    faqs: [
      {
        ...
        answer:
          "Students who: (1) Have covered 60-80% of the syllabus at least once, (2) Score 450-550 in mock tests, (3) Have specific weak chapters (not completely blank). If you're scoring below 400, consider the 90-day course. If above 550, the 45-day may suffice.",
      },
      {
        question: 'What is the daily schedule in the 60-day course?',
        answer:
          'Morning: 3-hour concept class (theory + diagrams). Afternoon: 1-hour PYQ practice session. Evening: 1-hour daily test + doubt clearing. Total: 5 hours of structured learning. Plus 2-3 hours of self-study with our material.',
      },
      {
        question: 'How much improvement can I expect in 60 days?',
        answer:
          'Based on 200+ students who took our 60-day course: Average improvement is 80-100 marks. Top performers improve 120-150 marks. Key factors: daily attendance, completing daily tests, and following the study plan. Students who attend 90%+ of classes improve the most.',
      },
      {
        question: 'What is the fee for the 60-day crash course?',
        answer:
          '₹19,999 (MRP ₹25,000). Includes: 300+ hours live teaching, study material, 4000+ MCQ bank, 8 mock exams, PYQ booklet, WhatsApp doubt support. EMI: ₹6,666/month for 3 months. Scholarship available for 85%+ scorers.',
      },
      {
        question: 'Is the 60-day course available online?',
        answer:
          'Yes, fully online with live interactive sessions. Same faculty, same batch size (12 students), same daily tests. 75% of our 60-day students choose online mode. Recordings provided for revision.',
      },
      {
        question: 'Can I start mid-month or do I need to wait for a batch?',
        answer:
          "New batches start every 2 weeks. You don't need to wait months. Contact us to know the next batch start date — usually within 3-7 days.",
      },
    ],
    courseSummary: {
    ...
    cta: {
      ...
      subtitle:
        'Only 12 seats per batch. Book your free diagnostic assessment to confirm the 60-day duration is right for your current level.',
      primaryButton: { text: 'Join 60-Day Course', link: '/admissions' },
    },
    contactButtons: defaultContactButtons,
    toolsCTA: crashCourseToolsCTA,
    relatedPages: [
    ...
    schema: {
      ...
      provider: 'Cerebrum Biology Academy',
      description:
        '60-day intensive NEET Biology crash course — the most popular duration for gap-filling and exam preparation',
      duration: '60 days',
      price: 19999,
      priceCurrency: 'INR',
    },
  ...
  'neet-crash-course-fees': {
    ...
    metaDescription:
      'NEET crash course fees: ₹14,999 (30-day) to ₹34,999 (45-day) at Cerebrum vs ₹40,000-80,000 at Aakash and Allen. NEET May 2 — enroll now. EMI, scholarships available.',
    keywords: [
      'neet crash course fees',
    ...
    hero: {
      ...
      subheadline:
        'Only ~42 days until NEET 2026. Our 30-day crash course starts at ₹14,999 — 70% less than Aakash and Allen. 45-day option at ₹34,999 for students who need deeper coverage. Both include AIIMS faculty and 12-student batches.',
      ...
      points: [
        {
          ...
          solution:
            'Cerebrum: ₹14,999-34,999 with 92% verified success rate. We prove ROI with student results, not marketing.',
        },
        {
          icon: '🔒',
          question:
            'Hidden costs — registration fee, material fee, test series fee charged separately?',
          solution:
            'Our price includes EVERYTHING: classes, material, tests, mock exams, doubt support. Zero hidden charges.',
        },
        {
          icon: '💳',
          question: "Can't afford full payment upfront?",
          solution:
            'EMI from ₹5,000/month. No credit card needed. No-cost EMI for 3-month split. Scholarship test for additional 10-30% discount.',
        },
      ],
    },
    benefits: {
      ...
      items: [
        {
          ...
          description:
            'Includes: 150+ hrs teaching, study material, 30 daily tests, 10 full mocks, PYQs, doubt support. Batch: 12 students. Faculty: AIIMS-trained.',
        },
        {
          icon: '🟢',
          title: 'Cerebrum 45-Day Intensive: ₹34,999 (Starting Now)',
          description:
            'Includes: 225+ hrs, 15 mock exams, 3000+ MCQs, gap analysis, complete syllabus revision. Batch: 12 students.',
        },
        {
          icon: '🟡',
          title: 'No More 60/90 Day Options',
          description:
            "NEET 2026 is May 2. With 42 days left, only 30-day and 45-day courses are available. Don't waste time on courses that end after the exam.",
        },
        {
          icon: '🔴',
          title: 'National NEET chain crash: ₹45,000-80,000',
          description:
            'All 3 subjects (Biology gets 1/3 time). Batch: 60-100 students. Material extra. No personal attention.',
        },
      ],
    },
    stats: [
    ...
    testimonials: [
      {
        ...
        quote:
          "We spent ₹4.5 lakhs at a major national NEET chain for 2 years with average results. Cerebrum's 90-day crash course at ₹27,999 gave better results. My son improved 180 marks. Cost per mark improvement: ₹155 at Cerebrum vs ₹2,500 at the chain.",
        score: '635/720',
      },
      {
        name: 'Shruti Pandey',
        ...
        quote:
          'I chose the 45-day course — honestly, I was skeptical that such quality was possible at this price. But it was unmatched. 12 students, AIIMS faculty, daily tests. Best investment of my NEET journey.',
        score: '618/720',
      },
    ],
    faqs: [
      {
        ...
        answer:
          "Three reasons: (1) We teach only Biology, not all 3 subjects — lower infrastructure cost, (2) We don't spend on TV ads and billboards — savings passed to students, (3) We run online classes — no massive real estate costs. Lower cost ≠ lower quality. Our 92% success rate is higher than most ₹80,000 crash courses.",
      },
      {
        question: 'What is included in the crash course fee?',
        answer:
          'Everything: live classes (4-5 hrs/day), printed study material, daily chapter tests, full-length mock exams, 10-year PYQ booklet, WhatsApp doubt support (7 AM-11 PM), recorded class backup, performance reports. No registration fee, no material fee, no hidden charges.',
      },
      {
        question: 'Do you offer EMI for the crash course?',
        answer:
          'Yes. 45-day: ₹5,000/month for 3 months. 60-day: ₹6,666/month for 3 months. 90-day: ₹9,333/month for 3 months. No credit card required. No interest. Simple bank transfer EMI.',
      },
      {
        question: 'Is there a scholarship for the crash course?',
        answer:
          'Yes. Take our scholarship test (free, 30 minutes). Score 80%+: 10% off. Score 90%+: 20% off. Score 95%+: 30% off. The test covers basic Class 11+12 Biology concepts. Available before every batch start.',
      },
      {
        question: 'Can I get a refund if I am not satisfied?',
        answer:
          'We offer a 7-day satisfaction guarantee. Attend classes for 7 days — if you are not satisfied with the teaching quality, we refund 100% of your fee. No questions asked. We are that confident in our crash course.',
      },
      {
        question: 'Is the online crash course fee the same as offline?',
        answer:
          'Yes, same fee for online and offline. Same faculty, same batch size, same material. Online students get additional benefit of recorded class backup. Most students (70%) prefer online as it saves commute time and cost.',
      },
    ],
    courseSummary: {
    ...
    cta: {
      ...
      subtitle:
        "Quality doesn't mean expensive. Book a free counseling call to discuss the right plan for your budget and preparation level.",
      primaryButton: { text: 'Get Fee Details', link: '/contact' },
    },
    contactButtons: defaultContactButtons,
    toolsCTA: crashCourseToolsCTA,
    relatedPages: [
    ...
    schema: {
      ...
      provider: 'Cerebrum Biology Academy',
      description:
        'NEET crash course fees starting ₹14,999. Compare pricing with Aakash and Allen. EMI available, scholarship up to 30%.',
      duration: '30-45 days',
      price: 14999,
      priceCurrency: 'INR',
    },
