...
export const cellBiologyQuestions: NEETQuestion[] = [
  {
    ...
    explanation:
      'Prokaryotic cells lack a membrane-bound nucleus. Their genetic material is present in the nucleoid region. All other options are characteristic features of prokaryotic cells.',
  ...
  },
  {
    ...
    explanation:
      'The fluid mosaic model describes the plasma membrane as a fluid lipid bilayer with proteins embedded in it. Both phospholipids and proteins can move laterally within the membrane, giving it fluid characteristics.',
...
export const assertionReasonQuestions: AssertionReasonQuestion[] = [
  {
    ...
    questionText:
      'Assertion (A): C4 plants are more efficient than C3 plants in hot and dry conditions.\nReason (R): C4 plants have evolved a mechanism to minimize photorespiration.',
    questionType: 'assertion-reason',
    difficulty: 'medium',
    ...
    explanation:
      'C4 plants are indeed more efficient in hot and dry conditions because they have evolved C4 cycle which concentrates CO2 around RuBisCO, minimizing photorespiration. The spatial separation of C4 and C3 cycles helps maintain efficiency.',
...
export const matchFollowingQuestions: MatchFollowingQuestion[] = [
  {
    ...
    explanation:
      'Cellulose provides structural support in plant cell walls, insulin is a hormone that regulates blood glucose, cholesterol maintains membrane fluidity, and DNA stores genetic information.',
...
export const diagramBasedQuestions: DiagramBasedQuestion[] = [
  {
    ...
    topicId: 'topic-cell-biology',
    questionText:
      'Identify the organelle labeled as X in the given diagram and select its primary function:',
    questionType: 'diagram-based',
    difficulty: 'medium',
    diagramUrl: '/images/cell-organelles-diagram.png',
    diagramDescription:
      'Plant cell diagram showing various organelles with X pointing to a double-membrane bound organelle with internal membranes',
    labelledParts: [{ id: 'x', name: 'Chloroplast', position: { x: 300, y: 200 } }],
    options: ['Protein synthesis', 'Photosynthesis', 'Cellular respiration', 'Lipid synthesis'],
    correctAnswer: 'Photosynthesis',
    explanation:
      'The organelle X is a chloroplast, identified by its double membrane structure and internal thylakoid membranes. Chloroplasts are the site of photosynthesis in plant cells.',
...
export const totalPhase1Questions = Object.values(phase1QuestionDistribution).reduce(
...
export const multipleCorrectQuestions: MultipleCorrectQuestion[] = [
  {
    ...
    correctAnswer: 'A, C, D',
    correctAnswers: ['Presence of nucleoid region', '70S ribosomes', 'Peptidoglycan cell wall'],
    maxSelections: 4,
    partialMarking: {
      fullMarks: 4,
      partialMarks: 2,
    ...
    explanation:
      'Prokaryotic cells have nucleoid region (not membrane-bound nucleus), 70S ribosomes, and peptidoglycan cell wall. They lack membrane-bound organelles and histones.',
    ncertReference: 'Class XI, Chapter 8, Page 134',
...
export const numericalQuestions: NumericalQuestion[] = [
  {
    ...
    topicId: 'topic-photosynthesis',
    questionText:
      'If a C3 plant fixes 6 molecules of CO2 during photosynthesis, how many molecules of glucose will be formed?',
    questionType: 'numerical',
    difficulty: 'medium',
    answerType: 'integer',
    correctAnswer: 1,
    ...
    explanation:
      'In photosynthesis, 6 molecules of CO2 are required to synthesize 1 molecule of glucose through the Calvin cycle.',
...
export const statementBasedQuestions: StatementBasedQuestion[] = [
  {
    ...
    explanation:
      'Glycolysis occurs in cytoplasm (Statement 1 correct). Electron transport chain produces maximum ATP, not Krebs cycle (Statement 2 incorrect). Glycolysis is anaerobic (Statement 3 incorrect). ETC occurs in mitochondrial inner membrane (Statement 4 correct).',
