      ...
      modules: [
        ...
        },
        {
          ...
          learningObjectives: [
            ...
            'Trace the respiratory pathway',
            'Understand gaseous exchange in alveoli',
          ],
        ...
        },
        {
          ...
          learningObjectives: [
            ...
            'Compare transport in plants and animals',
          ],
          practicalWork: [
            'Heart dissection study',
        ...
        },
        {
          ...
          learningObjectives: [
            'Explain nervous signal transmission',
            'Identify endocrine glands and their hormones',
            'Understand plant hormone responses',
            'Connect to NEET physiology topics',
          ],
        ...
        },
        {
          ...
          duration: 35,
          topics: [
            'Asexual reproduction modes — fission, budding, fragmentation, spore formation',
          ...
          learningObjectives: [
            ...
            'Build NEET-level reproductive biology foundation',
          ],
          practicalWork: [
            'Budding in yeast observation',
            'Pollen germination',
            'Flower dissection',
          ],
        },
        {
          ...
          learningObjectives: [
            ...
            'Understand natural selection and speciation',
            'Build foundation for NEET genetics',
          ],
        ...
        },
        {
          ...
          learningObjectives: [
            ...
            'Analyze environmental pollution',
            'Connect to NEET ecology',
          ],
        ...
        },
        {
          ...
          topics: [
            ...
            'Chipko movement and stakeholders',
          ],
          learningObjectives: [
            'Evaluate conservation strategies',
            'Understand sustainable development',
            'Analyze resource management challenges',
          ],
        ...
        },
        {
          ...
          learningObjectives: [
            'Score 90+ in board biology',
            'Master all question types',
            'Perfect diagram labeling',
          ],
        ...
        },
        {
          ...
          duration: 33,
          topics: [
            'NSEB Stage 1 pattern and strategy',
            'Advanced genetics problems',
            'Comparative physiology',
            'Ecology and environmental biology',
            'Data interpretation',
            'Scientific reasoning and experimental design',
            'Previous year NSEB analysis',
            'Mock olympiad tests',
          ],
          learningObjectives: [
            'Solve olympiad-level problems',
            'Qualify NSEB Stage 1',
            'Develop analytical thinking for NEET',
          ],
          practicalWork: [
            'Olympiad mock tests',
            'Scientific paper reading',
      ...
      modules: [
        ...
        },
        {
          ...
          learningObjectives: [
            ...
            'Differentiate between virus types',
            'Understand Whittaker classification basis',
          ],
        ...
        },
        {
          ...
          learningObjectives: [
            'Compare plant divisions',
            'Understand alternation of generations',
        ...
        },
        {
          ...
          topics: [
            'Basis of classification',
            'Phylum Porifera to Hemichordata',
            'Phylum Chordata',
            'Classes of vertebrates',
            'Salient features of each phylum',
            'Examples and identification',
          ],
          learningObjectives: [
            'Classify animals systematically',
            'Identify phylum-level features',
            'Master NEET-level animal diversity',
          ],
        ...
        },
        {
          ...
          topics: [
            'Root system types',
            'Stem modifications',
            'Leaf anatomy and venation',
            'Inflorescence types',
            'Flower parts and floral diagrams',
            'Fruit and seed types',
            'Plant families — Fabaceae, Solanaceae, Liliaceae',
          ],
          learningObjectives: [
            'Draw floral diagrams',
        ...
        },
        {
          ...
          learningObjectives: [
            'Differentiate dicot and monocot anatomy',
            'Explain secondary growth',
            'Draw anatomical cross-sections',
          ],
          practicalWork: [
        ...
        },
        {
          ...
          learningObjectives: [
            ...
            'Describe cockroach organ systems',
            'Understand comparative anatomy',
          ],
        ...
        },
        {
          ...
          learningObjectives: [
            ...
            'Explain crossing over significance',
            'Draw cell division stages',
          ],
        ...
        },
        {
          ...
          duration: 30,
          topics: [
            'Means of transport — diffusion, osmosis',
            'Plasmolysis',
            'Water potential',
          ...
          learningObjectives: [
            'Explain water potential concept',
            'Describe transpiration mechanism',
            'Understand mineral absorption',
          ],
          practicalWork: [
            'Osmosis experiment',
            'Transpiration measurement',
            'Xylem transport demonstration',
          ],
        },
        {
          id: 'c11-mod-12',
          ...
          learningObjectives: [
            'Classify essential minerals',
            'Explain light and dark reactions',
        ...
        },
        {
          ...
          topics: [
            ...
            'Double circulation',
            'ECG',
            'Disorders of circulatory and respiratory systems',
          ],
          learningObjectives: [
            'Explain complete digestion process',
            'Describe gas exchange mechanism',
            'Understand cardiac cycle and ECG',
          ],
          practicalWork: [
            'Spirometry basics',
        ...
        },
        {
          ...
          topics: [
            ...
            'Neural system — brain, spinal cord',
          ...
          learningObjectives: [
            'Explain urine formation mechanism',
            'Describe muscle contraction',
            'Understand nervous signal transmission',
            'Identify hormones and their functions',
          ],
          practicalWork: [
            'Bone and joint study',
            'Reflex action testing',
            'Eye and ear model study',
          ],
        },
      ],
    },
      ...
      modules: [
        ...
        },
        {
          ...
          topics: [
            ...
            'Post-fertilisation — seed and fruit',
        ...
        },
        {
          ...
          learningObjectives: [
            ...
            'Explain menstrual cycle hormonal control',
            'Trace embryonic development stages',
          ],
        ...
        },
        {
          ...
          learningObjectives: [
            ...
            'Understand ART techniques',
            'Analyse population control strategies',
          ],
        ...
        },
        {
          ...
          duration: 45,
          topics: [
            'Mendel laws — dominance, segregation, independent assortment',
          ...
          learningObjectives: [
            ...
            'Understand chromosomal disorders',
          ],
          practicalWork: [
        ...
        },
        {
          ...
          learningObjectives: [
            'Explain DNA replication mechanism',
        ...
        },
        {
          ...
          duration: 30,
          topics: [
            'Common diseases — typhoid, malaria, amoebiasis, ringworm',
          ...
          learningObjectives: [
            'Classify immune responses',
            'Understand vaccination mechanism',
            'Analyse disease prevention strategies',
          ],
        ...
        },
        {
          ...
          learningObjectives: [
            'Explain rDNA technology steps',
            'Describe PCR process',
            'Understand gene cloning vectors',
          ],
        ...
        },
        {
          ...
          duration: 25,
          topics: [
            'Bt crops — Bt cotton, Bt corn',
            'RNA interference',
            'Gene therapy',
            'Transgenic animals',
            'GMO applications in agriculture and medicine',
            'Bioethics and biosafety',
            'Biopiracy and patents',
          ],
          learningObjectives: [
            'Evaluate GMO applications',
            'Explain gene therapy mechanism',
            'Analyse bioethical issues',
          ],
        ...
        },
        {
          ...
          learningObjectives: [
            'Apply population growth equations',
            'Construct ecological pyramids',
            'Trace nutrient cycles',
          ],
        ...
        },
        {
          ...
          learningObjectives: [
            'Classify conservation strategies',
            'Analyse environmental issues',
            'Understand biodiversity importance for NEET',
          ],
