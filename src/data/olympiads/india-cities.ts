...
export const olympiadCities: OlympiadCityEntry[] = [
  {
    ...
    localContext:
      "Delhi consistently produces a disproportionate share of NSEB qualifiers relative to its student population — DPS RK Puram, Modern School Barakhamba, Springdales Pusa Road, and Mount Carmel between them typically send 40-60 students to the November NSEB paper annually, with historical qualification rates of 15-25% to INBO (above the 1% national average). The pattern holds because Delhi's CBSE-plus schools register early via IAPT and have biology faculty who actively push students toward olympiad prep alongside NEET. Our Delhi cohort runs with a bias toward Class 11 students who begin Campbell Biology in Q1 (July-August) and sit their first NSEB in November Class 11 — calibration attempt — then the serious attempt in Class 12. Sanskriti School and Vasant Valley students typically prefer 1:1 Elite mentoring due to school schedule density; DPS RK Puram and Modern cohorts often join our small-batch weekend programme at the South Extension centre.",
    commuteContext:
  ...
  },
  {
    ...
    localContext:
      "South Delhi has the highest IB/IGCSE/Cambridge school density in India, which creates a secondary olympiad pipeline — IB HL Biology students commonly layer NSEB onto their HL coursework because the 75-85% curriculum overlap makes it efficient. Schools like Vasant Valley, Shriram Aravali, Pathways, Mother's International, and Sardar Patel Vidyalaya contribute steadily to INBO qualification from this dual-track group. Our South Delhi cohort has a different profile from the wider Delhi group — more IB students, fewer pure-CBSE, and a higher proportion continue on to US/UK university applications where olympiad credentials carry weight. Programme schedule accommodates IB mock-exam season (Oct-Nov) and the NSEB November paper with staggered content — HL theme review in September, NSEB past-paper drills in October.",
    commuteContext:
  ...
  },
  {
    ...
    localContext:
      "Gurugram has India's most concentrated IB/Cambridge/CBSE-International cluster within a 15 km radius — Pathways World School Aravali, Scottish High, DPS International, Heritage Xperiential, GD Goenka Global, and Lancers International collectively host one of the densest olympiad-eligible student populations nationally. The pattern here leans heavily toward the IB-plus-olympiad dual track because 60%+ of Gurugram olympiad students are in IB HL Biology, where the Campbell overlap makes NSEB preparation almost a natural extension. Our Gurugram cohort's NSEB qualification rate sits 20-30% above national average largely because the school-level biology depth is stronger. Class 11 start in July is ideal; students in DLF Phase 1-5 and Sohna Road schools often join mid-Year-11 if they had NEET-focused prep earlier.",
    commuteContext:
  ...
  },
  {
    ...
    localContext:
      "Rohini and North Delhi have a strong CBSE cohort that has historically been NEET-focused rather than olympiad-track — students at Maharaja Agrasen Model, Rukmini Devi Public School, DPS Rohini, and MM Public School typically start olympiad prep as a NEET-strengthening exercise rather than a stand-alone goal. This is changing; over the last 3 years, Pitampura and Model Town schools have started pushing NSEB registration actively. Our Rohini cohort's NSEB qualification rate is catching up with South Delhi. Most students target NSEB in Class 12 after a dedicated Class 11 foundation year, and many use the Campbell depth for NEET rank improvement even if they do not clear INBO.",
    commuteContext:
  ...
  },
  {
    ...
    localContext:
      "Mumbai is one of India's top IB/Cambridge school markets — Dhirubhai Ambani International School, Bombay Scottish, Ecole Mondiale, Oberoi International, Jamnabai Narsee, Aditya Birla World Academy, and BD Somani International together host thousands of IBDP students. The IB-plus-olympiad dual track dominates Mumbai registrations — about 70% of our Mumbai cohort is in IB HL Biology. NSEB participation is lower than Delhi/Gurugram in absolute numbers but qualification rates per participant are high because IB HL students come in with stronger conceptual foundations. Mumbai students tend to target USABO or IBO alongside NSEB because their profile is often US-university-bound.",
    commuteContext:
  ...
  },
  {
    ...
    localContext:
      "Bangalore has India's second-largest IB/Cambridge cohort after Mumbai — Indus International, Inventure Academy, Canadian International, Stonehill International, Greenwood High, Ekya School, Trio World Academy, and Mallya Aditi International collectively feed NSEB, INBO, and IBO registrations. The Bangalore olympiad profile skews younger than Delhi — many students start olympiad prep in Class 9-10 because Bangalore IB schools actively introduce Campbell Biology in their pre-IB years. NSEB qualification rates from Bangalore IB schools have historically tracked 15-20% above national average. A secondary cluster from CBSE schools in Koramangala, HSR, Indiranagar, and Whitefield uses olympiad prep primarily as a NEET-rank improvement strategy.",
    commuteContext:
