...
const commonFaqsBase = (city: string) => [
  {
    ...
    answer:
      'Our Biology Olympiad programme runs primarily online across India so students from all cities can access the same senior biology tutors and past-paper archive. Offline classroom coaching is available at our Gurugram, South Extension (Delhi), and Faridabad centres. Students in other cities join the online batches.',
  },
  {
...
export const olympiadCities: OlympiadCityEntry[] = [
  {
    ...
    intro:
      "Delhi has one of India's highest olympiad-qualifying student concentrations, with DPS RK Puram, Modern School, Springdales, Mount Carmel, and other schools known for sending graduates to St Stephen's all registering students for NSEB every November. Our programme runs online with Delhi-timezone live classes and offline at our South Extension centre. Complete Campbell Biology coverage, weekly past-paper drills, and 1:1 mentoring with senior biology tutors.",
    ...
    localContext:
      "Delhi is one of India's highest-participation NSEB regions — DPS RK Puram, Modern School Barakhamba, Springdales Pusa Road, Mount Carmel, and Sanskriti all register Class 11-12 students every November via IAPT. Most of our Delhi students start Campbell Biology in the first quarter of Class 11 (July-August) — if that's you, the usual path is a first NSEB sitting in Class 11 as a calibration attempt, then the serious attempt in Class 12. Students at Sanskriti and Vasant Valley (heavy school-week loads) typically choose 1:1 Elite mentoring; students at DPS RK Puram and Modern (with more flexible schedules) often prefer our small-batch weekend programme at the South Extension centre.",
    commuteContext:
      'South Extension centre is accessible from most Delhi neighbourhoods within 25-40 minutes by metro. Pink Line connects directly from INA, Dhaula Kuan, and Rajiv Chowk. Yellow Line via Moolchand serves Greater Kailash, Saket, and Hauz Khas. Violet Line via Mandi House serves Central Delhi and ITO. For students in North and West Delhi (Rohini, Pitampura, Rajouri Garden), expect 45-60 min commute — most choose the online batches with optional Saturday intensives at the centre for lab practicals.',
  },
  {
    slug: 'south-delhi',
    city: 'South Delhi',
    ...
    intro:
      'South Delhi has the highest density of IB/IGCSE and CBSE olympiad-track schools in India. Our South Extension centre services Greater Kailash, Defence Colony, Saket, Vasant Kunj, Hauz Khas, Panchsheel Park, and Chanakyapuri. Complete Olympiad Year runs as a blended programme — offline intensive weekends plus online weekday classes shared with online-only students across India.',
  ...
  },
  {
    ...
    state: 'HR',
    pitch:
      'Gurugram Biology Olympiad coaching — offline at our Sector 51 centre plus online batches.',
    intro:
      "Gurugram has India's largest concentration of IB, Cambridge, and CBSE-International schools — these schools register heavily for NSEB and INBO every November. Our Sector 51 centre hosts offline olympiad programmes (DLF Phase 1-5, Sohna Road, Sector 51-56, Golf Course Road). Online batches available for students in Sectors 82+ or Manesar. See /biology-olympiad-coaching-gurugram for the detailed centre page.",
    ...
    localContext:
      "Gurugram has one of India's most concentrated IB/Cambridge/CBSE-International school clusters — Pathways World School Aravali, Scottish High, DPS International, Heritage Xperiential, GD Goenka Global, and Lancers International all sit within a 15 km radius. Most of our Gurugram students are in IB HL Biology; Campbell Biology is canonical for both IB HL and NSEB, so preparation runs in parallel rather than stacked. Class 11 start in July is ideal; students in DLF Phase 1-5 and Sohna Road who had NEET-focused prep earlier often join mid-Year-11 and follow a compressed track.",
    commuteContext:
      'Sector 51 centre (M2K Corporate Park) is 8-12 minutes from DLF Phase 5 via Golf Course Road, 15-18 minutes from DLF Phase 1-4 and Sohna Road, and 20-25 minutes from Sector 82-92 and Manesar. HUDA City Centre metro is 10 minutes away; Sector 53-54 metro is 5 minutes. Students in outer sectors (93+) or Manesar typically choose the online batches with optional Saturday intensives. The centre operates blended weekday-evening + Saturday schedules designed to fit around DPS Gurgaon, Pathways, and Scottish High term calendars.',
  },
  {
    slug: 'noida',
    city: 'Noida',
    ...
    intro:
      'Noida has a large base of CBSE and IB schools registering students for NSEB — Amity International, DPS Noida, Pathways Noida, Lotus Valley, and The Heritage School all send students to the olympiad every year. Our programme is online for Noida students with Delhi-timezone live classes; offline option available at our South Extension Delhi centre for students in Sectors 15-50 range.',
    schoolCatchment: [
    ...
    faqs: [
      ...commonFaqsBase('Noida'),
      {
        ...
        answer:
          'Currently our closest offline centres are at South Extension (Delhi) and Sector 51 (Gurugram). Noida Sectors 15-50 students often choose South Extension (30-45 min via DND). Greater Noida students typically opt for online classes due to distance. In-person lab practical sessions are scheduled during intensive weekends in Delhi.',
      },
    ],
    relatedLinks: [
      { label: 'NSEB coaching', href: '/nseb-coaching' },
    ...
    localContext:
      'Noida and Greater Noida have a fast-growing IB/Cambridge school scene — Amity International, DPS Noida, Pathways Noida, Lotus Valley, and The Heritage School send students to NSEB each November, though total participation is lower than Gurugram and South Delhi (historically 60-100 students across Noida schools). Many Noida families choose NSEB to strengthen US/UK college applications. Our Noida students tend to start later (Class 11 Q3 - Q4) because school NEET coaching fills the earlier months. Our programme includes a compressed 6-month sprint track for late-start Noida students targeting NSEB in their Class 12 year.',
    commuteContext:
      'No physical Cerebrum centre in Noida. Students in Sectors 15-50 can reach our South Extension Delhi centre in 35-50 min via DND Flyway. Greater Noida and Sectors 82+ students are too far for offline — the standard path is online classes with Saturday lab intensives (once monthly) scheduled at the Delhi centre. IST timezone matches the full Noida school day.',
  },
  {
    slug: 'faridabad',
    city: 'Faridabad',
    ...
    state: 'HR',
    pitch:
      'Faridabad Biology Olympiad coaching with offline centre at Sector 17 plus online batches.',
    intro:
      'Faridabad students benefit from our Sector 17 offline centre plus our national online batches. Key nearby schools include Delhi Public School Faridabad, Manav Rachna International School, Modern Delhi Public School, Apeejay, and Ryan International. Our programme is scheduled to avoid school hour conflicts and includes Saturday intensives for practical lab skills.',
    ...
    faqs: [
      ...commonFaqsBase('Faridabad'),
      {
        ...
        answer:
          'Our Sector 17 centre is 10-15 minutes from NIT Faridabad, Old Faridabad, and Sector 14-19 residential clusters. Greater Faridabad (Sector 80+) and Ballabhgarh students usually join the online batches.',
      },
    ],
    relatedLinks: [
      { label: 'NSEB coaching', href: '/nseb-coaching' },
    ...
    localContext:
      'Faridabad has a strong CBSE+International school cluster centred on DPS Faridabad, Manav Rachna International, Modern DPS, Apeejay, and Ryan International. NSEB participation has grown steadily year-over-year as more Faridabad schools formalise olympiad registration via IAPT. Many of our Faridabad students are serious NEET aspirants pursuing the olympiad track at the same time — a combination that suits our integrated programme design. NSEB qualification from Faridabad sits near the national 1% average with upward trajectory; our students from NIT Faridabad and Sector 14-19 cluster have historically tracked above average due to stronger school-level biology foundations.',
    commuteContext:
      'Sector 17 offline centre is 10-15 minutes from NIT Faridabad, Old Faridabad, and Sectors 14-19. Sector 21, 75, and 86 are 20-30 minutes. Greater Faridabad (Sector 80+), Ballabhgarh, and Surajkund students typically opt for online classes due to distance; monthly Saturday lab intensives at the centre cover practical skills. Students from Palwal or more distant NCR townships join online fully.',
  },
  {
    slug: 'rohini',
    city: 'Rohini',
    ...
    state: 'DL',
    pitch:
      'Rohini Biology Olympiad coaching — online batches for North Delhi students with offline option at South Extension.',
    intro:
    ...
    faqs: [
      ...commonFaqsBase('Rohini'),
      {
        ...
        answer:
          'Rohini East or West metro (Red Line) to Kashmere Gate (Yellow Line) to INA to Moolchand then Pink Line to South Extension — total journey 30-40 minutes. Most Rohini students join the online batches due to commute. Online live classes are scheduled to match Delhi school timings.',
      },
    ],
    relatedLinks: [
      { label: 'NSEB coaching', href: '/nseb-coaching' },
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Not currently. Mumbai students study with us fully online. For hands-on practical lab sessions we offer optional intensive weekends in Delhi twice a year (travel cost on student).',
      },
    ],
    relatedLinks: [
      { label: 'NSEB coaching', href: '/nseb-coaching' },
    ...
    localContext:
      "Mumbai is one of India's top IB/Cambridge school markets — Dhirubhai Ambani International School, Bombay Scottish, Ecole Mondiale, Oberoi International, Jamnabai Narsee, Aditya Birla World Academy, and BD Somani International are all IBDP centres. Most of our Mumbai students are in IB HL Biology and run NSEB as the parallel Indian credential. NSEB participation in Mumbai is smaller in absolute numbers than Delhi or Gurugram but IB HL students arrive with strong conceptual foundations. Mumbai students often target USABO or IBO alongside NSEB because many are applying to US universities.",
    commuteContext:
      "No offline Cerebrum centre in Mumbai; classes are fully online. Live weekday classes run 5:30-8:00 PM IST to avoid conflicts with mornings commute from Bandra, Powai, Navi Mumbai, and Thane. All sessions recorded for students in school-exam-week overlap. Twice-yearly Delhi lab intensive weekends available for students who want hands-on practical sessions — travel at student's cost.",
  },
  {
    slug: 'bangalore',
    city: 'Bangalore',
    ...
    intro:
      "Bangalore has one of India's largest IB and Cambridge school clusters. Indus International, Inventure Academy, Canadian International, Stonehill, Greenwood, and Ekya School all register students for NSEB and INBO. Our programme is online with Bangalore-timezone live classes and same curriculum depth as Delhi NCR students.",
    schoolCatchment: [
    ...
    localContext:
      "Bangalore has one of India's larger IB/Cambridge school clusters — Indus International, Inventure Academy, Canadian International, Stonehill International, Greenwood High, Ekya School, Trio World Academy, and Mallya Aditi International all register students for NSEB, INBO, and IBO. Bangalore students often start olympiad prep younger than their Delhi counterparts because Bangalore IB schools often introduce Campbell Biology in pre-IB years, so they arrive with a head start. A secondary CBSE cluster from Koramangala, HSR, Indiranagar, and Whitefield uses olympiad prep primarily as a NEET-rank improvement strategy.",
    commuteContext:
      "No offline centre in Bangalore; classes are fully online. Live weekday classes run 5:30-8:00 PM IST which works across Koramangala, Indiranagar, HSR, Whitefield, and Electronic City school evening windows. Weekend intensive blocks (Saturdays 10 AM - 1 PM IST) work for students at Inventure, Stonehill, Canadian International (which have later school days). Full session recording means traffic delays from Whitefield/E-City don't force missed classes.",
  },
  {
    slug: 'hyderabad',
    city: 'Hyderabad',
    ...
    intro:
      'Hyderabad has a growing IB and CBSE-International school cluster — Chirec International, Oakridge International, Glendale Academy, Indus International, Meridian School. Our online programme serves Hyderabad students with IST live classes and full Campbell coverage.',
    schoolCatchment: [
    ...
    localContext:
      'Hyderabad has a growing IB/Cambridge cluster centred on Banjara Hills, Jubilee Hills, HITEC City, and Gachibowli — Chirec International, Oakridge International, Glendale Academy, Indus International Hyderabad, Meridian School, and DPS Secunderabad send the most students. NSEB registration from Hyderabad IB schools has grown year-over-year as schools formalise IAPT submissions. As in Bangalore, students are a mix of IB-track dual aspirants and CBSE NEET aspirants using olympiad prep for rank improvement. Class 11 start is most common; students at Chirec and Oakridge often combine NSEB prep with USABO/IBO targets because of international school orientation.',
    commuteContext:
      'No offline Cerebrum centre in Hyderabad; classes are fully online. Live classes scheduled 5:30-8:00 PM IST which fits standard Banjara Hills / Jubilee Hills school evening windows. HITEC City and Gachibowli students with traffic-heavy commutes rely on recordings. Twice-yearly Delhi lab intensive weekends available for hands-on practical sessions.',
  },
  {
    slug: 'chennai',
    city: 'Chennai',
    ...
    localContext:
      "Chennai has a concentrated IB/Cambridge cluster along ECR, Adyar, and Nungambakkam — American International School Chennai, British International, Good Shepherd International, Sishya School, and Padma Seshadri Bala Bhavan (IBDP track) send the most students. Distinctively, many Chennai students pair NSEB prep with SAT/US-college application preparation, because many Chennai IB students are US-bound. A significant group of our Chennai students pursue USABO or BBO alongside NSEB for dual credentialing. NSEB participation numbers are modest in absolute terms but qualification rates per participant are above average, especially from AISC and KC High.",
    commuteContext:
      'No offline Cerebrum centre in Chennai; classes are fully online. Live classes scheduled 5:30-8:00 PM IST which works across Adyar, ECR, T Nagar, Nungambakkam, Anna Nagar, and OMR school windows. OMR students with longer commutes use recordings. Saturday 10 AM IST weekend intensives match Chennai Class 12 weekend coaching schedules.',
  },
  {
    slug: 'pune',
    city: 'Pune',
    ...
    intro:
      'Pune has a strong CBSE base and a growing IB school cluster — Mercedes-Benz International, Symbiosis International, Vibgyor High, Victorious Kidss, Indus International. Our online programme runs on IST timings with full Campbell coverage.',
    schoolCatchment: [
    ...
    localContext:
      'Pune has a growing IB/Cambridge cluster serving Koregaon Park, Viman Nagar, Baner, and Kalyani Nagar — Mercedes-Benz International, Symbiosis International, Vibgyor High, Victorious Kidss Educares, Indus International Pune, and DPS Pune send the most olympiad students. Pune NSEB participation has historically been moderate but quality is high — IB students here tend to be academically rigorous and arrive at olympiad prep from strong Science-foundation courses. Pune students frequently combine NSEB with NEET rank improvement because many also target state quota medical admissions. Class 11 start is standard.',
    commuteContext:
      'No offline Cerebrum centre in Pune; classes are fully online. Live classes scheduled 5:30-8:00 PM IST which fits Pune school evening windows across Koregaon Park, Viman Nagar, Baner, and Kalyani Nagar. Students in outer Pune clusters (Hinjewadi, Wakad) rely more on recordings due to evening traffic patterns. Saturday 10 AM IST weekend intensives are Pune-friendly.',
  },
  {
    slug: 'kolkata',
    city: 'Kolkata',
