  ...
  reviewerRoles: [
    {
      ...
      qualifications: ['PhD in Biology/Life Sciences', '5+ years teaching experience', 'NEET coaching background'],
      responsibilities: ['Scientific accuracy validation', 'NCERT alignment verification', 'Concept clarity assessment']
    },
    {
      role: 'Educational Reviewer',
      qualifications: ['M.Ed or equivalent', '3+ years curriculum design', 'Assessment expertise'],
      responsibilities: ['Pedagogical effectiveness review', 'Explanation quality assessment', 'Learning objective alignment']
    },
    {
      role: 'Technical Reviewer',
      qualifications: ['Technical background', 'Platform familiarity', 'Quality assurance experience'],
      responsibilities: ['Format validation', 'Technical implementation review', 'Metadata verification']
    }
  ]
}
