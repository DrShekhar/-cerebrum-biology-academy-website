...
export const NEAR_ME_CITIES: NearMeCityData[] = [
  // ─── NORTH INDIA ───────────────────────────────────────────────────
  {
    ...
    localFaqs: [
      ...
      {
        question: 'Will my Prayagraj study material delivery be reliable?',
        answer:
...

  {
    ...
    localFaqs: [
      {
        question: 'Should an Ambala student move to Chandigarh / Kota for NEET dropper year?',
        answer:
      ...
      {
        question: "What's the Haryana state quota college situation for Ambala students?",
        answer:
      ...
      {
        question: 'Can you ship study material to Ambala Cantonment area?',
        answer:
...

  {
    ...
    localFaqs: [
      ...
      {
        question: 'Will the printed Cerebrum study material reach Ranjit Avenue / Green Avenue?',
        answer:
...

  {
    ...
    localCoachingPresence:
      'Allen Career Institute, Sri Chaitanya, Narayana — Maharashtra-strong coaching market but biology in regional medium of instruction has consistent gaps',
    ...
    localFaqs: [
      {
        question: 'Will the biology teaching match the Maharashtra State Board syllabus?',
        answer:
          'We teach NEET NCERT exclusively because NEET tests NCERT — not state board. If your child is on Maharashtra State Board, we explicitly bridge from state-board framing to NCERT framing in the first 4 weeks. Most state-board students see a 30-50 mark biology improvement in the first 3 months.',
      },
      {
        question: "What's the state quota cut-off for GMC Aurangabad?",
        answer:
          'Maharashtra state quota for GMC Aurangabad has been ~325-340/360 biology in recent years for general category. Our biology programme targets 340+/360.',
      },
      {
        question: 'Do you offer classes in Marathi?',
        answer:
          'No — all biology classes are in English (NCERT NEET medium of instruction). The terminology and conceptual scaffolding matches NEET papers. Most CBSE / English-medium State Board students adapt within a week.',
      },
      {
        question: 'Shipping to CIDCO and Beed Bypass — any issue?',
        answer:
          'No — Aurangabad pincodes (CIDCO, Garkheda, Beed Bypass, Jalna Road) all reachable by courier in 5-6 days.',
      },
    ],
  },

  {
    ...
    feederSchools: [
      ...
      'Jawaharlal Nehru School BHEL',
      'Bal Bhavan International School',
    ],
    localCoachingPresence:
      'Allen Career Institute (MP Nagar), Aakash Institute, Resonance, FIITJEE — MP Nagar is the coaching corridor; biology depth consistently the weak link',
    ...
    localFaqs: [
      ...
      },
      {
        ...
        answer:
          'MP state quota for GMC Bhopal has been ~325-340/360 biology in recent years for general category. AIIMS Bhopal usually needs 340+/360.',
      },
      {
        question: 'Can a Class 12 BHEL Area student manage Cerebrum online + school?',
        answer:
          'Yes — live online classes are 5:30 PM - 8 PM IST, well after school dismissal. BHEL Area kids save 60-90 minutes of MP Nagar commute time daily.',
      },
      {
        question: 'Shipping reliability to Arera Colony and Kolar Road?',
        answer:
          'Yes — all Bhopal pincodes including Arera Colony, MP Nagar, Shyamla Hills, BHEL, and Kolar Road delivered via tracked courier in 4-5 days.',
      },
    ],
  },
