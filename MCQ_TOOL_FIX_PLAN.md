...
```json
{
  ...
  "options": ["I, II and IV only", "I and II only", "I, II, III and IV", "II and III only"],
  "correctAnswer": "A"
}
```
...
```json
{
  ...
  "items": ["Wheat", "Rice", "Mustard", "Maize", "Pea", "Sugarcane"],
...
```json
{
  ...
  "options": ["1 → 4 → 2 → 3", "4 → 1 → 2 → 3", "1 → 2 → 4 → 3", "4 → 2 → 1 → 3"],
  "correctAnswer": "A"
}
```
