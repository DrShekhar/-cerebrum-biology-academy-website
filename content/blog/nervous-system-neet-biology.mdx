...
![Labeled neuron showing dendrites (input), cell body/soma with nucleus, axon hillock (where action potentials originate), myelinated axon with Nodes of Ranvier for saltatory conduction, and axon terminals/synaptic knobs](/blog/diagrams/nervous-system/neuron-structure.svg)
...
![Chemical synapse showing the 5-step process: action potential arrives at axon terminal → voltage-gated Ca2+ channels open → synaptic vesicles fuse with presynaptic membrane → neurotransmitter released into synaptic cleft (20-40 nm) → binds postsynaptic receptors → Na+ enters → new action potential](/blog/diagrams/nervous-system/synapse-transmission.svg)
