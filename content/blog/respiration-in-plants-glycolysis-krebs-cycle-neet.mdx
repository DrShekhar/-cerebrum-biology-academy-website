...
| ------------- | --------------------------------------------- | ---------------------------------------------------------- |
| Organisms     | Yeast (_Saccharomyces_), some bacteria        | Muscle cells, _Lactobacillus_                              |
...
| 2019 | Fermentation  | Organisms performing alcoholic fermentation    | Yeast (_Saccharomyces_)    |
