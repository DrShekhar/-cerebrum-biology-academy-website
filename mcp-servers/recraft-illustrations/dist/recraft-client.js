...
export class RecraftClient {
  client
  outputDir
  constructor(apiKey, outputDir = './generated-illustrations') {
      ...
      illustrations: [
        {
          ...
          name: 'flat_vector',
          description:
            'Clean, minimal flat design like Google illustrations. Best for modern websites.',
          outputFormat: 'SVG',
        },
        {
