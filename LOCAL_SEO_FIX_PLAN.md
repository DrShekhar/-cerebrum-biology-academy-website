...
| Tier 2 | /locations/_, /best-neet-coaching-_, /neet-coaching-[major-city] | 0.8      | High-intent landing pages  |
| Tier 3 | neet-coaching-\* (with unique Content component, 169 pages)      | 0.6      | Unique content local pages |
| Tier 4 | biology-tutor-_, biology-classes-_, [localSlug], school pages    | 0.4      | Template/data-driven pages |
| Tier 5 | biology-coaching-_, best-biology-tuition-_ (CityHubPage)         | 0.3      | Pure template pages        |
