...
console.log(
  `  - ${fixes.missingMetadata.filter((f) => f.field === 'publishedAt').length} missing publishedAt`
)
console.log(
  `  - ${fixes.missingMetadata.filter((f) => f.field === 'featuredImage').length} missing featuredImage`
)
console.log(
  `  - ${fixes.missingMetadata.filter((f) => f.field === 'readTime').length} missing readTime`
)
